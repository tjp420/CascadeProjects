...
function filterPlatformArtifactPaths(entries = []) {
...
function classifyRegenerableArtifacts(analysis = {}) {
...
function softenPriorityActions(actions = [], artifactProfile = 'mixed') {
