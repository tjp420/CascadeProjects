...
describe('simplebeacon-intelligence/index.js', () => {
  ...
  it('exports factory functions', () => {
    assert.strictEqual(typeof intelligence.createIntelligenceEngine, 'function');
  ...
  it('exports structural scanner functions', () => {
    ...
    assert.strictEqual(typeof intelligence.isPlaceholderCredentialValue, 'function');
  ...
  it('exports constants', () => {
    assert.ok(Array.isArray(intelligence.GENERIC_AI_MARKERS) || intelligence.GENERIC_AI_MARKERS);
  ...
  it('exports tree-sitter query functions', () => {
    ...
    assert.strictEqual(typeof intelligence.extractFunctionsFromTree, 'function');
