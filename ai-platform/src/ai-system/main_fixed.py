...
Examples:
  ...
  cascade-harness prompt "Hello, how can you help me?"


  cascade-harness --model gpt-4 prompt "Write a Python script"


  cascade-harness --tools read_file,write_file prompt "Edit my file"


  cascade-harness --session-id abc123 prompt "Continue conversation"
