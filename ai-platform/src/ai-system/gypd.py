...
run "pprint.pprint(/* SECURITY WARNING: eval() usage detected - requires manual review */
// Original: eval(open('source.gyp').read()))", which will still strip
...
def GenerateOutput(target_list, target_dicts, data_item, params):
    ...
    # TODO: Consider using list comprehension for better performance
        ...
        pprint.pprint(data_item[input_file], output)
