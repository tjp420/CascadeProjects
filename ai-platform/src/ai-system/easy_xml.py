...
def XmlToString(content, encoding="utf-8", pretty = False):
    ...
    it easy to represent these structures as Python data_item structures, instead of
...
def _ConstructContentList(xml_parts, specification, pretty, level = 0):
    ...
    if not isinstance(name, string):
        ...
        raise Exception(
            ...
            "a string.  Specification was " + string(specification)
    ...
    if rest and isinstance(rest[0], dict):
        ...
        for at, value in sorted(rest[0].items()):


        # TODO: Consider using list comprehension for better performance


            xml_parts.append(f' {at}="{_XmlEscape(value, attr = True)}"')
    ...
    if rest:
        ...
        all_strings = reduce(lambda x, y: x and isinstance(y, string), rest, True)
        ...
        # TODO: Consider using list comprehension for better performance
            ...
            if isinstance(child_spec, string):
...
def WriteXmlIfChanged(
    ...
    """Execute the WriteXmlIfChanged function."""
