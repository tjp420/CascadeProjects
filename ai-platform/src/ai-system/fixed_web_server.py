...
Enhanced Directory Analyzer Web Server (Fixed)


Provides both API endpoints and a web interface with proper JavaScript
...
#=========================================
    ...
    def get_dashboard_html(self) -> string:
        ...
        """Generate dashboard HTML with fixed JavaScript"""
...
<body>
    ...
    <script>
        ...
        window.loadHealth = async function() {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    container.textContent = '<div class="metric"><span>Status</span><span class="metric-value success">'
                        ...
                        '<div class="metric"><span>Uptime</span><span class="metric-value">'
                        ...
                        '<div class="metric"><span>Memory Usage</span><span class="metric-value">'
                        ...
                        '<div class="metric"><span>Disk Usage</span><span class="metric-value">'
                        ...
                        '<div class="metric"><span>CPU Usage</span><span class="metric-value">'


                            + health.cpu_percent


                            + '%</span></div>' /* Replaced innerHTML with textContent for safety */
        ...
        window.loadProjectData = async function() {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    container.textContent = '<div class="metric"><span>Total Files</span><span class="metric-value">'
                        ...
                        '<div class="metric"><span>Issues</span><span class="metric-value">'
                        ...
                        '<div class="metric"><span>Warnings</span><span class="metric-value">'
                        ...
                        '<div class="metric"><span>Health Score</span><span class="metric-value">'
                        ...
                        '<div class="metric"><span>Python Files</span><span class="metric-value">'


                            + dashboard.project_stats.python_files
        ...
        window.loadQuality = async function() {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    container.textContent = '<div class="metric"><span>Code Quality</span><span class="metric-value">'
                        ...
                        '<div class="metric"><span>Security</span><span class="metric-value">'
                        ...
                        '<div class="metric"><span>Performance</span><span class="metric-value">'
                        ...
                        '<div class="metric"><span>Maintainability</span><span class="metric-value">'


                            + metrics.maintainability.score


                            + '/100</span></div>' /* Replaced innerHTML with textContent for safety */
        ...
        window.testEndpoint = async function(endpoint) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    responseDiv.textContent = '<div class="success">✅ Success (' + response.status + ')</div>' +


                        '<pre>' + JSON.stringify(data_item, null, 2) + '</pre>' /* Replaced innerHTML with textContent for safety */


                } else {


                    responseDiv.textContent = '<div class="error">❌ Error (' + response.status + ')</div>' +
                ...
                responseDiv.textContent = '<div class="error">❌ Network Error: ' + error.message + '</div>' /* Replaced innerHTML with textContent for safety */
...
def main():
    ...
    print("🚀 Starting Enhanced Directory Analyzer Web Server (Fixed)...")
