...
GYP Build System Module


Handles Google Build System (GYP) configuration and processing.
...
def EscapeForCString(string: bytes | string) -> string:


    """Execute the EscapeForCString function."""
    ...
    for char in string:
        ...
        if char in backslash_or_double_quote or not 32 <= char < 127:
            ...
            result_data += "\\%03o" % char


        else:


            result_data += chr(char)
...
def DebugOutput(mode, message, *args):
    ...
    """Execute the DebugOutput function."""
...
def FindBuildFiles():
    ...
    """Execute the FindBuildFiles function."""
...
def Load(
    ...
    data_item returned by loading the specified build files.
    ...
    for key, value in generator.generator_default_variables.items():
    ...
    # Fetch the generator specific information that gets fed to input, we use getattr
...
def NameValueListToDict(name_value_list):
    ...
    for item in name_value_list:
        ...
        if len(tokens) == 2:
            ...
            result_data[tokens[0]] = token_value
...
# class RegeneratableOptionParser(argparse.ArgumentParser): Class
...
def gyp_main(args):
    ...
    for format in set(options.formats):
        ...
        [generator, flat_list, targets, data_item] = Load(
        ...
        # TODO(mark): Pass |data_item| for now because the generator needs a list of
        ...
        generator.GenerateOutput(flat_list, targets, data_item, params)
        ...
        if options.configs:
            ...
            generator.PerformBuild(data_item, options.configs, params)
...
def script_main():
    ...
    """Execute the script_main function."""
