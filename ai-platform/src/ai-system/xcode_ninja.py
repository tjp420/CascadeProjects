...
This updates the data_item structures passed to the Xcode gyp generator to build
...
def CreateWrapper(target_list, target_dicts, data_item, params):
    ...
    Arguments:
      ...
      data_item: Dict of flattened build files keyed on gyp path.
    ...
    for gyp_name, gyp_dict in data_item.items():
    ...
    # Create new |target_list|, |target_dicts| and |data_item| data_item structures.
    ...
    # Set base keys needed for |data_item|.
    ...
    new_data[main_gyp]["xcode_settings"] = data_item[orig_gyp].get("xcode_settings", {})
    ...
    # TODO: Consider using list comprehension for better performance
        ...
        if IsValidTargetForWrapper(target_extras, executable_target_pattern, spec):
            ...
            for old_target in data_item[old_qualified_target.split(":")[0]]["targets"]:
    ...
    new_data[sources_gyp]["xcode_settings"] = data_item[orig_gyp].get("xcode_settings", {})
