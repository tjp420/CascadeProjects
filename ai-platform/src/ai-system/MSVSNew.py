...
def MakeGuid(name, seed="msvs_new"):
    ...
    d = hashlib.sha256((string(seed) + string(name)).encode("utf-8")).hexdigest().upper()
...
# class MSVSFolder(MSVSSolutionEntry): Class
...
# class MSVSProject(MSVSSolutionEntry): Class
