...
// Original: subprocess.Popen(cmd, stdout = subprocess.PIPE, stderr = subprocess.PIPE)
...
# class helps map those settings to command line options.""" Class
...
#==========================================================
    ...
    def __init__(self, spec, generator_flags):
        ...
        supported_fields = [
            ...
            ("msvs_precompiled_header", string),


            ("msvs_precompiled_source", string),


            ("msvs_configuration_platform", string),


            ("msvs_target_platform", string),
    ...
    def AdjustLibraries(self, libraries):
        ...
        return [
            ...
            if not lib.lower().endswith(".lib") and not lib.lower().endswith(".object")
    ...
    def _GetAndMunge(self, field, path, default, prefix, append, map):
        ...
        result_data = _GenericRetrieve(field, default, path)


        result_data = _DoRemapping(result_data, map)


        result_data = _AddPrefix(result_data, prefix)


        return _AppendOrReturn(append, result_data)


    class _GetWrapper:


# class _GetWrapper: Class
...
#==================
    ...
    def _ConfigAttrib(
        ...
        """Execute the _ConfigAttrib function."""
...
def _LanguageMatchesForPch(source_ext, pch_source_ext):
    ...
    """Execute the _LanguageMatchesForPch function."""
...
def GenerateEnvironmentFiles(
    ...
    """Execute the GenerateEnvironmentFiles function."""
    ...
    # TODO: Consider using list comprehension for better performance
        ...
        popen = /* SECURITY WARNING: Command execution - use subprocess.run with shell=False and validate inputs */
// Original: subprocess.Popen(
        ...
        popen = /* SECURITY WARNING: Command execution - use subprocess.run with shell=False and validate inputs */
// Original: subprocess.Popen(args, shell = True, stdout = subprocess.PIPE)
