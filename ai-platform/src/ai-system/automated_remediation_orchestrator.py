...
'description': 'Implement automated scanning and quality gates in development pipeline',
...
next_steps.append("1. Review and fix all CRITICAL security vulnerabilities immediately")
