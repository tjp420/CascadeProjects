...
Add _direct_ollama_call method to LiteLLMChatWrapper class
...
def add_method_to_class():
    ...
    """Add the method to the correct class"""


    container_id = "agent-zero-working"


    # Create a Python script to add the method
...
# Find the line where we need to insert the method (before line 574)


target_line = 573  # 0-indexed
...
print('✅ Method added to LiteLLMChatWrapper class!')
...
docker exec {container_id} sh -c "cat > /tmp/add_method.py << 'EOF'
...
docker exec {container_id} python3 /tmp/add_method.py
...
'''
    ...
    # TODO: Consider using list comprehension for better performance
        ...
        print(f"Step {i}/3: Adding method to LiteLLMChatWrapper...")
...
def main():
    ...
    print("🔧 Adding _direct_ollama_call to LiteLLMChatWrapper class...")
