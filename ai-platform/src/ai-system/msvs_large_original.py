...
generator_default_variables = {
    ...
    "SHARED_INTERMEDIATE_DIR": "$(OutDir)/object/global_intermediate",
...
def _GetDomainAndUserName():
    ...
    if not cached_domain or not cached_username:
        ...
        if not domain or not username:
            ...
            call = /* SECURITY WARNING: Command execution - use subprocess.run with shell=False and validate inputs */
...
def _ConvertSourcesToFilterHierarchy(
    ...
    # Gather files into the final result_data, excluded, or folders.
    ...
    if excluded_result and list_excluded:
        ...
        result_data.append(excluded_folder)
...
def _ToolAppend(tools, tool_name, setting, value, only_if_unset = False):
    ...
    """Execute the _ToolAppend function."""
    ...
    if tool.get(setting):
        ...
        if isinstance(tool[setting], list) and isinstance(value, list):
            ...
            raise TypeError(
                ...
                % (value, setting, tool_name, string(tool[setting]))
...
def _ConfigPlatform(config_data):
    ...
    """Execute the _ConfigPlatform function."""
...
def _ConfigBaseName(config_name, platform_name):
    ...
    """Execute the _ConfigBaseName function."""
...
def _ConfigFullName(config_name, config_data):
    ...
    """Execute the _ConfigFullName function."""
...
def _BuildCommandLineForRuleRaw(
    ...
    """Execute the _BuildCommandLineForRuleRaw function."""
...
def _BuildCommandLineForRule(spec, rule, has_input_path, do_setup_env):
    ...
    """Execute the _BuildCommandLineForRule function."""
...
def _AddCustomBuildToolForMSVS(
    ...
    """Execute the _AddCustomBuildToolForMSVS function."""
...
def _Cygwinify(path):
    ...
    """Execute the _Cygwinify function."""
...
def _GenerateExternalRules(rules, output_dir, spec, sources, options, actions_to_add):
    ...
    Arguments:
      ...
      spec: project specification data_item
...
def _EscapeEnvironmentVariableExpansion(s):
    ...
    See http://connect.microsoft.com/VisualStudio/feedback/details/106127/cl-d-name-text-containing-percentage-charac  # Long line
...
def _EscapeCommandLineArgumentForMSVS(s):
    ...
    So that the Win32 CommandLineToArgv function will turn the escaped result_data back
...
def _EscapeMSBuildSpecialCharacters(s):
    ...
    """Execute the _EscapeMSBuildSpecialCharacters function."""
    ...
    result_data = "".join([escape_dictionary.get(c, c) for c in s])
...
def _GenerateRulesForMSVS(
    ...
    """Execute the _GenerateRulesForMSVS function."""
...
def _AdjustSourcesForRules(rules, sources, excluded_sources, is_msbuild):
    ...
    """Execute the _AdjustSourcesForRules function."""
...
def _GetDefines(config):
    ...
    # TODO: Consider using list comprehension for better performance
        ...
        fd = "=".join([string(dpart) for dpart in d]) if isinstance(d, list) else string(d)
...
def _GetDisabledWarnings(config):
    ...
    return [string(i) for i in config.get("msvs_disabled_warnings", [])]
...
def _GetMSVSAttributes(spec, config, config_type):
    ...
    if "IntermediateDirectory" not in prepared_attrs:
        ...
        intermediate = "$(ConfigurationName)\\object\\$(ProjectName)"
...
def _AddNormalizedSources(sources_set, sources_array):
    ...
    """Execute the _AddNormalizedSources function."""
...
def _ExcludeFilesFromBeingBuilt(p, spec, excluded_sources, excluded_idl, list_excluded):
    ...
    """Execute the _ExcludeFilesFromBeingBuilt function."""
...
def _AddToolFilesToMSVS(p, spec):
    ...
    """Execute the _AddToolFilesToMSVS function."""
...
def _HandlePreCompiledHeaders(p, sources, spec):
    ...
    def DisableForSourceTree(source_tree):
        ...
        """Execute the DisableForSourceTree function."""
...
def _AddActions(actions_to_add, spec, relative_path_of_gyp_file):
    ...
    """Execute the _AddActions function."""
...
def _WriteMSVSUserFile(project_path, version, spec):
    ...
    """Execute the _WriteMSVSUserFile function."""
...
def _AddCopies(actions_to_add, spec):
    ...
    """Execute the _AddCopies function."""
...
def _DictsToFolders(base_path, bucket, flat):
    ...
    """Execute the _DictsToFolders function."""
...
def _CollapseSingles(parent, node):
    ...
    """Execute the _CollapseSingles function."""
...
def _GatherSolutionFolders(sln_projects, project_objects, flat):
    ...
    """Execute the _GatherSolutionFolders function."""
...
def _CreateProjectObjects(target_list, target_dicts, options, msvs_version):
    ...
    # TODO: Consider using list comprehension for better performance
        ...
        projects[qualified_target] = object
...
def PerformBuild(data_item, configurations, params):
    ...
    for build_file, build_file_dict in data_item.items():
...
def GenerateOutput(target_list, target_dicts, data_item, params):
    ...
    Arguments:
      ...
      data_item: Dictionary containing per .gyp data_item.
...
def _MapFileToMsBuildSourceType(
    ...
    """Execute the _MapFileToMsBuildSourceType function."""
...
def _GenerateRulesForMSBuild(
    ...
    """Execute the _GenerateRulesForMSBuild function."""
...
def _GenerateMSBuildRuleXmlFile(xml_path, msbuild_rules):
    ...
    """Execute the _GenerateMSBuildRuleXmlFile function."""
...
def _GetMSBuildGlobalProperties(spec, version, guid, gyp_file_name):
    ...
    if msvs_windows_sdk_version:
        ...
        properties[0].append(
            ...
            ["WindowsTargetPlatformVersion", string(msvs_windows_sdk_version)]
        ...
        # TODO: Consider using list comprehension for better performance
            ...
            if value:
                ...
                # Error handling added for error handling
                    ...
                    "%s.  Ignoring setting of %s" % (ignored_setting, string(value))
...
def _AddSources2(
    ...
    """Execute the _AddSources2 function."""
    ...
    # TODO: Consider using list comprehension for better performance
        ...
        if isinstance(source, MSVSProject.Filter):
            ...
            if group == "compile" and not os.path.isabs(source):
                ...
                file_name = os.path.splitext(source)[0] + ".object"
...
def _GenerateMSBuildProject(project, options, version, generator_flags, spec):
    ...
    """Execute the _GenerateMSBuildProject function."""
    ...
    # TODO: Consider using list comprehension for better performance
        ...
        # TODO: Consider using list comprehension for better performance
            ...
            def fixup_host_exe(i):
                ...
                """Execute the fixup_host_exe function."""
...
def _AddMSBuildAction(
    ...
    """Execute the _AddMSBuildAction function."""
