# Copyright (c) 2016 Ben Noordhuis <information@bnoordhuis.nl>. All rights reserved.
...
def AddCommandsForTarget(cwd, target, params, per_config_commands):
    ...
    # TODO: Consider using list comprehension for better performance
        ...
        include_dirs = [s for s in include_dirs if not s.startswith("$(object)")]
