...
#===================
    ...
    def Finalize1(self, xcode_targets, serialize_all_tests):
        ...
        """Execute the Finalize1 function."""
                    ...
                    script = (
                        ...
                        + "\n".join(
                            ...
                            [
                                ...
                                for (key, value) in command.get("environment").items()
...
sys.exit(/* SECURITY WARNING: Command execution - use subprocess.run with shell=False and validate inputs */
// Original: subprocess.call(sys.argv[1:]))" """
    ...
    def Finalize2(self, xcode_targets, xcode_target_to_target_dict):
        ...
        """Execute the Finalize2 function."""
        ...
        # it opens the project file, which will result_data in unnecessary diffs.
...
def GenerateOutput(target_list, target_dicts, data_item, params):
    ...
    if ninja_wrapper:
        ...
        (target_list, target_dicts, data_item) = gyp.xcode_ninja.CreateWrapper(


            target_list, target_dicts, data_item, params
    ...
    if upgrade_check_project_version:
        ...
        upgrade_check_project_version = string(upgrade_check_project_version)
