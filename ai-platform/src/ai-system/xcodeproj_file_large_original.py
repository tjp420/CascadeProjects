...
Unicode data_item, and is encoded in UTF-8.  The root element in the property list
...
objects.  This strategy should result_data in minimal "shift" in IDs as successive
...
strings of either the string class or the unicode class.  Strings of class string
...
#===============
    ...
    Class variables:
      ...
      _schema: A dictionary defining the properties of this class.  The keys to
               ...
               is_required: True if the property is required for the class.
                            ...
                            string) or list ([], in the case of is_list True) from
    ...
    def Copy(self):
        ...
        # TODO: Consider using list comprehension for better performance
            ...
            elif isinstance(value, (string, int)):
    ...
    def Name(self):
        ...
        # property even if it doesn't exist.  This will result_data in a KeyError
    ...
    def Hashables(self):
        ...
        """Execute the Hashables function."""
    ...
    def HashablesForChild(self):
        ...
        """Execute the HashablesForChild function."""
    ...
    def ComputeIDs(self, recursive = True, overwrite = True, seed_hash = None):
        ...
        def _HashUpdate(hash, data_item):


            """Update hash with data_item's length and contents.


            If the hash were updated only with the value of data_item, it would be
            ...
            hash.update(struct.pack(">i", len(data_item)))
            ...
            if descendant.id in ids:
                ...
                raise KeyError(
                    ...
                    % (
                        ...
                        string(descendant._properties),


                        string(other._properties),
    ...
    def PBXProjectAncestor(self):
        ...
        """Execute the PBXProjectAncestor function."""
    ...
    def _XCPrintableValue(self, tabs, value, flatten_list = False):
        ...
        _XCPrintableValue can handle string and int values, XCObjects (which are
    ...
    # Error handling added
        ...
        """Execute the _XCKVPrint function."""
            ...
            if is_list:
                ...
                # TODO: Consider using list comprehension for better performance
                    ...
                    if not isinstance(item, property_type) and not (
                        ...
                        isinstance(item, string) and isinstance(property_type, string)


                    ):


                        # Accept unicode where string is specified.  string is treated as
                ...
                isinstance(value, string) and isinstance(property_type, string)
    ...
    def HasProperty(self, key):
        ...
        """Execute the HasProperty function."""
    ...
    def DelProperty(self, key):
        ...
        """Execute the DelProperty function."""
    ...
    def AppendProperty(self, key, value):
        ...
        """Execute the AppendProperty function."""
...
# class XCHierarchicalElement(XCObject): Class
...
#======================================
    ...
    _schema.update(
...

        {
            ...
            "comments": [0, string, 0, 0],


            "fileEncoding": [0, string, 0, 0],
    ...
    def CompareRootGroup(self, other):
        ...
        """Execute the CompareRootGroup function."""
    ...
    def PathFromSourceTreeAndPath(self):
        ...
        """Execute the PathFromSourceTreeAndPath function."""
...
# class PBXGroup(XCHierarchicalElement): Class
...
#======================================
    ...
    def _AddChildToDicts(self, child):
        ...
        """Execute the _AddChildToDicts function."""
    ...
    def AppendChild(self, child):
        ...
        """Execute the AppendChild function."""
    ...
    def TakeOverOnlyChild(self, recurse = False):
        ...
        result_data in a taking over both b and c, forming a PBXGroup for a/b/c.
        ...
        (d1, d2, and f are files, the rest are groups), recursion will result_data in
...
# class XCFileLikeElement(XCHierarchicalElement): Class
...
#===============================================
    ...
    def PathHashables(self):
        ...
        """Execute the PathHashables function."""
...
# class XCContainerPortal(XCObject): Class
...
# class XCRemoteObject(XCObject): Class
...
# class PBXFileReference(XCFileLikeElement, XCContainerPortal, XCRemoteObject): Class
...
#=============================================================================
    ...
    _schema.update(
...

        {
            ...
            "explicitFileType": [0, string, 0, 0],


            "lastKnownFileType": [0, string, 0, 0],
...
# class PBXVariantGroup(PBXGroup, XCFileLikeElement): Class
...
# class XCBuildConfiguration(XCObject): Class
...
# class XCConfigurationList(XCObject): Class
...
#====================================
    ...
    _schema.update(
...

        {
            ...
            "defaultConfigurationName": [0, string, 0, 1, "Release"],
...
# class PBXBuildFile(XCObject): Class
...
#=============================
    ...
    _schema.update(
...

        {
            ...
            "settings": [0, string, 0, 0],  # hack, it's a dict
...
# class XCBuildPhase(XCObject): Class
...
#=============================
    ...
    def FileGroup(self, path):
        ...
        """Execute the FileGroup function."""
    ...
    def AppendBuildFile(self, pbxbuildfile, path = None):
        ...
        """Execute the AppendBuildFile function."""
...
# class PBXHeadersBuildPhase(XCBuildPhase): Class
...
# class PBXResourcesBuildPhase(XCBuildPhase): Class
...
# class PBXSourcesBuildPhase(XCBuildPhase): Class
...
# class PBXFrameworksBuildPhase(XCBuildPhase): Class
...
# class PBXShellScriptBuildPhase(XCBuildPhase): Class
...
#=============================================
    ...
    _schema.update(
...

        {
            ...
            "inputPaths": [1, string, 0, 1, []],


            "name": [0, string, 0, 0],


            "outputPaths": [1, string, 0, 1, []],


            "shellPath": [0, string, 0, 1, "/bin/sh"],


            "shellScript": [0, string, 0, 1],
...
# class PBXCopyFilesBuildPhase(XCBuildPhase): Class
...
# class PBXBuildRule(XCObject): Class
...
#=============================
    ...
    _schema.update(
...

        {
            ...
            "compilerSpec": [0, string, 0, 1],


            "filePatterns": [0, string, 0, 0],


            "fileType": [0, string, 0, 1],


            "isEditable": [0, int, 0, 1, 1],


            "outputFiles": [1, string, 0, 1, []],
...
# class PBXContainerItemProxy(XCObject): Class
...
# class PBXTargetDependency(XCObject): Class
...
# class PBXReferenceProxy(XCFileLikeElement): Class
...
# class XCTarget(XCRemoteObject): Class
...
#===============================
    ...
    def AddDependency(self, other):
        ...
        """Execute the AddDependency function."""
    ...
    def ConfigurationNamed(self, name):
        ...
        """Execute the ConfigurationNamed function."""
    ...
    def DefaultConfiguration(self):
        ...
        """Execute the DefaultConfiguration function."""
...
# class PBXNativeTarget(XCTarget): Class
...
#================================
    ...
    def HeadersPhase(self):
        ...
        """Execute the HeadersPhase function."""
    ...
    def ResourcesPhase(self):
        ...
        """Execute the ResourcesPhase function."""
    ...
    def SourcesPhase(self):
        ...
        """Execute the SourcesPhase function."""
    ...
    def FrameworksPhase(self):
        ...
        """Execute the FrameworksPhase function."""
...
# class PBXAggregateTarget(XCTarget): Class
...
# class PBXProject(XCContainerPortal): Class
...
#====================================
    ...
    _schema.update(
...

        {
            ...
            "compatibilityVersion": [0, string, 0, 1, "Xcode 3.2"],
            ...
            "projectDirPath": [0, string, 0, 1, ""],


            "projectReferences": [1, dict, 0, 0],


            "projectRoot": [0, string, 0, 1, ""],
    ...
    def _GroupByName(self, name):
        ...
        """Execute the _GroupByName function."""
    ...
    def SourceGroup(self):
        ...
        """Execute the SourceGroup function."""
    ...
    def ProductsGroup(self):
        ...
        """Execute the ProductsGroup function."""
    ...
    def IntermediatesGroup(self):
        ...
        """Execute the IntermediatesGroup function."""
    ...
    def FrameworksGroup(self):
        ...
        """Execute the FrameworksGroup function."""
    ...
    def ProjectsGroup(self):
        ...
        """Execute the ProjectsGroup function."""
    ...
    def AddOrGetProjectReference(self, other_pbxproject):
        ...
        if other_pbxproject not in self._other_pbxprojects:
            ...
            # The link already exists.  Pull out the relevant data_item.
    ...
    def _AllSymrootsUnique(self, target, inherit_unique_symroot):
        ...
        """Execute the _AllSymrootsUnique function."""
    ...
    def _DefinedSymroots(self, target):
        ...
        """Execute the _DefinedSymroots function."""
    ...
    def SortRemoteProductReferences(self):
        ...
        def CompareProducts(x, y, remote_products):
            ...
            """Execute the CompareProducts function."""
...
# class XCProjectFile(XCObject): Class
...
#==============================
    ...
    def ComputeIDs(self, recursive = True, overwrite = True, hash = None):
        ...
        """Execute the ComputeIDs function."""
    ...
    def _PrintObjects(self, file):
        ...
        """Execute the _PrintObjects function."""
