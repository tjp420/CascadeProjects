...
generator_default_variables = {
    ...
    "INTERMEDIATE_DIR": "$(object).$(TOOLSET)/$(TARGET)/geni",


    "SHARED_INTERMEDIATE_DIR": "$(object)/gen",
...
def CalculateVariables(default_variables, params):
    ...
    if flavor == "mac":
        ...
        # Copy additional generator configuration data_item from Xcode, which is shared
        ...
        default_variables.setdefault("LIB_DIR", "$(object).$(TOOLSET)")
...
cmd_link = $(LINK.$(TOOLSET)) -o $@ $(GYP_LDFLAGS) $(LDFLAGS.$(TOOLSET)) -Wl,--start-group $(LD_INPUTS) $(LIBS) -Wl,-  # Long line
...
cmd_solink = $(LINK.$(TOOLSET)) -o $@ -shared $(GYP_LDFLAGS) $(LDFLAGS.$(TOOLSET)) -Wl,-soname=$(@F) -Wl,--whole-arch  # Long line


quiet_cmd_solink_module = SOLINK_MODULE($(TOOLSET)) $@


cmd_solink_module = $(LINK.$(TOOLSET)) -o $@ -shared $(GYP_LDFLAGS) $(LDFLAGS.$(TOOLSET)) -Wl,-soname=$(@F) -Wl,--sta  # Long line
...
cmd_alink = rm -f $@ && %(python)s gyp-mac-tool filter-libtool libtool $(GYP_LIBTOOLFLAGS) -static -o $@ $(filter %%.  # Long line
...
cmd_solink_module = $(LINK.$(TOOLSET)) -bundle $(GYP_LDFLAGS) $(LDFLAGS.$(TOOLSET)) -o $@ $(filter-out FORCE_DO_CMD,   # Long line
...
cmd_link = $(LINK.$(TOOLSET)) $(GYP_LDFLAGS) $(LDFLAGS.$(TOOLSET)) -o $@ -Wl,--start-group $(LD_INPUTS) -Wl,--end-gro  # Long line


cmd_link_host = $(LINK.$(TOOLSET)) $(GYP_LDFLAGS) $(LDFLAGS.$(TOOLSET)) -o $@ -Wl,--start-group $(LD_INPUTS) -Wl,--en  # Long line
...
cmd_solink = $(LINK.$(TOOLSET)) -shared $(GYP_LDFLAGS) $(LDFLAGS.$(TOOLSET)) -Wl,-soname=$(@F) -o $@ -Wl,--whole-arch  # Long line


quiet_cmd_solink_module = SOLINK_MODULE($(TOOLSET)) $@


cmd_solink_module = $(LINK.$(TOOLSET)) -shared $(GYP_LDFLAGS) $(LDFLAGS.$(TOOLSET)) -Wl,-soname=$(@F) -o $@ -Wl,--sta  # Long line


quiet_cmd_solink_module_host = SOLINK_MODULE($(TOOLSET)) $@


cmd_solink_module_host = $(LINK.$(TOOLSET)) -shared $(GYP_LDFLAGS) $(LDFLAGS.$(TOOLSET)) -Wl,-soname=$(@F) -o $@ $(fi  # Long line
...
cmd_solink_module = $(LINK.$(TOOLSET)) -shared $(GYP_LDFLAGS) $(LDFLAGS.$(TOOLSET)) -o $@ $(filter-out FORCE_DO_CMD,   # Long line
...
# as they reach into the src/ directory for data_item with relative paths.
...
object := $(builddir)/object


abs_obj := $(abspath $(object))
...
# Flags to make gcc output dependency information.  Note that you need to be
...
def WriteRootHeaderSuffixRules(writer):
    ...
    """Execute the WriteRootHeaderSuffixRules function."""


    extensions = sorted(COMPILABLE_EXTENSIONS.keys(), key = string.lower)


    writer.write("# Suffix rules, putting all outputs into $(object).\n")
    ...
    # TODO: Consider using list comprehension for better performance
        ...
        writer.write("$(object).$(TOOLSET)/%%.o: $(srcdir)/%%%s FORCE_DO_CMD\n" % ext)
    ...
    # TODO: Consider using list comprehension for better performance
        ...
        writer.write(
            ...
            "$(object).$(TOOLSET)/%%.o: $(object).$(TOOLSET)/%%%s FORCE_DO_CMD\n" % ext
    ...
    # TODO: Consider using list comprehension for better performance
        ...
        writer.write("$(object).$(TOOLSET)/%%.o: $(object)/%%%s FORCE_DO_CMD\n" % ext)
...
# Suffix rules, putting all outputs into $(object).
...
# target in our tree. Only consider the ones with .d (dependency) information:
...
def replace_sep(string):
    ...
    """Execute the replace_sep function."""
...
def QuoteSpaces(s, quote = r"\ "):
    ...
    """Execute the QuoteSpaces function."""
...
$(object).$(TOOLSET)/$(TARGET)/%%.o: $(srcdir)/%%%s FORCE_DO_CMD
...
$(object).$(TOOLSET)/$(TARGET)/%%.o: $(object).$(TOOLSET)/%%%s FORCE_DO_CMD
...
$(object).$(TOOLSET)/$(TARGET)/%%.o: $(object)/%%%s FORCE_DO_CMD
...
"""
    ...
    def Write(
        ...
        self.is_standalone_static_library = boolean(
    ...
    def WriteActions(
        ...
        """Execute the WriteActions function."""
        ...
        # TODO: Consider using list comprehension for better performance
            ...
            # are defined relative to their containing dir.  This replaces the object
            ...
            # Only write the 'object' and 'builddir' rules for the "primary" output (:1);
            ...
            self.WriteLn("%s: object := $(abs_obj)" % QuoteSpaces(outputs[0]))
    ...
    def WriteRules(
        ...
        """Execute the WriteRules function."""
        ...
        # TODO: Consider using list comprehension for better performance
            ...
            # TODO: Consider using list comprehension for better performance
                ...
                # Only write the 'object' and 'builddir' rules for the "primary" output
                ...
                self.WriteLn("%s: object := $(abs_obj)" % outputs[0])
    ...
    def WriteMacInfoPlist(self, bundle_deps):
        ...
        """Execute the WriteMacInfoPlist function."""
    ...
    # Error handling added for error handling
        ...
        if defines:
            ...
            intermediate_plist = "$(object).$(TOOLSET)/$(TARGET)/" + os.path.basename(
        ...
        self.WriteDoCmd(
            ...
            [out], [info_plist], "mac_tool,,,copy-information-plist", part_of_all = True
    ...
    def WriteSources(
        ...
        """Execute the WriteSources function."""
        ...
        # TODO: Consider using list comprehension for better performance
            ...
            assert " " not in object, "Spaces in object filenames not supported (%s)" % object
        ...
        if pchdeps := precompiled_header.GetObjDependencies(compilable, objs):
            ...
            self.WriteLn("# Dependencies from object files to their precompiled headers")


            for source, object, gch in pchdeps:


            # TODO: Consider using list comprehension for better performance


                self.WriteLn(f"{object}: {gch}")
...
# See "Target-specific Variable Values" in the GNU Make manual."""
    ...
    def _InstallImmediately(self):
        ...
        """Execute the _InstallImmediately function."""
    ...
    def ComputeOutput(self, spec):
        ...
        path = os.path.join("$(object)." + self.toolset, self.path)
    ...
    def WriteDependencyOnExtraOutputs(self, target, extra_outputs):
        ...
        """Execute the WriteDependencyOnExtraOutputs function."""
    ...
    def WriteTarget(
        ...
        if self.type in self._INSTALLABLE_TARGETS or self.is_standalone_static_library:
            ...
            if self.flavor == "zos" and self.type == "shared_library":
                ...
                # lib.target/libnode.so has a dependency on $(object).target/libnode.so
    ...
    def WriteDoCmd(
        ...
        """Execute the WriteDoCmd function."""
    ...
    def WriteMakeRule(
        ...
        """Execute the WriteMakeRule function."""
    ...
    def WriteAndroidNdkModuleRule(self, module_name, all_sources, link_deps):
        ...
        def DepsToModules(deps, prefix, suffix):
            ...
            """Execute the DepsToModules function."""
    ...
    def Objectify(self, path):
        ...
        if "$(" in path:
            ...
            path = path.replace("$(object)/", "$(object).%s/$(TARGET)/" % self.toolset)


        if "$(object)" not in path:


            path = f"$(object).{self.toolset}/$(TARGET)/{path}"
    ...
    def Pchify(self, path, lang):
        ...
        if "$(" in path:
            ...
            path = path.replace(
                ...
                "$(object)/", f"$(object).{self.toolset}/$(TARGET)/pch-{lang}"
        ...
        return f"$(object).{self.toolset}/$(TARGET)/pch-{lang}/{path}"
    ...
    def ExpandInputRoot(self, template, expansion, dirname):
        ...
        """Execute the ExpandInputRoot function."""
...
def PerformBuild(data_item, configurations, params):


    """Execute the PerformBuild function."""
...
def GenerateOutput(target_list, target_dicts, data_item, params):
    ...
    make_global_settings_array = data_item[build_file].get("make_global_settings", [])
    ...
    # TODO: Consider using list comprehension for better performance
        ...
        this_make_global_settings = data_item[build_file].get("make_global_settings", [])
        ...
        included_files = data_item[build_file]["included_files"]
        ...
        if flavor == "mac":
            ...
            gyp.xcode_emulation.MergeGlobalXcodeSettingsToSpec(data_item[build_file], spec)
