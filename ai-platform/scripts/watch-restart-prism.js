...
function restartPrism(){
  ...
  exec('docker compose -f docker-compose.prism.yml up -d --build --force-recreate prism-mock', { cwd: repoRoot }, (err, stdout, stderr) => {
...
console.log('Watching', spec, 'for changes (polling every 2s). Press Ctrl+C to exit.');
