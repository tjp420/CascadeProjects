...
class JavascriptLexer(RegexLexer):
    ...
    tokens = {
        ...
        'root': [
            ...
            (r'(abstract|bool|byte|char|double|enum|final|float|goto|'
    ...
    tokens = {
        ...
        'lasso': [
            ...
            (r'(array|date|decimal|duration|integer|map|pair|string|tag|xml|'
             r'null|bool|bytes|keyword|list|locale|queue|set|stack|'
    ...
    tokens = {
        ...
        'statements': [
            ...
            (r'(int|long|float|short|double|char|unsigned|signed|void|'
             r'id|BOOL|bool|bool|IBOutlet|IBAction|SEL|@outlet|@action)\b',
             Keyword.Type),
