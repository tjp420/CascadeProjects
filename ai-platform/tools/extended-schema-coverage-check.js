...
const TARGETS = [
    ...
    { relPath: 'data/roadmap/gguf-roadmap-data.json', requiredKeys: ['projectOverview', 'developmentPhases'] },
    { relPath: 'web/data/gguf-mock-analysis-sample.json', requiredKeys: ['type', 'analysisOverview'] },
