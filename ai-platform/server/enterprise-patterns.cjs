...
const PRIVACY_PATTERNS = [
    ...
    {
        id: 'internal-api-key',
        regex: /\b(internal|private|secret|confidential)[-_]?(api|access|auth)[-_]?key\b/gi,
        severity: 'high',
        category: 'Corporate',
    ...
    },
    {
        ...
        regex: /\b(confidential|internal use only|do not share|proprietary|restricted)\b/gi,
        severity: 'medium',
        category: 'Corporate',
        regulation: 'Internal Policy'
    },
    ...
    for (const pattern of PRIVACY_PATTERNS) {
        ...
        while ((match = pattern.regex.exec(text)) !== null) {
            findings.push({
                ...
                severityBand: pattern.severity === 'critical' ? 'critical' : pattern.severity,
                pattern: pattern.id,
                ...
                recommendation: 'Remove sensitive data before sending prompts to external AI services',
                context
            });
        }
    }
