...
//   Returns the current org partition enforcement configuration.
...
//   Update org partition enforcement configuration (admin only).
...
//   Export all recorded partition violations as JSON (admin only).
