...
} = require("../lib/file-quality-heuristics.cjs");
...
function analyzeFileStatus(content, _filename) {
  ...
  if (content.includes("// IN PROGRESS") || content.includes("# IN PROGRESS"))
    return "in-progress";
  if (content.includes("// COMPLETED") || content.includes("# COMPLETED"))
    return "completed";
  return "planned";
}
    ...
    const releases = [
      {
        ...
        description:
          "AI Data Processing Platform with technical debt management",
      ...
      },
      {
        ...
        description:
          "Enhanced analytics and reporting features with mock data analyzer",
        date: "2026-06-15",
        status: "upcoming",
      },
      {
