...
const KW_VECTORS = [
  ...
  },
  {
    ...
    kekBits: 256,
    keyBits: 128,
    kek: hex('000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F'),
    plaintext: hex('00112233445566778899AABBCCDDEEFF'),
  ...
  },
  {
    ...
    ciphertext: hex('031D33264E15D332 68F24EC260743EDC E1C6C7DDEE725A93 6BA814915C6762D2'),
  },
  {
    id: '4.5',
    ...
    kek: hex('000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F'),
    plaintext: hex('00112233445566778899AABBCCDDEEFF0001020304050607'),
    ciphertext: hex('A8F9BC1612C68B3F F6E6F4FBE30E71E4 769C8B80A32CB895 8CD5D17D6B254DA1'),
  },
  {
    id: '4.6',
    ...
    keyBits: 256,
    kek: hex('000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F'),
    plaintext: hex('00112233445566778899AABBCCDDEEFF000102030405060708090A0B0C0D0E0F'),
    ciphertext: hex('28C9F404C4B810F4 CBCCB35CFB87F826 3F5786E2D80ED326 CBC7F0E71A99F43B FB988B9B7A02DD21'),
  },
];
...
const KWP_VECTORS = [
  {
    ...
    ciphertext: hex('138bdeaa9b8fa7fc 61f97742e72248ee 5ae6ae5360d1ae6a 5f54f373fa543b6a'),
  },
  {
    id: '6.2',
