...
describe('code-understanding/index', () => {
  test('exports frozen object with expected keys', () => {
    ...
    expect(typeof codeUnderstanding.attachUnderstandingToCodebaseReport).toBe('function');
    ...
    expect(typeof codeUnderstanding.detectBusinessLogicPatterns).toBe('function');
