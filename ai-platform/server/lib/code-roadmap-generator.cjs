...
function buildProgressMetrics(
  ...
  const priorTestCoverage =
    typeof priorMetrics.testCoverage === 'number' ? priorMetrics.testCoverage : null;
  const priorLineCoverage =
    typeof priorMetrics.lineCoverage === 'number' ? priorMetrics.lineCoverage : null;
  const priorBranchCoverage =
    typeof priorMetrics.branchCoverage === 'number' ? priorMetrics.branchCoverage : null;
