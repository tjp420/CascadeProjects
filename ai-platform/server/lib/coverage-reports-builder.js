...
const { loadJestCoverageSummary, roundPct } = require('./jest-coverage-reader');
...
const FILE_TO_PROJECT = {
    ...
    'src/api/dashboard-stub-api.js': 'proj_stub_api',
...
function buildCoverageReportsModel(baseDir, sample = {}, options = {}) {
    ...
    return {
        ...
        modelInfo: {
            ...
            confidence: null,
            notes: 'Istanbul metrics from coverage/dashboard/coverage-summary.json (npm run test:coverage)'
        },
        overview: {
            ...(sample.overview || {}),
