...
const { readJsonFileSyncOrNull, statMtimeMsOrNull } = require('./recoverable-io.cjs');
...
const DEFAULT_INTERVAL_MS =
  constants.MINUTES_PER_HOUR * constants.SECONDS_PER_MINUTE * constants.MS_PER_SECOND;
