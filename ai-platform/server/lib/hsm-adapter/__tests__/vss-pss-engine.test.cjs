...
describe('Track 55: VssPssEngine', () => {
  ...
  describe('dealSecret', () => {
    ...
    test('rejects missing sessionId', () => {
      expect(() => engine.dealSecret({
        secret: crypto.randomBytes(32), threshold: 2, participants: 3,
      })).toThrow(HsmAdapterError);
    });

    test('rejects duplicate sessionId', () => {
      engine.dealSecret({
        sessionId: 's1', secret: crypto.randomBytes(32),
    ...
    test('rejects non-Buffer secret', () => {
      expect(() => engine.dealSecret({
        sessionId: 's1', secret: 'not-a-buffer',
        threshold: 2, participants: 3,
      })).toThrow(HsmAdapterError);
    });
  ...
  describe('verifyShare', () => {
    ...
    test('rejects unknown session', () => {
      expect(() => engine.verifyShare('unknown', 'n1')).toThrow(HsmAdapterError);
    });
    ...
    test('rejects unknown node', () => {
      ...
      expect(() => engine.verifyShare('s1', 'unknown')).toThrow(HsmAdapterError);
    });
  ...
  describe('fileComplaint', () => {
    ...
    test('rejects unknown session', () => {
      expect(() => engine.fileComplaint('unknown', 'n1', 'n2'))
        .toThrow(HsmAdapterError);
    });
    ...
    test('rejects unknown complainant', () => {
      ...
      expect(() => engine.fileComplaint('s1', 'unknown', 'n2'))
        .toThrow(HsmAdapterError);
    });
    ...
    test('rejects unknown accused', () => {
      ...
      expect(() => engine.fileComplaint('s1', 'n1', 'unknown'))
        .toThrow(HsmAdapterError);
    });
  });
  ...
  describe('disqualifyNode', () => {
    ...
    test('rejects unknown session', () => {
      expect(() => engine.disqualifyNode('unknown', 'n1'))
        .toThrow(HsmAdapterError);
    });
    ...
    test('rejects unknown node', () => {
      ...
      expect(() => engine.disqualifyNode('s1', 'unknown'))
        .toThrow(HsmAdapterError);
    });
  });
  ...
  describe('reconstructSecret', () => {
    ...
    test('rejects insufficient shares', () => {
      ...
      expect(() => engine.reconstructSecret('s1', ['n1', 'n2']))
        .toThrow(HsmAdapterError);
    });

    test('rejects unknown session', () => {
      expect(() => engine.reconstructSecret('unknown', ['n1']))
        .toThrow(HsmAdapterError);
    });
    ...
    test('rejects disqualified node', () => {
      ...
      expect(() => engine.reconstructSecret('s1', ['n1', 'n3']))
        .toThrow(HsmAdapterError);
    });
  ...
  describe('refreshShares', () => {
    ...
    test('rejects when proactive refresh disabled', () => {
      ...
      expect(() => disabled.refreshShares('s1', 'e1'))
        .toThrow(HsmAdapterError);
    });

    test('rejects unknown session', () => {
      engine.startEpoch();
      expect(() => engine.refreshShares('unknown', 'e1'))
        .toThrow(HsmAdapterError);
    });
    ...
    test('rejects unknown epoch', () => {
      ...
      expect(() => engine.refreshShares('s1', 'unknown'))
        .toThrow(HsmAdapterError);
    });
  });
  ...
  describe('recoverShare', () => {
    ...
    test('rejects unknown session', () => {
      expect(() => engine.recoverShare('unknown', 'n1', ['n2', 'n3']))
        .toThrow(HsmAdapterError);
    });
    ...
    test('rejects unknown node', () => {
      ...
      expect(() => engine.recoverShare('s1', 'unknown', ['n1', 'n2']))
        .toThrow(HsmAdapterError);
    });
    ...
    test('rejects insufficient helpers', () => {
      ...
      expect(() => engine.recoverShare('s1', 'n3', ['n1']))
        .toThrow(HsmAdapterError);
    });
  });
