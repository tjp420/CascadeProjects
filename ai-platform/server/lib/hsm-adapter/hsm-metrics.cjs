...
const counters = {
  ...
  hsm_rgate_pools_initialized_total: 0,
  hsm_rgate_pools_accredited_total: 0,
  hsm_rgate_pools_settled_total: 0,
  hsm_rgate_pools_cancelled_total: 0,
  hsm_rgate_pools_active: 0,
  hsm_rgate_rebalances_total: 0,
  hsm_rgate_batch_inits_total: 0,
  hsm_rgate_committee_signatures_aggregated_total: 0,
  hsm_rgate_claims_verified_total: 0,
  hsm_rgate_claims_slashed_total: 0,
  hsm_rgate_batch_verifications_total: 0,
  hsm_rgate_hw_snark_proofs_generated_total: 0,
  hsm_rgate_hw_snark_proofs_verified_total: 0,
  hsm_rgate_banned_peers: 0,
...
const META = {
  ...
  hsm_rgate_pools_initialized_total: { help: 'Total scientific reproducibility gating pools initialized.', type: 'counter' },
  hsm_rgate_pools_accredited_total: { help: 'Total peer review accreditation completions finalized.', type: 'counter' },
  hsm_rgate_pools_settled_total: { help: 'Total scientific reproducibility gating pools settled cross-chain.', type: 'counter' },
  hsm_rgate_pools_cancelled_total: { help: 'Total scientific reproducibility gating pools cancelled.', type: 'counter' },
  hsm_rgate_pools_active: { help: 'Number of active scientific reproducibility gating pools.', type: 'gauge' },
  hsm_rgate_rebalances_total: { help: 'Total citation depth rebalances performed.', type: 'counter' },
  hsm_rgate_batch_inits_total: { help: 'Total batch pool initializations for scientific reproducibility gating.', type: 'counter' },
  hsm_rgate_committee_signatures_aggregated_total: { help: 'Total committee signature aggregations for research gating pools.', type: 'counter' },
  hsm_rgate_claims_verified_total: { help: 'Total ZK replication claim proofs verified.', type: 'counter' },
  hsm_rgate_claims_slashed_total: { help: 'Total ZK replication claim proofs slashed.', type: 'counter' },
  hsm_rgate_batch_verifications_total: { help: 'Total batch replication claim verifications performed.', type: 'counter' },
  hsm_rgate_hw_snark_proofs_generated_total: { help: 'Total hardware-accelerated SNARK proofs generated for replication claims.', type: 'counter' },
  hsm_rgate_hw_snark_proofs_verified_total: { help: 'Total hardware-accelerated SNARK proofs verified for replication claims.', type: 'counter' },
  hsm_rgate_banned_peers: { help: 'Number of banned peers in scientific reproducibility gating hub.', type: 'gauge' },
};
