...
const counters = {
  ...
  hsm_trgate_pools_initialized_total: 0,
  hsm_trgate_pools_accredited_total: 0,
  hsm_trgate_pools_settled_total: 0,
  hsm_trgate_pools_cancelled_total: 0,
  hsm_trgate_pools_active: 0,
  hsm_trgate_rebalances_total: 0,
  hsm_trgate_batch_inits_total: 0,
  hsm_trgate_committee_signatures_aggregated_total: 0,
  hsm_trgate_claims_verified_total: 0,
  hsm_trgate_claims_slashed_total: 0,
  hsm_trgate_batch_verifications_total: 0,
  hsm_trgate_hw_snark_proofs_generated_total: 0,
  hsm_trgate_hw_snark_proofs_verified_total: 0,
  hsm_trgate_banned_peers: 0,
...
const META = {
  ...
  hsm_trgate_pools_initialized_total: { help: 'Total AI model training gating pools initialized.', type: 'counter' },
  hsm_trgate_pools_accredited_total: { help: 'Total model accreditation completions finalized.', type: 'counter' },
  hsm_trgate_pools_settled_total: { help: 'Total AI model training gating pools settled cross-chain.', type: 'counter' },
  hsm_trgate_pools_cancelled_total: { help: 'Total AI model training gating pools cancelled.', type: 'counter' },
  hsm_trgate_pools_active: { help: 'Number of active AI model training gating pools.', type: 'gauge' },
  hsm_trgate_rebalances_total: { help: 'Total provenance depth rebalances performed.', type: 'counter' },
  hsm_trgate_batch_inits_total: { help: 'Total batch pool initializations for AI model training gating.', type: 'counter' },
  hsm_trgate_committee_signatures_aggregated_total: { help: 'Total committee signature aggregations for training gating pools.', type: 'counter' },
  hsm_trgate_claims_verified_total: { help: 'Total ZK training claim proofs verified.', type: 'counter' },
  hsm_trgate_claims_slashed_total: { help: 'Total ZK training claim proofs slashed.', type: 'counter' },
  hsm_trgate_batch_verifications_total: { help: 'Total batch training claim verifications performed.', type: 'counter' },
  hsm_trgate_hw_snark_proofs_generated_total: { help: 'Total hardware-accelerated SNARK proofs generated for training claims.', type: 'counter' },
  hsm_trgate_hw_snark_proofs_verified_total: { help: 'Total hardware-accelerated SNARK proofs verified for training claims.', type: 'counter' },
  hsm_trgate_banned_peers: { help: 'Number of banned peers in AI model training gating hub.', type: 'gauge' },
};
