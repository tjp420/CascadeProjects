...
const counters = {
  ...
  hsm_wgate_pools_initialized_total: 0,
  hsm_wgate_pools_accredited_total: 0,
  hsm_wgate_pools_settled_total: 0,
  hsm_wgate_pools_cancelled_total: 0,
  hsm_wgate_pools_active: 0,
  hsm_wgate_rebalances_total: 0,
  hsm_wgate_batch_inits_total: 0,
  hsm_wgate_committee_signatures_aggregated_total: 0,
  hsm_wgate_claims_verified_total: 0,
  hsm_wgate_claims_slashed_total: 0,
  hsm_wgate_batch_verifications_total: 0,
  hsm_wgate_hw_snark_proofs_generated_total: 0,
  hsm_wgate_hw_snark_proofs_verified_total: 0,
  hsm_wgate_banned_peers: 0,
...
const META = {
  ...
  hsm_wgate_pools_initialized_total: { help: 'Total water rights allocation gating pools initialized.', type: 'counter' },
  hsm_wgate_pools_accredited_total: { help: 'Total watershed accreditation completions finalized.', type: 'counter' },
  hsm_wgate_pools_settled_total: { help: 'Total water rights allocation gating pools settled cross-chain.', type: 'counter' },
  hsm_wgate_pools_cancelled_total: { help: 'Total water rights allocation gating pools cancelled.', type: 'counter' },
  hsm_wgate_pools_active: { help: 'Number of active water rights allocation gating pools.', type: 'gauge' },
  hsm_wgate_rebalances_total: { help: 'Total flow chain depth rebalances performed.', type: 'counter' },
  hsm_wgate_batch_inits_total: { help: 'Total batch pool initializations for water rights allocation gating.', type: 'counter' },
  hsm_wgate_committee_signatures_aggregated_total: { help: 'Total committee signature aggregations for water gating pools.', type: 'counter' },
  hsm_wgate_claims_verified_total: { help: 'Total ZK water claim proofs verified.', type: 'counter' },
  hsm_wgate_claims_slashed_total: { help: 'Total ZK water claim proofs slashed.', type: 'counter' },
  hsm_wgate_batch_verifications_total: { help: 'Total batch water claim verifications performed.', type: 'counter' },
  hsm_wgate_hw_snark_proofs_generated_total: { help: 'Total hardware-accelerated SNARK proofs generated for water claims.', type: 'counter' },
  hsm_wgate_hw_snark_proofs_verified_total: { help: 'Total hardware-accelerated SNARK proofs verified for water claims.', type: 'counter' },
  hsm_wgate_banned_peers: { help: 'Number of banned peers in water rights allocation gating hub.', type: 'gauge' },
};
