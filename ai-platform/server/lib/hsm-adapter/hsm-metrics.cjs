...
const counters = {
  ...
  // Track 77 Phase 2: PQC Biometric Verification Gating & ZK Biometric Claim Validators
  hsm_bgate_pools_initialized_total: 0,
  hsm_bgate_pools_accredited_total: 0,
  hsm_bgate_pools_settled_total: 0,
  hsm_bgate_pools_cancelled_total: 0,
  hsm_bgate_pools_active: 0,
  hsm_bgate_rebalances_total: 0,
  hsm_bgate_batch_inits_total: 0,
  hsm_bgate_committee_signatures_aggregated_total: 0,
  hsm_bgate_claims_verified_total: 0,
  hsm_bgate_claims_slashed_total: 0,
  hsm_bgate_batch_verifications_total: 0,
  hsm_bgate_hw_snark_proofs_generated_total: 0,
  hsm_bgate_hw_snark_proofs_verified_total: 0,
  hsm_bgate_banned_peers: 0,
...
const META = {
  ...
  // Track 77 Phase 2: PQC Biometric Verification Gating & ZK Biometric Claim Validators
  hsm_bgate_pools_initialized_total: { help: 'Total biometric verification gating pools initialized.', type: 'counter' },
  hsm_bgate_pools_accredited_total: { help: 'Total liveness accreditation completions finalized.', type: 'counter' },
  hsm_bgate_pools_settled_total: { help: 'Total biometric verification gating pools settled cross-chain.', type: 'counter' },
  hsm_bgate_pools_cancelled_total: { help: 'Total biometric verification gating pools cancelled.', type: 'counter' },
  hsm_bgate_pools_active: { help: 'Number of active biometric verification gating pools.', type: 'gauge' },
  hsm_bgate_rebalances_total: { help: 'Total liveness metric depth rebalances performed.', type: 'counter' },
  hsm_bgate_batch_inits_total: { help: 'Total batch pool initializations for biometric verification gating.', type: 'counter' },
  hsm_bgate_committee_signatures_aggregated_total: { help: 'Total committee signature aggregations for biometric gating pools.', type: 'counter' },
  hsm_bgate_claims_verified_total: { help: 'Total ZK biometric claim proofs verified.', type: 'counter' },
  hsm_bgate_claims_slashed_total: { help: 'Total ZK biometric claim proofs slashed.', type: 'counter' },
  hsm_bgate_batch_verifications_total: { help: 'Total batch biometric claim verifications performed.', type: 'counter' },
  hsm_bgate_hw_snark_proofs_generated_total: { help: 'Total hardware-accelerated SNARK proofs generated for biometric claims.', type: 'counter' },
  hsm_bgate_hw_snark_proofs_verified_total: { help: 'Total hardware-accelerated SNARK proofs verified for biometric claims.', type: 'counter' },
  hsm_bgate_banned_peers: { help: 'Number of banned peers in biometric verification gating hub.', type: 'gauge' },
