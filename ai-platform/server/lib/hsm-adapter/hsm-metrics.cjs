...
const counters = {
  ...
  hsm_tgate_pools_initialized_total: 0,
  hsm_tgate_pools_accredited_total: 0,
  hsm_tgate_pools_settled_total: 0,
  hsm_tgate_pools_cancelled_total: 0,
  hsm_tgate_pools_active: 0,
  hsm_tgate_rebalances_total: 0,
  hsm_tgate_batch_inits_total: 0,
  hsm_tgate_committee_signatures_aggregated_total: 0,
  hsm_tgate_claims_verified_total: 0,
  hsm_tgate_claims_slashed_total: 0,
  hsm_tgate_batch_verifications_total: 0,
  hsm_tgate_hw_snark_proofs_generated_total: 0,
  hsm_tgate_hw_snark_proofs_verified_total: 0,
  hsm_tgate_banned_peers: 0,
...
const META = {
  ...
  hsm_tgate_pools_initialized_total: { help: 'Total DAO treasury management gating pools initialized.', type: 'counter' },
  hsm_tgate_pools_accredited_total: { help: 'Total voter accreditation completions finalized.', type: 'counter' },
  hsm_tgate_pools_settled_total: { help: 'Total DAO treasury management gating pools settled cross-chain.', type: 'counter' },
  hsm_tgate_pools_cancelled_total: { help: 'Total DAO treasury management gating pools cancelled.', type: 'counter' },
  hsm_tgate_pools_active: { help: 'Number of active DAO treasury management gating pools.', type: 'gauge' },
  hsm_tgate_rebalances_total: { help: 'Total allocation depth rebalances performed.', type: 'counter' },
  hsm_tgate_batch_inits_total: { help: 'Total batch pool initializations for DAO treasury management gating.', type: 'counter' },
  hsm_tgate_committee_signatures_aggregated_total: { help: 'Total committee signature aggregations for treasury gating pools.', type: 'counter' },
  hsm_tgate_claims_verified_total: { help: 'Total ZK proposal claim proofs verified.', type: 'counter' },
  hsm_tgate_claims_slashed_total: { help: 'Total ZK proposal claim proofs slashed.', type: 'counter' },
  hsm_tgate_batch_verifications_total: { help: 'Total batch proposal claim verifications performed.', type: 'counter' },
  hsm_tgate_hw_snark_proofs_generated_total: { help: 'Total hardware-accelerated SNARK proofs generated for proposal claims.', type: 'counter' },
  hsm_tgate_hw_snark_proofs_verified_total: { help: 'Total hardware-accelerated SNARK proofs verified for proposal claims.', type: 'counter' },
  hsm_tgate_banned_peers: { help: 'Number of banned peers in DAO treasury management gating hub.', type: 'gauge' },
};
