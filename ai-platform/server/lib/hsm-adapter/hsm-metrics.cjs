...
const counters = {
  ...
  hsm_wlgate_pools_initialized_total: 0,
  hsm_wlgate_pools_accredited_total: 0,
  hsm_wlgate_pools_settled_total: 0,
  hsm_wlgate_pools_cancelled_total: 0,
  hsm_wlgate_pools_active: 0,
  hsm_wlgate_rebalances_total: 0,
  hsm_wlgate_batch_inits_total: 0,
  hsm_wlgate_committee_signatures_aggregated_total: 0,
  hsm_wlgate_claims_verified_total: 0,
  hsm_wlgate_claims_slashed_total: 0,
  hsm_wlgate_batch_verifications_total: 0,
  hsm_wlgate_hw_snark_proofs_generated_total: 0,
  hsm_wlgate_hw_snark_proofs_verified_total: 0,
  hsm_wlgate_banned_peers: 0,
...
const META = {
  ...
  hsm_wlgate_pools_initialized_total: { help: 'Total wildlife conservation tracking gating pools initialized.', type: 'counter' },
  hsm_wlgate_pools_accredited_total: { help: 'Total biodiversity accreditation completions finalized.', type: 'counter' },
  hsm_wlgate_pools_settled_total: { help: 'Total wildlife conservation tracking gating pools settled cross-chain.', type: 'counter' },
  hsm_wlgate_pools_cancelled_total: { help: 'Total wildlife conservation tracking gating pools cancelled.', type: 'counter' },
  hsm_wlgate_pools_active: { help: 'Number of active wildlife conservation tracking gating pools.', type: 'gauge' },
  hsm_wlgate_rebalances_total: { help: 'Total telemetry chain depth rebalances performed.', type: 'counter' },
  hsm_wlgate_batch_inits_total: { help: 'Total batch pool initializations for wildlife conservation tracking gating.', type: 'counter' },
  hsm_wlgate_committee_signatures_aggregated_total: { help: 'Total committee signature aggregations for wildlife gating pools.', type: 'counter' },
  hsm_wlgate_claims_verified_total: { help: 'Total ZK conservation claim proofs verified.', type: 'counter' },
  hsm_wlgate_claims_slashed_total: { help: 'Total ZK conservation claim proofs slashed.', type: 'counter' },
  hsm_wlgate_batch_verifications_total: { help: 'Total batch conservation claim verifications performed.', type: 'counter' },
  hsm_wlgate_hw_snark_proofs_generated_total: { help: 'Total hardware-accelerated SNARK proofs generated for conservation claims.', type: 'counter' },
  hsm_wlgate_hw_snark_proofs_verified_total: { help: 'Total hardware-accelerated SNARK proofs verified for conservation claims.', type: 'counter' },
  hsm_wlgate_banned_peers: { help: 'Number of banned peers in wildlife conservation tracking gating hub.', type: 'gauge' },
};
