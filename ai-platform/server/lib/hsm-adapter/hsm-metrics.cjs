...
const counters = {
  ...
  // Track 80 Phase 2: PQC VRF Audit Sortition Gating & ZK Sortition Claim Validators
  hsm_vgate_pools_initialized_total: 0,
  hsm_vgate_pools_accredited_total: 0,
  hsm_vgate_pools_settled_total: 0,
  hsm_vgate_pools_cancelled_total: 0,
  hsm_vgate_pools_active: 0,
  hsm_vgate_rebalances_total: 0,
  hsm_vgate_batch_inits_total: 0,
  hsm_vgate_committee_signatures_aggregated_total: 0,
  hsm_vgate_claims_verified_total: 0,
  hsm_vgate_claims_slashed_total: 0,
  hsm_vgate_batch_verifications_total: 0,
  hsm_vgate_hw_snark_proofs_generated_total: 0,
  hsm_vgate_hw_snark_proofs_verified_total: 0,
  hsm_vgate_banned_peers: 0,
...
const META = {
  ...
  // Track 80 Phase 2: PQC VRF Audit Sortition Gating & ZK Sortition Claim Validators
  hsm_vgate_pools_initialized_total: { help: 'Total VRF audit sortition gating pools initialized.', type: 'counter' },
  hsm_vgate_pools_accredited_total: { help: 'Total validator accreditation completions finalized.', type: 'counter' },
  hsm_vgate_pools_settled_total: { help: 'Total VRF audit sortition gating pools settled cross-chain.', type: 'counter' },
  hsm_vgate_pools_cancelled_total: { help: 'Total VRF audit sortition gating pools cancelled.', type: 'counter' },
  hsm_vgate_pools_active: { help: 'Number of active VRF audit sortition gating pools.', type: 'gauge' },
  hsm_vgate_rebalances_total: { help: 'Total entropy depth rebalances performed.', type: 'counter' },
  hsm_vgate_batch_inits_total: { help: 'Total batch pool initializations for VRF audit sortition gating.', type: 'counter' },
  hsm_vgate_committee_signatures_aggregated_total: { help: 'Total committee signature aggregations for sortition gating pools.', type: 'counter' },
  hsm_vgate_claims_verified_total: { help: 'Total ZK sortition claim proofs verified.', type: 'counter' },
  hsm_vgate_claims_slashed_total: { help: 'Total ZK sortition claim proofs slashed.', type: 'counter' },
  hsm_vgate_batch_verifications_total: { help: 'Total batch sortition claim verifications performed.', type: 'counter' },
  hsm_vgate_hw_snark_proofs_generated_total: { help: 'Total hardware-accelerated SNARK proofs generated for sortition claims.', type: 'counter' },
  hsm_vgate_hw_snark_proofs_verified_total: { help: 'Total hardware-accelerated SNARK proofs verified for sortition claims.', type: 'counter' },
  hsm_vgate_banned_peers: { help: 'Number of banned peers in VRF audit sortition gating hub.', type: 'gauge' },
