...
const counters = {
  ...
  hsm_cgate_pools_initialized_total: 0,
  hsm_cgate_pools_accredited_total: 0,
  hsm_cgate_pools_settled_total: 0,
  hsm_cgate_pools_cancelled_total: 0,
  hsm_cgate_pools_active: 0,
  hsm_cgate_rebalances_total: 0,
  hsm_cgate_batch_inits_total: 0,
  hsm_cgate_committee_signatures_aggregated_total: 0,
  hsm_cgate_claims_verified_total: 0,
  hsm_cgate_claims_slashed_total: 0,
  hsm_cgate_batch_verifications_total: 0,
  hsm_cgate_hw_snark_proofs_generated_total: 0,
  hsm_cgate_hw_snark_proofs_verified_total: 0,
  hsm_cgate_banned_peers: 0,
...
const META = {
  ...
  hsm_cgate_pools_initialized_total: { help: 'Total telecom routing gating pools initialized.', type: 'counter' },
  hsm_cgate_pools_accredited_total: { help: 'Total routing accreditation completions finalized.', type: 'counter' },
  hsm_cgate_pools_settled_total: { help: 'Total telecom routing gating pools settled cross-chain.', type: 'counter' },
  hsm_cgate_pools_cancelled_total: { help: 'Total telecom routing gating pools cancelled.', type: 'counter' },
  hsm_cgate_pools_active: { help: 'Number of active telecom routing gating pools.', type: 'gauge' },
  hsm_cgate_rebalances_total: { help: 'Total network routing depth rebalances performed.', type: 'counter' },
  hsm_cgate_batch_inits_total: { help: 'Total batch pool initializations for telecom routing gating.', type: 'counter' },
  hsm_cgate_committee_signatures_aggregated_total: { help: 'Total committee signature aggregations for telecom gating pools.', type: 'counter' },
  hsm_cgate_claims_verified_total: { help: 'Total ZK bandwidth claim proofs verified.', type: 'counter' },
  hsm_cgate_claims_slashed_total: { help: 'Total ZK bandwidth claim proofs slashed.', type: 'counter' },
  hsm_cgate_batch_verifications_total: { help: 'Total batch bandwidth claim verifications performed.', type: 'counter' },
  hsm_cgate_hw_snark_proofs_generated_total: { help: 'Total hardware-accelerated SNARK proofs generated for bandwidth claims.', type: 'counter' },
  hsm_cgate_hw_snark_proofs_verified_total: { help: 'Total hardware-accelerated SNARK proofs verified for bandwidth claims.', type: 'counter' },
  hsm_cgate_banned_peers: { help: 'Number of banned peers in telecom routing gating hub.', type: 'gauge' },
};
