...
const META = {
  ...
  hsm_pgate_pools_initialized_total: { help: 'Total polar research data gating pools initialized.', type: 'counter' },
  hsm_pgate_pools_accredited_total: { help: 'Total data accreditation completions finalized.', type: 'counter' },
  hsm_pgate_pools_settled_total: { help: 'Total polar research data gating pools settled cross-chain.', type: 'counter' },
  hsm_pgate_pools_cancelled_total: { help: 'Total polar research data gating pools cancelled.', type: 'counter' },
  hsm_pgate_pools_active: { help: 'Number of active polar research data gating pools.', type: 'gauge' },
  hsm_pgate_rebalances_total: { help: 'Total research chain depth rebalances performed.', type: 'counter' },
  hsm_pgate_batch_inits_total: { help: 'Total batch pool initializations for polar research data gating.', type: 'counter' },
  hsm_pgate_committee_signatures_aggregated_total: { help: 'Total committee signature aggregations for polar research gating pools.', type: 'counter' },
  hsm_pgate_claims_verified_total: { help: 'Total ZK research claim proofs verified.', type: 'counter' },
  hsm_pgate_claims_slashed_total: { help: 'Total ZK research claim proofs slashed.', type: 'counter' },
  hsm_pgate_batch_verifications_total: { help: 'Total batch research claim verifications performed.', type: 'counter' },
  hsm_pgate_hw_snark_proofs_generated_total: { help: 'Total hardware-accelerated SNARK proofs generated for research claims.', type: 'counter' },
  hsm_pgate_hw_snark_proofs_verified_total: { help: 'Total hardware-accelerated SNARK proofs verified for research claims.', type: 'counter' },
  hsm_pgate_banned_peers: { help: 'Number of banned peers in polar research data gating hub.', type: 'gauge' },
