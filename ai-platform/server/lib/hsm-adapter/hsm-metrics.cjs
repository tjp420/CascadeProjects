...
const counters = {
  ...
  hsm_lgate_pools_initialized_total: 0,
  hsm_lgate_pools_accredited_total: 0,
  hsm_lgate_pools_settled_total: 0,
  hsm_lgate_pools_cancelled_total: 0,
  hsm_lgate_pools_active: 0,
  hsm_lgate_rebalances_total: 0,
  hsm_lgate_batch_inits_total: 0,
  hsm_lgate_committee_signatures_aggregated_total: 0,
  hsm_lgate_claims_verified_total: 0,
  hsm_lgate_claims_slashed_total: 0,
  hsm_lgate_batch_verifications_total: 0,
  hsm_lgate_hw_snark_proofs_generated_total: 0,
  hsm_lgate_hw_snark_proofs_verified_total: 0,
  hsm_lgate_banned_peers: 0,
...
const META = {
  ...
  hsm_lgate_pools_initialized_total: { help: 'Total cross-border logistics gating pools initialized.', type: 'counter' },
  hsm_lgate_pools_accredited_total: { help: 'Total carrier accreditation completions finalized.', type: 'counter' },
  hsm_lgate_pools_settled_total: { help: 'Total cross-border logistics gating pools settled cross-chain.', type: 'counter' },
  hsm_lgate_pools_cancelled_total: { help: 'Total cross-border logistics gating pools cancelled.', type: 'counter' },
  hsm_lgate_pools_active: { help: 'Number of active cross-border logistics gating pools.', type: 'gauge' },
  hsm_lgate_rebalances_total: { help: 'Total manifest depth rebalances performed.', type: 'counter' },
  hsm_lgate_batch_inits_total: { help: 'Total batch pool initializations for cross-border logistics gating.', type: 'counter' },
  hsm_lgate_committee_signatures_aggregated_total: { help: 'Total committee signature aggregations for logistics gating pools.', type: 'counter' },
  hsm_lgate_claims_verified_total: { help: 'Total ZK manifest claim proofs verified.', type: 'counter' },
  hsm_lgate_claims_slashed_total: { help: 'Total ZK manifest claim proofs slashed.', type: 'counter' },
  hsm_lgate_batch_verifications_total: { help: 'Total batch manifest claim verifications performed.', type: 'counter' },
  hsm_lgate_hw_snark_proofs_generated_total: { help: 'Total hardware-accelerated SNARK proofs generated for manifest claims.', type: 'counter' },
  hsm_lgate_hw_snark_proofs_verified_total: { help: 'Total hardware-accelerated SNARK proofs verified for manifest claims.', type: 'counter' },
  hsm_lgate_banned_peers: { help: 'Number of banned peers in cross-border logistics gating hub.', type: 'gauge' },
};
