...
const META = {
  ...
  hsm_sgate_pools_initialized_total: { help: 'Total space-asset telemetry gating pools initialized.', type: 'counter' },
  hsm_sgate_pools_accredited_total: { help: 'Total orbital accreditation completions finalized.', type: 'counter' },
  hsm_sgate_pools_settled_total: { help: 'Total space-asset telemetry gating pools settled cross-chain.', type: 'counter' },
  hsm_sgate_pools_cancelled_total: { help: 'Total space-asset telemetry gating pools cancelled.', type: 'counter' },
  hsm_sgate_pools_active: { help: 'Number of active space-asset telemetry gating pools.', type: 'gauge' },
  hsm_sgate_rebalances_total: { help: 'Total telemetry chain depth rebalances performed.', type: 'counter' },
  hsm_sgate_batch_inits_total: { help: 'Total batch pool initializations for space-asset telemetry gating.', type: 'counter' },
  hsm_sgate_committee_signatures_aggregated_total: { help: 'Total committee signature aggregations for orbital gating pools.', type: 'counter' },
  hsm_sgate_claims_verified_total: { help: 'Total ZK telemetry claim proofs verified.', type: 'counter' },
  hsm_sgate_claims_slashed_total: { help: 'Total ZK telemetry claim proofs slashed.', type: 'counter' },
  hsm_sgate_batch_verifications_total: { help: 'Total batch telemetry claim verifications performed.', type: 'counter' },
  hsm_sgate_hw_snark_proofs_generated_total: { help: 'Total hardware-accelerated SNARK proofs generated for telemetry claims.', type: 'counter' },
  hsm_sgate_hw_snark_proofs_verified_total: { help: 'Total hardware-accelerated SNARK proofs verified for telemetry claims.', type: 'counter' },
  hsm_sgate_banned_peers: { help: 'Number of banned peers in space-asset telemetry gating hub.', type: 'gauge' },
};
