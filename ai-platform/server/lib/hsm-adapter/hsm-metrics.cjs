...
const counters = {
  ...
  hsm_ngate_pools_initialized_total: 0,
  hsm_ngate_pools_accredited_total: 0,
  hsm_ngate_pools_settled_total: 0,
  hsm_ngate_pools_cancelled_total: 0,
  hsm_ngate_pools_active: 0,
  hsm_ngate_rebalances_total: 0,
  hsm_ngate_batch_inits_total: 0,
  hsm_ngate_committee_signatures_aggregated_total: 0,
  hsm_ngate_claims_verified_total: 0,
  hsm_ngate_claims_slashed_total: 0,
  hsm_ngate_batch_verifications_total: 0,
  hsm_ngate_hw_snark_proofs_generated_total: 0,
  hsm_ngate_hw_snark_proofs_verified_total: 0,
  hsm_ngate_banned_peers: 0,
...
const META = {
  ...
  hsm_ngate_pools_initialized_total: { help: 'Total nuclear safeguards monitoring gating pools initialized.', type: 'counter' },
  hsm_ngate_pools_accredited_total: { help: 'Total nuclear accreditation completions finalized.', type: 'counter' },
  hsm_ngate_pools_settled_total: { help: 'Total nuclear safeguards monitoring gating pools settled cross-chain.', type: 'counter' },
  hsm_ngate_pools_cancelled_total: { help: 'Total nuclear safeguards monitoring gating pools cancelled.', type: 'counter' },
  hsm_ngate_pools_active: { help: 'Number of active nuclear safeguards monitoring gating pools.', type: 'gauge' },
  hsm_ngate_rebalances_total: { help: 'Total telemetry chain depth rebalances performed.', type: 'counter' },
  hsm_ngate_batch_inits_total: { help: 'Total batch pool initializations for nuclear safeguards monitoring gating.', type: 'counter' },
  hsm_ngate_committee_signatures_aggregated_total: { help: 'Total committee signature aggregations for nuclear gating pools.', type: 'counter' },
  hsm_ngate_claims_verified_total: { help: 'Total ZK safeguards claim proofs verified.', type: 'counter' },
  hsm_ngate_claims_slashed_total: { help: 'Total ZK safeguards claim proofs slashed.', type: 'counter' },
  hsm_ngate_batch_verifications_total: { help: 'Total batch safeguards claim verifications performed.', type: 'counter' },
  hsm_ngate_hw_snark_proofs_generated_total: { help: 'Total hardware-accelerated SNARK proofs generated for safeguards claims.', type: 'counter' },
  hsm_ngate_hw_snark_proofs_verified_total: { help: 'Total hardware-accelerated SNARK proofs verified for safeguards claims.', type: 'counter' },
  hsm_ngate_banned_peers: { help: 'Number of banned peers in nuclear safeguards monitoring gating hub.', type: 'gauge' },
};
