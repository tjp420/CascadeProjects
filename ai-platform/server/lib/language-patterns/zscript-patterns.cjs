...
module.exports = {
    techDebt: [
        { id: 'deprecated-actor', pattern: /\bdeprecated\b.*\bactor\b/gi, label: 'Deprecated actor reference' },
    ...
    bestPractices: [
        { id: 'missing-state', pattern: /\bStates?\.\s*Null\b/gi, label: 'Missing state definition (States.Null)' },
        ...
        { id: 'version-compat', pattern: /\bversion\s*["']\s*4\.\d+/gi, label: 'GZDoom 4.x+ ZScript version feature' }
    ]
};
