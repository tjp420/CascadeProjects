...
module.exports = {
  techDebt: [
    ...
    {
      id: "old-weapon",
      pattern: /\bOldWeapon\b/gi,
      label: "Old weapon reference",
    },
  ],
  debug: [
    {
      id: "console-command",
      pattern: /\bConsole\.Command\b/gi,
    ...
    {
      id: "developer-only",
      pattern: /\bDEVONLY\b/gi,
      label: "Developer-only code (DEVONLY)",
    },
  ],
  placeholders: [
    {
      id: "placeholder-actor",
      pattern: /\bPlaceholderActor\b/gi,
      label: "Placeholder actor",
    },
  ...
  bestPractices: [
    ...
    {
      id: "no-sound",
      pattern: /\bNoSound\b/gi,
      label: "Missing sound assignment (NoSound)",
    },
    {
      id: "infinite-loop",
      pattern: /\bwhile\s*\(\s*1\s*\)/gi,
