...
module.exports = {
    techDebt: [
        ...baseline.techDebt,
        { id: 'go-todo-comment', pattern: /\/\/\s*TODO\b/gi, label: 'Go TODO comment' },
        { id: 'go-fixme-comment', pattern: /\/\/\s*FIXME\b/gi, label: 'Go FIXME comment' }
    ],
    debug: [
        ...baseline.debug,
    ...
    productionLeak: [
        { id: 'go-test-helper', pattern: /\btesting\.T\b|\btesting\.B\b/g, label: 'Go testing import usage' }
    ]
};
