...
module.exports = {
  ...
  debug: [{ id: 'sql-select-star', pattern: /\bSELECT\s+\*\s+FROM\b/gi, label: 'SELECT * query' }],
  placeholders: [
    ...baseline.placeholders,
    {
      id: 'sql-placeholder-table',
      pattern: /\b(?:temp|tmp|staging)_\w+/gi,
      label: 'Temporary/staging table name',
    },
  ],
  bestPractices: [
  ...
  productionLeak: [
    {
      id: 'sql-seed-data',
      pattern: /\b(?:INSERT\s+INTO|seed|fixture)_/gi,
      label: 'Seed/fixture SQL pattern',
    },
  ],
};
