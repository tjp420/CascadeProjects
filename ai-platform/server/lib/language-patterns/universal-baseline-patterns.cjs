...
const FAMILY_BEST_PRACTICES = {
  ...
  data: [{ id: 'python-bare-except', pattern: /except\s*:/g, label: 'Python bare except clause' }],
  devops: [
    {
      id: 'terraform-count',
...
function getBaselinePatternsForFamily(family) {
  ...
  return {
    ...
    debug: [...UNIVERSAL_DEBUG, ...(FAMILY_DEBUG_PATTERNS[key] || FAMILY_DEBUG_PATTERNS.domain)],
