...
export function createExtendedAnalyzers(deps) {
    ...
    return input.taskSequenceScores
      .map((row) => {
        ...
        return {
          ...
          checkpoint: Number(
            (_c = (_b = row.checkpoint) !== null && _b !== void 0 ? _b : row.step) !== null &&
              _c !== void 0
              ? _c
              : 0
          ),
  ...
  function runCostBarrierAnalyzer(definition, issueId, input = {}) {
    ...
    const costs = tiers
      .map((tier) => {
        var _a, _b;
        return Number(
          (_b = (_a = tier.monthlyCost) !== null && _a !== void 0 ? _a : tier.cost) !== null &&
            _b !== void 0
            ? _b
            : 0
        );
  ...
  function runLanguageLimitationAnalyzer(definition, issueId, input = {}) {
    ...
    const qualityScores = evaluations.map((row) => {
      var _a;
      return clampScore(
        Number((_a = row.qualityScore) !== null && _a !== void 0 ? _a : row.passed ? 80 : 40)
      );
    });
