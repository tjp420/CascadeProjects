  ...
  return {
    ...
    repositoryInventory:
      ((_a = report.repositoryInventory) === null || _a === void 0 ? void 0 : _a.totalFiles) != null
        ...
        : inventory,
    repositoryFilesTotal:
      (_b = report.repositoryFilesTotal) !== null && _b !== void 0 ? _b : inventory.totalFiles,
    repositoryFoldersTotal:
      (_c = report.repositoryFoldersTotal) !== null && _c !== void 0 ? _c : inventory.totalFolders,
    filesAnalyzed:
      (_e =
...
export function convertSandboxReportToSimplebeacon(report, projectPath) {
  ...
  for (const f of report.files || []) {
    const p = String(typeof f === 'string' ? f : f.absolutePath || f.path || f.name || '').replace(
      /\\/g,
      '/'
    );
    const parts = p.split('/');
  ...
  const sampleFiles = (report.files || [])
    .slice(0, 96)
    .map((f) =>
      typeof f === 'string' ? f : f.absolutePath || f.path || f.name || f.relativePath || ''
    )
    .filter(Boolean);
  return {
