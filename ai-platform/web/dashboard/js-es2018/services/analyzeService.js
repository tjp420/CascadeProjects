...
export async function ensureDashboardApiReady() {
    ...
    if (probeRes.status === 403 && probeData.error === 'vault_required') {
        throw new Error('Vault session required for internal dashboard. '
...
export async function patchProvidersFromSavedAiKeys(data) {
    var _a;
    if (!((_a = data === null || data === void 0 ? void 0 : data.providers) === null || _a === void 0 ? void 0 : _a.length))
        return data;
    ...
    const model = String((keys === null || keys === void 0 ? void 0 : keys.ollamaModel) || '').trim();
    if (!model)
        return data;
        ...
        return {
            ...
            fileReductionPlan: report.fileReductionPlan
                ? {
                    ...
                    safeToDelete: {
                        topDirectories: (((_a = report.fileReductionPlan.safeToDelete) === null || _a === void 0 ? void 0 : _a.topDirectories) || []).slice(0, 8)
                    },
                    unusedFiles: {
                        candidates: (_c = (_b = report.fileReductionPlan.unusedFiles) === null || _b === void 0 ? void 0 : _b.candidates) !== null && _c !== void 0 ? _c : null
                    }
                }
                : null,
            executiveSummary: report.executiveSummary
                ? {
                    ...
                    security: {
                        piiNeedingReview: (_e = (_d = report.executiveSummary.security) === null || _d === void 0 ? void 0 : _d.piiNeedingReview) !== null && _e !== void 0 ? _e : null,
                        credentialsNeedingReview: (_g = (_f = report.executiveSummary.security) === null || _f === void 0 ? void 0 : _f.credentialsNeedingReview) !== null && _g !== void 0 ? _g : null
                    }
                }
                : null,
...
export async function summarizeReport(report, options = {}) {
    ...
    const res = await fetch('/api/analyze/summary', {
        ...
        body: JSON.stringify({
            report: slim,
            reportType: options.reportType || (report === null || report === void 0 ? void 0 : report.type),
...
export function slimCompleteScanForAudit(exportPayload, options = {}) {
    ...
    if (!exportPayload || typeof exportPayload !== 'object')
        return null;
    const findingsLimit = (_a = options.findingsLimit) !== null && _a !== void 0 ? _a : 5000;
    ...
    const slimCleanupAssistant = results.cleanupAssistant
        ? {
            ...
            tiers: {
                safeNow: ((_b = results.cleanupAssistant.tiers) === null || _b === void 0 ? void 0 : _b.safeNow)
                    ? {
                    ...
                    : null,
                investigate: ((_c = results.cleanupAssistant.tiers) === null || _c === void 0 ? void 0 : _c.investigate) || null
            },
    ...
    return {
        ...
        scanDurationMs: (_f = (_d = exportPayload.scanDurationMs) !== null && _d !== void 0 ? _d : (_e = exportPayload.summary) === null || _e === void 0 ? void 0 : _e.scanDurationMs) !== null && _f !== void 0 ? _f : null,
            ...
            roadmap: results.roadmap
                ? {
                    ...
                    codeAnalysis: results.roadmap.codeAnalysis
                        ? {
                            structure: {
                                totalFiles: (_h = (_g = results.roadmap.codeAnalysis.structure) === null || _g === void 0 ? void 0 : _g.totalFiles) !== null && _h !== void 0 ? _h : null,
                                languages: (_k = (_j = results.roadmap.codeAnalysis.structure) === null || _j === void 0 ? void 0 : _j.languages) !== null && _k !== void 0 ? _k : null
                            }
                        }
                        : null,
...
export function normalizeAuditExportPayload(exportPayload) {
    ...
    if (exportPayload.type === 'data-cleanup-report') {
        ...
        return {
            ...
            scanDurationMs: (_a = exportPayload.durationMs) !== null && _a !== void 0 ? _a : null,
            summary: {
                scanKind: profile,
                dataQualityFindings: (_c = (_b = exportPayload.summary) === null || _b === void 0 ? void 0 : _b.totalFindings) !== null && _c !== void 0 ? _c : null,
                fileReductionFindings: (_e = (_d = exportPayload.summary) === null || _d === void 0 ? void 0 : _d.totalFindings) !== null && _e !== void 0 ? _e : null
            },
            results: {
...
function gatePassFromExportScan(normalized) {
    var _a, _b, _c;
    const results = (normalized === null || normalized === void 0 ? void 0 : normalized.results) || {};
    const fromGate = (_b = (_a = results.simplebeacon) === null || _a === void 0 ? void 0 : _a.gate) === null || _b === void 0 ? void 0 : _b.pass;
    if (fromGate === true || fromGate === false)
        return fromGate;
    const fromSummary = (_c = normalized === null || normalized === void 0 ? void 0 : normalized.summary) === null || _c === void 0 ? void 0 : _c.simplebeaconGatePass;
    if (fromSummary === true || fromSummary === false)
        return fromSummary;
    return null;
}
/**
...
function codeFilesFromExportScan(normalized) {
    var _a, _b, _c;
    const value = (_c = (_b = (_a = normalized === null || normalized === void 0 ? void 0 : normalized.results) === null || _a === void 0 ? void 0 : _a.codebase) === null || _b === void 0 ? void 0 : _b.summary) === null || _c === void 0 ? void 0 : _c.codeFilesAnalyzed;
...
function detectSupplementaryExportStep(normalized) {
    var _a;
    const results = (normalized === null || normalized === void 0 ? void 0 : normalized.results) || {};
    const scanKind = (_a = normalized === null || normalized === void 0 ? void 0 : normalized.summary) === null || _a === void 0 ? void 0 : _a.scanKind;
...
export function auditExportButtonLabel(tierInfo) {
    if (!tierInfo || tierInfo.exportBlocked)
        return 'Download audit PDF';
...
export async function fetchComplianceTrailExportJson(windowDays = 90) {
    ...
    if (!res.ok) {
        const data = await parseJsonSafe(res);
        throw new Error((data === null || data === void 0 ? void 0 : data.message) || (data === null || data === void 0 ? void 0 : data.error) || 'Compliance trail JSON export failed');
    }
    const payload = await res.json();
    const disposition = res.headers.get('Content-Disposition') || '';
    const match = disposition.match(/filename="([^"]+)"/i);
    const filename = (match === null || match === void 0 ? void 0 : match[1]) || `compliance-trail-${windowDays}d.json`;
...
export async function fetchComplianceTrailExportHtml(windowDays = 90) {
    ...
    if (!res.ok) {
        const data = await parseJsonSafe(res);
        throw new Error((data === null || data === void 0 ? void 0 : data.message) || (data === null || data === void 0 ? void 0 : data.error) || 'Compliance trail PDF export failed');
    }
    const html = await res.text();
    const disposition = res.headers.get('Content-Disposition') || '';
    const match = disposition.match(/filename="([^"]+)"/i);
    const filename = (match === null || match === void 0 ? void 0 : match[1]) || `compliance-trail-${windowDays}d.html`;
...
export async function fetchCodebaseAnalysis(projectPath, options = {}) {
    ...
    const timeoutMs = (_a = options.timeoutMs) !== null && _a !== void 0 ? _a : (options.context === 'complete' ? 900000 : 600000);
...
export async function fetchDataCleanupScan(projectPath, options = {}) {
    ...
    const timeoutMs = (_a = options.timeoutMs) !== null && _a !== void 0 ? _a : 300000;
    ...
    try {
        ...
        if (profile === 'file-reduction') {
            const hasSignal = ((_c = (_b = scan.fileReductionPlan) === null || _b === void 0 ? void 0 : _b.totals) === null || _c === void 0 ? void 0 : _c.safeToDeleteBytes) != null
                ...
                || ((_j = scan.summary) === null || _j === void 0 ? void 0 : _j.totalFindings) > 0;
            if (!hasSignal) {
        ...
        if (profile === 'data-quality') {
            const hasSignal = scan.executiveSummary
                || ((_k = scan.summary) === null || _k === void 0 ? void 0 : _k.totalFindings) > 0
...
export function scanHintsGameMod(scan) {
    ...
    const insights = ((_a = scan.codeUnderstanding) === null || _a === void 0 ? void 0 : _a.fileInsights) || [];
    return insights.some((item) => {
        var _a, _b, _c, _d, _e, _f, _g;
        const domains = ((_d = (_c = (_b = (_a = item.understanding) === null || _a === void 0 ? void 0 : _a.layers) === null || _b === void 0 ? void 0 : _b.semantic) === null || _c === void 0 ? void 0 : _c.businessLogic) === null || _d === void 0 ? void 0 : _d.domains)
            || ((_g = (_f = (_e = item.understanding) === null || _e === void 0 ? void 0 : _e.layers) === null || _f === void 0 ? void 0 : _f.semantic) === null || _g === void 0 ? void 0 : _g.domains)
            || [];
...
export async function refreshPathInventory(app, projectPath, options = {}) {
    ...
    const promise = (async () => {
        try {
            ...
            const root = (inventory === null || inventory === void 0 ? void 0 : inventory.projectRoot) || path;
            if ((inventory === null || inventory === void 0 ? void 0 : inventory.totalFiles) != null && isInventoryRootAligned(path, root)) {
...
export function liveInventoryForPath(app, projectPath) {
    var _a;
    const cached = (_a = app === null || app === void 0 ? void 0 : app.state) === null || _a === void 0 ? void 0 : _a.pathInventory;
    if (!(cached === null || cached === void 0 ? void 0 : cached.inventory) || !projectPath)
        return null;
...
export function buildPathInventoryProvenance(app, projectPath, report = null) {
    ...
    return buildInventoryProvenance(resolvedReport, projectPath, {
        liveInventory: (live === null || live === void 0 ? void 0 : live.inventory) || null,
        inventoryFetchedAt: (_a = live === null || live === void 0 ? void 0 : live.fetchedAt) !== null && _a !== void 0 ? _a : null
    });
}
/**
...
export function preferPlatformAnalyzePath(candidatePath, defaultPath) {
    ...
    if (candidateNorm === defaultNorm)
        return raw;
    if (defaultNorm.startsWith(`${candidateNorm}/`))
        return fallback;
    return raw;
}
/**
...
export function sanitizeFictionDigestExport(digest) {
    if (!digest || typeof digest !== 'object')
        return digest;
    if (digest.type !== 'simplebeacon-fiction-digest')
        return digest;
...
export function resolveCompleteScanTargetPath(projectPath, priorSteps = []) {
    ...
    const report = (_a = priorSteps.find((step) => (step === null || step === void 0 ? void 0 : step.id) === 'simplebeacon')) === null || _a === void 0 ? void 0 : _a.report;
    const platformRoot = report === null || report === void 0 ? void 0 : report.platformRoot;
...
export async function enrichScanReport(report, projectPath) {
    ...
    if (projectPath && merged.projectRoot
        ...
        if ((fetched === null || fetched === void 0 ? void 0 : fetched.projectRoot)
            && normalizeProjectPath(fetched.projectRoot) === normalizeProjectPath(projectPath)) {
            merged = fetched;
        }
    }
    let inventory = ((_a = merged.repositoryInventory) === null || _a === void 0 ? void 0 : _a.totalFiles) != null
...
export function buildInventoryProvenance(report, requestedPath, options = {}) {
    ...
    if (!(report === null || report === void 0 ? void 0 : report.generatedAt) && !requested && !(liveInventory === null || liveInventory === void 0 ? void 0 : liveInventory.totalFiles))
        return null;
    const reportInventory = ((_a = report === null || report === void 0 ? void 0 : report.repositoryInventory) === null || _a === void 0 ? void 0 : _a.totalFiles) != null
        ? report.repositoryInventory
        : null;
    const reportRoot = (_e = (_d = (_c = (_b = reportInventory === null || reportInventory === void 0 ? void 0 : reportInventory.projectRoot) !== null && _b !== void 0 ? _b : report === null || report === void 0 ? void 0 : report.scanTargetRoot) !== null && _c !== void 0 ? _c : report === null || report === void 0 ? void 0 : report.platformRoot) !== null && _d !== void 0 ? _d : report === null || report === void 0 ? void 0 : report.projectRoot) !== null && _e !== void 0 ? _e : null;
    const reportStale = report && requested ? isLegacyScanReport(report, requested) : false;
    const reportAligned = Boolean((report === null || report === void 0 ? void 0 : report.generatedAt)
        && requested
        && reportRoot
        && isInventoryRootAligned(requested, reportRoot)
        && !reportStale);
    const liveRoot = (liveInventory === null || liveInventory === void 0 ? void 0 : liveInventory.projectRoot) || requested || null;
    const liveAligned = Boolean((liveInventory === null || liveInventory === void 0 ? void 0 : liveInventory.totalFiles) != null
    ...
    const inventoryRoot = (_h = (_g = (_f = inventory === null || inventory === void 0 ? void 0 : inventory.projectRoot) !== null && _f !== void 0 ? _f : (reportAligned ? reportRoot : null)) !== null && _g !== void 0 ? _g : requested) !== null && _h !== void 0 ? _h : null;
    const profile = (inventory === null || inventory === void 0 ? void 0 : inventory.profile) || 'explorer';
    const files = (_j = inventory === null || inventory === void 0 ? void 0 : inventory.totalFiles) !== null && _j !== void 0 ? _j : (reportAligned ? ((_k = report === null || report === void 0 ? void 0 : report.repositoryFilesTotal) !== null && _k !== void 0 ? _k : reportInventory === null || reportInventory === void 0 ? void 0 : reportInventory.totalFiles) : null);
    const folders = (_l = inventory === null || inventory === void 0 ? void 0 : inventory.totalFolders) !== null && _l !== void 0 ? _l : (reportAligned ? ((_m = report === null || report === void 0 ? void 0 : report.repositoryFoldersTotal) !== null && _m !== void 0 ? _m : reportInventory === null || reportInventory === void 0 ? void 0 : reportInventory.totalFolders) : null);
    const ruleScoped = reportAligned
        ? ((_q = (_o = report === null || report === void 0 ? void 0 : report.ruleScopedFilesAnalyzed) !== null && _o !== void 0 ? _o : (_p = report === null || report === void 0 ? void 0 : report.scanScope) === null || _p === void 0 ? void 0 : _p.ruleScopedFilesAnalyzed) !== null && _q !== void 0 ? _q : null)
        : null;
    const generatedAt = reportAligned ? ((_r = report === null || report === void 0 ? void 0 : report.generatedAt) !== null && _r !== void 0 ? _r : null) : null;
    ...
    return {
        ...
        stale: reportStale || (Boolean((report === null || report === void 0 ? void 0 : report.generatedAt) && requested && reportRoot) && !reportAligned),
        hasReport: reportAligned,
        liveInventory: liveAligned && Boolean((liveInventory === null || liveInventory === void 0 ? void 0 : liveInventory.totalFiles) != null),
        inventoryFetchedAt: (_s = options.inventoryFetchedAt) !== null && _s !== void 0 ? _s : null,
        reportMisaligned: Boolean((report === null || report === void 0 ? void 0 : report.generatedAt) && requested && reportRoot && !reportAligned)
    };
}
/**
...
export function buildMonorepoScopeNote(report) {
    var _a, _b, _c, _d;
    if (!(report === null || report === void 0 ? void 0 : report.platformRoot) || !(report === null || report === void 0 ? void 0 : report.projectRoot))
        return '';
    if (normalizeProjectPath(report.platformRoot) === normalizeProjectPath(report.projectRoot)) {
        return '';
    }
    const repoFiles = (_a = report.repositoryFilesTotal) !== null && _a !== void 0 ? _a : (_b = report.repositoryInventory) === null || _b === void 0 ? void 0 : _b.totalFiles;
    const jsonFiction = (_c = report.fictionJsonFilesScanned) !== null && _c !== void 0 ? _c : (_d = report.scanScope) === null || _d === void 0 ? void 0 : _d.fictionJsonFilesScanned;
    const parts = [
        repoFiles != null
...
export function isInventoryRootAligned(requestedPath, inventoryRoot) {
    if (!requestedPath || !inventoryRoot)
        return true;
    const req = normalizeProjectPath(requestedPath);
    const inv = normalizeProjectPath(inventoryRoot);
    if (req === inv)
        return true;
    if (!inv.includes('/') && req.endsWith(`/${inv}`))
        return true;
    if (!req.includes('/') && inv.endsWith(`/${req}`))
        return true;
    if (req.startsWith(`${inv}/`) && req.length > inv.length)
        return false;
    if (inv.startsWith(`${req}/`) && inv.length > req.length)
        return false;
...
export function getScanFileMetrics(report, options = {}) {
    ...
    if (!report || typeof report !== 'object') {
        return {
            ...
            repositoryFiles: (_a = inventory === null || inventory === void 0 ? void 0 : inventory.totalFiles) !== null && _a !== void 0 ? _a : null,
            repositoryFolders: (_b = inventory === null || inventory === void 0 ? void 0 : inventory.totalFolders) !== null && _b !== void 0 ? _b : null,
...
export function resolveDisplayScore(report) {
    ...
    if (!report)
        return null;
    return (_c = (_b = (_a = report.consistencyScore) !== null && _a !== void 0 ? _a : report.schemaCompliance) !== null && _b !== void 0 ? _b : report.qualityScore) !== null && _c !== void 0 ? _c : null;
}
/** Prefer API report when it is newer than cached app state. */
export function shouldPreferLiveReport(cachedReport, liveReport) {
    if (!(liveReport === null || liveReport === void 0 ? void 0 : liveReport.generatedAt))
        return false;
    if (!(cachedReport === null || cachedReport === void 0 ? void 0 : cachedReport.generatedAt))
        return true;
...
export async function refreshLiveReport(scanService, state) {
    ...
    if (!live)
        return (_a = state.report) !== null && _a !== void 0 ? _a : null;
...
export function resolveJestTestsLabel(baseline, dashboardHome, report) {
    if (baseline === null || baseline === void 0 ? void 0 : baseline.jestTestsLabel)
        return baseline.jestTestsLabel;
    const jestSummary = report === null || report === void 0 ? void 0 : report.jestSummary;
    if ((jestSummary === null || jestSummary === void 0 ? void 0 : jestSummary.testsPassed) != null && (jestSummary === null || jestSummary === void 0 ? void 0 : jestSummary.testsTotal) != null) {
    ...
    const overview = dashboardHome === null || dashboardHome === void 0 ? void 0 : dashboardHome.overview;
    if ((overview === null || overview === void 0 ? void 0 : overview.passedTests) != null && (overview === null || overview === void 0 ? void 0 : overview.totalTests) != null) {
        return `${overview.passedTests}/${overview.totalTests}`;
    }
    if ((report === null || report === void 0 ? void 0 : report.jestBaselineChecked) === false) {
...
export function resolvePageSpecsLabel(report, baseline) {
    var _a, _b;
    if ((report === null || report === void 0 ? void 0 : report.pageSampleSchemaChecked) != null) {
        return `${(_a = report.pageSampleSchemaPassed) !== null && _a !== void 0 ? _a : 0}/${report.pageSampleSchemaChecked}`;
    }
    return (_b = baseline === null || baseline === void 0 ? void 0 : baseline.pageSamplesLabel) !== null && _b !== void 0 ? _b : null;
}
/**
...
export function hydrateDashboardHome(home, baseline) {
    ...
    const jestPassing = (_a = baseline === null || baseline === void 0 ? void 0 : baseline.jestTestsPassing) !== null && _a !== void 0 ? _a : (_b = home === null || home === void 0 ? void 0 : home.overview) === null || _b === void 0 ? void 0 : _b.passedTests;
    const suites = (_c = baseline === null || baseline === void 0 ? void 0 : baseline.jestSuites) !== null && _c !== void 0 ? _c : (_d = home === null || home === void 0 ? void 0 : home.overview) === null || _d === void 0 ? void 0 : _d.testSuites;
    if (!jestLabel)
        return home;
    /**
    ...
    const comparativeAnalysis = (home.comparativeAnalysis || []).map((row) => {
        ...
        const change = Number.isFinite(prevNum) && jestPassing != null && prevNum !== jestPassing
            ...
            : row.change;
        return { ...row, current: jestPassing !== null && jestPassing !== void 0 ? jestPassing : row.current, change };
    });
    /**
     * Kpis.
     * @param {any} home.kpis || []
     * @returns {any}
     */
    const kpis = (home.kpis || []).map((item) => (String(item.name || '').toLowerCase().includes('jest')
    ...
    return {
        ...
        overview: home.overview
            ? {
                ...home.overview,
                totalTests: jestPassing !== null && jestPassing !== void 0 ? jestPassing : home.overview.totalTests,
                passedTests: jestPassing !== null && jestPassing !== void 0 ? jestPassing : home.overview.passedTests,
                testSuites: suites !== null && suites !== void 0 ? suites : home.overview.testSuites,
...
export function buildScanScopeLines(report) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
    const scope = report === null || report === void 0 ? void 0 : report.scanScope;
    if (!scope) {
        return [
...
export function buildConsolidationConclusion(scan) {
    ...
    if (isBenchmarkCachePath(projectPath) || scan.benchmarkScan) {
        const repoFiles = (_a = scan.summary.repositoryFilesTotal) !== null && _a !== void 0 ? _a : (_b = scan.repositoryInventory) === null || _b === void 0 ? void 0 : _b.totalFiles;
        ...
        const parts = [
            ...
            ((_c = scan.summary.sampleDataFilesAnalyzed) !== null && _c !== void 0 ? _c : 0) === 0
    ...
    const repoFiles = (_d = s.repositoryFilesTotal) !== null && _d !== void 0 ? _d : (_e = scan.repositoryInventory) === null || _e === void 0 ? void 0 : _e.totalFiles;
    ...
    const repoNote = repoFiles != null
        ...
        : (jsonScanned != null ? ` ${jsonScanned.toLocaleString()} JSON files hashed for duplicates (${((_g = s.exactDuplicateGroups) !== null && _g !== void 0 ? _g : 0).toLocaleString()} duplicate groups).` : '');
    if (!candidates) {
...
export function buildScanConclusion(report, options = {}) {
    ...
    if (options.benchmarkScan) {
        const repoFiles = (_a = report.repositoryFilesTotal) !== null && _a !== void 0 ? _a : (_b = report.scanScope) === null || _b === void 0 ? void 0 : _b.repositoryFilesTotal;
        ...
        const jsonFiction = (_f = report.fictionJsonFilesScanned) !== null && _f !== void 0 ? _f : (_g = report.scanScope) === null || _g === void 0 ? void 0 : _g.fictionJsonFilesScanned;
    ...
    const nonFictionIssues = issueList(report).filter((item) => !/fiction|fictional|consistency|kpi/i.test(String(item.type || '')));
    ...
    if (focus === 'fiction' || focus === 'all') {
        if (fiction.length) {
            ...
            const jsonScanned = (_h = report.fictionJsonFilesScanned) !== null && _h !== void 0 ? _h : (_j = report.scanScope) === null || _j === void 0 ? void 0 : _j.fictionJsonFilesScanned;
            const sampleScanned = (_k = report.fictionSampleFilesScanned) !== null && _k !== void 0 ? _k : report.mockSampleFiles;
            if (jsonScanned != null) {
                parts.push(`No fiction KPI hits in ${Number(jsonScanned).toLocaleString()} JSON files scanned (${sampleScanned !== null && sampleScanned !== void 0 ? sampleScanned : '—'} sample files among them)`);
            }
            else {
    ...
    if (focus === 'all') {
        ...
        if (schema.length)
            parts.push(`${countIssues(schema)} schema violation(s)`);
    }
    const repoFiles = (_l = report.repositoryFilesTotal) !== null && _l !== void 0 ? _l : (_m = report.repositoryInventory) === null || _m === void 0 ? void 0 : _m.totalFiles;
    const ruleScoped = report.ruleScopedFilesAnalyzed;
    const jsonFiction = (_o = report.fictionJsonFilesScanned) !== null && _o !== void 0 ? _o : (_p = report.scanScope) === null || _p === void 0 ? void 0 : _p.fictionJsonFilesScanned;
    const jestNote = report.jestBaselineChecked === false && ((_q = report.scanScope) === null || _q === void 0 ? void 0 : _q.jestExecutedDuringScan) === false
        ? 'Jest was not run as part of this scan.'
        : '';
    if (focus === 'fiction') {
        const gateNote = ((_r = report.gate) === null || _r === void 0 ? void 0 : _r.pass)
            ? (nonFictionCount > 0
        ...
        const inventoryBrief = repoFiles != null && ruleScoped != null
            ...
            : '';
        const fictionScope = ((_t = (_s = report.scanScope) === null || _s === void 0 ? void 0 : _s.limitations) === null || _t === void 0 ? void 0 : _t.find((line) => /fiction|KPI|source code/i.test(line)))
    ...
    const scope = ((_v = (_u = report.scanScope) === null || _u === void 0 ? void 0 : _u.limitations) === null || _v === void 0 ? void 0 : _v[0])
    ...
    const inventoryNote = repoFiles != null
        ...
        : '';
    const gateNote = ((_w = report.gate) === null || _w === void 0 ? void 0 : _w.pass)
        ? 'Gate passes on configured severities.'
        : report.gate
            ? 'Gate would fail on configured severities — review before merge.'
            : '';
...
export function buildFictionDigestPayload(report, options = {}) {
    ...
    const nonFictionIssues = issueList(prepared).filter((item) => !/fiction|fictional|consistency|kpi/i.test(String(item.type || '')));
...
export function normalizeImportedReport(payload) {
    var _a, _b;
    if (payload.type === 'simplebeacon-report')
        return payload;
    if (((_a = payload.report) === null || _a === void 0 ? void 0 : _a.type) === 'simplebeacon-report')
    ...
    if (Array.isArray(payload.rawIssues)) {
        return {
            ...
            issueCount: (_b = payload.issueCount) !== null && _b !== void 0 ? _b : payload.rawIssues.length,
...
export async function readDroppedFiles(fileList) {
    ...
    for (const file of jsonFiles) {
        try {
            ...
            if (report)
                reports.push({ file: file.name, report });
        }
        catch (_a) {
            /* skip non-json */
        }
...
export function assertCompleteScanComplianceFresh(report, checklist) {
    if (!(checklist === null || checklist === void 0 ? void 0 : checklist.evaluatedAt))
        return;
    const reportAt = Date.parse((report === null || report === void 0 ? void 0 : report.generatedAt) || '');
