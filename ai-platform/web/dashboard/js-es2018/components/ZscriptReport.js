...
export function renderZscriptReportPanel(zscriptReport, options = {}) {
  ...
  const report =
    (zscriptReport === null || zscriptReport === void 0 ? void 0 : zscriptReport.report) ||
    zscriptReport;
  ...
  const intensityCvars =
    ((_b = report.cvars) === null || _b === void 0 ? void 0 : _b.intensityCvars) ||
...
export function buildZscriptConclusion(zscriptReport) {
  ...
  const report =
    ...
    zscriptReport;
  if (
    !((_a = report === null || report === void 0 ? void 0 : report.problem_diagnosis) === null ||
    _a === void 0
      ? void 0
      : _a.problem)
  )
