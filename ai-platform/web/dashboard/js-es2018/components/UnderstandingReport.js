        ...
        <div class="consolidation-list">
          ${insights
            .map((item) => {
              ...
              const semantic =
                ((_a = u.layers) === null || _a === void 0 ? void 0 : _a.semantic) || {};
              const business =
                ((_c = (_b = u.layers) === null || _b === void 0 ? void 0 : _b.semantic) === null ||
                _c === void 0
                  ? void 0
                  : _c.businessLogic) ||
                semantic.businessLogic ||
                {};
...
export function buildUnderstandingConclusion(codeUnderstanding) {
  ...
  const count =
    ((_a = codeUnderstanding.fileInsights) === null || _a === void 0 ? void 0 : _a.length) || 0;
    ...
    ...new Set(
      (codeUnderstanding.fileInsights || [])
        .map((i) => {
          var _a, _b, _c;
          return (_c =
            (_b = (_a = i.understanding) === null || _a === void 0 ? void 0 : _a.layers) === null ||
            _b === void 0
              ? void 0
              : _b.static) === null || _c === void 0
            ? void 0
            : _c.language;
        })
        .filter(Boolean)
