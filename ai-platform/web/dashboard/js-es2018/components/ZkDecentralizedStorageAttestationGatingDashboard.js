...
const COUNTER_DEFS = [
  {
    key: "hsm_zkstorage_pool_initialized_total",
    label: "ZK Storage Pools Initialized",
    severity: "positive",
  },
  {
    key: "hsm_zk_storage_proof_verified_total",
    label: "ZK Storage Proofs Verified",
    severity: "positive",
  },
  {
    key: "hsm_zkstorage_replication_accreditation_completed_total",
    label: "Replication Accreditations Completed",
    severity: "positive",
  },
  {
    key: "hsm_zkstorage_dispersal_completed_total",
    label: "Replica Dispersals Completed",
    severity: "positive",
  },
  {
    key: "hsm_zkstorage_slash_recorded_total",
    label: "Storage Claim Slashes",
    severity: "negative",
  },
  {
    key: "hsm_zkstorage_challenge_issued_total",
    label: "Proof-of-Space-Time Challenges Issued",
    severity: "positive",
  },
];
...
const FORM_FIELDS = [
  ...
  {
    name: "proofOfSpaceTimeWindowSeconds",
    label: "Proof-of-Space-Time Window (s)",
    type: "number",
  },
  {
    name: "storageAttestationChainDepth",
    label: "Storage Attestation Chain Depth",
    type: "number",
  },
  {
    name: "replicaDispersalDistance",
    label: "Replica Dispersal Distance",
    type: "number",
  },
  {
...
const BOOLEAN_FIELDS = [
  {
    name: "storageAuthorityInitializerAttestation",
    label: "Require Storage Authority Initializer Attestation",
  },
  {
    name: "storageEthicsOversightCommitteeAttestation",
    label: "Require Storage Ethics Oversight Committee Attestation",
  },
  {
    name: "banMalformedOrOutOfOrderStorageClaims",
    label: "Ban Malformed / Out-of-Order Storage Claims",
  },
...
async function loadZkStorageData(container, isInitial) {
  ...
  try {
    ...
    content.innerHTML =
      '<div class="text-danger">Failed to load ZK decentralized storage gating data.</div>';
    window["console"]["error"](
      "[ZkDecentralizedStorageAttestationGatingDashboard] Error:",
      error.message,
    );
  } finally {
    isRefreshing = false;
