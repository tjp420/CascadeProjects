...
const COUNTER_DEFS = [
  {
    key: "hsm_kineticgate_pool_initialized_total",
    label: "Kinetic Assembly Pools Initialized",
    severity: "positive",
  },
  {
    key: "hsm_zk_kinetic_posture_verified_total",
    label: "ZK Kinetic Posture Verified",
    severity: "positive",
  },
  {
    key: "hsm_assembly_accreditation_completed_total",
    label: "Assembly Accreditation Completions",
    severity: "positive",
  },
];
...
const FORM_FIELDS = [
  ...
  {
    name: "kineticValidationWindowSeconds",
    label: "Kinetic Validation Window (s)",
    type: "number",
  },
  {
    name: "kineticAssemblyChainDepth",
    label: "Kinetic Assembly Chain Depth",
    type: "number",
  },
  {
...
const BOOLEAN_FIELDS = [
  {
    name: "kineticAssemblyAuthorityInitializerAttestation",
    label: "Require Kinetic Assembly Authority Initializer Attestation",
  },
  {
    name: "assemblyEthicsOversightCommitteeAttestation",
    label: "Require Assembly Ethics Oversight Committee Attestation",
  },
  {
    name: "banMalformedOrOutOfOrderKineticAssemblyClaims",
    label: "Ban Malformed / Out-of-Order Kinetic Assembly Claims",
  },
...
function bindSwarmRoboticsKineticAssemblyDashboard(container) {
  ...
  const validateBtn = container.querySelector(
    "#kinetic-assembly-validate-policy",
  );
...
async function loadSwarmRoboticsKineticAssemblyData(container, isInitial) {
  ...
  try {
    ...
    content.innerHTML =
      '<div class="text-danger">Failed to load swarm robotics kinetic assembly data.</div>';
    window["console"]["error"](
      "[SwarmRoboticsKineticAssemblyDashboard] Error:",
      error.message,
    );
  } finally {
    isRefreshing = false;
...
async function onValidatePolicy(container) {
  const resultBox = container.querySelector(
    "#kinetic-assembly-validation-result",
  );
