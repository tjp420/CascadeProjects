...
const COUNTER_DEFS = [
  {
    key: "hsm_didgate_pool_initialized_total",
    label: "DID Pools Initialized",
    severity: "positive",
  },
  {
    key: "hsm_zk_identity_claim_verified_total",
    label: "ZK Identity Claims Verified",
    severity: "positive",
  },
  {
    key: "hsm_revocation_accreditation_completed_total",
    label: "Revocation Accreditations",
    severity: "positive",
  },
];
...
const FORM_FIELDS = [
  ...
  {
    name: "revocationWindowSeconds",
    label: "Revocation Window (s)",
    type: "number",
  },
...
const BOOLEAN_FIELDS = [
  {
    name: "identityAuthorityInitializerAttestation",
    label: "Require Authority Initializer Attestation",
  },
  {
    name: "identityEthicsOversightCommitteeAttestation",
    label: "Require Ethics Oversight Attestation",
  },
  {
    name: "banMalformedOrOutOfOrderIdentityClaims",
    label: "Ban Malformed / Out-of-Order Claims",
  },
...
async function loadDecentralizedIdentityData(container, isInitial) {
  ...
  try {
    ...
    content.innerHTML =
      '<div class="text-danger">Failed to load decentralized identity gating data.</div>';
    window["console"]["error"](
      "[DecentralizedIdentityGatingDashboard] Error:",
      error.message,
    );
  } finally {
    isRefreshing = false;
