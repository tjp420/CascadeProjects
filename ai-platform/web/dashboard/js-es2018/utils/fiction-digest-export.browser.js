...
function isBenchmarkScannerMetaIssue(issue) {
  ...
  if (!issue) return false;
  const intent = String(
    ((_a = issue.metadata) === null || _a === void 0 ? void 0 : _a.intent) || issue.intent || ''
  );
...
function buildBenchmarkFictionConclusion(fictionIssues, nonFictionIssues, sourceReport) {
  ...
  const repoFiles =
    (_a =
      ...
      ? _a
      : (_b =
            sourceReport === null || sourceReport === void 0 ? void 0 : sourceReport.scanScope) ===
            null || _b === void 0
        ? void 0
...
function isStaleFullTreeScan(report) {
  ...
  const mock =
    (_c = (_b = report.mockSampleFiles) !== null && _b !== void 0 ? _b : report.totalFiles) !==
      null && _c !== void 0
      ? _c
      : 0;
...
function reconcileProductDigestScanScope(scanScope = {}, report = {}) {
  ...
  const mockInPaths =
    (_a = scanScope.mockSampleFilesInScanPaths) !== null && _a !== void 0 ? _a : 0;
  const ruleScoped =
    (_c =
  ...
  const mockSampleFiles =
    (_e = (_d = report.mockSampleFiles) !== null && _d !== void 0 ? _d : report.totalFiles) !==
      null && _e !== void 0
      ? _e
      : null;
...
function sanitizeBenchmarkDigestScanScope(scanScope, report) {
  ...
  const scanned =
    (_e =
      ...
      : repoTotal;
  const rawLlm =
    (_f = scanScope.llmSlopScanRaw) !== null && _f !== void 0 ? _f : report.llmSlopScanRaw;
  const reconciled =
...
function buildBenchmarkFictionScopeSummary(sourceReport) {
  ...
  return {
    benchmarkScannerMetaExcluded:
      (_g = scope.benchmarkScannerMetaExcluded) !== null && _g !== void 0 ? _g : 0,
    benchmarkCloneNoiseExcluded:
      (_h = scope.benchmarkCloneNoiseExcluded) !== null && _h !== void 0 ? _h : 0,
...
function formatAncillaryPatternHitsNote(sourceReport) {
  ...
  const blocking =
    (_b =
      (_a = sourceReport === null || sourceReport === void 0 ? void 0 : sourceReport.gate) ===
        null || _a === void 0
        ? void 0
    ...
    repositoryFilesTotal:
      (_g =
        (_e =
          ...
          ? _e
          : (_f = digest === null || digest === void 0 ? void 0 : digest.scanScope) === null ||
              _f === void 0
            ? void 0
    ...
    gateProfile:
      (_w =
        (_u =
          (_t =
            (_r =
              (_q = scope.profile) !== null && _q !== void 0 ? _q : scope.gateRuleBundleProfile) !==
              null && _r !== void 0
              ? _r
...
function buildProductFictionHygieneSummary(sourceReport, digest, options = {}) {
  ...
  const jestChecked =
    ...
    ((_c = digest === null || digest === void 0 ? void 0 : digest.hygieneSummary) === null ||
    _c === void 0
      ? void 0
  ...
  return {
    ...
    gatePass:
      (_f =
        (_e = sourceReport === null || sourceReport === void 0 ? void 0 : sourceReport.gate) ===
          null || _e === void 0
          ? void 0
    ...
    blockingCount:
      (_h =
        (_g = sourceReport === null || sourceReport === void 0 ? void 0 : sourceReport.gate) ===
          null || _g === void 0
          ? void 0
...
function buildProductFictionScanScope(sourceReport, digest, options = {}) {
  ...
  return {
    ...
    fictionDigestNote:
      ...
      ((_a = digest === null || digest === void 0 ? void 0 : digest.scanScope) === null ||
      _a === void 0
        ? void 0
...
function buildProductFictionExportNotes(digest, sourceReport, options = {}) {
  ...
  if (
    ((_k = sourceReport === null || sourceReport === void 0 ? void 0 : sourceReport.gate) ===
      null || _k === void 0
      ? void 0
      : _k.pass) &&
    ruleScoped > 0
    ...
    ((_l = sourceReport === null || sourceReport === void 0 ? void 0 : sourceReport.gate) ===
      null || _l === void 0
      ? void 0
      : _l.pass) &&
    ruleScoped === 0
    ...
    ((_m = sourceReport === null || sourceReport === void 0 ? void 0 : sourceReport.gate) ===
      null || _m === void 0
      ? void 0
      : _m.pass) === false
  ) {
    const blocking =
      (_p = (_o = sourceReport.gate) === null || _o === void 0 ? void 0 : _o.blockingCount) !==
        null && _p !== void 0
        ? _p
        : 0;
    if (blocking > 0) {
...
function enrichProductSourceReport(sourceReport) {
  ...
  const reportHealth = intentionalFullTree
    ...
    : ((_b = sourceReport.scanScope) === null || _b === void 0 ? void 0 : _b.reportHealth) ||
      'platform-scoped';
  ...
  return {
    ...
    scanScope: {
      ...
      rescanRecommended: intentionalFullTree
        ? false
        : Boolean(
            (_e = sourceReport.scanScope) === null || _e === void 0 ? void 0 : _e.rescanRecommended
          ),
...
function resolveDigestTrust(benchmarkScan, fictionIssues, sourceReport) {
  ...
  const ruleScoped =
    (_c =
      ...
      : 0;
  if (
    ((_d = sourceReport === null || sourceReport === void 0 ? void 0 : sourceReport.gate) ===
      null || _d === void 0
      ? void 0
      : _d.pass) &&
    ruleScoped === 0
...
function sanitizeSourceReportForDigest(report, projectPath) {
  ...
  const blockingCount = platformIssues
    .filter((issue) =>
      (gateConfig.failOn || ['high']).includes(issue.severityBand || issue.severity)
    )
    .reduce((sum, issue) => sum + (issue.count || 1), 0);
  const warningCount = platformIssues
    .filter((issue) =>
      (gateConfig.warnOn || ['medium', 'low']).includes(issue.severityBand || issue.severity)
    )
    .reduce((sum, issue) => sum + (issue.count || 1), 0);
  const ruleScoped =
    (_e =
  ...
  const intentionalFullTree = Boolean(
    report.fullDirectoryScan ||
    ((_f = report.scanScope) === null || _f === void 0 ? void 0 : _f.fullDirectoryScan)
  );
  ...
  const scanScopeBase = {
    ...
    reportHealth: benchmarkTarget
      ...
      : intentionalFullTree
        ...
        : staleFullTreeScan
          ...
          : ((_g = report.scanScope) === null || _g === void 0 ? void 0 : _g.reportHealth) ||
            'platform-scoped',
    rescanRecommended: benchmarkTarget
      ...
      : intentionalFullTree
        ...
        : staleFullTreeScan ||
          Boolean(
            (_h = report.scanScope) === null || _h === void 0 ? void 0 : _h.rescanRecommended
          ),
...
export function sanitizeFictionDigestExport(digest, options = {}) {
  ...
  return {
    ...
    sourceProjectPath:
      normalizeDigestProjectPaths(digest.sourceProjectPath, projectLabel) || normalizedPath,
    ...(benchmarkScan
      ? {
          benchmarkScan: true,
          scanTargetProfile: 'benchmark-cache',
