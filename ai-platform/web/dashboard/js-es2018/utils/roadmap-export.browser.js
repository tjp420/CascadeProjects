...
function isStaleEmptyCodebaseMetrics(metrics) {
  ...
  const docs =
    (_d = (_c = metrics.documentation) === null || _c === void 0 ? void 0 : _c.totalDocs) !==
      null && _d !== void 0
      ? _d
      : 0;
      ...
      (_j =
        (_h =
          (_f =
            ...
            ? _f
            : (_g =
                  gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) ===
                  null || _g === void 0
              ? void 0
...
function resolveRoadmapGateContext(roadmap, options = {}) {
  ...
  const gateProfile =
    (_s =
      (_r =
        (_q = (_p = gateReport.scanScope) === null || _p === void 0 ? void 0 : _p.profile) !==
          null && _q !== void 0
          ? _q
  ...
  const gatePass =
    (_4 =
      (_3 = (_2 = gateReport.gate) === null || _2 === void 0 ? void 0 : _2.pass) !== null &&
      _3 !== void 0
        ? _3
  ...
  const blockingCount =
    (_8 =
      (_7 =
        (_6 = (_5 = gateReport.gate) === null || _5 === void 0 ? void 0 : _5.blockingCount) !==
          null && _6 !== void 0
          ? _6
...
function hasFictionCoverageInStrategicInsights(insights) {
  ...
  const parts = [
    ...
    ...(
      ((_a = insights.riskAssessment) === null || _a === void 0 ? void 0 : _a.riskFactors) || []
...
function sanitizeProductCoverageForExport(roadmap) {
  ...
  if (
    ...
    ((_c = next.progressMetrics) === null || _c === void 0 ? void 0 : _c.metrics)
  ) {
...
function buildProductRoadmapHygieneSummary(roadmap, gateContext = {}) {
   ...
   */
  const jestFeature = (
    ((_a = roadmap.codeAnalysis) === null || _a === void 0 ? void 0 : _a.features) || []
  ).find((f) =>
  ...
  return {
    roadmapAuditFiles:
      (_d =
        (_c = (_b = roadmap.codeAnalysis) === null || _b === void 0 ? void 0 : _b.structure) ===
          null || _c === void 0
          ? void 0
    ...
    sprintCompletionRate:
      (_f =
        (_e = roadmap.executiveSummary) === null || _e === void 0 ? void 0 : _e.completionRate) !==
        null && _f !== void 0
        ? _f
        : null,
    coverageEvidenceSource:
      (_g = roadmap.coverageEvidenceSource) !== null && _g !== void 0
        ? _g
        : ((_j = (_h = roadmap.progressMetrics) === null || _h === void 0 ? void 0 : _h.metrics) ===
              null || _j === void 0
              ? void 0
    ...
    apiRouteCount:
      (_p =
        (_m =
          (_l =
            (_k = roadmap.codeAnalysis) === null || _k === void 0 ? void 0 : _k.aiIntegration) ===
            null || _l === void 0
            ? void 0
        ...
        : null,
    jestFilesOnDisk:
      (_q = jestFeature === null || jestFeature === void 0 ? void 0 : jestFeature.count) !== null &&
      _q !== void 0
        ? _q
        : null,
...
function buildProductRoadmapScanScope(scanScope, roadmap, gateContext = {}) {
  ...
  return {
    ...
    roadmapNote:
      ...
      ((_a = roadmap === null || roadmap === void 0 ? void 0 : roadmap.scanScope) === null ||
      _a === void 0
        ? void 0
        : _a.roadmapNote) ||
...
function buildProductRoadmapExportNotes(roadmap, context = {}) {
  ...
  const auditFiles =
    (_e = (_d = roadmap.codeAnalysis) === null || _d === void 0 ? void 0 : _d.structure) === null ||
    _e === void 0
      ? void 0
      : _e.totalFiles;
  ...
  const fictionJsonFilesScanned =
    (_h = context.fictionJsonFilesScanned) !== null && _h !== void 0 ? _h : null;
  const fictionSampleFilesScanned =
    (_j = context.fictionSampleFilesScanned) !== null && _j !== void 0 ? _j : null;
...
function sanitizeProductRoadmapExport(next, options = {}) {
  ...
  if (
    ...
    ((_a = roadmap.codeAnalysis) === null || _a === void 0 ? void 0 : _a.structure)
  ) {
...
function alignProjectStructureInventory(projectStructure, structure) {
  if (
    !projectStructure ||
    !(structure === null || structure === void 0 ? void 0 : structure.totalFiles)
  )
...
function sanitizeCodebaseMetricsForBenchmark(metrics, structure) {
  ...
  return {
    ...metrics,
    totalLinesOfCode:
      (metrics === null || metrics === void 0 ? void 0 : metrics.totalLinesOfCode) || null,
    languages: languages || {},
    testCoverage: null,
    ...
    documentation: {
      readmeFiles:
        (_d =
          (_b = (_a = structure.languages) === null || _a === void 0 ? void 0 : _a['.md']) !==
            null && _b !== void 0
            ? _b
            : (_c = metrics === null || metrics === void 0 ? void 0 : metrics.documentation) ===
                  null || _c === void 0
              ? void 0
...
function resolveRoadmapExportContext(roadmap, options = {}) {
  ...
  const sourceRoot = normalizeExportPath(
    (roadmap === null || roadmap === void 0 ? void 0 : roadmap.sourceProjectPath) ||
      (roadmap === null || roadmap === void 0 ? void 0 : roadmap.projectRoot) ||
      ((_a = roadmap === null || roadmap === void 0 ? void 0 : roadmap.projectStructure) === null ||
      _a === void 0
        ? void 0
        : _a.projectRoot) ||
      ''
...
function sanitizeProgressMetrics(
  ...
  return {
    ...
    categories: {
      'OSS source': (
        codeMetrics === null || codeMetrics === void 0 ? void 0 : codeMetrics.codeFiles
      )
        ? Math.min(100, Math.round(codeMetrics.codeFiles / 20))
        : null,
      Documentation:
        (_b = (_a = metrics.categories) === null || _a === void 0 ? void 0 : _a.Documentation) !==
          null && _b !== void 0
          ? _b
          : null,
    },
...
function sanitizeCodeAnalysisForBenchmark(codeAnalysis, misscopedPlatformWalk = false) {
  ...
  const pairs =
    (_b = (_a = next.phase2) === null || _a === void 0 ? void 0 : _a.fuzzySimilarity) === null ||
    _b === void 0
      ? void 0
      : _b.pairs;
...
function sanitizeExecutiveSummaryForBenchmark(summary, codeMetrics) {
  ...
  return {
    ...
    codeFilesAnalyzed:
      (_a = codeMetrics === null || codeMetrics === void 0 ? void 0 : codeMetrics.codeFiles) !==
        null && _a !== void 0
        ? _a
...
export function sanitizeRoadmapExport(roadmap, options = {}) {
  ...
  if ((_o = next.implementationPhases) === null || _o === void 0 ? void 0 : _o.length) {
    const alreadyBenchmark =
      ...
      String(
        ((_p = next.implementationPhases[0]) === null || _p === void 0 ? void 0 : _p.phase) || ''
      )
        .toLowerCase()
  ...
  if (
    (_t = (_s = next.codeAnalysis) === null || _s === void 0 ? void 0 : _s.phase2) === null ||
    _t === void 0
      ? void 0
      : _t.resourceEstimate
  ) {
