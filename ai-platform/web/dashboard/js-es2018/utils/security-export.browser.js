...
function normalizeComplianceInput(compliance) {
  ...
  return {
    ...
    optimizationCompliance:
      (_c = compliance.optimizationCompliance) !== null && _c !== void 0 ? _c : null,
    generatedAt:
      (_e =
        (_d = compliance.generatedAt) !== null && _d !== void 0
          ? _d
          : compliance.headlineGeneratedAt) !== null && _e !== void 0
        ? _e
        : null,
  };
}
...
function resolveComplianceHeadlineGeneratedAt(compliance) {
  ...
  if (!compliance) return null;
  return (_b =
    (_a = compliance.generatedAt) !== null && _a !== void 0
      ? _a
      : compliance.headlineGeneratedAt) !== null && _b !== void 0
    ? _b
    : null;
}
/**
...
function sanitizeComplianceForSecurityExport(compliance, report) {
  ...
  const scanGatePass =
    (_b =
      (_a = report === null || report === void 0 ? void 0 : report.gate) === null || _a === void 0
        ? void 0
  ...
  const gateReconciled =
    scanGatePass != null && headlineGatePass != null && scanGatePass === headlineGatePass;
  return {
    securityScore: (_d = compliance.securityScore) !== null && _d !== void 0 ? _d : null,
    gatePass: headlineGatePass,
    optimizationCompliance:
      (_e = compliance.optimizationCompliance) !== null && _e !== void 0 ? _e : null,
    provenance:
...
function buildSecurityExportNotes(report, findings = [], compliance = null) {
  ...
  const suppressed =
    (_a = report === null || report === void 0 ? void 0 : report.productionLeakSuppressedIntent) !==
      null && _a !== void 0
      ? _a
      : 0;
  if (suppressed > 0) {
  ...
  if (
    findings.length === 0 &&
    ((_b = report === null || report === void 0 ? void 0 : report.gate) === null || _b === void 0
      ? void 0
      : _b.pass)
  ) {
    notes.push(
  ...
  const scanGatePass =
    (_c = report === null || report === void 0 ? void 0 : report.gate) === null || _c === void 0
      ? void 0
      : _c.pass;
  const headlineGatePass =
    compliance === null || compliance === void 0 ? void 0 : compliance.gatePass;
...
function buildSecurityHygieneSummary(summary) {
  ...
  return {
    ...
    productionLeakFindings:
      (_d = summary.productionLeakFindings) !== null && _d !== void 0 ? _d : null,
    ...
    productionLeakSuppressedIntent:
      (_g = summary.productionLeakSuppressedIntent) !== null && _g !== void 0 ? _g : null,
...
function buildScanReportFromSecurityExport(bundle = {}) {
  ...
  return {
    generatedAt:
      (_b = (_a = scan.generatedAt) !== null && _a !== void 0 ? _a : summary.generatedAt) !==
        null && _b !== void 0
        ? _b
        : null,
    ...
    credentialScanned:
      (_f =
        (_e = scan.credentialScanned) !== null && _e !== void 0
          ? _e
          : summary.credentialScanned) !== null && _f !== void 0
        ? _f
        : null,
    credentialFindings: (_g = summary.credentialFindings) !== null && _g !== void 0 ? _g : null,
    productionLeakScanned:
      (_j =
        (_h = scan.productionLeakScanned) !== null && _h !== void 0
          ? _h
          : summary.productionLeakScanned) !== null && _j !== void 0
        ? _j
        : null,
    productionLeakFindings:
      (_k = summary.productionLeakFindings) !== null && _k !== void 0 ? _k : null,
    productionLeakSuppressedIntent:
      (_m =
        (_l = scan.productionLeakSuppressedIntent) !== null && _l !== void 0
          ? _l
          : summary.productionLeakSuppressedIntent) !== null && _m !== void 0
        ? _m
        : null,
...
export function buildSecurityExportSummary(report, findings = [], compliance = null) {
  ...
  const credentialFindings =
    (_b = report === null || report === void 0 ? void 0 : report.credentialFindings) !== null &&
    _b !== void 0
      ? _b
      : findings
  ...
  const productionLeakFindings =
    (_c = report === null || report === void 0 ? void 0 : report.productionLeakFindings) !== null &&
    _c !== void 0
      ? _c
      : findings
  ...
  return {
    credentialScanned:
      (_d = report === null || report === void 0 ? void 0 : report.credentialScanned) !== null &&
      _d !== void 0
        ? _d
        : null,
    credentialFindings,
    productionLeakScanned:
      (_e = report === null || report === void 0 ? void 0 : report.productionLeakScanned) !==
        null && _e !== void 0
        ? _e
        : null,
    productionLeakFindings,
    productionLeakSuppressedIntent:
      (_f =
        report === null || report === void 0 ? void 0 : report.productionLeakSuppressedIntent) !==
        null && _f !== void 0
        ? _f
        : null,
    totalFindings: findings.reduce((sum, f) => {
      var _a;
      return sum + ((_a = f.count) !== null && _a !== void 0 ? _a : 1);
    }, 0),
    severityCounts,
    gatePass:
      (_j =
        (_h =
          (_g = report === null || report === void 0 ? void 0 : report.gate) === null ||
          _g === void 0
            ? void 0
            : _g.pass) !== null && _h !== void 0
          ? _h
          : compliance === null || compliance === void 0
            ? void 0
            : compliance.gatePass) !== null && _j !== void 0
        ? _j
        : null,
    gateBlockingCount:
      (_l =
        (_k = report === null || report === void 0 ? void 0 : report.gate) === null || _k === void 0
          ? void 0
          : _k.blockingCount) !== null && _l !== void 0
        ? _l
        : null,
    generatedAt:
      (_m = report === null || report === void 0 ? void 0 : report.generatedAt) !== null &&
      _m !== void 0
        ? _m
        : null,
    securityScore:
      (_o = compliance === null || compliance === void 0 ? void 0 : compliance.securityScore) !==
        null && _o !== void 0
        ? _o
        : null,
...
export function buildSecurityExportPayload(report, findings = [], compliance = null) {
  ...
  return {
    ...
    scan: {
      ...
      productionLeakScanned:
        (_d = report.productionLeakScanned) !== null && _d !== void 0 ? _d : null,
      productionLeakSuppressedIntent:
        (_e = report.productionLeakSuppressedIntent) !== null && _e !== void 0 ? _e : null,
...
export function canExportSecurityScan(report) {
  return Boolean(
    report && (report.generatedAt || report.gate != null || report.credentialScanned != null)
  );
}
