...
function redactDataCleanupExportPaths(report, projectPath) {
  ...
  if (
    (_b = (_a = next.scannerStatistics) === null || _a === void 0 ? void 0 : _a.project) === null ||
    _b === void 0
      ? void 0
      : _b.projectRoot
  ) {
...
function resolveFileReductionStatus(report) {
  ...
  const safeBytes =
    (_c =
      (_b = (_a = report.fileReductionPlan) === null || _a === void 0 ? void 0 : _a.totals) ===
        null || _b === void 0
        ? void 0
      ...
      : 0;
  const unused =
    (_e = (_d = report.summary) === null || _d === void 0 ? void 0 : _d.unusedFileCandidates) !==
      null && _e !== void 0
      ? _e
      : 0;
  const dupGroups =
    (_g = (_f = report.summary) === null || _f === void 0 ? void 0 : _f.duplicateAssetGroups) !==
      null && _g !== void 0
      ? _g
      : 0;
...
function resolveDataCleanupGateContext(report, options = {}) {
  ...
  const gateProfile =
    (_6 =
      (_4 =
        (_2 = (_1 = gateReport.scanScope) === null || _1 === void 0 ? void 0 : _1.profile) !==
          null && _2 !== void 0
          ? _2
  ...
  return {
    ...
    fictionSampleFilesScanned:
      (_17 =
        (_15 =
          (_13 =
            (_12 = gateReport.fictionSampleFilesScanned) !== null && _12 !== void 0
              ? _12
...
function buildDataQualityHygieneSummary(report, options = {}) {
  ...
  const workspaceFiles =
    (_b = (_a = report.inventory) === null || _a === void 0 ? void 0 : _a.totalFiles) !== null &&
    _b !== void 0
      ? _b
      : null;
  return {
    ...
    totalFindings:
      (_e = (_d = report.summary) === null || _d === void 0 ? void 0 : _d.totalFindings) !== null &&
      _e !== void 0
        ? _e
        : 0,
    ...
    packageJsonFiles:
      (_l =
        (_h =
          (_g =
            (_f = report.scanners) === null || _f === void 0 ? void 0 : _f['dependency-health']) ===
            null || _g === void 0
            ? void 0
    ...
    dataLineageSampleFiles:
      (_y =
        (_v =
          (_u = (_t = report.scanners) === null || _t === void 0 ? void 0 : _t['data-lineage']) ===
            null || _u === void 0
            ? void 0
            : _u.dataFilesTracked) !== null && _v !== void 0
          ? _v
          : (_x = (_w = report.metadata) === null || _w === void 0 ? void 0 : _w.dataLineage) ===
                null || _x === void 0
            ? void 0
    ...
    mirrorConsumersExcluded:
      (_3 =
        (_2 = report.metadata) === null || _2 === void 0 ? void 0 : _2.mirrorConsumersExcluded) !==
        null && _3 !== void 0
        ? _3
        : 0,
    ...
    ((_4 = report.hygieneSummary) === null || _4 === void 0 ? void 0 : _4.jestBaselineChecked) ===
      false
...
function enrichProductDataQualityScanScope(scanScope, report, options = {}) {
  ...
  return {
    ...
    resultsViewScope:
      ...
      'platform-only',
    reportHealth:
      (scanScope === null || scanScope === void 0 ? void 0 : scanScope.reportHealth) ||
      'platform-scoped',
...
function buildFileReductionHygieneSummary(report, options = {}) {
  ...
  const unusedScanned =
    (_h =
      (_e =
        (_d = (_c = report.scanners) === null || _c === void 0 ? void 0 : _c['unused-files']) ===
          null || _d === void 0
          ? void 0
  ...
  const entryPoints =
    (_p =
      (_l =
        (_k = (_j = report.metadata) === null || _j === void 0 ? void 0 : _j.entryPoints) ===
          null || _k === void 0
          ? void 0
          : _k.length) !== null && _l !== void 0
        ? _l
        : (_o = (_m = report.scanners) === null || _m === void 0 ? void 0 : _m['unused-files']) ===
              null || _o === void 0
          ? void 0
  ...
  return {
    ...
    safeToDeleteBytes:
      (_w =
        (_t =
          (_s = (_r = report.fileReductionPlan) === null || _r === void 0 ? void 0 : _r.totals) ===
            null || _s === void 0
            ? void 0
    ...
    duplicateAssetBytes:
      (_2 =
        (_z =
          (_y = (_x = report.fileReductionPlan) === null || _x === void 0 ? void 0 : _x.totals) ===
            null || _y === void 0
            ? void 0
    ...
    unusedFileCandidates:
      (_4 = (_3 = report.summary) === null || _3 === void 0 ? void 0 : _3.unusedFileCandidates) !==
        null && _4 !== void 0
        ? _4
        : 0,
    ...
    assetFilesScanned:
      (_7 =
        (_6 =
          (_5 = report.scanners) === null || _5 === void 0 ? void 0 : _5['asset-consolidation']) ===
          null || _6 === void 0
          ? void 0
    ...
    ...(gateProfile ? { gateRuleBundleProfile: gateProfile } : {}),
    ...(gateReport.jestBaselineChecked === false ||
    ((_8 = report.hygieneSummary) === null || _8 === void 0 ? void 0 : _8.jestBaselineChecked) ===
      false
      ? { jestBaselineChecked: false }
      : {}),
    attestationNote:
...
function enrichProductFileReductionScanScope(scanScope, report, options = {}) {
  ...
  return {
    ...
    securityHandoffEligible: false,
    fileReductionNote:
      (scanScope === null || scanScope === void 0 ? void 0 : scanScope.fileReductionNote) ||
...
function buildProductFileReductionExportNotes(report, options = {}) {
  ...
  const assetScanned =
    (_c = (_b = report.scanners) === null || _b === void 0 ? void 0 : _b['asset-consolidation']) ===
      null || _c === void 0
      ? void 0
  ...
  const safeBytes =
    (_f =
      (_e = (_d = report.fileReductionPlan) === null || _d === void 0 ? void 0 : _d.totals) ===
        null || _e === void 0
        ? void 0
      ...
      : 0;
  const shells =
    ((_h = (_g = report.fileReductionPlan) === null || _g === void 0 ? void 0 : _g.safeToDelete) ===
      null || _h === void 0
      ? void 0
      : _h.topDirectories) || [];
  ...
  const unused =
    (_k = (_j = report.summary) === null || _j === void 0 ? void 0 : _j.unusedFileCandidates) !==
      null && _k !== void 0
      ? _k
      : 0;
  if (unused > 0) {
  ...
  const dupBytes =
    (_r =
      (_o =
        (_m = (_l = report.fileReductionPlan) === null || _l === void 0 ? void 0 : _l.totals) ===
          null || _m === void 0
          ? void 0
  ...
  const reviewBytes =
    (_u =
      (_t = (_s = report.fileReductionPlan) === null || _s === void 0 ? void 0 : _s.totals) ===
        null || _t === void 0
        ? void 0
  ...
  if (
    ((_v = report.summary) === null || _v === void 0 ? void 0 : _v.estimatedReductionPct) != null
  ) {
    notes.push(
  ...
  const unusedScanned =
    (_1 =
      (_y =
        (_x = (_w = report.scanners) === null || _w === void 0 ? void 0 : _w['unused-files']) ===
          null || _x === void 0
          ? void 0
      ...
      : null;
  const workspaceFiles =
    (_3 = (_2 = report.inventory) === null || _2 === void 0 ? void 0 : _2.totalFiles) !== null &&
    _3 !== void 0
      ? _3
      : null;
  ...
  if (
    ((_11 = (_10 = report.summary) === null || _10 === void 0 ? void 0 : _10.totalFindings) !==
      null && _11 !== void 0
      ? _11
      : 0) === 0 &&
...
function sanitizeFileReductionPlanForProduct(plan) {
  ...
  if (
    (_b = (_a = plan.duplicateAssets) === null || _a === void 0 ? void 0 : _a.topGroups) === null ||
    _b === void 0
      ? void 0
      : _b.length
  ) {
  ...
  const safeBytes =
    (_d = (_c = plan.totals) === null || _c === void 0 ? void 0 : _c.safeToDeleteBytes) !== null &&
    _d !== void 0
      ? _d
      : 0;
  const hasZeroByteShell = (
    ((_e = plan.safeToDelete) === null || _e === void 0 ? void 0 : _e.topDirectories) || []
  ).some((entry) => {
    var _a;
    return (
  ...
  if (
    ...
    next.hygieneSummary = {
      safeToDeleteBytes: 0,
      duplicateAssetBytes:
        (_g = (_f = plan.totals) === null || _f === void 0 ? void 0 : _f.duplicateAssetBytes) !==
          null && _g !== void 0
          ? _g
          : 0,
...
function enrichProductFileReductionExecutiveSummary(executiveSummary, _report) {
  ...
  const safeArtifacts = (
    ((_a = _report === null || _report === void 0 ? void 0 : _report.findings) === null ||
    _a === void 0
      ? void 0
      : _a.buildArtifacts) || []
  ).filter(
...
function resolveDataQualityStatus(report) {
  ...
  const total =
    (_b = (_a = report.summary) === null || _a === void 0 ? void 0 : _a.totalFindings) !== null &&
    _b !== void 0
      ? _b
      : 0;
  const critical =
    (_e =
      (_d = (_c = report.aggregation) === null || _c === void 0 ? void 0 : _c.bySeverity) ===
        null || _d === void 0
        ? void 0
  ...
  const high =
    (_h =
      (_g = (_f = report.aggregation) === null || _f === void 0 ? void 0 : _f.bySeverity) ===
        null || _g === void 0
        ? void 0
...
function buildProductDataQualityExportNotes(report, options = {}) {
  ...
  const sourceScanned =
    (_c =
      (_b = report.scanners) === null || _b === void 0 ? void 0 : _b['data-access-patterns']) ===
      null || _c === void 0
      ? void 0
  ...
  const lineageSamples =
    (_g =
      (_f = (_e = report.scanners) === null || _e === void 0 ? void 0 : _e['data-lineage']) ===
        null || _f === void 0
        ? void 0
        : _f.dataFilesTracked) !== null && _g !== void 0
      ? _g
      : (_j = (_h = report.metadata) === null || _h === void 0 ? void 0 : _h.dataLineage) ===
            null || _j === void 0
        ? void 0
        : _j.length;
  if (
  ...
  const packageJsonFiles =
    (_m =
      (_l = (_k = report.scanners) === null || _k === void 0 ? void 0 : _k['dependency-health']) ===
        null || _l === void 0
        ? void 0
        : _l.packageJsonFiles) !== null && _m !== void 0
      ? _m
      : (_p =
            (_o = report.scanners) === null || _o === void 0 ? void 0 : _o['config-management']) ===
            null || _p === void 0
        ? void 0
        : _p.packageJsonFiles;
    ...
    (_v =
      (_s =
        ...
        : (_u =
          ...
          ? void 0
          : _u.filter((f) => f.type === 'missing-env-key').length) !== null && _v !== void 0
      ? _v
      : 0;
  const syncIo =
    (_1 =
      (_y =
        ...
        ? _y
        : (_0 =
              (_z = report.findings) === null || _z === void 0 ? void 0 : _z.dataAccessPatterns) ===
              null || _0 === void 0
          ? void 0
  ...
  if (
    ((_2 = report.summary) === null || _2 === void 0 ? void 0 : _2.estimatedReductionPct) != null
  ) {
    notes.push(
  ...
  const mirrorExcluded =
    (_4 =
      (_3 = report.metadata) === null || _3 === void 0 ? void 0 : _3.mirrorConsumersExcluded) !==
      null && _4 !== void 0
      ? _4
      : 0;
  if (mirrorExcluded > 0) {
    ...
    const mirrorConsumers = (
      ((_5 = report.metadata) === null || _5 === void 0 ? void 0 : _5.dataLineage) || []
  ...
  if (
    gateReport.jestBaselineChecked === false ||
    ((_6 = report.hygieneSummary) === null || _6 === void 0 ? void 0 : _6.jestBaselineChecked) ===
      false
  ) {
    notes.push(
  ...
  if (
    ((_8 = (_7 = report.summary) === null || _7 === void 0 ? void 0 : _7.totalFindings) !== null &&
    _8 !== void 0
      ? _8
      : 0) === 0
  ) {
  ...
  const envKeys =
    (_11 =
      (_10 =
        (_9 = report.scanners) === null || _9 === void 0 ? void 0 : _9['environment-variables']) ===
        null || _10 === void 0
        ? void 0
...
function fixEstimatedReductionPct(summary, inventory) {
  ...
  return {
    ...
    estimatedReductionPct:
      Math.round(((summary.totalFindings || 0) / inventory.totalFiles) * 1000) / 10,
  };
}
/**
...
function repairCompactAssetFindings(report) {
  ...
  const topGroups =
    ((_b =
      (_a = report.fileReductionPlan) === null || _a === void 0 ? void 0 : _a.duplicateAssets) ===
      null || _b === void 0
      ? void 0
      : _b.topGroups) || [];
   ...
   */
  const repaired = (
    ((_c = report.findings) === null || _c === void 0 ? void 0 : _c.assetConsolidation) || []
  ).map((finding, index) => {
    const group =
      topGroups[index] || topGroups.find((g) => g.reclaimableBytes === finding.reclaimableBytes);
...
export function sanitizeDataCleanupReportExport(report, options = {}) {
  ...
  if (profile === 'file-reduction' && next.fileReductionPlan && !benchmarkScan) {
    ...
    if (
      ((_b = (_a = next.findings) === null || _a === void 0 ? void 0 : _a.assetConsolidation) ===
        null || _b === void 0
        ? void 0
        : _b.length) &&
      ((_d =
  ...
  if (benchmarkScan) {
    next.exportNotes = [...(next.exportNotes || []), benchmarkExportNote(profile)].filter(
      (note, index, all) => all.indexOf(note) === index
    );
  } else {
    if (
      profile === 'data-quality' &&
      ((_f = (_e = next.metadata) === null || _e === void 0 ? void 0 : _e.dataLineage) === null ||
      _f === void 0
        ? void 0
        : _f.length)
    ) {
      const { dataLineage, mirrorConsumersExcluded } = sanitizeDataLineageForExport(
        next.metadata.dataLineage
      );
      next = {
        ...next,
        metadata: {
        ...
        profile === 'data-quality'
          ? enrichProductDataQualityScanScope(
              {
                ...
                reportHealth:
                  ((_h = next.scanScope) === null || _h === void 0 ? void 0 : _h.reportHealth) ||
                  'platform-scoped',
                securityHandoffEligible: false,
                dataQualityNote:
          ...
          : profile === 'file-reduction'
            ? enrichProductFileReductionScanScope(
                {
                  ...
                  reportHealth:
                    ((_k = next.scanScope) === null || _k === void 0 ? void 0 : _k.reportHealth) ||
                    'platform-scoped',
                  securityHandoffEligible: false,
                  fileReductionNote:
                    'File-reduction export — reclaim tiers are guidance only, not vendor handoff clearance.',
            ...
            : {
                ...
                reportHealth:
                  ((_m = next.scanScope) === null || _m === void 0 ? void 0 : _m.reportHealth) ||
                  'platform-scoped',
                securityHandoffEligible: false,
              },
      ...(profile === 'data-quality'
    ...
    if (profile === 'data-quality' && next.executiveSummary) {
      next.executiveSummary = {
        ...
        remediationHint:
          ((_p = (_o = next.summary) === null || _o === void 0 ? void 0 : _o.totalFindings) !==
            null && _p !== void 0
            ? _p
            : 0) > 0
