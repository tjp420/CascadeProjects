...
function summarizeGateReport(report) {
  ...
  return {
    ...
    productionLeakFindings:
      (_h = report.productionLeakFindings) !== null && _h !== void 0 ? _h : null,
  };
}
/**
 * Summarize baseline.
...
function buildScanSnapshot(report, baseline, dashboardHome) {
  ...
  return {
    ...
    mockSampleFiles:
      (_b = (_a = metrics.mockSampleFiles) !== null && _a !== void 0 ? _a : report.totalFiles) !==
        null && _b !== void 0
        ? _b
        : null,
...
export function buildTrustPageExport(trustData) {
  return {
    ...
    publishedAt:
      (trustData === null || trustData === void 0 ? void 0 : trustData.publishedAt) || null,
