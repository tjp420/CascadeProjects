...
export function extractRoadmapFileMetrics(payload) {
  ...
  const sourceMetrics =
    (_b = root.strategicInsights) === null || _b === void 0 ? void 0 : _b.sourceMetrics;
  const totalFiles =
    (_d =
      (_c = structure === null || structure === void 0 ? void 0 : structure.totalFiles) !== null &&
      _c !== void 0
        ? _c
  ...
  const codeFiles =
    (_f =
      (_e = structure === null || structure === void 0 ? void 0 : structure.codeFiles) !== null &&
      _e !== void 0
        ? _e
        : sourceMetrics === null || sourceMetrics === void 0
          ? void 0
  ...
  const apiRoutes =
    (_j =
      (_h = (_g = root.aiIntegration) === null || _g === void 0 ? void 0 : _g.apiRouteCount) !==
        null && _h !== void 0
        ? _h
        : sourceMetrics === null || sourceMetrics === void 0
          ? void 0
      ...
      : null;
  const generatedAt =
    (_l = (_k = root.generatedAt) !== null && _k !== void 0 ? _k : root.timestamp) !== null &&
    _l !== void 0
      ? _l
      : null;
...
function resolveScopeContext(context = {}) {
    ...
    if (lastResult.kind === 'complete') {
      const step =
        (_a = lastResult.steps) === null || _a === void 0
          ? void 0
          : _a.find((s) => s.id === 'roadmap');
      return extractRoadmapFileMetrics(step === null || step === void 0 ? void 0 : step.data);
    }
    return null;
  })();
  const scanPaths =
    Array.isArray(report === null || report === void 0 ? void 0 : report.scanPaths) &&
    report.scanPaths.length
      ? report.scanPaths
      : Array.isArray(config === null || config === void 0 ? void 0 : config.scanPaths) &&
          config.scanPaths.length
        ? config.scanPaths
        : DEFAULT_SCAN_PATHS;
  const productionPaths = (
    (_a = scope.productionPaths) === null || _a === void 0 ? void 0 : _a.length
  )
    ? scope.productionPaths
    : (
          (_b = config === null || config === void 0 ? void 0 : config.productionPaths) === null ||
          _b === void 0
            ? void 0
            : _b.length
        )
  ...
  const sourceCodeScanPaths = (
    (_c = scope.sourceCodeScanPaths) === null || _c === void 0 ? void 0 : _c.length
  )
    ? scope.sourceCodeScanPaths
    : (
          (_d = config === null || config === void 0 ? void 0 : config.sourceCodeScanPaths) ===
            null || _d === void 0
            ? void 0
            : _d.length
        )
  ...
  return {
    ...
    profile:
      scope.profile ||
      (config === null || config === void 0 ? void 0 : config.profile) ||
      'standard',
    ...
    benchmarkScan: Boolean(
      ...
      isBenchmarkCachePath(projectPath)
    ),
    counts: {
      repositoryFiles:
        (_f =
      ...
      const sections = [
        {
          ...
          paths: ['**/* (project tree)'],
          count:
            (_a = live === null || live === void 0 ? void 0 : live.totalFiles) !== null &&
            _a !== void 0
              ? _a
