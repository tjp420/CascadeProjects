...
export function resolveGateResult(bundle = {}) {
  ...
  return (_d =
    (_c = assessment === null || assessment === void 0 ? void 0 : assessment.executiveSummary) ===
      null || _c === void 0
      ? void 0
...
function shouldReconcileScanRulesFromEmbedded(bundle = {}) {
  ...
  if (
    ...
    !((_b = (_a = bundle.compliance) === null || _a === void 0 ? void 0 : _a.rules) === null ||
    _b === void 0
      ? void 0
      : _b.length)
  )
...
function reconcileComplianceForLiveGate(compliance, bundle = {}) {
  var _a, _b, _c, _d, _e, _f;
  if (
    !((_a = compliance === null || compliance === void 0 ? void 0 : compliance.rules) === null ||
    _a === void 0
      ? void 0
      : _a.length)
  )
  ...
  const score = scored
    ...
    : (_c = (_b = compliance.summary) === null || _b === void 0 ? void 0 : _b.score) !== null &&
        _c !== void 0
      ? _c
      : null;
  return {
...
function dedupeAssessmentFindings(assessment) {
  ...
  if (
    !((_b =
      (_a = assessment === null || assessment === void 0 ? void 0 : assessment.findings) === null ||
      _a === void 0
        ? void 0
...
function resolveSprintGateResult(bundle = {}, assessment = {}) {
  ...
  if (
    (_a = assessment === null || assessment === void 0 ? void 0 : assessment.executiveSummary) ===
      null || _a === void 0
      ? void 0
      : _a.sprintGateResult
  ) {
  ...
  if (
    ((_c = (_b = bundle.sprintReport) === null || _b === void 0 ? void 0 : _b.gate) === null ||
    _c === void 0
      ? void 0
      : _c.pass) === false
  )
    return 'FAIL';
  if (
    ((_e = (_d = bundle.sprintReport) === null || _d === void 0 ? void 0 : _d.gate) === null ||
    _e === void 0
      ? void 0
      : _e.pass) === true
  )
    return 'PASS';
  if (
    ((_f = assessment === null || assessment === void 0 ? void 0 : assessment.executiveSummary) ===
      null || _f === void 0
      ? void 0
      : _f.gateResultSource) !== 'live-gate-scan'
  ) {
    return (_h =
      (_g = assessment === null || assessment === void 0 ? void 0 : assessment.executiveSummary) ===
        null || _g === void 0
        ? void 0
  ...
  if (freshMetrics.metricsSource === 'live-gate-scan' && next.euAiActSummary) {
    next = {
      ...
      euAiActSummary: {
        ...next.euAiActSummary,
        ...((
          (_a = next.euAiActSummary.documentationFound) === null || _a === void 0
            ? void 0
            : _a.length
        )
...
function resolveFreshEuAiActMetrics(bundle = {}) {
  ...
  const docs =
    source.documentationFound || sprintEu.documentationFound || embeddedEu.documentationFound || [];
  const operatorCount =
  ...
  return {
    ...
    euAiActScanned: preferEmbedded
      ...
      : (_p =
            (_m =
              (_l =
                (_k =
                  assessment === null || assessment === void 0 ? void 0 : assessment.findings) ===
                  null || _k === void 0
                  ? void 0
    ...
    simplebeaconDocumentationArtifacts:
      docs.filter((doc) => String(doc).startsWith('.simplebeacon/')).length || null,
    ...
    ...(sourceReport
      ? {
          sourceReport: {
            ...
            duplicateGroups:
              (_c = sourceReport.duplicateGroups) !== null && _c !== void 0 ? _c : null,
          },
        }
      : {}),
  };
...
function sanitizeEmbeddedMainReportExport(embedded, projectLabel) {
  ...
  return {
    ...
    productionLeakFindings:
      (_h = embedded.productionLeakFindings) !== null && _h !== void 0 ? _h : null,
    productionLeakScanned:
      (_j = embedded.productionLeakScanned) !== null && _j !== void 0 ? _j : null,
...
export function buildEuAiActSummary(bundle = {}) {
  ...
  const mainReportGatePass =
    (_a = embedded === null || embedded === void 0 ? void 0 : embedded.gatePass) !== null &&
    _a !== void 0
      ? _a
      : null;
  ...
  return {
    ...
    readinessScore:
      (_e = (_d = summary.score) !== null && _d !== void 0 ? _d : summary.complianceScore) !==
        null && _e !== void 0
        ? _e
        : null,
    checklistHeadline:
    ...
    checklistReconciledFrom:
      (_h =
        compliance === null || compliance === void 0 ? void 0 : compliance.gateReconciledFrom) !==
        null && _h !== void 0
        ? _h
        : null,
    gateResult,
    ...
    evaluatedAt:
      (_l =
        (_k =
          (_j = compliance === null || compliance === void 0 ? void 0 : compliance.evaluatedAt) !==
            null && _j !== void 0
            ? _j
    ...
    mainReportGeneratedAt:
      (_m = embedded === null || embedded === void 0 ? void 0 : embedded.generatedAt) !== null &&
      _m !== void 0
        ? _m
        : null,
    projectRoot: redactProjectPathForExport(
      (_r =
        (_p =
          (_o = compliance === null || compliance === void 0 ? void 0 : compliance.projectRoot) !==
            null && _o !== void 0
            ? _o
            : assessment === null || assessment === void 0
              ? void 0
    ...
    ...((
      (_s = assessment === null || assessment === void 0 ? void 0 : assessment.executiveSummary) ===
        null || _s === void 0
        ? void 0
...
export function buildEuAiActExportBundle(bundle = {}) {
  ...
  const exportNotes = dedupeExportNotes([
    ...
    ((_b = (_a = exportEligibility.errors) === null || _a === void 0 ? void 0 : _a[0]) === null ||
    _b === void 0
      ? void 0
      : _b.message)
...
function buildSprintArtifactExportNotes(sprint = {}, options = {}) {
  ...
  if (
    ((_b = (_a = sprint.complianceChecklist) === null || _a === void 0 ? void 0 : _a.summary) ===
      null || _b === void 0
      ? void 0
  ...
  const sprintRepo =
    (_g =
      (_d = (_c = sprint.report) === null || _c === void 0 ? void 0 : _c.repositoryFilesTotal) !==
        null && _d !== void 0
        ? _d
        : (_f =
              (_e = sprint.report) === null || _e === void 0 ? void 0 : _e.repositoryInventory) ===
              null || _f === void 0
          ? void 0
  ...
  const ruleScoped =
    (_m =
      (_j =
        (_h = sprint.report) === null || _h === void 0 ? void 0 : _h.ruleScopedFilesAnalyzed) !==
        null && _j !== void 0
        ? _j
  ...
  const sprintProfile =
    (_q =
      (_p = (_o = sprint.report) === null || _o === void 0 ? void 0 : _o.scanScope) === null ||
      _p === void 0
        ? void 0
  ...
  const sprintFiction =
    (_s = (_r = sprint.report) === null || _r === void 0 ? void 0 : _r.fictionJsonFilesScanned) !==
      null && _s !== void 0
      ? _s
      : (_u = (_t = sprint.report) === null || _t === void 0 ? void 0 : _t.scanScope) === null ||
          _u === void 0
        ? void 0
  ...
  const nonDocs =
    (_w = (_v = sprint.report) === null || _v === void 0 ? void 0 : _v.euAiActSummary) === null ||
    _w === void 0
      ? void 0
  ...
  const suppressed =
    (_x = sprint.report) === null || _x === void 0 ? void 0 : _x.productionLeakSuppressedIntent;
  if (
    suppressed != null &&
    suppressed > 0 &&
    ((_z = (_y = sprint.report) === null || _y === void 0 ? void 0 : _y.productionLeakFindings) !==
      null && _z !== void 0
      ? _z
      : 0) === 0
  ) {
  ...
  if (
    (_1 = (_0 = sprint.assessment) === null || _0 === void 0 ? void 0 : _0.pilotProposal) ===
      null || _1 === void 0
      ? void 0
      : _1.pricePlaceholder
  ) {
  ...
  if (
    ...
    ((_3 = sprint.complianceChecklist) === null || _3 === void 0 ? void 0 : _3.complianceStatus) ===
      'failed'
  ) {
    const failedIds = (
      ((_4 = sprint.complianceChecklist) === null || _4 === void 0 ? void 0 : _4.rules) || []
    )
...
function buildSprintArtifactHygieneSummary(sprint = {}, options = {}) {
  var _a,
    ...
    _25;
  const checklist =
    ((_a = sprint.complianceChecklist) === null || _a === void 0 ? void 0 : _a.summary) || {};
  const gateContext = resolveSprintGateContext(sprint, options);
  const {
    repositoryFilesTotal: gateTotal,
    credentialScanned,
  ...
  const sprintRepo =
    (_f =
      (_c = (_b = sprint.report) === null || _b === void 0 ? void 0 : _b.repositoryFilesTotal) !==
        null && _c !== void 0
        ? _c
        : (_e =
              (_d = sprint.report) === null || _d === void 0 ? void 0 : _d.repositoryInventory) ===
              null || _e === void 0
          ? void 0
  ...
  const ruleScoped =
    (_l =
      (_h =
        (_g = sprint.report) === null || _g === void 0 ? void 0 : _g.ruleScopedFilesAnalyzed) !==
        null && _h !== void 0
        ? _h
  ...
  const sprintFiction =
    (_r =
      (_o =
        (_m = sprint.report) === null || _m === void 0 ? void 0 : _m.fictionJsonFilesScanned) !==
        null && _o !== void 0
        ? _o
  ...
  const jestChecked =
    (_w =
      (_u =
        (_t = (_s = sprint.report) === null || _s === void 0 ? void 0 : _s.jestBaselineChecked) !==
          null && _t !== void 0
          ? _t
  ...
  return {
    ...
    operatorDocumentationCount:
      (_14 =
        (_11 = checklist.operatorDocumentationCount) !== null && _11 !== void 0
          ? _11
          : (_13 =
                (_12 = sprint.report) === null || _12 === void 0 ? void 0 : _12.euAiActSummary) ===
                null || _13 === void 0
            ? void 0
    ...
    euAiActScanned:
      (_19 =
        (_16 = (_15 = sprint.report) === null || _15 === void 0 ? void 0 : _15.euAiActScanned) !==
          null && _16 !== void 0
          ? _16
          : (_18 = (_17 = sprint.report) === null || _17 === void 0 ? void 0 : _17.scanScope) ===
                null || _18 === void 0
            ? void 0
    ...
    scanMatchedNonDocsCount:
      (_22 =
        (_21 = (_20 = sprint.report) === null || _20 === void 0 ? void 0 : _20.euAiActSummary) ===
          null || _21 === void 0
          ? void 0
    ...
    legalHandoffEligible:
      (_25 = checklist.legalHandoffEligible) !== null && _25 !== void 0 ? _25 : null,
...
export function sanitizeEuAiActSprintArtifactExport(sprint, options = {}) {
  ...
  if (
    ((_f = (_e = sprint.complianceChecklist) === null || _e === void 0 ? void 0 : _e.summary) ===
      null || _f === void 0
      ? void 0
...
export function sanitizeEuAiActExport(bundle) {
  ...
  if (bundle.type === 'simplebeacon-eu-ai-act-export') {
    return buildEuAiActExportBundle({
      hasData:
        (_b = (_a = bundle.summary) === null || _a === void 0 ? void 0 : _a.hasData) !== null &&
        _b !== void 0
          ? _b
          : true,
