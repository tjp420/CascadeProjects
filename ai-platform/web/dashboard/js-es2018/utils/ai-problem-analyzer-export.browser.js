...
function enrichTopPriorityIssuesForExport(issues = [], analyzerResults = []) {
  ...
  return issues.map((issue) => {
    ...
    const metricScore =
      (_c =
        result === null || result === void 0 ? void 0 : result.metricScore) !==
        null && _c !== void 0
        ? _c
        : null;
    const scoringDirection =
      (_d =
        result === null || result === void 0
          ? void 0
          : result.scoringDirection) !== null && _d !== void 0
        ? _d
        : null;
    return {
      ...issue,
...
function slimArchitectureForExport(architecture, summary = null) {
  ...
  if (
    ...
    ((_a =
      summary === null || summary === void 0 ? void 0 : summary.stubCount) !==
      null && _a !== void 0
      ? _a
      : 0) === 0
  ) {
...
function buildHygieneSummary(summary, riskSummary, healthScore) {
  ...
  const execution =
    (riskSummary === null || riskSummary === void 0
      ? void 0
      : riskSummary.executionStatus) || {};
  return {
    selectedAnalyzerCount:
      (_a =
        summary === null || summary === void 0
          ? void 0
          : summary.selectedIssueCount) !== null && _a !== void 0
        ? _a
        : null,
    measuredCount:
      (_c =
    ...
    insufficientDataCount:
      (_d = execution.insufficientData) !== null && _d !== void 0 ? _d : null,
    peakSeverity:
      (_e =
        riskSummary === null || riskSummary === void 0
          ? void 0
          : riskSummary.peakSeverity) !== null && _e !== void 0
        ? _e
        : null,
    overallRiskLevel:
      (_f =
        riskSummary === null || riskSummary === void 0
          ? void 0
          : riskSummary.overallRiskLevel) !== null && _f !== void 0
        ? _f
        : null,
    healthScore:
      healthScore !== null && healthScore !== void 0 ? healthScore : null,
    attestationNote:
...
function buildExportNotes(analysisResult, options = {}) {
  ...
  if (
    (_a = options.context) === null || _a === void 0 ? void 0 : _a.inputKind
  ) {
  ...
  const healthScore =
    (_b = options.context) === null || _b === void 0 ? void 0 : _b.healthScore;
  if (hasPeakRisk) {
...
function buildSlimPayload(sanitized, summary) {
  ...
  return {
    ...
    registrySummary: {
      catalogSize:
        (_d =
          (_c = source.registry) === null || _c === void 0
            ? void 0
      ...
      implementedInRun:
        (_e =
          summary === null || summary === void 0
            ? void 0
            : summary.implementedCount) !== null && _e !== void 0
          ? _e
          : null,
      stubsInRun:
        (_f =
          summary === null || summary === void 0
            ? void 0
            : summary.stubCount) !== null && _f !== void 0
          ? _f
          : 0,
...
function resolveSelectedIssueIds(sanitized) {
  ...
  const fromPayload =
    (_a = sanitized.payload) === null || _a === void 0
      ? void 0
      : _a.selectedIssueIds;
  if (Array.isArray(fromPayload) && fromPayload.length) return fromPayload;
  const fromArch =
    (_c =
      (_b = sanitized.architecture) === null || _b === void 0
        ? void 0
        : _b.dataCollectionLayer) === null || _c === void 0
      ? void 0
      : _c.selectedIssueIds;
...
export function sanitizeAiProblemAnalyzerExport(analysisResult, options = {}) {
  ...
  const projectLabel = projectLabelFromPath(
    options.projectPath ||
      ((_b =
        (_a = options.context) === null || _a === void 0
          ? void 0
  ...
  const benchmarkScan = isBenchmarkPath(
    options.projectPath ||
      ((_d =
        (_c = options.context) === null || _c === void 0
          ? void 0
  ...
  const healthScore =
    (_k =
      (_j =
        (_f =
          (_e = options.context) === null || _e === void 0
            ? void 0
            : _e.healthScore) !== null && _f !== void 0
          ? _f
          : (_h =
                (_g = options.context) === null || _g === void 0
                  ? void 0
                  : _g.report) === null || _h === void 0
            ? void 0
  ...
  const analysisGeneratedAt =
    ((_l = options.context) === null || _l === void 0
      ? void 0
      : _l.analysisGeneratedAt) ||
    sanitized.analysisGeneratedAt ||
    sanitized.generatedAt ||
    ((_o =
      (_m = options.context) === null || _m === void 0 ? void 0 : _m.report) ===
      null || _o === void 0
      ? void 0
  ...
  return {
    ...
    inputKind:
      ((_p = options.context) === null || _p === void 0
        ? void 0
        : _p.inputKind) ||
      sanitized.inputKind ||
      null,
    scannedAt:
      ((_q = options.context) === null || _q === void 0
        ? void 0
        : _q.scannedAt) ||
      ((_s =
        (_r = options.context) === null || _r === void 0
          ? void 0
          : _r.report) === null || _s === void 0
        ? void 0
        : _s.generatedAt) ||
      sanitized.scannedAt ||
      null,
