...
function normalizeAssessmentTitle(assessment, projectLabel) {
  const raw = String(
    (assessment === null || assessment === void 0 ? void 0 : assessment.title) || ''
  );
...
function buildAssessmentExportNotes(assessment, _projectLabel) {
  ...
  const checklist =
    ((_a = assessment.complianceChecklist) === null || _a === void 0 ? void 0 : _a.summary) || {};
...
function reconcileComplianceReady(executiveSummary, checklist, sourceReport) {
  ...
  ).some((r) => ['GATE-001', 'CRED-001', 'LEAK-001'].includes(r.id) && r.status === 'skip');
  const gatePass = Boolean(
    (_g = (_f = sourceReport.gate) === null || _f === void 0 ? void 0 : _f.pass) !== null &&
      _g !== void 0
      ? _g
...
function reconcileExecutiveSummary(assessment, sourceReport) {
  ...
  exec.complianceScore =
    (_c =
      (_b = (_a = checklist.summary) === null || _a === void 0 ? void 0 : _a.score) !== null &&
      _b !== void 0
        ? _b
...
export function sanitizeAssessmentExport(assessment, options = {}) {
  ...
  if (sourceReport) {
    ...
    executiveSummary = {
        ...
        (_l =
          (_k =
            (_h = sourceReport.repositoryFilesTotal) !== null && _h !== void 0
              ? _h
              : (_j = sourceReport.repositoryInventory) === null || _j === void 0
                ? void 0
          ...
          ? _l
          : null,
      gateResult: ((_m = sourceReport.gate) === null || _m === void 0 ? void 0 : _m.pass)
        ? 'PASS'
        : 'FAIL',
      blockingCount:
        (_q =
      ...
      warningCount:
        (_t =
          (_s = (_r = sourceReport.gate) === null || _r === void 0 ? void 0 : _r.warningCount) !==
            null && _s !== void 0
            ? _s
  ...
  const sanitizedSource = embeddedSource
    ? {
        ...
        duplicateGroups:
          (_y = embeddedSource.duplicateGroups) !== null && _y !== void 0 ? _y : null,
      }
    : undefined;
  return {
    ...rest,
    ...
    hygieneSummary: {
      ...
      complianceScore:
        (_0 = executiveSummary.complianceScore) !== null && _0 !== void 0 ? _0 : null,
      complianceReady:
        (_1 = executiveSummary.complianceReady) !== null && _1 !== void 0 ? _1 : false,
      filesScanned: (_2 = executiveSummary.filesScanned) !== null && _2 !== void 0 ? _2 : null,
      mockSampleFiles:
        (_3 = executiveSummary.mockSampleFiles) !== null && _3 !== void 0 ? _3 : null,
      benchmarkScan,
