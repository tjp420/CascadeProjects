...
export class ToolsView {
  ...
  render() {
    ...
    (_b = el.querySelector("#run-consolidation-btn")) === null || _b === void 0
      ? void 0
      : _b.addEventListener("click", () => this.runConsolidationScan());
    return el;
  }
  bindActions(el) {
  ...
  setOutput(el, html, visible = true) {
    ...
    const output =
      el === null || el === void 0 ? void 0 : el.querySelector("#tool-output");
    if (!output) return;
  ...
  async runAction(action, el) {
    ...
    try {
      ...
      if (action === "baseline") {
        ...
        const label =
          ((_a = data.baseline) === null || _a === void 0
            ? void 0
            : _a.jestTestsLabel) ||
          ((_b = this.app.state.baseline) === null || _b === void 0
            ? void 0
            : _b.jestTestsLabel) ||
          "OK";
        this.setOutput(
  ...
  renderConsolidation() {
    ...
    return renderConsolidationPanel({
      ...
      error:
        (_a = this.reductionScan) === null || _a === void 0 ? void 0 : _a.error,
    });
  }
