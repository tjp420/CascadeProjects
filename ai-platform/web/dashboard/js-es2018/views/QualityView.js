...
import {
  buildQualityExportBundle,
  qualityExportFilename,
} from "../utils/quality-export.browser.js?v=20260716cachefix1";
...
function resolveCoverageSnapshot(coverage, baseline, dashboardHome) {
  ...
  const passed =
    (_b =
      (_a = merged.passedTests) !== null && _a !== void 0
        ? _a
        : baseline === null || baseline === void 0
          ? void 0
          : baseline.jestTestsPassing) !== null && _b !== void 0
      ? _b
      : (_c =
            dashboardHome === null || dashboardHome === void 0
              ? void 0
              : dashboardHome.overview) === null || _c === void 0
        ? void 0
        : _c.passedTests;
  const total =
    (_g =
      (_e =
        (_d = merged.totalTests) !== null && _d !== void 0
          ? _d
          : parseJestTotal(
              baseline === null || baseline === void 0
                ? void 0
        ...
        : (_f =
              dashboardHome === null || dashboardHome === void 0
                ? void 0
                : dashboardHome.overview) === null || _f === void 0
          ? void 0
          : _f.totalTests) !== null && _g !== void 0
      ? _g
      : passed;
...
function coveragePendingMessage(coverage) {
  if (
    ...
    return "";
  return (
    (coverage === null || coverage === void 0 ? void 0 : coverage.notes) ||
...
export class QualityView {
  ...
  render() {
        ...
        (_b =
          (_a =
            auditStats === null || auditStats === void 0
              ? void 0
              : auditStats.vulnerabilityTotal) !== null && _a !== void 0
            ? _a
            : security.npmAuditTotal) !== null && _b !== void 0
          ? _b
          : security.openVulnerabilities) !== null && _c !== void 0
        ? _c
        : "—";
    const engineeringFindings =
      (_d = security.openEngineeringFindings) !== null && _d !== void 0
        ? _d
        : "—";
    ...
    `;
    (_r = el.querySelector("#run-audit-btn")) === null || _r === void 0
      ? void 0
      : _r.addEventListener("click", () => this.runAudit());
    (_r = el.querySelector("#quality-export-json")) === null || _r === void 0
      ? void 0
      : _r.addEventListener("click", () => this.exportQualityData());
    (_s = el.querySelector("#quality-send-ai-btn")) === null || _s === void 0
      ? void 0
      : _s.addEventListener("click", async () => {
          ...
          const payload = {
            projectPath:
              this.app.state.lastProjectPath || window.location.origin,
            reportType: "quality-security",
            reportSummary: {
              lineCoverage:
                (_f =
                  (_e = coverage.overallCoverage) !== null && _e !== void 0
                    ? _e
                    : coverage.lineCoverage) !== null && _f !== void 0
                  ? _f
                  : "N/A",
              branchCoverage:
                (_g = coverage.branchCoverage) !== null && _g !== void 0
                  ? _g
                  : "N/A",
              securityScore:
                (_h = security.securityScore) !== null && _h !== void 0
                  ? _h
                  : "N/A",
              qualityScore:
                (_k =
                  (_j = quality.overallScore) !== null && _j !== void 0
                    ? _j
                    : quality.qualityScore) !== null && _k !== void 0
                  ? _k
                  : "N/A",
              npmVulnerabilities:
                (_l =
                  auditStats === null || auditStats === void 0
                    ? void 0
                    : auditStats.vulnerabilityTotal) !== null && _l !== void 0
                  ? _l
                  : "N/A",
              openEngineeringFindings:
                (_m = security.openEngineeringFindings) !== null &&
                _m !== void 0
                  ? _m
                  : "N/A",
            },
            ...
            notes:
              "Quality & Security — coverage, security checklist, and npm audit",
          };
          ...
          if (vscode) {
            try {
              ...
              window["console"]["warn"](
                "[Quality-AI] vscode.postMessage failed:",
                err,
              );
  ...
  renderAudit(audit) {
    ...
    const vulnerabilities = Array.isArray(rawVulns)
      ? rawVulns
      : rawVulns
        ? Object.values(rawVulns)
        : [];
  ...
  async runAudit() {
    ...
    try {
      this.app.state.npmAudit = await this.app.platformService.refreshNpmAudit({
        force: true,
      });
  ...
  async mount(container) {
    ...
    const needsPlatformData =
      this.app.state.coverage == null || this.app.state.security == null;
    if (needsPlatformData) {
      window.setSafeHTML(
        container,
        '<p class="text-muted card">Loading quality metrics…</p>',
      );
      try {
