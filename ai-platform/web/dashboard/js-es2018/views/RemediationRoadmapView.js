...
function convertPhasesToIssues(phases, summary) {
    ...
    if (Array.isArray(phase.tasks) && phase.tasks.length) {
      for (const task of phase.tasks) {
        issues.push({
          ...
          category:
            (phase.title || '').replace(/^Phase \d+:\s*/, '') || phase.id || phase.phase || 'Phase',
  ...
  return {
    issues,
    exportedAt: (summary === null || summary === void 0 ? void 0 : summary.exportedAt) || null,
  };
}
/**
 * Slugify.
  ...
  bindEvents(el) {
    ...
    if (dropZone) {
      ...
      const handleDrop = (e) => {
        ...
        dropZone.style.background = '';
        const file =
          (_b = (_a = e.dataTransfer) === null || _a === void 0 ? void 0 : _a.files) === null ||
          _b === void 0
            ? void 0
            : _b[0];
        if (!file) return;
    ...
    generateBtn === null || generateBtn === void 0
      ...
      : generateBtn.addEventListener('click', () => {
          const text =
            (jsonInput === null || jsonInput === void 0 ? void 0 : jsonInput.value) || '';
          if (!text.trim()) {
            showToast('Paste JSON data first', 'warning');
            return;
          }
