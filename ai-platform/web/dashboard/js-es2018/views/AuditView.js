...
import {
  ...
  readFileAsJson,
} from "../services/analyzeService.js?v=20260726auditfix1";
...
function renderScanScope(metrics) {
  ...
  if (metrics.mockSampleFiles != null) {
    parts.push(
      `${formatNumber(metrics.mockSampleFiles)} mock/sample files in scan paths`,
    );
  }
  if (metrics.filesAnalyzed != null) {
    parts.push(
      `${formatNumber(metrics.filesAnalyzed)} files analyzed (credentials + leak rules)`,
    );
  }
...
export class AuditView {
  ...
  exportAuditData() {
    ...
    try {
      ...
      window.console.warn(
        "[AuditView] authService.isFreeTier check failed",
        _err,
      );
    }
  ...
  renderLayerCard(key, layer, metrics) {
    ...
    const findings =
      (_b =
        (_a = layer.findings) !== null && _a !== void 0
          ? _a
          : layer.blockingCount) !== null && _b !== void 0
        ? _b
        : "—";
    const scanned =
      (_e =
        (_d =
          (_c = layer.scanned) !== null && _c !== void 0
            ? _c
            : layer.checked) !== null && _d !== void 0
          ? _d
  ...
  render() {
    ...
    if (this.authRequired && !this.audit) {
        ...
        fileInput.addEventListener("change", async (e) => {
          ...
          try {
            ...
            const report =
              ...
              (isSimplebeaconReport(parsed)
                ? normalizeSimplebeaconReport(parsed)
                : null);
            if (!report) {
              showToast(
                "File is not a recognized Simplebeacon report",
                "error",
              );
              return;
            }
            ...
            showToast(
              `Loaded report: ${file.name} — ${report.issueCount || 0} issues`,
              "success",
            );
          } catch (err) {
      ...
      (_a = el.querySelector("#audit-retry")) === null || _a === void 0
        ? void 0
        : _a.addEventListener("click", () => this.reload(el.parentElement), {
            once: true,
          });
      return el;
    }
    if (this.error && !this.audit) {
      el.innerHTML = `
        ...
        ${renderEmptyState({
          ...
          actions: [
            { label: "Retry", id: "audit-retry", className: "btn-primary" },
          ],
        })}
        `;
      (_a = el.querySelector("#audit-retry")) === null || _a === void 0
    ...
    (_d = el.querySelector("#audit-download-assessment")) === null ||
    _d === void 0
      ? void 0
    ...
    (_f = el.querySelector("#audit-send-ai-btn")) === null || _f === void 0
      ...
      : _f.addEventListener("click", async () => {
          ...
          const npmAudit =
            audit === null || audit === void 0 ? void 0 : audit.npmAudit;
          const vulnList = [];
          const rawVulns =
          ...
          const payload = {
            ...
            reportSummary: {
              ...
              qualityScore:
                (_g =
                  report === null || report === void 0
                    ? void 0
                    : report.qualityScore) !== null && _g !== void 0
                  ? _g
                  : "N/A",
              consistencyScore:
                (_j =
              ...
              totalIssues:
                (_k =
                  report === null || report === void 0
                    ? void 0
                    : report.issueCount) !== null && _k !== void 0
                  ? _k
                  : (_m =
                        (_l =
                          report === null || report === void 0
                            ? void 0
                            : report.rawIssues) === null || _l === void 0
                          ? void 0
              ...
              npmAuditVulnerabilities:
                (_p =
                  (_o =
                    npmAudit === null || npmAudit === void 0
                      ? void 0
                      : npmAudit.summary) === null || _o === void 0
                    ? void 0
            ...
            notes:
              "Compliance Audit — perimeter scan, assessment, npm audit layers",
          };
          ...
          if (vscode) {
            try {
              ...
              window["console"]["warn"](
                "[Audit-AI] vscode.postMessage failed:",
                err,
              );
  ...
  scrollToAssessmentSummary() {
    requestAnimationFrame(() => {
      var _a;
      (_a = document.getElementById("audit-assessment-summary")) === null ||
      _a === void 0
        ? void 0
  ...
  async handleAction(action, container) {
    ...
    if (action === "results") {
      ...
      if (!report) {
        ...
        showToast(
          "Gate passed — 0 blocking issues. Sample files are listed on Results.",
          "info",
        );
      } else {
        showToast(
          `Opening ${issueCount} issue group(s) from the latest scan`,
          "success",
        );
      }
      return;
    ...
    try {
      if (action === "scan") {
        ...
        showToast(
          "Assessment complete — summary and checklist updated below",
          "success",
        );
      } else if (action === "npm") {
  ...
  async reload(container, options = {}) {
    ...
    await this.loadAudit({
      force: true,
      includeNpm: Boolean(options.includeNpm),
    });
  }
  ...
  buildAuditFromReport(report) {
    ...
    layers.roadmap = {
      status: "pass",
      findings: 0,
      scanned: r.roadmapSchemaChecked || 0,
    };
    layers.jestBaseline = {
