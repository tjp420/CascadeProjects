...
export class TrustView {
  ...
  render() {
    ...
    const staticHost = Boolean(
      (_b = this.data) === null || _b === void 0 ? void 0 : _b.staticHost,
    );
    const disclaimers =
      (live === null || live === void 0 ? void 0 : live.disclaimers) || [];
    const methodology =
      (live === null || live === void 0 ? void 0 : live.methodology) || [];
    const fictionScope =
      (live === null || live === void 0 ? void 0 : live.fictionScope) || null;
    return `
      ...
      <div class="card mb-4">
        ...
        <div class="card mb-4">
          ...
          ${
            (
              (_e =
                live === null || live === void 0
                  ? void 0
                  : live.repositoryHealth) === null || _e === void 0
                ? void 0
                : _e.headline
            )
              ? renderRepositoryHealthSection(live.repositoryHealth, {
                  compact: true,
                })
