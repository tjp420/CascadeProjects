      ...
      <div class="card">
        ...
        <div class="form-group">
          ...
          <div class="drop-zone" id="upload-drop-zone" style="border:2px dashed var(--border);border-radius:12px;padding:40px 24px;text-align:center;cursor:pointer;transition:border-color 0.2s,background 0.2s;background:var(--bg-input);">
            ...
            <input type="file" id="upload-file-input" accept=".json,application/json" style="display:none;" aria-label="Upload scan report file">
          </div>
  ...
  renderPreview(data, scanMetaEl, previewContentEl) {
    ...
    const quality =
      (_g =
        (_d = data.qualityScore) !== null && _d !== void 0
          ? _d
          : (_f =
                (_e = data.results) === null || _e === void 0
                  ? void 0
                  : _e.simplebeacon) === null || _f === void 0
            ? void 0
    ...
    const files =
      (_m =
        (_k =
          (_j =
            (_h = data.repositoryFilesTotal) !== null && _h !== void 0
              ? _h
              : data.totalFiles) !== null && _j !== void 0
            ? _j
    ...
    const issues =
      (_r =
        (_q =
          (_p =
            (_o = data.issueCount) !== null && _o !== void 0
              ? _o
              : gate.blockingCount) !== null && _p !== void 0
            ? _p
