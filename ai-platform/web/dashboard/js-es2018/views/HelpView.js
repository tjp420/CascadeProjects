...
function renderLiveScanStrip(report, baseline, dashboardHome) {
  ...
  const gateLabel = ((_a = report.gate) === null || _a === void 0 ? void 0 : _a.pass)
    ? 'PASS'
    : 'FAIL';
  const jestLabel =
    (_b = resolveJestTestsLabel(baseline, dashboardHome)) !== null && _b !== void 0 ? _b : '—';
  const pageSpecs =
    (_c = resolvePageSpecsLabel(report, baseline)) !== null && _c !== void 0 ? _c : '—';
  return `
