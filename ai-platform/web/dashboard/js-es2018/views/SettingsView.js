...
export class SettingsView {
  ...
  _removeOrphanSettingsRoots(container) {
    document
      .querySelectorAll('body > .fade-in, .app-shell > .fade-in, .app-body > .fade-in')
      .forEach((el) => {
  ...
  returnVaultToken(index, rerender) {
    ...
    const tHint =
      entry.token.length > 24 ? `${entry.token.slice(0, 8)}…${entry.token.slice(-8)}` : entry.token;
    if (
      !globalThis.confirm(
          ...
          <div class="settings-checkbox-group">
            ${SEVERITIES.map((sev) => {
              ...
              return checkbox(
                'fail',
                sev,
                (_a = config.gate) === null || _a === void 0 ? void 0 : _a.failOn
              );
            }).join('')}
          </div>
        </div>
          ...
          <div class="settings-checkbox-group">
            ${SEVERITIES.map((sev) => {
              ...
              return checkbox(
                'warn',
                sev,
                (_a = config.gate) === null || _a === void 0 ? void 0 : _a.warnOn
              );
            }).join('')}
          </div>
        </div>
  ...
  renderTokenSection() {
    ...
    const hint =
      token && token.length > 24 ? `${token.slice(0, 8)}…${token.slice(-8)}` : token || '—';
  ...
  loadDownloadSettings() {
    ...
    try {
      ...
      return {
        ...
        agency: {
          projectName:
            ((_e = parsed.agency) === null || _e === void 0 ? void 0 : _e.projectName) ||
            'CascadeProjects',
          devAgency:
            ((_f = parsed.agency) === null || _f === void 0 ? void 0 : _f.devAgency) || 'Agency',
          client: ((_g = parsed.agency) === null || _g === void 0 ? void 0 : _g.client) || '',
          milestone:
            ((_h = parsed.agency) === null || _h === void 0 ? void 0 : _h.milestone) || 'Release',
        ...
        executive: {
          ...
          reportId:
            ((_s = parsed.executive) === null || _s === void 0 ? void 0 : _s.reportId) || '',
          summary: ((_t = parsed.executive) === null || _t === void 0 ? void 0 : _t.summary) || '',
          verdict:
            ((_u = parsed.executive) === null || _u === void 0 ? void 0 : _u.verdict) || 'READY',
        },
      };
    } catch (_v) {
  ...
  collectAiKeysPayload(root = this._root) {
    ...
    if (root) {
      for (const field of AI_KEY_FIELDS) {
        ...
        const value =
          ((_a = input === null || input === void 0 ? void 0 : input.value) === null ||
          _a === void 0
            ? void 0
            : _a.trim()) || '';
  ...
  async testOllamaConnection(root, rerender) {
    ...
    try {
      ...
      const picked =
        model || this.displayAiKeys().ollamaModel || String(this.ollamaModels[0]).split(':')[0];
  ...
  async applyProfilePreset(profile, rerender) {
    ...
    try {
      ...
      this.draft = {
        ...
        productionPaths: (
          (_a = preset.productionPaths) === null || _a === void 0 ? void 0 : _a.length
        )
  ...
  buildConfigFromDom(base, rootEl) {
    ...
    if (root) {
      config.sampleDir =
        ((_b =
          (_a = root.querySelector('#settings-sample-dir')) === null || _a === void 0
            ? void 0
            : _a.value) === null || _b === void 0
          ? void 0
          : _b.trim()) || config.sampleDir;
      const scanPaths = textToPaths(
        (_c = root.querySelector('#settings-scan-paths')) === null || _c === void 0
          ? void 0
          : _c.value
      );
      const productionPaths = textToPaths(
        (_d = root.querySelector('#settings-production-paths')) === null || _d === void 0
          ? void 0
          : _d.value
      );
