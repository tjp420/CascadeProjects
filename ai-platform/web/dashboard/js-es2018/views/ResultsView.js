...
export class ResultsView {
  ...
  getFilteredIssues() {
    ...
    const source =
      (_a = report === null || report === void 0 ? void 0 : report.rawIssues) !== null &&
      _a !== void 0
        ? _a
    ...
    let issues = source.map((issue, index) => {
      ...
      return {
        ...
        filePath:
          ...
          ((_d = (_c = issue.metadata) === null || _c === void 0 ? void 0 : _c.duplicatePaths) ===
            null || _d === void 0
            ? void 0
            : _d[0]) ||
  ...
  renderScanSummary(report) {
    ...
    const blockingCount =
      (_b = (_a = report.gate) === null || _a === void 0 ? void 0 : _a.blockingCount) !== null &&
      _b !== void 0
        ? _b
        : 0;
    const gatePass =
      ((_c = report.gate) === null || _c === void 0 ? void 0 : _c.pass) === true &&
      blockingCount === 0;
  ...
  render() {
    ...
    const fromAudit =
      ((_d = this.app.state.routeParams) === null || _d === void 0 ? void 0 : _d.from) === 'audit';
  ...
  bindExport(el, issues) {
    ...
    (_g = el.querySelector('#ai-send-confirm')) === null || _g === void 0
      ...
      : _g.addEventListener('click', async () => {
          ...
          await doSendToAi(
            (aiNotesInput === null || aiNotesInput === void 0 ? void 0 : aiNotesInput.value) || ''
          );
          btn.disabled = false;
  ...
  showDetail(container, issue) {
    ...
    if (issue.filePath) {
      fileRow.appendChild(
        renderIdeFileLink(issue.filePath, issue.line || 1, { projectRoot, label: issue.filePath })
      );
    ...
    if (
      (_c = (_b = issue.metadata) === null || _b === void 0 ? void 0 : _b.duplicatePaths) ===
        null || _c === void 0
        ? void 0
        : _c.length
    ) {
