...
export class ResultsView {
  ...
  render() {
    ...
    el.querySelector("#clear-results-filters")?.addEventListener(
      "click",
      () => {
        this.filterSeverity = "all";
        this.filterCategory = "all";
  ...
  bindExport(el, issues) {
    ...
    el.querySelector("#export-full-btn")?.addEventListener(
      "click",
      async () => {
        try {
    ...
    el.querySelector("#export-filtered-json-btn")?.addEventListener(
      "click",
      () => {
        if (!issues.length) {
    ...
    el.querySelector("#ai-send-confirm")?.addEventListener(
      "click",
      async () => {
