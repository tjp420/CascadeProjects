...
export function bindQuickActions(container, handlers) {
  container
    .querySelector("#action-run-scan")
    ?.addEventListener("click", handlers.onRunScan);
  container
    .querySelector("#action-export")
    ?.addEventListener("click", handlers.onExport);
  container
    .querySelector("#action-send-ai")
    ?.addEventListener("click", handlers.onSendAi || (() => {}));
  container
    .querySelector("#action-legacy")
    ?.addEventListener("click", handlers.onLegacy);
}
