...
function generateDirectorySummaryContent(data, format, _includeCharts) {
    if (format === 'csv') {
...
function generateDirectoryDetailedContent(data, _format, _includeCharts) {
    return `
...
function generateDirectoryMetricsContent(data, _format, _includeCharts) {
    return `
...
function generateDiagnosticsSummaryContent(data, format, _includeCharts) {
    if (format === 'csv') {
...
function generateDiagnosticsDetailedContent(data, _format, _includeCharts) {
    return `
...
function generateDiagnosticsDebugContent(data, _format, _includeCharts) {
    return `
...
function generateDiagnosticsHealthContent(data, _format, _includeCharts) {
    return `
