...
class SchemaDesigner {
    ...
    generateSQL(tableName, fields, config) {
        const _databaseType = config.databaseType;
     ...
     * Generate indexes
     */
    generateIndexes(tableName, fields, _config) {
        const indexes = [];
     ...
     */
    generateConstraints(tableName, fields, _config) {
        const constraints = [];
     ...
     */
    generateJSONSchema(pattern, fields, _config) {
        const properties = {};
     ...
     * Generate relationships
     */
    generateRelationships(_patterns, _config) {
        const relationships = [];
...
function _initializeSchemaDesigner(containerId = 'schema-designer-container') {
    if (!schemaDesigner) {
