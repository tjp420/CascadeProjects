...
(function loadChunkedScript() {
    ...
    if (window.__dashboard_inline_core_loaded) {
        return;
    }
    window.__dashboard_inline_core_loaded = true;

    const parts = ['dashboard-inline-core.part1.js', 'dashboard-inline-core.part2.js', 'dashboard-inline-core.part3.js'];
