...
class RoadmapComparisonAnalyzer {
     ...
     */
    generateRecommendations(ggufData, aiData, differences, _insights) {
     ...
     * Compare milestones
     */
    compareMilestones(ggufData, _aiData) {
    ...
    analyzeCompletionRootCause(ggufData, aiData) {
        const _ggufMethod = 'Local GGUF AI processing with development focus';
        const _aiMethod = aiData.executiveSummary?.analysisMethod || 'Cloud-based AI analysis with executive perspective';
     ...
     */
    analyzeHealthPerspectives(_ggufData, _aiData) {
        return {
     ...
     */
    analyzeVelocityFactors(_ggufData, _aiData) {
        return {
...
class VisualComparisonGenerator {
    ...
    createVelocityChart(_ggufData, _aiData) {
        return {
            type: 'line',
...
if (typeof module !== 'undefined' && module.exports) {
    ...
    window.RoadmapComparisonAnalyzer = RoadmapComparisonAnalyzer;
}
