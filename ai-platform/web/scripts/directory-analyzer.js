...
function _showDirectoryAnalyzer(container) {
...
// Tab switching
function _showDirectoryTab(tabName) {
...
function _exportAnalysisReport() {
...
function _analyzeFile(filename) {
