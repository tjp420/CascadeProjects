...
// Tab switching
function _showAboutTab(tabName) {
...
function _confirmContactSales() {
    const companyName = document.getElementById('companyName').value.trim();
    const contactName = document.getElementById('contactName').value.trim();
    const email = document.getElementById('contactEmail').value.trim();
    const _phone = document.getElementById('contactPhone').value.trim();
    const _productInterest = document.getElementById('productInterest').value;
