...
// Show settings
function _showSettings(container) {
...
// Tab switching
function _showSettingsTab(tabName) {
...
function _confirmResetSettings() {
...
function _toggleNotification(key) {
