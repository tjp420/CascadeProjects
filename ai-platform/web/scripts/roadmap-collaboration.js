...
window.confirmCreateDepartment = function() {
    ...
    const _budget = document.getElementById('deptBudget').value.trim();
    const _description = document.getElementById('deptDescription').value.trim();
...
let collaborationInstance;

// Initialize when DOM is ready
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', () => {
        collaborationInstance = new RoadmapCollaboration();
        window.roadmapCollaboration = collaborationInstance;
    });
} else {
    collaborationInstance = new RoadmapCollaboration();
    window.roadmapCollaboration = collaborationInstance;
