      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <p className="text-sm text-foreground-muted mt-1">
              This happens when the server can't access the project path. Ensure the path exists on
              the server filesystem, or use a local scan via Privacy Mode.
            </p>
          </div>
          <div>
            <p className="text-sm font-medium">Why am I getting "Local Network Access" prompts?</p>
            <p className="text-sm text-foreground-muted mt-1">
              The dashboard probes for a local API server on common dev ports. On hosted
              deployments, this is disabled. If you see this, hard-refresh to load the latest
              bundle.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-sm text-foreground-muted mt-1">
              The gate is a pass/fail threshold based on blocking issues (critical + high severity).
              A PASS means no blocking issues were found.
            </p>
          </div>
        </CardContent>
      </Card>
