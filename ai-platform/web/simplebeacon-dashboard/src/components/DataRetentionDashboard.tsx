        ...
        <CardContent>
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="rounded-md border border-border bg-muted/20 p-3 space-y-1">
              ...
              <p className="text-sm font-semibold">{stats?.lastPurge ? formatTime(stats.lastPurge.timestamp) : 'ΓÇö'}</p>
            </div>
          </div>
                ...
                <div key={catId} className="flex items-center gap-2 text-xs py-1 border-b border-border/50 last:border-0">
                  ...
                  {res.skipped ? (
                    ...
                    <>
                      ...
                      <span className="text-foreground-muted">{formatBytes(res.sizeBefore)} ΓåÆ {formatBytes(res.sizeAfter)}</span>
                    </>
                  )}
                </div>
              ))}
