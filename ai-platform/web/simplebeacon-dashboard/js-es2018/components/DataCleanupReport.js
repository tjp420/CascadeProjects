...
function renderDuplicateAssetsSection(findings) {
  const items =
    (findings === null || findings === void 0 ? void 0 : findings.assetConsolidation) || [];
  if (!items.length) return '';
  const rows = items
    .map(
      (f) => `
...
function renderScannerStatistics(scan, profile) {
  ...
  const statLines = rows
    ...
    .join('');
  const piiCategories =
    ((_b = (_a = scan.executiveSummary) === null || _a === void 0 ? void 0 : _a.security) ===
      null || _b === void 0
      ? void 0
      : _b.piiByCategory) || [];
...
function renderExecutiveSummary(scan, profile) {
  ...
  const credentials =
    ((_a = summary.security) === null || _a === void 0 ? void 0 : _a.credentials) || [];
