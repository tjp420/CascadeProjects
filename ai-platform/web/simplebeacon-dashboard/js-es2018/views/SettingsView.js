...
export class SettingsView {
      ...
      <div class="card settings-grid mb-6" id="settings-ai-keys-card">
        ...
        <div class="settings-field settings-field-stack">
          ...
          <input
            ...
            type="url"
            spellcheck="false"
            placeholder="http://127.0.0.1:11434" // simplebeacon-ignore hardcoded-url — default localhost Ollama placeholder in settings UI
    ...
    async testOllamaConnection(root, rerender) {
        ...
        const baseUrl = ((_b = (_a = payloadRoot === null || payloadRoot === void 0 ? void 0 : payloadRoot.querySelector('#settings-ai-ollama')) === null || _a === void 0 ? void 0 : _a.value) === null || _b === void 0 ? void 0 : _b.trim()) || 'http://127.0.0.1:11434'; // simplebeacon-ignore hardcoded-url — default localhost Ollama fallback
    ...
    bindEvents(root) {
        ...
        if (root.querySelector('#settings-ai-keys-card')) {
            const baseUrl = this.displayAiKeys().ollamaBaseUrl || 'http://127.0.0.1:11434'; // simplebeacon-ignore hardcoded-url — default localhost Ollama fallback
