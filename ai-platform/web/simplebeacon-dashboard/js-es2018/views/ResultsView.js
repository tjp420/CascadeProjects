...
import {
  openInIde,
  renderIdeFileLink,
  resolveProjectRootFromApp,
} from "../utils-lib/ideDeepLink.js";
...
export class ResultsView {
        ...
        filePath:
          ...
          ((_d =
            (_c = issue.metadata) === null || _c === void 0
              ? void 0
              : _c.duplicatePaths) === null || _d === void 0
            ? void 0
            : _d[0]) ||
          ((_e = issue.affectedFiles) === null || _e === void 0
            ? void 0
            : _e[0]),
      };
    });
    const query =
      (_b = this.app.state.routeParams) === null || _b === void 0
        ? void 0
        : _b.q;
    if (query) {
      ...
      issues = issues.filter((i) => {
        var _a, _b, _c;
        return (
          ((_a = i.type) === null || _a === void 0
            ? void 0
            : _a.toLowerCase().includes(q)) ||
          ((_b = i.description) === null || _b === void 0
            ? void 0
            : _b.toLowerCase().includes(q)) ||
          ((_c = i.filePath) === null || _c === void 0
            ? void 0
            : _c.toLowerCase().includes(q))
        );
      });
    }
  ...
  render() {
    ...
    const filtersActive =
      ...
      this.filterCategory !== "all" ||
      Boolean(
        (_c = this.app.state.routeParams) === null || _c === void 0
          ? void 0
          : _c.q,
      );
    const fromAudit =
      ((_d = this.app.state.routeParams) === null || _d === void 0
        ? void 0
        : _d.from) === "audit";
    ...
    const _noReportEmptyState = !report
      ? renderEmptyState({
          ...
          actions: [
            {
              label: "Go to Analyze",
              onClick: () => this.app.navigate("analyze"),
            },
          ],
        })
      : null;
    const _issuesEmptyState =
      report && issues.length === 0
        ? renderEmptyState({
            icon:
              totalIssues === 0 && report?.gate?.pass && !filtersActive
                ? "✅"
                : "🔍",
            title: this.emptyStateMessage(
              report,
              totalIssues,
              filtersActive,
              activeCategory,
      ...
      ${
        ...
        <div class="card mb-4" style="padding:var(--space-4)">
          <p style="margin:0">
            ...
            ${
              totalIssues === 0 &&
              ((_e = report.gate) === null || _e === void 0 ? void 0 : _e.pass)
  ...
  bindExport(el, issues) {
    ...
    (_c = el.querySelector("#export-filtered-json-btn")) === null ||
    _c === void 0
      ? void 0
    ...
    (_f = el.querySelector("#export-audit-pdf-btn")) === null || _f === void 0
      ...
      : _f.addEventListener("click", () => {
          try {
            svc.exportAuditPdf();
            showToast(
              "Audit PDF opened in new window — use Print to save",
              "success",
            );
          } catch (err) {
    ...
    const doSendToAi = async (notes = "") => {
      ...
      const reportSummary = {
        gatePass:
          (_b =
            ...
            : "N/A",
        qualityScore:
          (_c = report.qualityScore) !== null && _c !== void 0 ? _c : "N/A",
      ...
      if (hasVsCodeApi) {
        try {
          ...
          window["console"]["warn"](
            "[AI-Send] vscode.postMessage failed:",
            err,
          );
        }
      }
    ...
    (_g = el.querySelector("#ai-send-confirm")) === null || _g === void 0
      ...
      : _g.addEventListener("click", async () => {
          ...
          await doSendToAi(
            (aiNotesInput === null || aiNotesInput === void 0
              ? void 0
              : aiNotesInput.value) || "",
          );
          btn.disabled = false;
  ...
  renderSampleFiles() {
    ...
    const report = this.app.state.report;
    const files =
      (report === null || report === void 0 ? void 0 : report.sampleFiles) ||
      [];
  ...
  showDetail(container, issue) {
    ...
    if (issue.filePath) {
      ...
      openBtn.addEventListener("click", () =>
        openInIde(issue.filePath, issue.line || 1, { projectRoot }),
      );
    ...
    if (
      (_a = issue.affectedFiles) === null || _a === void 0 ? void 0 : _a.length
    ) {
