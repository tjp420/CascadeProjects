...
export class UploadView {
  ...
  renderPreview(data, scanMetaEl, previewContentEl) {
    ...
    const gate =
      data.gate ||
      ((_b = (_a = data.results) === null || _a === void 0 ? void 0 : _a.simplebeacon) === null ||
      _b === void 0
        ? void 0
        : _b.gate) ||
      {};
    ...
    const quality =
      (_g =
        (_d = data.qualityScore) !== null && _d !== void 0
          ? _d
          : (_f = (_e = data.results) === null || _e === void 0 ? void 0 : _e.simplebeacon) ===
                null || _f === void 0
            ? void 0
    ...
    const files =
      (_m =
        (_k =
          (_j =
            (_h = data.repositoryFilesTotal) !== null && _h !== void 0 ? _h : data.totalFiles) !==
            null && _j !== void 0
            ? _j
    ...
    const issues =
      (_r =
        (_q =
          (_p = (_o = data.issueCount) !== null && _o !== void 0 ? _o : gate.blockingCount) !==
            null && _p !== void 0
            ? _p
