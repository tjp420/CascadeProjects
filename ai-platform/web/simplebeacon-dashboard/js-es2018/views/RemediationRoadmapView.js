...
function sortBySeverity(issues) {
  return [...issues].sort((a, b) => {
    var _a, _b;
    const sa =
      (_a = SEVERITY_ORDER[a.severity]) !== null && _a !== void 0 ? _a : 99;
    const sb =
      (_b = SEVERITY_ORDER[b.severity]) !== null && _b !== void 0 ? _b : 99;
...
function convertPhasesToIssues(phases, summary) {
  ...
  return {
    issues,
    exportedAt:
      (summary === null || summary === void 0 ? void 0 : summary.exportedAt) ||
      null,
  };
}
/**
...
export class RemediationRoadmapView {
  ...
  getIssues() {
    ...
    if (
      remediationPayload &&
      Array.isArray(remediationPayload.issues) &&
      remediationPayload.issues.length
    ) {
  ...
  async ensureReportFresh() {
    ...
    try {
      ...
      if (
        fresh &&
        (((_a = fresh.rawIssues) === null || _a === void 0
          ? void 0
          : _a.length) ||
          ((_b = fresh.detectedIssues) === null || _b === void 0
            ? void 0
            : _b.length))
      ) {
  ...
  importFromText(text) {
    ...
    try {
      ...
      if (
        data.id === "roadmap" &&
        ((_a = data.data) === null || _a === void 0 ? void 0 : _a.roadmap)
      ) {
        data = data.data;
      }
      ...
      if (data.type === "simplebeacon-report") {
        const sourceIssues = (
          (_c = data.rawIssues) === null || _c === void 0 ? void 0 : _c.length
        )
          ? data.rawIssues
          : data.detectedIssues || [];
      ...
      if (
        ...
        const sb =
          (_d = data.results) === null || _d === void 0
            ? void 0
            : _d.simplebeacon;
        if (sb) {
          const sourceIssues = (
            (_e = sb.rawIssues) === null || _e === void 0 ? void 0 : _e.length
          )
            ? sb.rawIssues
            : sb.detectedIssues || [];
          if (sourceIssues.length) {
      ...
      if (Array.isArray(data.issues) && data.issues.length) {
        issues = data.issues;
        metaExportedAt =
          (_f = data.metadata) === null || _f === void 0
            ? void 0
            : _f.exportedAt;
  ...
  bindEvents(el) {
    ...
    el.querySelectorAll(".roadmap-open-file").forEach((btn) => {
      btn.addEventListener("click", (e) => {
        e.preventDefault();
        e.stopPropagation();
        openInIde(btn.dataset.file, Number(btn.dataset.line) || 1, {
          projectRoot,
        });
      });
    });
    ...
    if (!this._paginationDelegated && mount) {
      ...
      mount.addEventListener("click", (event) => {
        const prev =
          ...
          event.target.closest("#remediation-prev-page");
        const next =
          event.target.closest &&
          event.target.closest("#remediation-next-page");
        if (!prev && !next) return;
