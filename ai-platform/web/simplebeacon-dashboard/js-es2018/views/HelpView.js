...
import { getScanFileMetrics, resolveDisplayScore, resolveJestTestsLabel, resolvePageSpecsLabel, formatScanScopeSummary, formatScanInventoryNote } from '../services/analyzeService.js?v=20260710reportnorm1';
...
npm test -- --testPathPattern=page-samples</pre>
    ...
    `;
        ...
        // Copy CLI
        (_c = el.querySelector('#help-copy-cli')) === null || _c === void 0 ? void 0 : _c.addEventListener('click', async () => {
            var _a;
        ...
        (_d = el.querySelector('#help-open-features')) === null || _d === void 0 ? void 0 : _d.addEventListener('click', () => {
