...
export class ChatbotView {
    ...
    mount(container) {
      ...
      <div class="view-container">
        <div class="analyze-hero" style="margin-bottom:var(--space-4);">
          ...
          <p class="text-muted analyze-hero-sub">AI-powered assistance for your codebase</p>
        </div>
    ...
    bindEvents() {
        // simplebeacon-ignore memory-leak — listeners are bound to DOM elements recreated on each mount; no long-lived detached references
