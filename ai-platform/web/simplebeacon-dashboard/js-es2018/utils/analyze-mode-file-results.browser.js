...
function isIntentionalConsolidationCandidate(item) {
  ...
  const paths = ((item === null || item === void 0 ? void 0 : item.files) || [])
    .map((file) =>
      normalizeRelPath(
        typeof file === 'string' ? file : file.path || file.relativePath || file.name
      )
    )
    .filter(Boolean);
...
function rowsFromGateReport(report) {
  ...
  const docs =
    ((_a = report.euAiActSummary) === null || _a === void 0 ? void 0 : _a.documentationFound) || [];
...
function rowsFromCompliance(checklist) {
  return ((checklist === null || checklist === void 0 ? void 0 : checklist.rules) || []).map(
    (rule) => ({
      path: rule.id,
...
function resolvePayload(mode, lastResult, report) {
  ...
  switch (mode) {
    case 'simplebeacon':
      if (
        (lastResult === null || lastResult === void 0 ? void 0 : lastResult.kind) ===
        'simplebeacon-report'
      )
      ...
      if ((lastResult === null || lastResult === void 0 ? void 0 : lastResult.kind) === 'complete')
        return {
          kind: 'gate',
          report:
            (_a = stepPayload(lastResult, 'simplebeacon')) === null || _a === void 0
              ? void 0
              : _a.report,
        };
    ...
    case 'eu-ai-act':
      if ((lastResult === null || lastResult === void 0 ? void 0 : lastResult.kind) === 'eu-ai-act')
        return {
          kind: 'gate',
          report: (_b = lastResult.sprint) === null || _b === void 0 ? void 0 : _b.report,
        };
      if ((lastResult === null || lastResult === void 0 ? void 0 : lastResult.kind) === 'complete')
        return {
          kind: 'gate',
          report:
            (_c = stepPayload(lastResult, 'simplebeacon')) === null || _c === void 0
              ? void 0
              : _c.report,
        };
      return null;
    case 'mock-scan':
      if (
        (lastResult === null || lastResult === void 0 ? void 0 : lastResult.kind) === 'complete'
      ) {
        const step = stepPayload(lastResult, 'mock-scan');
        return {
          kind: 'fiction',
          report: step === null || step === void 0 ? void 0 : step.report,
          issues: step === null || step === void 0 ? void 0 : step.fictionIssues,
        };
      }
    ...
    case 'consolidation':
      ...
      if ((lastResult === null || lastResult === void 0 ? void 0 : lastResult.kind) === 'complete')
        return {
          kind: 'consolidation',
          scan:
            (_d = stepPayload(lastResult, 'consolidation')) === null || _d === void 0
              ? void 0
              : _d.scan,
        };
      return null;
    case 'codebase':
      ...
      if ((lastResult === null || lastResult === void 0 ? void 0 : lastResult.kind) === 'complete')
        return {
          kind: 'codebase',
          scan:
            (_e = stepPayload(lastResult, 'codebase')) === null || _e === void 0 ? void 0 : _e.scan,
        };
      return null;
    case 'file-reduction':
    case 'data-quality':
      ...
      if ((lastResult === null || lastResult === void 0 ? void 0 : lastResult.kind) === 'complete')
        return {
          kind: 'cleanup',
          scan: (_f = stepPayload(lastResult, mode)) === null || _f === void 0 ? void 0 : _f.scan,
        };
      return null;
    case 'cleanup-assistant':
      ...
      if ((lastResult === null || lastResult === void 0 ? void 0 : lastResult.kind) === 'complete')
        return {
          kind: 'cleanup-brief',
          brief:
            (_g = stepPayload(lastResult, 'cleanup-assistant')) === null || _g === void 0
              ? void 0
              : _g.brief,
        };
      return null;
    case 'compliance':
      if (
        (lastResult === null || lastResult === void 0 ? void 0 : lastResult.kind) === 'compliance'
      )
      ...
      if ((lastResult === null || lastResult === void 0 ? void 0 : lastResult.kind) === 'complete')
        return {
          kind: 'compliance',
          checklist:
            (_h = stepPayload(lastResult, 'compliance')) === null || _h === void 0
              ? void 0
              : _h.checklist,
        };
      return null;
    case 'npm-audit':
      ...
      if ((lastResult === null || lastResult === void 0 ? void 0 : lastResult.kind) === 'complete')
        return {
          kind: 'npm',
          npmAudit:
            (_j = stepPayload(lastResult, 'npm-audit')) === null || _j === void 0
              ? void 0
              : _j.npmAudit,
        };
      return null;
    case 'roadmap':
      ...
      if ((lastResult === null || lastResult === void 0 ? void 0 : lastResult.kind) === 'complete')
        return {
          kind: 'roadmap',
          data:
            (_k = stepPayload(lastResult, 'roadmap')) === null || _k === void 0 ? void 0 : _k.data,
        };
      return null;
    case 'complete':
      if ((lastResult === null || lastResult === void 0 ? void 0 : lastResult.kind) === 'complete')
    ...
    case 'auto':
      return resolvePayload(
        (lastResult === null || lastResult === void 0 ? void 0 : lastResult.kind) === 'roadmap'
          ? 'roadmap'
          : 'simplebeacon',
        lastResult,
        report
...
function buildRows(mode, payload) {
  ...
  if (payload.kind === 'fiction') {
    const issues =
      payload.issues ||
      (payload.report ? payload.report.rawIssues || payload.report.detectedIssues || [] : []);
      ...
      summary: {
        scoped:
          (_b =
            ...
            ? _b
            : (_d = (_c = payload.report) === null || _c === void 0 ? void 0 : _c.scanScope) ===
                  null || _d === void 0
              ? void 0
  ...
  if (payload.kind === 'consolidation') {
    return {
      ...
      summary: {
        scoped:
          (_g =
            (_f = (_e = payload.scan) === null || _e === void 0 ? void 0 : _e.summary) === null ||
            _f === void 0
              ? void 0
              : _f.jsonFilesAnalyzed) !== null && _g !== void 0
            ? _g
            : (_j = (_h = payload.scan) === null || _h === void 0 ? void 0 : _h.summary) === null ||
                _j === void 0
              ? void 0
  ...
  if (payload.kind === 'codebase') {
    return {
      rows: rowsFromFindings(
        ((_k = payload.scan) === null || _k === void 0 ? void 0 : _k.findings) || [],
        'codebase'
      ),
      summary: {
        scoped:
          (_o =
            (_m = (_l = payload.scan) === null || _l === void 0 ? void 0 : _l.summary) === null ||
            _m === void 0
              ? void 0
              : _m.filesScanned) !== null && _o !== void 0
            ? _o
            : (_q = (_p = payload.scan) === null || _p === void 0 ? void 0 : _p.summary) === null ||
                _q === void 0
              ? void 0
  ...
  if (payload.kind === 'cleanup') {
    ...
    for (const [scannerId, block] of Object.entries(
      ...
      const items =
        ((_r = block === null || block === void 0 ? void 0 : block.findings) === null ||
        _r === void 0
          ? void 0
          : _r.items) ||
    ...
    return {
      rows: rowsFromFindings(
        [...top, ...scannerFindings],
        (scan === null || scan === void 0 ? void 0 : scan.scanProfile) || 'cleanup'
      ),
      summary: {
        scoped:
          (_t =
            (_s = scan === null || scan === void 0 ? void 0 : scan.inventory) === null ||
            _s === void 0
              ? void 0
              : _s.totalFiles) !== null && _t !== void 0
            ? _t
            : (_u = scan === null || scan === void 0 ? void 0 : scan.summary) === null ||
                _u === void 0
              ? void 0
              : _u.filesScanned,
      },
  ...
  if (payload.kind === 'roadmap') {
    const phases =
      ((_w = (_v = payload.data) === null || _v === void 0 ? void 0 : _v.roadmap) === null ||
      _w === void 0
        ? void 0
        : _w.phases) ||
  ...
  return [...rows].sort((a, b) => {
    ...
    return (
      ((_a = order[a.status]) !== null && _a !== void 0 ? _a : 9) -
        ((_b = order[b.status]) !== null && _b !== void 0 ? _b : 9) || a.path.localeCompare(b.path)
    );
  });
}
/**
