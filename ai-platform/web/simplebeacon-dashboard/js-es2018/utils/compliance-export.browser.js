...
function hasHollowGate(gateReport) {
  ...
  return (
    Boolean(
      (_a = gateReport === null || gateReport === void 0 ? void 0 : gateReport.gate) === null ||
        _a === void 0
        ? void 0
        : _a.pass
...
function schemaComplianceOk(gateReport) {
  ...
  const checked =
    (_b =
      (_a = gateReport === null || gateReport === void 0 ? void 0 : gateReport.schemaChecked) !==
        null && _a !== void 0
        ? _a
        : gateReport === null || gateReport === void 0
          ? void 0
  ...
  const passed =
    (_d =
      (_c = gateReport === null || gateReport === void 0 ? void 0 : gateReport.schemaPassed) !==
        null && _c !== void 0
        ? _c
        : gateReport === null || gateReport === void 0
          ? void 0
...
function checklistHasStaleFailRows(checklist, gateReport) {
  ...
  if (
    !((_a = checklist === null || checklist === void 0 ? void 0 : checklist.rules) === null ||
    _a === void 0
      ? void 0
      : _a.length) ||
    !gateReport
  ...
  const blocking =
    (_e =
      (_d = (_c = gateReport.gate) === null || _c === void 0 ? void 0 : _c.blockingCount) !==
        null && _d !== void 0
        ? _d
...
function refreshComplianceChecklistFromGate(checklist, gateReport) {
  ...
  const schemaChecked =
    (_c =
      (_b = gateReport.schemaChecked) !== null && _b !== void 0
        ? _b
        : gateReport.pageSampleSchemaChecked) !== null && _c !== void 0
      ? _c
      : 0;
  const schemaPassed =
    (_e =
      (_d = gateReport.schemaPassed) !== null && _d !== void 0
        ? _d
        : gateReport.pageSampleSchemaPassed) !== null && _e !== void 0
      ? _e
      : 0;
  /**
   * Rules.
  ...
  const rules = (checklist.rules || []).map((rule) => {
    ...
    if (
      rule.id === 'GATE-001' &&
      ((_a = gateReport.gate) === null || _a === void 0 ? void 0 : _a.pass)
    ) {
      return {
        ...rule,
        status: 'pass',
...
function buildComplianceHygieneSummary(checklist, gateReport, npmAudit, context) {
  ...
  const gateProfile =
    (_f =
      (_d =
        (_b =
          (_a = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) ===
            null || _a === void 0
            ? void 0
            : _a.profile) !== null && _b !== void 0
          ? _b
          : (_c = checklist === null || checklist === void 0 ? void 0 : checklist.scanScope) ===
                null || _c === void 0
            ? void 0
            : _c.gateRuleBundleProfile) !== null && _d !== void 0
        ? _d
        : (_e = checklist === null || checklist === void 0 ? void 0 : checklist.hygieneSummary) ===
              null || _e === void 0
          ? void 0
    ...
    (_l =
      (_j =
        (_g =
          gateReport === null || gateReport === void 0
            ? void 0
            : gateReport.repositoryFilesTotal) !== null && _g !== void 0
          ? _g
          : (_h =
                gateReport === null || gateReport === void 0
                  ? void 0
                  : gateReport.repositoryInventory) === null || _h === void 0
            ? void 0
            : _h.totalFiles) !== null && _j !== void 0
        ? _j
        : (_k = checklist === null || checklist === void 0 ? void 0 : checklist.hygieneSummary) ===
              null || _k === void 0
          ? void 0
  ...
  const credentialScanned =
    (_r =
      (_p =
        (_m =
          gateReport === null || gateReport === void 0 ? void 0 : gateReport.credentialScanned) !==
          null && _m !== void 0
          ? _m
          : (_o = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) ===
                null || _o === void 0
            ? void 0
            : _o.productionDirsScanned) !== null && _p !== void 0
        ? _p
        : (_q = checklist === null || checklist === void 0 ? void 0 : checklist.hygieneSummary) ===
              null || _q === void 0
          ? void 0
  ...
  const contentScanned =
    (_0 =
      (_y =
          ...
          (_u =
            ...
            : (_w =
                  (_v =
                    gateReport === null || gateReport === void 0
                      ? void 0
                      : gateReport.scanScope) === null || _v === void 0
                    ? void 0
        ...
        ? _y
        : (_z = checklist === null || checklist === void 0 ? void 0 : checklist.hygieneSummary) ===
              null || _z === void 0
          ? void 0
  ...
  return {
      ...
      (_10 =
        (_8 =
          (_6 =
            gateReport === null || gateReport === void 0
              ? void 0
              : gateReport.fictionJsonFilesScanned) !== null && _6 !== void 0
            ? _6
            : (_7 =
                  gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) ===
                  null || _7 === void 0
          ...
          ? _8
          : (_9 =
                checklist === null || checklist === void 0 ? void 0 : checklist.hygieneSummary) ===
                null || _9 === void 0
            ? void 0
    ...
    npmAuditHigh:
      (_23 =
        ...
        ? _23
        : null,
    ...((gateReport === null || gateReport === void 0 ? void 0 : gateReport.jestBaselineChecked) ===
      false ||
    ((_24 = checklist === null || checklist === void 0 ? void 0 : checklist.hygieneSummary) ===
      null || _24 === void 0
      ? void 0
...
function buildComplianceScanScope(gateReport, options = {}) {
    ...
    (_h =
      (_f =
        (_d =
          ...
          ? _d
          : (_e = checklist === null || checklist === void 0 ? void 0 : checklist.scanScope) ===
                null || _e === void 0
            ? void 0
            : _e.gateRepositoryFilesTotal) !== null && _f !== void 0
        ? _f
        : (_g = checklist === null || checklist === void 0 ? void 0 : checklist.hygieneSummary) ===
              null || _g === void 0
          ? void 0
  ...
  const gateProfile =
    (_p =
      (_m =
        (_k =
          (_j = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) ===
            null || _j === void 0
            ? void 0
            : _j.profile) !== null && _k !== void 0
          ? _k
          : (_l = checklist === null || checklist === void 0 ? void 0 : checklist.scanScope) ===
                null || _l === void 0
            ? void 0
            : _l.gateRuleBundleProfile) !== null && _m !== void 0
        ? _m
        : (_o = checklist === null || checklist === void 0 ? void 0 : checklist.hygieneSummary) ===
              null || _o === void 0
          ? void 0
  ...
  return {
    checklistProfile:
      ((_q = checklist === null || checklist === void 0 ? void 0 : checklist.scanScope) === null ||
      _q === void 0
        ? void 0
    ...
    sourceArtifacts: {
      gateReport: Boolean(
        gateReport ||
        ((_s =
          (_r = checklist === null || checklist === void 0 ? void 0 : checklist.scanScope) ===
            null || _r === void 0
            ? void 0
      ...
      npmAudit: Boolean(
        options.npmAudit ||
        ((_u =
          (_t = checklist === null || checklist === void 0 ? void 0 : checklist.scanScope) ===
            null || _t === void 0
            ? void 0
...
function buildExportNotes(checklist, gateReport, npmAudit, context) {
  ...
  const repoTotal =
    (_c =
      (_a =
        gateReport === null || gateReport === void 0 ? void 0 : gateReport.repositoryFilesTotal) !==
        null && _a !== void 0
        ? _a
        : (_b =
              gateReport === null || gateReport === void 0
  ...
  const credentialScanned =
    (_e =
      ...
      ? _e
      : (_f = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) ===
            null || _f === void 0
        ? void 0
  ...
  const fictionJson =
    (_g =
      gateReport === null || gateReport === void 0
        ? void 0
        : gateReport.fictionJsonFilesScanned) !== null && _g !== void 0
      ? _g
      : (_h = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) ===
            null || _h === void 0
        ? void 0
  ...
  const fictionSamples =
    (_j =
      gateReport === null || gateReport === void 0
        ? void 0
        : gateReport.fictionSampleFilesScanned) !== null && _j !== void 0
      ? _j
      : (_k = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) ===
            null || _k === void 0
        ? void 0
  ...
  if (
    ...
    ((_l = gateReport === null || gateReport === void 0 ? void 0 : gateReport.euAiActSummary) ===
      null || _l === void 0
      ? void 0
  ...
  const gateProfile =
    (_s =
      (_q =
        (_o =
          (_m = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) ===
            null || _m === void 0
            ? void 0
            : _m.profile) !== null && _o !== void 0
          ? _o
          : (_p = checklist === null || checklist === void 0 ? void 0 : checklist.scanScope) ===
                null || _p === void 0
            ? void 0
            : _p.gateRuleBundleProfile) !== null && _q !== void 0
        ? _q
        : (_r = checklist === null || checklist === void 0 ? void 0 : checklist.hygieneSummary) ===
              null || _r === void 0
          ? void 0
  ...
  if (
    ...
    ((_u = gateReport === null || gateReport === void 0 ? void 0 : gateReport.gate) === null ||
    _u === void 0
      ? void 0
      : _u.pass) === false
  ) {
    ...
    const blocking =
      (_x =
        (_w = (_v = gateReport.gate) === null || _v === void 0 ? void 0 : _v.blockingCount) !==
          null && _w !== void 0
          ? _w
...
export function sanitizeComplianceChecklistArtifactExport(checklist, options = {}) {
  ...
  const projectPath =
    options.projectPath ||
    (checklist === null || checklist === void 0 ? void 0 : checklist.projectRoot) ||
    '';
  ...
  return {
    ...
    complianceStatus: benchmarkScan
      ...
      : hollowGate
        ? 'limited-gate-scope'
        : ((_g = (_f = sanitized.summary) === null || _f === void 0 ? void 0 : _f.failed) !==
              null && _g !== void 0
              ? _g
              : 0) > 0
          ? 'failed'
...
export function sanitizeComplianceBundleExport(payload = {}) {
  ...
  const failed =
    (_d =
      (_c = checklist === null || checklist === void 0 ? void 0 : checklist.summary) === null ||
      _c === void 0
        ? void 0
  ...
  return {
    ...
    readyForAutomation:
      (_f =
        (_e = checklist === null || checklist === void 0 ? void 0 : checklist.summary) === null ||
        _e === void 0
          ? void 0
    ...
    checklist: {
      ...
      summary: (
        (_g = checklist.summary) === null || _g === void 0 ? void 0 : _g.productPlatformRoot
      )
        ? {
            ...checklist.summary,
