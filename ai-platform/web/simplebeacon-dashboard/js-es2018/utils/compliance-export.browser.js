...
function ruleScopedFromGate(gateReport) {
    var _a, _b, _c;
    return (_c = (_a = gateReport === null || gateReport === void 0 ? void 0 : gateReport.ruleScopedFilesAnalyzed) !== null && _a !== void 0 ? _a : (_b = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null || _b === void 0 ? void 0 : _b.ruleScopedFilesAnalyzed) !== null && _c !== void 0 ? _c : 0;
}
/**
 * Has hollow gate.
 * @param {number} gateReport
...
function hasHollowGate(gateReport) {
    var _a;
    return Boolean((_a = gateReport === null || gateReport === void 0 ? void 0 : gateReport.gate) === null || _a === void 0 ? void 0 : _a.pass) && ruleScopedFromGate(gateReport) === 0;
}
/**
...
function schemaComplianceOk(gateReport) {
    var _a, _b, _c, _d;
    const checked = (_b = (_a = gateReport === null || gateReport === void 0 ? void 0 : gateReport.schemaChecked) !== null && _a !== void 0 ? _a : gateReport === null || gateReport === void 0 ? void 0 : gateReport.pageSampleSchemaChecked) !== null && _b !== void 0 ? _b : 0;
    const passed = (_d = (_c = gateReport === null || gateReport === void 0 ? void 0 : gateReport.schemaPassed) !== null && _c !== void 0 ? _c : gateReport === null || gateReport === void 0 ? void 0 : gateReport.pageSampleSchemaPassed) !== null && _d !== void 0 ? _d : 0;
...
function checklistHasStaleFailRows(checklist, gateReport) {
    ...
    if (!((_a = checklist === null || checklist === void 0 ? void 0 : checklist.rules) === null || _a === void 0 ? void 0 : _a.length) || !gateReport)
        return false;
    if (((_b = gateReport.gate) === null || _b === void 0 ? void 0 : _b.pass) !== true)
        return false;
    const blocking = (_e = (_d = (_c = gateReport.gate) === null || _c === void 0 ? void 0 : _c.blockingCount) !== null && _d !== void 0 ? _d : gateReport.issueCount) !== null && _e !== void 0 ? _e : null;
    if (blocking != null && blocking > 0)
        return false;
    if (((_f = gateReport.productionLeakFindings) !== null && _f !== void 0 ? _f : 0) > 0)
        return false;
    const schemaOk = schemaComplianceOk(gateReport);
    return checklist.rules.some((rule) => {
        if (rule.status !== 'fail')
            return false;
        if (rule.id === 'GATE-001' || rule.id === 'LEAK-001')
            return true;
...
function refreshComplianceChecklistFromGate(checklist, gateReport) {
    var _a, _b, _c, _d, _e;
    if (!((_a = checklist === null || checklist === void 0 ? void 0 : checklist.rules) === null || _a === void 0 ? void 0 : _a.length) || !gateReport || !checklistHasStaleFailRows(checklist, gateReport)) {
        return checklist;
    }
    const schemaOk = schemaComplianceOk(gateReport);
    const schemaChecked = (_c = (_b = gateReport.schemaChecked) !== null && _b !== void 0 ? _b : gateReport.pageSampleSchemaChecked) !== null && _c !== void 0 ? _c : 0;
    const schemaPassed = (_e = (_d = gateReport.schemaPassed) !== null && _d !== void 0 ? _d : gateReport.pageSampleSchemaPassed) !== null && _e !== void 0 ? _e : 0;
    /**
     * Rules.
    ...
    const rules = (checklist.rules || []).map((rule) => {
        ...
        if (rule.id === 'LEAK-001' && ((_b = gateReport.productionLeakFindings) !== null && _b !== void 0 ? _b : 0) === 0) {
            return {
                ...rule,
                status: 'pass',
...
function patchSupplyRulesFromNpmAudit(rules, npmAudit) {
    if (!Array.isArray(rules) || !npmAudit)
        return rules;
...
function resolveBundleHandoffEligible(checklist, context) {
    var _a, _b, _c;
    if (context.benchmarkScan || context.hollowGate)
        return false;
    const summary = (checklist === null || checklist === void 0 ? void 0 : checklist.summary) || {};
    if (summary.handoffEligible === false)
        return false;
    if (((_a = summary.failed) !== null && _a !== void 0 ? _a : 0) > 0)
        return false;
    if (summary.readyForAutomation === false)
        return false;
    if (summary.handoffEligible === true)
        return true;
    return ((_b = summary.passed) !== null && _b !== void 0 ? _b : 0) > 0 && ((_c = summary.failed) !== null && _c !== void 0 ? _c : 0) === 0;
}
/**
...
function buildComplianceHygieneSummary(checklist, gateReport, npmAudit, context) {
    ...
    const summary = (checklist === null || checklist === void 0 ? void 0 : checklist.summary) || {};
    const gateProfile = (_f = (_d = (_b = (_a = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null || _a === void 0 ? void 0 : _a.profile) !== null && _b !== void 0 ? _b : (_c = checklist === null || checklist === void 0 ? void 0 : checklist.scanScope) === null || _c === void 0 ? void 0 : _c.gateRuleBundleProfile) !== null && _d !== void 0 ? _d : (_e = checklist === null || checklist === void 0 ? void 0 : checklist.hygieneSummary) === null || _e === void 0 ? void 0 : _e.gateRuleBundleProfile) !== null && _f !== void 0 ? _f : null;
    const repoTotal = (_l = (_j = (_g = gateReport === null || gateReport === void 0 ? void 0 : gateReport.repositoryFilesTotal) !== null && _g !== void 0 ? _g : (_h = gateReport === null || gateReport === void 0 ? void 0 : gateReport.repositoryInventory) === null || _h === void 0 ? void 0 : _h.totalFiles) !== null && _j !== void 0 ? _j : (_k = checklist === null || checklist === void 0 ? void 0 : checklist.hygieneSummary) === null || _k === void 0 ? void 0 : _k.gateRepositoryFilesTotal) !== null && _l !== void 0 ? _l : ruleScopedFromGate(gateReport);
    const credentialScanned = (_r = (_p = (_m = gateReport === null || gateReport === void 0 ? void 0 : gateReport.credentialScanned) !== null && _m !== void 0 ? _m : (_o = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null || _o === void 0 ? void 0 : _o.productionDirsScanned) !== null && _p !== void 0 ? _p : (_q = checklist === null || checklist === void 0 ? void 0 : checklist.hygieneSummary) === null || _q === void 0 ? void 0 : _q.credentialScanned) !== null && _r !== void 0 ? _r : null;
    const contentScanned = (_0 = (_y = (_x = (_u = (_t = (_s = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null || _s === void 0 ? void 0 : _s.fullDirectoryStats) === null || _t === void 0 ? void 0 : _t.contentScanned) !== null && _u !== void 0 ? _u : (_w = (_v = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null || _v === void 0 ? void 0 : _v.fullDirectoryStats) === null || _w === void 0 ? void 0 : _w.filesContentScanned) !== null && _x !== void 0 ? _x : gateReport === null || gateReport === void 0 ? void 0 : gateReport.credentialScanned) !== null && _y !== void 0 ? _y : (_z = checklist === null || checklist === void 0 ? void 0 : checklist.hygieneSummary) === null || _z === void 0 ? void 0 : _z.contentFilesScanned) !== null && _0 !== void 0 ? _0 : null;
    ...
    return {
        ...
        fictionJsonFilesScanned: (_10 = (_8 = (_6 = gateReport === null || gateReport === void 0 ? void 0 : gateReport.fictionJsonFilesScanned) !== null && _6 !== void 0 ? _6 : (_7 = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null || _7 === void 0 ? void 0 : _7.fictionJsonFilesScanned) !== null && _8 !== void 0 ? _8 : (_9 = checklist === null || checklist === void 0 ? void 0 : checklist.hygieneSummary) === null || _9 === void 0 ? void 0 : _9.fictionJsonFilesScanned) !== null && _10 !== void 0 ? _10 : null,
        fictionSampleFilesScanned: (_15 = (_13 = (_11 = gateReport === null || gateReport === void 0 ? void 0 : gateReport.fictionSampleFilesScanned) !== null && _11 !== void 0 ? _11 : (_12 = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null || _12 === void 0 ? void 0 : _12.fictionSampleFilesScanned) !== null && _13 !== void 0 ? _13 : (_14 = checklist === null || checklist === void 0 ? void 0 : checklist.hygieneSummary) === null || _14 === void 0 ? void 0 : _14.fictionSampleFilesScanned) !== null && _15 !== void 0 ? _15 : null,
        ...(gateProfile ? { gateRuleBundleProfile: gateProfile } : {}),
        npmAuditCritical: (_19 = (_17 = (_16 = npmAudit === null || npmAudit === void 0 ? void 0 : npmAudit.summary) === null || _16 === void 0 ? void 0 : _16.critical) !== null && _17 !== void 0 ? _17 : (_18 = checklist === null || checklist === void 0 ? void 0 : checklist.hygieneSummary) === null || _18 === void 0 ? void 0 : _18.npmAuditCritical) !== null && _19 !== void 0 ? _19 : null,
        npmAuditHigh: (_23 = (_21 = (_20 = npmAudit === null || npmAudit === void 0 ? void 0 : npmAudit.summary) === null || _20 === void 0 ? void 0 : _20.high) !== null && _21 !== void 0 ? _21 : (_22 = checklist === null || checklist === void 0 ? void 0 : checklist.hygieneSummary) === null || _22 === void 0 ? void 0 : _22.npmAuditHigh) !== null && _23 !== void 0 ? _23 : null,
        ...((gateReport === null || gateReport === void 0 ? void 0 : gateReport.jestBaselineChecked) === false || ((_24 = checklist === null || checklist === void 0 ? void 0 : checklist.hygieneSummary) === null || _24 === void 0 ? void 0 : _24.jestBaselineChecked) === false
...
function buildComplianceScanScope(gateReport, options = {}) {
    ...
    const repoTotal = (_h = (_f = (_d = (_b = (_a = options.repositoryFilesTotal) !== null && _a !== void 0 ? _a : gateReport === null || gateReport === void 0 ? void 0 : gateReport.repositoryFilesTotal) !== null && _b !== void 0 ? _b : (_c = gateReport === null || gateReport === void 0 ? void 0 : gateReport.repositoryInventory) === null || _c === void 0 ? void 0 : _c.totalFiles) !== null && _d !== void 0 ? _d : (_e = checklist === null || checklist === void 0 ? void 0 : checklist.scanScope) === null || _e === void 0 ? void 0 : _e.gateRepositoryFilesTotal) !== null && _f !== void 0 ? _f : (_g = checklist === null || checklist === void 0 ? void 0 : checklist.hygieneSummary) === null || _g === void 0 ? void 0 : _g.gateRepositoryFilesTotal) !== null && _h !== void 0 ? _h : null;
    const gateProfile = (_p = (_m = (_k = (_j = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null || _j === void 0 ? void 0 : _j.profile) !== null && _k !== void 0 ? _k : (_l = checklist === null || checklist === void 0 ? void 0 : checklist.scanScope) === null || _l === void 0 ? void 0 : _l.gateRuleBundleProfile) !== null && _m !== void 0 ? _m : (_o = checklist === null || checklist === void 0 ? void 0 : checklist.hygieneSummary) === null || _o === void 0 ? void 0 : _o.gateRuleBundleProfile) !== null && _p !== void 0 ? _p : null;
    return {
        checklistProfile: ((_q = checklist === null || checklist === void 0 ? void 0 : checklist.scanScope) === null || _q === void 0 ? void 0 : _q.checklistProfile) || 'default',
        resultsViewScope: 'platform-only',
        securityHandoffEligible: false,
        ...(repoTotal != null ? { gateRepositoryFilesTotal: repoTotal } : {}),
        ...(gateProfile ? { gateRuleBundleProfile: gateProfile } : {}),
        sourceArtifacts: {
            gateReport: Boolean(gateReport || ((_s = (_r = checklist === null || checklist === void 0 ? void 0 : checklist.scanScope) === null || _r === void 0 ? void 0 : _r.sourceArtifacts) === null || _s === void 0 ? void 0 : _s.gateReport)),
            npmAudit: Boolean(options.npmAudit || ((_u = (_t = checklist === null || checklist === void 0 ? void 0 : checklist.scanScope) === null || _t === void 0 ? void 0 : _t.sourceArtifacts) === null || _u === void 0 ? void 0 : _u.npmAudit))
        }
    };
}
/**
...
function buildExportNotes(checklist, gateReport, npmAudit, context) {
    ...
    const repoTotal = (_c = (_a = gateReport === null || gateReport === void 0 ? void 0 : gateReport.repositoryFilesTotal) !== null && _a !== void 0 ? _a : (_b = gateReport === null || gateReport === void 0 ? void 0 : gateReport.repositoryInventory) === null || _b === void 0 ? void 0 : _b.totalFiles) !== null && _c !== void 0 ? _c : ruleScopedFromGate(gateReport);
    const credentialScanned = (_e = (_d = gateReport === null || gateReport === void 0 ? void 0 : gateReport.credentialScanned) !== null && _d !== void 0 ? _d : gateReport === null || gateReport === void 0 ? void 0 : gateReport.productionLeakScanned) !== null && _e !== void 0 ? _e : (_f = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null || _f === void 0 ? void 0 : _f.productionDirsScanned;
    if (repoTotal > 0 && credentialScanned != null && credentialScanned < repoTotal) {
        const metadataOnly = repoTotal - credentialScanned;
        notes.push(`CRED/LEAK rules scanned ${Number(credentialScanned).toLocaleString()} production-path file(s) — ${Number(metadataOnly).toLocaleString()} binary/metadata-only path(s) in gate inventory of ${Number(repoTotal).toLocaleString()}.`);
    }
    const fictionJson = (_g = gateReport === null || gateReport === void 0 ? void 0 : gateReport.fictionJsonFilesScanned) !== null && _g !== void 0 ? _g : (_h = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null || _h === void 0 ? void 0 : _h.fictionJsonFilesScanned;
    const fictionSamples = (_j = gateReport === null || gateReport === void 0 ? void 0 : gateReport.fictionSampleFilesScanned) !== null && _j !== void 0 ? _j : (_k = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null || _k === void 0 ? void 0 : _k.fictionSampleFilesScanned;
    ...
    if (summary.operatorDocumentationCount > 0 && ((_l = gateReport === null || gateReport === void 0 ? void 0 : gateReport.euAiActSummary) === null || _l === void 0 ? void 0 : _l.operatorDocumentationCount) != null) {
        notes.push(`${summary.operatorDocumentationCount} operator documentation path(s) in gate EU AI Act summary — use json/eu-ai-act-sprint.json for sprint handoff pack.`);
    }
    const gateProfile = (_s = (_q = (_o = (_m = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null || _m === void 0 ? void 0 : _m.profile) !== null && _o !== void 0 ? _o : (_p = checklist === null || checklist === void 0 ? void 0 : checklist.scanScope) === null || _p === void 0 ? void 0 : _p.gateRuleBundleProfile) !== null && _q !== void 0 ? _q : (_r = checklist === null || checklist === void 0 ? void 0 : checklist.hygieneSummary) === null || _r === void 0 ? void 0 : _r.gateRuleBundleProfile) !== null && _s !== void 0 ? _s : null;
    if (gateProfile) {
        notes.push(`Gate rule bundle profile: ${gateProfile} — pair checklist with json/simplebeacon-gate.json for rule evidence.`);
    }
    const complianceStatus = context.benchmarkScan ? 'benchmark-cache' : context.hollowGate ? 'limited-gate-scope' : ((_t = summary.failed) !== null && _t !== void 0 ? _t : 0) > 0 ? 'failed' : 'pass';
    if (complianceStatus === 'failed' && ((_u = gateReport === null || gateReport === void 0 ? void 0 : gateReport.gate) === null || _u === void 0 ? void 0 : _u.pass) === false) {
        /**
         * Failed ids.
         * @param {any} checklist?.rules || []
         * @returns {any}
         */
        const failedIds = ((checklist === null || checklist === void 0 ? void 0 : checklist.rules) || []).filter((rule) => rule.status === 'fail').map((rule) => rule.id);
        const blocking = (_x = (_w = (_v = gateReport.gate) === null || _v === void 0 ? void 0 : _v.blockingCount) !== null && _w !== void 0 ? _w : gateReport.issueCount) !== null && _x !== void 0 ? _x : null;
        if (failedIds.length) {
            notes.push(`Checklist failures (${failedIds.join(', ')}) align with bundled gate (pass=false${blocking != null ? `, ${Number(blocking).toLocaleString()} blocking finding(s)` : ''}) — see json/simplebeacon-gate.json.`);
        }
    }
...
export function sanitizeComplianceChecklistArtifactExport(checklist, options = {}) {
    ...
    const projectPath = options.projectPath || (checklist === null || checklist === void 0 ? void 0 : checklist.projectRoot) || '';
    ...
    if (options.operatorExport !== false) {
        exportNotes.push('Checklist attests automated rule rows only — securityHandoffEligible remains false until operator vendor sign-off.');
    }
    ...
    const scanScope = buildComplianceScanScope(gateReport, {
        repositoryFilesTotal: (_b = (_a = options.repositoryFilesTotal) !== null && _a !== void 0 ? _a : gateReport === null || gateReport === void 0 ? void 0 : gateReport.repositoryFilesTotal) !== null && _b !== void 0 ? _b : (_c = gateReport === null || gateReport === void 0 ? void 0 : gateReport.repositoryInventory) === null || _c === void 0 ? void 0 : _c.totalFiles,
        npmAudit,
        checklist: { scanScope: checklist === null || checklist === void 0 ? void 0 : checklist.scanScope, hygieneSummary }
    });
    const summary = {
        ...sanitized.summary,
        securityHandoffEligible: false,
    ...
    return {
        ...
        handoffEligible: false,
        scanTargetProfile: ((_e = sanitized.summary) === null || _e === void 0 ? void 0 : _e.scanTargetProfile)
            || (benchmarkScan ? 'benchmark-cache' : hollowGate ? 'limited-gate-scope' : 'product'),
        securityHandoffEligible: false,
        complianceStatus: benchmarkScan ? 'benchmark-cache' : hollowGate ? 'limited-gate-scope' : ((_g = (_f = sanitized.summary) === null || _f === void 0 ? void 0 : _f.failed) !== null && _g !== void 0 ? _g : 0) > 0 ? 'failed' : 'pass',
...
export function sanitizeComplianceBundleExport(payload = {}) {
    ...
    const failed = (_d = (_c = checklist === null || checklist === void 0 ? void 0 : checklist.summary) === null || _c === void 0 ? void 0 : _c.failed) !== null && _d !== void 0 ? _d : 0;
    const pathContext = resolveComplianceExportPathContext(projectPath, context);
    return {
        type: payload.type || 'simplebeacon-compliance-checklist',
        generatedAt: payload.generatedAt || (checklist === null || checklist === void 0 ? void 0 : checklist.evaluatedAt) || new Date().toISOString(),
        ...
        handoffEligible,
        readyForAutomation: (_f = (_e = checklist === null || checklist === void 0 ? void 0 : checklist.summary) === null || _e === void 0 ? void 0 : _e.readyForAutomation) !== null && _f !== void 0 ? _f : false,
