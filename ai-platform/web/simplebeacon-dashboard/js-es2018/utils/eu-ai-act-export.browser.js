...
function resolveProjectLabel(bundle = {}) {
  ...
  return projectLabelFromPath(
    ((_a = bundle.compliance) === null || _a === void 0
      ? void 0
      : _a.projectRoot) ||
      ((_b = bundle.assessment) === null || _b === void 0
        ? void 0
        : _b.projectRoot) ||
      ((_c = bundle.sprintReport) === null || _c === void 0
        ? void 0
        : _c.projectRoot) ||
      ((_d = bundle.embeddedInMainReport) === null || _d === void 0
        ? void 0
        : _d.projectRoot),
  );
}
...
export function resolveGateResult(bundle = {}) {
  ...
  const embeddedAt = parseTimestamp(
    embedded === null || embedded === void 0 ? void 0 : embedded.generatedAt,
  );
  const sprintAt = parseTimestamp(
    (assessment === null || assessment === void 0
      ...
      ((_a = bundle.compliance) === null || _a === void 0
        ? void 0
        : _a.evaluatedAt) ||
      ((_b = bundle.sprintReport) === null || _b === void 0
        ? void 0
        : _b.generatedAt),
  );
  if (
    (embedded === null || embedded === void 0 ? void 0 : embedded.gatePass) !=
      null &&
  ...
  return (_d =
    (_c =
      assessment === null || assessment === void 0
        ? void 0
        : assessment.executiveSummary) === null || _c === void 0
      ? void 0
...
function buildFreshnessNote(bundle = {}) {
  ...
  const embeddedAt = parseTimestamp(
    (_a = bundle.embeddedInMainReport) === null || _a === void 0
      ? void 0
      : _a.generatedAt,
  );
  const sprintAt = parseTimestamp(
    ((_b = bundle.compliance) === null || _b === void 0
      ? void 0
      : _b.evaluatedAt) ||
      ((_c = bundle.assessment) === null || _c === void 0
        ? void 0
        : _c.generatedAt) ||
      ((_d = bundle.sprintReport) === null || _d === void 0
        ? void 0
        : _d.generatedAt),
  );
...
function reconcileScanChecklistRule(rule, embedded = {}) {
  ...
  const cred =
    (_a = embedded.credentialFindings) !== null && _a !== void 0 ? _a : null;
  const leak =
    (_b = embedded.productionLeakFindings) !== null && _b !== void 0
      ? _b
      : null;
  const credScanned =
    (_c = embedded.credentialScanned) !== null && _c !== void 0 ? _c : null;
  const leakScanned =
    (_d = embedded.productionLeakScanned) !== null && _d !== void 0 ? _d : null;
  if (rule.id === "GATE-001") {
    return {
      ...rule,
...
function reconcileComplianceForLiveGate(compliance, bundle = {}) {
  ...
  if (
    !((_a =
      compliance === null || compliance === void 0
        ? void 0
        : compliance.rules) === null || _a === void 0
      ? void 0
      : _a.length)
  )
    return compliance;
  ...
  const score = scored
    ...
    : (_c =
          (_b = compliance.summary) === null || _b === void 0
            ? void 0
  ...
  return {
    ...
    summary: {
      ...
      score,
      headline:
        (_d = buildChecklistHeadline(passed, failed, rules.length)) !== null &&
        _d !== void 0
          ? _d
    ...
    gateReconciledAt:
      (_f = embedded.generatedAt) !== null && _f !== void 0 ? _f : null,
  };
}
/**
  ...
  if (
    !((_b =
      (_a =
        assessment === null || assessment === void 0
          ? void 0
          : assessment.findings) === null || _a === void 0
        ? void 0
...
function resolveSprintGateResult(bundle = {}, assessment = {}) {
  ...
  if (
    (_a =
      assessment === null || assessment === void 0
        ? void 0
        : assessment.executiveSummary) === null || _a === void 0
      ? void 0
      : _a.sprintGateResult
  ) {
  ...
  if (
    ((_f =
      assessment === null || assessment === void 0
        ? void 0
        : assessment.executiveSummary) === null || _f === void 0
      ? void 0
    ...
    return (_h =
      (_g =
        assessment === null || assessment === void 0
          ? void 0
          : assessment.executiveSummary) === null || _g === void 0
        ? void 0
...
function reconcileExecutiveSummaryForLiveGate(executiveSummary, bundle = {}) {
  ...
  const sprintBlocking =
    (_a = executiveSummary.blockingCount) !== null && _a !== void 0 ? _a : 0;
  const next = {
    ...executiveSummary,
    gateResult,
    sprintGateResult,
  ...
  if (freshMetrics.metricsSource === "live-gate-scan" && next.euAiActSummary) {
    next = {
      ...
      euAiActSummary: {
        ...next.euAiActSummary,
        ...((
          (_a = next.euAiActSummary.documentationFound) === null ||
          _a === void 0
            ? void 0
            : _a.length
        )
...
function resolveFreshEuAiActMetrics(bundle = {}) {
  ...
  const embeddedEu =
    (embedded === null || embedded === void 0 ? void 0 : embedded.summary) ||
    {};
  const embeddedNewer =
    embeddedAt != null && sprintAt != null && embeddedAt > sprintAt;
  ...
  return {
    aiSystemIndicators:
      (_f = source.aiSystemIndicators) !== null && _f !== void 0 ? _f : null,
    highRiskIndicators:
      (_g = source.highRiskIndicators) !== null && _g !== void 0 ? _g : null,
    transparencyGaps:
      (_h = source.transparencyGaps) !== null && _h !== void 0 ? _h : null,
            ...
            (_m =
              (_l =
                (_k =
                  assessment === null || assessment === void 0
                    ? void 0
                    : assessment.findings) === null || _k === void 0
                  ? void 0
...
const NOTE_CLASSIFIERS = new Map([
  ...
  [
    /GATE-001 checklist rule reconciled|GATE-001, CRED-001, and LEAK-001 reconciled/i,
...
function sanitizeAssessmentExport(assessment, projectLabel) {
  ...
  return {
    ...
    provenance:
      ((_a = assessment.executiveSummary) === null || _a === void 0
        ? void 0
        : _a.gateResultSource) === "live-gate-scan"
        ? "live-gate-scan-reconciled"
        : "eu-ai-act-sprint-artifact",
    ...(euAiActSummary
      ? {
    ...
    ...(sourceReport
      ? {
          sourceReport: {
            generatedAt:
              (_b = sourceReport.generatedAt) !== null && _b !== void 0
                ? _b
                : null,
            ...
            duplicateGroups:
              (_c = sourceReport.duplicateGroups) !== null && _c !== void 0
                ? _c
                : null,
          },
        }
...
function sanitizeEmbeddedMainReportExport(embedded, projectLabel) {
  ...
  const docSplit = splitDocumentationPaths(
    ((_a = embedded.summary) === null || _a === void 0
      ? void 0
      : _a.documentationFound) || [],
  );
  return {
    generatedAt:
      (_b = embedded.generatedAt) !== null && _b !== void 0 ? _b : null,
    projectRoot: redactProjectPathForExport(embedded.projectRoot, projectLabel),
    euAiActScanned:
      (_c = embedded.euAiActScanned) !== null && _c !== void 0 ? _c : null,
    euAiActFindings:
      (_d = embedded.euAiActFindings) !== null && _d !== void 0 ? _d : null,
    gatePass: (_e = embedded.gatePass) !== null && _e !== void 0 ? _e : null,
    credentialFindings:
      (_f = embedded.credentialFindings) !== null && _f !== void 0 ? _f : null,
    credentialScanned:
      (_g = embedded.credentialScanned) !== null && _g !== void 0 ? _g : null,
    productionLeakFindings:
      (_h = embedded.productionLeakFindings) !== null && _h !== void 0
        ? _h
        : null,
    productionLeakScanned:
      (_j = embedded.productionLeakScanned) !== null && _j !== void 0
        ? _j
        : null,
...
export function buildEuAiActSummary(bundle = {}) {
  ...
  return {
    checklistPassed:
      (_b = summary.passed) !== null && _b !== void 0 ? _b : null,
    checklistTotal: (_c = summary.total) !== null && _c !== void 0 ? _c : null,
    readinessScore:
      (_e =
        (_d = summary.score) !== null && _d !== void 0
          ? _d
          : summary.complianceScore) !== null && _e !== void 0
        ? _e
        : null,
    checklistHeadline:
      (_g =
    ...
    checklistReconciledFrom:
      (_h =
        compliance === null || compliance === void 0
          ? void 0
          : compliance.gateReconciledFrom) !== null && _h !== void 0
        ? _h
        : null,
    gateResult,
    sprintGateResult,
      ...
      (_l =
        (_k =
          (_j =
            compliance === null || compliance === void 0
              ? void 0
              : compliance.evaluatedAt) !== null && _j !== void 0
            ? _j
            : assessment === null || assessment === void 0
              ? void 0
    ...
    mainReportGeneratedAt:
      (_m =
        embedded === null || embedded === void 0
          ? void 0
          : embedded.generatedAt) !== null && _m !== void 0
        ? _m
        : null,
    projectRoot: redactProjectPathForExport(
      (_r =
        (_p =
          (_o =
            compliance === null || compliance === void 0
              ? void 0
              : compliance.projectRoot) !== null && _o !== void 0
            ? _o
            : assessment === null || assessment === void 0
              ? void 0
    ...
    ...((
      (_s =
        assessment === null || assessment === void 0
          ? void 0
          : assessment.executiveSummary) === null || _s === void 0
        ? void 0
...
export function buildEuAiActExportBundle(bundle = {}) {
  ...
  const exportNotes = dedupeExportNotes([
    ...
    ((_b =
      (_a = exportEligibility.errors) === null || _a === void 0
        ? void 0
        : _a[0]) === null || _b === void 0
      ? void 0
      : _b.message)
...
function buildSprintArtifactExportNotes(sprint = {}, options = {}) {
  ...
  if (
    ((_b =
      (_a = sprint.complianceChecklist) === null || _a === void 0
        ? void 0
  ...
  const sprintRepo =
    (_g =
      (_d =
        (_c = sprint.report) === null || _c === void 0
          ? void 0
          : _c.repositoryFilesTotal) !== null && _d !== void 0
        ? _d
        : (_f =
              (_e = sprint.report) === null || _e === void 0
                ? void 0
  ...
  const ruleScoped =
    (_m =
      (_j =
        (_h = sprint.report) === null || _h === void 0
          ? void 0
          : _h.ruleScopedFilesAnalyzed) !== null && _j !== void 0
        ? _j
        : (_l =
              (_k = sprint.report) === null || _k === void 0
                ? void 0
                : _k.scanScope) === null || _l === void 0
          ? void 0
  ...
  const sprintProfile =
    (_q =
      (_p =
        (_o = sprint.report) === null || _o === void 0
          ? void 0
          : _o.scanScope) === null || _p === void 0
        ? void 0
  ...
  const sprintFiction =
    (_s =
      (_r = sprint.report) === null || _r === void 0
        ? void 0
        : _r.fictionJsonFilesScanned) !== null && _s !== void 0
      ? _s
      : (_u =
            (_t = sprint.report) === null || _t === void 0
              ? void 0
              : _t.scanScope) === null || _u === void 0
        ? void 0
  ...
  const nonDocs =
    (_w =
      (_v = sprint.report) === null || _v === void 0
        ? void 0
        : _v.euAiActSummary) === null || _w === void 0
      ? void 0
  ...
  const suppressed =
    (_x = sprint.report) === null || _x === void 0
      ? void 0
      : _x.productionLeakSuppressedIntent;
  if (
    suppressed != null &&
    suppressed > 0 &&
    ((_z =
      (_y = sprint.report) === null || _y === void 0
        ? void 0
        : _y.productionLeakFindings) !== null && _z !== void 0
      ? _z
      : 0) === 0
  ) {
    notes.push(
  ...
  if (
    (_1 =
      (_0 = sprint.assessment) === null || _0 === void 0
        ? void 0
        : _0.pilotProposal) === null || _1 === void 0
      ? void 0
      : _1.pricePlaceholder
  ) {
    notes.push(
  ...
  if (
    ((_2 = sprint.gate) === null || _2 === void 0 ? void 0 : _2.pass) ===
      false ||
    ((_3 = sprint.complianceChecklist) === null || _3 === void 0
      ? void 0
      : _3.complianceStatus) === "failed"
  ) {
    const failedIds = (
      ((_4 = sprint.complianceChecklist) === null || _4 === void 0
        ? void 0
        : _4.rules) || []
    )
  ...
  const reportNotes =
    (_9 = sprint.report) === null || _9 === void 0 ? void 0 : _9.exportNotes;
...
function buildSprintArtifactHygieneSummary(sprint = {}, options = {}) {
  ...
  const sprintRepo =
    (_f =
      (_c =
        (_b = sprint.report) === null || _b === void 0
          ? void 0
          : _b.repositoryFilesTotal) !== null && _c !== void 0
        ? _c
        : (_e =
              (_d = sprint.report) === null || _d === void 0
                ? void 0
  ...
  const ruleScoped =
    (_l =
      (_h =
        (_g = sprint.report) === null || _g === void 0
          ? void 0
          : _g.ruleScopedFilesAnalyzed) !== null && _h !== void 0
        ? _h
        : (_k =
              (_j = sprint.report) === null || _j === void 0
                ? void 0
                : _j.scanScope) === null || _k === void 0
          ? void 0
  ...
  const sprintFiction =
    (_r =
      (_o =
        (_m = sprint.report) === null || _m === void 0
          ? void 0
          : _m.fictionJsonFilesScanned) !== null && _o !== void 0
        ? _o
        : (_q =
              (_p = sprint.report) === null || _p === void 0
                ? void 0
                : _p.scanScope) === null || _q === void 0
          ? void 0
  ...
  const jestChecked =
    (_w =
      (_u =
        (_t =
          (_s = sprint.report) === null || _s === void 0
            ? void 0
            : _s.jestBaselineChecked) !== null && _t !== void 0
          ? _t
  ...
  return {
    ...
    readinessScore:
      (_5 =
        ...
        : null,
    gateResult:
      ((_6 = sprint.gate) === null || _6 === void 0 ? void 0 : _6.pass) ===
      false
        ? "FAIL"
    ...
    operatorDocumentationCount:
      (_14 =
        (_11 = checklist.operatorDocumentationCount) !== null && _11 !== void 0
          ? _11
          : (_13 =
                (_12 = sprint.report) === null || _12 === void 0
                  ? void 0
                  : _12.euAiActSummary) === null || _13 === void 0
            ? void 0
    ...
    euAiActScanned:
      (_19 =
        (_16 =
          (_15 = sprint.report) === null || _15 === void 0
            ? void 0
            : _15.euAiActScanned) !== null && _16 !== void 0
          ? _16
          : (_18 =
                (_17 = sprint.report) === null || _17 === void 0
                  ? void 0
                  : _17.scanScope) === null || _18 === void 0
            ? void 0
    ...
    scanMatchedNonDocsCount:
      (_22 =
        (_21 =
          (_20 = sprint.report) === null || _20 === void 0
            ? void 0
            : _20.euAiActSummary) === null || _21 === void 0
          ? void 0
    ...
    productionLeakSuppressedIntent:
      (_24 =
        (_23 = sprint.report) === null || _23 === void 0
          ? void 0
          : _23.productionLeakSuppressedIntent) !== null && _24 !== void 0
        ? _24
        : null,
    ...
    legalHandoffEligible:
      (_25 = checklist.legalHandoffEligible) !== null && _25 !== void 0
        ? _25
        : null,
...
export function sanitizeEuAiActSprintArtifactExport(sprint, options = {}) {
  ...
  if (
    complianceChecklist === null || complianceChecklist === void 0
      ? void 0
  ...
  if (
    ((_f =
      (_e = sprint.complianceChecklist) === null || _e === void 0
        ? void 0
        : _e.summary) === null || _f === void 0
      ? void 0
...
export function sanitizeEuAiActExport(bundle) {
  ...
  if (bundle.type === "simplebeacon-eu-ai-act-export") {
    return buildEuAiActExportBundle({
      hasData:
        (_b =
          (_a = bundle.summary) === null || _a === void 0
            ? void 0
            : _a.hasData) !== null && _b !== void 0
          ? _b
          : true,
