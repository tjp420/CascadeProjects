...
function buildAssessmentExportNotes(assessment, _projectLabel) {
  ...
  const checklist =
    ((_a = assessment.complianceChecklist) === null || _a === void 0
      ? void 0
      : _a.summary) || {};
  ...
  if (exec.gateResult === "PASS" && checklist.readyForAutomation) {
    ...
    notes.push(
      `Gate FAIL — ${(_b = exec.blockingCount) !== null && _b !== void 0 ? _b : 0} blocking finding(s). Review gate report detectedIssues before merge.`,
    );
  }
...
function reconcileComplianceReady(executiveSummary, checklist, sourceReport) {
  ...
  let ready =
    (_b =
      (_a = summary.readyForAutomation) !== null && _a !== void 0
        ? _a
        : executiveSummary.complianceReady) !== null && _b !== void 0
      ? _b
      : false;
  if (!sourceReport) return ready;
  const ruleScoped =
    (_e =
      (_c = sourceReport.ruleScopedFilesAnalyzed) !== null && _c !== void 0
        ? _c
  ...
  const gatePass = Boolean(
    (_g =
      ...
      null && _g !== void 0
      ? _g
      : executiveSummary.gateResult === "PASS",
  );
  if (
    gatePass &&
    ruleScoped > 0 &&
...
function reconcileExecutiveSummary(assessment, sourceReport) {
  ...
  exec.complianceScore =
    (_c =
      (_b =
        (_a = checklist.summary) === null || _a === void 0
          ? void 0
          : _a.score) !== null && _b !== void 0
        ? _b
        : exec.complianceScore) !== null && _c !== void 0
      ? _c
      : null;
...
export function sanitizeAssessmentExport(assessment, options = {}) {
  ...
  if (sourceReport) {
    ...
    const mockSampleFiles =
      (_e =
        (_d = sourceReport.mockSampleFiles) !== null && _d !== void 0
          ? _d
          : sourceReport.totalFiles) !== null && _e !== void 0
        ? _e
        : null;
    executiveSummary = {
      ...executiveSummary,
      filesScanned:
        (_g =
          (_f =
            ruleScoped !== null && ruleScoped !== void 0
              ? ruleScoped
              : sourceReport.filesAnalyzed) !== null && _f !== void 0
            ? _f
            : sourceReport.repositoryFilesTotal) !== null && _g !== void 0
          ? _g
      ...
      repositoryFilesTotal:
        (_l =
          (_k =
            (_h = sourceReport.repositoryFilesTotal) !== null && _h !== void 0
              ? _h
              : (_j = sourceReport.repositoryInventory) === null ||
                  _j === void 0
                ? void 0
                : _j.totalFiles) !== null && _k !== void 0
            ? _k
            : executiveSummary.repositoryFilesTotal) !== null && _l !== void 0
          ? _l
          : null,
      gateResult: (
        (_m = sourceReport.gate) === null || _m === void 0 ? void 0 : _m.pass
      )
        ? "PASS"
        : "FAIL",
      blockingCount:
        (_q =
          (_p =
            ...
            ? _p
            : executiveSummary.blockingCount) !== null && _q !== void 0
          ? _q
          : 0,
      warningCount:
        (_t =
          (_s =
            (_r = sourceReport.gate) === null || _r === void 0
              ? void 0
              : _r.warningCount) !== null && _s !== void 0
            ? _s
            : executiveSummary.warningCount) !== null && _t !== void 0
          ? _t
          : 0,
      qualityScore:
        (_v =
          (_u = sourceReport.qualityScore) !== null && _u !== void 0
            ? _u
            : executiveSummary.qualityScore) !== null && _v !== void 0
          ? _v
          : null,
    };
  ...
  const sanitizedSource = embeddedSource
    ? {
        generatedAt:
          (_w = embeddedSource.generatedAt) !== null && _w !== void 0
            ? _w
            : null,
        scanPaths:
          (_x = embeddedSource.scanPaths) !== null && _x !== void 0 ? _x : null,
        duplicateGroups:
          (_y = embeddedSource.duplicateGroups) !== null && _y !== void 0
            ? _y
            : null,
      }
    : undefined;
  return {
    ...
    hygieneSummary: {
      gateResult:
        (_z = executiveSummary.gateResult) !== null && _z !== void 0
          ? _z
          : null,
      complianceScore:
        (_0 = executiveSummary.complianceScore) !== null && _0 !== void 0
          ? _0
          : null,
      complianceReady:
        (_1 = executiveSummary.complianceReady) !== null && _1 !== void 0
          ? _1
          : false,
      filesScanned:
        (_2 = executiveSummary.filesScanned) !== null && _2 !== void 0
          ? _2
          : null,
      mockSampleFiles:
        (_3 = executiveSummary.mockSampleFiles) !== null && _3 !== void 0
          ? _3
          : null,
      benchmarkScan,
