...
export function npmAuditSummary(audit) {
  ...
  const summary =
    ...
    ((_a = audit === null || audit === void 0 ? void 0 : audit.metadata) ===
      null || _a === void 0
      ? void 0
      : _a.vulnerabilities) ||
    {};
  const deps =
    ...
    ((_b = audit === null || audit === void 0 ? void 0 : audit.metadata) ===
      null || _b === void 0
      ? void 0
      : _b.dependencies) ||
    {};
  return {
    dependencies:
      (_d =
        (_c = summary.dependencies) !== null && _c !== void 0
          ? _c
          : deps.total) !== null && _d !== void 0
        ? _d
        : null,
    prod:
      (_f =
        (_e = summary.prodDependencies) !== null && _e !== void 0
          ? _e
          : deps.prod) !== null && _f !== void 0
        ? _f
        : null,
    dev:
      (_h =
    ...
    moderate:
      (_m =
        (_l = summary.moderate) !== null && _l !== void 0
          ? _l
          : summary.medium) !== null && _m !== void 0
        ? _m
        : 0,
    low: (_o = summary.low) !== null && _o !== void 0 ? _o : 0,
    vulnerabilityTotal:
      (_q =
        (_p = summary.vulnerabilityTotal) !== null && _p !== void 0
          ? _p
          : summary.total) !== null && _q !== void 0
        ? _q
        : (_s =
              (_r =
                audit === null || audit === void 0
                  ? void 0
                  : audit.vulnerabilities) === null || _r === void 0
                ? void 0
                : _r.length) !== null && _s !== void 0
          ? _s
          : 0,
    generatedAt:
      (_t = audit === null || audit === void 0 ? void 0 : audit.generatedAt) !==
        null && _t !== void 0
        ? _t
        : null,
  };
...
export function sanitizeCoverageExport(coverage) {
  ...
  return {
    ...
    lastRun:
      (_b =
        (_a = clean.lastRun) !== null && _a !== void 0
          ? _a
          : clean.testCountGeneratedAt) !== null && _b !== void 0
        ? _b
        : null,
    freshnessNote:
      clean.lastRun &&
...
export function sanitizeQualityExport(quality, coverage = null, report = null) {
    ...
    (_b =
      (_a =
        coverage === null || coverage === void 0
          ? void 0
          : coverage.totalTests) !== null && _a !== void 0
        ? _a
        : coverage === null || coverage === void 0
          ? void 0
  ...
  const qualTotal =
    (_e =
      (_d =
        (_c = clean.totalTests) !== null && _c !== void 0
          ? _c
          : clean.passedTests) !== null && _d !== void 0
        ? _d
  ...
  const covPassed =
    (_f =
      coverage === null || coverage === void 0
        ? void 0
        : coverage.passedTests) !== null && _f !== void 0
      ? _f
      : null;
  const qualPassed =
    (_h =
      (_g = clean.passedTests) !== null && _g !== void 0
        ? _g
        : clean.testsPassed) !== null && _h !== void 0
      ? _h
      : null;
  const covAt =
    (_j =
      coverage === null || coverage === void 0
        ? void 0
        : coverage.testCountGeneratedAt) !== null && _j !== void 0
      ? _j
      : null;
  const qualAt =
    (_k = clean.testCountGeneratedAt) !== null && _k !== void 0 ? _k : null;
  const covLabel =
    (_l =
      coverage === null || coverage === void 0
        ? void 0
        : coverage.jestTestsLabel) !== null && _l !== void 0
      ? _l
  ...
  if (
    ...
    ((_p =
      coverage === null || coverage === void 0
        ? void 0
        : coverage.failedTests) !== null && _p !== void 0
      ? _p
      : 0) === 0
  ) {
...
function buildMeasuredBaselinesNote(quality, report = null) {
  var _a;
  const catalog =
    quality === null || quality === void 0 ? void 0 : quality.measuredBaselines;
    ...
    summary: {
      lineCoverage:
        (_e =
          (_d =
            coverage === null || coverage === void 0
              ? void 0
              : coverage.overallCoverage) !== null && _d !== void 0
            ? _d
            : coverage === null || coverage === void 0
              ? void 0
      ...
      branchCoverage:
        (_f =
          coverage === null || coverage === void 0
            ? void 0
            : coverage.branchCoverage) !== null && _f !== void 0
          ? _f
          : null,
      functionCoverage:
        (_g =
          coverage === null || coverage === void 0
            ? void 0
            : coverage.functionCoverage) !== null && _g !== void 0
          ? _g
          : null,
      statementCoverage:
        (_h =
          coverage === null || coverage === void 0
            ? void 0
            : coverage.statementCoverage) !== null && _h !== void 0
          ? _h
          : null,
      securityScore:
        (_j =
          security === null || security === void 0
            ? void 0
            : security.securityScore) !== null && _j !== void 0
          ? _j
          : null,
      qualityScore:
        (_l =
          (_k =
            quality === null || quality === void 0
              ? void 0
              : quality.overallScore) !== null && _k !== void 0
            ? _k
            : quality === null || quality === void 0
              ? void 0
      ...
      npmDependencies:
        (_q =
          auditStats === null || auditStats === void 0
            ? void 0
            : auditStats.dependencies) !== null && _q !== void 0
          ? _q
          : null,
      npmCritical:
        (_r =
          auditStats === null || auditStats === void 0
            ? void 0
            : auditStats.critical) !== null && _r !== void 0
          ? _r
          : null,
      npmHigh:
        (_s =
          auditStats === null || auditStats === void 0
            ? void 0
            : auditStats.high) !== null && _s !== void 0
          ? _s
          : null,
      engineeringFindings:
        (_t =
          security === null || security === void 0
            ? void 0
            : security.openEngineeringFindings) !== null && _t !== void 0
          ? _t
          : null,
      complianceRate:
        (_u =
          security === null || security === void 0
            ? void 0
            : security.complianceRate) !== null && _u !== void 0
          ? _u
          : null,
      testsPassed:
        (_v =
          coverage === null || coverage === void 0
            ? void 0
            : coverage.passedTests) !== null && _v !== void 0
          ? _v
          : null,
      testsTotal:
        (_w =
          coverage === null || coverage === void 0
            ? void 0
            : coverage.totalTests) !== null && _w !== void 0
          ? _w
          : null,
      testCountSource:
        (_x =
          coverage === null || coverage === void 0
            ? void 0
            : coverage.testCountSource) !== null && _x !== void 0
          ? _x
          : null,
      testCountStale:
        (_y =
          coverage === null || coverage === void 0
            ? void 0
            : coverage.testCountStale) !== null && _y !== void 0
          ? _y
          : false,
      coverageLastRun:
        (_z =
          coverage === null || coverage === void 0
            ? void 0
            : coverage.lastRun) !== null && _z !== void 0
          ? _z
          : null,
      jestResultAt:
        (_0 =
          coverage === null || coverage === void 0
            ? void 0
            : coverage.testCountGeneratedAt) !== null && _0 !== void 0
          ? _0
          : null,
      npmAuditAt:
        (_1 =
          auditStats === null || auditStats === void 0
            ? void 0
            : auditStats.generatedAt) !== null && _1 !== void 0
          ? _1
          : null,
      measuredBaselines:
        (_2 =
          quality === null || quality === void 0
            ? void 0
            : quality.measuredBaselines) !== null && _2 !== void 0
          ? _2
          : null,
    ...
    hygieneSummary: {
      lineCoverage:
        (_4 =
          (_3 =
            coverage === null || coverage === void 0
              ? void 0
              : coverage.overallCoverage) !== null && _3 !== void 0
            ? _3
            : coverage === null || coverage === void 0
              ? void 0
      ...
      testsTotal:
        (_5 =
          coverage === null || coverage === void 0
            ? void 0
            : coverage.totalTests) !== null && _5 !== void 0
          ? _5
          : null,
      testsPassed:
        (_6 =
          coverage === null || coverage === void 0
            ? void 0
            : coverage.passedTests) !== null && _6 !== void 0
          ? _6
          : null,
      npmVulnerabilities:
        (_7 =
          auditStats === null || auditStats === void 0
            ? void 0
            : auditStats.vulnerabilityTotal) !== null && _7 !== void 0
          ? _7
          : 0,
      npmDependencies:
        (_8 =
          auditStats === null || auditStats === void 0
            ? void 0
            : auditStats.dependencies) !== null && _8 !== void 0
          ? _8
          : null,
      securityScore:
        (_9 =
          security === null || security === void 0
            ? void 0
            : security.securityScore) !== null && _9 !== void 0
          ? _9
          : null,
      qualityScore:
        (_11 =
          (_10 =
            quality === null || quality === void 0
              ? void 0
              : quality.overallScore) !== null && _10 !== void 0
            ? _10
            : quality === null || quality === void 0
              ? void 0
