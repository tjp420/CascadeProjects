    ...
    categories: findings.length
      ? (report.categories || [])
          .map((c) => {
            ...
            return {
              ...c,
              count: (_a = categoryCounts[c.category]) !== null && _a !== void 0 ? _a : 0,
            };
          })
          .filter((c) => c.count > 0)
      : [],
...
function normalizeCodebaseExportPaths(report, scanTargetRoot = '', options = {}) {
  const rawRoot =
    scanTargetRoot || report.projectRoot || report.scanTargetRoot || report.requestedScanRoot || '';
  ...
  return {
    ...report,
    projectRoot:
      redactCodebasePathForExport(report.projectRoot || rawRoot, pathOptions) || redactedRoot,
    ...(report.scanTargetRoot || redactedRoot
      ? {
          scanTargetRoot:
            redactCodebasePathForExport(report.scanTargetRoot || rawRoot, pathOptions) ||
            redactedRoot,
        }
      : {}),
...
function resolveCodebaseHealthStatus(summary) {
  var _a, _b, _c, _d, _e;
  const total =
    (_a = summary === null || summary === void 0 ? void 0 : summary.findingsTotal) !== null &&
    _a !== void 0
      ? _a
      : 0;
  const high =
    (_c =
      (_b = summary === null || summary === void 0 ? void 0 : summary.severityCounts) === null ||
      _b === void 0
        ? void 0
  ...
  const medium =
    (_e =
      (_d = summary === null || summary === void 0 ? void 0 : summary.severityCounts) === null ||
      _d === void 0
        ? void 0
...
function resolveGateInventoryContext(report, options = {}) {
  ...
  const gateProfile =
    (_3 =
      (_1 =
        (_z = (_y = gateReport.scanScope) === null || _y === void 0 ? void 0 : _y.profile) !==
          null && _z !== void 0
          ? _z
  ...
  return {
    ...
    fictionSampleFilesScanned:
      (_14 =
        (_12 =
          (_10 =
            (_9 = gateReport.fictionSampleFilesScanned) !== null && _9 !== void 0
              ? _9
...
function buildProductCodebaseExportNotes(report, context = {}) {
  ...
  if (
    eslintSource === 'none' &&
    ((_c = report.summary) === null || _c === void 0 ? void 0 : _c.eslintSkipped)
  ) {
  ...
  const auditFiles =
    (_k = (_j = report.repositoryInventory) === null || _j === void 0 ? void 0 : _j.totalFiles) !==
      null && _k !== void 0
      ? _k
  ...
  if (
    ((_o = (_m = report.summary) === null || _m === void 0 ? void 0 : _m.findingsTotal) !== null &&
    _o !== void 0
      ? _o
      : 0) === 0
  ) {
  ...
  if (
    ...
    ((_q = report.hygieneSummary) === null || _q === void 0 ? void 0 : _q.jestBaselineChecked) ===
      false
  ) {
    notes.push(
  ...
  const medium =
    (_t =
      (_s = (_r = report.summary) === null || _r === void 0 ? void 0 : _r.severityCounts) ===
        null || _s === void 0
        ? void 0
  ...
  const high =
    (_w =
      (_v = (_u = report.summary) === null || _u === void 0 ? void 0 : _u.severityCounts) ===
        null || _v === void 0
        ? void 0
  ...
  const eslintFindings =
    (_z =
      (_y = (_x = report.summary) === null || _x === void 0 ? void 0 : _x.categoryCounts) ===
        null || _y === void 0
        ? void 0
...
function buildProductCodebaseHygieneSummary(report, options = {}) {
  ...
  const auditFiles =
    (_c =
      (_b =
        (_a = report.repositoryInventory) === null || _a === void 0 ? void 0 : _a.totalFiles) !==
        null && _b !== void 0
        ? _b
  ...
  return {
    ...
    eslintSource:
      ...
      ((_g = report.eslintSummary) === null || _g === void 0 ? void 0 : _g.source) ||
      'none',
    eslintWarnings:
      (_k =
    ...
    mediumSeverityFindings:
      (_m = (_l = summary.severityCounts) === null || _l === void 0 ? void 0 : _l.medium) !==
        null && _m !== void 0
        ? _m
        : 0,
    highSeverityFindings:
      (_p = (_o = summary.severityCounts) === null || _o === void 0 ? void 0 : _o.high) !== null &&
      _p !== void 0
        ? _p
        : 0,
    ...(gateReport.jestBaselineChecked === false ||
...
function annotateStructureInsights(structureInsights) {
  ...
  const langs =
    ((_b = structureInsights.summary) === null || _b === void 0 ? void 0 : _b.byLanguage) || {};
  ...
  if (
    docHeavy &&
    ((_c = structureInsights.summary) === null || _c === void 0 ? void 0 : _c.tier) === 'baseline'
  ) {
    const sampled =
      (_e =
        (_d = structureInsights.summary) === null || _d === void 0 ? void 0 : _d.sampledFiles) !==
        null && _e !== void 0
        ? _e
...
export function sanitizeCodebaseReportExport(report, options = {}) {
  ...
  const eslintSource =
    ...
    'none';
  const eslintSkipped =
    ((_c = next.summary) === null || _c === void 0 ? void 0 : _c.eslintSkipped) || null;
  ...
  if (benchmarkScan) {
    ...
    next = {
      ...
      hygieneSummary: {
        healthScore:
          (_e = (_d = next.summary) === null || _d === void 0 ? void 0 : _d.healthScore) !== null &&
          _e !== void 0
            ? _e
            : null,
        findingsTotal:
          (_g = (_f = next.summary) === null || _f === void 0 ? void 0 : _f.findingsTotal) !==
            null && _g !== void 0
            ? _g
            : 0,
        codeFilesAnalyzed:
          (_j = (_h = next.summary) === null || _h === void 0 ? void 0 : _h.codeFilesAnalyzed) !==
            null && _j !== void 0
            ? _j
            : null,
        repositoryFilesTotal:
          (_o =
            (_l =
              (_k = next.summary) === null || _k === void 0 ? void 0 : _k.repositoryFilesTotal) !==
              null && _l !== void 0
              ? _l
    ...
    const builtNotes = buildProductCodebaseExportNotes(next, {
      ...
      gateRepositoryFilesTotal:
        (_q = options.repositoryFilesTotal) !== null && _q !== void 0 ? _q : null,
