...
function isNodeModulesPath(relativePath) {
  const norm = normalizePath(relativePath);
  return (
    norm === 'node_modules' || norm.endsWith('/node_modules') || norm.includes('/node_modules/')
  );
}
/**
 * Classify directory.
...
function isDirectoryArtifact(finding) {
  return (
    (finding === null || finding === void 0 ? void 0 : finding.action) === 'safe-to-delete' &&
...
export function resolveFileReductionPlan(fileReduction) {
  ...
  if (
    ((_b =
      (_a = existing === null || existing === void 0 ? void 0 : existing.safeToDelete) === null ||
      _a === void 0
        ? void 0
        : _a.topDirectories) === null || _b === void 0
      ? void 0
      : _b.length) ||
    ((_c = existing === null || existing === void 0 ? void 0 : existing.totals) === null ||
    _c === void 0
      ? void 0
  ...
  const buildArtifacts =
    ((_d = fileReduction.findings) === null || _d === void 0 ? void 0 : _d.buildArtifacts) || [];
  const assetConsolidation =
    ((_e = fileReduction.findings) === null || _e === void 0 ? void 0 : _e.assetConsolidation) ||
    [];
  const directoryBloat =
    ((_f = fileReduction.findings) === null || _f === void 0 ? void 0 : _f.directoryBloat) || [];
  const buildSummary =
    ((_g = fileReduction.scanners) === null || _g === void 0 ? void 0 : _g['build-artifacts']) ||
    {};
  const assetSummary =
    ((_h = fileReduction.scanners) === null || _h === void 0
      ? void 0
      : _h['asset-consolidation']) || {};
  const unusedSummary =
    ((_j = fileReduction.scanners) === null || _j === void 0 ? void 0 : _j['unused-files']) || {};
  ...
  const safeBytes =
    (_k = buildSummary.safeToDeleteBytes) !== null && _k !== void 0
      ? _k
      : safeDirectories.reduce((sum, entry) => sum + (entry.bytes || 0), 0);
  const reviewBytes =
    (_l = buildSummary.reviewBeforeDeleteBytes) !== null && _l !== void 0
      ? _l
      : reviewLogs.reduce((sum, entry) => sum + (entry.bytes || 0), 0);
  const duplicateBytes =
    (_m = assetSummary.reclaimableBytes) !== null && _m !== void 0
      ? _m
      : assetConsolidation.reduce((sum, group) => sum + (group.reclaimableBytes || 0), 0);
  const unusedCandidates =
    (_q =
      (_o = unusedSummary.unusedCandidates) !== null && _o !== void 0
        ? _o
        : (_p = fileReduction.summary) === null || _p === void 0
          ? void 0
          : _p.unusedFileCandidates) !== null && _q !== void 0
      ? _q
      : 0;
  if (
    !safeDirectories.length &&
    !safeBytes &&
    !unusedCandidates &&
    !duplicateBytes &&
    !reviewLogs.length
  ...
  return {
    scopeNote:
      (existing === null || existing === void 0 ? void 0 : existing.scopeNote) ||
      'Synthesized from scan summaries — re-run file reduction if tiers look incomplete.',
    totals: {
      reclaimableBytes:
        (_t =
          (_s =
            (_r = fileReduction.summary) === null || _r === void 0
              ? void 0
              : _r.reclaimableBytes) !== null && _s !== void 0
            ? _s
            : buildSummary.reclaimableBytes) !== null && _t !== void 0
          ? _t
          : safeBytes + duplicateBytes,
    ...
    unusedFiles: {
      ...
      note:
        ((_u = existing === null || existing === void 0 ? void 0 : existing.unusedFiles) === null ||
        _u === void 0
          ? void 0
          : _u.note) ||
...
export function isCleanupBriefRunnable({ brief, fileReduction, dataQuality } = {}) {
  ...
  if (
    ((_a = brief === null || brief === void 0 ? void 0 : brief.inventory) === null || _a === void 0
      ? void 0
      : _a.totalFiles) != null
  )
    return true;
  if (
    ...
    return true;
  if (
    ((_c = dataQuality === null || dataQuality === void 0 ? void 0 : dataQuality.inventory) ===
      null || _c === void 0
      ? void 0
      : _c.totalFiles) != null
  )
  ...
  if ((dataQuality === null || dataQuality === void 0 ? void 0 : dataQuality.summary) != null)
    return true;
  if (
    (_d = brief === null || brief === void 0 ? void 0 : brief.scanAnalysis) === null ||
    _d === void 0
      ? void 0
      : _d.dataQuality
  )
    return true;
  if (
    (_e = brief === null || brief === void 0 ? void 0 : brief.scanAnalysis) === null ||
    _e === void 0
      ? void 0
      : _e.fileReduction
  )
    return true;
  if (
    (((_f = brief === null || brief === void 0 ? void 0 : brief.estimatedReduction) === null ||
    _f === void 0
      ? void 0
      : _f.files) || 0) > 0
  )
  ...
  if (
    (((_h =
      (_g = brief === null || brief === void 0 ? void 0 : brief.tiers) === null || _g === void 0
        ? void 0
        : _g.investigate) === null || _h === void 0
      ? void 0
      : _h.files) || 0) > 0
  )
    return true;
  if (
    (((_j = brief === null || brief === void 0 ? void 0 : brief.dataQualityActions) === null ||
    _j === void 0
      ? void 0
      : _j.length) || 0) > 0
  )
...
export function buildCleanupAssistantConclusion(brief) {
  ...
  const files =
    ((_a = brief.estimatedReduction) === null || _a === void 0 ? void 0 : _a.files) || 0;
  const bytes =
    ((_b = brief.estimatedReduction) === null || _b === void 0 ? void 0 : _b.bytes) || 0;
...
export function buildCleanupAssistantBrief({
  ...
  const inventory = {
    totalFiles:
      (_c =
        (_a =
          repositoryInventory === null || repositoryInventory === void 0
            ? void 0
            : repositoryInventory.totalFiles) !== null && _a !== void 0
          ? _a
          : (_b =
                fileReduction === null || fileReduction === void 0
                  ? void 0
                  : fileReduction.inventory) === null || _b === void 0
            ? void 0
    ...
    totalFolders:
      (_f =
        (_d =
          repositoryInventory === null || repositoryInventory === void 0
            ? void 0
            : repositoryInventory.totalFolders) !== null && _d !== void 0
          ? _d
          : (_e =
                fileReduction === null || fileReduction === void 0
                  ? void 0
                  : fileReduction.inventory) === null || _e === void 0
            ? void 0
            : _e.totalDirectories) !== null && _f !== void 0
        ? _f
        : null,
  };
  const tiers = {
    ...
    investigate: {
      files:
        (_h = (_g = plan.unusedFiles) === null || _g === void 0 ? void 0 : _g.candidates) !==
          null && _h !== void 0
          ? _h
          : 0,
      note: ((_j = plan.unusedFiles) === null || _j === void 0 ? void 0 : _j.note) || null,
    },
  };
  const skippedArtifactDirectories = [];
  for (const entry of ((_k = plan.safeToDelete) === null || _k === void 0
    ? void 0
    : _k.topDirectories) || []) {
    ...
    if (tier === 'protected') {
      ...
      tiers.reviewFirst.items.push({
        ...payload,
        reason: isNodeModulesPath(entry.path)
          ? 'node_modules disabled in policy'
          : 'scan cache disabled in policy',
      });
    } else {
  ...
  for (const entry of ((_l = plan.reviewBeforeDelete) === null || _l === void 0
    ? void 0
    : _l.logs) || []) {
  ...
  const projectedInventory = {
    totalFiles:
      inventory.totalFiles != null ? Math.max(0, inventory.totalFiles - tiers.safeNow.files) : null,
  ...
  return {
    ...
    duplicateAssets:
      ((_o = (_m = plan.duplicateAssets) === null || _m === void 0 ? void 0 : _m.topGroups) ===
        null || _o === void 0
        ? void 0
        : _o.slice(0, 8)) || [],
    ...
    sourceScans: {
      ...
      fileReductionPlanPresent: Boolean(
        (fileReduction === null || fileReduction === void 0
          ? void 0
          : fileReduction.fileReductionPlan) ||
        ((_q =
          (_p = plan === null || plan === void 0 ? void 0 : plan.safeToDelete) === null ||
          _p === void 0
            ? void 0
            : _p.topDirectories) === null || _q === void 0
          ? void 0
          : _q.length)
      ),
      synthesizedPlan: Boolean(
        ...
        !fileReduction.fileReductionPlan &&
        ((_s =
          (_r = plan === null || plan === void 0 ? void 0 : plan.safeToDelete) === null ||
          _r === void 0
            ? void 0
            : _r.topDirectories) === null || _s === void 0
          ? void 0
          : _s.length)
      ),
    },
...
function resolveCleanupScanInputs(lastResult) {
  ...
  if (lastResult.kind === 'complete' && Array.isArray(lastResult.steps)) {
    ...
    return {
      ...
      fileReduction:
        (cleanupStep === null || cleanupStep === void 0 ? void 0 : cleanupStep.fileReduction) ||
        (fileReductionStep === null || fileReductionStep === void 0
          ? void 0
          : fileReductionStep.scan) ||
        null,
      dataQuality:
        (cleanupStep === null || cleanupStep === void 0 ? void 0 : cleanupStep.dataQuality) ||
        (dataQualityStep === null || dataQualityStep === void 0 ? void 0 : dataQualityStep.scan) ||
        null,
      repositoryInventory:
        (cleanupStep === null || cleanupStep === void 0
          ? void 0
          : cleanupStep.repositoryInventory) ||
        lastResult.repositoryInventory ||
        null,
      policy:
...
export function readCleanupPolicyFromDom(root) {
  var _a, _b;
  const textarea =
    root === null || root === void 0 ? void 0 : root.querySelector('#cleanup-protected-paths');
  const protectedPaths = String(
    (textarea === null || textarea === void 0 ? void 0 : textarea.value) || ''
  )
    .split(/\r?\n/)
    .map((line) => line.trim())
    .filter(Boolean);
    ...
    allowNodeModules: Boolean(
      (_a =
        root === null || root === void 0
          ? void 0
          : root.querySelector('#cleanup-allow-node-modules')) === null || _a === void 0
        ? void 0
        : _a.checked
    ),
    allowSimplebeaconCache: Boolean(
      (_b =
        root === null || root === void 0
          ? void 0
          : root.querySelector('#cleanup-allow-simplebeacon')) === null || _b === void 0
        ? void 0
        : _b.checked
    ),
    aggressiveness: 'moderate',
