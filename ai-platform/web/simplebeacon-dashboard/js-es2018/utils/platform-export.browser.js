...
function resolveCanonicalJestLabel(baseline, dashboardHome, coverage) {
  ...
  const baseAt =
    (_a = baseline === null || baseline === void 0 ? void 0 : baseline.syncedAt) !== null &&
    _a !== void 0
      ? _a
...
export function buildPlatformMetrics(
  ...
  return {
    mockScanFiles:
      (_b =
        (_a = report === null || report === void 0 ? void 0 : report.mockSampleFiles) !== null &&
        _a !== void 0
          ? _a
        ...
        : overview.totalFiles,
    qualityScore:
      (_c = report === null || report === void 0 ? void 0 : report.qualityScore) !== null &&
      _c !== void 0
        ? _c
        : parseNumeric(overview.codeQuality),
    schemaPassRate:
      (_d = report === null || report === void 0 ? void 0 : report.schemaCompliance) !== null &&
      _d !== void 0
        ? _d
        : overview.schemaPassRate,
    scannerIssues:
      (_e = report === null || report === void 0 ? void 0 : report.issueCount) !== null &&
      _e !== void 0
        ? _e
    ...
    sampleJsonFiles:
      (_h =
        (_g = report === null || report === void 0 ? void 0 : report.mockSampleFiles) !== null &&
        _g !== void 0
          ? _g
          : report === null || report === void 0
            ? void 0
...
export function buildComparativeRows(home, metrics) {
  ...
  const liveByMetric = {
    'jest tests': {
      current:
        (_b = parseNumeric(
          (_a = metrics.jestTests) === null || _a === void 0 ? void 0 : _a.split('/')[0]
        )) !== null && _b !== void 0
          ? _b
...
export function buildPlatformExportBundle({
  ...
  const securityNote =
    ...
    ((_d = dashboardHome === null || dashboardHome === void 0 ? void 0 : dashboardHome.overview) ===
      null || _d === void 0
      ? void 0
  ...
  const subtitle = normalizeSimpleBeaconBranding(
    benchmarkScan
      ...
      : (dashboardHome === null || dashboardHome === void 0 ? void 0 : dashboardHome.subtitle) ||
          defaultSubtitle
  );
  return {
    ...
    summary: {
      ...
      lineCoverage:
        (_r =
          (_q = coverage === null || coverage === void 0 ? void 0 : coverage.overallCoverage) !==
            null && _q !== void 0
            ? _q
          ...
          : null,
      branchCoverage:
        (_s = coverage === null || coverage === void 0 ? void 0 : coverage.branchCoverage) !==
          null && _s !== void 0
          ? _s
          : null,
      ...
      gatePass:
        (_y =
          (_w =
            (_v = report === null || report === void 0 ? void 0 : report.gate) === null ||
            _v === void 0
              ? void 0
      ...
      ruleScopedFilesAnalyzed:
        (_2 =
          (_0 = report === null || report === void 0 ? void 0 : report.ruleScopedFilesAnalyzed) !==
            null && _0 !== void 0
            ? _0
          ...
          : null,
      reportGeneratedAt:
        (_3 = report === null || report === void 0 ? void 0 : report.generatedAt) !== null &&
        _3 !== void 0
          ? _3
          : null,
      coverageLastRun:
        (_4 = coverage === null || coverage === void 0 ? void 0 : coverage.lastRun) !== null &&
        _4 !== void 0
          ? _4
          : null,
      jestResultAt:
        (_5 = coverage === null || coverage === void 0 ? void 0 : coverage.testCountGeneratedAt) !==
          null && _5 !== void 0
          ? _5
          : null,
      pageSpecCatalogSize:
    ...
    comparativeAnalysis,
    insights:
      (dashboardHome === null || dashboardHome === void 0 ? void 0 : dashboardHome.insights) || [],
    mockDataCategories:
      (report === null || report === void 0 ? void 0 : report.mockDataCategories) || [],
    ...
    hygieneSummary: {
      gatePass:
        (_10 =
          (_9 =
            sanitizedReport === null || sanitizedReport === void 0
              ? void 0
              : sanitizedReport.gate) === null || _9 === void 0
            ? void 0
      ...
      ruleScopedFilesAnalyzed:
        (_14 =
          (_12 = report === null || report === void 0 ? void 0 : report.ruleScopedFilesAnalyzed) !==
            null && _12 !== void 0
            ? _12
      ...
      lineCoverage:
        (_17 =
          (_16 = coverage === null || coverage === void 0 ? void 0 : coverage.overallCoverage) !==
            null && _16 !== void 0
            ? _16
            : coverage === null || coverage === void 0
              ? void 0
