...
function isBenchmarkComplianceAudit(audit = {}) {
  ...
  return (
    Boolean(
      ...
      ((_c = audit.report) === null || _c === void 0 ? void 0 : _c.scanTargetProfile) ===
        'benchmark-cache'
...
function resolveCanonicalJestLabel(audit = {}) {
  ...
  const pageSampleAt = parseTimestamp(
    (_b = (_a = audit.pageSamples) === null || _a === void 0 ? void 0 : _a.baselineComparison) ===
      null || _b === void 0
      ? void 0
      : _b.generatedAt
  );
  ...
  const pageLabel =
    ((_f =
      (_e = (_d = audit.pageSamples) === null || _d === void 0 ? void 0 : _d.baselineComparison) ===
        null || _e === void 0
        ? void 0
  ...
  const layerLabel =
    (_j = (_h = audit.auditLayers) === null || _h === void 0 ? void 0 : _h.jestBaseline) === null ||
    _j === void 0
      ? void 0
      : _j.label;
...
function buildPageSpecsMismatchNote(audit = {}, pageSpecsLabel) {
  ...
  const baselineStatus =
    ((_a = audit.dashboard) === null || _a === void 0 ? void 0 : _a.baselineStatus) || {};
...
export function buildAuditMetrics(audit = {}) {
  ...
  return {
    ...
    inventoryRoot:
      (_r =
        (_q = inventory === null || inventory === void 0 ? void 0 : inventory.projectRoot) !==
          null && _q !== void 0
          ? _q
        ...
        : null,
    qualityScore:
      (_t = (_s = report.qualityScore) !== null && _s !== void 0 ? _s : dash.qualityScore) !==
        null && _t !== void 0
        ? _t
        : null,
...
export function buildComplianceAuditSummary(audit = {}) {
  ...
  const exec =
    ((_a = audit.assessment) === null || _a === void 0 ? void 0 : _a.executiveSummary) || {};
  const checklist =
    ((_c = (_b = audit.assessment) === null || _b === void 0 ? void 0 : _b.complianceChecklist) ===
      null || _c === void 0
      ? void 0
      : _c.summary) || {};
  ...
  return {
    ...
    ruleScopedFilesAnalyzed:
      (_r = metrics.ruleScopedFilesAnalyzed) !== null && _r !== void 0 ? _r : null,
    ...
    fictionActiveFindings:
      (_w = (_v = layers.fictionKpis) === null || _v === void 0 ? void 0 : _v.findings) !== null &&
      _w !== void 0
        ? _w
        : null,
    npmDependencies:
      (_x = npmStats === null || npmStats === void 0 ? void 0 : npmStats.dependencies) !== null &&
      _x !== void 0
        ? _x
        : null,
    npmVulnerabilities:
      (_y = npmStats === null || npmStats === void 0 ? void 0 : npmStats.vulnerabilityTotal) !==
        null && _y !== void 0
        ? _y
        : null,
    npmAuditAt:
      (_z = npmStats === null || npmStats === void 0 ? void 0 : npmStats.generatedAt) !== null &&
      _z !== void 0
        ? _z
        : null,
    npmAuditScope:
      benchmarkScan && npmProjectLabel !== projectLabel ? 'product-platform' : 'aligned',
...
function reconcileAssessmentFromReport(assessment, report) {
  ...
  if (findings.productionLeaks) {
    const count =
      (_b = report.productionLeakFindings) !== null && _b !== void 0 ? _b : productionLeaks.length;
  ...
  return {
    ...
    executiveSummary: {
      ...
      gateResult: ((_c = report.gate) === null || _c === void 0 ? void 0 : _c.pass)
        ? 'PASS'
        : 'FAIL',
      ...
      blockingCount:
        (_k =
          (_h = (_g = report.gate) === null || _g === void 0 ? void 0 : _g.blockingCount) !==
            null && _h !== void 0
            ? _h
...
function sanitizeReportExport(report, projectLabel, options = {}) {
  ...
  return {
    ...
    blockingCount:
      (_e =
        (_d = (_c = sanitized.gate) === null || _c === void 0 ? void 0 : _c.blockingCount) !==
          null && _d !== void 0
          ? _d
    ...
    warningCount:
      (_h =
        (_g = (_f = sanitized.gate) === null || _f === void 0 ? void 0 : _f.warningCount) !==
          null && _g !== void 0
          ? _g
    ...
    ...(sourceReport
      ? {
          sourceReport: {
            ...
            duplicateGroups:
              (_b = sourceReport.duplicateGroups) !== null && _b !== void 0 ? _b : null,
          },
        }
      : {}),
  };
...
function sanitizeDashboardExport(dashboard, audit = {}) {
  ...
  const report = audit.report || {};
  const gate =
    report.gate || ((_a = audit.auditLayers) === null || _a === void 0 ? void 0 : _a.gate) || {};
  const next = {
    ...rest,
  ...
  if (next.scanStatus && gate.pass != null) {
    ...
    next.scanStatus = {
      ...
      gatePass: gate.pass,
      issueCount:
        (_c = (_b = gate.blockingCount) !== null && _b !== void 0 ? _b : report.issueCount) !==
          null && _c !== void 0
          ? _c
          : next.scanStatus.issueCount,
      blockingCount:
        (_d = gate.blockingCount) !== null && _d !== void 0 ? _d : next.scanStatus.blockingCount,
      warningCount:
        (_e = gate.warningCount) !== null && _e !== void 0 ? _e : next.scanStatus.warningCount,
      qualityScore:
        (_f = report.qualityScore) !== null && _f !== void 0 ? _f : next.scanStatus.qualityScore,
...
export function buildAuditLayersCsv(auditLayers = {}) {
  ...
  const rows = keys.map((key) => {
    ...
    const checked =
      (_c =
        (_b = (_a = layer.scanned) !== null && _a !== void 0 ? _a : layer.checked) !== null &&
        _b !== void 0
          ? _b
        ...
        : '';
    const findings =
      (_e = (_d = layer.findings) !== null && _d !== void 0 ? _d : layer.blockingCount) !== null &&
      _e !== void 0
        ? _e
        : '';
    return [
...
export function buildAssessmentChecklistCsv(assessment) {
  ...
  const rules =
    (_a =
      assessment === null || assessment === void 0 ? void 0 : assessment.complianceChecklist) ===
      null || _a === void 0
      ? void 0
      : _a.rules;
