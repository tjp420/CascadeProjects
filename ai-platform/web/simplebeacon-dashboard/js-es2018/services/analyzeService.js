...
function normalizeScanReport(rawReport) {
  ...
  const ruleScopedFilesAnalyzed =
    rawReport.ruleScopedFilesAnalyzed ?? summary.ruleScopedFilesAnalyzed ?? null;
...
export async function summarizeReport(report, options = {}) {
  ...
  const res = await fetch(resolveApiUrl('/api/analyze/summary'), {
    ...
    body: JSON.stringify({
      report: slim,
      reportType:
        options.reportType || (report === null || report === void 0 ? void 0 : report.type),
...
export function slimCompleteScanForAudit(exportPayload, options = {}) {
  ...
  const slimCleanupAssistant = results.cleanupAssistant
    ? {
        ...
        tiers: {
          safeNow: (
            (_b = results.cleanupAssistant.tiers) === null || _b === void 0 ? void 0 : _b.safeNow
          )
            ? {
  ...
  if (exportPayload.type === 'data-cleanup-report') {
    ...
    return {
      ...
      summary: {
        ...
        dataQualityFindings:
          (_c =
            (_b = exportPayload.summary) === null || _b === void 0 ? void 0 : _b.totalFindings) !==
            null && _c !== void 0
            ? _c
            : null,
        fileReductionFindings:
          (_e =
            (_d = exportPayload.summary) === null || _d === void 0 ? void 0 : _d.totalFindings) !==
            null && _e !== void 0
            ? _e
            : null,
      },
...
function gatePassFromExportScan(normalized) {
  var _a, _b, _c;
  const results =
    (normalized === null || normalized === void 0 ? void 0 : normalized.results) || {};
  const fromGate =
    (_b = (_a = results.simplebeacon) === null || _a === void 0 ? void 0 : _a.gate) === null ||
    _b === void 0
      ? void 0
      : _b.pass;
  if (fromGate === true || fromGate === false) return fromGate;
  const fromSummary =
    (_c = normalized === null || normalized === void 0 ? void 0 : normalized.summary) === null ||
    _c === void 0
      ? void 0
...
function codeFilesFromExportScan(normalized) {
  ...
  const value =
    (_c =
      (_b =
        (_a = normalized === null || normalized === void 0 ? void 0 : normalized.results) ===
          null || _a === void 0
          ? void 0
...
function detectSupplementaryExportStep(normalized) {
  ...
  const results =
    (normalized === null || normalized === void 0 ? void 0 : normalized.results) || {};
  const scanKind =
    (_a = normalized === null || normalized === void 0 ? void 0 : normalized.summary) === null ||
    _a === void 0
      ? void 0
      : _a.scanKind;
...
export async function fetchDataCleanupScan(projectPath, options = {}) {
  ...
  try {
    ...
    if (profile === 'file-reduction') {
      const hasSignal =
        ((_c = (_b = scan.fileReductionPlan) === null || _b === void 0 ? void 0 : _b.totals) ===
          null || _c === void 0
          ? void 0
          : _c.safeToDeleteBytes) != null ||
        ((_f =
          (_e =
            (_d = scan.fileReductionPlan) === null || _d === void 0 ? void 0 : _d.safeToDelete) ===
            null || _e === void 0
            ? void 0
            : _e.topDirectories) === null || _f === void 0
          ? void 0
          : _f.length) ||
        ((_h = (_g = scan.scanners) === null || _g === void 0 ? void 0 : _g['build-artifacts']) ===
          null || _h === void 0
          ? void 0
...
export function scanHintsGameMod(scan) {
  ...
  const insights =
    ((_a = scan.codeUnderstanding) === null || _a === void 0 ? void 0 : _a.fileInsights) || [];
  return insights.some((item) => {
    var _a, _b, _c, _d, _e, _f, _g;
    const domains =
      ((_d =
        (_c =
          (_b = (_a = item.understanding) === null || _a === void 0 ? void 0 : _a.layers) ===
            null || _b === void 0
            ? void 0
...
export async function refreshPathInventory(app, projectPath, options = {}) {
  ...
  const promise = (async () => {
    try {
      ...
      const root =
        (inventory === null || inventory === void 0 ? void 0 : inventory.projectRoot) || path;
      if (
...
export function buildPathInventoryProvenance(app, projectPath, report = null) {
  ...
  return buildInventoryProvenance(resolvedReport, projectPath, {
    ...
    inventoryFetchedAt:
      (_a = live === null || live === void 0 ? void 0 : live.fetchedAt) !== null && _a !== void 0
        ? _a
        : null,
  });
}
...
export function convertSandboxReportToSimplebeacon(report, projectPath) {
  ...
  const gatePass =
    blockingCount === 0 && (severityCounts.high || 0) === 0 && cert.letterGrade !== 'F';
...
export function isClientScanReport(report) {
  return Boolean(
    report &&
    (report.scanSource === 'browser-sandbox' ||
      report.scanSource === 'browser-local' ||
      report.clientScan === true)
  );
}
...
function buildScanScope(report, benchmarkCacheIssues, staleFullTreeScan) {
  ...
  scope.rescanRecommended =
    staleFullTreeScan || benchmarkCacheIssues.length > 0 || Boolean(scope.rescanRecommended);
  return scope;
}
...
export function preparePlatformResultsReport(report) {
  ...
  const walkedFiles =
    (_h =
      (_g = report.ruleScopedFilesAnalyzed) !== null && _g !== void 0 ? _g : report.totalFiles) !==
      null && _h !== void 0
      ? _h
      : 0;
  const fullTree = Boolean(
    report.fullDirectoryScan ||
    ((_j = report.scanScope) === null || _j === void 0 ? void 0 : _j.fullDirectoryScan)
  );
  ...
  const weightedPenalty = platformIssues
    ...
    .reduce(
      (sum, issue) =>
        sum + (severityWeight[issue.severityBand || issue.severity] || 1) * (issue.count || 1),
      0
    );
  ...
  const qualityScore =
    report.qualityScore ?? (platformIssues.length > 0 ? computedQualityScore : null);
  return {
    ...report,
...
export function resolveCompleteScanTargetPath(projectPath, priorSteps = []) {
  ...
  const report =
    (_a = priorSteps.find(
      (step) => (step === null || step === void 0 ? void 0 : step.id) === 'simplebeacon'
    )) === null || _a === void 0
      ? void 0
      : _a.report;
...
export function buildInventoryProvenance(report, requestedPath, options = {}) {
  ...
  const reportInventory =
    ((_a = report === null || report === void 0 ? void 0 : report.repositoryInventory) === null ||
    _a === void 0
      ? void 0
      : _a.totalFiles) != null
      ? report.repositoryInventory
  ...
  const liveRoot =
    (liveInventory === null || liveInventory === void 0 ? void 0 : liveInventory.projectRoot) ||
    requested ||
    null;
  ...
  const inventoryRoot =
    (_h =
      (_g =
        (_f = inventory === null || inventory === void 0 ? void 0 : inventory.projectRoot) !==
          null && _f !== void 0
          ? _f
          : reportAligned
            ? reportRoot
      ...
      : null;
  const profile =
    (inventory === null || inventory === void 0 ? void 0 : inventory.profile) || 'explorer';
  const files =
    (_j = inventory === null || inventory === void 0 ? void 0 : inventory.totalFiles) !== null &&
    _j !== void 0
      ? _j
      : reportAligned
        ? (_k = report === null || report === void 0 ? void 0 : report.repositoryFilesTotal) !==
            null && _k !== void 0
          ? _k
          : reportInventory === null || reportInventory === void 0
            ? void 0
        ...
        : null;
  const folders =
    (_l = inventory === null || inventory === void 0 ? void 0 : inventory.totalFolders) !== null &&
    _l !== void 0
      ? _l
      : reportAligned
        ? (_m = report === null || report === void 0 ? void 0 : report.repositoryFoldersTotal) !==
            null && _m !== void 0
          ? _m
          : reportInventory === null || reportInventory === void 0
            ? void 0
  ...
  const ruleScoped = reportAligned
    ? (_q =
        (_o = report === null || report === void 0 ? void 0 : report.ruleScopedFilesAnalyzed) !==
          null && _o !== void 0
          ? _o
          : (_p = report === null || report === void 0 ? void 0 : report.scanScope) === null ||
              _p === void 0
            ? void 0
  ...
  const generatedAt = reportAligned
    ? (_r = report === null || report === void 0 ? void 0 : report.generatedAt) !== null &&
      _r !== void 0
      ? _r
      : null
    : null;
...
export function isLegacyScanReport(report, projectPath = '') {
  ...
  const inventoryRoot =
    (_a = normalized.repositoryInventory) === null || _a === void 0 ? void 0 : _a.projectRoot;
...
export function getScanFileMetrics(report, options = {}) {
  ...
  if (!report || typeof report !== 'object') {
    return {
      ...
      repositoryFiles:
        (_a = inventory === null || inventory === void 0 ? void 0 : inventory.totalFiles) !==
          null && _a !== void 0
          ? _a
          : null,
      repositoryFolders:
        (_b = inventory === null || inventory === void 0 ? void 0 : inventory.totalFolders) !==
          null && _b !== void 0
          ? _b
          : null,
      repositoryRoot:
        (_c = inventory === null || inventory === void 0 ? void 0 : inventory.projectRoot) !==
          null && _c !== void 0
          ? _c
          : null,
    };
  ...
  return {
    ...
    productionLeakScanned:
      (_6 = normalizedReport.productionLeakScanned) !== null && _6 !== void 0 ? _6 : 0,
    repositoryFiles,
    repositoryFolders:
      (_8 =
    ...
    repositoryRoot:
      (_11 =
        (_9 = inventory === null || inventory === void 0 ? void 0 : inventory.projectRoot) !==
          null && _9 !== void 0
          ? _9
...
export function resolveDisplayScore(report) {
  ...
  return (_c =
    (_b =
      (_a = report.consistencyScore) !== null && _a !== void 0 ? _a : report.schemaCompliance) !==
      null && _b !== void 0
      ? _b
...
export function resolveJestTestsLabel(baseline, dashboardHome, report) {
  ...
  const overview =
    dashboardHome === null || dashboardHome === void 0 ? void 0 : dashboardHome.overview;
  if (
...
export function resolvePageSpecsLabel(report, baseline) {
  ...
  return (_b = baseline === null || baseline === void 0 ? void 0 : baseline.pageSamplesLabel) !==
    null && _b !== void 0
    ? _b
    : null;
}
...
export function hydrateDashboardHome(home, baseline) {
  ...
  const jestPassing =
    (_a = baseline === null || baseline === void 0 ? void 0 : baseline.jestTestsPassing) !== null &&
    _a !== void 0
      ? _a
      : (_b = home === null || home === void 0 ? void 0 : home.overview) === null || _b === void 0
        ...
        : _b.passedTests;
  const suites =
    (_c = baseline === null || baseline === void 0 ? void 0 : baseline.jestSuites) !== null &&
    _c !== void 0
      ? _c
  ...
  const comparativeAnalysis = (home.comparativeAnalysis || []).map((row) => {
    ...
    return {
      ...row,
      current: jestPassing !== null && jestPassing !== void 0 ? jestPassing : row.current,
      change,
    };
  });
  /**
  ...
  return {
    ...
    overview: home.overview
      ? {
          ...home.overview,
          totalTests:
            jestPassing !== null && jestPassing !== void 0 ? jestPassing : home.overview.totalTests,
          passedTests:
...
export function normalizeSimplebeaconReport(report) {
  ...
  const weightedPenalty = detectedIssues
    ...
    .reduce(
      (sum, i) =>
        sum + (severityWeight[i.severityBand || i.severity] || 1) * (Number(i.count) || 1),
      0
    );
  const computedQualityScore = Math.max(
    0,
  ...
  const qualityScore =
    report.qualityScore ?? (detectedIssues.length > 0 ? computedQualityScore : null);
  ...
  return Object.assign({}, report, {
    ...
    qualityScore,
    filesAnalyzed:
      report.codeFilesAnalyzed || report.filesAnalyzed || report.summary?.codeFilesAnalyzed || 0,
...
function normalizeDashboardIssue(issue) {
  ...
  return {
    ...
    description:
      issue.description || issue.message || issue.recommendedAction || issue.type || 'Finding',
    count: issue.count || 1,
  };
}
/**
...
export function buildScanConclusion(report, options = {}) {
  ...
  const jestNote =
    ...
    ((_q = report.scanScope) === null || _q === void 0 ? void 0 : _q.jestExecutedDuringScan) ===
      false
  ...
  if (focus === 'fiction') {
    ...
    const inventoryBrief =
      repoFiles != null && ruleScoped != null
        ...
        : '';
    const fictionScope =
      ((_t = (_s = report.scanScope) === null || _s === void 0 ? void 0 : _s.limitations) ===
        null || _t === void 0
        ? void 0
  ...
  const scope =
    ((_v = (_u = report.scanScope) === null || _u === void 0 ? void 0 : _u.limitations) === null ||
    _v === void 0
      ? void 0
      : _v[0]) ||
...
export function normalizeImportedReport(payload) {
  ...
  if (
    ((_a = payload.report) === null || _a === void 0 ? void 0 : _a.type) === 'simplebeacon-report'
  )
  ...
  if (Array.isArray(payload.rawIssues)) {
    return {
      ...
      issueCount:
        (_b = payload.issueCount) !== null && _b !== void 0 ? _b : payload.rawIssues.length,
...
export function assertCompleteScanFileReductionFresh(scan) {
  ...
  const hasSignal =
    ((_b = (_a = scan.fileReductionPlan) === null || _a === void 0 ? void 0 : _a.totals) === null ||
    _b === void 0
      ? void 0
      : _b.safeToDeleteBytes) != null ||
    ((_e =
      (_d = (_c = scan.fileReductionPlan) === null || _c === void 0 ? void 0 : _c.safeToDelete) ===
        null || _d === void 0
        ? void 0
        : _d.topDirectories) === null || _e === void 0
      ? void 0
      : _e.length) ||
    ((_g = (_f = scan.scanners) === null || _f === void 0 ? void 0 : _f['build-artifacts']) ===
      null || _g === void 0
      ? void 0
