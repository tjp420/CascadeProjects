...
export function normalizeSecurityFinding(issue, index = 0) {
  ...
  const filePath =
    ...
    ((_c = (_b = issue.metadata) === null || _b === void 0 ? void 0 : _b.duplicatePaths) === null ||
    _c === void 0
      ? void 0
      : _c[0]) ||
  ...
  return {
    ...
    recommendation:
      issue.recommendedAction || issue.recommendation || 'Review and remediate before merge',
  ...
  return {
    ...
    gatePass:
      (_g =
        ...
        : null,
    generatedAt:
      (_h = report === null || report === void 0 ? void 0 : report.generatedAt) !== null &&
      _h !== void 0
        ? _h
        : null,
  };
