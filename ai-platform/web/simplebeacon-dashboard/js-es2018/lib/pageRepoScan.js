...
export function readProjectPathInput(root) {
  ...
  return (_a = el === null || el === void 0 ? void 0 : el.value) !== null && _a !== void 0
    ? _a
    : '';
}
/**
...
export function reportForProjectPath(app, projectPath) {
  ...
  const analyzeReport =
    (_a = app.state.analyzeResult) === null || _a === void 0 ? void 0 : _a.report;
...
export function renderPageScanContext(app, options = {}) {
  ...
  const report =
    (_a = options.report) !== null && _a !== void 0 ? _a : reportForProjectPath(app, requested);
  ...
  const scannedLabel = scannedRoot
    ...
    : '';
  const mismatch =
    requested && scannedRoot && !reportMatchesPagePath({ projectRoot: scannedRoot }, requested);
  const gate =
...
export async function refreshAppReportForPath(app, projectPath, root) {
  const path = String(
    projectPath || (root ? getPageProjectPath(app, root) : getPageProjectPath(app)) || ''
  ).trim();
  if (!path) {
...
export async function runPageRepoScan(app, projectPath, options = {}) {
  ...
  const resolved = String(
    projectPath || (root ? getPageProjectPath(app, root) : resolvePageProjectPath('', app)) || ''
  ).trim();
  if (!resolved) {
  ...
  try {
    ...
    (_b = (_a = app.views.audit) === null || _a === void 0 ? void 0 : _a.invalidateCache) ===
      null || _b === void 0
      ? void 0
      : _b.call(_a);
