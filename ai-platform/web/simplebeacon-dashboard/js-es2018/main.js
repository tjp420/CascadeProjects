...
class SimplebeaconDashboard {
  ...
  showLockScreen(view, options = {}) {
    ...
    if (tokenForm) {
      tokenForm.addEventListener('submit', async (e) => {
        ...
        const password =
          ((_a = main.querySelector('#lock-token-password')) === null || _a === void 0
            ? void 0
            : _a.value) || '';
  ...
  setupKeyboard() {
    document.addEventListener('keydown', (e) => {
      ...
      if (mod && e.key === 'k') {
        e.preventDefault();
        (_a = document.getElementById('global-search')) === null || _a === void 0
          ? void 0
          : _a.focus();
      }
      if (mod && e.key === 'r') {
      ...
      if (e.key === 'Escape') {
        if (document.getElementById('token-prompt-modal')) return;
        (_b = document.getElementById('onboarding-modal')) === null || _b === void 0
          ? void 0
          : _b.remove();
        this.closeMobileNav();
      }
  ...
  async onRoute(view, params) {
    ...
    if (isFreeTier) {
      ...
      (_a = document.getElementById('readonly-banner')) === null || _a === void 0
        ? void 0
        : _a.remove();
    }
  ...
  async runScan(projectPath) {
    ...
    const resolvedPath =
      resolveDashboardProjectPath(
        String(
          projectPath || this.state.lastProjectPath || this.state.defaultProjectPath || ''
        ).trim(),
    ...
    try {
      ...
      (_b = (_a = this.views.audit) === null || _a === void 0 ? void 0 : _a.invalidateCache) ===
        null || _b === void 0
        ? void 0
        : _b.call(_a);
  ...
  refreshCurrentView() {
    ...
    requestAnimationFrame(() => {
      ...
      if (this._currentViewName === 'dashboard' && this.state.report && hadReport) {
        (_b =
          (_a = this.views.dashboard) === null || _a === void 0 ? void 0 : _a.refreshScanStatus) ===
          null || _b === void 0
          ? void 0
          : _b.call(_a);
        return;
