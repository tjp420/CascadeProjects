...
export class TrustView {
  ...
  async mount(container) {
    ...
    try {
      ...
      container.innerHTML = this.render();
      container
        .querySelector("#trust-download-json")
        ?.addEventListener("click", () => this.downloadTrustData());
      container
        .querySelector("#trust-send-ai-btn")
          ...
          const payload = {
            ...
            reportSummary: {
              ...
              repositoryHealthScore:
                live.repositoryHealth?.headline?.repositoryHealthScore ?? "N/A",
            },
            notes:
