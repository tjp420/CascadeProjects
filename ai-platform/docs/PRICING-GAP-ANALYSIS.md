...
assert.strictEqual(
  starterLimits.maxFilesPerScan,
  50,
  "Starter should have 50-file limit",
);
assert.strictEqual(
  starterLimits.maxFindingsShown,
  5,
  "Starter should show 5 findings",
);
assert.strictEqual(
  starterLimits.showQualityScore,
  false,
  "Starter should hide quality score",
);
...
assert.strictEqual(
  proLimits.maxFilesPerScan,
  null,
  "Pro should have unlimited files",
);
assert.strictEqual(
  proLimits.maxFindingsShown,
  null,
  "Pro should show all findings",
);
assert.strictEqual(
  proLimits.showQualityScore,
  true,
  "Pro should show quality score",
);
...
assert.strictEqual(
  hasMaxFilesCheck,
  true,
  "Scanner should reference tier limits",
);
...
_Next review: After tier enforcement is implemented_
