# Runbook: Track120RollbackBlockedSpike

**Alert**: `Track120RollbackBlockedSpike`
**Severity**: `warning`
**Counter(s)**: `hsm_reconciliation_rollback_blocked_total`

## Summary

More than 1 rollback attempt per second is being blocked over 5 minutes

## Description

The anti-rollback protection is actively rejecting epoch rollback attempts at an elevated rate. This indicates possible downgrade attacks, historic key frame reinjection attempts, or misconfigured recovery procedures.

## Triage Steps

1. Check the reconciliation logs for the source of rollback attempts (node IDs and key epochs)
