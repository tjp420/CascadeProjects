...
describe('AssessmentController', () => {
  ...
  describe('resolveAssessmentId', () => {
    test('returns params.id when present', () => {
      expect(AssessmentController.resolveAssessmentId({ params: { id: 'abc' } })).toBe('abc');
    });
  ...
  describe('triggerScan', () => {
    test('delegates to createAssessment', async () => {
      const spy = jest.spyOn(AssessmentController, 'createAssessment').mockResolvedValue();
      const req = { body: {} };
      const res = {};
  ...
  describe('getReport', () => {
    test('delegates to getAssessment with resolved id', async () => {
      const spy = jest.spyOn(AssessmentController, 'getAssessment').mockResolvedValue();
  ...
  describe('downloadReport', () => {
    test('delegates to downloadAssessment with resolved id', async () => {
      const spy = jest.spyOn(AssessmentController, 'downloadAssessment').mockResolvedValue();
  ...
  describe('getAssessment', () => {
    test('returns 404 when assessment file missing', async () => {
      ...
      jest.spyOn(AssessmentController, 'readAssessment').mockRejectedValue({ code: 'ENOENT' });
  ...
  describe('createAssessment — authenticated success', () => {
    test('creates assessment with repoUrl', async () => {
      ...
      AssessmentController.cloneRepo = jest.fn().mockResolvedValue('/cloned/path');
      ...
      AssessmentController.runSimplebeaconScan = jest.fn().mockResolvedValue({ issueCount: 0 });
