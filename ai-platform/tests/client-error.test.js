...
describe("client-error", () => {
  ...
  describe("toClientError", () => {
    ...
    test("returns fallback in production", () => {
      process.env.NODE_ENV = "production";
      expect(toClientError(new Error("sensitive"))).toBe(
    ...
    test("returns fallback string for custom fallback", () => {
      process.env.NODE_ENV = "production";
      expect(toClientError(new Error("sensitive"), "Custom fallback")).toBe(
        "Custom fallback",
      );
    });
  ...
  describe("clientErrorPayload", () => {
    ...
    test("uses custom errorLabel", () => {
      const payload = clientErrorPayload(new Error("x"), {
  ...
  describe("sendClientError", () => {
    ...
    test("passes options through", () => {
      ...
      sendClientError(res, 500, new Error("fail"), {
