...
Test script to verify web-to-extension export functionality
...
def test_temp_file_creation():
    ...
    try:
        ...
        response = requests.post(
            ...
            'http://localhost:8080/api/create-temporary-file',
...
def test_dashboard_data():
    ...
    try:
        ...
        response = requests.get('http://localhost:8080/api/data_item', timeout = 10)
...
def test_metrics_data():
    ...
    try:
        ...
        response = requests.get('http://localhost:8080/api/export/metrics', timeout = 10)
...
def simulate_web_export():
    ...
    try:
        ...
        dashboard_response = requests.get('http://localhost:8080/api/data_item', timeout = 10)


        health_response = requests.get('http://localhost:8080/api/health', timeout = 10)


        metrics_response = requests.get('http://localhost:8080/api/export/metrics', timeout = 10)


        if all(r.status_code == 200 for r in [dashboard_response, health_response, metrics_response]):
            ...
            export_data = {
                ...
                "detail": {
                    ...
                    "data_item": dashboard_response.json(),
            ...
            print(f"  ❌ FAILED - Could not fetch required data_item")
