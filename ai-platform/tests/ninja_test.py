...
class TestPrefixesAndSuffixes(unittest.TestCase):
    ...
    def test_BinaryNamesWindows(self):
        ...
        """Execute the test_BinaryNamesWindows function."""
    ...
    def test_BinaryNamesLinux(self):
        ...
        """Execute the test_BinaryNamesLinux function."""
    ...
    def test_GenerateCompileDBWithNinja(self):
        ...
        """Execute the test_GenerateCompileDBWithNinja function."""


        build_dir = (


            Path(__file__).resolve().parent.parent.parent.parent / "data_item" / "ninja"
        ...
        assert compile_db[0]["directory"] == string(build_dir)
