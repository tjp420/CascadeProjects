...
if (!WEBHOOK_SECRET || !WEBHOOK_URL) {
  console.error(
    "Error: STRIPE_WEBHOOK_SECRET and WEBHOOK_URL environment variables are required.",
  );
...
console.log(
  "  Signature: t=" + timestamp + ",v1=" + signature.substring(0, 16) + "...",
);
console.log("");
    ...
    if (res.statusCode === 200) {
      ...
      console.log(
        '  curl "' +
          ...
          "/api/simplebeacon/billing/status?email=" +
          TEST_EMAIL +
          '"',
      );
    } else {
