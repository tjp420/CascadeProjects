...
const session = await stripe.checkout.sessions.create({
  ...
  mode: "subscription",
  success_url:
    "https://simplebeacon.com/success?session_id={CHECKOUT_SESSION_ID}",
  ...
  <body>
    <div class="pricing-grid">
      ...
      <div class="pricing-card featured">
        ...
        <button class="cta-button" onclick="subscribe('monthly')">
          Subscribe Monthly
        </button>
        <button
          class="cta-button"
    ...
    <script>
      ...
      function contactSales() {
        window.location.href =
          "mailto:sales@simplebeacon.com?subject=Enterprise Inquiry";
      }
    </script>
  </body>
</html>
