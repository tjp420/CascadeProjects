...
**Why defensible:** GitHub scans repos statically. We see _how_ code arrived. Requires IDE integration they can't replicate without owning the editor.
...
_Owner: SimpleBeacon Core Team_
