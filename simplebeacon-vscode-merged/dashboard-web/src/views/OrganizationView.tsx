                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      ...
                      {member.role === 'owner' ? (
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent>
                            {ASSIGNABLE_ROLES.map((r) => (
                              <DropdownMenuItem key={r} onClick={() => handleRoleChange(member.user_email, r)}>
                                {ROLE_LABELS[r]}
                              </DropdownMenuItem>
                            ))}
                          </DropdownMenuContent>
      ...
      {activeOrg && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Download vulnerability trend data and audit reports for compliance teams</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <p className="text-xs text-muted-foreground">
              Exports use the latest scan report stored in your browser. Run a scan from the Analyze page to populate
              data. The Audit PDF opens a printable view — use your browser's Print dialog to save as PDF.
            </p>
          </CardContent>
        </Card>
      )}
