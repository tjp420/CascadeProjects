    ...
    async (e: React.DragEvent) => {
      ...
      if (dtFiles.length > 0) {
        ...
        if (!hasRelativePath && dtFiles.length <= 2) {
          toast.warning('Folder drop exposed only 1 file. Click Select Folder to scan the full directory.', {
            duration: 10000,
          });
          setScanState('idle');
          return;
              ...
              <div className="flex items-center justify-between gap-3">
                <div>
                  ...
                  <p className="text-xs text-foreground-muted mt-1">
                    Your browser blocked the automatic file picker (async gesture chain broken). Click the button below
                    to choose a local directory to scan.
                  </p>
                </div>
                <Button
                  size="sm"
