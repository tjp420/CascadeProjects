...
const FLAG_UPGRADE: Record<FeatureFlag, UpgradeInfo> = {
  canExportCertificates: {
    ...
    minTier: 'Developer',
    priceLabel: '$49/mo',
    description: 'Unlock trust certificates, license management, and signed compliance artifacts.',
  },
  canUseCiGate: {
    flag: 'canUseCiGate',
    minTier: 'Developer',
    priceLabel: '$49/mo',
    description: 'Unlock CI/CD gate integration, platform metrics, and ops reporting.',
  },
  canUseAdvancedAnalyzers: {
    flag: 'canUseAdvancedAnalyzers',
    minTier: 'Developer',
    priceLabel: '$49/mo',
    description: 'Unlock advanced analyzers, fine-tuning curation, and workspace configuration.',
  },
  canMapEuAiAct: {
    flag: 'canMapEuAiAct',
    minTier: 'Team Pro',
    priceLabel: '$149/mo',
    description: 'Unlock EU AI Act compliance mapping, outreach analytics, and compliance dashboards.',
  },
  canExportBoardPdf: {
    flag: 'canExportBoardPdf',
    minTier: 'Team Pro',
    priceLabel: '$149/mo',
    description: 'Unlock board-ready PDF reports and enterprise governance dashboards.',
  },
  canUseSso: {
    flag: 'canUseSso',
    minTier: 'Team Pro',
    priceLabel: '$149/mo',
    description: 'Unlock organization management, team metrics, and webhook event integration.',
  },
};
