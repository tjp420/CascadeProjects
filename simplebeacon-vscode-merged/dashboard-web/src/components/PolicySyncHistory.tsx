                    ...
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={data.timeline}>
                        ...
                        <Tooltip
                          ...
                          contentStyle={{ fontSize: '12px', borderRadius: '8px' }}
                        />
                        <Bar dataKey="syncs" fill="#3b82f6" name="Syncs" radius={[4, 4, 0, 0]} />
                      </BarChart>
                    </ResponsiveContainer>
                  </div>
                </div>
            ...
            {data.recent.length > 0 && (
              <div className="space-y-2">
                ...
                <div className="space-y-1 max-h-64 overflow-y-auto">
                  {data.recent.map((e) => (
                    <div key={e.id} className="flex items-center gap-3 text-xs border rounded px-3 py-2">
                      ...
                      <span className="text-foreground-muted flex-shrink-0">{formatTimeAgo(e.timestamp)}</span>
                    </div>
                  ))}
                </div>
              </div>
