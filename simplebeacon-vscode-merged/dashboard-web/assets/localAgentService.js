import { g as Ae, E as Ee, V as $e } from './main.js';
function Be(e) {
...
function he(e, t) {
  ...
  const r = o.includes('\\') ? '\\' : '/',
    a = n.replace(/^[/\\]+/, '').replace(/\//g, r);
  return `${o}${r}${a}`;
}
function Ce(e, t = 1, n = {}) {
  const o = he(e, n.projectRoot);
  if (!o || !fe(o)) return null;
  const r = n.scheme || (typeof navigator < 'u' && /Cursor/i.test(navigator.userAgent || '') ? 'cursor' : 'vscode'),
    a = Be(o),
    s = Math.max(1, Number(t) || 1);
  return /^\/\//.test(a) || /^[A-Za-z]:\//.test(a) ? `${r}://file/${a}:${s}` : `${r}://file/${a}:${s}`;
}
function ue(e, t = 1, n = {}) {
  const o = he(e, n.projectRoot);
  if (!o) return !1;
  const r = Math.max(1, Number(t) || 1),
    a = { command: 'openFile', file: o, path: o, line: r },
    s = Ae();
  if (s)
    try {
  ...
  if (typeof window < 'u' && window.parent && window.parent !== window)
    try {
      return (window.parent.postMessage(a, '*'), !0);
    } catch {}
  const c = Ce(o, r, n);
  if (c)
    try {
...
const x = 'sb_api_base',
  R = 'sb_notify_base';
function me() {
  return typeof location > 'u' ? !1 : /^(localhost|127\.0\.0\.1|\[::1\])$/i.test(location.hostname);
}
function ee(e) {
  return /^(localhost|127\.0\.0\.1|\[::1\])$/i.test(String(e || ''));
}
function Le(e) {
  if (!e) return !1;
  try {
    const t = new URL(e, location.href),
      n = ee(t.hostname),
      o = String(t.hostname || '');
    if (!/^(localhost|127\.0\.0\.1|\[::1\])$/i.test(o) && o.indexOf('.') === -1) return !1;
    if (!me() && n) {
      try {
        const r = new URLSearchParams(location.search || '');
        if (r.get(x) || r.get(R)) return !0;
      } catch {}
      try {
        if (typeof sessionStorage < 'u' && (sessionStorage.getItem(x) || sessionStorage.getItem(R))) return !0;
      } catch {}
      return !1;
    }
    return !((location.protocol === 'https:' && t.protocol === 'http:') || Pe(e));
  } catch {
    return !1;
  }
}
function xe(e, t = {}) {
  ...
  const o = String(e)
      .replace(/\/+$/, '')
      .replace(/\/api\/?$/i, ''),
    r = o.endsWith('/') ? `${o}api` : `${o}/api`;
  if (!Le(r)) return !1;
  if (me() && typeof location < 'u' && location.protocol === 'http:')
    try {
      if (new URL(r).port === '4000') return !1;
    } catch {}
  if ((Re(o), Ne(o), (window.__SB_BRIDGE_HOST__ = o), t.websiteMode !== !1 && typeof sessionStorage < 'u'))
    try {
  ...
  if (t.updateUrl !== !1)
    try {
      ...
      (a.searchParams.set(x, o),
        a.searchParams.set(R, o),
        a.searchParams.set('sb_website_mode', '1'),
        a.searchParams.has('sb_parent_urlbar') || a.searchParams.set('sb_parent_urlbar', '1'),
...
function U(e = {}) {
  if (typeof sessionStorage < 'u')
    try {
      (sessionStorage.removeItem(x), sessionStorage.removeItem(R));
    } catch {}
  if (typeof window < 'u')
    try {
      delete window.__SB_BRIDGE_HOST__;
    } catch {}
  if (e.updateUrl !== !1 && typeof window < 'u')
    try {
      const t = new URL(window.location.href);
      ([x, R, 'sb_website_mode', 'sb_parent_urlbar'].forEach((n) => {
...
function Pe(e) {
  if (!e || typeof location > 'u') return !1;
  try {
    const t = new URL(String(e).startsWith('http') ? e : `http:${e}`, location.href),
      n = location.port || (location.protocol === 'https:' ? '443' : '80'),
      o = t.port || (t.protocol === 'https:' ? '443' : '80');
    return ee(t.hostname) && ee(location.hostname) && o !== n;
  } catch {
    return !1;
  }
}
const M = 'http://127.0.0.1:55432',
  te = 'http://127.0.0.1:4000',
  de = 'sb_api_base',
  se = 3e3,
  pe = {
...
function Ze() {
  ...
  if (e)
    try {
      ne(new URL(String(e).replace(/\/api\/?$/, '')).origin) && (U({ updateUrl: !0 }), (t = !0));
    } catch {}
  if (typeof window < 'u' && window.__SB_BRIDGE_HOST__ && ne(window.__SB_BRIDGE_HOST__)) {
    try {
      delete window.__SB_BRIDGE_HOST__;
    } catch {}
    t = !0;
...
function Te(e, t = {}, n = 4e3) {
  return new Promise((o, r) => {
    if (!ge()) {
      r(new Error('Parent bridge unavailable'));
      return;
    }
    const a = `pbf_${Date.now().toString(36)}_${Math.random().toString(36).slice(2)}`;
    let s = !1;
    const c = () => {
        ((s = !0), clearTimeout(l), window.removeEventListener('message', i));
      },
      l = setTimeout(() => {
        s || (c(), r(new Error('Parent bridge fetch timeout')));
      }, n),
      i = (p) => {
        const f = p == null ? void 0 : p.data;
        if (!(!f || f.command !== 'bridgeFetchResponse' || f.requestId !== a)) {
          if ((c(), f.error)) {
            r(new Error(String(f.error)));
            return;
          }
          o(
            new Response(f.body ?? '', {
    ...
    : ge()
      ? async (e, t) => {
          try {
            ...
            const o = String((n == null ? void 0 : n.message) || n);
            if (o.includes('Parent bridge fetch timeout') || o.includes('Parent bridge unavailable'))
              return fetch(e, t);
            throw n;
          }
        }
...
function V() {
  ...
  try {
    const e = new URLSearchParams(window.location.search),
      t = e.get(de) || e.get('sb_notify_base');
    if (t) return t;
  } catch {}
  if (typeof sessionStorage < 'u')
    try {
      return sessionStorage.getItem(de) || sessionStorage.getItem('sb_notify_base');
    } catch {}
  return null;
}
function b() {
  ...
  try {
    ...
    return (o !== '127.0.0.1' && o !== 'localhost') || (E() && ne(n.origin)) ? null : n.origin;
  } catch {
    return null;
  }
}
...
const y = 'http://127.0.0.1:11434',
  ke = [54358, 54697, 58681];
function Qe() {
  return $e;
}
function et(e = 'chatbot') {
  ...
  return `${t}://${Ee}/connect?route=${encodeURIComponent(n)}`;
}
function T() {
  if (typeof window > 'u') return !1;
...
async function re(e = ke, t = {}) {
  if (typeof window > 'u' || !T()) return null;
  const n = $();
  for (const o of e) {
    const r = `http://127.0.0.1:${o}`;
    if (!(D(r) && !g()))
      try {
        const a = await n(`${r}/api/ping`, { signal: AbortSignal.timeout(2200) });
        if (!a.ok) continue;
        const s = await a.json().catch(() => ({}));
        if (s && (s.online === !0 || s.status === 'ok')) return `${r}/api`;
      } catch {}
  }
  return null;
}
async function tt(e = {}) {
  ...
  const o = await re();
  return o
    ? xe(o, { websiteMode: !0, updateUrl: !0 })
      ? { ok: !0, source: 'probe', apiBase: o }
      : { ok: !1, source: 'denied' }
    : { ok: !1, source: 'none' };
}
async function nt() {
...
function De(e, t = y) {
  const n = String(t || y).replace(/\/+$/, ''),
    o = String(e || '').startsWith('/') ? String(e) : `/${e || ''}`,
    r = b();
  if (r) {
    const a = `baseUrl=${encodeURIComponent(n)}`;
    return o === '/api/tags'
      ? `${r}/api/simplebeacon/ollama/models?${a}`
      : o === '/api/chat'
        ? `${r}/api/simplebeacon/ollama/chat?${a}`
        : `${r}/api/simplebeacon/ollama/proxy?${a}&path=${encodeURIComponent(o)}`;
  }
  return `${n}${o}`;
}
async function ae(e) {
...
function Fe(e = y) {
  ...
  const o = `baseUrl=${encodeURIComponent(t)}`;
  return [
    `${n}/api/simplebeacon/ollama/models?${o}`,
    `${n}/api/tags?${o}`,
    `${n}/api/simplebeacon/ollama/proxy?${o}&path=${encodeURIComponent('/api/tags')}`,
  ];
}
function ot(e = y) {
  const t = String(e || y).replace(/\/+$/, ''),
  ...
  const o = `baseUrl=${encodeURIComponent(t)}`;
  return [
    `${n}/api/simplebeacon/ollama/chat?${o}`,
    `${n}/api/simplebeacon/ollama/proxy?${o}&path=${encodeURIComponent('/api/chat')}`,
  ];
}
async function W() {
  const e = b();
  ...
  try {
    ...
    return { ok: (o == null ? void 0 : o.online) !== !1, reason: 'ping-ok' };
  } catch (n) {
    return { ok: !1, reason: 'unreachable', error: String((n == null ? void 0 : n.message) || n) };
  }
}
async function rt(e = y) {
  if (typeof window > 'u') return !1;
  const t = String(e || y).replace(/\/$/, '');
  if (k()) return !1;
  const n = $(),
  ...
  if (k() && D(o) && !g()) return !1;
  try {
    const r = await n(o, { signal: AbortSignal.timeout(2500) });
    return (await ae(r)).ok;
  } catch {
    return !1;
  }
}
async function at(e = y) {
  ...
  for (const l of s)
    try {
      const i = await o(l, { signal: AbortSignal.timeout(4e3) }),
        p = await ae(i);
  ...
  if (r)
    return a.ok && c.status === 404
      ...
      : a.ok && c.bridgeReachable && c.error
  ...
  try {
    const l = await o(s[0], { signal: AbortSignal.timeout(4e3) }),
      i = await ae(l);
    return i.ok
...
async function st(e) {
  const t = b();
  if (!t || !(await W()).ok) return null;
  const o = $();
  try {
    const a = await (await o(`${t}/api/status`, { headers: { Accept: 'application/json' } })).json().catch(() => ({}));
    if (
      a.workspace &&
      (String(a.workspace).replace(/\\/g, '/').split('/').pop() || '').toLowerCase() === String(e).toLowerCase()
    )
      return String(a.workspace);
  } catch {}
  try {
    const r = await o(
        `${t}/api/find-folder`,
    ...
    if (!r.ok) return null;
    const s = Array.isArray(a.results) ? a.results : [];
...
async function it() {
  ...
  try {
    ...
    return !o.ok || r.success !== !0 ? null : String(r.path || '').trim() || null;
  } catch {
    return null;
  }
}
async function B(e, t = {}, n = 3e5) {
  const o = we(),
    r = new Promise((s, c) => {
      setTimeout(() => c(new Error('Local agent request timed out')), n);
    });
  return await Promise.race([o(e, t), r]);
}
function je(e) {
      ...
      : I ||
        ((I = (async () => {
          if (!g() && D(e)) {
            ...
            return ((S = t), (j = Date.now()), t);
          }
          try {
            const t = await B(`${e}/health`, { method: 'GET', headers: { Accept: 'application/json' } }, se),
            ...
            return ((S = o), (j = Date.now()), o);
          } catch (t) {
            return (
              (S = { available: !1, scannerAvailable: !1, likelyBlocked: !g() && ze(e, t) }),
              (j = Date.now()),
              S
            );
          } finally {
...
async function lt(e, t = {}, n = M) {
  const o = await B(`${n}/inventory`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json', Accept: 'application/json' },
      body: JSON.stringify({ projectPath: e, fullDirectoryScan: t.fullDirectoryScan }),
    }),
    r = await o.json().catch(() => ({}));
  if (!o.ok || !r.success) throw new Error(r.error || `Agent inventory failed (${o.status})`);
  return r.inventory;
}
async function ut(e, t = {}, n = M) {
  let o = n,
    r = t;
  typeof t == 'string' && ((o = t), (r = {}));
  const a = await B(
      `${o}/scan`,
      {
        method: 'POST',
        headers: { 'Content-Type': 'application/json', Accept: 'application/json' },
        body: JSON.stringify({ projectPath: e, fullDirectoryScan: r.fullDirectoryScan === !0 }),
      },
      6e5
    ),
    s = await a.json().catch(() => ({}));
  if (!a.ok || !s.success) throw new Error(s.error || `Agent scan failed (${a.status})`);
  return s.report;
}
async function dt(e, t = M) {
  const n = new URLSearchParams({ projectPath: String(e || '') }),
    o = await B(`${t}/progress?${n}`, { headers: { Accept: 'application/json' } }, 15e3),
    r = await o.json().catch(() => ({}));
  return !o.ok || !r.success ? { active: !1 } : r.progress || { active: !1 };
}
async function pt(e) {
  const t = b();
  ...
  const n = new URLSearchParams({ projectPath: String(e || '') });
  try {
    const o = await B(`${t}/api/simplebeacon/scan/progress?${n}`, { headers: { Accept: 'application/json' } }, 15e3),
      r = await o.json().catch(() => ({}));
    return o.status === 404
...
async function ft(e = oe()) {
  if (!He())
    return { available: !1, likelyBlocked: !1, extensionBridge: !1, origin: oe() || te, integratedSkipped: E() };
  if (!e) return { available: !1, likelyBlocked: !1, extensionBridge: !1, origin: te, integratedSkipped: !0 };
  const t = ye(e);
  return k() && !t && !g()
      ...
      : O ||
        ((O = (async () => {
          if (!t && !g() && D(e)) {
            ...
            return ((A = n), (z = Date.now()), n);
          }
          try {
            const n = await B(`${e}/api/ping`, { method: 'GET', headers: { Accept: 'application/json' } }, se),
              o = await n.json().catch(() => ({})),
              r = { available: n.ok && o.online === !0, extensionBridge: t, origin: e };
            return ((A = r), (z = Date.now()), r);
          } catch {
            const o = { available: !1, extensionBridge: t, origin: e };
            return ((A = o), (z = Date.now()), o);
          } finally {
            O = null;
          }
        })()),
...
async function Ve(e, t, n) {
  ...
  let r = 0;
  for (; Date.now() - o < Me;) {
    await new Promise((a) => setTimeout(a, Ge));
    try {
      if (
        !(
          (
      ...
      throw new Error(`Scan polling failed: ${a.message || a}`);
    }
  }
  throw new Error('Scan timed out after 5 minutes');
}
async function ht(e, t = oe()) {
  if (ye(t)) {
    const r = $(),
      a = await r(`${t}/api/scan`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json', Accept: 'application/json' },
        body: JSON.stringify({ path: e }),
      }),
      s = await a.json().catch(() => ({}));
    if (!a.ok || !s.success) throw new Error(s.error || s.warning || `Extension scan failed (${a.status})`);
    return s.scanning
      ? {
          success: !0,
          extensionBridge: !0,
          report: await Ve(t, e, r),
          path: e,
  ...
  const n = await B(`${t}/api/analyze`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json', Accept: 'application/json' },
      body: JSON.stringify({ path: e }),
    }),
    o = await n.json().catch(() => ({}));
  if (!n.ok || !o.success) throw new Error(o.error || `Agent scan failed (${n.status})`);
  return o;
}
function mt(e, t) {
  if (!t) return;
  ...
  if (!n) return;
  const o = e.files || [],
    r = o.filter((d) => d.status && d.status !== 'Clean'),
    a = o.length - r.length,
    s = typeof e.discoveredFiles == 'number' ? e.discoveredFiles : o.length,
  ...
  ((q.className = 'sb-compliance-eyebrow'), (q.textContent = 'Scan complete'));
  const J = document.createElement('h3');
  ((J.className = 'sb-compliance-title'), (J.textContent = 'Compliance summary'));
  const K = document.createElement('p');
  ((K.className = 'sb-compliance-status'),
    (K.textContent = n.complianceStatus || 'Review required'),
    f.appendChild(q),
    f.appendChild(J),
    f.appendChild(K));
  const F = document.createElement('div');
  ((F.className = 'sb-compliance-grade'),
    F.setAttribute('aria-label', `Grade ${n.letterGrade || '?'}`),
    (F.textContent = n.letterGrade || '?'),
    p.appendChild(f),
    p.appendChild(F),
    i.appendChild(p));
  const X = document.createElement('div');
  if (
    ((X.className = 'sb-compliance-metrics'),
    [
      { label: 'Files scanned', value: `${o.length} / ${s}` },
      { label: 'Heuristic score', value: `${n.score || 0}/100` },
      { label: 'Issues flagged', value: String(r.length) },
      ...
      ((_.className = d.danger ? 'sb-compliance-metric-danger' : ''),
        (_.textContent = d.value),
        m.appendChild(h),
        m.appendChild(_),
        X.appendChild(m));
    }),
  ...
  if (
    ((Y.className = 'sb-compliance-actions'),
    [
    ...
    ((d.className = 'sb-compliance-files'), (d.open = r.length > 0 && r.length <= 12));
    const m = document.createElement('summary');
    ((m.textContent = `File inventory (${r.length} flagged · ${a} clean)`), d.appendChild(m));
    const h = document.createElement('div');
    h.className = 'sb-compliance-files-toolbar';
    let _ = 'issues';
    const Se = [
        { id: 'issues', label: `Issues (${r.length})` },
        { id: 'all', label: `All (${o.length})` },
        { id: 'clean', label: `Clean (${a})` },
      ],
      N = document.createElement('div');
    N.className = 'sb-compliance-files-list';
    const ce = () => {
      N.replaceChildren();
      let v = o;
      _ === 'issues' ? (v = r) : _ === 'clean' && (v = o.filter((u) => !u.status || u.status === 'Clean'));
      const w = _ === 'all' ? 80 : 120;
      if (
        (v.slice(0, w).forEach((u) => {
          const C = document.createElement('div'),
            le = !u.status || u.status === 'Clean';
          C.className = `sb-compliance-file-row${le ? ' is-clean' : ' is-issue'}`;
          const Z = document.createElement('span');
          ((Z.className = 'sb-compliance-file-badge'), (Z.textContent = le ? 'Clean' : String(u.status)));
          const L = document.createElement('span');
          ((L.className = 'sb-compliance-file-path'),
            (L.textContent = u.absolutePath || u.name || ''),
            (u.absolutePath || u.name) &&
              ((L.style.cursor = 'pointer'),
              (L.title = 'Open in editor'),
              L.addEventListener('click', () => {
                ue(u.absolutePath || u.name, u.line || 1, { projectRoot: l });
              })));
          ...
          ((Q.className = 'sb-compliance-file-size'),
            (Q.textContent = `${u.size || 0} B`),
            C.appendChild(Z),
            C.appendChild(L),
            C.appendChild(P),
            C.appendChild(Q),
        ...
        ((u.className = 'sb-compliance-files-more text-muted'),
          (u.textContent = `+ ${v.length - w} more files — run a full export for the complete inventory.`),
          N.appendChild(u));
      }
    };
    (Se.forEach((v) => {
      ...
      ((w.type = 'button'),
        (w.className = `btn btn-ghost btn-xs sb-compliance-filter${v.id === _ ? ' is-active' : ''}`),
        (w.textContent = v.label),
  ...
  t.appendChild(i);
  const ie = t.closest('#analyze-path-dropzone');
  ie && ie.classList.add('has-compliance-report');
}
function bt(e, t) {
  return !(t != null && t.available) || !(t != null && t.scannerAvailable) ? !1 : je(e);
}
function k() {
...
function He() {
  return g() || b() ? !0 : k() || E() ? !1 : T();
}
function We() {
  return k() ? g() || H() : !(E() && !b() && !g());
}
const qe = { available: !1, scannerAvailable: !1, hostedSkipped: !0 },
...
function yt(e) {
  ...
  if (!(!((o = e) === null || o === void 0) && o.scannerAvailable)) {
    var r;
    return `Local Scan Agent is running but the scanner is not loaded.${!((r = e) === null || r === void 0) && r.scannerLoadError ? ` (${e.scannerLoadError})` : ''} Restart the agent or reinstall the portable package.`;
  }
...
export {
  Te as bridgeFetchViaParent,
  ot as buildBridgeOllamaChatUrls,
  Fe as buildBridgeOllamaProbeUrls,
  et as buildExtensionConnectDeepLink,
  ge as canUseParentBridgeFetch,
  Ze as clearStaleIntegratedBridgeParams,
  ve as detectPlatform,
  tt as discoverAndApplyExtensionBridge,
  lt as fetchInventoryViaAgent,
  dt as fetchScanProgressViaAgent,
  pt as fetchScanProgressViaExtensionBridge,
  st as findFolderViaBridge,
  gt as formatAgentStatus,
  wt as getAgentDownloadUrl,
  yt as getAgentFallbackMessage,
  we as getBridgeFetch,
  b as getExtensionBridgeOrigin,
  _t as getInstallInstructions,
  $ as getLocalBridgeFetch,
  kt as getPlatformLabel,
  Qe as getVsixDownloadUrl,
  G as hasExplicitBridgeParam,
  H as hasExtensionBridgeConfigured,
  k as isHostedHttpsDashboard,
  E as isIntegratedLocalDashboard,
  je as isLocalPath,
  it as pickFolderViaExtensionBridge,
  ct as probeAgent,
  ft as probeAgent4000,
  W as probeExtensionBridgeHealth,
  re as probeExtensionDataServer,
  rt as probeLocalOllama,
  at as probeUserInitiatedOllama,
  mt as renderAgentCertificate,
  De as resolveOllamaProxyUrl,
  ut as scanViaAgent,
  ht as scanViaAgent4000,
  He as shouldProbeAgent4000,
  We as shouldProbeLocalAgent,
  bt as shouldUseAgent,
  nt as validateExtensionBridgeOnLoad,
};
