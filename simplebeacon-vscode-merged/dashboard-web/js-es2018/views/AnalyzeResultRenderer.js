...
export class AnalyzeResultRenderer {
    ...
    renderSimplebeaconResults(result) {
      ...
      <div class="an-res-v3">
        ...
        <div class="an-res-v3-body">
          ${((_c = report.issues) === null || _c === void 0 ? void 0 : _c.length) ? renderIssueList(report.issues) : '<p class="text-muted">No issues found.</p>'}
        </div>
      </div>
    `;
    }
    ...
    renderAiSystemsResults(result) {
      ...
      <div class="an-res-v3">
        ...
        <div class="an-res-v3-body">
          ${((_a = result.issues) === null || _a === void 0 ? void 0 : _a.length) ? renderIssueList(result.issues) : '<p class="text-muted">No AI system issues detected.</p>'}
        </div>
      </div>
    `;
    }
    renderSnippetResults(result) {
      ...
      <div class="an-res-v3">
        ...
        <div class="an-res-v3-body">
          ${((_a = result.findings) === null || _a === void 0 ? void 0 : _a.length) ? renderIssueList(result.findings) : '<p class="text-muted">No findings in snippet.</p>'}
        </div>
      </div>
    `;
    }
