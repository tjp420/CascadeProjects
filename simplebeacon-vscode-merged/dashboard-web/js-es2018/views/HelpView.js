...
export class HelpView {
  ...
  render() {
    ...
    const metricDefs = [
      {
        term: 'mock/sample',
        meaning: 'Files in configured scanPaths (e.g. web/data/*-sample.json) — the gate target (~42 on ai-platform).',
      },
      {
        term: 'rule-scoped',
        meaning: 'Files read by credential + production-leak rules (often ~117) — broader than mock paths alone.',
      },
      {
        term: 'page specs',
        meaning:
      ...
      {
        term: 'repo files',
        meaning: 'Audit inventory of project root (~1k on ai-platform, skips node_modules/.git) — context only.',
      },
      {
        term: 'consistency',
        meaning: 'Fiction/KPI drift score on samples — prefer this over capped quality score for pass/fail.',
      },
...
npm test -- --testPathPattern=page-samples</pre>
    ...
    (_c = el.querySelector('#help-copy-cli')) === null || _c === void 0
      ...
      : _c.addEventListener('click', async () => {
          var _a;
          const code =
            ((_a = el.querySelector('#help-cli-code')) === null || _a === void 0 ? void 0 : _a.textContent) || '';
          try {
  ...
  render() {
    ...
    (_a = el.querySelector('#features-filter')) === null || _a === void 0
      ...
      : _a.addEventListener('input', (e) => {
          ...
          (_a = container === null || container === void 0 ? void 0 : container.querySelector('#features-filter')) ===
            null || _a === void 0
            ? void 0
            : _a.focus();
          const input =
            container === null || container === void 0 ? void 0 : container.querySelector('#features-filter');
          if (input) {
            input.focus();
