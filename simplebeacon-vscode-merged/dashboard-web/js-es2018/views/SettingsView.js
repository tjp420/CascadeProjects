...
export class SettingsView {
      ...
      : _b.addEventListener('click', () => {
          ...
          const baseUrl =
            this.sanitizeOllamaBaseUrl(
              (_b = (_a = root.querySelector('#settings-ai-ollama')) === null || _a === void 0 ? void 0 : _a.value) ===
                null || _b === void 0
                ? void 0
                : _b.trim()
            ) ||
  ...
  captureAiKeysFormDraft(root = this._root) {
    ...
    this.syncAiKeysFormDraft({
      ...
      ollamaModel:
        (_f =
          (_e =
            (_d = root.querySelector('#settings-ai-ollama-model')) === null || _d === void 0 ? void 0 : _d.value) ===
            null || _e === void 0
            ? void 0
    ...
    try {
      ...
      return {
        ...
        agency: {
          ...
          score:
            (_m = (_l = parsed.agency) === null || _l === void 0 ? void 0 : _l.score) !== null && _m !== void 0
              ? _m
              : 100,
        ...
        executive: {
          projectName:
            ((_p = parsed.executive) === null || _p === void 0 ? void 0 : _p.projectName) || 'CascadeProjects',
          assessor:
            ((_q = parsed.executive) === null || _q === void 0 ? void 0 : _q.assessor) || 'SimpleBeacon Operator',
            ...
            agency: {
              ...
              milestone:
                ((_d = root.querySelector('#settings-agency-milestone')) === null || _d === void 0
                  ...
                  : _d.value) || 'Release',
              date:
                ((_e = root.querySelector('#settings-agency-date')) === null || _e === void 0 ? void 0 : _e.value) ||
                '',
              scanId:
                ((_f = root.querySelector('#settings-agency-scan-id')) === null || _f === void 0
                  ...
                  : _f.value.trim()) || '',
              score: Number(
                ((_g = root.querySelector('#settings-agency-score')) === null || _g === void 0 ? void 0 : _g.value) ||
                  100
              ),
              status:
                ((_h = root.querySelector('#settings-agency-status')) === null || _h === void 0 ? void 0 : _h.value) ||
                'PASS',
            },
            executive: {
              projectName:
              ...
              assessor:
                ((_k = root.querySelector('#settings-exec-assessor')) === null || _k === void 0
                  ...
                  : _k.value.trim()) || '',
              date:
                ((_l = root.querySelector('#settings-exec-date')) === null || _l === void 0 ? void 0 : _l.value) || '',
              reportId:
                ((_m = root.querySelector('#settings-exec-report-id')) === null || _m === void 0
                  ? void 0
                  : _m.value.trim()) || '',
              summary:
                ((_o = root.querySelector('#settings-exec-summary')) === null || _o === void 0 ? void 0 : _o.value) ||
                '',
              verdict:
                ((_p = root.querySelector('#settings-exec-verdict')) === null || _p === void 0 ? void 0 : _p.value) ||
                'READY',
            },
          });
  ...
  buildConfigFromDom(base, rootEl) {
    ...
    if (root) {
      config.sampleDir =
        ((_b = (_a = root.querySelector('#settings-sample-dir')) === null || _a === void 0 ? void 0 : _a.value) ===
          null || _b === void 0
          ? void 0
