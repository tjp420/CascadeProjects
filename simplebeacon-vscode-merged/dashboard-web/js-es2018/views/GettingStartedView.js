...
const TASKS = [
    {
        ...
        description: 'Drop a folder, browse, or paste a path. Privacy mode keeps scans in your browser.',
        route: 'analyze',
    ...
    },
    {
        ...
        description: 'Filter issues by severity and category. See your gate score and what to fix.',
        route: 'results',
    ...
    },
    {
        ...
        description: 'Prioritized fix steps generated from your latest scan report.',
        route: 'roadmap',
    ...
    },
    {
        ...
        description: 'Connect OpenAI, Anthropic, or Ollama for AI-powered scan summaries and chat.',
        route: 'settings',
    ...
    },
    {
        ...
        description: 'Add a FIDO2 hardware key or platform authenticator for passwordless login.',
        route: 'profile',
    ...
    },
    {
        ...
        description: 'Ask AI about your codebase and scan findings. Use local Ollama for private AI.',
        route: 'chatbot',
...
function isTaskComplete(taskId, appState) {
    ...
    if (taskId === 'review_findings' && appState.report && appState._hadReport) return true;
    return false;
}
