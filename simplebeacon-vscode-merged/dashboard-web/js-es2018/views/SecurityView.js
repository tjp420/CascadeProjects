...
export class SecurityView {
  ...
  async handlePurgeStaleKeys() {
    ...
    try {
      ...
      const purged =
        res && (res.purged || res.purgedCount || res.deleted) ? res.purged || res.purgedCount || res.deleted : 0;
  ...
  render() {
    ...
    const complianceScore =
      (_c = (_b = this.compliance) === null || _b === void 0 ? void 0 : _b.securityScore) !== null && _c !== void 0
        ? _c
        : null;
      ...
      : _f.addEventListener('click', async () => {
          ...
          const payload = {
            ...
            reportSummary: {
              ...
              complianceScore:
                (_b = (_a = this.compliance) === null || _a === void 0 ? void 0 : _a.securityScore) !== null &&
                _b !== void 0
                  ? _b
                  : 'N/A',
            },
