...
function parseJestTotal(jestTestsLabel, fallback) {
  if (!jestTestsLabel) return fallback !== null && fallback !== void 0 ? fallback : null;
...
function resolveCoverageSnapshot(coverage, baseline, dashboardHome) {
  ...
  const passed =
    (_b =
      ...
      ? _b
      : (_c = dashboardHome === null || dashboardHome === void 0 ? void 0 : dashboardHome.overview) === null ||
          _c === void 0
        ? void 0
        : _c.passedTests;
  const total =
    (_g =
      (_e =
        (_d = merged.totalTests) !== null && _d !== void 0
          ? _d
          : parseJestTotal(baseline === null || baseline === void 0 ? void 0 : baseline.jestTestsLabel, passed)) !==
        null && _e !== void 0
        ? _e
        : (_f = dashboardHome === null || dashboardHome === void 0 ? void 0 : dashboardHome.overview) === null ||
            _f === void 0
          ? void 0
...
function coveragePendingMessage(coverage) {
  if (
    (coverage === null || coverage === void 0 ? void 0 : coverage.branchCoverage) != null ||
    (coverage === null || coverage === void 0 ? void 0 : coverage.lineCoverage) != null
  )
    return '';
  return (
...
export class QualityView {
  ...
  render() {
    ...
    const dependencyVulnTotal =
      (_c =
        (_b =
          (_a = auditStats === null || auditStats === void 0 ? void 0 : auditStats.vulnerabilityTotal) !== null &&
          _a !== void 0
            ? _a
    ...
    (_s = el.querySelector('#quality-send-ai-btn')) === null || _s === void 0
      ...
      : _s.addEventListener('click', async () => {
          ...
          if (typeof rawVulns === 'object' && rawVulns !== null) {
            for (const [pkg, info] of Object.entries(rawVulns)) {
              if (info && typeof info === 'object') {
                const sev =
                  info.severity ||
                  ((_b = (_a = info.via) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0
                    ? void 0
                    : _b.severity) ||
                  'unknown';
                const title =
                  ((_d = (_c = info.via) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0
                    ? void 0
                    : _d.title) ||
                  info.title ||
                  info.overview ||
          ...
          const payload = {
            ...
            reportSummary: {
              lineCoverage:
                (_f = (_e = coverage.overallCoverage) !== null && _e !== void 0 ? _e : coverage.lineCoverage) !==
                  null && _f !== void 0
                  ? _f
                  : 'N/A',
              ...
              qualityScore:
                (_k = (_j = quality.overallScore) !== null && _j !== void 0 ? _j : quality.qualityScore) !== null &&
                _k !== void 0
                  ? _k
                  : 'N/A',
              npmVulnerabilities:
                (_l = auditStats === null || auditStats === void 0 ? void 0 : auditStats.vulnerabilityTotal) !== null &&
                _l !== void 0
                  ? _l
                  : 'N/A',
