...
export function resolveGateResult(bundle = {}) {
  ...
  return (_d =
    (_c = assessment === null || assessment === void 0 ? void 0 : assessment.executiveSummary) === null || _c === void 0
      ? void 0
...
function resolveSprintGateResult(bundle = {}, assessment = {}) {
  ...
  if (
    (_a = assessment === null || assessment === void 0 ? void 0 : assessment.executiveSummary) === null || _a === void 0
      ? void 0
      : _a.sprintGateResult
  ) {
  ...
  return {
    ...
    euAiActScanned: preferEmbedded
      ...
      : (_p =
            (_m =
              (_l =
                (_k = assessment === null || assessment === void 0 ? void 0 : assessment.findings) === null ||
                _k === void 0
                  ? void 0
...
function sanitizeComplianceExport(compliance, projectLabel) {
  ...
  return {
    ...
    provenance:
      compliance.gateReconciledFrom === 'live-gate-scan' ? 'live-gate-scan-reconciled' : 'eu-ai-act-sprint-artifact',
  };
}
/**
...
function sanitizeAssessmentExport(assessment, projectLabel) {
  ...
  return {
    ...
    provenance:
      ((_a = assessment.executiveSummary) === null || _a === void 0 ? void 0 : _a.gateResultSource) === 'live-gate-scan'
...
export function buildEuAiActSummary(bundle = {}) {
  ...
  const mainReportGatePass =
    (_a = embedded === null || embedded === void 0 ? void 0 : embedded.gatePass) !== null && _a !== void 0 ? _a : null;
  ...
  return {
    ...
    readinessScore:
      (_e = (_d = summary.score) !== null && _d !== void 0 ? _d : summary.complianceScore) !== null && _e !== void 0
        ? _e
        : null,
    checklistHeadline:
      (_g =
...
function syncAssessmentEuMetrics(assessment, summary) {
  ...
  return {
    ...
    euAiActSummary: {
      ...
      aiSystemIndicators:
        (_a = summary.aiSystemIndicators) !== null && _a !== void 0 ? _a : assessment.euAiActSummary.aiSystemIndicators,
      highRiskIndicators:
        (_b = summary.highRiskIndicators) !== null && _b !== void 0 ? _b : assessment.euAiActSummary.highRiskIndicators,
      transparencyGaps:
        (_c = summary.transparencyGaps) !== null && _c !== void 0 ? _c : assessment.euAiActSummary.transparencyGaps,
      documentationArtifacts:
  ...
  return {
    ...
    summary: {
      ...
      operatorDocumentationCount:
        (_c = summary.operatorDocumentationCount) !== null && _c !== void 0 ? _c : summary.documentationArtifacts,
    ...
    hygieneSummary: {
      ...
      documentationArtifacts:
        (_d = summary.operatorDocumentationCount) !== null && _d !== void 0 ? _d : summary.documentationArtifacts,
      operatorDocumentationCount:
        (_e = summary.operatorDocumentationCount) !== null && _e !== void 0 ? _e : summary.documentationArtifacts,
...
function buildSprintArtifactExportNotes(sprint = {}, options = {}) {
  ...
  if (
    ((_b = (_a = sprint.complianceChecklist) === null || _a === void 0 ? void 0 : _a.summary) === null || _b === void 0
      ? void 0
  ...
  const sprintRepo =
    (_g =
      (_d = (_c = sprint.report) === null || _c === void 0 ? void 0 : _c.repositoryFilesTotal) !== null && _d !== void 0
        ? _d
  ...
  const ruleScoped =
    (_m =
      ...
      _j !== void 0
        ? _j
        : (_l = (_k = sprint.report) === null || _k === void 0 ? void 0 : _k.scanScope) === null || _l === void 0
          ? void 0
  ...
  if (
    ...
    const blocking =
      (_8 =
        (_6 = (_5 = sprint.gate) === null || _5 === void 0 ? void 0 : _5.blockingCount) !== null && _6 !== void 0
          ? _6
...
function buildSprintArtifactHygieneSummary(sprint = {}, options = {}) {
  ...
  const sprintRepo =
    (_f =
      (_c = (_b = sprint.report) === null || _b === void 0 ? void 0 : _b.repositoryFilesTotal) !== null && _c !== void 0
        ? _c
  ...
  const ruleScoped =
    (_l =
      ...
      _h !== void 0
        ? _h
        : (_k = (_j = sprint.report) === null || _j === void 0 ? void 0 : _j.scanScope) === null || _k === void 0
          ? void 0
  ...
  const sprintFiction =
    (_r =
      ...
      _o !== void 0
        ? _o
        : (_q = (_p = sprint.report) === null || _p === void 0 ? void 0 : _p.scanScope) === null || _q === void 0
          ? void 0
  ...
  return {
    ...
    euAiActScanned:
      (_19 =
        ...
        _16 !== void 0
          ? _16
          : (_18 = (_17 = sprint.report) === null || _17 === void 0 ? void 0 : _17.scanScope) === null || _18 === void 0
            ? void 0
    ...
    productionLeakSuppressedIntent:
      (_24 = (_23 = sprint.report) === null || _23 === void 0 ? void 0 : _23.productionLeakSuppressedIntent) !== null &&
      _24 !== void 0
        ? _24
        : null,
...
export function sanitizeEuAiActSprintArtifactExport(sprint, options = {}) {
  ...
  if (
    ((_f = (_e = sprint.complianceChecklist) === null || _e === void 0 ? void 0 : _e.summary) === null || _f === void 0
      ? void 0
