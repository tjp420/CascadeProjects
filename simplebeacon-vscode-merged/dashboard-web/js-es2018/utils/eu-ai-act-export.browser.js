...
function resolveProjectLabel(bundle = {}) {
    var _a, _b, _c, _d;
    return projectLabelFromPath(((_a = bundle.compliance) === null || _a === void 0 ? void 0 : _a.projectRoot)
...
export function resolveGateResult(bundle = {}) {
    ...
    const sprintAt = parseTimestamp((assessment === null || assessment === void 0 ? void 0 : assessment.generatedAt)
        || ((_a = bundle.compliance) === null || _a === void 0 ? void 0 : _a.evaluatedAt)
        || ((_b = bundle.sprintReport) === null || _b === void 0 ? void 0 : _b.generatedAt));
    if ((embedded === null || embedded === void 0 ? void 0 : embedded.gatePass) != null && (embeddedAt == null || sprintAt == null || embeddedAt >= sprintAt)) {
        return embedded.gatePass === true ? 'PASS' : 'FAIL';
    }
    return (_d = (_c = assessment === null || assessment === void 0 ? void 0 : assessment.executiveSummary) === null || _c === void 0 ? void 0 : _c.gateResult) !== null && _d !== void 0 ? _d : ((embedded === null || embedded === void 0 ? void 0 : embedded.gatePass) === true ? 'PASS' : (embedded === null || embedded === void 0 ? void 0 : embedded.gatePass) === false ? 'FAIL' : null);
}
/**
...
function buildFreshnessNote(bundle = {}) {
    ...
    const embeddedAt = parseTimestamp((_a = bundle.embeddedInMainReport) === null || _a === void 0 ? void 0 : _a.generatedAt);
    const sprintAt = parseTimestamp(((_b = bundle.compliance) === null || _b === void 0 ? void 0 : _b.evaluatedAt)
...
function resolveSprintTimestamp(bundle = {}) {
    var _a, _b, _c;
    return parseTimestamp(((_a = bundle.compliance) === null || _a === void 0 ? void 0 : _a.evaluatedAt)
...
function isLiveGatePreferred(bundle = {}) {
    ...
    return (embedded === null || embedded === void 0 ? void 0 : embedded.gatePass) != null && embeddedAt != null && sprintAt != null && embeddedAt > sprintAt;
}
...
function shouldReconcileScanRulesFromEmbedded(bundle = {}) {
    var _a, _b;
    if (!bundle.embeddedInMainReport || !((_b = (_a = bundle.compliance) === null || _a === void 0 ? void 0 : _a.rules) === null || _b === void 0 ? void 0 : _b.length))
        return false;
    if (isLiveGatePreferred(bundle))
        return true;
    const embedded = bundle.embeddedInMainReport;
    if (embedded.gatePass !== true)
        return false;
    const hasStaleFail = bundle.compliance.rules.some((rule) => SCAN_CHECKLIST_RULE_IDS.includes(rule.id) && rule.status === 'fail');
    if (!hasStaleFail)
        return false;
...
function reconcileScanChecklistRule(rule, embedded = {}) {
    var _a, _b, _c, _d;
    if (!SCAN_CHECKLIST_RULE_IDS.includes(rule.id))
        return rule;
    ...
    if (rule.id === 'CRED-001' && cred === 0 && (credScanned !== null && credScanned !== void 0 ? credScanned : 0) > 0) {
        return {
            ...rule,
            status: 'pass',
    ...
    if (rule.id === 'LEAK-001' && leak === 0 && (leakScanned !== null && leakScanned !== void 0 ? leakScanned : 0) > 0) {
        return {
            ...rule,
            status: 'pass',
...
function reconcileComplianceForLiveGate(compliance, bundle = {}) {
    var _a, _b, _c, _d, _e, _f;
    if (!((_a = compliance === null || compliance === void 0 ? void 0 : compliance.rules) === null || _a === void 0 ? void 0 : _a.length))
        return compliance;
    ...
    const score = scored ? Math.round((passed / scored) * 100) : (_c = (_b = compliance.summary) === null || _b === void 0 ? void 0 : _b.score) !== null && _c !== void 0 ? _c : null;
    return {
        ...compliance,
        title: normalizeSimpleBeaconBranding(compliance.title),
        rules,
        summary: {
            ...
            total: rules.length,
            score,
            headline: (_d = buildChecklistHeadline(passed, failed, rules.length)) !== null && _d !== void 0 ? _d : (_e = compliance.summary) === null || _e === void 0 ? void 0 : _e.headline,
...
function dedupeAssessmentFindings(assessment) {
    var _a, _b;
    if (!((_b = (_a = assessment === null || assessment === void 0 ? void 0 : assessment.findings) === null || _a === void 0 ? void 0 : _a.fictionKpis) === null || _b === void 0 ? void 0 : _b.summary))
        return assessment;
    return {
        ...assessment,
        findings: {
...
function resolveSprintGateResult(bundle = {}, assessment = {}) {
    ...
    if ((_a = assessment === null || assessment === void 0 ? void 0 : assessment.executiveSummary) === null || _a === void 0 ? void 0 : _a.sprintGateResult) {
        return assessment.executiveSummary.sprintGateResult;
    }
    if (((_c = (_b = bundle.sprintReport) === null || _b === void 0 ? void 0 : _b.gate) === null || _c === void 0 ? void 0 : _c.pass) === false)
        return 'FAIL';
    if (((_e = (_d = bundle.sprintReport) === null || _d === void 0 ? void 0 : _d.gate) === null || _e === void 0 ? void 0 : _e.pass) === true)
        return 'PASS';
    if (((_f = assessment === null || assessment === void 0 ? void 0 : assessment.executiveSummary) === null || _f === void 0 ? void 0 : _f.gateResultSource) !== 'live-gate-scan') {
        return (_h = (_g = assessment === null || assessment === void 0 ? void 0 : assessment.executiveSummary) === null || _g === void 0 ? void 0 : _g.gateResult) !== null && _h !== void 0 ? _h : null;
    }
    return null;
}
/**
...
function applyExportReconciliation(bundle = {}) {
    return {
        ...
        compliance: bundle.compliance
            ? reconcileComplianceForLiveGate({ ...bundle.compliance, title: normalizeSimpleBeaconBranding(bundle.compliance.title) }, bundle)
            : null,
...
function resolveFreshEuAiActMetrics(bundle = {}) {
    ...
    const preferEmbedded = embeddedNewer && (embeddedEu.aiSystemIndicators != null || embeddedEu.documentationArtifacts != null);
    ...
    const operatorCount = (_a = source.operatorDocumentationCount) !== null && _a !== void 0 ? _a : docs.filter((doc) => !String(doc).startsWith('.simplebeacon/')).length;
    const metricsStaleNote = preferEmbedded && ((sprintEu.aiSystemIndicators != null && embeddedEu.aiSystemIndicators != null
    ...
    return {
        ...
        euAiActScanned: preferEmbedded
            ? ((_j = embedded.euAiActScanned) !== null && _j !== void 0 ? _j : null)
            : ((_p = (_m = (_l = (_k = assessment === null || assessment === void 0 ? void 0 : assessment.findings) === null || _k === void 0 ? void 0 : _k.euAiAct) === null || _l === void 0 ? void 0 : _l.scanned) !== null && _m !== void 0 ? _m : (_o = bundle.sprintReport) === null || _o === void 0 ? void 0 : _o.euAiActScanned) !== null && _p !== void 0 ? _p : null),
...
function buildFilesScannedNote(assessment) {
    var _a;
    const filesScanned = (_a = assessment === null || assessment === void 0 ? void 0 : assessment.executiveSummary) === null || _a === void 0 ? void 0 : _a.filesScanned;
    if (filesScanned == null || filesScanned > 20)
        return null;
...
function sanitizeAssessmentExport(assessment, projectLabel) {
    ...
    const docSplit = splitDocumentationPaths((euAiActSummary === null || euAiActSummary === void 0 ? void 0 : euAiActSummary.documentationFound) || []);
    ...
    return {
        ...
        provenance: ((_a = assessment.executiveSummary) === null || _a === void 0 ? void 0 : _a.gateResultSource) === 'live-gate-scan'
            ? 'live-gate-scan-reconciled'
            : 'eu-ai-act-sprint-artifact',
        ...(euAiActSummary
            ? {
        ...
        ...(sourceReport
            ? {
                sourceReport: {
                    ...
                    scanPaths: relativizeScanPathsForExport(sourceReport.scanPaths, assessment.projectRoot, projectLabel),
...
function sanitizeEmbeddedMainReportExport(embedded, projectLabel) {
    ...
    if (!embedded)
        return null;
    const docSplit = splitDocumentationPaths(((_a = embedded.summary) === null || _a === void 0 ? void 0 : _a.documentationFound) || []);
    return {
...
export function buildEuAiActSummary(bundle = {}) {
    ...
    const assessment = bundle.assessment;
    const embedded = bundle.embeddedInMainReport;
    const summary = (compliance === null || compliance === void 0 ? void 0 : compliance.summary) || (assessment === null || assessment === void 0 ? void 0 : assessment.executiveSummary) || {};
    const freshMetrics = resolveFreshEuAiActMetrics(bundle);
    const projectLabel = resolveProjectLabel(bundle);
    const gateResult = resolveGateResult(bundle);
    const sprintGateResult = resolveSprintGateResult(bundle, assessment);
    const mainReportGatePass = (_a = embedded === null || embedded === void 0 ? void 0 : embedded.gatePass) !== null && _a !== void 0 ? _a : null;
    ...
    return {
        ...
        readinessScore: (_e = (_d = summary.score) !== null && _d !== void 0 ? _d : summary.complianceScore) !== null && _e !== void 0 ? _e : null,
        checklistHeadline: (_g = (_f = summary.headline) !== null && _f !== void 0 ? _f : compliance === null || compliance === void 0 ? void 0 : compliance.title) !== null && _g !== void 0 ? _g : null,
        checklistReconciledFrom: (_h = compliance === null || compliance === void 0 ? void 0 : compliance.gateReconciledFrom) !== null && _h !== void 0 ? _h : null,
        gateResult,
        sprintGateResult,
        mainReportGatePass,
        ...
        evaluatedAt: (_l = (_k = (_j = compliance === null || compliance === void 0 ? void 0 : compliance.evaluatedAt) !== null && _j !== void 0 ? _j : assessment === null || assessment === void 0 ? void 0 : assessment.generatedAt) !== null && _k !== void 0 ? _k : embedded === null || embedded === void 0 ? void 0 : embedded.generatedAt) !== null && _l !== void 0 ? _l : null,
        mainReportGeneratedAt: (_m = embedded === null || embedded === void 0 ? void 0 : embedded.generatedAt) !== null && _m !== void 0 ? _m : null,
        projectRoot: redactProjectPathForExport((_r = (_p = (_o = compliance === null || compliance === void 0 ? void 0 : compliance.projectRoot) !== null && _o !== void 0 ? _o : assessment === null || assessment === void 0 ? void 0 : assessment.projectRoot) !== null && _p !== void 0 ? _p : (_q = bundle.sprintReport) === null || _q === void 0 ? void 0 : _q.projectRoot) !== null && _r !== void 0 ? _r : embedded === null || embedded === void 0 ? void 0 : embedded.projectRoot, projectLabel),
        freshnessNote: buildFreshnessNote(bundle),
        metricsStaleNote: freshMetrics.metricsStaleNote,
        ...(filesScannedNote ? { filesScannedNote } : {}),
        ...(((_s = assessment === null || assessment === void 0 ? void 0 : assessment.executiveSummary) === null || _s === void 0 ? void 0 : _s.executiveSummaryNote)
...
function syncAssessmentEuMetrics(assessment, summary) {
    var _a, _b, _c, _d;
    if (!(assessment === null || assessment === void 0 ? void 0 : assessment.euAiActSummary) || summary.metricsSource !== 'live-gate-scan')
        return assessment;
    return {
        ...assessment,
        euAiActSummary: {
            ...assessment.euAiActSummary,
            aiSystemIndicators: (_a = summary.aiSystemIndicators) !== null && _a !== void 0 ? _a : assessment.euAiActSummary.aiSystemIndicators,
            highRiskIndicators: (_b = summary.highRiskIndicators) !== null && _b !== void 0 ? _b : assessment.euAiActSummary.highRiskIndicators,
            transparencyGaps: (_c = summary.transparencyGaps) !== null && _c !== void 0 ? _c : assessment.euAiActSummary.transparencyGaps,
            documentationArtifacts: (_d = summary.documentationArtifacts) !== null && _d !== void 0 ? _d : assessment.euAiActSummary.documentationArtifacts
        }
    };
}
/**
...
export function buildEuAiActExportBundle(bundle = {}) {
    ...
    const exportNotes = dedupeExportNotes([
        ...
        summary.metricsSource === 'live-gate-scan' && summary.simplebeaconDocumentationArtifacts
            ...
            : null,
        !exportEligibility.eligible && ((_b = (_a = exportEligibility.errors) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.message)
    ...
    return {
        ...
        summary: {
            ...summary,
            operatorDocumentationCount: (_c = summary.operatorDocumentationCount) !== null && _c !== void 0 ? _c : summary.documentationArtifacts,
        ...
        hygieneSummary: {
            ...
            documentationArtifacts: (_d = summary.operatorDocumentationCount) !== null && _d !== void 0 ? _d : summary.documentationArtifacts,
            operatorDocumentationCount: (_e = summary.operatorDocumentationCount) !== null && _e !== void 0 ? _e : summary.documentationArtifacts,
...
function buildSprintArtifactExportNotes(sprint = {}, options = {}) {
    ...
    if (((_b = (_a = sprint.complianceChecklist) === null || _a === void 0 ? void 0 : _a.summary) === null || _b === void 0 ? void 0 : _b.legalHandoffEligible) === true) {
        notes.push('legalHandoffEligible reflects EU technical rule rows — EUAI-000 classification sign-off still required before client legal handoff.');
    }
    const gateContext = resolveSprintGateContext(sprint, options);
    const { repositoryFilesTotal: gateTotal, credentialScanned, gateProfile, gateReport, fictionJsonFilesScanned: gateFiction, fictionSampleFilesScanned: fictionSamples } = gateContext;
    const sprintRepo = (_g = (_d = (_c = sprint.report) === null || _c === void 0 ? void 0 : _c.repositoryFilesTotal) !== null && _d !== void 0 ? _d : (_f = (_e = sprint.report) === null || _e === void 0 ? void 0 : _e.repositoryInventory) === null || _f === void 0 ? void 0 : _f.totalFiles) !== null && _g !== void 0 ? _g : null;
    if (gateTotal != null && sprintRepo != null && gateTotal > sprintRepo) {
        notes.push(`EU sprint inventory ${Number(sprintRepo).toLocaleString()} files (audit profile) — Complete scan gate full-tree inventory is ${Number(gateTotal).toLocaleString()} paths.`);
    }
    ...
    const ruleScoped = (_m = (_j = (_h = sprint.report) === null || _h === void 0 ? void 0 : _h.ruleScopedFilesAnalyzed) !== null && _j !== void 0 ? _j : (_l = (_k = sprint.report) === null || _k === void 0 ? void 0 : _k.scanScope) === null || _l === void 0 ? void 0 : _l.ruleScopedFilesAnalyzed) !== null && _m !== void 0 ? _m : null;
    const sprintProfile = (_q = (_p = (_o = sprint.report) === null || _o === void 0 ? void 0 : _o.scanScope) === null || _p === void 0 ? void 0 : _p.profile) !== null && _q !== void 0 ? _q : gateProfile;
    if (sprintProfile === 'eu-ai-act' && ruleScoped != null) {
        notes.push(`EU AI Act sprint gate checked ${Number(ruleScoped).toLocaleString()} rule-scoped paths — narrower scope than full-platform gate when run standalone.`);
    }
    const sprintFiction = (_s = (_r = sprint.report) === null || _r === void 0 ? void 0 : _r.fictionJsonFilesScanned) !== null && _s !== void 0 ? _s : (_u = (_t = sprint.report) === null || _t === void 0 ? void 0 : _t.scanScope) === null || _u === void 0 ? void 0 : _u.fictionJsonFilesScanned;
    ...
    const nonDocs = (_w = (_v = sprint.report) === null || _v === void 0 ? void 0 : _v.euAiActSummary) === null || _w === void 0 ? void 0 : _w.scanMatchedNonDocsCount;
    if (nonDocs != null && nonDocs > 0) {
        notes.push(`${Number(nonDocs).toLocaleString()} EU AI Act scan pattern match(es) outside docs/ (e.g. package.json) — not operator handoff documentation.`);
    }
    const suppressed = (_x = sprint.report) === null || _x === void 0 ? void 0 : _x.productionLeakSuppressedIntent;
    if (suppressed != null && suppressed > 0 && ((_z = (_y = sprint.report) === null || _y === void 0 ? void 0 : _y.productionLeakFindings) !== null && _z !== void 0 ? _z : 0) === 0) {
        notes.push(`${Number(suppressed).toLocaleString()} production-leak pattern hit(s) suppressed as intentional — blocking productionLeakFindings is 0.`);
    }
    if ((_1 = (_0 = sprint.assessment) === null || _0 === void 0 ? void 0 : _0.pilotProposal) === null || _1 === void 0 ? void 0 : _1.pricePlaceholder) {
    ...
    if (((_2 = sprint.gate) === null || _2 === void 0 ? void 0 : _2.pass) === false || ((_3 = sprint.complianceChecklist) === null || _3 === void 0 ? void 0 : _3.complianceStatus) === 'failed') {
        const failedIds = (((_4 = sprint.complianceChecklist) === null || _4 === void 0 ? void 0 : _4.rules) || [])
            .filter((rule) => rule.status === 'fail')
            .map((rule) => rule.id);
        const blocking = (_8 = (_6 = (_5 = sprint.gate) === null || _5 === void 0 ? void 0 : _5.blockingCount) !== null && _6 !== void 0 ? _6 : (_7 = gateReport.gate) === null || _7 === void 0 ? void 0 : _7.blockingCount) !== null && _8 !== void 0 ? _8 : null;
        if (failedIds.length) {
            notes.push(`Checklist failures (${failedIds.join(', ')}) align with sprint gate (pass=false${blocking != null ? `, ${Number(blocking).toLocaleString()} blocking finding(s)` : ''}) — see json/simplebeacon-gate.json.`);
        }
    }
...
function buildSprintArtifactHygieneSummary(sprint = {}, options = {}) {
    ...
    const gateContext = resolveSprintGateContext(sprint, options);
    const { repositoryFilesTotal: gateTotal, credentialScanned, gateProfile, gateReport, fictionJsonFilesScanned: gateFiction, fictionSampleFilesScanned: fictionSamples } = gateContext;
    const sprintRepo = (_f = (_c = (_b = sprint.report) === null || _b === void 0 ? void 0 : _b.repositoryFilesTotal) !== null && _c !== void 0 ? _c : (_e = (_d = sprint.report) === null || _d === void 0 ? void 0 : _d.repositoryInventory) === null || _e === void 0 ? void 0 : _e.totalFiles) !== null && _f !== void 0 ? _f : null;
    const ruleScoped = (_l = (_h = (_g = sprint.report) === null || _g === void 0 ? void 0 : _g.ruleScopedFilesAnalyzed) !== null && _h !== void 0 ? _h : (_k = (_j = sprint.report) === null || _j === void 0 ? void 0 : _j.scanScope) === null || _k === void 0 ? void 0 : _k.ruleScopedFilesAnalyzed) !== null && _l !== void 0 ? _l : null;
    const sprintFiction = (_r = (_o = (_m = sprint.report) === null || _m === void 0 ? void 0 : _m.fictionJsonFilesScanned) !== null && _o !== void 0 ? _o : (_q = (_p = sprint.report) === null || _p === void 0 ? void 0 : _p.scanScope) === null || _q === void 0 ? void 0 : _q.fictionJsonFilesScanned) !== null && _r !== void 0 ? _r : null;
    const jestChecked = (_w = (_u = (_t = (_s = sprint.report) === null || _s === void 0 ? void 0 : _s.jestBaselineChecked) !== null && _t !== void 0 ? _t : gateReport.jestBaselineChecked) !== null && _u !== void 0 ? _u : (_v = sprint.hygieneSummary) === null || _v === void 0 ? void 0 : _v.jestBaselineChecked) !== null && _w !== void 0 ? _w : null;
    return {
        checklistPassed: (_z = (_x = checklist.passed) !== null && _x !== void 0 ? _x : (_y = sprint.compliance) === null || _y === void 0 ? void 0 : _y.passed) !== null && _z !== void 0 ? _z : null,
        checklistTotal: (_2 = (_0 = checklist.total) !== null && _0 !== void 0 ? _0 : (_1 = sprint.compliance) === null || _1 === void 0 ? void 0 : _1.total) !== null && _2 !== void 0 ? _2 : null,
        readinessScore: (_5 = (_3 = checklist.score) !== null && _3 !== void 0 ? _3 : (_4 = sprint.compliance) === null || _4 === void 0 ? void 0 : _4.score) !== null && _5 !== void 0 ? _5 : null,
        gateResult: ((_6 = sprint.gate) === null || _6 === void 0 ? void 0 : _6.pass) === false ? 'FAIL' : ((_7 = sprint.gate) === null || _7 === void 0 ? void 0 : _7.pass) ? 'PASS' : null,
        euPatternHits: (_10 = (_8 = sprint.euPatternHits) !== null && _8 !== void 0 ? _8 : (_9 = sprint.report) === null || _9 === void 0 ? void 0 : _9.euAiActFindings) !== null && _10 !== void 0 ? _10 : 0,
        operatorDocumentationCount: (_14 = (_11 = checklist.operatorDocumentationCount) !== null && _11 !== void 0 ? _11 : (_13 = (_12 = sprint.report) === null || _12 === void 0 ? void 0 : _12.euAiActSummary) === null || _13 === void 0 ? void 0 : _13.operatorDocumentationCount) !== null && _14 !== void 0 ? _14 : null,
        ruleScopedFilesAnalyzed: ruleScoped,
        euAiActScanned: (_19 = (_16 = (_15 = sprint.report) === null || _15 === void 0 ? void 0 : _15.euAiActScanned) !== null && _16 !== void 0 ? _16 : (_18 = (_17 = sprint.report) === null || _17 === void 0 ? void 0 : _17.scanScope) === null || _18 === void 0 ? void 0 : _18.euAiActFilesScanned) !== null && _19 !== void 0 ? _19 : null,
        scanMatchedNonDocsCount: (_22 = (_21 = (_20 = sprint.report) === null || _20 === void 0 ? void 0 : _20.euAiActSummary) === null || _21 === void 0 ? void 0 : _21.scanMatchedNonDocsCount) !== null && _22 !== void 0 ? _22 : null,
        productionLeakSuppressedIntent: (_24 = (_23 = sprint.report) === null || _23 === void 0 ? void 0 : _23.productionLeakSuppressedIntent) !== null && _24 !== void 0 ? _24 : null,
...
function reconcileEuAiActSprintReportLimitations(report) {
    var _a, _b, _c, _d, _e, _f, _g, _h;
    if (!((_b = (_a = report === null || report === void 0 ? void 0 : report.scanScope) === null || _a === void 0 ? void 0 : _a.limitations) === null || _b === void 0 ? void 0 : _b.length))
        return report;
    const prodScanned = (_e = (_c = report.productionLeakScanned) !== null && _c !== void 0 ? _c : (_d = report.scanScope) === null || _d === void 0 ? void 0 : _d.productionDirsScanned) !== null && _e !== void 0 ? _e : 0;
    const sourceFiction = (_h = (_f = report.sourceCodeFilesScanned) !== null && _f !== void 0 ? _f : (_g = report.scanScope) === null || _g === void 0 ? void 0 : _g.sourceCodeFilesScanned) !== null && _h !== void 0 ? _h : 0;
...
export function sanitizeEuAiActSprintArtifactExport(sprint, options = {}) {
    ...
    const repositoryFilesTotal = (_d = (_b = (_a = options.repositoryFilesTotal) !== null && _a !== void 0 ? _a : gateReport === null || gateReport === void 0 ? void 0 : gateReport.repositoryFilesTotal) !== null && _b !== void 0 ? _b : (_c = gateReport === null || gateReport === void 0 ? void 0 : gateReport.repositoryInventory) === null || _c === void 0 ? void 0 : _c.totalFiles) !== null && _d !== void 0 ? _d : null;
    const reportOptions = {
        projectPath,
    ...
    if (((_f = (_e = sprint.complianceChecklist) === null || _e === void 0 ? void 0 : _e.summary) === null || _f === void 0 ? void 0 : _f.legalHandoffEligible) != null && (complianceChecklist === null || complianceChecklist === void 0 ? void 0 : complianceChecklist.summary)) {
        complianceChecklist = {
            ...complianceChecklist,
            summary: {
...
export function sanitizeEuAiActExport(bundle) {
    ...
    if (bundle.type === 'simplebeacon-eu-ai-act-export') {
        return buildEuAiActExportBundle({
            hasData: (_b = (_a = bundle.summary) === null || _a === void 0 ? void 0 : _a.hasData) !== null && _b !== void 0 ? _b : true,
            disclaimer: bundle.disclaimer,
...
export function euAiActExportFilename(ext = 'json') {
    ...
    if (ext === 'csv')
        return `eu-ai-act-metrics-${stamp}.csv`;
