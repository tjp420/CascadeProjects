...
function reconcileComplianceReady(executiveSummary, checklist, sourceReport) {
  ...
  let ready =
    (_b = (_a = summary.readyForAutomation) !== null && _a !== void 0 ? _a : executiveSummary.complianceReady) !==
      null && _b !== void 0
      ? _b
      : false;
   ...
   * @returns {any}
   */
  const coreSecuritySkipped = ((checklist === null || checklist === void 0 ? void 0 : checklist.rules) || []).some(
    (r) => ['GATE-001', 'CRED-001', 'LEAK-001'].includes(r.id) && r.status === 'skip'
  );
  const gatePass = Boolean(
    (_g = (_f = sourceReport.gate) === null || _f === void 0 ? void 0 : _f.pass) !== null && _g !== void 0
      ? _g
...
function reconcileExecutiveSummary(assessment, sourceReport) {
  ...
  exec.complianceScore =
    (_c =
      (_b = (_a = checklist.summary) === null || _a === void 0 ? void 0 : _a.score) !== null && _b !== void 0
        ? _b
...
export function sanitizeAssessmentExport(assessment, options = {}) {
  ...
  if (sourceReport) {
    ...
    const mockSampleFiles =
      (_e = (_d = sourceReport.mockSampleFiles) !== null && _d !== void 0 ? _d : sourceReport.totalFiles) !== null &&
      _e !== void 0
        ? _e
        : null;
    executiveSummary = {
      ...
      filesScanned:
        (_g =
          (_f = ruleScoped !== null && ruleScoped !== void 0 ? ruleScoped : sourceReport.filesAnalyzed) !== null &&
          _f !== void 0
            ? _f
      ...
      warningCount:
        (_t =
          (_s = (_r = sourceReport.gate) === null || _r === void 0 ? void 0 : _r.warningCount) !== null && _s !== void 0
            ? _s
            : executiveSummary.warningCount) !== null && _t !== void 0
          ? _t
          : 0,
      qualityScore:
        (_v = (_u = sourceReport.qualityScore) !== null && _u !== void 0 ? _u : executiveSummary.qualityScore) !==
          null && _v !== void 0
          ? _v
          : null,
    };
  ...
  return {
    ...
    exportNotes,
    disclaimers: [
      ...(benchmarkScan ? ['Benchmark clone assessment — not SimpleBeacon ai-platform product handoff.'] : []),
