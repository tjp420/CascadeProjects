...
function enrichAnalyzerResultForExport(result) {
    ...
    const metricScore = hasLegacyScore
        ...
        : clampScore((_a = result.metricScore) !== null && _a !== void 0 ? _a : (scoringDirection === 'higher_better' && Number.isFinite(Number(result.riskScore))
...
function enrichTopPriorityIssuesForExport(issues = [], analyzerResults = []) {
    ...
    return issues.map((issue) => {
        ...
        const riskScore = (_b = (_a = issue.priorityScore) !== null && _a !== void 0 ? _a : result === null || result === void 0 ? void 0 : result.riskScore) !== null && _b !== void 0 ? _b : null;
        const metricScore = (_c = result === null || result === void 0 ? void 0 : result.metricScore) !== null && _c !== void 0 ? _c : null;
        const scoringDirection = (_d = result === null || result === void 0 ? void 0 : result.scoringDirection) !== null && _d !== void 0 ? _d : null;
        return {
            ...issue,
            riskScore,
...
function slimArchitectureForExport(architecture, summary = null) {
    ...
    if (Array.isArray(slim.keyDesignPrinciples) && ((_a = summary === null || summary === void 0 ? void 0 : summary.stubCount) !== null && _a !== void 0 ? _a : 0) === 0) {
        slim.keyDesignPrinciples = slim.keyDesignPrinciples.filter((principle) => !/contract-valid safe stubs/i.test(String(principle)));
    }
    return slim;
}
/**
...
function buildHygieneSummary(summary, riskSummary, healthScore) {
    ...
    return {
        selectedAnalyzerCount: (_a = summary === null || summary === void 0 ? void 0 : summary.selectedIssueCount) !== null && _a !== void 0 ? _a : null,
        measuredCount: (_c = (_b = riskSummary === null || riskSummary === void 0 ? void 0 : riskSummary.measuredAnalyzerCount) !== null && _b !== void 0 ? _b : execution.measured) !== null && _c !== void 0 ? _c : null,
        insufficientDataCount: (_d = execution.insufficientData) !== null && _d !== void 0 ? _d : null,
        peakSeverity: (_e = riskSummary === null || riskSummary === void 0 ? void 0 : riskSummary.peakSeverity) !== null && _e !== void 0 ? _e : null,
        overallRiskLevel: (_f = riskSummary === null || riskSummary === void 0 ? void 0 : riskSummary.overallRiskLevel) !== null && _f !== void 0 ? _f : null,
...
function buildExportNotes(analysisResult, options = {}) {
    ...
    if (((analysisResult === null || analysisResult === void 0 ? void 0 : analysisResult.coverageGaps) || []).length > 0) {
...
function buildSlimPayload(sanitized, summary) {
    ...
    return {
        ...
        selectedIssueCount: (_b = (_a = summary === null || summary === void 0 ? void 0 : summary.selectedIssueCount) !== null && _a !== void 0 ? _a : source.selectedIssueCount) !== null && _b !== void 0 ? _b : null,
        selectedIssueIdsRef: 'root.selectedIssueIds',
        registrySummary: {
            catalogSize: (_d = (_c = source.registry) === null || _c === void 0 ? void 0 : _c.length) !== null && _d !== void 0 ? _d : 48,
            implementedInRun: (_e = summary === null || summary === void 0 ? void 0 : summary.implementedCount) !== null && _e !== void 0 ? _e : null,
            stubsInRun: (_f = summary === null || summary === void 0 ? void 0 : summary.stubCount) !== null && _f !== void 0 ? _f : 0,
...
function resolveSelectedIssueIds(sanitized) {
    ...
    if (Array.isArray(fromPayload) && fromPayload.length)
        return fromPayload;
    const fromArch = (_c = (_b = sanitized.architecture) === null || _b === void 0 ? void 0 : _b.dataCollectionLayer) === null || _c === void 0 ? void 0 : _c.selectedIssueIds;
    if (Array.isArray(fromArch) && fromArch.length)
        return fromArch;
...
export function sanitizeAiProblemAnalyzerExport(analysisResult, options = {}) {
    ...
    const projectLabel = projectLabelFromPath(options.projectPath
        || ((_b = (_a = options.context) === null || _a === void 0 ? void 0 : _a.report) === null || _b === void 0 ? void 0 : _b.projectRoot)
        || analysisResult.projectPath
        || 'ai-platform');
    const benchmarkScan = isBenchmarkPath(options.projectPath || ((_d = (_c = options.context) === null || _c === void 0 ? void 0 : _c.report) === null || _d === void 0 ? void 0 : _d.projectRoot) || analysisResult.projectPath);
    ...
    const healthScore = (_k = (_j = (_f = (_e = options.context) === null || _e === void 0 ? void 0 : _e.healthScore) !== null && _f !== void 0 ? _f : (_h = (_g = options.context) === null || _g === void 0 ? void 0 : _g.report) === null || _h === void 0 ? void 0 : _h.qualityScore) !== null && _j !== void 0 ? _j : sanitized.healthScore) !== null && _k !== void 0 ? _k : null;
    ...
    const analysisGeneratedAt = ((_l = options.context) === null || _l === void 0 ? void 0 : _l.analysisGeneratedAt)
        || sanitized.analysisGeneratedAt
        || sanitized.generatedAt
        || ((_o = (_m = options.context) === null || _m === void 0 ? void 0 : _m.report) === null || _o === void 0 ? void 0 : _o.analysisGeneratedAt)
        || null;
    return {
        ...
        inputKind: ((_p = options.context) === null || _p === void 0 ? void 0 : _p.inputKind) || sanitized.inputKind || null,
        scannedAt: ((_q = options.context) === null || _q === void 0 ? void 0 : _q.scannedAt) || ((_s = (_r = options.context) === null || _r === void 0 ? void 0 : _r.report) === null || _s === void 0 ? void 0 : _s.generatedAt) || sanitized.scannedAt || null,
        analysisGeneratedAt,
        healthScore,
        selectedIssueIds,
        summary,
...
export function buildAiProblemAnalyzerCsv(exportPayload) {
    ...
    for (const result of (exportPayload === null || exportPayload === void 0 ? void 0 : exportPayload.analyzerResults) || []) {
        rows.push([
            ...
            result.status || '',
            result.severity || '',
            (_b = (_a = result.metricScore) !== null && _a !== void 0 ? _a : result.score) !== null && _b !== void 0 ? _b : '',
