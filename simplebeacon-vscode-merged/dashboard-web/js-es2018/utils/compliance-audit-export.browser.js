...
function resolveCanonicalJestLabel(audit = {}) {
  ...
  const pageSampleAt = parseTimestamp(
    (_b = (_a = audit.pageSamples) === null || _a === void 0 ? void 0 : _a.baselineComparison) === null || _b === void 0
      ? void 0
      : _b.generatedAt
  );
...
function resolveCanonicalPageSpecsLabel(audit = {}) {
  ...
  if (
    pageLabel &&
    (!reportLabel || reportLabel === '0/0' || (pageSampleAt != null && reportAt != null && pageSampleAt >= reportAt))
  ) {
    return pageLabel;
  }
  return (
    reportLabel || pageLabel || ((_j = audit.baseline) === null || _j === void 0 ? void 0 : _j.pageSamplesLabel) || null
  );
}
/**
 * Dedupe export notes.
  ...
  return {
    ...
    inventoryRoot:
      (_r =
        ...
        : null,
    qualityScore:
      (_t = (_s = report.qualityScore) !== null && _s !== void 0 ? _s : dash.qualityScore) !== null && _t !== void 0
        ? _t
        : null,
  ...
  return {
    ...
    npmDependencies:
      (_x = npmStats === null || npmStats === void 0 ? void 0 : npmStats.dependencies) !== null && _x !== void 0
        ...
        : null,
    npmVulnerabilities:
      (_y = npmStats === null || npmStats === void 0 ? void 0 : npmStats.vulnerabilityTotal) !== null && _y !== void 0
        ? _y
        : null,
    npmAuditAt:
...
function reconcileAssessmentFromReport(assessment, report) {
  ...
  return {
    ...
    executiveSummary: {
      ...
      blockingCount:
        (_k =
          (_h = (_g = report.gate) === null || _g === void 0 ? void 0 : _g.blockingCount) !== null && _h !== void 0
            ? _h
      ...
      warningCount:
        (_p =
          (_m = (_l = report.gate) === null || _l === void 0 ? void 0 : _l.warningCount) !== null && _m !== void 0
            ? _m
...
function sanitizeReportExport(report, projectLabel, options = {}) {
  ...
  return {
    ...
    blockingCount:
      (_e =
        (_d = (_c = sanitized.gate) === null || _c === void 0 ? void 0 : _c.blockingCount) !== null && _d !== void 0
          ? _d
    ...
    warningCount:
      (_h =
        (_g = (_f = sanitized.gate) === null || _f === void 0 ? void 0 : _f.warningCount) !== null && _g !== void 0
          ? _g
...
function sanitizeDashboardExport(dashboard, audit = {}) {
  ...
  if (next.scanStatus && gate.pass != null) {
    ...
    next.scanStatus = {
      ...
      gatePass: gate.pass,
      issueCount:
        (_c = (_b = gate.blockingCount) !== null && _b !== void 0 ? _b : report.issueCount) !== null && _c !== void 0
          ? _c
