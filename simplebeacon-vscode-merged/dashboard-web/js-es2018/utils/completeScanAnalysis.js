...
(function tryLoadOptionalExports() {
  try {
    ...
    import("./roadmap-export.browser.js?v=20260716cachefix1")
      ...
      .catch((e) => {
        console["warn"](
          "[completeScanAnalysis] roadmap-export not available, using noop fallback.",
          e,
        );
      });
    import("./consolidation-export.browser.js?v=20260716cachefix1")
      ...
      .catch((e) => {
        console["warn"](
          "[completeScanAnalysis] consolidation-export not available, using noop fallback.",
          e,
        );
      });
  } catch (e) {
    console["warn"](
      "[completeScanAnalysis] failed to initiate optional exports import",
      e,
    );
  }
})();
 ...
 * @returns {any}
 */
export function buildCompleteScanAnalysis({
  fileReduction,
  dataQuality,
  projectPath,
} = {}) {
  ...
  const frExec =
    fileReduction === null || fileReduction === void 0
      ? void 0
      : fileReduction.executiveSummary;
  const dqExec =
    dataQuality === null || dataQuality === void 0
      ? void 0
      : dataQuality.executiveSummary;
  const benchmarkScan = isBenchmarkScanTarget(projectPath);
  const priorityActions = [
    ...((frExec === null || frExec === void 0
      ? void 0
      : frExec.priorityActions) || []),
    ...((dqExec === null || dqExec === void 0
      ? void 0
      : dqExec.priorityActions) || []),
  ].slice(0, 10);
  const rawTopDirs =
    ((_a =
      frPlan === null || frPlan === void 0 ? void 0 : frPlan.safeToDelete) ===
      null || _a === void 0
      ? void 0
      : _a.topDirectories) || [];
  const {
    measurable: topSafeDirectories,
    skippedShells: skippedArtifactDirectories,
  } = partitionArtifactDirectoryEntries(rawTopDirs);
  const benchmarkDirsExcluded = rawTopDirs.filter((entry) =>
    isBenchmarkCachePath(entry.path),
  ).length;
  const analysis = {
    projectPath:
      projectPath ||
      (fileReduction === null || fileReduction === void 0
        ? void 0
        : fileReduction.projectRoot) ||
      "",
    fileReduction: frPlan
      ? {
          safeToDeleteBytes:
            (_c =
              (_b = frPlan.totals) === null || _b === void 0
                ? void 0
          ...
          reviewBeforeDeleteBytes:
            (_e =
              (_d = frPlan.totals) === null || _d === void 0
                ? void 0
                : _d.reviewBeforeDeleteBytes) !== null && _e !== void 0
              ? _e
              : null,
          immediateSavingsBytes:
            (_g =
              (_f = frPlan.totals) === null || _f === void 0
                ? void 0
                : _f.estimatedImmediateSavingsBytes) !== null && _g !== void 0
              ? _g
              : null,
          duplicateAssetBytes:
            (_j =
              (_h = frPlan.totals) === null || _h === void 0
                ? void 0
                : _h.duplicateAssetBytes) !== null && _j !== void 0
              ? _j
              : null,
          unusedFileCandidates:
            (_l =
              (_k = frPlan.unusedFiles) === null || _k === void 0
                ? void 0
                : _k.candidates) !== null && _l !== void 0
              ? _l
              : null,
          ...
          reviewLogs:
            ((_o =
              (_m = frPlan.reviewBeforeDelete) === null || _m === void 0
                ? void 0
                : _m.logs) === null || _o === void 0
              ? void 0
              : _o.slice(0, 8)) || [],
    ...
    dataQuality: dqExec
      ? {
          workspacePackages:
            (_q =
              (_p = dqExec.workspace) === null || _p === void 0
                ? void 0
                : _p.packageJsonFiles) !== null && _q !== void 0
              ? _q
              : null,
          unusedDependencies:
            (_s =
              (_r = dqExec.workspace) === null || _r === void 0
                ? void 0
                : _r.unusedDependencies) !== null && _s !== void 0
              ? _s
              : null,
          envInconsistencies:
            (_u =
              (_t = dqExec.workspace) === null || _t === void 0
                ? void 0
                : _t.envInconsistencies) !== null && _u !== void 0
              ? _u
              : null,
          missingEnvKeys:
            (_w =
              (_v = dqExec.workspace) === null || _v === void 0
                ? void 0
                : _v.missingEnvKeys) !== null && _w !== void 0
              ? _w
              : null,
          shapeDriftGroups:
            (_y =
              (_x = dqExec.data) === null || _x === void 0
                ? void 0
                : _x.shapeDriftGroups) !== null && _y !== void 0
              ? _y
              : null,
          credentialsNeedingReview:
            (_0 =
              (_z = dqExec.security) === null || _z === void 0
                ? void 0
                : _z.credentialsNeedingReview) !== null && _0 !== void 0
              ? _0
              : null,
          piiNeedingReview:
            (_2 =
              (_1 = dqExec.security) === null || _1 === void 0
                ? void 0
                : _1.piiNeedingReview) !== null && _2 !== void 0
              ? _2
              : null,
        }
      : null,
    priorityActions,
    notes: [
      ...((frPlan === null || frPlan === void 0 ? void 0 : frPlan.scopeNote)
        ? [frPlan.scopeNote]
        : []),
  ...
  analysis.priorityActions = softenPriorityActions(
    analysis.priorityActions,
    analysis.artifactProfile,
  );
  return analysis;
}
/**
...
export function renderCompleteScanAnalysisPanel(analysis) {
   ...
   */
  const topDirs = (
    (fr === null || fr === void 0 ? void 0 : fr.topSafeDirectories) || []
  )
    .map(
      (entry) => `
  ...
  const skippedDirNames = (
    (fr === null || fr === void 0 ? void 0 : fr.skippedArtifactDirectories) ||
    []
  )
...
function hasHollowGateFromReport(sb) {
  ...
  const ruleScoped =
    (_c =
      (_a =
        sb === null || sb === void 0 ? void 0 : sb.ruleScopedFilesAnalyzed) !==
        null && _a !== void 0
        ? _a
        : (_b = sb === null || sb === void 0 ? void 0 : sb.scanScope) ===
              null || _b === void 0
          ? void 0
  ...
  return (
    Boolean(
      (_d = sb === null || sb === void 0 ? void 0 : sb.gate) === null ||
        _d === void 0
        ? void 0
        : _d.pass,
    ) && ruleScoped === 0
...
function inferCompleteScanTargetFromHints(bundle, options = {}) {
  ...
  const sourceRoot = String(
    options.projectPath ||
      bundle.projectPath ||
      ((_b =
        (_a = bundle.results) === null || _a === void 0
          ? void 0
          : _a.simplebeacon) === null || _b === void 0
        ? void 0
        : _b.projectRoot) ||
      ((_d =
        (_c = bundle.results) === null || _c === void 0
          ? void 0
          : _c.simplebeacon) === null || _d === void 0
        ? void 0
        : _d.platformRoot) ||
      "",
  ).replace(/\\/g, "/");
...
function resolveBenchmarkGateAttestation(sb, hollowGate) {
  ...
  if (
    ((_a = sb === null || sb === void 0 ? void 0 : sb.gate) === null ||
    _a === void 0
      ? void 0
      : _a.pass) === false
  )
  ...
  if (
    (_b = sb === null || sb === void 0 ? void 0 : sb.gate) === null ||
    _b === void 0
      ? void 0
      : _b.pass
  ) {
...
function assembleBenchmarkCompleteScanExportNotes(existingNotes = []) {
  const scopeNote =
    "Complete scan export scoped to github-cache/ OSS clone — not Simplebeacon product handoff.";
  const skipPatterns = [
    /complete scan export scoped to github-cache/i,
    /benchmark clone.*not valid for simplebeacon/i,
    /jest was not (executed|run)/i,
  ];
  const filteredExisting = dedupeCompleteScanExportNotes(existingNotes).filter(
    (note) => {
...
function buildBenchmarkCompleteScanHygieneSummary(bundle, auditFiles) {
  var _a,
    ...
    _7;
  const sb =
    (_a = bundle.results) === null || _a === void 0 ? void 0 : _a.simplebeacon;
  const rawLlm =
    (_b = sb === null || sb === void 0 ? void 0 : sb.llmSlopScanRaw) !== null &&
    _b !== void 0
      ? _b
      : (_c = sb === null || sb === void 0 ? void 0 : sb.scanScope) === null ||
          _c === void 0
        ? void 0
        : _c.llmSlopScanRaw;
  const scannedLlm =
    (_f =
      (_d = sb === null || sb === void 0 ? void 0 : sb.llmSlopFilesScanned) !==
        null && _d !== void 0
        ? _d
        : (_e = sb === null || sb === void 0 ? void 0 : sb.scanScope) ===
              null || _e === void 0
          ? void 0
      ...
      : null;
  const reconciledLlm =
    (_g = sb === null || sb === void 0 ? void 0 : sb.llmSlopScanReconciled) !==
      null && _g !== void 0
      ? _g
      : (_h = sb === null || sb === void 0 ? void 0 : sb.scanScope) === null ||
          _h === void 0
        ? void 0
  ...
  return {
    simplebeaconGatePass:
      (_k =
        (_j = bundle.summary) === null || _j === void 0
          ? void 0
          : _j.simplebeaconGatePass) !== null && _k !== void 0
        ? _k
        : null,
    simplebeaconGateAttestation:
      (_m =
        (_l = bundle.summary) === null || _l === void 0
          ? void 0
          : _l.simplebeaconGateAttestation) !== null && _m !== void 0
        ? _m
        : null,
    simplebeaconIssues:
      (_p =
        (_o = bundle.summary) === null || _o === void 0
          ? void 0
          : _o.simplebeaconIssues) !== null && _p !== void 0
        ? _p
        : 0,
    complianceFailed:
      (_r =
        (_q = bundle.summary) === null || _q === void 0
          ? void 0
          : _q.complianceFailed) !== null && _r !== void 0
        ? _r
        : 0,
    repositoryFilesTotal:
      (_v =
        (_u =
          (_t =
            (_s = bundle.summary) === null || _s === void 0
              ? void 0
              : _s.platformScope) === null || _t === void 0
            ? void 0
    ...
    roadmapFiles:
      (_x =
        (_w = bundle.summary) === null || _w === void 0
          ? void 0
          : _w.roadmapFiles) !== null && _x !== void 0
        ? _x
        : null,
    cleanupProjectedFiles:
      (_z =
        (_y = bundle.summary) === null || _y === void 0
          ? void 0
          : _y.cleanupProjectedFiles) !== null && _z !== void 0
        ? _z
        : null,
    ...(((_0 = bundle.summary) === null || _0 === void 0
      ? void 0
      : _0.cleanupProjectedFilesRaw) != null
      ? { cleanupProjectedFilesRaw: bundle.summary.cleanupProjectedFilesRaw }
      : {}),
    roadmapMisscoped:
      ((_2 =
        (_1 = bundle.results) === null || _1 === void 0
          ? void 0
          : _1.roadmap) === null || _2 === void 0
        ? void 0
        : _2.misscopedPlatformCodeWalk) === true,
    codebaseMisscoped:
      ((_4 =
        (_3 = bundle.results) === null || _3 === void 0
          ? void 0
          : _3.codebase) === null || _4 === void 0
        ? void 0
    ...
    fictionJsonFilesScanned:
      (_7 =
        (_5 =
          sb === null || sb === void 0
            ? void 0
            : sb.fictionJsonFilesScanned) !== null && _5 !== void 0
          ? _5
          : (_6 = sb === null || sb === void 0 ? void 0 : sb.scanScope) ===
                null || _6 === void 0
            ? void 0
    ...
    rawLlm > scannedLlm
      ...
      : {}),
    attestationNote:
      "Complete scan on OSS benchmark clone — not Simplebeacon product handoff clearance.",
  };
}
/**
 ...
 * @returns {any}
 */
function sanitizeComplianceForCompleteScan(
  compliance,
  gateReport,
  projectPath,
  context = {},
    ...
    (_c =
      (_a =
        gateReport === null || gateReport === void 0
          ? void 0
          : gateReport.ruleScopedFilesAnalyzed) !== null && _a !== void 0
        ? _a
        : (_b =
              gateReport === null || gateReport === void 0
                ? void 0
                : gateReport.scanScope) === null || _b === void 0
          ? void 0
          : _b.ruleScopedFilesAnalyzed) !== null && _c !== void 0
      ? _c
      : 0;
    ...
    rules = rules.map((rule) => {
      if (rule.id === "GATE-001" && rule.status === "pass") {
        return {
          ...
          status: "skip",
          evidence:
            "No gate-rule production paths configured for this scan target",
        };
      }
      if (
...
function dedupeCompleteScanExportNotes(notes = []) {
  ...
  for (const note of notes) {
    ...
    const scopeKey = /complete scan export scoped to github-cache/i.test(
      normalized,
    )
...
function resolveRoadmapSummaryFiles(roadmap, auditFiles, summary = {}) {
  ...
  const structure =
    (_a =
      roadmap === null || roadmap === void 0
        ? void 0
        : roadmap.codeAnalysis) === null || _a === void 0
      ? void 0
      : _a.structure;
  const roadmapScoped =
    (_e =
        ...
        (_c =
          (_b =
            structure === null || structure === void 0
              ? void 0
              : structure.totalFilesRaw) !== null && _b !== void 0
            ? _b
            : structure === null || structure === void 0
              ? void 0
  ...
  const misscoped =
    (roadmap === null || roadmap === void 0
      ? void 0
      : roadmap.misscopedPlatformCodeWalk) === true;
    ...
    return {
      roadmapFiles:
        (_f =
          structure === null || structure === void 0
            ? void 0
            : structure.totalFiles) !== null && _f !== void 0
          ? _f
  ...
  return {
    roadmapFiles:
      (_g =
        structure === null || structure === void 0
          ? void 0
          : structure.totalFiles) !== null && _g !== void 0
        ? _g
        : roadmapScoped,
    roadmapFilesRaw: summary.roadmapFilesRaw,
    roadmapFilesNote: summary.roadmapFilesNote,
...
export function sanitizeCompleteScanBundle(bundle, options = {}) {
  ...
  if (next.results.simplebeacon && typeof prepare === "function") {
    next.results.simplebeacon =
      prepare(next.results.simplebeacon, nestedOptions) ||
      next.results.simplebeacon;
  } else if (next.results.simplebeacon) {
    next.results.simplebeacon = sanitizeSimplebeaconReportExport(
      next.results.simplebeacon,
      nestedOptions,
    );
  }
  const repositoryFilesTotal =
    (_b =
      (_a = next.results.simplebeacon) === null || _a === void 0
        ? void 0
        : _a.repositoryFilesTotal) !== null && _b !== void 0
      ? _b
      : (_d =
            (_c = next.results.simplebeacon) === null || _c === void 0
              ? void 0
              : _c.repositoryInventory) === null || _d === void 0
        ? void 0
        : _d.totalFiles;
  if (
    next.results.consolidation &&
    typeof options.sanitizeConsolidationExport === "function"
  ) {
    next.results.consolidation = options.sanitizeConsolidationExport(
      next.results.consolidation,
      nestedOptions,
    );
  }
  ...
  if (
    next.results.mockScan &&
    typeof options.sanitizeFictionDigestExport === "function"
  ) {
    next.results.mockScan = options.sanitizeFictionDigestExport(
      next.results.mockScan,
      nestedOptions,
    );
  }
  ...
  nestedOptions.repositoryFilesTotal =
    (_e = sb === null || sb === void 0 ? void 0 : sb.repositoryFilesTotal) !==
      null && _e !== void 0
      ? _e
      : (_f =
            sb === null || sb === void 0 ? void 0 : sb.repositoryInventory) ===
            null || _f === void 0
        ? void 0
        : _f.totalFiles;
  ...
  const platformRepo =
    (_j =
      (_g = sb === null || sb === void 0 ? void 0 : sb.repositoryFilesTotal) !==
        null && _g !== void 0
        ? _g
        : (_h =
              sb === null || sb === void 0
                ? void 0
                : sb.repositoryInventory) === null || _h === void 0
          ? void 0
  ...
  next.summary.platformScope = {
    reportHealth: benchmarkScan
      ...
      : ((_k = sb === null || sb === void 0 ? void 0 : sb.scanScope) === null ||
        _k === void 0
          ? void 0
          : _k.reportHealth) || "platform-scoped",
    mockSampleFiles:
      (_l = sb === null || sb === void 0 ? void 0 : sb.mockSampleFiles) !==
        null && _l !== void 0
        ? _l
        : null,
    ...
    simplebeaconGatePass:
      benchmarkScan && hollowGate
        ...
        : (_p =
              (_o =
                (_m = sb === null || sb === void 0 ? void 0 : sb.gate) ===
                  null || _m === void 0
                  ? void 0
                  : _m.pass) !== null && _o !== void 0
                ? _o
        ...
        : benchmarkScan
          ...
          : hollowGate
            ...
            : (sb === null || sb === void 0 ? void 0 : sb.gateAttestation) ||
              ((
                (_q = sb === null || sb === void 0 ? void 0 : sb.gate) ===
                  null || _q === void 0
                  ? void 0
                  : _q.pass
              )
                ? "platform-gate-pass"
                : ((_r = sb === null || sb === void 0 ? void 0 : sb.gate) ===
                      null || _r === void 0
                      ? void 0
                      : _r.pass) === false
                  ? "fail"
  ...
  if (benchmarkScan) {
    ...
    next.summary.simplebeaconGateAttestation = resolveBenchmarkGateAttestation(
      sb,
      hollowGate,
    );
    if (hollowGate) {
  ...
  const roadmapSummary = resolveRoadmapSummaryFiles(
  ...
  if (
    (_s = next.results.mockScan) === null || _s === void 0
      ? void 0
      : _s.digestTrust
  ) {
  ...
  if (
    (_t = next.results.consolidation) === null || _t === void 0
      ? void 0
      : _t.exportSanitized
  ) {
  ...
  if (
    (_u = next.results.roadmap) === null || _u === void 0
      ? void 0
      : _u.exportNormalized
  ) {
  ...
  if (next.results.fileReduction || next.results.dataQuality) {
    ...
    const profile =
      (_v = next.completeScanAnalysis) === null || _v === void 0
        ? void 0
        : _v.artifactProfile;
  ...
  if (next.results.npmAudit) {
    next.results.npmAudit = sanitizeNpmAuditExport(
      next.results.npmAudit,
      next.projectPath,
      {
        repositoryFilesTotal:
          (_w =
            sb === null || sb === void 0 ? void 0 : sb.repositoryFilesTotal) !==
            null && _w !== void 0
            ? _w
            : (_x =
                  sb === null || sb === void 0
                    ? void 0
                    : sb.repositoryInventory) === null || _x === void 0
              ? void 0
              : _x.totalFiles,
        gateReport: sb || null,
      },
  ...
  if (next.results.compliance && sb) {
    ...
    next.results.compliance = sanitizeComplianceForCompleteScan(
      next.results.compliance,
      sb,
      next.projectPath,
      { benchmarkScan, hollowGate, productPlatformRoot },
    );
  }
  if (next.results.cleanupAssistant) {
    next.results.cleanupAssistant = sanitizeCleanupBriefExport(
      next.results.cleanupAssistant,
      {
        projectPath: next.projectPath,
        repositoryFilesTotal:
          (_y =
            ...
            : (_z =
                  sb === null || sb === void 0
                    ? void 0
                    : sb.repositoryInventory) === null || _z === void 0
              ? void 0
              : _z.totalFiles,
        gateReport: sb || null,
      },
  ...
  if (next.results.dataQuality) {
    next.results.dataQuality = sanitizeDataCleanupReportExport(
      next.results.dataQuality,
      {
        projectPath: next.projectPath,
        repositoryFilesTotal:
          (_0 =
            ...
            : (_1 =
                  sb === null || sb === void 0
                    ? void 0
                    : sb.repositoryInventory) === null || _1 === void 0
              ? void 0
              : _1.totalFiles,
        gateReport: sb || null,
      },
  ...
  if (next.results.fileReduction) {
    next.results.fileReduction = sanitizeDataCleanupReportExport(
      next.results.fileReduction,
      {
        projectPath: next.projectPath,
        repositoryFilesTotal:
          (_2 =
            ...
            : (_3 =
                  sb === null || sb === void 0
                    ? void 0
                    : sb.repositoryInventory) === null || _3 === void 0
              ? void 0
              : _3.totalFiles,
        gateReport: sb || null,
      },
  ...
  if (next.results.codebase) {
    next.results.codebase = sanitizeCodebaseReportExport(
  ...
  next.summary = {
    ...
    ...(sbFinal
      ? {
          simplebeaconGatePass:
            (_5 =
              (_4 = sbFinal.gate) === null || _4 === void 0
                ? void 0
                : _4.pass) !== null && _5 !== void 0
              ? _5
          ...
          simplebeaconIssues:
            (_8 =
              ...
              ? _8
              : (_10 =
                    (_9 = sbFinal.rawIssues) === null || _9 === void 0
                      ? void 0
                      : _9.length) !== null && _10 !== void 0
                ? _10
                : next.summary.simplebeaconIssues,
        }
      : {}),
    ...((complianceResult === null || complianceResult === void 0
      ? void 0
      : complianceResult.summary) ||
    ((_11 =
      complianceResult === null || complianceResult === void 0
        ? void 0
        : complianceResult.checklist) === null || _11 === void 0
      ? void 0
      : _11.summary)
      ? {
          compliancePassed:
            (_14 = (
              (_13 =
                (_12 = complianceResult.checklist) === null || _12 === void 0
                  ? void 0
                  : _12.summary) !== null && _13 !== void 0
                ? _13
                : complianceResult.summary
          ...
          complianceFailed:
            (_17 = (
              (_16 =
                (_15 = complianceResult.checklist) === null || _15 === void 0
                  ? void 0
                  : _15.summary) !== null && _16 !== void 0
                ? _16
                : complianceResult.summary
      ...
      : {}),
    ...((
      consolidationResult === null || consolidationResult === void 0
        ? void 0
      ...
      ? {
          consolidationDuplicateGroups:
            (_19 =
              (_18 = consolidationResult.summary.exactDuplicateGroups) !==
                null && _18 !== void 0
                ? _18
                : consolidationResult.summary.mergeCandidates) !== null &&
            _19 !== void 0
              ? _19
    ...
    ...(mockScanResult
      ? {
          ...
          fictionDigestTrust:
            (_20 = mockScanResult.digestTrust) !== null && _20 !== void 0
              ? _20
              : next.summary.fictionDigestTrust,
        }
      : {}),
  };
  if (next.summary.platformScope) {
    next.summary.platformScope = {
      ...
      securityHandoffEligible: false,
      scanPaths:
        (sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.scanPaths) ||
        next.summary.platformScope.scanPaths,
      simplebeaconGatePass:
        (_23 =
  ...
  const auditFiles =
    (_26 =
      sbFinal === null || sbFinal === void 0
        ? void 0
        : sbFinal.repositoryFilesTotal) !== null && _26 !== void 0
      ? _26
      : (_27 =
            sbFinal === null || sbFinal === void 0
              ? void 0
              : sbFinal.repositoryInventory) === null || _27 === void 0
        ? void 0
        : _27.totalFiles;
  const cleanupExplorer =
    (_32 =
      (_31 =
        (_29 =
          (_28 =
            cleanupResult === null || cleanupResult === void 0
              ? void 0
              : cleanupResult.inventory) === null || _28 === void 0
            ? void 0
          ...
          : (_30 =
                cleanupResult === null || cleanupResult === void 0
                  ? void 0
                  : cleanupResult.inventory) === null || _30 === void 0
            ? void 0
  ...
  if (
    auditFiles != null &&
    cleanupExplorer != null &&
    cleanupExplorer > auditFiles
  ) {
    ...
    next.summary.cleanupProjectedFilesNote =
      ((_33 =
        cleanupResult === null || cleanupResult === void 0
          ? void 0
          : cleanupResult.inventory) === null || _33 === void 0
        ? void 0
        : _33.inventoryNote) ||
    ...
    ((_34 =
      cleanupResult === null || cleanupResult === void 0
        ? void 0
        : cleanupResult.inventory) === null || _34 === void 0
      ? void 0
      : _34.auditRepositoryFiles) != null
  ) {
    next.summary.cleanupProjectedFiles =
      cleanupResult.inventory.auditRepositoryFiles;
  } else if (
    ((_35 =
      cleanupResult === null || cleanupResult === void 0
        ? void 0
        : cleanupResult.inventory) === null || _35 === void 0
      ? void 0
      : _35.totalFiles) != null
  ) {
    next.summary.cleanupProjectedFiles = cleanupResult.inventory.totalFiles;
  }
  const roadmapSummaryFinal = resolveRoadmapSummaryFiles(
    next.results.roadmap,
    auditFiles,
    next.summary,
  );
  ...
  if (
    (_36 = next.summary.complianceExportNotes) === null || _36 === void 0
      ? void 0
      : _36.length
  ) {
    next.summary.complianceExportNotes = dedupeCompleteScanExportNotes(
      next.summary.complianceExportNotes,
    );
  }
  if (!benchmarkScan) {
    const exportNotes = [];
    ...
    if (
      ((_37 = next.completeScanAnalysis) === null || _37 === void 0
        ? void 0
        : _37.artifactProfile) === "mixed-no-safe-delete"
    ) {
      exportNotes.push(
    ...
    const credentialScanned =
      (_39 =
        (_38 =
          sbFinal === null || sbFinal === void 0
            ? void 0
            : sbFinal.credentialScanned) !== null && _38 !== void 0
          ? _38
          : sbFinal === null || sbFinal === void 0
            ? void 0
    ...
    const gateProfile =
      (_41 =
        (_40 =
          sbFinal === null || sbFinal === void 0
            ? void 0
            : sbFinal.scanScope) === null || _40 === void 0
          ? void 0
    ...
    const fictionJson =
      (_42 =
        sbFinal === null || sbFinal === void 0
          ? void 0
          : sbFinal.fictionJsonFilesScanned) !== null && _42 !== void 0
        ? _42
        : (_43 =
              sbFinal === null || sbFinal === void 0
                ? void 0
                : sbFinal.scanScope) === null || _43 === void 0
          ? void 0
    ...
    const fictionSamples =
      (_44 =
        sbFinal === null || sbFinal === void 0
          ? void 0
          : sbFinal.fictionSampleFilesScanned) !== null && _44 !== void 0
        ? _44
        : sbFinal === null || sbFinal === void 0
          ? void 0
    ...
    const blockingCount =
      (_47 =
        (_46 =
          (_45 =
            sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.gate) ===
            null || _45 === void 0
            ? void 0
    ...
    if (
      ((_48 =
        ...
        ? void 0
        : _48.pass) === false &&
      (blockingCount !== null && blockingCount !== void 0 ? blockingCount : 0) >
        0
    ) {
      exportNotes.push(
      ...
      (_49 = sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.gate) ===
        null || _49 === void 0
        ? void 0
        : _49.pass
    ) {
    ...
    if (
      ((_50 =
        sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.scanScope) ===
        null || _50 === void 0
        ? void 0
        : _50.jestExecutedDuringScan) === false ||
      (sbFinal === null || sbFinal === void 0
        ? void 0
        : sbFinal.jestBaselineChecked) === false
    ) {
      exportNotes.push(
    ...
    const hygieneSummary = {
      completeScanHealthStatus:
        next.summary.simplebeaconGatePass &&
        ((_51 = next.summary.complianceFailed) !== null && _51 !== void 0
          ? _51
          : 1) === 0
      ...
      enginesRun:
        (_55 =
          (_53 =
            (_52 = next.enginesRun) === null || _52 === void 0
              ? void 0
              : _52.length) !== null && _53 !== void 0
            ? _53
      ...
      stepsCompleted:
        (_57 =
          (_56 = next.summary) === null || _56 === void 0
            ? void 0
            : _56.stepsCompleted) !== null && _57 !== void 0
          ? _57
          : null,
      gatePass:
        (_60 =
      ...
      ...(credentialScanned != null
        ? { contentFilesScanned: credentialScanned }
        : {}),
      ...(auditFiles != null &&
      credentialScanned != null &&
      auditFiles > credentialScanned
      ...
      compliancePassed:
        (_61 = next.summary.compliancePassed) !== null && _61 !== void 0
          ? _61
          : null,
      complianceFailed:
        (_62 = next.summary.complianceFailed) !== null && _62 !== void 0
          ? _62
          : null,
      euAiActIncluded:
        (_63 = next.summary.euAiActIncluded) !== null && _63 !== void 0
          ? _63
          : null,
      jestBaselineChecked:
        (sbFinal === null || sbFinal === void 0
    ...
    next = {
      ...
      completeScanHealthStatus:
        next.summary.simplebeaconGatePass &&
        ((_64 = next.summary.complianceFailed) !== null && _64 !== void 0
          ? _64
          : 1) === 0
          ? "hygiene-pass-not-handoff"
          : "review-required",
    ...
    next = {
      ...
      hygieneSummary: buildBenchmarkCompleteScanHygieneSummary(
        next,
        auditFiles,
      ),
      exportNotes: assembleBenchmarkCompleteScanExportNotes(
        next.exportNotes || [],
      ),
    };
  }
...
export function sanitizeRoadmapExport(roadmap, options = {}) {
  ...
  const benchmarkScan =
    ...
    isBenchmarkCachePath(
      options.scanTargetRoot || options.requestedProjectPath || "",
    ) ||
    isBenchmarkCachePath(
      roadmap.scanTargetRoot || roadmap.requestedScanRoot || "",
    ) ||
    isBenchmarkCachePath(
      roadmap.sourceProjectPath ||
        ((_a = roadmap.projectStructure) === null || _a === void 0
          ? void 0
          : _a.projectRoot) ||
        "",
    );
  const structure =
    ((_b = roadmap.codeAnalysis) === null || _b === void 0
      ...
      : _b.structure) || {};
  const repoRaw =
    (_c = structure.totalFiles) !== null && _c !== void 0 ? _c : null;
  ...
  const sampleInternal = (
    (deps === null || deps === void 0 ? void 0 : deps.sampleInternal) || []
  ).filter(
    (edge) => !roadmapPathTouchesBenchmark(String(edge).split(" -> ")[0]),
  );
  const phase2 =
    (_e = roadmap.codeAnalysis) === null || _e === void 0 ? void 0 : _e.phase2;
  let nextPhase2 = phase2;
  if (
    (_f =
      phase2 === null || phase2 === void 0
        ? void 0
        : phase2.dependencyGraph) === null || _f === void 0
      ? void 0
      : _f.edges
  ) {
    const edges = phase2.dependencyGraph.edges.filter(
      (edge) =>
        !roadmapPathTouchesBenchmark(edge.from) &&
        !roadmapPathTouchesBenchmark(edge.to),
    );
    nextPhase2 = {
      ...phase2,
      dependencyGraph: {
  ...
  const topDirectories = filterRoadmapTopDirectoriesExport(
    structure.topDirectories || [],
  );
  const mainCategories = {};
  for (const [name, category] of Object.entries(
    ((_g = roadmap.projectStructure) === null || _g === void 0
      ? void 0
      : _g.mainCategories) || {},
  )) {
  ...
  let next = {
    ...
    codeAnalysis: {
      ...
      structure: {
        ...
        topDirectories,
        ...(staleWalk &&
        ((_h = roadmap.projectStructure) === null || _h === void 0
          ? void 0
          : _h.totalFiles) != null
          ? {
  ...
  if (
    ((_j = next.strategicInsights) === null || _j === void 0
      ? void 0
      : _j.sourceMetrics) &&
    staleWalk &&
    ((_k = next.projectStructure) === null || _k === void 0
      ? void 0
      : _k.totalFiles) != null
  ) {
  ...
  if (
    ...
    next.exportNotes = [
      ...
      ...(staleWalk && !benchmarkScan
        ? [next.codeAnalysis.structure.staleWalkNote]
        : []),
      ...(staleWalk && benchmarkScan
        ? [
