...
function buildBenchmarkFictionConclusion(fictionIssues, nonFictionIssues, sourceReport) {
  ...
  const ruleScoped =
    (_e =
      ...
      : 0;
  const jsonFiction =
    (_f = sourceReport === null || sourceReport === void 0 ? void 0 : sourceReport.fictionJsonFilesScanned) !== null &&
    _f !== void 0
      ? _f
...
function isStaleFullTreeScan(report) {
  ...
  const mock =
    (_c = (_b = report.mockSampleFiles) !== null && _b !== void 0 ? _b : report.totalFiles) !== null && _c !== void 0
      ? _c
      : 0;
...
function reconcileProductDigestScanScope(scanScope = {}, report = {}) {
  ...
  const ruleScoped =
    (_c = (_b = report.ruleScopedFilesAnalyzed) !== null && _b !== void 0 ? _b : scanScope.ruleScopedFilesAnalyzed) !==
      null && _c !== void 0
      ? _c
      : 0;
  const mockSampleFiles =
    (_e = (_d = report.mockSampleFiles) !== null && _d !== void 0 ? _d : report.totalFiles) !== null && _e !== void 0
      ? _e
      : null;
  const fictionSamples =
    (_g =
      (_f = report.fictionSampleFilesScanned) !== null && _f !== void 0 ? _f : scanScope.fictionSampleFilesScanned) !==
      null && _g !== void 0
      ? _g
      : null;
  ...
  if (mockSampleFiles != null && mockSampleFiles < mockInPaths) {
    ...
    const jsonFiction =
      (_j =
        (_h = report.fictionJsonFilesScanned) !== null && _h !== void 0 ? _h : scanScope.fictionJsonFilesScanned) !==
        null && _j !== void 0
        ? _j
        : null;
...
function sanitizeBenchmarkDigestScanScope(scanScope, report) {
  ...
  const repoTotal =
    (_c =
      ...
      : null;
  const scanned =
    (_e = (_d = scanScope.llmSlopFilesScanned) !== null && _d !== void 0 ? _d : report.llmSlopFilesScanned) !== null &&
    _e !== void 0
      ? _e
      : repoTotal;
...
function buildBenchmarkFictionScopeSummary(sourceReport) {
  ...
  return {
    ...
    fictionJsonFilesScanned:
      (_k =
        (_j = sourceReport === null || sourceReport === void 0 ? void 0 : sourceReport.fictionJsonFilesScanned) !==
          null && _j !== void 0
          ? _j
    ...
    ruleScopedFilesAnalyzed:
      (_m =
        (_l = sourceReport === null || sourceReport === void 0 ? void 0 : sourceReport.ruleScopedFilesAnalyzed) !==
          null && _l !== void 0
          ? _l
...
function summarizeAncillaryPatternHits(sourceReport) {
  ...
  const totals =
    (_c =
      ...
      ? _c
      : (_d = sourceReport === null || sourceReport === void 0 ? void 0 : sourceReport.fullDirectoryStats) === null ||
          _d === void 0
        ? void 0
        : _d.ruleHitTotals;
...
function formatAncillaryPatternHitsNote(sourceReport) {
  ...
  const blocking =
    (_b =
      (_a = sourceReport === null || sourceReport === void 0 ? void 0 : sourceReport.gate) === null || _a === void 0
        ? void 0
  ...
  return {
    ...
    repositoryFilesTotal:
      (_g =
        (_e =
          (_d =
            (_c =
              (_b = (_a = options.repositoryFilesTotal) !== null && _a !== void 0 ? _a : gate.repositoryFilesTotal) !==
                null && _b !== void 0
                ? _b
                : sourceReport === null || sourceReport === void 0
                  ? void 0
    ...
    contentScanned:
      (_p =
        (_o =
          (_m =
            (_l =
              (_j = (_h = scope.fullDirectoryStats) === null || _h === void 0 ? void 0 : _h.contentScanned) !== null &&
              _j !== void 0
                ? _j
    ...
    gateProfile:
      (_w =
        (_u =
          (_t =
            (_r = (_q = scope.profile) !== null && _q !== void 0 ? _q : scope.gateRuleBundleProfile) !== null &&
            _r !== void 0
              ? _r
              : (_s = digest === null || digest === void 0 ? void 0 : digest.scanScope) === null || _s === void 0
                ? void 0
...
function buildProductFictionHygieneSummary(sourceReport, digest, options = {}) {
  ...
  return {
    ...
    gatePass:
      (_f =
        (_e = sourceReport === null || sourceReport === void 0 ? void 0 : sourceReport.gate) === null || _e === void 0
          ? void 0
    ...
    blockingCount:
      (_h =
        (_g = sourceReport === null || sourceReport === void 0 ? void 0 : sourceReport.gate) === null || _g === void 0
          ? void 0
    ...
    ruleScopedFilesAnalyzed:
      (_k =
        (_j = sourceReport === null || sourceReport === void 0 ? void 0 : sourceReport.ruleScopedFilesAnalyzed) !==
          null && _j !== void 0
          ? _j
    ...
    fictionJsonFilesScanned:
      (_m =
        (_l = sourceReport === null || sourceReport === void 0 ? void 0 : sourceReport.fictionJsonFilesScanned) !==
          null && _l !== void 0
          ? _l
    ...
    fictionSampleFilesScanned:
      (_p =
        (_o = sourceReport === null || sourceReport === void 0 ? void 0 : sourceReport.fictionSampleFilesScanned) !==
          null && _o !== void 0
          ? _o
...
function buildProductFictionExportNotes(digest, sourceReport, options = {}) {
  ...
  const scope = (sourceReport === null || sourceReport === void 0 ? void 0 : sourceReport.scanScope) || {};
  const fictionJson =
    (_a = sourceReport === null || sourceReport === void 0 ? void 0 : sourceReport.fictionJsonFilesScanned) !== null &&
    _a !== void 0
      ? _a
  ...
  const mockSamples =
    (_e =
      (_d =
        (_c = sourceReport === null || sourceReport === void 0 ? void 0 : sourceReport.mockSampleFiles) !== null &&
        _c !== void 0
          ? _c
          : sourceReport === null || sourceReport === void 0
            ? void 0
  ...
  const fictionSamples =
    (_g =
      (_f = sourceReport === null || sourceReport === void 0 ? void 0 : sourceReport.fictionSampleFilesScanned) !==
        null && _f !== void 0
        ? _f
  ...
  if (
    ...
    const blocking =
      (_p = (_o = sourceReport.gate) === null || _o === void 0 ? void 0 : _o.blockingCount) !== null && _p !== void 0
        ? _p
        : 0;
    if (blocking > 0) {
      notes.push(
...
function enrichProductSourceReport(sourceReport) {
  ...
  return {
    ...
    scanScope: {
      ...
      resultsViewScope:
        ((_d = sourceReport.scanScope) === null || _d === void 0 ? void 0 : _d.resultsViewScope) || 'platform-only',
      reportHealth,
      ...
      inventoryMetricsStale: intentionalFullTree
        ? false
        : (_g = (_f = sourceReport.scanScope) === null || _f === void 0 ? void 0 : _f.inventoryMetricsStale) !== null &&
            _g !== void 0
          ? _g
          : false,
