...
function countExcludedFuzzyPairs(pairs = []) {
  ...
  return {
    ...
    intentionalPairsExcluded:
      browserMirrorPairsExcluded + mcpExamplePairsExcluded + monorepoAliasPairsExcluded + ephemeralPathsExcluded,
  };
}
/**
...
function resolveIntentionalPairsExcludedCount(summaryBase, pairExclusions, rawMergeCount, mergeCandidatesLength) {
  var _a, _b, _c;
  const fromPairs =
    (_a = pairExclusions === null || pairExclusions === void 0 ? void 0 : pairExclusions.intentionalPairsExcluded) !==
      null && _a !== void 0
      ? _a
      : 0;
...
function resolveBenchmarkConsolidationHealth(summary) {
  var _a, _b;
  const mergeN =
    (_a = summary === null || summary === void 0 ? void 0 : summary.mergeCandidates) !== null && _a !== void 0 ? _a : 0;
  const savings =
    (_b = summary === null || summary === void 0 ? void 0 : summary.potentialSavingsBytes) !== null && _b !== void 0
      ? _b
      : 0;
...
function buildBenchmarkConsolidationExportNotes(summary, pairExclusions) {
  ...
  const intentional = Math.max(
    (_a = pairExclusions === null || pairExclusions === void 0 ? void 0 : pairExclusions.intentionalPairsExcluded) !==
      ...
      ? _a
      : 0,
    (_b = summary === null || summary === void 0 ? void 0 : summary.intentionalPairsExcluded) !== null && _b !== void 0
      ? _b
      : 0,
    ((_c = summary === null || summary === void 0 ? void 0 : summary.browserMirrorPairsExcluded) !== null &&
    _c !== void 0
      ? _c
      : 0) +
      ((_d = summary === null || summary === void 0 ? void 0 : summary.mcpExamplePairsExcluded) !== null &&
      _d !== void 0
        ? _d
        : 0)
  );
  ...
  if (
    ((_e = summary === null || summary === void 0 ? void 0 : summary.mergeCandidates) !== null && _e !== void 0
      ? _e
      : 0) === 0
  ) {
  ...
  if (
    ((_f = summary === null || summary === void 0 ? void 0 : summary.potentialSavingsBytes) !== null && _f !== void 0
      ? _f
      : 0) === 0
  ) {
...
function assembleBenchmarkConsolidationExportNotes(existingNotes = [], summary, pairExclusions) {
  ...
  const filtered = dedupeExportNotes(existingNotes).filter((note) => {
    ...
    return !skipPatterns.some((re) => re.test(lowered)) && !dynamic.some((entry) => entry.toLowerCase() === lowered);
  });
...
function filterAdvancedAnalysis(analysis, benchmarkScan) {
  ...
  const fuzzyPairs = filterFuzzyPairs(
    ...
    (pair) =>
      benchmarkScan || (!consolidationPathTouchesExcluded(pair.fileA) && !consolidationPathTouchesExcluded(pair.fileB))
  );
  const patternGroups = (
    ((_b = analysis.patternConsolidation) === null || _b === void 0 ? void 0 : _b.recommendations) || []
  ).filter(
    (group) => benchmarkScan || !(group.files || []).every((file) => consolidationPathTouchesExcluded(file.path))
  );
  return {
    ...analysis,
    fuzzyNearDuplicates: {
...
function resolveConsolidationGateContext(scan, options = {}) {
  ...
  const credentialScanned =
    (_p =
      (_m =
        (_k = (_j = gateReport.credentialScanned) !== null && _j !== void 0 ? _j : gateReport.productionLeakScanned) !==
          null && _k !== void 0
          ? _k
  ...
  const contentScanned =
    (_y =
      (_w =
        (_v =
          (_s =
            (_r = (_q = gateReport.scanScope) === null || _q === void 0 ? void 0 : _q.fullDirectoryStats) === null ||
            _r === void 0
              ? void 0
              : _r.contentScanned) !== null && _s !== void 0
            ? _s
            : (_u = (_t = gateReport.scanScope) === null || _t === void 0 ? void 0 : _t.fullDirectoryStats) === null ||
                _u === void 0
              ? void 0
  ...
  const gateProfile =
    (_4 =
      (_2 =
        (_0 = (_z = gateReport.scanScope) === null || _z === void 0 ? void 0 : _z.profile) !== null && _0 !== void 0
          ? _0
...
function buildProductConsolidationHygieneSummary(summaryBase, scan, options = {}) {
  ...
  return {
    ...
    intentionalPairsExcluded:
      (_s =
        (_r = summaryBase.intentionalPairsExcluded) !== null && _r !== void 0 ? _r : summaryBase.fuzzyPairsExcluded) !==
        null && _s !== void 0
        ? _s
        : 0,
    ...(gateReport.jestBaselineChecked === false ||
    ((_t = scan.hygieneSummary) === null || _t === void 0 ? void 0 : _t.jestBaselineChecked) === false
...
function buildProductConsolidationExportNotes(scan, ephemeralExcluded, context = {}) {
  ...
  const repoTotal =
    (_b = (_a = scan.summary) === null || _a === void 0 ? void 0 : _a.repositoryFilesTotal) !== null && _b !== void 0
      ? _b
      : (_c = scan.repositoryInventory) === null || _c === void 0
        ? void 0
        : _c.totalFiles;
  const repoAudited =
    (_e = (_d = scan.summary) === null || _d === void 0 ? void 0 : _d.repositoryFilesAudited) !== null && _e !== void 0
      ? _e
  ...
  const jsonN =
    (_h = (_g = scan.summary) === null || _g === void 0 ? void 0 : _g.jsonFilesAnalyzed) !== null && _h !== void 0
      ? _h
      : (_j = scan.scanScope) === null || _j === void 0
        ? void 0
        : _j.jsonFilesAnalyzed;
  const sampleN =
    (_l = (_k = scan.summary) === null || _k === void 0 ? void 0 : _k.sampleDataFilesAnalyzed) !== null && _l !== void 0
      ? _l
  ...
  const aliasExcluded =
    ((_p = (_o = scan.summary) === null || _o === void 0 ? void 0 : _o.monorepoAliasPairsExcluded) !== null &&
    _p !== void 0
      ? _p
      : 0) +
    ((_r = (_q = scan.summary) === null || _q === void 0 ? void 0 : _q.browserMirrorPairsExcluded) !== null &&
    _r !== void 0
      ? _r
      : 0) +
    ((_t = (_s = scan.summary) === null || _s === void 0 ? void 0 : _s.mcpExamplePairsExcluded) !== null &&
    _t !== void 0
      ? _t
      : 0);
  if (aliasExcluded > 0) {
  ...
  if (
    ((_v = (_u = scan.summary) === null || _u === void 0 ? void 0 : _u.exactDuplicateGroups) !== null && _v !== void 0
      ? _v
      : 0) === 0 &&
    ((_x = (_w = scan.summary) === null || _w === void 0 ? void 0 : _w.mergeCandidates) !== null && _x !== void 0
      ? _x
      : 0) === 0
  ) {
  ...
  if (
    ((_z = (_y = scan.summary) === null || _y === void 0 ? void 0 : _y.potentialSavingsBytes) !== null && _z !== void 0
      ? _z
      : 0) === 0
  ) {
    notes.push(
  ...
  if (
    gateReport.jestBaselineChecked === false ||
    ((_0 = scan.hygieneSummary) === null || _0 === void 0 ? void 0 : _0.jestBaselineChecked) === false
  ) {
...
function buildBenchmarkConsolidationConclusion(scan) {
  ...
  const s = scan.summary || {};
  const repoFiles =
    (_b = (_a = s.repositoryFilesTotal) !== null && _a !== void 0 ? _a : s.repositoryFilesAudited) !== null &&
    _b !== void 0
      ? _b
      : (_c = scan.repositoryInventory) === null || _c === void 0
        ? void 0
...
export function sanitizeConsolidationExport(scan, options = {}) {
  ...
  const rawFuzzyPairExclusions = !benchmarkScan
    ? countExcludedFuzzyPairs(
        ((_d = rawAdvanced === null || rawAdvanced === void 0 ? void 0 : rawAdvanced.fuzzyNearDuplicates) === null ||
        _d === void 0
          ? void 0
          : _d.pairs) || []
      )
  ...
  const summaryBase = {
    ...
    fuzzyNearDuplicatePairs:
      (_f =
        (_e =
          advancedAnalysis === null || advancedAnalysis === void 0 ? void 0 : advancedAnalysis.fuzzyNearDuplicates) ===
          null || _e === void 0
          ? void 0
  ...
  const productScanPathsOnBenchmark =
    ...
    ((_l = (_k = scan.summary) === null || _k === void 0 ? void 0 : _k.sampleDataFilesAnalyzed) !== null &&
    _l !== void 0
      ? _l
      : 0) === 0;
  const result = {
    ...
    projectRoot:
      scan.projectRoot || projectPath || undefined
        ...
        : undefined,
    platformRoot:
      productPlatformRoot || (scan.platformRoot ? String(scan.platformRoot).replace(/\\/g, '/') : undefined),
    scanTargetRoot: scanTargetRoot ? String(scanTargetRoot).replace(/\\/g, '/') : undefined,
    ...(scan.repositoryInventory
      ? {
          repositoryInventory: {
            ...scan.repositoryInventory,
            projectRoot: String(scan.repositoryInventory.projectRoot || scan.projectRoot || projectPath || '').replace(
              /\\/g,
              '/'
            ),
          },
    ...
    advancedAnalysis:
      benchmarkScan &&
      (advancedAnalysis === null || advancedAnalysis === void 0 ? void 0 : advancedAnalysis.semanticHints)
        ? {
            ...advancedAnalysis,
            semanticHints: {
      ...
      ...(benchmarkScan
        ...
        : staleProductInventory
          ? {
              ...
              repositoryFilesTotal:
                (_o = (_m = scan.scanScope) === null || _m === void 0 ? void 0 : _m.platformRepositoryFilesTotal) !==
                  null && _o !== void 0
                  ? _o
                  : null,
    ...
    ...(benchmarkScan
      ? {
          ...
          hygieneSummary: {
            ...
            intentionalPairsExcluded,
            repositoryFilesTotal:
              (_s = repoRaw !== null && repoRaw !== void 0 ? repoRaw : summaryBase.repositoryFilesTotal) !== null &&
              _s !== void 0
                ? _s
                : null,
    ...
    if (result.scanScope) {
      result.scanScope = {
        ...
        sampleDataPathsOmitted:
          scan.scanPaths || ((_v = result.scanScope) === null || _v === void 0 ? void 0 : _v.sampleDataPaths) || [],
      };
    }
  }
