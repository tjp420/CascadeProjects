...
function schemaComplianceOk(gateReport) {
  ...
  const checked =
    (_b =
      (_a = gateReport === null || gateReport === void 0 ? void 0 : gateReport.schemaChecked) !== null && _a !== void 0
        ? _a
  ...
  const passed =
    (_d =
      (_c = gateReport === null || gateReport === void 0 ? void 0 : gateReport.schemaPassed) !== null && _c !== void 0
        ? _c
        : gateReport === null || gateReport === void 0
          ? void 0
...
function checklistHasStaleFailRows(checklist, gateReport) {
  ...
  const blocking =
    (_e =
      (_d = (_c = gateReport.gate) === null || _c === void 0 ? void 0 : _c.blockingCount) !== null && _d !== void 0
        ? _d
...
function refreshComplianceChecklistFromGate(checklist, gateReport) {
  ...
  const schemaChecked =
    (_c = (_b = gateReport.schemaChecked) !== null && _b !== void 0 ? _b : gateReport.pageSampleSchemaChecked) !==
      ...
      : 0;
  const schemaPassed =
    (_e = (_d = gateReport.schemaPassed) !== null && _d !== void 0 ? _d : gateReport.pageSampleSchemaPassed) !== null &&
    _e !== void 0
      ? _e
      : 0;
  /**
...
function buildComplianceHygieneSummary(checklist, gateReport, npmAudit, context) {
  ...
  const gateProfile =
    (_f =
      (_d =
        (_b =
          (_a = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null || _a === void 0
            ? void 0
            : _a.profile) !== null && _b !== void 0
          ? _b
          : (_c = checklist === null || checklist === void 0 ? void 0 : checklist.scanScope) === null || _c === void 0
            ? void 0
  ...
  const repoTotal =
    (_l =
      (_j =
        (_g = gateReport === null || gateReport === void 0 ? void 0 : gateReport.repositoryFilesTotal) !== null &&
        _g !== void 0
          ? _g
          : (_h = gateReport === null || gateReport === void 0 ? void 0 : gateReport.repositoryInventory) === null ||
              _h === void 0
            ? void 0
    ...
    (_0 =
      (_y =
        (_x =
          (_u =
            (_t =
              (_s = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null ||
              _s === void 0
                ? void 0
            ...
            ? _u
            : (_w =
                  (_v = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null ||
                  _v === void 0
                    ? void 0
  ...
  return {
    ...
    fictionJsonFilesScanned:
      (_10 =
        (_8 =
          (_6 = gateReport === null || gateReport === void 0 ? void 0 : gateReport.fictionJsonFilesScanned) !== null &&
          _6 !== void 0
            ? _6
            : (_7 = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null ||
                _7 === void 0
              ? void 0
    ...
    fictionSampleFilesScanned:
      (_15 =
        (_13 =
          (_11 = gateReport === null || gateReport === void 0 ? void 0 : gateReport.fictionSampleFilesScanned) !==
            null && _11 !== void 0
            ? _11
            : (_12 = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null ||
                _12 === void 0
              ? void 0
    ...
    npmAuditCritical:
      (_19 =
        (_17 =
          (_16 = npmAudit === null || npmAudit === void 0 ? void 0 : npmAudit.summary) === null || _16 === void 0
            ? void 0
    ...
    npmAuditHigh:
      (_23 =
        (_21 =
          (_20 = npmAudit === null || npmAudit === void 0 ? void 0 : npmAudit.summary) === null || _20 === void 0
            ? void 0
    ...
    ((_24 = checklist === null || checklist === void 0 ? void 0 : checklist.hygieneSummary) === null || _24 === void 0
      ? void 0
...
function buildComplianceScanScope(gateReport, options = {}) {
      ...
      (_f =
        (_d =
          (_b =
            ...
            ? _b
            : (_c = gateReport === null || gateReport === void 0 ? void 0 : gateReport.repositoryInventory) === null ||
                _c === void 0
              ? void 0
              : _c.totalFiles) !== null && _d !== void 0
          ? _d
          : (_e = checklist === null || checklist === void 0 ? void 0 : checklist.scanScope) === null || _e === void 0
            ? void 0
  ...
  const gateProfile =
    (_p =
      (_m =
        (_k =
          (_j = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null || _j === void 0
            ? void 0
            : _j.profile) !== null && _k !== void 0
          ? _k
          : (_l = checklist === null || checklist === void 0 ? void 0 : checklist.scanScope) === null || _l === void 0
            ? void 0
  ...
  return {
    ...
    sourceArtifacts: {
      gateReport: Boolean(
        gateReport ||
        ((_s =
          (_r = checklist === null || checklist === void 0 ? void 0 : checklist.scanScope) === null || _r === void 0
            ? void 0
      ...
      npmAudit: Boolean(
        options.npmAudit ||
        ((_u =
          (_t = checklist === null || checklist === void 0 ? void 0 : checklist.scanScope) === null || _t === void 0
            ? void 0
...
function buildExportNotes(checklist, gateReport, npmAudit, context) {
  ...
  const credentialScanned =
    (_e =
      ...
      ? _e
      : (_f = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null || _f === void 0
        ? void 0
  ...
  const fictionJson =
    ...
    _g !== void 0
      ? _g
      : (_h = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null || _h === void 0
        ? void 0
  ...
  const fictionSamples =
    ...
    _j !== void 0
      ? _j
      : (_k = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null || _k === void 0
        ? void 0
  ...
  if (
    ...
    ((_l = gateReport === null || gateReport === void 0 ? void 0 : gateReport.euAiActSummary) === null || _l === void 0
      ? void 0
  ...
  const gateProfile =
    (_s =
      (_q =
        (_o =
          (_m = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null || _m === void 0
            ? void 0
            : _m.profile) !== null && _o !== void 0
          ? _o
          : (_p = checklist === null || checklist === void 0 ? void 0 : checklist.scanScope) === null || _p === void 0
            ? void 0
  ...
  if (
    ...
    const blocking =
      (_x =
        (_w = (_v = gateReport.gate) === null || _v === void 0 ? void 0 : _v.blockingCount) !== null && _w !== void 0
          ? _w
...
export function sanitizeComplianceChecklistArtifactExport(checklist, options = {}) {
  ...
  return {
    ...
    complianceStatus: benchmarkScan
      ...
      : hollowGate
        ? 'limited-gate-scope'
        : ((_g = (_f = sanitized.summary) === null || _f === void 0 ? void 0 : _f.failed) !== null && _g !== void 0
              ? _g
              : 0) > 0
          ? 'failed'
          : 'pass',
