...
function resolveSupplyChainStatus(audit) {
  ...
  const deps =
    (_c =
      (_a = summary.dependencies) !== null && _a !== void 0
        ? _a
        : (_b = audit.dependencies) === null || _b === void 0
          ? void 0
...
function resolveNpmAuditGateContext(audit, options = {}) {
    ...
    (_f =
      (_e =
        (_d =
          ...
          ? _d
          : scanScope.gateRepositoryFilesTotal) !== null && _e !== void 0
        ? _e
        : hygiene.gateRepositoryFilesTotal) !== null && _f !== void 0
      ? _f
      : null;
  const credentialScanned =
    (_j =
      (_h = (_g = gateReport.credentialScanned) !== null && _g !== void 0 ? _g : gateReport.productionLeakScanned) !==
        null && _h !== void 0
        ? _h
        : hygiene.contentFilesScanned) !== null && _j !== void 0
      ? _j
      : null;
    ...
    (_t =
      (_s =
        (_r =
          (_q =
            (_m =
              (_l = (_k = gateReport.scanScope) === null || _k === void 0 ? void 0 : _k.fullDirectoryStats) === null ||
              _l === void 0
                ? void 0
                : _l.contentScanned) !== null && _m !== void 0
              ? _m
              : (_p = (_o = gateReport.scanScope) === null || _o === void 0 ? void 0 : _o.fullDirectoryStats) ===
                    null || _p === void 0
                ? void 0
                : _p.filesContentScanned) !== null && _q !== void 0
            ? _q
            : gateReport.credentialScanned) !== null && _r !== void 0
          ? _r
          : gateReport.productionLeakScanned) !== null && _s !== void 0
        ? _s
        : hygiene.contentFilesScanned) !== null && _t !== void 0
      ? _t
      : null;
  const gateProfile =
    (_x =
      (_w =
        (_v = (_u = gateReport.scanScope) === null || _u === void 0 ? void 0 : _u.profile) !== null && _v !== void 0
          ? _v
          : scanScope.gateRuleBundleProfile) !== null && _w !== void 0
        ? _w
        : hygiene.gateRuleBundleProfile) !== null && _x !== void 0
      ? _x
      : null;
  const fictionJsonFilesScanned =
    (_1 =
      (_0 =
        (_y = gateReport.fictionJsonFilesScanned) !== null && _y !== void 0
          ? _y
          : (_z = gateReport.scanScope) === null || _z === void 0
            ? void 0
            : _z.fictionJsonFilesScanned) !== null && _0 !== void 0
        ? _0
        : hygiene.fictionJsonFilesScanned) !== null && _1 !== void 0
      ? _1
      : null;
  const fictionSampleFilesScanned =
    (_6 =
      (_5 =
        (_3 =
          (_2 = gateReport.fictionSampleFilesScanned) !== null && _2 !== void 0 ? _2 : gateReport.mockSampleFiles) !==
          null && _3 !== void 0
          ? _3
          : (_4 = gateReport.scanScope) === null || _4 === void 0
            ? void 0
            : _4.fictionSampleFilesScanned) !== null && _5 !== void 0
        ? _5
        : hygiene.fictionSampleFilesScanned) !== null && _6 !== void 0
      ? _6
      : null;
  const gatePass =
    (_9 =
      (_8 = (_7 = gateReport.gate) === null || _7 === void 0 ? void 0 : _7.pass) !== null && _8 !== void 0
        ? _8
        : hygiene.gatePass) !== null && _9 !== void 0
      ? _9
      : null;
  const blockingCount =
    (_13 =
      (_12 =
        (_11 = (_10 = gateReport.gate) === null || _10 === void 0 ? void 0 : _10.blockingCount) !== null &&
        _11 !== void 0
          ? _11
          : gateReport.issueCount) !== null && _12 !== void 0
        ? _12
        : hygiene.blockingCount) !== null && _13 !== void 0
      ? _13
      : null;
  return {
    gateReport,
...
function buildNpmAuditHygieneSummary(audit, context = {}) {
  ...
  return {
    ...
    prodDependencies:
      (_f =
        (_d = summary.prodDependencies) !== null && _d !== void 0
          ? _d
          : (_e = audit.dependencies) === null || _e === void 0
            ? void 0
            : _e.prod) !== null && _f !== void 0
        ? _f
        : null,
    devDependencies:
      (_j =
        (_g = summary.devDependencies) !== null && _g !== void 0
          ? _g
          : (_h = audit.dependencies) === null || _h === void 0
            ? void 0
            : _h.dev) !== null && _j !== void 0
        ? _j
        : null,
    optionalDependencies:
      (_m =
        (_l = (_k = audit.dependencies) === null || _k === void 0 ? void 0 : _k.optional) !== null && _l !== void 0
          ? _l
          : summary.optionalDependencies) !== null && _m !== void 0
        ? _m
        : null,
    ...
    supplyChainStatus:
      (_o = context.supplyChainStatus) !== null && _o !== void 0 ? _o : resolveSupplyChainStatus(audit),
    auditPackageJson:
      (_q = (_p = context.packageJsonPath) !== null && _p !== void 0 ? _p : audit.packageJsonPath) !== null &&
      _q !== void 0
        ? _q
        : null,
    ...
    ((_r = audit.hygieneSummary) === null || _r === void 0 ? void 0 : _r.jestBaselineChecked) === false
...
function buildProductNpmAuditScanScope(audit, options = {}) {
  ...
  return {
    ...
    ...(gateProfile ? { gateRuleBundleProfile: gateProfile } : {}),
    supplyChainNote:
      ((_b = audit.scanScope) === null || _b === void 0 ? void 0 : _b.supplyChainNote) ||
...
function buildNpmAuditExportNotes(audit, context = {}) {
  ...
  if (supplyChainStatus === 'pass' && deps != null) {
    ...
    if (!benchmarkScan && !skipped) {
      ...
      const optional =
        (_h = (_g = audit.dependencies) === null || _g === void 0 ? void 0 : _g.optional) !== null && _h !== void 0
          ? _h
          : summary.optionalDependencies;
...
export function sanitizeNpmAuditExport(audit, projectPath = '', options = {}) {
  ...
  if (benchmarkScan) {
    ...
    next.productPlatformRoot = paths.productPlatformRoot || resolveProductPlatformRoot(rawPath) || undefined;
  ...
  const noteContext = {
    ...
    gateReport: options.gateReport,
    repositoryFilesTotal:
      (_d = options.repositoryFilesTotal) !== null && _d !== void 0
        ? _d
        : (_e = options.gateReport) === null || _e === void 0
          ? void 0
  ...
  if (!benchmarkScan && !skipped) {
    ...
    next.hygieneSummary = buildNpmAuditHygieneSummary(next, {
      ...
      gateReport: options.gateReport,
      repositoryFilesTotal:
        (_f = options.repositoryFilesTotal) !== null && _f !== void 0
          ? _f
          : (_g = options.gateReport) === null || _g === void 0
            ? void 0
            : _g.repositoryFilesTotal,
    });
  }
  next.summary = {
    ...summary,
    total:
      (_j = (_h = summary.total) !== null && _h !== void 0 ? _h : summary.vulnerabilityTotal) !== null && _j !== void 0
        ? _j
        : 0,
    vulnerabilityTotal:
      (_l = (_k = summary.vulnerabilityTotal) !== null && _k !== void 0 ? _k : summary.total) !== null && _l !== void 0
        ? _l
        : 0,
    dependencies: deps,
  };
