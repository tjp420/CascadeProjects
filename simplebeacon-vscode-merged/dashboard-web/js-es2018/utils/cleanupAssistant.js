...
export function resolveFileReductionPlan(fileReduction) {
  ...
  return {
    ...
    totals: {
      reclaimableBytes:
        (_t =
          (_s = (_r = fileReduction.summary) === null || _r === void 0 ? void 0 : _r.reclaimableBytes) !== null &&
          _s !== void 0
            ? _s
    ...
    unusedFiles: {
      ...
      note:
        ((_u = existing === null || existing === void 0 ? void 0 : existing.unusedFiles) === null || _u === void 0
          ? void 0
          : _u.note) ||
...
export function isCleanupBriefRunnable({ brief, fileReduction, dataQuality } = {}) {
  ...
  if (
    ...
    return true;
  if (
    ((_c = dataQuality === null || dataQuality === void 0 ? void 0 : dataQuality.inventory) === null || _c === void 0
      ? void 0
      : _c.totalFiles) != null
  )
    return true;
...
export function buildCleanupAssistantBrief({
  ...
  const inventory = {
    totalFiles:
      (_c =
        (_a =
          repositoryInventory === null || repositoryInventory === void 0 ? void 0 : repositoryInventory.totalFiles) !==
          null && _a !== void 0
          ? _a
          : (_b = fileReduction === null || fileReduction === void 0 ? void 0 : fileReduction.inventory) === null ||
              _b === void 0
    ...
    totalFolders:
      (_f =
        (_d =
          ...
          ? _d
          : (_e = fileReduction === null || fileReduction === void 0 ? void 0 : fileReduction.inventory) === null ||
              _e === void 0
            ? void 0
  ...
  const tiers = {
    ...
    investigate: {
      files:
        (_h = (_g = plan.unusedFiles) === null || _g === void 0 ? void 0 : _g.candidates) !== null && _h !== void 0
          ? _h
          : 0,
  ...
  return {
    ...
    duplicateAssets:
      ((_o = (_m = plan.duplicateAssets) === null || _m === void 0 ? void 0 : _m.topGroups) === null || _o === void 0
        ? void 0
        : _o.slice(0, 8)) || [],
  ...
  if (lastResult.kind === 'complete' && Array.isArray(lastResult.steps)) {
    ...
    return {
      ...
      repositoryInventory:
        ...
        null,
      policy:
        (cleanupStep === null || cleanupStep === void 0 ? void 0 : cleanupStep.policy) || lastResult.policy || null,
    };
  }
  return {
    projectPath: lastResult.projectPath,
...
export function readCleanupPolicyFromDom(root) {
  ...
  return {
    ...
    allowNodeModules: Boolean(
      (_a = root === null || root === void 0 ? void 0 : root.querySelector('#cleanup-allow-node-modules')) === null ||
        _a === void 0
        ? void 0
        : _a.checked
    ),
    allowSimplebeaconCache: Boolean(
      (_b = root === null || root === void 0 ? void 0 : root.querySelector('#cleanup-allow-simplebeacon')) === null ||
        _b === void 0
        ? void 0
        : _b.checked
    ),
