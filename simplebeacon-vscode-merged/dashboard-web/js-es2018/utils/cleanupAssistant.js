...
export function pathMatchesProtected(relativePath, protectedPaths = []) {
  ...
  return protectedPaths.some((entry) => {
    ...
    if (!pat) return false;
    return (
      norm === pat || norm.startsWith(`${pat}/`) || norm.includes(`/${pat}/`)
    );
  });
}
/**
...
function isDirectoryArtifact(finding) {
  return (
    (finding === null || finding === void 0 ? void 0 : finding.action) ===
      "safe-to-delete" &&
    (finding.kind === "directory" ||
      / directory$/i.test(String(finding.reason || "")))
  );
}
...
export function resolveFileReductionPlan(fileReduction) {
    ...
    ((_b =
      (_a =
        existing === null || existing === void 0
          ? void 0
          : existing.safeToDelete) === null || _a === void 0
        ? void 0
        : _a.topDirectories) === null || _b === void 0
      ? void 0
      : _b.length) ||
    ((_c =
      existing === null || existing === void 0 ? void 0 : existing.totals) ===
      null || _c === void 0
      ? void 0
  ...
  const buildArtifacts =
    ((_d = fileReduction.findings) === null || _d === void 0
      ? void 0
      : _d.buildArtifacts) || [];
  const assetConsolidation =
    ((_e = fileReduction.findings) === null || _e === void 0
      ? void 0
      : _e.assetConsolidation) || [];
  const directoryBloat =
    ((_f = fileReduction.findings) === null || _f === void 0
      ? void 0
      : _f.directoryBloat) || [];
  const buildSummary =
    ((_g = fileReduction.scanners) === null || _g === void 0
      ? void 0
      : _g["build-artifacts"]) || {};
  const assetSummary =
  ...
  const unusedSummary =
    ((_j = fileReduction.scanners) === null || _j === void 0
      ? void 0
      : _j["unused-files"]) || {};
  ...
  const reviewLogs = buildArtifacts
    .filter(
      (finding) =>
        finding.action === "review-before-delete" &&
  ...
  const duplicateBytes =
    (_m = assetSummary.reclaimableBytes) !== null && _m !== void 0
      ? _m
      : assetConsolidation.reduce(
          (sum, group) => sum + (group.reclaimableBytes || 0),
          0,
        );
  ...
  return {
    ...
    unusedFiles: {
      ...
      note:
        ((_u =
          existing === null || existing === void 0
            ? void 0
            : existing.unusedFiles) === null || _u === void 0
          ? void 0
          : _u.note) ||
    ...
    duplicateAssets: {
      topGroups: assetConsolidation
        ...
        .sort(
          (left, right) =>
            (right.reclaimableBytes || 0) - (left.reclaimableBytes || 0),
        )
        .slice(0, 8)
        .map((group) => ({
          keeper: group.keeper,
 ...
 * @returns {any}
 */
export function isCleanupBriefRunnable({
  brief,
  fileReduction,
  dataQuality,
} = {}) {
  ...
  if (
    ((_a = brief === null || brief === void 0 ? void 0 : brief.inventory) ===
      null || _a === void 0
      ? void 0
      : _a.totalFiles) != null
  )
  ...
  if (
    ((_c =
      dataQuality === null || dataQuality === void 0
        ? void 0
        : dataQuality.inventory) === null || _c === void 0
      ? void 0
      : _c.totalFiles) != null
  )
    return true;
  if (
    (dataQuality === null || dataQuality === void 0
      ? void 0
      : dataQuality.summary) != null
  )
    return true;
  if (
    (_d = brief === null || brief === void 0 ? void 0 : brief.scanAnalysis) ===
      null || _d === void 0
      ? void 0
      : _d.dataQuality
  )
    return true;
  if (
    (_e = brief === null || brief === void 0 ? void 0 : brief.scanAnalysis) ===
      null || _e === void 0
      ? void 0
      : _e.fileReduction
  )
  ...
  if (
    (((_f =
      brief === null || brief === void 0
        ? void 0
        : brief.estimatedReduction) === null || _f === void 0
      ? void 0
      : _f.files) || 0) > 0
  )
    return true;
  if (
    (((_h =
      (_g = brief === null || brief === void 0 ? void 0 : brief.tiers) ===
        null || _g === void 0
        ? void 0
  ...
  if (
    (((_j =
      brief === null || brief === void 0
        ? void 0
        : brief.dataQualityActions) === null || _j === void 0
      ? void 0
      : _j.length) || 0) > 0
  )
    return true;
...
export function buildCleanupAssistantConclusion(brief) {
  ...
  const files =
    ((_a = brief.estimatedReduction) === null || _a === void 0
      ...
      : _a.files) || 0;
  const bytes =
    ((_b = brief.estimatedReduction) === null || _b === void 0
      ? void 0
      : _b.bytes) || 0;
  const after =
    (_c = brief.projectedInventory) === null || _c === void 0
      ? void 0
      : _c.totalFiles;
  const inventory =
    (_d = brief.inventory) === null || _d === void 0 ? void 0 : _d.totalFiles;
  if (files > 0) {
...
export function buildCleanupAssistantBrief({
  ...
  const tiers = {
    ...
    investigate: {
      files:
        (_h =
          (_g = plan.unusedFiles) === null || _g === void 0
            ? void 0
            : _g.candidates) !== null && _h !== void 0
          ? _h
          : 0,
      note:
        ((_j = plan.unusedFiles) === null || _j === void 0
          ? void 0
          : _j.note) || null,
    },
  };
  ...
  if (
    ...
    analysis.fileReduction.skippedArtifactDirectories =
      skippedArtifactDirectories.slice(0, 8);
  }
  ...
  return {
    ...
    duplicateAssets:
      ((_o =
        (_m = plan.duplicateAssets) === null || _m === void 0
          ? void 0
          : _m.topGroups) === null || _o === void 0
        ? void 0
        : _o.slice(0, 8)) || [],
...
function resolveCleanupScanInputs(lastResult) {
  ...
  if (lastResult.kind === "complete" && Array.isArray(lastResult.steps)) {
    const cleanupStep =
      lastResult.steps.find((step) => step.id === "cleanup-assistant") || null;
    const fileReductionStep =
      lastResult.steps.find((step) => step.id === "file-reduction") || null;
    const dataQualityStep =
      lastResult.steps.find((step) => step.id === "data-quality") || null;
    return {
      projectPath: lastResult.projectPath,
      fileReduction:
        (cleanupStep === null || cleanupStep === void 0
          ? void 0
          : cleanupStep.fileReduction) ||
      ...
      dataQuality:
        (cleanupStep === null || cleanupStep === void 0
          ? void 0
          : cleanupStep.dataQuality) ||
        (dataQualityStep === null || dataQualityStep === void 0
          ? void 0
          : dataQualityStep.scan) ||
        null,
      repositoryInventory:
        (cleanupStep === null || cleanupStep === void 0
          ? void 0
 ...
 * @returns {any}
 */
export function renderCleanupAssistantPanel(
  brief,
  { policy = loadCleanupPolicy() } = {},
) {
  if (!brief) return "";
  const protectedValue = (
    policy.protectedPaths || DEFAULT_PROTECTED_PATHS
  ).join("\n");
  /**
   * Actions.
  ...
  `,
      ...
      .join("") ||
    '<li class="text-muted">No data-quality actions flagged.</li>';
  return `
...
export function readCleanupPolicyFromDom(root) {
  ...
  const textarea =
    root === null || root === void 0
      ? void 0
      : root.querySelector("#cleanup-protected-paths");
  ...
  return {
    ...
    allowNodeModules: Boolean(
      (_a =
        root === null || root === void 0
          ? void 0
          : root.querySelector("#cleanup-allow-node-modules")) === null ||
        _a === void 0
        ? void 0
        : _a.checked,
    ),
    allowSimplebeaconCache: Boolean(
      (_b =
        root === null || root === void 0
          ? void 0
          : root.querySelector("#cleanup-allow-simplebeacon")) === null ||
        _b === void 0
        ? void 0
        : _b.checked,
    ),
