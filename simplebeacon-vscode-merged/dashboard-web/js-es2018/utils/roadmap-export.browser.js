...
const INTENTIONAL_MIRROR_PAIRS = [['complete-scan-artifact-profile.js', 'complete-scan-artifact-profile.browser.js']];
/**
...
function matchesRoadmapTemplate(text) {
  ...
  return (
    SIMPLEBEACON_ROADMAP_MARKERS.some((re) => re.test(value)) || BENCHMARK_TEMPLATE_PHRASES.some((re) => re.test(value))
  );
}
/**
...
function inferScanTargetRootFromHints(roadmap, options = {}) {
  ...
  const sourceRoot = normalizeExportPath(
    (roadmap === null || roadmap === void 0 ? void 0 : roadmap.sourceProjectPath) ||
      (roadmap === null || roadmap === void 0 ? void 0 : roadmap.projectRoot) ||
      ''
  );
  if (isBenchmarkScanTargetRoot(sourceRoot)) return '';
  const platformRoot =
    resolveProductPlatformRoot(`${sourceRoot.replace(/\/$/, '')}/github-cache/${cloneName}`) || sourceRoot;
...
function isStaleEmptyCodebaseMetrics(metrics) {
  ...
  const docs =
    (_d = (_c = metrics.documentation) === null || _c === void 0 ? void 0 : _c.totalDocs) !== null && _d !== void 0
      ? _d
      : 0;
...
function stripFictionCoverageFromText(text) {
  ...
  let out = text
    ...
    .replace(/\b\d{1,3}(?:\.\d+)?%\b(?: is above the recommended threshold of \d+%)?[^.]*\./gi, (match) =>
      /coverage/i.test(match) ? 'Coverage percentages require live Jest/Istanbul — not inferred by roadmap LLM.' : match
    );
  ...
  const repositoryFilesTotal =
    (_d =
      (_c =
        ...
        _a !== void 0
          ? _a
          : (_b = gateReport === null || gateReport === void 0 ? void 0 : gateReport.repositoryInventory) === null ||
              _b === void 0
            ? void 0
  ...
  const credentialScanned =
    (_k =
      (_j =
        (_h =
          (_f =
            (_e = gateReport === null || gateReport === void 0 ? void 0 : gateReport.credentialScanned) !== null &&
            _e !== void 0
              ? _e
            ...
            ? _f
            : (_g = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null ||
                _g === void 0
              ? void 0
...
function resolveRoadmapGateContext(roadmap, options = {}) {
  ...
  const repositoryFilesTotal =
    (_c =
      (_b = (_a = options.repositoryFilesTotal) !== null && _a !== void 0 ? _a : gateTotalFromReport) !== null &&
      _b !== void 0
        ? _b
      ...
      (_m =
        (_l =
          (_k =
            (_j =
              (_f =
                (_e = (_d = gateReport.scanScope) === null || _d === void 0 ? void 0 : _d.fullDirectoryStats) ===
                  null || _e === void 0
                  ? void 0
                  : _e.contentScanned) !== null && _f !== void 0
                ? _f
                : (_h = (_g = gateReport.scanScope) === null || _g === void 0 ? void 0 : _g.fullDirectoryStats) ===
                      null || _h === void 0
                  ? void 0
  ...
  const gateProfile =
    (_s =
      (_r =
        (_q = (_p = gateReport.scanScope) === null || _p === void 0 ? void 0 : _p.profile) !== null && _q !== void 0
          ? _q
  ...
  const fictionSampleFilesScanned =
    (_1 =
      (_0 =
        (_y =
          (_x = gateReport.fictionSampleFilesScanned) !== null && _x !== void 0 ? _x : gateReport.mockSampleFiles) !==
          null && _y !== void 0
          ? _y
  ...
  const gatePass =
    (_4 =
      (_3 = (_2 = gateReport.gate) === null || _2 === void 0 ? void 0 : _2.pass) !== null && _3 !== void 0
        ? _3
  ...
  const blockingCount =
    (_8 =
      (_7 =
        (_6 = (_5 = gateReport.gate) === null || _5 === void 0 ? void 0 : _5.blockingCount) !== null && _6 !== void 0
          ? _6
  ...
  const jestBaselineChecked =
    gateReport.jestBaselineChecked === false || hygiene.jestBaselineChecked === false ? false : null;
...
function hasFictionCoverageInStrategicInsights(insights) {
  ...
  const parts = [
    ...
    ...(((_a = insights.riskAssessment) === null || _a === void 0 ? void 0 : _a.riskFactors) || []).flatMap((f) => [
      f.description,
      f.recommendation,
    ]),
  ].filter(Boolean);
    ...
    const next = {
      ...
      coverageEvidenceSource:
        (_b = roadmap.coverageEvidenceSource) !== null && _b !== void 0
          ? _b
          : (metrics === null || metrics === void 0 ? void 0 : metrics.testCoverage) != null
...
function buildProductRoadmapHygieneSummary(roadmap, gateContext = {}) {
   ...
   * @returns {any}
   */
  const jestFeature = (((_a = roadmap.codeAnalysis) === null || _a === void 0 ? void 0 : _a.features) || []).find((f) =>
    /jest test files/i.test(String((f === null || f === void 0 ? void 0 : f.name) || ''))
  );
  const {
  ...
  return {
    roadmapAuditFiles:
      (_d =
        (_c = (_b = roadmap.codeAnalysis) === null || _b === void 0 ? void 0 : _b.structure) === null || _c === void 0
          ? void 0
    ...
    sprintCompletionRate:
      (_f = (_e = roadmap.executiveSummary) === null || _e === void 0 ? void 0 : _e.completionRate) !== null &&
      _f !== void 0
        ? _f
        : null,
    coverageEvidenceSource:
      (_g = roadmap.coverageEvidenceSource) !== null && _g !== void 0
        ? _g
        : ((_j = (_h = roadmap.progressMetrics) === null || _h === void 0 ? void 0 : _h.metrics) === null ||
            _j === void 0
              ? void 0
    ...
    apiRouteCount:
      (_p =
        (_m =
          (_l = (_k = roadmap.codeAnalysis) === null || _k === void 0 ? void 0 : _k.aiIntegration) === null ||
          _l === void 0
            ? void 0
        ...
        : null,
    jestFilesOnDisk:
      (_q = jestFeature === null || jestFeature === void 0 ? void 0 : jestFeature.count) !== null && _q !== void 0
        ? _q
        : null,
...
function buildProductRoadmapScanScope(scanScope, roadmap, gateContext = {}) {
  ...
  return {
    ...
    ...(gateProfile ? { gateRuleBundleProfile: gateProfile } : {}),
    roadmapNote:
      (scanScope === null || scanScope === void 0 ? void 0 : scanScope.roadmapNote) ||
      ((_a = roadmap === null || roadmap === void 0 ? void 0 : roadmap.scanScope) === null || _a === void 0
        ? void 0
        : _a.roadmapNote) ||
...
function sanitizeProductDevelopmentPhases(phases, codeAnalysis) {
   ...
   * @returns {any}
   */
  const jestFeature = ((codeAnalysis === null || codeAnalysis === void 0 ? void 0 : codeAnalysis.features) || []).find(
    (f) => /jest test files/i.test(String((f === null || f === void 0 ? void 0 : f.name) || ''))
  );
  ...
  return phases.map((phase) => {
    ...
    return features.some((feature, index) => {
      var _a;
      return feature !== ((_a = phase.features) === null || _a === void 0 ? void 0 : _a[index]);
    })
      ? { ...phase, features }
      : phase;
  });
...
function buildProductRoadmapExportNotes(roadmap, context = {}) {
  ...
  const auditFiles =
    (_e = (_d = roadmap.codeAnalysis) === null || _d === void 0 ? void 0 : _d.structure) === null || _e === void 0
      ? void 0
      : _e.totalFiles;
...
function sanitizeProductRoadmapExport(next, options = {}) {
  var _a;
  const rawPath =
    options.requestedProjectPath || options.projectPath || next.sourceProjectPath || next.platformRoot || '';
...
function normalizeRoadmapExportPaths(roadmap, scanTargetRoot = '') {
  ...
  const next = {
    ...
    ...(roadmap.productPlatformRoot ? { productPlatformRoot: normalizeExportPath(roadmap.productPlatformRoot) } : {}),
  };
  if (next.projectStructure) {
    const mainCategories = next.projectStructure.mainCategories
      ? Object.fromEntries(
...
function sanitizeCodebaseMetricsForBenchmark(metrics, structure) {
  ...
  return {
    ...
    documentation: {
      readmeFiles:
        (_d =
          (_b = (_a = structure.languages) === null || _a === void 0 ? void 0 : _a['.md']) !== null && _b !== void 0
            ? _b
            : (_c = metrics === null || metrics === void 0 ? void 0 : metrics.documentation) === null || _c === void 0
              ? void 0
              : _c.readmeFiles) !== null && _d !== void 0
          ? _d
          : 0,
      totalDocs:
        (_f = (_e = structure.languages) === null || _e === void 0 ? void 0 : _e['.md']) !== null && _f !== void 0
          ? _f
          : 0,
      coverage: null,
    },
...
function resolveRoadmapExportContext(roadmap, options = {}) {
  ...
  const sourceRoot = normalizeExportPath(
    (roadmap === null || roadmap === void 0 ? void 0 : roadmap.sourceProjectPath) ||
      (roadmap === null || roadmap === void 0 ? void 0 : roadmap.projectRoot) ||
      ((_a = roadmap === null || roadmap === void 0 ? void 0 : roadmap.projectStructure) === null || _a === void 0
        ? void 0
        : _a.projectRoot) ||
      ''
  );
...
function sanitizeProgressMetrics(metrics, benchmarkScan, codeMetrics, misscopedPlatformWalk = false) {
  ...
  return {
    ...
    categories: {
      'OSS source': (codeMetrics === null || codeMetrics === void 0 ? void 0 : codeMetrics.codeFiles)
        ? Math.min(100, Math.round(codeMetrics.codeFiles / 20))
        : null,
      Documentation:
        (_b = (_a = metrics.categories) === null || _a === void 0 ? void 0 : _a.Documentation) !== null && _b !== void 0
          ? _b
          : null,
    },
    metrics: {
      ...(metrics.metrics || {}),
      jestTests:
        (codeMetrics === null || codeMetrics === void 0 ? void 0 : codeMetrics.codeFiles) != null
...
function sanitizeCodeAnalysisForBenchmark(codeAnalysis, misscopedPlatformWalk = false) {
    ...
    if (misscopedPlatformWalk) {
      ...
      next.features = next.features.filter((feature) => {
        ...
        if (
          ...
          Number(feature === null || feature === void 0 ? void 0 : feature.count) === 1000
        )
          return false;
  ...
  const pairs =
    (_b = (_a = next.phase2) === null || _a === void 0 ? void 0 : _a.fuzzySimilarity) === null || _b === void 0
      ? void 0
      : _b.pairs;
...
function sanitizeExecutiveSummaryForBenchmark(summary, codeMetrics) {
  ...
  return {
    ...
    codeFilesAnalyzed:
      (_a = codeMetrics === null || codeMetrics === void 0 ? void 0 : codeMetrics.codeFiles) !== null && _a !== void 0
        ? _a
...
export function sanitizeRoadmapExport(roadmap, options = {}) {
  ...
  if (next.recommendations) {
    ...
    const filtered = {
      ...
      priorities: {
        high: filterTemplateLines(
          ((_b = rec.priorities) === null || _b === void 0 ? void 0 : _b.high) || rec.immediate
        ),
        medium: filterTemplateLines(
          ((_c = rec.priorities) === null || _c === void 0 ? void 0 : _c.medium) || rec.shortTerm
        ),
    ...
    next.recommendations =
      hasAny && !recommendationsNeedBenchmarkReplace(filtered) ? filtered : benchmarkRecommendations();
  } else {
    next.recommendations = benchmarkRecommendations();
  }
  if (
    ((_e = next.developmentPhases) === null || _e === void 0 ? void 0 : _e.length) &&
    ...
    next.developmentPhases = (
      ((_f = next.benchmarkSprintModel) === null || _f === void 0 ? void 0 : _f.phases) || [
        {
  ...
  if ((_o = next.implementationPhases) === null || _o === void 0 ? void 0 : _o.length) {
    const alreadyBenchmark =
      ...
      String(((_p = next.implementationPhases[0]) === null || _p === void 0 ? void 0 : _p.phase) || '')
        .toLowerCase()
  ...
  if (next.executiveSummary && typeof next.executiveSummary === 'object') {
    next.executiveSummary = sanitizeExecutiveSummaryForBenchmark(
      ...
      (_q = next.codeAnalysis) === null || _q === void 0 ? void 0 : _q.structure
    );
  }
  ...
  if (
    (_t = (_s = next.codeAnalysis) === null || _s === void 0 ? void 0 : _s.phase2) === null || _t === void 0
      ? void 0
      : _t.resourceEstimate
  ) {
  ...
  if (next.codebaseMetrics) {
    next.codebaseMetrics = sanitizeCodebaseMetricsForBenchmark(
      ...
      (_v = next.codeAnalysis) === null || _v === void 0 ? void 0 : _v.structure
    );
  }
