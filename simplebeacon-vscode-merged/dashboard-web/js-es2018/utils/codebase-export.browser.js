...
function resolveCodebaseExportContext(report, options = {}) {
    ...
    const projectRoot = normalizeExportPath((report === null || report === void 0 ? void 0 : report.projectRoot) || (report === null || report === void 0 ? void 0 : report.projectPath) || '');
...
function isKnownCodebaseFalsePositive(finding) {
    ...
    if (finding.type === 'placeholder-token' && /^README\.md$/i.test(filePath))
        return true;
    if (finding.category === 'tech-debt' && /liability-metrics\.js$/i.test(filePath))
        return true;
...
function filterKnownFalsePositiveFindings(report) {
    ...
    return {
        ...
        categories: findings.length
            ? (report.categories || []).map((c) => { var _a; return ({ ...c, count: (_a = categoryCounts[c.category]) !== null && _a !== void 0 ? _a : 0 }); }).filter((c) => c.count > 0)
            : [],
        summary: {
            ...report.summary,
            ...
            severityCounts: findings.length ? (_b = report.summary) === null || _b === void 0 ? void 0 : _b.severityCounts : { high: 0, medium: 0, low: 0 },
            categoryCounts,
            analyzerCounts: {
                debugArtifacts: 0,
...
function normalizeCodebaseExportPaths(report, scanTargetRoot = '', options = {}) {
    ...
    const projectLabel = projectLabelFromPath(options.productPlatformRoot || resolveProductPlatformRoot(rawRoot) || rawRoot);
    const pathOptions = {
        projectLabel,
    ...
    return {
        ...
        ...(report.repositoryInventory
            ? {
                repositoryInventory: {
                    ...report.repositoryInventory,
                    projectRoot: redactCodebasePathForExport(report.repositoryInventory.projectRoot || rawRoot, pathOptions) || redactedRoot
                }
            }
            : {})
    };
...
function replaceMisleadingCodebaseLimitations(limitations = [], context) {
    ...
    const filtered = limitations.filter((line) => {
        ...
        if (/ESLint ran on server, packages/i.test(text))
            return false;
        if (/under the platform root when available/i.test(text))
            return false;
        if (/^OSS benchmark clone under github-cache/i.test(text))
            return false;
        if (/ESLint (not run|did not run)/i.test(text))
            return false;
        return true;
    });
    if (context.benchmarkScan) {
...
function resolveCodebaseHealthStatus(summary) {
    var _a, _b, _c, _d, _e;
    const total = (_a = summary === null || summary === void 0 ? void 0 : summary.findingsTotal) !== null && _a !== void 0 ? _a : 0;
    const high = (_c = (_b = summary === null || summary === void 0 ? void 0 : summary.severityCounts) === null || _b === void 0 ? void 0 : _b.high) !== null && _c !== void 0 ? _c : 0;
    const medium = (_e = (_d = summary === null || summary === void 0 ? void 0 : summary.severityCounts) === null || _d === void 0 ? void 0 : _d.medium) !== null && _e !== void 0 ? _e : 0;
    if (high > 0)
        return 'needs-attention';
    if (medium > 0)
        return 'healthy-with-findings';
    if (total > 0)
        return 'clean-low-noise';
    return 'clean';
}
/**
...
function resolveGateInventoryContext(report, options = {}) {
    ...
    const repositoryFilesTotal = (_g = (_e = (_c = (_b = (_a = options.repositoryFilesTotal) !== null && _a !== void 0 ? _a : options.gateRepositoryFilesTotal) !== null && _b !== void 0 ? _b : gateReport.repositoryFilesTotal) !== null && _c !== void 0 ? _c : (_d = gateReport.repositoryInventory) === null || _d === void 0 ? void 0 : _d.totalFiles) !== null && _e !== void 0 ? _e : (_f = report.hygieneSummary) === null || _f === void 0 ? void 0 : _f.gateRepositoryFilesTotal) !== null && _g !== void 0 ? _g : null;
    const credentialScanned = (_o = (_l = (_j = (_h = gateReport.credentialScanned) !== null && _h !== void 0 ? _h : gateReport.productionLeakScanned) !== null && _j !== void 0 ? _j : (_k = gateReport.scanScope) === null || _k === void 0 ? void 0 : _k.productionDirsScanned) !== null && _l !== void 0 ? _l : (_m = report.hygieneSummary) === null || _m === void 0 ? void 0 : _m.credentialScanned) !== null && _o !== void 0 ? _o : null;
    const contentScanned = (_x = (_v = (_u = (_r = (_q = (_p = gateReport.scanScope) === null || _p === void 0 ? void 0 : _p.fullDirectoryStats) === null || _q === void 0 ? void 0 : _q.contentScanned) !== null && _r !== void 0 ? _r : (_t = (_s = gateReport.scanScope) === null || _s === void 0 ? void 0 : _s.fullDirectoryStats) === null || _t === void 0 ? void 0 : _t.filesContentScanned) !== null && _u !== void 0 ? _u : gateReport.credentialScanned) !== null && _v !== void 0 ? _v : (_w = report.hygieneSummary) === null || _w === void 0 ? void 0 : _w.contentFilesScanned) !== null && _x !== void 0 ? _x : null;
    const gateProfile = (_3 = (_1 = (_z = (_y = gateReport.scanScope) === null || _y === void 0 ? void 0 : _y.profile) !== null && _z !== void 0 ? _z : (_0 = report.scanScope) === null || _0 === void 0 ? void 0 : _0.gateRuleBundleProfile) !== null && _1 !== void 0 ? _1 : (_2 = report.hygieneSummary) === null || _2 === void 0 ? void 0 : _2.gateRuleBundleProfile) !== null && _3 !== void 0 ? _3 : null;
    return {
        gateReport,
        ...
        contentScanned,
        gateProfile,
        fictionJsonFilesScanned: (_8 = (_6 = (_4 = gateReport.fictionJsonFilesScanned) !== null && _4 !== void 0 ? _4 : (_5 = gateReport.scanScope) === null || _5 === void 0 ? void 0 : _5.fictionJsonFilesScanned) !== null && _6 !== void 0 ? _6 : (_7 = report.hygieneSummary) === null || _7 === void 0 ? void 0 : _7.fictionJsonFilesScanned) !== null && _8 !== void 0 ? _8 : null,
        fictionSampleFilesScanned: (_14 = (_12 = (_10 = (_9 = gateReport.fictionSampleFilesScanned) !== null && _9 !== void 0 ? _9 : gateReport.mockSampleFiles) !== null && _10 !== void 0 ? _10 : (_11 = gateReport.scanScope) === null || _11 === void 0 ? void 0 : _11.fictionSampleFilesScanned) !== null && _12 !== void 0 ? _12 : (_13 = report.hygieneSummary) === null || _13 === void 0 ? void 0 : _13.fictionSampleFilesScanned) !== null && _14 !== void 0 ? _14 : null
    };
}
/**
...
function buildProductCodebaseExportNotes(report, context = {}) {
    ...
    const eslintSource = ((_a = report.summary) === null || _a === void 0 ? void 0 : _a.eslintSource) || ((_b = report.eslintSummary) === null || _b === void 0 ? void 0 : _b.source) || 'none';
    if (eslintSource === 'none' && ((_c = report.summary) === null || _c === void 0 ? void 0 : _c.eslintSkipped)) {
        ...
        notes.push(`ESLint ran on platform targets (${(_e = (_d = report.summary) === null || _d === void 0 ? void 0 : _d.eslintErrors) !== null && _e !== void 0 ? _e : 0} errors, ${(_g = (_f = report.summary) === null || _f === void 0 ? void 0 : _f.eslintWarnings) !== null && _g !== void 0 ? _g : 0} warnings).`);
    }
    const codeFiles = (_h = report.summary) === null || _h === void 0 ? void 0 : _h.codeFilesAnalyzed;
    const auditFiles = (_k = (_j = report.repositoryInventory) === null || _j === void 0 ? void 0 : _j.totalFiles) !== null && _k !== void 0 ? _k : (_l = report.summary) === null || _l === void 0 ? void 0 : _l.repositoryFilesTotal;
    if (codeFiles != null && auditFiles != null && auditFiles > codeFiles) {
        notes.push(`${Number(codeFiles).toLocaleString()} code-like file(s) deep-scanned — audit inventory (${Number(auditFiles).toLocaleString()} paths) includes non-code assets and metadata.`);
    }
    if (((_o = (_m = report.summary) === null || _m === void 0 ? void 0 : _m.findingsTotal) !== null && _o !== void 0 ? _o : 0) === 0) {
    ...
    if (gateTotal != null && auditFiles != null && gateTotal !== auditFiles) {
        ...
        notes.push(`repositoryInventory.totalFiles (${Number(auditFiles).toLocaleString()}, ${profile} profile) — gate full-tree inventory is ${Number(gateTotal).toLocaleString()} paths.`);
    }
    if (gateTotal != null && credentialScanned != null && credentialScanned < gateTotal) {
        notes.push(`CRED/LEAK rules scanned ${Number(credentialScanned).toLocaleString()} production-path file(s) — ${Number(gateTotal - credentialScanned).toLocaleString()} metadata-only path(s) in gate inventory of ${Number(gateTotal).toLocaleString()}.`);
    }
    ...
    if (gateReport.jestBaselineChecked === false || ((_q = report.hygieneSummary) === null || _q === void 0 ? void 0 : _q.jestBaselineChecked) === false) {
        notes.push('Jest was not run during the paired gate scan — codebase unused-file heuristics are static/ESLint only.');
    }
    const medium = (_t = (_s = (_r = report.summary) === null || _r === void 0 ? void 0 : _r.severityCounts) === null || _s === void 0 ? void 0 : _s.medium) !== null && _t !== void 0 ? _t : 0;
    const high = (_w = (_v = (_u = report.summary) === null || _u === void 0 ? void 0 : _u.severityCounts) === null || _v === void 0 ? void 0 : _v.high) !== null && _w !== void 0 ? _w : 0;
    const eslintFindings = (_z = (_y = (_x = report.summary) === null || _x === void 0 ? void 0 : _x.categoryCounts) === null || _y === void 0 ? void 0 : _y.eslint) !== null && _z !== void 0 ? _z : 0;
    if (medium > 0 && eslintFindings === medium && high === 0) {
        notes.push(`${medium} medium-severity finding(s) are ESLint style-tier warnings only — no high-severity merge-risk issues.`);
    }
    const mirrorSamples = (((_0 = report.structureInsights) === null || _0 === void 0 ? void 0 : _0.samples) || [])
        .filter((s) => String(s.filePath || '').startsWith('.github-sync/')).length;
    if (mirrorSamples > 0) {
        notes.push(`Structure samples include ${mirrorSamples} path(s) under .github-sync/ — mirror tree, not primary product source.`);
    }
...
function buildProductCodebaseHygieneSummary(report, options = {}) {
    ...
    const auditFiles = (_c = (_b = (_a = report.repositoryInventory) === null || _a === void 0 ? void 0 : _a.totalFiles) !== null && _b !== void 0 ? _b : summary.repositoryFilesTotal) !== null && _c !== void 0 ? _c : null;
    ...
    return {
        ...
        eslintSource: summary.eslintSource || ((_g = report.eslintSummary) === null || _g === void 0 ? void 0 : _g.source) || 'none',
        eslintWarnings: (_k = (_h = summary.eslintWarnings) !== null && _h !== void 0 ? _h : (_j = report.eslintSummary) === null || _j === void 0 ? void 0 : _j.warnings) !== null && _k !== void 0 ? _k : null,
        mediumSeverityFindings: (_m = (_l = summary.severityCounts) === null || _l === void 0 ? void 0 : _l.medium) !== null && _m !== void 0 ? _m : 0,
        highSeverityFindings: (_p = (_o = summary.severityCounts) === null || _o === void 0 ? void 0 : _o.high) !== null && _p !== void 0 ? _p : 0,
        ...(gateReport.jestBaselineChecked === false || ((_q = report.hygieneSummary) === null || _q === void 0 ? void 0 : _q.jestBaselineChecked) === false
...
function annotateStructureInsights(structureInsights) {
    var _a, _b, _c, _d, _e;
    if (!((_a = structureInsights === null || structureInsights === void 0 ? void 0 : structureInsights.samples) === null || _a === void 0 ? void 0 : _a.length))
    ...
    if (docHeavy && ((_c = structureInsights.summary) === null || _c === void 0 ? void 0 : _c.tier) === 'baseline') {
        const sampled = (_e = (_d = structureInsights.summary) === null || _d === void 0 ? void 0 : _d.sampledFiles) !== null && _e !== void 0 ? _e : structureInsights.samples.length;
    ...
    if (!Object.keys(summaryExtras).length)
        return structureInsights;
    return {
        ...structureInsights,
        summary: {
...
export function sanitizeCodebaseReportExport(report, options = {}) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q;
    if (!report || report.type !== 'codebase-analyzer-report')
        return report;
    ...
    const eslintSource = ((_a = next.summary) === null || _a === void 0 ? void 0 : _a.eslintSource) || ((_b = next.eslintSummary) === null || _b === void 0 ? void 0 : _b.source) || 'none';
    ...
    if (benchmarkScan) {
        ...
        next = {
            ...
            hygieneSummary: {
                healthScore: (_e = (_d = next.summary) === null || _d === void 0 ? void 0 : _d.healthScore) !== null && _e !== void 0 ? _e : null,
                findingsTotal: (_g = (_f = next.summary) === null || _f === void 0 ? void 0 : _f.findingsTotal) !== null && _g !== void 0 ? _g : 0,
                codeFilesAnalyzed: (_j = (_h = next.summary) === null || _h === void 0 ? void 0 : _h.codeFilesAnalyzed) !== null && _j !== void 0 ? _j : null,
                repositoryFilesTotal: (_o = (_l = (_k = next.summary) === null || _k === void 0 ? void 0 : _k.repositoryFilesTotal) !== null && _l !== void 0 ? _l : (_m = next.repositoryInventory) === null || _m === void 0 ? void 0 : _m.totalFiles) !== null && _o !== void 0 ? _o : null,
                eslintSource,
