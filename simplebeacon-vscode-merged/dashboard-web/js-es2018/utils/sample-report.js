...
export function generateSampleReport() {
  ...
  const rawIssues = [
    // ═══ Critical (3 findings) ═══
    {
      ...
      line: 3,
      description:
        "GCP service account key detected — private_key field contains a live RSA private key",
      confidence: 0.98,
      count: 1,
    ...
    },
    {
      ...
      line: 7,
      description:
        "Azure storage account key detected — AccountKey parameter contains a hardcoded secret",
      confidence: 0.95,
      count: 1,
    ...
    },
    {
      ...
      line: 1,
      description:
        ".env file committed to repository — contains DATABASE_URL, JWT_SECRET, and STRIPE_API_KEY",
      confidence: 1.0,
      count: 1,
      affectedFiles: [".env"],
    ...
    // ═══ High (4 findings) ═══
    {
      ...
      line: 12,
      description:
        "OAuth token hardcoded — ya29.* Google API token detected in source code",
      confidence: 0.92,
      count: 1,
    ...
    },
    {
      ...
      line: 15,
      description:
        "Docker container configured to run in privileged mode — full host access granted",
      confidence: 1.0,
      count: 1,
    ...
    },
    {
      ...
      line: 23,
      description:
        'Suspicious npm package name detected — "expresss" appears to be a typosquat of "express"',
      confidence: 0.88,
      count: 1,
    ...
    },
    {
      ...
      line: 31,
      description:
        "Malicious postinstall script detected — uses curl to download and execute remote code",
      confidence: 0.94,
      count: 1,
      affectedFiles: ["package.json"],
    ...
    // ═══ Medium (3 findings) ═══
    {
      ...
      line: 20,
      description:
        "Docker container runs as root user — no USER directive specifies a non-root account",
      confidence: 1.0,
      count: 1,
      affectedFiles: ["Dockerfile"],
    ...
    },
    {
      ...
      line: 18,
      description:
        'Unpinned dependency version — "axios" uses "^1.6.0" which can resolve to unexpected versions',
      confidence: 1.0,
      count: 1,
      affectedFiles: ["package.json"],
    ...
    },
    {
      ...
      line: 1,
      description:
        'Boilerplate LLM-generated comment detected — "This module provides utility functions for..."',
      confidence: 0.82,
      count: 1,
    ...
    },
    {
      ...
      line: 5,
      description:
        "Hardcoded URL detected — http://localhost:3000/api should use environment variable",
      confidence: 0.75,
      count: 1,
  ...
  const blockingIssues = rawIssues.filter((i) =>
    ["critical", "high"].includes(i.severity),
  );
  const warningIssues = rawIssues.filter((i) =>
  ...
  return {
    ...
    sampleFiles: [
      "web/data/dashboard-sample.json",
      "web/data/metrics-sample.json",
    ],
    scanScope: {
    ...
    npmAudit: {
      packageJsonCount: 1,
      dependencyCount: 47,
      summary: "1 package.json with 47 dependencies.",
    },
    ...
    remediationPhases: [
      {
        ...
        tasks: [
          {
            description: "Rotate 3 exposed credentials",
            type: "fix",
            done: false,
          },
      ...
      },
      {
        ...
        tasks: [
          {
            description: "Remove privileged mode from Dockerfile",
            type: "fix",
            done: false,
          },
          {
          ...
          {
            description: 'Remove suspicious package "expresss"',
            type: "fix",
            done: false,
          },
          {
            description: "Remove malicious postinstall script",
            type: "fix",
            done: false,
          },
        ],
