...
function resolveHeadlineMetric(headline, platform, key) {
  var _a, _b;
  return (_b =
    (_a = headline[key]) !== null && _a !== void 0 ? _a : platform[key]) !==
    null && _b !== void 0
    ? _b
    : null;
}
...
function headlineMonorepoMetricsDiverge(headline, platform, monorepo) {
  ...
  const pairs = [
    [
      ...
      resolveHeadlineMetric(headline, platform, "repositoryHealthScore"),
    ],
    [
      "duplicateGroups",
      resolveHeadlineMetric(headline, platform, "duplicateGroups"),
    ],
    [
      "mergeCandidates",
      resolveHeadlineMetric(headline, platform, "mergeCandidates"),
    ],
    [
    ...
    [
      ...
      resolveHeadlineMetric(headline, platform, "reductionOpportunities"),
    ],
  ];
  return pairs.some(
    ([key, headlineVal]) =>
...
export function buildRepositoryHealthSummary(
  ...
  const headlineScopeNote = headlineMonorepoMetricsDiverge(
    headline,
    platform,
    monorepo,
  )
    ...
    : null;
  return {
    repositoryHealthScore: resolveHeadlineMetric(
      headline,
      platform,
      "repositoryHealthScore",
    ),
    platformHealthScore:
      (_a = platform.repositoryHealthScore) !== null && _a !== void 0
        ? _a
        : null,
    monorepoHealthScore: hasMonorepo
      ? (_b = monorepo.repositoryHealthScore) !== null && _b !== void 0
        ...
        : null
      : null,
    optimizationPotential: resolveHeadlineMetric(
      headline,
      platform,
    ...
    duplicateGroups: resolveHeadlineMetric(
      headline,
      platform,
      "duplicateGroups",
    ),
    oversizedFiles: resolveHeadlineMetric(headline, platform, "oversizedFiles"),
    reductionOpportunities: resolveHeadlineMetric(
      headline,
      platform,
      "reductionOpportunities",
    ),
    mergeCandidates: resolveHeadlineMetric(
      headline,
      platform,
      "mergeCandidates",
    ),
    repositoryFilesTotal: resolveHeadlineMetric(
      headline,
      platform,
      "repositoryFilesTotal",
    ),
    repositoryFoldersTotal: resolveHeadlineMetric(
      headline,
      platform,
    ...
    monorepoMergeCandidates: hasMonorepo
      ...
      : null,
    platformLastScan:
      (_e = platform.generatedAt) !== null && _e !== void 0 ? _e : null,
    ...
    lastScan:
      (_j =
        (_h =
          (_g = headline.lastScan) !== null && _g !== void 0
            ? _g
            : platform.generatedAt) !== null && _h !== void 0
          ? _h
    ...
    monorepoReportStatus:
      (_k = health.monorepoStatus) !== null && _k !== void 0
        ? _k
        : hasMonorepo
          ? "loaded"
          : null,
...
function sanitizeSnapshotExport(snapshot) {
  ...
  return {
    ...
    platformRoot: snapshot.platformRoot
      ? redactSnapshotPath(snapshot.platformRoot)
      : null,
    generatedAt:
      (_b = snapshot.generatedAt) !== null && _b !== void 0 ? _b : null,
    reportVersion:
      (_c = snapshot.reportVersion) !== null && _c !== void 0 ? _c : null,
    repositoryHealthScore:
      (_d = snapshot.repositoryHealthScore) !== null && _d !== void 0
        ? _d
        : null,
    optimizationPotential:
      (_e = snapshot.optimizationPotential) !== null && _e !== void 0
        ? _e
        : null,
    optimizationPotentialBytes:
      (_f = snapshot.optimizationPotentialBytes) !== null && _f !== void 0
        ? _f
        : null,
    duplicateGroups:
      (_g = snapshot.duplicateGroups) !== null && _g !== void 0 ? _g : null,
    mergeCandidates:
      (_h = snapshot.mergeCandidates) !== null && _h !== void 0 ? _h : null,
    oversizedFiles:
      (_j = snapshot.oversizedFiles) !== null && _j !== void 0 ? _j : null,
    reductionOpportunities:
      (_k = snapshot.reductionOpportunities) !== null && _k !== void 0
        ? _k
        : null,
    repositoryFilesTotal:
      (_l = snapshot.repositoryFilesTotal) !== null && _l !== void 0
        ? _l
        : null,
    repositoryFoldersTotal:
      (_m = snapshot.repositoryFoldersTotal) !== null && _m !== void 0
        ? _m
        : null,
    repositoryFilesAudited:
      (_o = snapshot.repositoryFilesAudited) !== null && _o !== void 0
        ? _o
        : null,
    jsonFilesAnalyzed:
      (_p = snapshot.jsonFilesAnalyzed) !== null && _p !== void 0 ? _p : null,
...
function sanitizeCandidatesExport(candidates = []) {
  ...
  return candidates.map((item) => {
    ...
    return {
      ...
      savingsLabel:
        (_c = item.savingsLabel) !== null && _c !== void 0 ? _c : null,
      savingsBytes:
        (_d = item.savingsBytes) !== null && _d !== void 0 ? _d : null,
      files: Array.isArray(item.files)
        ? item.files.map((f) => {
            ...
            return {
              ...
              sizeLabel:
                (_b = f.sizeLabel) !== null && _b !== void 0 ? _b : null,
            };
          })
        : [],
    };
...
function sanitizePreviewExport(preview) {
  ...
  return {
    ...
    safeToExecute:
      (_d = preview.safeToExecute) !== null && _d !== void 0 ? _d : null,
    executionMode:
      (_e = preview.executionMode) !== null && _e !== void 0 ? _e : null,
    riskAssessment: preview.riskAssessment
      ? {
          level:
            (_f = preview.riskAssessment.level) !== null && _f !== void 0
              ? _f
              : null,
          factors:
            (_g = preview.riskAssessment.factors) !== null && _g !== void 0
              ? _g
              : [],
        }
      : null,
...
function buildExportProvenance(
  health = {},
  { candidates, preview, candidatesScope } = {},
) {
  var _a, _b, _c, _d;
  ...
  if (Array.isArray(candidates) && candidates.length) {
    ...
    ((_b =
      (_a = health.monorepo) === null || _a === void 0
        ? void 0
        : _a.mergeCandidates) !== null && _b !== void 0
      ? _b
      : 0) > 0 ||
    ((_d =
      (_c = health.platform) === null || _c === void 0
        ? void 0
        : _c.mergeCandidates) !== null && _d !== void 0
      ? _d
      : 0) > 0
  ) {
  ...
  return {
    ...
    candidatesScope:
      Array.isArray(candidates) && candidates.length && candidatesScope
        ? candidatesScope
        : null,
  };
}
...
function buildExportNotes(
  ...
  return dedupeExportNotes(
    notes.map((line) => normalizeSimpleBeaconBranding(line)),
  );
}
/**
...
export function buildRepositoryHealthExportBundle({
  ...
  const summary = buildRepositoryHealthSummary(health || {}, {
    candidates,
    preview,
  });
  ...
  return {
    ...
    ...(sanitizedCandidates.length
      ? { mergeCandidates: sanitizedCandidates }
      : {}),
    ...
    ...(sanitizedCandidates.length && redactedCandidatesPath
      ...
      : {}),
    ...(sanitizedCandidates.length && candidatesScope
      ? { candidatesScope }
      : {}),
    provenance: buildExportProvenance(health || {}, {
      candidates,
      preview,
      candidatesScope,
    }),
 ...
 * @returns {any}
 */
export function buildRepositoryHealthCsv({
  summary,
  recommendations,
  platform,
  monorepo,
