...
function resolveRedactedBriefProjectPath(brief, options = {}) {
  ...
  const rawPath =
    options.projectPath ||
    brief.projectPath ||
    ((_a = brief.scanAnalysis) === null || _a === void 0 ? void 0 : _a.projectPath) ||
    '';
...
function resolveProjectedInventoryNote(next, auditFiles) {
  ...
  const safeFiles =
    (_e =
      (_b = (_a = next.estimatedReduction) === null || _a === void 0 ? void 0 : _a.files) !== null && _b !== void 0
        ? _b
        : (_d = (_c = next.tiers) === null || _c === void 0 ? void 0 : _c.safeNow) === null || _d === void 0
          ? void 0
  ...
  if (
    auditFiles != null &&
    ((_h = (_g = next.inventory) === null || _g === void 0 ? void 0 : _g.totalFiles) !== null && _h !== void 0
      ? _h
      : 0) >
      auditFiles * 2
  ) {
...
function duplicateStatsFromBrief(brief) {
  ...
  return {
    reclaimableBytes:
      (_c =
        (_b = fr === null || fr === void 0 ? void 0 : fr.duplicateAssetBytes) !== null && _b !== void 0
          ? _b
        ...
        : null,
    duplicateFiles:
      (_d = dupRow === null || dupRow === void 0 ? void 0 : dupRow.files) !== null && _d !== void 0 ? _d : null,
  };
}
/**
...
function pruneDuplicateAssetsForExport(groups = [], brief) {
  ...
  const withPaths = normalized.filter((g) => {
    var _a;
    return ((_a = g.duplicates) === null || _a === void 0 ? void 0 : _a.length) > 0 && g.keeper;
  });
  if (withPaths.length) {
...
function resolveArtifactProfileForExport(scanAnalysis = {}, tiers = {}, estimatedReduction = {}) {
  ...
  const investigate =
    (_c =
      (_b = (_a = tiers.investigate) === null || _a === void 0 ? void 0 : _a.files) !== null && _b !== void 0
        ? _b
        : fr.unusedFileCandidates) !== null && _c !== void 0
      ? _c
      : 0;
  const dupBytes =
    (_e = (_d = fr.duplicateAssetBytes) !== null && _d !== void 0 ? _d : fr.immediateSavingsBytes) !== null &&
    _e !== void 0
      ? _e
      : 0;
  const safeFiles =
  ...
  const hasFollowUp =
    investigate > 0 ||
    dupBytes > 0 ||
    ((_k = (_j = tiers.reviewFirst) === null || _j === void 0 ? void 0 : _j.files) !== null && _k !== void 0 ? _k : 0) >
      0;
...
function resolveCleanupStatus(brief) {
  ...
  const safeFiles =
    (_e =
      (_b = (_a = brief.estimatedReduction) === null || _a === void 0 ? void 0 : _a.files) !== null && _b !== void 0
        ? _b
        : (_d = (_c = brief.tiers) === null || _c === void 0 ? void 0 : _c.safeNow) === null || _d === void 0
          ? void 0
          : _d.files) !== null && _e !== void 0
      ? _e
      : 0;
  const dupBytes =
    (_g = (_f = brief.estimatedReduction) === null || _f === void 0 ? void 0 : _f.phase2DuplicateBytes) !== null &&
    _g !== void 0
      ? _g
      : 0;
  const investigate =
    (_k =
      (_j = (_h = brief.tiers) === null || _h === void 0 ? void 0 : _h.investigate) === null || _j === void 0
        ? void 0
...
function resolveFileReductionWorkspaceFiles(brief, options = {}) {
  ...
  return (_g =
    (_d =
      (_c =
        (_b = (_a = options.fileReductionReport) === null || _a === void 0 ? void 0 : _a.inventory) === null ||
        _b === void 0
          ? void 0
      ...
      ? _d
      : (_f = (_e = brief.scanAnalysis) === null || _e === void 0 ? void 0 : _e.fileReduction) === null || _f === void 0
        ? void 0
...
function resolveGateInventoryContext(brief, options = {}) {
  ...
  const credentialScanned =
    (_q =
      (_o =
        (_l = (_k = gateReport.credentialScanned) !== null && _k !== void 0 ? _k : gateReport.productionLeakScanned) !==
          null && _l !== void 0
          ? _l
  ...
  const contentScanned =
    (_z =
      (_x =
        (_w =
          (_t =
            (_s = (_r = gateReport.scanScope) === null || _r === void 0 ? void 0 : _r.fullDirectoryStats) === null ||
            _s === void 0
              ? void 0
              : _s.contentScanned) !== null && _t !== void 0
            ? _t
            : (_v = (_u = gateReport.scanScope) === null || _u === void 0 ? void 0 : _u.fullDirectoryStats) === null ||
                _v === void 0
              ? void 0
  ...
  const gateProfile =
    (_5 =
      (_3 =
        (_1 = (_0 = gateReport.scanScope) === null || _0 === void 0 ? void 0 : _0.profile) !== null && _1 !== void 0
          ? _1
  ...
  return {
    ...
    fictionSampleFilesScanned:
      (_16 =
        (_14 =
          (_12 =
            (_11 = gateReport.fictionSampleFilesScanned) !== null && _11 !== void 0
              ? _11
...
function buildCleanupBriefHygieneSummary(brief, options = {}) {
  ...
  return {
    ...
    explorerInventoryFiles:
      (_c = (_b = brief.inventory) === null || _b === void 0 ? void 0 : _b.totalFiles) !== null && _c !== void 0
        ? _c
        : null,
    ...
    phase1SafeDeleteFiles:
      (_h =
        (_e = (_d = brief.estimatedReduction) === null || _d === void 0 ? void 0 : _d.files) !== null && _e !== void 0
          ? _e
          : (_g = (_f = brief.tiers) === null || _f === void 0 ? void 0 : _f.safeNow) === null || _g === void 0
            ? void 0
            : _g.files) !== null && _h !== void 0
        ? _h
        : 0,
    phase1SafeDeleteBytes:
      (_o =
        (_k = (_j = brief.estimatedReduction) === null || _j === void 0 ? void 0 : _j.bytes) !== null && _k !== void 0
          ? _k
          : (_m = (_l = brief.tiers) === null || _l === void 0 ? void 0 : _l.safeNow) === null || _m === void 0
            ? void 0
            : _m.bytes) !== null && _o !== void 0
        ? _o
        : 0,
    phase2DuplicateBytes:
      (_q = (_p = brief.estimatedReduction) === null || _p === void 0 ? void 0 : _p.phase2DuplicateBytes) !== null &&
      _q !== void 0
        ? _q
        : 0,
    investigateFiles:
      (_t =
        (_s = (_r = brief.tiers) === null || _r === void 0 ? void 0 : _r.investigate) === null || _s === void 0
          ? void 0
    ...
    ((_u = brief.hygieneSummary) === null || _u === void 0 ? void 0 : _u.jestBaselineChecked) === false
...
function buildCleanupBriefScanScope(brief, options = {}) {
  ...
  const explorerFiles =
    (_b = (_a = brief.inventory) === null || _a === void 0 ? void 0 : _a.totalFiles) !== null && _b !== void 0
      ? _b
      : null;
  const frWorkspace = resolveFileReductionWorkspaceFiles(brief, options);
  const monorepoShells =
    repositoryFilesTotal != null && explorerFiles != null && explorerFiles > repositoryFilesTotal * 2;
  return {
    inventoryScope:
      ((_c = brief.inventory) === null || _c === void 0 ? void 0 : _c.inventoryScope) || 'platform-product',
...
function buildProductExportNotes(brief, options = {}) {
  ...
  const dqOpen = countDataQualityOpenFindings(
    ((_c = brief.scanAnalysis) === null || _c === void 0 ? void 0 : _c.dataQuality) || {}
  );
  ...
  const safeFiles =
    (_k =
      (_g = (_f = brief.estimatedReduction) === null || _f === void 0 ? void 0 : _f.files) !== null && _g !== void 0
        ? _g
        : (_j = (_h = brief.tiers) === null || _h === void 0 ? void 0 : _h.safeNow) === null || _j === void 0
          ? void 0
          : _j.files) !== null && _k !== void 0
      ? _k
      : 0;
  const safeBytes =
    (_q =
      (_m = (_l = brief.estimatedReduction) === null || _l === void 0 ? void 0 : _l.bytes) !== null && _m !== void 0
        ? _m
        : (_p = (_o = brief.tiers) === null || _o === void 0 ? void 0 : _o.safeNow) === null || _p === void 0
          ? void 0
  ...
  if (cleanupStatus === 'safe-delete-available' && safeFiles > 0) {
    ...
    String(((_r = brief.scanAnalysis) === null || _r === void 0 ? void 0 : _r.artifactProfile) || '').startsWith(
      'mixed'
    ) &&
  ...
  if (
    ((_t = (_s = brief.tiers) === null || _s === void 0 ? void 0 : _s.investigate) === null || _t === void 0
      ? void 0
      : _t.files) > 0
  ) {
    notes.push(
  ...
  if (
    ((_u = brief.estimatedReduction) === null || _u === void 0 ? void 0 : _u.phase2DuplicateBytes) > 0 &&
    ((_v = brief.duplicateAssets) === null || _v === void 0 ? void 0 : _v.length)
  ) {
    notes.push(
...
function enrichProductAgentPrompt(brief) {
  ...
  const investigate =
    (_b =
      (_a = tiers === null || tiers === void 0 ? void 0 : tiers.investigate) === null || _a === void 0
        ? void 0
...
function enrichProductAgentInstructions(brief) {
  ...
  const investigate =
    (_c =
      (_b = (_a = brief.tiers) === null || _a === void 0 ? void 0 : _a.investigate) === null || _b === void 0
        ? void 0
        : _b.files) !== null && _c !== void 0
      ? _c
      : 0;
  const dupBytes =
    (_e = (_d = brief.estimatedReduction) === null || _d === void 0 ? void 0 : _d.phase2DuplicateBytes) !== null &&
    _e !== void 0
      ? _e
      : 0;
  const lines = [
...
export function sanitizeCleanupBriefExport(brief, options = {}) {
    ...
    tiers: {
      ...
      duplicateConsolidation: dupStats.reclaimableBytes
        ? {
            ...
            note:
              ((_c = pruned.duplicateAssetsSummary) === null || _c === void 0 ? void 0 : _c.note) ||
    ...
    next.scanAnalysis = {
      ...
      ...(benchmarkScan
        ? {
            ...
            artifactProfile:
              next.scanAnalysis.artifactProfile === 'empty' ? 'oss-clone-hygiene' : next.scanAnalysis.artifactProfile,
          }
        : {}),
    };
  }
  if (!benchmarkScan) {
    ...
    const exportNotes = buildProductExportNotes(
      {
        ...
        inventory: {
          ...
          ...(auditFiles != null &&
          ((_e = (_d = next.inventory) === null || _d === void 0 ? void 0 : _d.totalFiles) !== null && _e !== void 0
            ? _e
            : 0) >
            auditFiles * 2
            ? {
    ...
    return {
      ...
      agentBriefReady: Boolean(
        ((_g = next.sourceScans) === null || _g === void 0 ? void 0 : _g.fileReductionPresent) ||
        ((_h = next.sourceScans) === null || _h === void 0 ? void 0 : _h.dataQualityPresent)
      ),
      securityHandoffEligible: false,
      ...
      inventory: {
        ...
        inventoryScope: 'platform-product',
        ...(auditFiles != null &&
        ((_k = (_j = next.inventory) === null || _j === void 0 ? void 0 : _j.totalFiles) !== null && _k !== void 0
          ? _k
          : 0) >
          auditFiles * 2
          ? {
  ...
  return {
    ...
    scanAnalysis: next.scanAnalysis ? { ...next.scanAnalysis, projectPath: redactedClonePath } : next.scanAnalysis,
