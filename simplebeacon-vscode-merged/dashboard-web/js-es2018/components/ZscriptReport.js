...
export function renderZscriptReportPanel(zscriptReport, options = {}) {
    ...
    const intensityCvars = ((_b = report.cvars) === null || _b === void 0 ? void 0 : _b.intensityCvars) || diagnosis.cvar_candidates || [];
...
export function buildZscriptConclusion(zscriptReport) {
    var _a;
    const report = (zscriptReport === null || zscriptReport === void 0 ? void 0 : zscriptReport.report) || zscriptReport;
    if (!((_a = report === null || report === void 0 ? void 0 : report.problem_diagnosis) === null || _a === void 0 ? void 0 : _a.problem))
        return '';
