...
function buildPreviewFindings(lastResult) {
    ...
    ((_b =
      (_a =
        lastResult === null || lastResult === void 0
          ? void 0
          : lastResult.steps) === null || _a === void 0
        ? void 0
  ...
  const codebase =
    ((_d =
      (_c =
        lastResult === null || lastResult === void 0
          ? void 0
          : lastResult.steps) === null || _c === void 0
        ? void 0
  ...
  const issues = [
    ...((simplebeacon === null || simplebeacon === void 0
      ? void 0
      : simplebeacon.rawIssues) ||
      (simplebeacon === null || simplebeacon === void 0
        ? void 0
        : simplebeacon.detectedIssues) ||
      []),
...
function buildTrustSignals(lastResult) {
  ...
  const simplebeacon =
    (_a = steps.find((s) => s.id === "simplebeacon")) === null || _a === void 0
      ...
      : _a.report;
  const codebase =
    (_b = steps.find((s) => s.id === "codebase")) === null || _b === void 0
      ? void 0
      : _b.scan;
  const repoInv =
    lastResult === null || lastResult === void 0
      ...
      (_e =
        (_c =
          repoInv === null || repoInv === void 0
            ? void 0
            : repoInv.totalFiles) !== null && _c !== void 0
          ? _c
          : (_d =
                codebase === null || codebase === void 0
                  ? void 0
                  : codebase.summary) === null || _d === void 0
            ? void 0
...
export function buildPublicSummaryFromScan(lastResult) {
  ...
  const gatePass =
    (_e =
      simplebeacon === null || simplebeacon === void 0
        ? void 0
        : simplebeacon.gate) === null || _e === void 0
      ? void 0
      : _e.pass;
  return {
    summary: {
        ...
        (_h =
          (_g =
            (_f =
              codebase === null || codebase === void 0
                ? void 0
                : codebase.summary) === null || _f === void 0
              ? void 0
          ...
          : null,
      status:
        gatePass === true ? "PASS" : gatePass === false ? "FAIL" : "REVIEW",
      ...
      qualityScore:
        (_j =
          simplebeacon === null || simplebeacon === void 0
            ? void 0
            : simplebeacon.qualityScore) !== null && _j !== void 0
          ? _j
          : null,
      codeHealth:
        (_l =
          (_k =
            codebase === null || codebase === void 0
              ? void 0
              : codebase.summary) === null || _k === void 0
            ? void 0
...
export function isDeliverableLocked(entitlements, lastResult) {
  ...
  if (
    entitlements === null || entitlements === void 0
      ? void 0
      : entitlements.publicGateLocked
  )
    return true;
  return Boolean(
    lastResult === null || lastResult === void 0
      ? void 0
      : lastResult.publicGateLocked,
  );
}
/**
 * Render scan paywall.
...
export function renderScanPaywall(publicSummary, options = {}) {
  ...
  const summary =
    (publicSummary === null || publicSummary === void 0
      ? void 0
      : publicSummary.summary) || {};
  const counts =
    (publicSummary === null || publicSummary === void 0
      ? void 0
      : publicSummary.severityCounts) || {};
  const previewFindings =
    (publicSummary === null || publicSummary === void 0
      ? void 0
      : publicSummary.previewFindings) || [];
  const trust =
    (publicSummary === null || publicSummary === void 0
      ? void 0
      : publicSummary.trustSignals) || {};
  ...
  const total =
    (_a = summary.totalIssuesFound) !== null && _a !== void 0 ? _a : "—";
  const hasCritical =
    ((_b = counts.critical) !== null && _b !== void 0 ? _b : 0) > 0;
