 ...
 * @returns {((...args: any[]) => any) & {cancel:()=>void,flush:()=>void,pending:()=>boolean}} Debounced function with `.cancel()`, `.flush()`, and `.pending()` methods.
 */
...
/**
 * Throttle a function so it executes at most once per `limit` milliseconds.
 * The final pending call is flushed after the cooldown expires.
 * @param {(...args: any[]) => any} fn Function to throttle.
 * @param {number} [limit=300] Minimum time between invocations in milliseconds.
 * @returns {((...args: any[]) => any) & {cancel:()=>void,flush:()=>void,pending:()=>boolean}} Throttled function with `.cancel()`, `.flush()`, and `.pending()` methods.
 */
 ...
 * @param {(...args: any[]) => any} fn Function to wrap.
 ...
 * @param {(...args: any[]) => any} fn Function to debounce.
 * @param {number} [wait=300] Delay in milliseconds.
 * @returns {((...args: any[]) => any) & {cancel:()=>void,flush:()=>void,pending:()=>boolean}} Debounced function with `.cancel()` method.
 */
 ...
 * @param {(...args: any[]) => any} fn Function to memoize.
 * @param {number} [maxSize=1000] Maximum cache entries before LRU eviction.
 * @returns {((...args: any[]) => any) & {clear:()=>void}} Memoized function.
 */
