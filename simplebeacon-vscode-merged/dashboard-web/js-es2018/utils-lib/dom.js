...
export function requestNotificationPermission() {
    ...
    } catch (_) { console.error('Failed to request notification permission:', _); }
...
export function showOSNotification(title, body) {
    ...
    } catch (_) { console.error('Failed to show OS notification:', _); }
    return false;
}
...
export function setNotificationsEnabled(enabled) {
    ...
    } catch (_) { console.error('Failed to set notifications enabled state:', _); }
}
