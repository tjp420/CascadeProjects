    ...
    _vsCodeProxyCache = {
      postMessage(msg) {
        try {
          ...
          console.error('Failed to post message to parent for VS Code proxy:', _b);
        }
      },
    };
  }
...
export function requestNotificationPermission() {
  try {
    ...
    console.error('Failed to request notification permission:', _);
  }
...
export function showOSNotification(title, body) {
  try {
    ...
    console.error('Failed to show OS notification:', _);
  }
  return false;
}
...
export function setNotificationsEnabled(enabled) {
  try {
    ...
    console.error('Failed to set notifications enabled state:', _);
  }
}
