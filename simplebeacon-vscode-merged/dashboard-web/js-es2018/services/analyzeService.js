...
function normalizeScanReport(rawReport) {
  ...
  const repositoryFilesTotal =
    rawReport.repositoryFilesTotal ?? repositoryInventory?.totalFiles ?? summary.repositoryFilesTotal ?? null;
  const repositoryFoldersTotal =
    rawReport.repositoryFoldersTotal ?? repositoryInventory?.totalFolders ?? summary.repositoryFoldersTotal ?? null;
  const ruleScopedFilesAnalyzed = rawReport.ruleScopedFilesAnalyzed ?? summary.ruleScopedFilesAnalyzed ?? null;
  const codeFilesAnalyzed = summary.codeFilesAnalyzed ?? summary.codeFilesDiscovered ?? rawReport.filesAnalyzed ?? null;
...
export async function ensureDashboardApiReady() {
  ...
  try {
    probeRes = await fetchWithTimeout(
      resolveApiUrl('/api/simplebeacon/config'),
      {
...
async function fetchJsonWithGuidance(target, options = {}, timeoutMs = 0) {
  ...
  let res;
  try {
    res = timeoutMs > 0 ? await fetchWithTimeout(fullUrl, options, timeoutMs) : await fetch(fullUrl, options);
  } catch (error) {
...
export async function patchProvidersFromSavedAiKeys(data) {
  var _a;
  if (
    !((_a = data === null || data === void 0 ? void 0 : data.providers) === null || _a === void 0 ? void 0 : _a.length)
  )
    return data;
    ...
    return {
      ...
      fileReductionPlan: report.fileReductionPlan
        ? {
            ...
            safeToDelete: {
              topDirectories: (
                ((_a = report.fileReductionPlan.safeToDelete) === null || _a === void 0 ? void 0 : _a.topDirectories) ||
                []
              ).slice(0, 8),
            },
            unusedFiles: {
              candidates:
                (_c =
                  (_b = report.fileReductionPlan.unusedFiles) === null || _b === void 0 ? void 0 : _b.candidates) !==
                  null && _c !== void 0
                  ? _c
                  : null,
            },
      ...
      executiveSummary: report.executiveSummary
        ? {
            ...
            security: {
              piiNeedingReview:
                (_e =
                  (_d = report.executiveSummary.security) === null || _d === void 0 ? void 0 : _d.piiNeedingReview) !==
                  null && _e !== void 0
                  ? _e
                  : null,
              credentialsNeedingReview:
                (_g =
                  (_f = report.executiveSummary.security) === null || _f === void 0
                    ? void 0
    ...
    ? {
        ...
        tiers: {
          safeNow: ((_b = results.cleanupAssistant.tiers) === null || _b === void 0 ? void 0 : _b.safeNow)
            ...
            : null,
          investigate:
            ((_c = results.cleanupAssistant.tiers) === null || _c === void 0 ? void 0 : _c.investigate) || null,
        },
            ...
            codeAnalysis: results.roadmap.codeAnalysis
              ? {
                  structure: {
                    totalFiles:
                      (_h =
                        (_g = results.roadmap.codeAnalysis.structure) === null || _g === void 0
                          ? void 0
                    ...
                    languages:
                      (_k =
                        (_j = results.roadmap.codeAnalysis.structure) === null || _j === void 0
                          ? void 0
  ...
  if (exportPayload.type === 'data-cleanup-report') {
    ...
    return {
      ...
      summary: {
        scanKind: profile,
        dataQualityFindings:
          (_c = (_b = exportPayload.summary) === null || _b === void 0 ? void 0 : _b.totalFindings) !== null &&
          _c !== void 0
            ? _c
            : null,
        fileReductionFindings:
          (_e = (_d = exportPayload.summary) === null || _d === void 0 ? void 0 : _d.totalFindings) !== null &&
          _e !== void 0
            ? _e
            : null,
      },
...
function gatePassFromExportScan(normalized) {
  ...
  const fromGate =
    (_b = (_a = results.simplebeacon) === null || _a === void 0 ? void 0 : _a.gate) === null || _b === void 0
      ? void 0
      : _b.pass;
  if (fromGate === true || fromGate === false) return fromGate;
  const fromSummary =
    (_c = normalized === null || normalized === void 0 ? void 0 : normalized.summary) === null || _c === void 0
      ? void 0
...
function codeFilesFromExportScan(normalized) {
  ...
  const value =
    (_c =
      (_b =
        (_a = normalized === null || normalized === void 0 ? void 0 : normalized.results) === null || _a === void 0
          ? void 0
...
function detectSupplementaryExportStep(normalized) {
  ...
  const results = (normalized === null || normalized === void 0 ? void 0 : normalized.results) || {};
  const scanKind =
    (_a = normalized === null || normalized === void 0 ? void 0 : normalized.summary) === null || _a === void 0
      ? void 0
      : _a.scanKind;
...
export async function fetchCompleteAuditReport(completeScan, options = {}) {
  ...
  const res = await fetchWithTimeout(
    resolveApiUrl('/api/analyze/complete-audit-report'),
    {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
...
export async function fetchEuAiActAuditReport(options = {}) {
  ...
  const res = await fetchWithTimeout(
    resolveApiUrl('/api/analyze/eu-ai-act-audit-report'),
    {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
...
export async function fetchAnalyzeExportBundleZip(completeScan, options = {}) {
  ...
  const timeoutMs = (_b = options.timeoutMs) !== null && _b !== void 0 ? _b : 300000;
  const res = await fetchWithTimeout(
    resolveApiUrl('/api/analyze/export-bundle'),
    {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
...
export async function fetchCodebaseAnalysis(projectPath, options = {}) {
  ...
  const timeoutMs =
    (_a = options.timeoutMs) !== null && _a !== void 0 ? _a : options.context === 'complete' ? 900000 : 600000;
  const data = await fetchJsonWithGuidance(
...
export async function fetchDataCleanupScan(projectPath, options = {}) {
  ...
  try {
    ...
    if (profile === 'file-reduction') {
      const hasSignal =
        ((_c = (_b = scan.fileReductionPlan) === null || _b === void 0 ? void 0 : _b.totals) === null || _c === void 0
          ? void 0
          : _c.safeToDeleteBytes) != null ||
        ((_f =
          (_e = (_d = scan.fileReductionPlan) === null || _d === void 0 ? void 0 : _d.safeToDelete) === null ||
          _e === void 0
            ? void 0
            : _e.topDirectories) === null || _f === void 0
          ? void 0
          : _f.length) ||
        ((_h = (_g = scan.scanners) === null || _g === void 0 ? void 0 : _g['build-artifacts']) === null ||
        _h === void 0
          ? void 0
...
export function scanHintsGameMod(scan) {
  ...
  return insights.some((item) => {
    ...
    const domains =
      ((_d =
        (_c =
          (_b = (_a = item.understanding) === null || _a === void 0 ? void 0 : _a.layers) === null || _b === void 0
            ? void 0
        ...
        : _d.domains) ||
      ((_g =
        (_f = (_e = item.understanding) === null || _e === void 0 ? void 0 : _e.layers) === null || _f === void 0
          ? void 0
...
export async function refreshPathInventory(app, projectPath, options = {}) {
  ...
  if (!path || isRemoteRepoUrl(path) || shouldClearHostedServerDefaultPath(path)) {
    if (app === null || app === void 0 ? void 0 : app.state) app.state.pathInventory = null;
    return null;
  }
  ...
  const promise = (async () => {
    try {
      ...
      if (
        (inventory === null || inventory === void 0 ? void 0 : inventory.totalFiles) != null &&
        isInventoryRootAligned(path, root)
      ) {
        const entry = { path, inventory, fetchedAt: Date.now() };
        if (app === null || app === void 0 ? void 0 : app.state) app.state.pathInventory = entry;
        return inventory;
      }
    } catch (_a) {
...
export function liveInventoryForPath(app, projectPath) {
  var _a;
  const cached =
    (_a = app === null || app === void 0 ? void 0 : app.state) === null || _a === void 0 ? void 0 : _a.pathInventory;
  if (!(cached === null || cached === void 0 ? void 0 : cached.inventory) || !projectPath) return null;
...
export function buildPathInventoryProvenance(app, projectPath, report = null) {
  ...
  return buildInventoryProvenance(resolvedReport, projectPath, {
    ...
    inventoryFetchedAt:
      (_a = live === null || live === void 0 ? void 0 : live.fetchedAt) !== null && _a !== void 0 ? _a : null,
  });
}
/**
...
export function mergeReportInventory(report, inventory) {
  ...
  if (!report || typeof report !== 'object') return report;
  if (!(inventory === null || inventory === void 0 ? void 0 : inventory.totalFiles)) return report;
  const repoFiles =
    report.repositoryFilesTotal === 0 || report.repositoryFilesTotal === 1
      ? inventory.totalFiles
      : (report.repositoryFilesTotal ?? inventory.totalFiles);
  const repoFolders =
    report.repositoryFoldersTotal === 0 || report.repositoryFoldersTotal === 1
      ? (inventory.totalFolders ?? 0)
      : (report.repositoryFoldersTotal ?? inventory.totalFolders);
  const normalizedTotalFiles =
    report.totalFiles === 0 || report.totalFiles === 1 ? inventory.totalFiles : report.totalFiles;
  const normalizedFilesAnalyzed =
    report.filesAnalyzed === 0 || report.filesAnalyzed === 1 ? repoFiles : report.filesAnalyzed;
  const normalizedRuleScoped =
    report.ruleScopedFilesAnalyzed === 0 || report.ruleScopedFilesAnalyzed === 1
  ...
  return {
    ...
    repositoryInventory:
      ((_a = report.repositoryInventory) === null || _a === void 0 ? void 0 : _a.totalFiles) != null
...
export async function fetchScanReport(projectPath) {
  ...
  try {
    res = await fetchWithTimeout(
      resolveApiUrl(`/api/simplebeacon/report${params}`),
      {
        headers: authService.getAuthHeaders(),
      },
      30000
...
export function convertSandboxReportToSimplebeacon(report, projectPath) {
  ...
  const severityCounts = rawIssues.reduce(
    (acc, issue) => {
...
export function isClientScanReport(report) {
  return Boolean(
    report &&
    (report.scanSource === 'browser-sandbox' || report.scanSource === 'browser-local' || report.clientScan === true)
  );
}
  ...
  if (analyze && typeof analyze.resolveResultsReport === 'function') {
    ...
    if (issueList.length) {
      const prepared = preparePlatformResultsReport(
        typeof analyze.prepareReportForResults === 'function' ? analyze.prepareReportForResults(resolved) : resolved
      );
...
export function preparePlatformResultsReport(report) {
  ...
  const walkedFiles =
    (_h = (_g = report.ruleScopedFilesAnalyzed) !== null && _g !== void 0 ? _g : report.totalFiles) !== null &&
    _h !== void 0
      ? _h
      : 0;
  const fullTree = Boolean(
    report.fullDirectoryScan || ((_j = report.scanScope) === null || _j === void 0 ? void 0 : _j.fullDirectoryScan)
  );
  ...
  const highCount = platformIssues
    .filter(
      (issue) =>
        (issue.severityBand || issue.severity) === 'high' || (issue.severityBand || issue.severity) === 'critical'
    )
    .reduce((sum, issue) => sum + (issue.count || 1), 0);
...
export function resolveCompleteScanTargetPath(projectPath, priorSteps = []) {
  ...
  const report =
    (_a = priorSteps.find((step) => (step === null || step === void 0 ? void 0 : step.id) === 'simplebeacon')) ===
      null || _a === void 0
      ? void 0
      : _a.report;
...
export async function enrichScanReport(report, projectPath) {
  ...
  let inventory =
    ((_a = merged.repositoryInventory) === null || _a === void 0 ? void 0 : _a.totalFiles) != null
...
export function buildInventoryProvenance(report, requestedPath, options = {}) {
  ...
  if (
    ...
    !requested &&
    !(liveInventory === null || liveInventory === void 0 ? void 0 : liveInventory.totalFiles)
  )
    return null;
  const reportInventory =
    ((_a = report === null || report === void 0 ? void 0 : report.repositoryInventory) === null || _a === void 0
      ? void 0
      : _a.totalFiles) != null
      ? report.repositoryInventory
      : null;
  const reportRoot =
    (_e =
      (_d =
        (_c =
          (_b = reportInventory === null || reportInventory === void 0 ? void 0 : reportInventory.projectRoot) !==
            null && _b !== void 0
            ? _b
  ...
  const liveRoot =
    (liveInventory === null || liveInventory === void 0 ? void 0 : liveInventory.projectRoot) || requested || null;
  const liveAligned = Boolean(
    (liveInventory === null || liveInventory === void 0 ? void 0 : liveInventory.totalFiles) != null &&
  ...
  const inventoryRoot =
    (_h =
      (_g =
        (_f = inventory === null || inventory === void 0 ? void 0 : inventory.projectRoot) !== null && _f !== void 0
          ? _f
          : reportAligned
            ? reportRoot
            : null) !== null && _g !== void 0
  ...
  const files =
    (_j = inventory === null || inventory === void 0 ? void 0 : inventory.totalFiles) !== null && _j !== void 0
      ? _j
      : reportAligned
        ? (_k = report === null || report === void 0 ? void 0 : report.repositoryFilesTotal) !== null && _k !== void 0
          ? _k
        ...
        : null;
  const folders =
    (_l = inventory === null || inventory === void 0 ? void 0 : inventory.totalFolders) !== null && _l !== void 0
      ? _l
      : reportAligned
        ? (_m = report === null || report === void 0 ? void 0 : report.repositoryFoldersTotal) !== null && _m !== void 0
          ? _m
          : reportInventory === null || reportInventory === void 0
            ? void 0
  ...
  const ruleScoped = reportAligned
    ? (_q =
        (_o = report === null || report === void 0 ? void 0 : report.ruleScopedFilesAnalyzed) !== null && _o !== void 0
          ? _o
          : (_p = report === null || report === void 0 ? void 0 : report.scanScope) === null || _p === void 0
            ? void 0
  ...
  const generatedAt = reportAligned
    ? (_r = report === null || report === void 0 ? void 0 : report.generatedAt) !== null && _r !== void 0
      ? _r
      : null
    : null;
  ...
  return {
    ...
    stale:
      reportStale ||
      (Boolean((report === null || report === void 0 ? void 0 : report.generatedAt) && requested && reportRoot) &&
        !reportAligned),
    hasReport: reportAligned,
    liveInventory:
      liveAligned &&
      Boolean((liveInventory === null || liveInventory === void 0 ? void 0 : liveInventory.totalFiles) != null),
    inventoryFetchedAt: (_s = options.inventoryFetchedAt) !== null && _s !== void 0 ? _s : null,
    reportMisaligned: Boolean(
      (report === null || report === void 0 ? void 0 : report.generatedAt) && requested && reportRoot && !reportAligned
    ),
  };
}
/**
...
export function isHostedBrowserScanPath(projectPath) {
  const path = String(projectPath || '').trim();
  if (!path || isRemoteRepoUrl(path) || !isRemoteHostedDashboard()) return false;
...
export function isLegacyScanReport(report, projectPath = '') {
  ...
  if (normalized.reportVersion == null || normalized.reportVersion < 2) return true;
  ...
  if (normalized.scanSource === 'browser-local' || normalized.scanSource === 'browser-sandbox') {
    ...
    if (!root || !projectPath || isHostedServerDefaultPath(projectPath)) return false;
    if (isRemoteHostedDashboard()) {
      ...
      if (isLocalPath(projectPath) && !projectPathMatchesReportRoot(projectPath, root)) {
        ...
        if (pathBase && rootBase && pathBase.toLowerCase() === rootBase.toLowerCase()) return false;
      }
    }
  ...
  if (projectPathMatchesReportRoot(projectPath, normalized.projectRoot)) return false;
...
export function getScanFileMetrics(report, options = {}) {
  ...
  if (!report || typeof report !== 'object') {
    return {
      ...
      repositoryFiles:
        (_a = inventory === null || inventory === void 0 ? void 0 : inventory.totalFiles) !== null && _a !== void 0
          ? _a
          : null,
      repositoryFolders:
        (_b = inventory === null || inventory === void 0 ? void 0 : inventory.totalFolders) !== null && _b !== void 0
          ? _b
          : null,
      repositoryRoot:
        (_c = inventory === null || inventory === void 0 ? void 0 : inventory.projectRoot) !== null && _c !== void 0
          ? _c
          : null,
    };
  }
  if (normalizedReport.type === 'file-merger-reduction-report') {
    const sampleDataFiles =
      (_g =
        (_e = (_d = normalizedReport.summary) === null || _d === void 0 ? void 0 : _d.sampleDataFilesAnalyzed) !==
          null && _e !== void 0
          ? _e
    ...
    const repoFiles =
      (_o =
        (_l =
          (_j = (_h = normalizedReport.summary) === null || _h === void 0 ? void 0 : _h.repositoryFilesTotal) !==
            null && _j !== void 0
            ? _j
            : (_k = normalizedReport.repositoryInventory) === null || _k === void 0
              ? void 0
    ...
    return {
      ...
      jsonFilesAnalyzed:
        (_q = (_p = normalizedReport.summary) === null || _p === void 0 ? void 0 : _p.jsonFilesAnalyzed) !== null &&
        _q !== void 0
          ? _q
          : null,
      credentialScanned: null,
      ...
      repositoryFolders:
        (_u =
          (_s = (_r = normalizedReport.summary) === null || _r === void 0 ? void 0 : _r.repositoryFoldersTotal) !==
            null && _s !== void 0
            ? _s
            : (_t = normalizedReport.repositoryInventory) === null || _t === void 0
              ? void 0
              : _t.totalFolders) !== null && _u !== void 0
          ? _u
          : null,
      repositoryRoot:
        (_w = (_v = normalizedReport.repositoryInventory) === null || _v === void 0 ? void 0 : _v.projectRoot) !==
          null && _w !== void 0
          ? _w
          : null,
    };
  ...
  return {
    ...
    fictionJsonFilesScanned:
      (_4 =
        (_2 = normalizedReport.fictionJsonFilesScanned) !== null && _2 !== void 0
          ? _2
    ...
    repositoryRoot:
      (_11 =
        (_9 = inventory === null || inventory === void 0 ? void 0 : inventory.projectRoot) !== null && _9 !== void 0
          ? _9
          : (_10 = normalizedReport.repositoryInventory) === null || _10 === void 0
            ? void 0
...
export function resolveDisplayScore(report) {
  ...
  return (_c =
    (_b = (_a = report.consistencyScore) !== null && _a !== void 0 ? _a : report.schemaCompliance) !== null &&
    _b !== void 0
      ? _b
...
export function shouldPreferLiveReport(cachedReport, liveReport) {
  if (!(liveReport === null || liveReport === void 0 ? void 0 : liveReport.generatedAt)) return false;
  if (!(cachedReport === null || cachedReport === void 0 ? void 0 : cachedReport.generatedAt)) return true;
...
export function resolveJestTestsLabel(baseline, dashboardHome, report) {
  if (baseline === null || baseline === void 0 ? void 0 : baseline.jestTestsLabel) return baseline.jestTestsLabel;
  const jestSummary = report === null || report === void 0 ? void 0 : report.jestSummary;
  if (
    (jestSummary === null || jestSummary === void 0 ? void 0 : jestSummary.testsPassed) != null &&
  ...
  if (
    (overview === null || overview === void 0 ? void 0 : overview.passedTests) != null &&
    (overview === null || overview === void 0 ? void 0 : overview.totalTests) != null
  ) {
...
export function resolvePageSpecsLabel(report, baseline) {
  ...
  return (_b = baseline === null || baseline === void 0 ? void 0 : baseline.pageSamplesLabel) !== null && _b !== void 0
    ? _b
    : null;
}
/**
...
export function hydrateDashboardHome(home, baseline) {
  ...
  const jestPassing =
    (_a = baseline === null || baseline === void 0 ? void 0 : baseline.jestTestsPassing) !== null && _a !== void 0
      ? _a
      : (_b = home === null || home === void 0 ? void 0 : home.overview) === null || _b === void 0
        ? void 0
        : _b.passedTests;
  const suites =
    (_c = baseline === null || baseline === void 0 ? void 0 : baseline.jestSuites) !== null && _c !== void 0
      ? _c
      : (_d = home === null || home === void 0 ? void 0 : home.overview) === null || _d === void 0
        ? void 0
        : _d.testSuites;
...
export function resolveReportIssues(report) {
  ...
  let issues = [];
  const primary =
    normalized.rawIssues && normalized.rawIssues.length ? normalized.rawIssues : normalized.detectedIssues || [];
  if (primary.length) issues = primary.map(normalizeDashboardIssue).filter(Boolean);
  if (!issues.length) {
    const fromCategories = flattenCategoryFindings(normalized.categories);
    if (fromCategories.length) issues = fromCategories.map(normalizeDashboardIssue).filter(Boolean);
  }
  ...
  if (!issues.length && report.gate) {
    ...
    if (gateIssues.length) issues = gateIssues.map(normalizeDashboardIssue).filter(Boolean);
  }
...
export function buildScanConclusion(report, options = {}) {
  ...
  if (focus === 'fiction' || focus === 'all') {
    if (fiction.length) {
      ...
      const sampleScanned =
        (_k = report.fictionSampleFilesScanned) !== null && _k !== void 0 ? _k : report.mockSampleFiles;
      if (jsonScanned != null) {
        parts.push(
  ...
  const jestNote =
    ...
    ((_q = report.scanScope) === null || _q === void 0 ? void 0 : _q.jestExecutedDuringScan) === false
  ...
  if (focus === 'fiction') {
    ...
    const inventoryBrief =
      repoFiles != null && ruleScoped != null
        ...
        : '';
    const fictionScope =
      ((_t = (_s = report.scanScope) === null || _s === void 0 ? void 0 : _s.limitations) === null || _t === void 0
        ? void 0
  ...
  const scope =
    ((_v = (_u = report.scanScope) === null || _u === void 0 ? void 0 : _u.limitations) === null || _v === void 0
      ? void 0
      : _v[0]) ||
...
export async function fetchComplianceChecklist(report, projectPath, options = {}) {
  ...
  const checklistHttpResponse = await fetchWithTimeout(
    resolveApiUrl('/api/analyze/compliance-checklist'),
    {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
...
export function assertCompleteScanComplianceFresh(report, checklist) {
  if (!(checklist === null || checklist === void 0 ? void 0 : checklist.evaluatedAt)) return;
...
export function assertCompleteScanFileReductionFresh(scan) {
  ...
  const hasSignal =
    ((_b = (_a = scan.fileReductionPlan) === null || _a === void 0 ? void 0 : _a.totals) === null || _b === void 0
      ? void 0
      : _b.safeToDeleteBytes) != null ||
    ((_e =
      (_d = (_c = scan.fileReductionPlan) === null || _c === void 0 ? void 0 : _c.safeToDelete) === null ||
      _d === void 0
        ? void 0
        : _d.topDirectories) === null || _e === void 0
      ? void 0
      : _e.length) ||
    ((_g = (_f = scan.scanners) === null || _f === void 0 ? void 0 : _f['build-artifacts']) === null || _g === void 0
      ? void 0
