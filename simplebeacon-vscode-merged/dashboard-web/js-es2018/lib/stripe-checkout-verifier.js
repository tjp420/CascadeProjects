...
export function applyCheckoutMetadata(metadata) {
    ...
    if (licenseToken) {
        ...
        ((_a = authService.setToken) === null || _a === void 0 ? void 0 : _a.call(authService, licenseToken)) || ((_b = authService.bindTokenToAccount) === null || _b === void 0 ? void 0 : _b.call(authService, licenseToken, 'checkout'));
        syncTokenToExtensionHost(licenseToken);
    }
    else if (subscription === null || subscription === void 0 ? void 0 : subscription.apiToken) {
...
export async function verifyCheckoutSessionWithGrace(sessionId, options = {}) {
    ...
    showToast('Payment confirmed by Stripe. Your account will activate automatically in the background.', 'info');
    return lastResult;
}
/**
