...
!(function (t, n) {
  ...
  function d(t) {
    return function (n, e, r = e) {
      ...
      return (
        u && c
          ? (p(u, f, i, o, a), p(u, i, f, o, a), p(u, f, i, o, a), g(c, i, f, o, a), g(c, f, i, o, a), g(c, i, f, o, a))
          : u
  ...
  Vn.prototype = Wn.prototype = {
    ...
    attr: function (t, n) {
      ...
      return this.each(
        (null == n ? (e.local ? fn : cn) : 'function' == typeof n ? (e.local ? dn : hn) : e.local ? ln : sn)(e, n)
      );
    },
  ...
  function Li(t, n, e, r, i, o) {
    ...
    !(function (t, n, e) {
      ...
      function a(o) {
        ...
        for (f in i)
          if ((h = i[f]).name === e.name) {
            ...
            h.state === Oi
              ? ((h.state = Yi), h.timer.stop(), h.on.call('interrupt', t, t.__data__, h.index, h.group), delete i[f])
              : +f < n &&
                ((h.state = Yi), h.timer.stop(), h.on.call('cancel', t, t.__data__, h.index, h.group), delete i[f]);
          }
        if (
          ($i(function () {
      ...
      function u(n) {
        for (
          var i = n < e.duration ? e.ease.call(null, n / e.duration) : (e.timer.restart(c), (e.state = Bi), 1),
            o = -1,
            a = r.length;
          ++o < a;
        )
              ...
              .on(
                ...
                function (t) {
                  switch (t.keyCode) {
                    ...
                    case 18:
                      m === ra &&
                        (x < 0 ? (l = h) : x > 0 && (i = a), w < 0 ? (d = p) : w > 0 && (u = c), (m = ea), I(t));
                      break;
                    case 32:
                      m === na &&
                        (t.altKey
                          ? (x && ((l = h - C * x), (i = a + C * x)), w && ((d = p - P * w), (u = c + P * w)), (m = ra))
      ...
      (l.prototype = {
        ...
        emit: function (n, e, r) {
          ...
          a.call(
            n,
            this.that,
            new Qo(n, { sourceEvent: e, target: c, selection: t.output(this.state.selection), mode: r, dispatch: a }),
            i
          );
        },
      }),
  ...
  function Wa(t) {
    ...
    function f() {
      ...
      if (
        (c || (c = f = Ia()),
        h > Ca &&
          (Ma(y - g) > 2 * h + Ca ? (y > g ? ((g += h), (y -= h)) : ((g -= h), (y += h))) : (g = y = (g + y) / 2),
          Ma(b - _) > 2 * h + Ca ? (b > _ ? ((_ += h), (b -= h)) : ((_ -= h), (b += h))) : (_ = b = (_ + b) / 2)),
    ...
    _clipSegment(t, n, e, r, i, o) {
      ...
      for (a && ([t, n, e, r, i, o] = [e, r, t, n, o, i]); ;) {
        ...
        (8 & f
          ...
          i ? ((t = u), (n = c), (i = this._regioncode(t, n))) : ((e = u), (r = c), (o = this._regioncode(e, r))));
      }
    }
  ...
  ((qd.invert = function (t, n) {
    for (
      ...
      ((o =
        (i =
          (r -= e = (r * (zd + $d * i + o * (Dd + Rd * i)) - n) / (zd + 3 * $d * i + o * (7 * Dd + 9 * Rd * i))) * r) *
        i *
        i),
      !(xf(e) < pf));
      ++a
    ...
    return (
      ...
      (e.tickFormat = (n, r) => {
        if (
          (null == n && (n = 10),
          null == r && (r = 10 === a ? 's' : ','),
          'function' != typeof r && (a % 1 || null != (r = Jc(r)).precision || (r.trim = !0), (r = t.format(r))),
          n === 1 / 0)
        )
          return r;
  ...
  function Lg(t) {
    ...
    return (
      (n.exponent = function (n) {
        return arguments.length ? (1 === (e = +n) ? t(mg, mg) : 0.5 === e ? t(Bg, Yg) : t(Og(e), Og(1 / e))) : e;
      }),
      Ng(n)
    );
  }
  ...
  ((Tw.prototype = ww.prototype),
    ...
    (t.forceManyBody = function () {
      ...
      function h(t, o, f, s) {
        ...
        if (!(t.length || p >= u)) {
          (t.data !== n || t.next) &&
            (0 === l && (p += (l = Uc(e)) * l), 0 === h && (p += (h = Uc(e)) * h), p < a && (p = Math.sqrt(a * p)));
          do {
      ...
      if (((Qf = Kf = -(Wf = Zf = 1 / 0)), (is = []), Lf(t, Fs), (e = is.length))) {
        for (is.sort(Hs), n = 1, o = [(r = is[0])]; n < e; ++n)
          Xs(r, (i = is[n])[0]) || Xs(r, i[1])
            ? (js(r[0], i[1]) > js(r[0], r[1]) && (r[1] = i[1]), js(i[0], r[1]) > js(r[0], r[1]) && (r[0] = i[0]))
            : o.push((r = i));
    ...
    (t.geoCentroid = function (t) {
      ...
      var n = +Ns,
        ...
        r = +Cs,
        i = Ef(n, e, r);
      return i < pf && ((n = As), (e = Ss), (r = Es), xs < df && ((n = ws), (e = Ms), (r = Ts)), (i = Ef(n, e, r)) < pf)
        ? [NaN, NaN]
        : [Mf(e, n) * bf, Rf(r / i) * bf];
    }),
        ...
        n.parent.A = (function (n, e, r) {
          if (e) {
            for (
              ...
              ((c = Dp(c)),
                ((a = Rp(a)).a = n),
                (i = u.z + l - o.z - f + t(u._, o._)) > 0 && (Fp(qp(u, n, r), n, i), (f += i), (s += i)),
                (l += u.m),
                (f += o.m),
                (h += c.m),
                (s += a.m));
