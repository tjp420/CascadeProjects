...
const commandQueue = [];
function queueCommand(data) { commandQueue.push({ ...data, timestamp: Date.now() }); while (commandQueue.length > 100) commandQueue.shift(); }
...
const server = http.createServer((req, res) => {
  ...
  if (parsed.pathname === '/welcome') {
    ...
    res.end('<!DOCTYPE html><html><head><title>Welcome</title><style>body{font-family:sans-serif;background:#0f172a;color:#e2e8f0;display:flex;align-items:center;justify-content:center;height:100vh;margin:0}h1{font-weight:400}</style></head><body><h1>SimpleBeacon Dashboard</h1></body></html>');
    return;
  }
