...
[![Version](https://img.shields.io/badge/version-3.0.347-blue.svg)](https://github.com/simplebeacon/simplebeacon-vscode)
...
```json
{
  ...
  "simplebeacon.excludePatterns": ["node_modules", ".git", "dist", "build", ".vscode", ".simplebeacon"]
}
```
