...
const SEVERITY_MATRIX: Record<string, Partial<Record<FileRole, Severity>>> = {
  ...
  'secret-password': {
    app: 'error', config: 'error', infra: 'error',
    test: 'info', sample: 'info',
    docs: 'suppressed', generated: 'suppressed', vendor: 'suppressed',
  },
  'secret-api-key': {
    app: 'error', config: 'error', infra: 'error',
    test: 'info', sample: 'info',
  ...
  'weak-crypto-hash': {
    app: 'warning', config: 'warning', infra: 'warning',
    test: 'info', sample: 'info',
    docs: 'suppressed', generated: 'suppressed', vendor: 'suppressed',
  },
  'weak-crypto-random': {
  ...
  // ─── TODO / FIXME ───
  'todo-comment': {
    app: 'info', config: 'info', infra: 'info',
    test: 'info', sample: 'suppressed',
    docs: 'suppressed', generated: 'suppressed', vendor: 'suppressed',
  },
  'todo-marker': {
  ...
  'llm-placeholder': {
    app: 'high', config: 'high', infra: 'high',
    test: 'info', sample: 'info',
    docs: 'suppressed', generated: 'suppressed', vendor: 'suppressed',
