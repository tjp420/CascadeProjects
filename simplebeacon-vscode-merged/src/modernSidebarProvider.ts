...
(function(){
  ...
  function _closeDetailPanels(){
    ...
    let sendToAIAgentBtn=document.getElementById('sendToAIAgentDropdownHeader'); if(sendToAIAgentBtn){sendToAIAgentBtn.style.display='block';}
  ...
  let _codeMapDetailBackBtn=document.getElementById('codeMapDetailBackBtn');if(_codeMapDetailBackBtn){_codeMapDetailBackBtn.addEventListener('click', function() { const header=document.getElementById('codeMapDropdownHeader'); const detail=document.getElementById('codeMapDetailPanel'); if(header){header.style.display='block';} if(detail){detail.style.display='none';} document.body.classList.remove('detail-panel-open'); });}
  ...
  let _roadmapDetailBackBtn=document.getElementById('roadmapDetailBackBtn');if(_roadmapDetailBackBtn){_roadmapDetailBackBtn.addEventListener('click', function() { const header=document.getElementById('roadmapDropdownHeader'); const detail=document.getElementById('roadmapDetailPanel'); if(header){header.style.display='block';} if(detail){detail.style.display='none';} document.body.classList.remove('detail-panel-open'); });}
  let _openRoadmapBtn=document.getElementById('openRoadmapBtn');if(_openRoadmapBtn){_openRoadmapBtn.addEventListener('click', function() { _switchSidebarTab('roadmap'); });}
  ...
  let _uploadValidateBtn=document.getElementById('uploadValidateBtn');if(_uploadValidateBtn){_uploadValidateBtn.addEventListener('click', function() { if (window.vscode) window.vscode.postMessage({command: 'uploadValidate'}); });}
  ...
  let _auditDetailBackBtn=document.getElementById('auditDetailBackBtn');if(_auditDetailBackBtn){_auditDetailBackBtn.addEventListener('click', function() { const btn=document.getElementById('openAuditFromSidebar'); const detail=document.getElementById('auditDetailPanel'); if(btn){btn.style.display='block';} if(detail){detail.style.display='none';} document.body.classList.remove('detail-panel-open'); });}
  ...
  let _trustDetailBackBtn=document.getElementById('trustDetailBackBtn');if(_trustDetailBackBtn){_trustDetailBackBtn.addEventListener('click', function() { const header=document.getElementById('trustDropdownHeader'); const detail=document.getElementById('trustDetailPanel'); if(header){header.style.display='block';} if(detail){detail.style.display='none';} document.body.classList.remove('detail-panel-open'); });}
  ...
  let _assessmentsDetailBackBtn=document.getElementById('assessmentsDetailBackBtn');if(_assessmentsDetailBackBtn){_assessmentsDetailBackBtn.addEventListener('click', function() { const header=document.getElementById('assessmentsDropdownHeader'); const detail=document.getElementById('assessmentsDetailPanel'); if(header){header.style.display='block';} if(detail){detail.style.display='none';} document.body.classList.remove('detail-panel-open'); });}
  ...
  let _analyticsDetailBackBtn=document.getElementById('analyticsDetailBackBtn');if(_analyticsDetailBackBtn){_analyticsDetailBackBtn.addEventListener('click', function() { const header=document.getElementById('analyticsDropdownHeader'); const detail=document.getElementById('analyticsDetailPanel'); if(header){header.style.display='block';} if(detail){detail.style.display='none';} document.body.classList.remove('detail-panel-open'); });}
  ...
  let _teamDetailBackBtn=document.getElementById('teamDetailBackBtn');if(_teamDetailBackBtn){_teamDetailBackBtn.addEventListener('click', function() { _closeDetailPanels(); const header=document.getElementById('teamDropdownHeader'); const detail=document.getElementById('teamDetailPanel'); if(header){header.classList.remove('hidden'); header.style.display='block';} if(detail){detail.classList.remove('hidden'); detail.style.display='none';} document.body.classList.remove('detail-panel-open'); });}
  ...
  let _scanDetailBackBtn=document.getElementById('scanDetailBackBtn');if(_scanDetailBackBtn){_scanDetailBackBtn.addEventListener('click', function() { const header=document.getElementById('scanDropdownHeader'); const detail=document.getElementById('scanDetailPanel'); if(header){header.style.display='block';} if(detail){detail.style.display='none';} document.body.classList.remove('detail-panel-open'); });}
  ...
  let _sendToAIAgentDropdownHeader=document.getElementById('sendToAIAgentDropdownHeader');if(_sendToAIAgentDropdownHeader){_sendToAIAgentDropdownHeader.addEventListener('click', function() { if (window.vscode) window.vscode.postMessage({command: 'openSendToAIAgent'}); });}
  ...
  let _openPlatformFromSettingsTab=document.getElementById('openPlatformFromSettingsTab');if(_openPlatformFromSettingsTab){_openPlatformFromSettingsTab.addEventListener('click', function() { if (window.vscode) window.vscode.postMessage({command: 'openPlatform'}); });}
