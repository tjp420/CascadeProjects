...
export type VisualNode = HeaderNode | StatusNode | ProgressNode | 
  ScoreCardNode | MetricsGridNode | ActionsGroupNode | QuickActionNode | 
  CategoryNode | CategoryItemNode | FindingNode | ScanDetailsNode | 
  FileIssuesCategoryNode | FileIssuesNode | IssueNode;
```
