      ...
      try {
        switch (message.command) {
          ...
          case 'openCloudInBrowser':
            vscode.commands.executeCommand('simplebeacon.openInBrowser', '/upload.html');
            break;
          case 'openCloudInPreview':
            vscode.commands.executeCommand('simplebeacon.openInPreview', '/upload.html');
            break;
          ...
          case 'openAdvancedInPreview':
            vscode.commands.executeCommand('simplebeacon.openInPreview', '/#/dashboard');
            break;
          case 'openWebsiteInBrowser':
            vscode.commands.executeCommand('simplebeacon.openWebsite');
            break;
          case 'openWebsiteInPreview':
            vscode.commands.executeCommand('simplebeacon.openWebsitePreview');
            break;
          case 'remediation':
          ...
          case 'exportReport':
            ...
            break;
          case 'scanFolder':
            vscode.commands.executeCommand('simplebeacon.scanFolder');
            break;
          case 'refresh':
            vscode.commands.executeCommand('simplebeacon.refreshResults');
            break;
        }
      } catch (err) {
...
<div class="content">
  ...
  <div class="section">
    ...
    <div class="actions-secondary">
      ...
      <button class="btn btn-action btn-small" id="scanFolderBtn">
        <span class="btn-icon">📁</span>
        <span>Scan Folder</span>
      </button>
      <button class="btn btn-action btn-small" id="refreshBtn">
        <span class="btn-icon">🔄</span>
        <span>Refresh</span>
      </button>
    </div>
  ...
  <div class="section">
    <div class="collapsible" id="advancedFeatures">
      ...
      <div class="collapsible-content">
        ...
        <button class="collapsible-btn" onclick="vscode.postMessage({command:'remediation'})">📋 Remediation Guide</button>
        <button class="collapsible-btn" onclick="vscode.postMessage({command:'exportAIReport'})">📤 Export AI Report</button>
        <button class="collapsible-btn" onclick="vscode.postMessage({command:'exportReport'})">📄 Export Report</button>
      </div>
    </div>
  </div>
</div>
...
try {
  ...
  if (scanFolderBtn) scanFolderBtn.onclick = () => vscode.postMessage({command:'scanFolder'});
