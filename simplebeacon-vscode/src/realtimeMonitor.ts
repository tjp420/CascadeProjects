...
export class RealtimeMonitor {
    ...
    private setupFileWatchers(): void {
        // Watch for file changes in the workspace (broad pattern; VS Code doesn't support brace expansion)
    ...
    private displayIssues(issues: RealtimeIssue[]): void {
        ...
        for (const issue of issues) {
            ...
            this.outputChannel.appendLine(
                `${severityIcon} ${fileName}:${issue.line}:${issue.column} - ${issue.message}`
            );
            ...
            const diagnosticSeverity = issue.severity === 'error'
