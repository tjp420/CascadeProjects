...
## Branch
`feature/track81-extensions`

## Scope
Phase 2 extensions to PQC Cross-Border Logistics Gating Hub and ZK Manifest Claim Validator.

## Files
- `ai-platform/server/lib/hsm-adapter/pqc-cross-border-logistics-gating-hub.cjs`
- `ai-platform/server/lib/hsm-adapter/zk-manifest-claim-validator.cjs`
- `ai-platform/server/lib/hsm-adapter/hsm-metrics.cjs`
- `ai-platform/server/lib/hsm-adapter/__tests__/pq-cross-border-logistics-gating-extensions.test.cjs`
