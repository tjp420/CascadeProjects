...
Existing tools (Snyk, SonarQube) catch security bugs and code smells. None of them specifically target _AI-generated artifacts_.
...
_Built solo over 6 months. Revenue so far: $0. Let's see if HN changes that._
