...
const SKIP_DIRS =
    /^node_modules$|^\.git$|^\.husky$|^dist$|^build$|^\.next$|^out$|^coverage$|^frontend-build$|^\.github-sync$|^github-cache$|^\.simplebeacon$|^\.cursor$|^\.windsurf$|^deployments$|^backups$|^java-ai-vulnerable$|^Domain$|^coming-soon-dev$|^packages$/;
const BINARY_EXTS =
