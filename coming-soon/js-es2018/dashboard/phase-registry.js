...
export const PHASE_REGISTRY = [
    { id: 'security', title: 'Security Hardening', effort: '1–2 days', thresholds: { high: 1, critical: 1 },
        build(report) {
            ...
            const credFindings = (_b = (_a = report.gate) === null || _a === void 0 ? void 0 : _a.credentialHits) !== null && _b !== void 0 ? _b : ((_c = src.gate) === null || _c === void 0 ? void 0 : _c.credentialHits);
            const leakFindings = (_e = (_d = report.gate) === null || _d === void 0 ? void 0 : _d.productionLeakCount) !== null && _e !== void 0 ? _e : ((_f = src.gate) === null || _f === void 0 ? void 0 : _f.productionLeakCount);
    ...
    { id: 'integrity', title: 'Data Integrity', effort: '2–4 days', thresholds: { high: 3, critical: 5 },
        build(report) {
            var _a, _b, _c, _d, _e;
            const src = report.sourceReport || report;
            const invalidJson = (_a = report.invalidJsonFiles) !== null && _a !== void 0 ? _a : (_b = src.dataQuality) === null || _b === void 0 ? void 0 : _b.invalidJsonFileCount;
            const emptyFiles = (_c = report.emptyJsonFiles) !== null && _c !== void 0 ? _c : (_d = src.dataQuality) === null || _d === void 0 ? void 0 : _d.emptyFileCount;
    ...
    { id: 'consistency', title: 'Consistency & Deduplication', effort: '3–5 days', thresholds: { high: 5, critical: 10 },
        build(report) {
            var _a, _b, _c;
            const src = report.sourceReport || report;
            const dupes = (_a = report.duplicateGroups) !== null && _a !== void 0 ? _a : (_b = src.consolidation) === null || _b === void 0 ? void 0 : _b.duplicateGroups;
    ...
    { id: 'mockdata', title: 'Mock Data Review', effort: '1 day', thresholds: { high: 1, critical: 1 },
        build(report) {
            ...
            const mockTotal = (_a = src.mockSampleFiles) !== null && _a !== void 0 ? _a : mockCats.reduce((a, c) => a + (c.fileCount || 0), 0);
    ...
    { id: 'junkfiles', title: 'Junk & Temporary Files', effort: '1 day', thresholds: { high: 5, critical: 10 },
        build(report) {
            var _a, _b;
            const src = report.sourceReport || report;
            const jCount = (_b = (_a = report.junkFiles) === null || _a === void 0 ? void 0 : _a.count) !== null && _b !== void 0 ? _b : 0;
    ...
    { id: 'buildreadiness', title: 'Build Readiness', effort: '2–3 days', thresholds: { high: 3, critical: 5 },
        build(report) {
            var _a, _b, _c;
            const src = report.sourceReport || report;
            const brScore = ((_a = src.buildReadiness) === null || _a === void 0 ? void 0 : _a.score) != null ? Number(src.buildReadiness.score) : null;
            const issues = ((_c = (_b = src.buildReadiness) === null || _b === void 0 ? void 0 : _b.issues) === null || _c === void 0 ? void 0 : _c.length) || 0;
    ...
    { id: 'vulns', title: 'Dependency Vulnerability Audit', effort: '1–3 days', thresholds: { high: 1, critical: 1 },
        build(report) {
            var _a, _b;
            const src = report.sourceReport || report;
            const vCount = (_b = (_a = src.dependencyAudit) === null || _a === void 0 ? void 0 : _a.vulnerabilityCount) !== null && _b !== void 0 ? _b : 0;
