...
function resolveProjectedInventoryNote(next, auditFiles) {
    ...
    const safeFiles =
        (_e =
            (_b = (_a = next.estimatedReduction) === null || _a === void 0 ? void 0 : _a.files) !== null &&
            _b !== void 0
                ? _b
...
function resolveArtifactProfileForExport(scanAnalysis = {}, tiers = {}, estimatedReduction = {}) {
    ...
    const hasFollowUp =
        investigate > 0 ||
        dupBytes > 0 ||
        ((_k = (_j = tiers.reviewFirst) === null || _j === void 0 ? void 0 : _j.files) !== null && _k !== void 0
            ? _k
            : 0) > 0;
...
function resolveCleanupStatus(brief) {
    ...
    const safeFiles =
        (_e =
            (_b = (_a = brief.estimatedReduction) === null || _a === void 0 ? void 0 : _a.files) !== null &&
            _b !== void 0
                ? _b
...
function resolveFileReductionWorkspaceFiles(brief, options = {}) {
    ...
    return (_g =
        (_d =
            ...
            ? _d
            : (_f = (_e = brief.scanAnalysis) === null || _e === void 0 ? void 0 : _e.fileReduction) === null ||
                _f === void 0
              ? void 0
...
function resolveGateInventoryContext(brief, options = {}) {
        ...
        (_z =
            (_x =
                (_w =
                    (_t =
                        (_s =
                            (_r = gateReport.scanScope) === null || _r === void 0 ? void 0 : _r.fullDirectoryStats) ===
                            null || _s === void 0
                            ? void 0
    ...
    const gateProfile =
        (_5 =
            (_3 =
                (_1 = (_0 = gateReport.scanScope) === null || _0 === void 0 ? void 0 : _0.profile) !== null &&
                _1 !== void 0
                    ? _1
...
function buildCleanupBriefHygieneSummary(brief, options = {}) {
    ...
    return {
        ...
        phase1SafeDeleteFiles:
            (_h =
                (_e = (_d = brief.estimatedReduction) === null || _d === void 0 ? void 0 : _d.files) !== null &&
                _e !== void 0
                    ? _e
                    : (_g = (_f = brief.tiers) === null || _f === void 0 ? void 0 : _f.safeNow) === null ||
                        _g === void 0
                      ? void 0
                      : _g.files) !== null && _h !== void 0
                ? _h
        ...
        phase1SafeDeleteBytes:
            (_o =
                (_k = (_j = brief.estimatedReduction) === null || _j === void 0 ? void 0 : _j.bytes) !== null &&
                _k !== void 0
                    ? _k
                    : (_m = (_l = brief.tiers) === null || _l === void 0 ? void 0 : _l.safeNow) === null ||
                        _m === void 0
                      ? void 0
        ...
        phase2DuplicateBytes:
            (_q = (_p = brief.estimatedReduction) === null || _p === void 0 ? void 0 : _p.phase2DuplicateBytes) !==
                null && _q !== void 0
                ? _q
                : 0,
        investigateFiles:
...
function buildProductExportNotes(brief, options = {}) {
    ...
    const safeFiles =
        (_k =
            (_g = (_f = brief.estimatedReduction) === null || _f === void 0 ? void 0 : _f.files) !== null &&
            _g !== void 0
                ? _g
    ...
    const safeBytes =
        (_q =
            (_m = (_l = brief.estimatedReduction) === null || _l === void 0 ? void 0 : _l.bytes) !== null &&
            _m !== void 0
                ? _m
    ...
    if (!benchmarkScan) {
        ...
        const exportNotes = buildProductExportNotes(
            {
                ...
                inventory: {
                    ...
                    ...(auditFiles != null &&
                    ((_e = (_d = next.inventory) === null || _d === void 0 ? void 0 : _d.totalFiles) !== null &&
                    _e !== void 0
                        ? _e
                        : 0) >
                        auditFiles * 2
        ...
        return {
            ...
            inventory: {
                ...
                inventoryScope: 'platform-product',
                ...(auditFiles != null &&
                ((_k = (_j = next.inventory) === null || _j === void 0 ? void 0 : _j.totalFiles) !== null &&
                _k !== void 0
                    ? _k
                    : 0) >
                    auditFiles * 2
