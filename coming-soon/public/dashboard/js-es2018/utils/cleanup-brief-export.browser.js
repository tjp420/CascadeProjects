...
function resolveProjectedInventoryNote(next, auditFiles) {
    ...
    const safeFiles = (_e = (_b = (_a = next.estimatedReduction) === null || _a === void 0 ? void 0 : _a.files) !== null && _b !== void 0 ? _b : (_d = (_c = next.tiers) === null || _c === void 0 ? void 0 : _c.safeNow) === null || _d === void 0 ? void 0 : _d.files) !== null && _e !== void 0 ? _e : 0;
    const projectedTotal = (_f = next.projectedInventory) === null || _f === void 0 ? void 0 : _f.totalFiles;
    if (auditFiles != null && ((_h = (_g = next.inventory) === null || _g === void 0 ? void 0 : _g.totalFiles) !== null && _h !== void 0 ? _h : 0) > auditFiles * 2) {
...
export function normalizeDuplicateGroupForBrief(group) {
    ...
    let keeper = group.keeper
        ...
        || null;
    let duplicates = (((_a = group.duplicates) === null || _a === void 0 ? void 0 : _a.length)
        ? group.duplicates
    ...
    if (!keeper && !duplicates.length && !reclaimableBytes)
        return null;
    const normalized = {
        keeper,
...
function duplicateStatsFromBrief(brief) {
    var _a, _b, _c, _d;
    const fr = (_a = brief.scanAnalysis) === null || _a === void 0 ? void 0 : _a.fileReduction;
    ...
    return {
        reclaimableBytes: (_c = (_b = fr === null || fr === void 0 ? void 0 : fr.duplicateAssetBytes) !== null && _b !== void 0 ? _b : dupRow === null || dupRow === void 0 ? void 0 : dupRow.bytes) !== null && _c !== void 0 ? _c : null,
        duplicateFiles: (_d = dupRow === null || dupRow === void 0 ? void 0 : dupRow.files) !== null && _d !== void 0 ? _d : null
    };
}
/**
...
function pruneDuplicateAssetsForExport(groups = [], brief) {
    const normalized = groups
        ...
        .filter(Boolean);
    const withPaths = normalized.filter((g) => { var _a; return ((_a = g.duplicates) === null || _a === void 0 ? void 0 : _a.length) > 0 && g.keeper; });
    if (withPaths.length) {
...
function replaceMisleadingBriefNotes(notes = [], benchmarkScan) {
    ...
    if (benchmarkScan) {
        filtered.unshift('Scan target is an OSS clone under github-cache/ — not Simplebeacon product code. Simplebeacon platform protected paths do not apply.');
    }
...
function buildBenchmarkAgentInstructions(brief) {
    var _a;
    const dup = (_a = brief.estimatedReduction) === null || _a === void 0 ? void 0 : _a.phase2DuplicateBytes;
    return [
...
function resolveArtifactProfileForExport(scanAnalysis = {}, tiers = {}, estimatedReduction = {}) {
    ...
    const investigate = (_c = (_b = (_a = tiers.investigate) === null || _a === void 0 ? void 0 : _a.files) !== null && _b !== void 0 ? _b : fr.unusedFileCandidates) !== null && _c !== void 0 ? _c : 0;
    const dupBytes = (_e = (_d = fr.duplicateAssetBytes) !== null && _d !== void 0 ? _d : fr.immediateSavingsBytes) !== null && _e !== void 0 ? _e : 0;
    const safeFiles = (_h = (_f = estimatedReduction.files) !== null && _f !== void 0 ? _f : (_g = tiers.safeNow) === null || _g === void 0 ? void 0 : _g.files) !== null && _h !== void 0 ? _h : 0;
    const hasFollowUp = investigate > 0 || dupBytes > 0 || ((_k = (_j = tiers.reviewFirst) === null || _j === void 0 ? void 0 : _j.files) !== null && _k !== void 0 ? _k : 0) > 0;
    if (safeFiles > 0)
        return 'mixed-safe-delete-available';
    if (profile === 'empty' && hasFollowUp)
        return 'mixed-no-safe-delete';
    if (profile === 'empty')
        return 'no-reclaimable-artifacts';
    return profile;
}
/**
...
function resolveCleanupStatus(brief) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
    const safeFiles = (_e = (_b = (_a = brief.estimatedReduction) === null || _a === void 0 ? void 0 : _a.files) !== null && _b !== void 0 ? _b : (_d = (_c = brief.tiers) === null || _c === void 0 ? void 0 : _c.safeNow) === null || _d === void 0 ? void 0 : _d.files) !== null && _e !== void 0 ? _e : 0;
    const dupBytes = (_g = (_f = brief.estimatedReduction) === null || _f === void 0 ? void 0 : _f.phase2DuplicateBytes) !== null && _g !== void 0 ? _g : 0;
    const investigate = (_k = (_j = (_h = brief.tiers) === null || _h === void 0 ? void 0 : _h.investigate) === null || _j === void 0 ? void 0 : _j.files) !== null && _k !== void 0 ? _k : 0;
    if (brief.benchmarkScan)
...
function resolveFileReductionWorkspaceFiles(brief, options = {}) {
    ...
    return (_g = (_d = (_c = (_b = (_a = options.fileReductionReport) === null || _a === void 0 ? void 0 : _a.inventory) === null || _b === void 0 ? void 0 : _b.totalFiles) !== null && _c !== void 0 ? _c : options.fileReductionInventoryFiles) !== null && _d !== void 0 ? _d : (_f = (_e = brief.scanAnalysis) === null || _e === void 0 ? void 0 : _e.fileReduction) === null || _f === void 0 ? void 0 : _f.workspaceFilesScanned) !== null && _g !== void 0 ? _g : null;
}
/**
...
function countDataQualityOpenFindings(dataQuality = {}) {
    ...
    return ((_a = dataQuality.unusedDependencies) !== null && _a !== void 0 ? _a : 0)
        ...
        + ((_e = dataQuality.credentialsNeedingReview) !== null && _e !== void 0 ? _e : 0)
...
function resolveGateInventoryContext(brief, options = {}) {
    ...
    const repositoryFilesTotal = (_j = (_g = (_e = (_c = (_b = (_a = options.repositoryFilesTotal) !== null && _a !== void 0 ? _a : options.auditRepositoryFiles) !== null && _b !== void 0 ? _b : gateReport.repositoryFilesTotal) !== null && _c !== void 0 ? _c : (_d = gateReport.repositoryInventory) === null || _d === void 0 ? void 0 : _d.totalFiles) !== null && _e !== void 0 ? _e : (_f = brief.inventory) === null || _f === void 0 ? void 0 : _f.auditRepositoryFiles) !== null && _g !== void 0 ? _g : (_h = brief.hygieneSummary) === null || _h === void 0 ? void 0 : _h.gateRepositoryFilesTotal) !== null && _j !== void 0 ? _j : null;
    const credentialScanned = (_q = (_o = (_l = (_k = gateReport.credentialScanned) !== null && _k !== void 0 ? _k : gateReport.productionLeakScanned) !== null && _l !== void 0 ? _l : (_m = gateReport.scanScope) === null || _m === void 0 ? void 0 : _m.productionDirsScanned) !== null && _o !== void 0 ? _o : (_p = brief.hygieneSummary) === null || _p === void 0 ? void 0 : _p.credentialScanned) !== null && _q !== void 0 ? _q : null;
    const contentScanned = (_z = (_x = (_w = (_t = (_s = (_r = gateReport.scanScope) === null || _r === void 0 ? void 0 : _r.fullDirectoryStats) === null || _s === void 0 ? void 0 : _s.contentScanned) !== null && _t !== void 0 ? _t : (_v = (_u = gateReport.scanScope) === null || _u === void 0 ? void 0 : _u.fullDirectoryStats) === null || _v === void 0 ? void 0 : _v.filesContentScanned) !== null && _w !== void 0 ? _w : gateReport.credentialScanned) !== null && _x !== void 0 ? _x : (_y = brief.hygieneSummary) === null || _y === void 0 ? void 0 : _y.contentFilesScanned) !== null && _z !== void 0 ? _z : null;
    const gateProfile = (_5 = (_3 = (_1 = (_0 = gateReport.scanScope) === null || _0 === void 0 ? void 0 : _0.profile) !== null && _1 !== void 0 ? _1 : (_2 = brief.scanScope) === null || _2 === void 0 ? void 0 : _2.gateRuleBundleProfile) !== null && _3 !== void 0 ? _3 : (_4 = brief.hygieneSummary) === null || _4 === void 0 ? void 0 : _4.gateRuleBundleProfile) !== null && _5 !== void 0 ? _5 : null;
    return {
        gateReport,
        ...
        contentScanned,
        gateProfile,
        fictionJsonFilesScanned: (_10 = (_8 = (_6 = gateReport.fictionJsonFilesScanned) !== null && _6 !== void 0 ? _6 : (_7 = gateReport.scanScope) === null || _7 === void 0 ? void 0 : _7.fictionJsonFilesScanned) !== null && _8 !== void 0 ? _8 : (_9 = brief.hygieneSummary) === null || _9 === void 0 ? void 0 : _9.fictionJsonFilesScanned) !== null && _10 !== void 0 ? _10 : null,
        fictionSampleFilesScanned: (_16 = (_14 = (_12 = (_11 = gateReport.fictionSampleFilesScanned) !== null && _11 !== void 0 ? _11 : gateReport.mockSampleFiles) !== null && _12 !== void 0 ? _12 : (_13 = gateReport.scanScope) === null || _13 === void 0 ? void 0 : _13.fictionSampleFilesScanned) !== null && _14 !== void 0 ? _14 : (_15 = brief.hygieneSummary) === null || _15 === void 0 ? void 0 : _15.fictionSampleFilesScanned) !== null && _16 !== void 0 ? _16 : null
    };
}
/**
...
function buildCleanupBriefHygieneSummary(brief, options = {}) {
    ...
    const dq = ((_a = brief.scanAnalysis) === null || _a === void 0 ? void 0 : _a.dataQuality) || {};
    return {
        cleanupStatus: resolveCleanupStatus(brief),
        explorerInventoryFiles: (_c = (_b = brief.inventory) === null || _b === void 0 ? void 0 : _b.totalFiles) !== null && _c !== void 0 ? _c : null,
        ...
        phase1SafeDeleteFiles: (_h = (_e = (_d = brief.estimatedReduction) === null || _d === void 0 ? void 0 : _d.files) !== null && _e !== void 0 ? _e : (_g = (_f = brief.tiers) === null || _f === void 0 ? void 0 : _f.safeNow) === null || _g === void 0 ? void 0 : _g.files) !== null && _h !== void 0 ? _h : 0,
        phase1SafeDeleteBytes: (_o = (_k = (_j = brief.estimatedReduction) === null || _j === void 0 ? void 0 : _j.bytes) !== null && _k !== void 0 ? _k : (_m = (_l = brief.tiers) === null || _l === void 0 ? void 0 : _l.safeNow) === null || _m === void 0 ? void 0 : _m.bytes) !== null && _o !== void 0 ? _o : 0,
        phase2DuplicateBytes: (_q = (_p = brief.estimatedReduction) === null || _p === void 0 ? void 0 : _p.phase2DuplicateBytes) !== null && _q !== void 0 ? _q : 0,
        investigateFiles: (_t = (_s = (_r = brief.tiers) === null || _r === void 0 ? void 0 : _r.investigate) === null || _s === void 0 ? void 0 : _s.files) !== null && _t !== void 0 ? _t : 0,
        ...
        ...(gateReport.jestBaselineChecked === false || ((_u = brief.hygieneSummary) === null || _u === void 0 ? void 0 : _u.jestBaselineChecked) === false
...
function buildCleanupBriefScanScope(brief, options = {}) {
    ...
    const explorerFiles = (_b = (_a = brief.inventory) === null || _a === void 0 ? void 0 : _a.totalFiles) !== null && _b !== void 0 ? _b : null;
    const frWorkspace = resolveFileReductionWorkspaceFiles(brief, options);
    const monorepoShells = repositoryFilesTotal != null && explorerFiles != null && explorerFiles > repositoryFilesTotal * 2;
    return {
        inventoryScope: ((_c = brief.inventory) === null || _c === void 0 ? void 0 : _c.inventoryScope) || 'platform-product',
...
function buildProductExportNotes(brief, options = {}) {
    ...
    if ((_a = brief.inventory) === null || _a === void 0 ? void 0 : _a.inventoryNote) {
        notes.push(String(brief.inventory.inventoryNote));
    }
    const frWorkspace = resolveFileReductionWorkspaceFiles(brief, options);
    const explorerFiles = (_b = brief.inventory) === null || _b === void 0 ? void 0 : _b.totalFiles;
    if (frWorkspace != null && explorerFiles != null && explorerFiles > frWorkspace * 1.5) {
        notes.push(`File-reduction workspace walk counted ${formatNumber(frWorkspace)} files — repository inventory (${formatNumber(explorerFiles)} paths) includes un-walked regenerable shells.`);
    }
    const gateContext = resolveGateInventoryContext(brief, options);
    ...
    if (repositoryFilesTotal != null && credentialScanned != null && credentialScanned < repositoryFilesTotal) {
        notes.push(`CRED/LEAK rules scanned ${formatNumber(credentialScanned)} production-path file(s) — ${formatNumber(repositoryFilesTotal - credentialScanned)} metadata-only path(s) in gate inventory of ${formatNumber(repositoryFilesTotal)}.`);
    }
    ...
    if (gateReport.jestBaselineChecked === false) {
        notes.push('Jest was not run during the paired gate scan — use `npm run simplebeacon:full` or `npm test` before treating unused-file static analysis as complete.');
    }
    const cleanupStatus = resolveCleanupStatus(brief);
    if (cleanupStatus === 'no-immediate-safe-delete') {
        notes.push('No phase-1 safe deletes under current policy — review data-quality actions in json/data-quality.json before optional duplicate consolidation.');
    }
    ...
    const dqOpen = countDataQualityOpenFindings(((_c = brief.scanAnalysis) === null || _c === void 0 ? void 0 : _c.dataQuality) || {});
    if (((_d = brief.sourceScans) === null || _d === void 0 ? void 0 : _d.dataQualityPresent) && dqOpen === 0) {
    ...
    const fr = ((_e = brief.scanAnalysis) === null || _e === void 0 ? void 0 : _e.fileReduction) || {};
    const skipped = fr.skippedArtifactDirectories || [];
    const safeFiles = (_k = (_g = (_f = brief.estimatedReduction) === null || _f === void 0 ? void 0 : _f.files) !== null && _g !== void 0 ? _g : (_j = (_h = brief.tiers) === null || _h === void 0 ? void 0 : _h.safeNow) === null || _j === void 0 ? void 0 : _j.files) !== null && _k !== void 0 ? _k : 0;
    const safeBytes = (_q = (_m = (_l = brief.estimatedReduction) === null || _l === void 0 ? void 0 : _l.bytes) !== null && _m !== void 0 ? _m : (_p = (_o = brief.tiers) === null || _o === void 0 ? void 0 : _o.safeNow) === null || _p === void 0 ? void 0 : _p.bytes) !== null && _q !== void 0 ? _q : 0;
    if (skipped.length) {
        notes.push(`${skipped.length} regenerable directory shell(s) (e.g. node_modules, coverage) appear in tier lists with 0 B walked — inventory file count may still include them.`);
    }
    if (cleanupStatus === 'safe-delete-available' && safeFiles > 0) {
        notes.push(`Phase 1 safe-to-delete: ${formatNumber(safeFiles)} files (${formatBytes(safeBytes)}) in regenerable artifact directories — restore with npm install / rebuild after delete.`);
    }
    else if (String(((_r = brief.scanAnalysis) === null || _r === void 0 ? void 0 : _r.artifactProfile) || '').startsWith('mixed')
    ...
    if (((_t = (_s = brief.tiers) === null || _s === void 0 ? void 0 : _s.investigate) === null || _t === void 0 ? void 0 : _t.files) > 0) {
        notes.push(`${brief.tiers.investigate.files} unused-file candidates require import verification — not safe to bulk-delete.`);
    }
    if (((_u = brief.estimatedReduction) === null || _u === void 0 ? void 0 : _u.phase2DuplicateBytes) > 0 && ((_v = brief.duplicateAssets) === null || _v === void 0 ? void 0 : _v.length)) {
        notes.push(`Phase 2 duplicate consolidation may reclaim ${formatBytes(brief.estimatedReduction.phase2DuplicateBytes)} — use listed keeper/duplicate paths only.`);
    }
...
function enrichProductAgentPrompt(brief) {
    ...
    const investigate = (_b = (_a = tiers === null || tiers === void 0 ? void 0 : tiers.investigate) === null || _a === void 0 ? void 0 : _a.files) !== null && _b !== void 0 ? _b : 0;
    const dupBytes = (_c = estimatedReduction.phase2DuplicateBytes) !== null && _c !== void 0 ? _c : 0;
    const dupFiles = (_d = estimatedReduction.phase2DuplicateFiles) !== null && _d !== void 0 ? _d : 0;
    const safeFiles = (_e = estimatedReduction.files) !== null && _e !== void 0 ? _e : 0;
    const lines = [
        `Proceed in agent mode using the attached cleanup brief for: ${projectPath}`,
        '',
        'Deletion policy:',
    ...
    lines.push('', `Inventory: ${formatNumber(inventory.totalFiles)} files / ${formatNumber(inventory.totalFolders)} folders (may include un-walked node_modules shells)`, `Projected after phase 1: ~${formatNumber(projectedInventory.totalFiles)} files`, '', safeFiles > 0 || dupBytes > 0
...
function enrichProductAgentInstructions(brief) {
    ...
    const protectedPaths = policy.protectedPaths || [];
    const investigate = (_c = (_b = (_a = brief.tiers) === null || _a === void 0 ? void 0 : _a.investigate) === null || _b === void 0 ? void 0 : _b.files) !== null && _c !== void 0 ? _c : 0;
    const dupBytes = (_e = (_d = brief.estimatedReduction) === null || _d === void 0 ? void 0 : _d.phase2DuplicateBytes) !== null && _e !== void 0 ? _e : 0;
    const lines = [
    ...
    lines.push(policy.allowNodeModules
        ? 'node_modules may be removed and restored with npm install.'
        : 'Do not delete node_modules unless the user explicitly enables it.', policy.allowSimplebeaconCache
        ? '.simplebeacon scan artifacts may be trimmed or archived.'
        : 'Keep .simplebeacon scan artifacts unless the user opts in.', `Phase 1 target reduction: ~${formatNumber((_f = brief.estimatedReduction) === null || _f === void 0 ? void 0 : _f.files)} files (${formatBytes((_g = brief.estimatedReduction) === null || _g === void 0 ? void 0 : _g.bytes)}).`);
    return lines;
}
/**
...
export function sanitizeCleanupBriefExport(brief, options = {}) {
    ...
    if (!brief || brief.type !== 'simplebeacon-cleanup-brief')
        return brief;
        ...
        tiers: {
            ...
            duplicateConsolidation: dupStats.reclaimableBytes
                ? {
                    ...
                    note: ((_c = pruned.duplicateAssetsSummary) === null || _c === void 0 ? void 0 : _c.note)
    ...
    if (!benchmarkScan) {
        const artifactProfile = resolveArtifactProfileForExport(next.scanAnalysis || {}, next.tiers || {}, next.estimatedReduction || {});
        const exportNotes = buildProductExportNotes({
            ...next,
            inventory: {
                ...(next.inventory || {}),
                inventoryScope: 'platform-product',
                ...(auditFiles != null && ((_e = (_d = next.inventory) === null || _d === void 0 ? void 0 : _d.totalFiles) !== null && _e !== void 0 ? _e : 0) > auditFiles * 2
                    ? {
                    ...
                    : ((_f = next.inventory) === null || _f === void 0 ? void 0 : _f.totalFiles) > 5000
                        ? {
        ...
        return {
            ...
            agentBriefReady: Boolean(((_g = next.sourceScans) === null || _g === void 0 ? void 0 : _g.fileReductionPresent) || ((_h = next.sourceScans) === null || _h === void 0 ? void 0 : _h.dataQualityPresent)),
            securityHandoffEligible: false,
            ...
            inventory: {
                ...
                inventoryScope: 'platform-product',
                ...(auditFiles != null && ((_k = (_j = next.inventory) === null || _j === void 0 ? void 0 : _j.totalFiles) !== null && _k !== void 0 ? _k : 0) > auditFiles * 2
                    ? {
                        auditRepositoryFiles: auditFiles,
                        inventoryNote: `Cleanup inventory (${Number(next.inventory.totalFiles).toLocaleString()} files) includes un-walked regenerable shells; gate audit profile counted ${Number(auditFiles).toLocaleString()} files.`
                    }
                    : ((_l = next.inventory) === null || _l === void 0 ? void 0 : _l.totalFiles) > 5000
                        ? {
                            inventoryNote: 'File count may include node_modules and other shells not size-walked for safe deletion.'
                        }
                        : {})
