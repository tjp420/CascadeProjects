...
function resolveDigestProjectPath(digest, options = {}) {
  ...
  return String(
    options.projectPath ||
      ...
      ((_a = digest.sourceReport) === null || _a === void 0
        ? void 0
        : _a.projectRoot) ||
      "",
  ).replace(/\\/g, "/");
...
function isBenchmarkScannerMetaIssue(issue) {
  ...
  if (!issue) return false;
  const intent = String(
    ((_a = issue.metadata) === null || _a === void 0 ? void 0 : _a.intent) ||
      issue.intent ||
      "",
  );
 ...
 * @returns {any}
 */
function buildBenchmarkFictionConclusion(
  fictionIssues,
  nonFictionIssues,
  sourceReport,
) {
  ...
  const repoFiles =
    (_a =
      sourceReport === null || sourceReport === void 0
        ? void 0
        : sourceReport.repositoryFilesTotal) !== null && _a !== void 0
      ? _a
      : (_b =
            sourceReport === null || sourceReport === void 0
              ? void 0
              : sourceReport.scanScope) === null || _b === void 0
        ? void 0
  ...
  const ruleScoped =
    (_e =
      (_c =
        sourceReport === null || sourceReport === void 0
          ? void 0
          : sourceReport.ruleScopedFilesAnalyzed) !== null && _c !== void 0
        ? _c
        : (_d =
              sourceReport === null || sourceReport === void 0
                ? void 0
                : sourceReport.scanScope) === null || _d === void 0
          ? void 0
  ...
  const jsonFiction =
    (_f =
      sourceReport === null || sourceReport === void 0
        ? void 0
        : sourceReport.fictionJsonFilesScanned) !== null && _f !== void 0
      ? _f
      : (_g =
            sourceReport === null || sourceReport === void 0
              ? void 0
              : sourceReport.scanScope) === null || _g === void 0
        ? void 0
        : _g.fictionJsonFilesScanned;
  const fictionN = fictionIssues.reduce(
  ...
  const parts = [
    ...
    repoFiles != null
      ? `Repository inventory: ${Number(repoFiles).toLocaleString()} files`
      : null,
...
function isStaleFullTreeScan(report) {
  ...
  if (
    ...
    ((_a = report.scanScope) === null || _a === void 0
      ? void 0
      : _a.fullDirectoryScan)
  ) {
    return false;
  }
  const mock =
    (_c =
      (_b = report.mockSampleFiles) !== null && _b !== void 0
        ? _b
        : report.totalFiles) !== null && _c !== void 0
      ? _c
      : 0;
  const repoFiles =
    (_d = report.repositoryFilesTotal) !== null && _d !== void 0 ? _d : 0;
  /**
   * Paths.
   * @param {number} report.scanPaths || []
   * @returns {any}
   */
  const paths = (report.scanPaths || []).map((p) =>
...
function reconcileProductDigestScanScope(scanScope = {}, report = {}) {
  ...
  const fullTree = Boolean(
    report.fullDirectoryScan || scanScope.fullDirectoryScan,
  );
  if (!fullTree) return scanScope;
  const mockInPaths =
    (_a = scanScope.mockSampleFilesInScanPaths) !== null && _a !== void 0
      ? _a
      : 0;
  const ruleScoped =
    (_c =
  ...
  const mockSampleFiles =
    (_e =
      (_d = report.mockSampleFiles) !== null && _d !== void 0
        ? _d
        : report.totalFiles) !== null && _e !== void 0
      ? _e
      : null;
...
function dedupeFictionDigestExportNotes(notes = []) {
  ...
  for (const note of notes) {
    ...
    const scopeKey = /agency-handoff and eu ai act blog matches/i.test(
      normalized,
    )
...
function buildBenchmarkFictionExportNotes(existingNotes = [], extras = []) {
  ...
  const filtered = dedupeFictionDigestExportNotes(existingNotes).filter(
    (note) => {
...
function reconcileBenchmarkDigestScanMetrics(report) {
  ...
  const ruleScoped =
    (_f =
      ...
      : null;
  const cap =
    repoTotal !== null && repoTotal !== void 0 ? repoTotal : ruleScoped;
  const rawLlm =
    (_m =
      (_k =
        (_j =
...
function sanitizeBenchmarkDigestScanScope(scanScope, report) {
  ...
  const scanned =
    (_e =
      (_d = scanScope.llmSlopFilesScanned) !== null && _d !== void 0
        ? _d
        : report.llmSlopFilesScanned) !== null && _e !== void 0
      ? _e
      : repoTotal;
  const rawLlm =
    (_f = scanScope.llmSlopScanRaw) !== null && _f !== void 0
      ? _f
      : report.llmSlopScanRaw;
  const reconciled =
    (_g = scanScope.llmSlopScanReconciled) !== null && _g !== void 0
      ? _g
...
function resolveBenchmarkDigestGateAttestation(sourceReport) {
  ...
  const ruleScoped =
    (_c =
      ...
      : 0;
  if (
    ((_d = sourceReport.gate) === null || _d === void 0 ? void 0 : _d.pass) &&
    ruleScoped > 0
  )
    return "benchmark-clone";
  if (
    ((_e = sourceReport.gate) === null || _e === void 0 ? void 0 : _e.pass) &&
    ruleScoped === 0
  )
...
function buildBenchmarkFictionScopeSummary(sourceReport) {
  ...
  return {
    benchmarkScannerMetaExcluded:
      (_g = scope.benchmarkScannerMetaExcluded) !== null && _g !== void 0
        ? _g
        : 0,
    benchmarkCloneNoiseExcluded:
      (_h = scope.benchmarkCloneNoiseExcluded) !== null && _h !== void 0
        ? _h
        : 0,
...
function resolveProductFictionDigestGateAttestation(sourceReport) {
  ...
  if (
    ((_f = sourceReport.gate) === null || _f === void 0 ? void 0 : _f.pass) &&
    ruleScoped === 0
  )
...
function summarizeAncillaryPatternHits(sourceReport) {
    ...
    (_c =
      (_b =
        (_a =
          sourceReport === null || sourceReport === void 0
            ? void 0
            : sourceReport.scanScope) === null || _a === void 0
          ? void 0
      ...
      : (_d =
            sourceReport === null || sourceReport === void 0
              ? void 0
              : sourceReport.fullDirectoryStats) === null || _d === void 0
        ? void 0
        : _d.ruleHitTotals;
  if (totals && typeof totals === "object") {
    ...
    if (Object.keys(ancillary).length > 0) {
      return {
        fictionKpi: (_e = totals.fictionKpi) !== null && _e !== void 0 ? _e : 0,
        ancillary,
      };
    }
    return null;
  ...
  const blocking =
    (_b =
      (_a =
        sourceReport === null || sourceReport === void 0
          ? void 0
          : sourceReport.gate) === null || _a === void 0
        ? void 0
...
function resolveFictionDigestGateContext(sourceReport, digest, options = {}) {
  ...
  const scope =
    (sourceReport === null || sourceReport === void 0
      ...
      : sourceReport.scanScope) || {};
  const hygiene =
    (digest === null || digest === void 0 ? void 0 : digest.hygieneSummary) ||
    {};
  return {
    gateReport: gate,
        ...
        (_e =
          ...
          : (_f =
                digest === null || digest === void 0
                  ? void 0
                  : digest.scanScope) === null || _f === void 0
            ? void 0
    ...
    gateProfile:
      (_w =
        (_u =
          (_t =
            (_r =
              (_q = scope.profile) !== null && _q !== void 0
                ? _q
                : scope.gateRuleBundleProfile) !== null && _r !== void 0
              ? _r
              : (_s =
                    digest === null || digest === void 0
                      ? void 0
                      : digest.scanScope) === null || _s === void 0
                ? void 0
...
function buildProductFictionHygieneSummary(sourceReport, digest, options = {}) {
  ...
  const gateContext = resolveFictionDigestGateContext(
    sourceReport,
    digest,
    options,
  );
  ...
  return {
    digestTrust:
      (_d = digest.digestTrust) !== null && _d !== void 0 ? _d : null,
    gatePass:
      (_f =
        (_e =
          sourceReport === null || sourceReport === void 0
            ? void 0
            : sourceReport.gate) === null || _e === void 0
          ? void 0
    ...
    blockingCount:
      (_h =
        (_g =
          sourceReport === null || sourceReport === void 0
            ? void 0
            : sourceReport.gate) === null || _g === void 0
          ? void 0
    ...
    fictionSampleFilesScanned:
      (_p =
        ...
        ? _p
        : null,
    fictionKpiHits: (digest.fictionIssues || []).reduce(
      (sum, issue) => sum + (issue.count || 1),
      0,
    ),
    ...
    attestationNote:
      "Fiction/KPI digest hygiene — not vendor handoff or Complete scan clearance certification.",
  };
}
/**
...
function buildProductFictionScanScope(sourceReport, digest, options = {}) {
  ...
  return {
    ...
    fictionDigestNote:
      ...
      ((_a =
        digest === null || digest === void 0 ? void 0 : digest.scanScope) ===
        null || _a === void 0
        ? void 0
...
function buildProductFictionExportNotes(digest, sourceReport, options = {}) {
  ...
  const fictionJson =
    (_a =
      sourceReport === null || sourceReport === void 0
        ? void 0
        : sourceReport.fictionJsonFilesScanned) !== null && _a !== void 0
      ? _a
    ...
    (_e =
      (_d =
        (_c =
          sourceReport === null || sourceReport === void 0
            ? void 0
            : sourceReport.mockSampleFiles) !== null && _c !== void 0
          ? _c
          : sourceReport === null || sourceReport === void 0
            ? void 0
  ...
  const fictionSamples =
    (_g =
      (_f =
        sourceReport === null || sourceReport === void 0
          ? void 0
          : sourceReport.fictionSampleFilesScanned) !== null && _f !== void 0
        ? _f
  ...
  const ruleScoped =
    (_j =
      (_h =
        sourceReport === null || sourceReport === void 0
          ? void 0
          : sourceReport.ruleScopedFilesAnalyzed) !== null && _h !== void 0
        ? _h
  ...
  if (
    ((_k =
      sourceReport === null || sourceReport === void 0
        ? void 0
        : sourceReport.gate) === null || _k === void 0
      ? void 0
      : _k.pass) &&
    ruleScoped > 0
  ) {
    ...
    ((_l =
      sourceReport === null || sourceReport === void 0
        ? void 0
        : sourceReport.gate) === null || _l === void 0
      ? void 0
      : _l.pass) &&
    ruleScoped === 0
  ) {
    ...
    ((_m =
      sourceReport === null || sourceReport === void 0
        ? void 0
        : sourceReport.gate) === null || _m === void 0
      ? void 0
      : _m.pass) === false
  ) {
    const blocking =
      (_p =
        (_o = sourceReport.gate) === null || _o === void 0
          ? void 0
          : _o.blockingCount) !== null && _p !== void 0
        ? _p
        : 0;
    if (blocking > 0) {
      notes.push(
  ...
  const profile =
    gateProfile !== null && gateProfile !== void 0
      ...
      : (_q =
            sourceReport === null || sourceReport === void 0
              ? void 0
              : sourceReport.scanScope) === null || _q === void 0
        ? void 0
        : _q.profile;
  ...
  if (
    (digest.fictionIssues || []).length === 0 &&
    (digest.nonFictionIssues || []).length === 0
  ) {
    notes.push(
      ancillaryNote
...
function enrichProductSourceReport(sourceReport) {
  ...
  const intentionalFullTree = Boolean(
    sourceReport.fullDirectoryScan ||
    ((_a = sourceReport.scanScope) === null || _a === void 0
      ? void 0
      : _a.fullDirectoryScan),
  );
  const reportHealth = intentionalFullTree
    ...
    : ((_b = sourceReport.scanScope) === null || _b === void 0
        ? void 0
        : _b.reportHealth) || "platform-scoped";
  const scanProfile =
    (_c = sourceReport.scanScope) === null || _c === void 0
      ? void 0
      : _c.profile;
  ...
  return {
    ...
    scanScope: {
      ...(sourceReport.scanScope || {}),
      resultsViewScope:
        ((_d = sourceReport.scanScope) === null || _d === void 0
          ? void 0
          : _d.resultsViewScope) || "platform-only",
      reportHealth,
      rescanRecommended: intentionalFullTree
        ? false
        : Boolean(
            (_e = sourceReport.scanScope) === null || _e === void 0
              ? void 0
              : _e.rescanRecommended,
          ),
      inventoryMetricsStale: intentionalFullTree
        ? false
        : (_g =
              (_f = sourceReport.scanScope) === null || _f === void 0
                ? void 0
                : _f.inventoryMetricsStale) !== null && _g !== void 0
          ? _g
          : false,
      fictionDigestNote:
        "Fiction/KPI digest export — gate pass here does not replace Complete scan clearance bundle.",
...
function resolveDigestTrust(benchmarkScan, fictionIssues, sourceReport) {
  ...
  const ruleScoped =
    (_c =
      (_a =
        sourceReport === null || sourceReport === void 0
          ? void 0
          : sourceReport.ruleScopedFilesAnalyzed) !== null && _a !== void 0
        ? _a
        : (_b =
              sourceReport === null || sourceReport === void 0
                ? void 0
  ...
  if (
    ((_d =
      sourceReport === null || sourceReport === void 0
        ? void 0
        : sourceReport.gate) === null || _d === void 0
      ? void 0
      : _d.pass) &&
    ruleScoped === 0
  )
...
function sanitizeSourceReportForDigest(report, projectPath) {
  ...
  const projectKey = String(report.projectRoot || projectPath || "").replace(
    /\\/g,
    "/",
  );
  ...
  const blockingCount = platformIssues
    .filter((issue) =>
      (gateConfig.failOn || ["high"]).includes(
  ...
  const warningCount = platformIssues
    .filter((issue) =>
      (gateConfig.warnOn || ["medium", "low"]).includes(
        issue.severityBand || issue.severity,
      ),
    )
    .reduce((sum, issue) => sum + (issue.count || 1), 0);
  ...
  const intentionalFullTree = Boolean(
    report.fullDirectoryScan ||
    ((_f = report.scanScope) === null || _f === void 0
      ? void 0
      : _f.fullDirectoryScan),
  );
  const staleFullTreeScan =
    !benchmarkTarget && !intentionalFullTree && isStaleFullTreeScan(report);
  let normalizedReport = benchmarkTarget
    ? reconcileBenchmarkDigestScanMetrics(report)
    : report;
  ...
  const scanScopeBase = {
    ...
    benchmarkScannerMetaExcluded:
      benchmarkScannerMetaIssues.length || undefined,
      ...
      : intentionalFullTree
        ...
        : staleFullTreeScan
          ...
          : ((_g = report.scanScope) === null || _g === void 0
              ? void 0
              : _g.reportHealth) || "platform-scoped",
  ...
  return {
    ...normalizedReport,
    projectRoot: normalizeDigestProjectPaths(
      normalizedReport.projectRoot || projectKey,
      projectLabel,
    ),
    platformRoot: benchmarkTarget
      ? normalizeDigestProjectPaths(
          normalizedReport.platformRoot ||
            resolveProductPlatformRoot(projectKey),
          projectLabel,
        )
      : normalizeDigestProjectPaths(
          normalizedReport.platformRoot,
    ...
    ...(hollowGate && !benchmarkTarget
      ? { gateAttestation: "limited-scope" }
      : {}),
    ...
    ...(benchmarkTarget
      ? {
          ...
          handoffEligible: false,
          productPlatformRoot: normalizeDigestProjectPaths(
            resolveProductPlatformRoot(projectKey),
          ),
        }
      : {}),
...
export function sanitizeFictionDigestExport(digest, options = {}) {
  ...
  const rawProjectPath =
    hintedPath || resolveDigestProjectPath(digest, options);
  const benchmarkScan = isBenchmarkFictionDigest(digest, {
    ...options,
  ...
  const productPlatformRoot = rawPlatformRoot
    ? normalizeDigestProjectPaths(
        rawPlatformRoot,
        projectLabelFromPath(rawPlatformRoot),
      )
    : null;
  ...
  const fictionIssues = filterDigestIssues(
    digest.fictionIssues || [],
    benchmarkScan,
  );
  const nonFictionIssues = filterDigestIssues(
    digest.nonFictionIssues || [],
    benchmarkScan,
  );
  const digestTrust = resolveDigestTrust(
    benchmarkScan,
    fictionIssues,
  ...
  const fictionScopePreview = benchmarkScan
    ...
    : null;
  const ancillaryPatternSummary = benchmarkScan
    ? null
    : summarizeAncillaryPatternHits(enrichedSourceReport);
  ...
  return {
    ...
    conclusion: benchmarkScan
      ? buildBenchmarkFictionConclusion(
          fictionIssues,
          nonFictionIssues,
          enrichedSourceReport,
        )
    ...
    sourceProjectPath:
      normalizeDigestProjectPaths(digest.sourceProjectPath, projectLabel) ||
      normalizedPath,
    ...(benchmarkScan
      ? {
          benchmarkScan: true,
          ...
          gateAttestation:
            resolveBenchmarkDigestGateAttestation(enrichedSourceReport),
          fictionScopeSummary:
            buildBenchmarkFictionScopeSummary(enrichedSourceReport),
        }
      : {
          ...
          handoffEligible: false,
          gateAttestation:
            resolveProductFictionDigestGateAttestation(enrichedSourceReport),
          fictionScopeSummary: {
            fictionJsonFilesScanned:
              (_c =
                (_a =
                  enrichedSourceReport === null ||
                  enrichedSourceReport === void 0
                    ? void 0
                    : enrichedSourceReport.fictionJsonFilesScanned) !== null &&
                _a !== void 0
                  ? _a
                  : (_b =
                        enrichedSourceReport === null ||
                        enrichedSourceReport === void 0
                          ? void 0
                          : enrichedSourceReport.scanScope) === null ||
                      _b === void 0
                    ? void 0
            ...
            jestExecutedDuringScan:
              (_k =
                ...
                : false,
            ...((
              ancillaryPatternSummary === null ||
              ancillaryPatternSummary === void 0
                ? void 0
