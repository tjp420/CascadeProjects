...
export function npmAuditSummary(audit) {
    ...
    return {
        ...
        moderate:
            (_m = (_l = summary.moderate) !== null && _l !== void 0 ? _l : summary.medium) !== null && _m !== void 0
                ? _m
                : 0,
        low: (_o = summary.low) !== null && _o !== void 0 ? _o : 0,
        vulnerabilityTotal:
            (_q = (_p = summary.vulnerabilityTotal) !== null && _p !== void 0 ? _p : summary.total) !== null &&
            _q !== void 0
                ? _q
                : (_s =
...
export function sanitizeCoverageExport(coverage) {
    ...
    return {
        ...
        lastRun:
            (_b = (_a = clean.lastRun) !== null && _a !== void 0 ? _a : clean.testCountGeneratedAt) !== null &&
            _b !== void 0
                ? _b
                : null,
        freshnessNote:
...
export function sanitizeQualityExport(quality, coverage = null, report = null) {
    ...
    const qualPassed =
        (_h = (_g = clean.passedTests) !== null && _g !== void 0 ? _g : clean.testsPassed) !== null && _h !== void 0
            ...
            : null;
    const covAt =
        (_j = coverage === null || coverage === void 0 ? void 0 : coverage.testCountGeneratedAt) !== null &&
        _j !== void 0
            ? _j
            : null;
...
export function buildQualityExportBundle({ coverage, security, quality, npmAudit, report } = {}) {
    ...
    const qualityIssuesNote =
        (_b =
            sanitizedQuality === null || sanitizedQuality === void 0 ? void 0 : sanitizedQuality.qualityIssuesNote) !==
            null && _b !== void 0
            ? _b
            : null;
    ...
    const bundle = {
        ...
        summary: {
            lineCoverage:
                (_e =
                    (_d = coverage === null || coverage === void 0 ? void 0 : coverage.overallCoverage) !== null &&
                    _d !== void 0
                        ? _d
                        : coverage === null || coverage === void 0
                          ? void 0
                    ...
                    : null,
            branchCoverage:
                (_f = coverage === null || coverage === void 0 ? void 0 : coverage.branchCoverage) !== null &&
                _f !== void 0
                    ? _f
                    : null,
            functionCoverage:
                (_g = coverage === null || coverage === void 0 ? void 0 : coverage.functionCoverage) !== null &&
                _g !== void 0
                    ? _g
                    : null,
            statementCoverage:
                (_h = coverage === null || coverage === void 0 ? void 0 : coverage.statementCoverage) !== null &&
                _h !== void 0
                    ? _h
                    : null,
            securityScore:
                (_j = security === null || security === void 0 ? void 0 : security.securityScore) !== null &&
                _j !== void 0
                    ? _j
                    : null,
            qualityScore:
            ...
            dependencyVulnerabilities:
                (_p =
                    (_o =
                        (_m = auditStats === null || auditStats === void 0 ? void 0 : auditStats.vulnerabilityTotal) !==
                            null && _m !== void 0
                            ? _m
                    ...
                    : null,
            npmDependencies:
                (_q = auditStats === null || auditStats === void 0 ? void 0 : auditStats.dependencies) !== null &&
                _q !== void 0
                    ? _q
                    : null,
            npmCritical:
                (_r = auditStats === null || auditStats === void 0 ? void 0 : auditStats.critical) !== null &&
                _r !== void 0
                    ? _r
                    : null,
            npmHigh:
            ...
            engineeringFindings:
                ...
                _t !== void 0
                    ...
                    : null,
            complianceRate:
                (_u = security === null || security === void 0 ? void 0 : security.complianceRate) !== null &&
                _u !== void 0
                    ? _u
                    : null,
            testsPassed:
            ...
            testsTotal:
                (_w = coverage === null || coverage === void 0 ? void 0 : coverage.totalTests) !== null && _w !== void 0
                    ...
                    : null,
            testCountSource:
                (_x = coverage === null || coverage === void 0 ? void 0 : coverage.testCountSource) !== null &&
                _x !== void 0
                    ? _x
                    : null,
            testCountStale:
                (_y = coverage === null || coverage === void 0 ? void 0 : coverage.testCountStale) !== null &&
                _y !== void 0
                    ? _y
                    : false,
            coverageLastRun:
            ...
            jestResultAt:
                ...
                _0 !== void 0
                    ...
                    : null,
            npmAuditAt:
                (_1 = auditStats === null || auditStats === void 0 ? void 0 : auditStats.generatedAt) !== null &&
                _1 !== void 0
                    ? _1
                    : null,
            measuredBaselines:
                (_2 = quality === null || quality === void 0 ? void 0 : quality.measuredBaselines) !== null &&
                _2 !== void 0
                    ? _2
                    : null,
        ...
        hygieneSummary: {
            lineCoverage:
                (_4 =
                    (_3 = coverage === null || coverage === void 0 ? void 0 : coverage.overallCoverage) !== null &&
                    _3 !== void 0
                        ? _3
                        : coverage === null || coverage === void 0
                          ? void 0
            ...
            npmVulnerabilities:
                ...
                _7 !== void 0
                    ...
                    : 0,
            npmDependencies:
                (_8 = auditStats === null || auditStats === void 0 ? void 0 : auditStats.dependencies) !== null &&
                _8 !== void 0
                    ? _8
                    : null,
            securityScore:
                (_9 = security === null || security === void 0 ? void 0 : security.securityScore) !== null &&
                _9 !== void 0
                    ? _9
                    : null,
            qualityScore:
        ...
        exportNotes: dedupeExportNotes([
            ...
            qualityIssuesNote,
            (sanitizedCoverage === null || sanitizedCoverage === void 0 ? void 0 : sanitizedCoverage.freshnessNote) ||
                null
        ])
    };
    return bundle;
