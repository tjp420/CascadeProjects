...
export function resolveSectionProvenance(section) {
    ...
    if (section._source === 'sample')
        return 'repository-audit-live';
    if (section.generatedAt || section.exportNormalized)
...
export function sanitizeCoverageExport(coverage) {
    ...
    return {
        ...
        lastRun: (_b = (_a = clean.lastRun) !== null && _a !== void 0 ? _a : clean.testCountGeneratedAt) !== null && _b !== void 0 ? _b : null,
...
export function sanitizeQualityExport(quality, coverage = null, report = null) {
    ...
    const covTotal = (_b = (_a = coverage === null || coverage === void 0 ? void 0 : coverage.totalTests) !== null && _a !== void 0 ? _a : coverage === null || coverage === void 0 ? void 0 : coverage.passedTests) !== null && _b !== void 0 ? _b : null;
    const qualTotal = (_e = (_d = (_c = clean.totalTests) !== null && _c !== void 0 ? _c : clean.passedTests) !== null && _d !== void 0 ? _d : clean.testsPassed) !== null && _e !== void 0 ? _e : null;
    const covPassed = (_f = coverage === null || coverage === void 0 ? void 0 : coverage.passedTests) !== null && _f !== void 0 ? _f : null;
    const qualPassed = (_h = (_g = clean.passedTests) !== null && _g !== void 0 ? _g : clean.testsPassed) !== null && _h !== void 0 ? _h : null;
    const covAt = (_j = coverage === null || coverage === void 0 ? void 0 : coverage.testCountGeneratedAt) !== null && _j !== void 0 ? _j : null;
    const qualAt = (_k = clean.testCountGeneratedAt) !== null && _k !== void 0 ? _k : null;
    const covLabel = (_l = coverage === null || coverage === void 0 ? void 0 : coverage.jestTestsLabel) !== null && _l !== void 0 ? _l : (covPassed != null && covTotal != null ? `${covPassed}/${covTotal}` : null);
    const qualLabel = (_m = clean.jestTestsLabel) !== null && _m !== void 0 ? _m : (qualPassed != null && qualTotal != null ? `${qualPassed}/${qualTotal}` : null);
    ...
    if (staleRelativeToCoverage && ((_o = clean.issuesFound) !== null && _o !== void 0 ? _o : 0) > 0 && ((_p = coverage === null || coverage === void 0 ? void 0 : coverage.failedTests) !== null && _p !== void 0 ? _p : 0) === 0) {
...
function buildMeasuredBaselinesNote(quality, report = null) {
    ...
    if (catalog == null)
        return null;
    const gateLabel = (report === null || report === void 0 ? void 0 : report.pageSampleSchemaChecked) != null
...
export function buildExportProvenance({ coverage, security, quality, npmAudit } = {}) {
    return {
        ...
        npmAudit: (npmAudit === null || npmAudit === void 0 ? void 0 : npmAudit.error) ? 'error' : (npmAudit ? 'live-npm-audit' : 'missing')
    };
}
/**
...
export function buildQualityExportBundle({ coverage, security, quality, npmAudit, report } = {}) {
    ...
    const sanitizedAudit = sanitizeNpmAuditForQualityExport(npmAudit, (npmAudit === null || npmAudit === void 0 ? void 0 : npmAudit.projectPath) || 'ai-platform');
    const testCountMismatch = (sanitizedQuality === null || sanitizedQuality === void 0 ? void 0 : sanitizedQuality.staleRelativeToCoverage) === true;
    const measuredBaselinesNote = (_a = sanitizedQuality === null || sanitizedQuality === void 0 ? void 0 : sanitizedQuality.measuredBaselinesNote) !== null && _a !== void 0 ? _a : null;
    const qualityIssuesNote = (_b = sanitizedQuality === null || sanitizedQuality === void 0 ? void 0 : sanitizedQuality.qualityIssuesNote) !== null && _b !== void 0 ? _b : null;
    const gatePageSpecsLabel = (report === null || report === void 0 ? void 0 : report.pageSampleSchemaChecked) != null
    ...
    const bundle = {
        ...
        summary: {
            lineCoverage: (_e = (_d = coverage === null || coverage === void 0 ? void 0 : coverage.overallCoverage) !== null && _d !== void 0 ? _d : coverage === null || coverage === void 0 ? void 0 : coverage.lineCoverage) !== null && _e !== void 0 ? _e : null,
            branchCoverage: (_f = coverage === null || coverage === void 0 ? void 0 : coverage.branchCoverage) !== null && _f !== void 0 ? _f : null,
            functionCoverage: (_g = coverage === null || coverage === void 0 ? void 0 : coverage.functionCoverage) !== null && _g !== void 0 ? _g : null,
            statementCoverage: (_h = coverage === null || coverage === void 0 ? void 0 : coverage.statementCoverage) !== null && _h !== void 0 ? _h : null,
            securityScore: (_j = security === null || security === void 0 ? void 0 : security.securityScore) !== null && _j !== void 0 ? _j : null,
            qualityScore: (_l = (_k = quality === null || quality === void 0 ? void 0 : quality.overallScore) !== null && _k !== void 0 ? _k : quality === null || quality === void 0 ? void 0 : quality.qualityScore) !== null && _l !== void 0 ? _l : null,
            dependencyVulnerabilities: (_p = (_o = (_m = auditStats === null || auditStats === void 0 ? void 0 : auditStats.vulnerabilityTotal) !== null && _m !== void 0 ? _m : security === null || security === void 0 ? void 0 : security.npmAuditTotal) !== null && _o !== void 0 ? _o : security === null || security === void 0 ? void 0 : security.openVulnerabilities) !== null && _p !== void 0 ? _p : null,
            npmDependencies: (_q = auditStats === null || auditStats === void 0 ? void 0 : auditStats.dependencies) !== null && _q !== void 0 ? _q : null,
            npmCritical: (_r = auditStats === null || auditStats === void 0 ? void 0 : auditStats.critical) !== null && _r !== void 0 ? _r : null,
            npmHigh: (_s = auditStats === null || auditStats === void 0 ? void 0 : auditStats.high) !== null && _s !== void 0 ? _s : null,
            engineeringFindings: (_t = security === null || security === void 0 ? void 0 : security.openEngineeringFindings) !== null && _t !== void 0 ? _t : null,
            complianceRate: (_u = security === null || security === void 0 ? void 0 : security.complianceRate) !== null && _u !== void 0 ? _u : null,
            testsPassed: (_v = coverage === null || coverage === void 0 ? void 0 : coverage.passedTests) !== null && _v !== void 0 ? _v : null,
            testsTotal: (_w = coverage === null || coverage === void 0 ? void 0 : coverage.totalTests) !== null && _w !== void 0 ? _w : null,
            testCountSource: (_x = coverage === null || coverage === void 0 ? void 0 : coverage.testCountSource) !== null && _x !== void 0 ? _x : null,
            testCountStale: (_y = coverage === null || coverage === void 0 ? void 0 : coverage.testCountStale) !== null && _y !== void 0 ? _y : false,
            coverageLastRun: (_z = coverage === null || coverage === void 0 ? void 0 : coverage.lastRun) !== null && _z !== void 0 ? _z : null,
            jestResultAt: (_0 = coverage === null || coverage === void 0 ? void 0 : coverage.testCountGeneratedAt) !== null && _0 !== void 0 ? _0 : null,
            npmAuditAt: (_1 = auditStats === null || auditStats === void 0 ? void 0 : auditStats.generatedAt) !== null && _1 !== void 0 ? _1 : null,
            measuredBaselines: (_2 = quality === null || quality === void 0 ? void 0 : quality.measuredBaselines) !== null && _2 !== void 0 ? _2 : null,
            gateValidatedPageSpecs: gatePageSpecsLabel,
            ...(testCountMismatch && (sanitizedQuality === null || sanitizedQuality === void 0 ? void 0 : sanitizedQuality.testCountNote)
        ...
        securityHandoffEligible: false,
        hygieneSummary: {
            lineCoverage: (_4 = (_3 = coverage === null || coverage === void 0 ? void 0 : coverage.overallCoverage) !== null && _3 !== void 0 ? _3 : coverage === null || coverage === void 0 ? void 0 : coverage.lineCoverage) !== null && _4 !== void 0 ? _4 : null,
            testsTotal: (_5 = coverage === null || coverage === void 0 ? void 0 : coverage.totalTests) !== null && _5 !== void 0 ? _5 : null,
            testsPassed: (_6 = coverage === null || coverage === void 0 ? void 0 : coverage.passedTests) !== null && _6 !== void 0 ? _6 : null,
            npmVulnerabilities: (_7 = auditStats === null || auditStats === void 0 ? void 0 : auditStats.vulnerabilityTotal) !== null && _7 !== void 0 ? _7 : 0,
            npmDependencies: (_8 = auditStats === null || auditStats === void 0 ? void 0 : auditStats.dependencies) !== null && _8 !== void 0 ? _8 : null,
            securityScore: (_9 = security === null || security === void 0 ? void 0 : security.securityScore) !== null && _9 !== void 0 ? _9 : null,
            qualityScore: (_11 = (_10 = quality === null || quality === void 0 ? void 0 : quality.overallScore) !== null && _10 !== void 0 ? _10 : quality === null || quality === void 0 ? void 0 : quality.qualityScore) !== null && _11 !== void 0 ? _11 : null,
...
export function sanitizeQualitySecurityExport(bundle, options = {}) {
    ...
    if (!bundle || bundle.type !== 'simplebeacon-quality-security-export')
        return bundle;
    const report = options.report || bundle.report || (((_a = bundle.summary) === null || _a === void 0 ? void 0 : _a.gateValidatedPageSpecs)
        ? {
...
export function qualityExportFilename(ext = 'json') {
    ...
    if (ext === 'csv')
        return `quality-security-metrics-${stamp}.csv`;
