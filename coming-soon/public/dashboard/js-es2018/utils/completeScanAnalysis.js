...
export function buildCompleteScanAnalysis({ fileReduction, dataQuality, projectPath } = {}) {
    ...
    const rawTopDirs = ((_a = frPlan === null || frPlan === void 0 ? void 0 : frPlan.safeToDelete) === null || _a === void 0 ? void 0 : _a.topDirectories) || [];
    const { measurable: topSafeDirectories, skippedShells: skippedArtifactDirectories } = partitionArtifactDirectoryEntries(rawTopDirs);
    const benchmarkDirsExcluded = rawTopDirs.filter((entry) => isBenchmarkCachePath(entry.path)).length;
    const analysis = {
        projectPath: projectPath || (fileReduction === null || fileReduction === void 0 ? void 0 : fileReduction.projectRoot) || '',
        fileReduction: frPlan ? {
            safeToDeleteBytes: (_c = (_b = frPlan.totals) === null || _b === void 0 ? void 0 : _b.safeToDeleteBytes) !== null && _c !== void 0 ? _c : null,
            reviewBeforeDeleteBytes: (_e = (_d = frPlan.totals) === null || _d === void 0 ? void 0 : _d.reviewBeforeDeleteBytes) !== null && _e !== void 0 ? _e : null,
            immediateSavingsBytes: (_g = (_f = frPlan.totals) === null || _f === void 0 ? void 0 : _f.estimatedImmediateSavingsBytes) !== null && _g !== void 0 ? _g : null,
            duplicateAssetBytes: (_j = (_h = frPlan.totals) === null || _h === void 0 ? void 0 : _h.duplicateAssetBytes) !== null && _j !== void 0 ? _j : null,
            unusedFileCandidates: (_l = (_k = frPlan.unusedFiles) === null || _k === void 0 ? void 0 : _k.candidates) !== null && _l !== void 0 ? _l : null,
            ...
            reviewLogs: ((_o = (_m = frPlan.reviewBeforeDelete) === null || _m === void 0 ? void 0 : _m.logs) === null || _o === void 0 ? void 0 : _o.slice(0, 8)) || [],
            summaryTable: frPlan.summaryTable || []
        } : null,
        dataQuality: dqExec ? {
            workspacePackages: (_q = (_p = dqExec.workspace) === null || _p === void 0 ? void 0 : _p.packageJsonFiles) !== null && _q !== void 0 ? _q : null,
            unusedDependencies: (_s = (_r = dqExec.workspace) === null || _r === void 0 ? void 0 : _r.unusedDependencies) !== null && _s !== void 0 ? _s : null,
            envInconsistencies: (_u = (_t = dqExec.workspace) === null || _t === void 0 ? void 0 : _t.envInconsistencies) !== null && _u !== void 0 ? _u : null,
            missingEnvKeys: (_w = (_v = dqExec.workspace) === null || _v === void 0 ? void 0 : _v.missingEnvKeys) !== null && _w !== void 0 ? _w : null,
            shapeDriftGroups: (_y = (_x = dqExec.data) === null || _x === void 0 ? void 0 : _x.shapeDriftGroups) !== null && _y !== void 0 ? _y : null,
            credentialsNeedingReview: (_0 = (_z = dqExec.security) === null || _z === void 0 ? void 0 : _z.credentialsNeedingReview) !== null && _0 !== void 0 ? _0 : null,
            piiNeedingReview: (_2 = (_1 = dqExec.security) === null || _1 === void 0 ? void 0 : _1.piiNeedingReview) !== null && _2 !== void 0 ? _2 : null
        } : null,
        priorityActions,
        notes: [
...
export function renderCompleteScanAnalysisPanel(analysis) {
     ...
     * @returns {any}
     */
    const topDirs = ((fr === null || fr === void 0 ? void 0 : fr.topSafeDirectories) || []).map((entry) => `
...
function hasHollowGateFromReport(sb) {
    var _a, _b, _c, _d;
    const ruleScoped = (_c = (_a = sb === null || sb === void 0 ? void 0 : sb.ruleScopedFilesAnalyzed) !== null && _a !== void 0 ? _a : (_b = sb === null || sb === void 0 ? void 0 : sb.scanScope) === null || _b === void 0 ? void 0 : _b.ruleScopedFilesAnalyzed) !== null && _c !== void 0 ? _c : 0;
    return Boolean((_d = sb === null || sb === void 0 ? void 0 : sb.gate) === null || _d === void 0 ? void 0 : _d.pass) && ruleScoped === 0;
}
/**
...
function inferCompleteScanTargetFromHints(bundle, options = {}) {
    ...
    if (!filename.includes('github-cache'))
        return '';
    const slugMatch = filename.match(/github-cache[-_]([a-z0-9._-]+?)(?:-\d{4}-\d{2}-\d{2}|\(\d+\)|\.json)/i);
    if (!slugMatch)
        return '';
    const cloneName = slugMatch[1];
    const sourceRoot = String(options.projectPath
        || bundle.projectPath
        || ((_b = (_a = bundle.results) === null || _a === void 0 ? void 0 : _a.simplebeacon) === null || _b === void 0 ? void 0 : _b.projectRoot)
        || ((_d = (_c = bundle.results) === null || _c === void 0 ? void 0 : _c.simplebeacon) === null || _d === void 0 ? void 0 : _d.platformRoot)
        || '').replace(/\\/g, '/');
    if (isBenchmarkScanTarget(sourceRoot))
        return '';
...
function resolveBenchmarkGateAttestation(sb, hollowGate) {
    var _a, _b, _c, _d, _e;
    if (hollowGate || hasHollowGateFromReport(sb))
        return 'limited-benchmark';
    if (sb === null || sb === void 0 ? void 0 : sb.gateAttestation)
        return sb.gateAttestation;
    ...
    if ((_b = sb === null || sb === void 0 ? void 0 : sb.gate) === null || _b === void 0 ? void 0 : _b.pass) {
        const ruleScoped = (_e = (_c = sb.ruleScopedFilesAnalyzed) !== null && _c !== void 0 ? _c : (_d = sb.scanScope) === null || _d === void 0 ? void 0 : _d.ruleScopedFilesAnalyzed) !== null && _e !== void 0 ? _e : 0;
...
function buildBenchmarkCompleteScanHygieneSummary(bundle, auditFiles) {
    ...
    const rawLlm = (_b = sb === null || sb === void 0 ? void 0 : sb.llmSlopScanRaw) !== null && _b !== void 0 ? _b : (_c = sb === null || sb === void 0 ? void 0 : sb.scanScope) === null || _c === void 0 ? void 0 : _c.llmSlopScanRaw;
    const scannedLlm = (_f = (_d = sb === null || sb === void 0 ? void 0 : sb.llmSlopFilesScanned) !== null && _d !== void 0 ? _d : (_e = sb === null || sb === void 0 ? void 0 : sb.scanScope) === null || _e === void 0 ? void 0 : _e.llmSlopFilesScanned) !== null && _f !== void 0 ? _f : null;
    const reconciledLlm = (_g = sb === null || sb === void 0 ? void 0 : sb.llmSlopScanReconciled) !== null && _g !== void 0 ? _g : (_h = sb === null || sb === void 0 ? void 0 : sb.scanScope) === null || _h === void 0 ? void 0 : _h.llmSlopScanReconciled;
    return {
        simplebeaconGatePass: (_k = (_j = bundle.summary) === null || _j === void 0 ? void 0 : _j.simplebeaconGatePass) !== null && _k !== void 0 ? _k : null,
        simplebeaconGateAttestation: (_m = (_l = bundle.summary) === null || _l === void 0 ? void 0 : _l.simplebeaconGateAttestation) !== null && _m !== void 0 ? _m : null,
        simplebeaconIssues: (_p = (_o = bundle.summary) === null || _o === void 0 ? void 0 : _o.simplebeaconIssues) !== null && _p !== void 0 ? _p : 0,
        complianceFailed: (_r = (_q = bundle.summary) === null || _q === void 0 ? void 0 : _q.complianceFailed) !== null && _r !== void 0 ? _r : 0,
        repositoryFilesTotal: (_v = (_u = (_t = (_s = bundle.summary) === null || _s === void 0 ? void 0 : _s.platformScope) === null || _t === void 0 ? void 0 : _t.repositoryFilesTotal) !== null && _u !== void 0 ? _u : auditFiles) !== null && _v !== void 0 ? _v : null,
        roadmapFiles: (_x = (_w = bundle.summary) === null || _w === void 0 ? void 0 : _w.roadmapFiles) !== null && _x !== void 0 ? _x : null,
        cleanupProjectedFiles: (_z = (_y = bundle.summary) === null || _y === void 0 ? void 0 : _y.cleanupProjectedFiles) !== null && _z !== void 0 ? _z : null,
        ...(((_0 = bundle.summary) === null || _0 === void 0 ? void 0 : _0.cleanupProjectedFilesRaw) != null
            ...
            : {}),
        roadmapMisscoped: ((_2 = (_1 = bundle.results) === null || _1 === void 0 ? void 0 : _1.roadmap) === null || _2 === void 0 ? void 0 : _2.misscopedPlatformCodeWalk) === true,
        codebaseMisscoped: ((_4 = (_3 = bundle.results) === null || _3 === void 0 ? void 0 : _3.codebase) === null || _4 === void 0 ? void 0 : _4.misscopedPlatformCodeWalk) === true,
        fictionJsonFilesScanned: (_7 = (_5 = sb === null || sb === void 0 ? void 0 : sb.fictionJsonFilesScanned) !== null && _5 !== void 0 ? _5 : (_6 = sb === null || sb === void 0 ? void 0 : sb.scanScope) === null || _6 === void 0 ? void 0 : _6.fictionJsonFilesScanned) !== null && _7 !== void 0 ? _7 : null,
...
function sanitizeComplianceForCompleteScan(compliance, gateReport, projectPath, context = {}) {
    ...
    const ruleScoped = (_c = (_a = gateReport === null || gateReport === void 0 ? void 0 : gateReport.ruleScopedFilesAnalyzed) !== null && _a !== void 0 ? _a : (_b = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null || _b === void 0 ? void 0 : _b.ruleScopedFilesAnalyzed) !== null && _c !== void 0 ? _c : 0;
    if (ruleScoped === 0) {
        rules = rules.map((rule) => {
            ...
            if ((rule.id === 'CRED-001' || rule.id === 'LEAK-001') && rule.status === 'pass' && /Scanned 0 path/i.test(rule.evidence || '')) {
                return {
                    ...rule,
                    status: 'skip',
                    evidence: rule.id === 'CRED-001'
...
function resolveRoadmapSummaryFiles(roadmap, auditFiles, summary = {}) {
    ...
    const structure = (_a = roadmap === null || roadmap === void 0 ? void 0 : roadmap.codeAnalysis) === null || _a === void 0 ? void 0 : _a.structure;
    const roadmapScoped = (_e = (_d = (_c = (_b = structure === null || structure === void 0 ? void 0 : structure.totalFilesRaw) !== null && _b !== void 0 ? _b : structure === null || structure === void 0 ? void 0 : structure.totalFiles) !== null && _c !== void 0 ? _c : summary.roadmapFilesRaw) !== null && _d !== void 0 ? _d : summary.roadmapFiles) !== null && _e !== void 0 ? _e : null;
    ...
    if (auditFiles == null || roadmapScoped == null) {
        return {
            roadmapFiles: (_f = structure === null || structure === void 0 ? void 0 : structure.totalFiles) !== null && _f !== void 0 ? _f : summary.roadmapFiles,
    ...
    return {
        roadmapFiles: (_g = structure === null || structure === void 0 ? void 0 : structure.totalFiles) !== null && _g !== void 0 ? _g : roadmapScoped,
        roadmapFilesRaw: summary.roadmapFilesRaw,
        roadmapFilesNote: summary.roadmapFilesNote
    };
}
...
export function sanitizeCompleteScanBundle(bundle, options = {}) {
    ...
    if (!bundle || bundle.type !== 'simplebeacon-complete-scan')
        return bundle;
    ...
    const repositoryFilesTotal = (_b = (_a = next.results.simplebeacon) === null || _a === void 0 ? void 0 : _a.repositoryFilesTotal) !== null && _b !== void 0 ? _b : (_d = (_c = next.results.simplebeacon) === null || _c === void 0 ? void 0 : _c.repositoryInventory) === null || _d === void 0 ? void 0 : _d.totalFiles;
    ...
    nestedOptions.repositoryFilesTotal = (_e = sb === null || sb === void 0 ? void 0 : sb.repositoryFilesTotal) !== null && _e !== void 0 ? _e : (_f = sb === null || sb === void 0 ? void 0 : sb.repositoryInventory) === null || _f === void 0 ? void 0 : _f.totalFiles;
    nestedOptions.gateReport = sb || null;
    const platformRepo = (_j = (_g = sb === null || sb === void 0 ? void 0 : sb.repositoryFilesTotal) !== null && _g !== void 0 ? _g : (_h = sb === null || sb === void 0 ? void 0 : sb.repositoryInventory) === null || _h === void 0 ? void 0 : _h.totalFiles) !== null && _j !== void 0 ? _j : null;
    next.summary.platformScope = {
        reportHealth: benchmarkScan
            ? 'benchmark-clone-scan'
            : (((_k = sb === null || sb === void 0 ? void 0 : sb.scanScope) === null || _k === void 0 ? void 0 : _k.reportHealth) || 'platform-scoped'),
        mockSampleFiles: (_l = sb === null || sb === void 0 ? void 0 : sb.mockSampleFiles) !== null && _l !== void 0 ? _l : null,
        ...
        productPlatformRoot: productPlatformRoot || undefined,
        simplebeaconGatePass: (benchmarkScan && hollowGate)
            ? null
            : ((_p = (_o = (_m = sb === null || sb === void 0 ? void 0 : sb.gate) === null || _m === void 0 ? void 0 : _m.pass) !== null && _o !== void 0 ? _o : next.summary.simplebeaconGatePass) !== null && _p !== void 0 ? _p : null),
        simplebeaconGateAttestation: (benchmarkScan && hollowGate)
            ? 'limited-benchmark'
            : benchmarkScan
                ? resolveBenchmarkGateAttestation(sb, hollowGate)
                : hollowGate
                    ? 'limited-scope'
                    : ((sb === null || sb === void 0 ? void 0 : sb.gateAttestation) || (((_q = sb === null || sb === void 0 ? void 0 : sb.gate) === null || _q === void 0 ? void 0 : _q.pass) ? 'platform-gate-pass' : ((_r = sb === null || sb === void 0 ? void 0 : sb.gate) === null || _r === void 0 ? void 0 : _r.pass) === false ? 'fail' : 'not-evaluated')),
        handoffEligible: false
    };
    if (benchmarkScan) {
    ...
    if (next.results.fileReduction || next.results.dataQuality) {
        ...
        if (benchmarkScan && next.completeScanAnalysis) {
            ...
            const notes = (next.completeScanAnalysis.notes || []).filter((note) => {
                const text = String(note);
                if (/exclude(s)?\s+github-cache/i.test(text))
                    return false;
            ...
            notes.unshift('Scan target is an OSS clone under github-cache/ — not Simplebeacon product code. Gate rules for ai-platform paths did not apply.');
    ...
    if (next.results.npmAudit) {
        next.results.npmAudit = sanitizeNpmAuditExport(next.results.npmAudit, next.projectPath, {
            repositoryFilesTotal: (_w = sb === null || sb === void 0 ? void 0 : sb.repositoryFilesTotal) !== null && _w !== void 0 ? _w : (_x = sb === null || sb === void 0 ? void 0 : sb.repositoryInventory) === null || _x === void 0 ? void 0 : _x.totalFiles,
            gateReport: sb || null
        });
    }
    if (next.results.compliance && sb) {
        ...
        next.results.compliance = sanitizeComplianceForCompleteScan(next.results.compliance, sb, next.projectPath, { benchmarkScan, hollowGate, productPlatformRoot });
    }
    if (next.results.cleanupAssistant) {
        next.results.cleanupAssistant = sanitizeCleanupBriefExport(next.results.cleanupAssistant, {
            projectPath: next.projectPath,
            repositoryFilesTotal: (_y = sb === null || sb === void 0 ? void 0 : sb.repositoryFilesTotal) !== null && _y !== void 0 ? _y : (_z = sb === null || sb === void 0 ? void 0 : sb.repositoryInventory) === null || _z === void 0 ? void 0 : _z.totalFiles,
            gateReport: sb || null
        });
    }
    if (next.results.dataQuality) {
        next.results.dataQuality = sanitizeDataCleanupReportExport(next.results.dataQuality, {
            projectPath: next.projectPath,
            repositoryFilesTotal: (_0 = sb === null || sb === void 0 ? void 0 : sb.repositoryFilesTotal) !== null && _0 !== void 0 ? _0 : (_1 = sb === null || sb === void 0 ? void 0 : sb.repositoryInventory) === null || _1 === void 0 ? void 0 : _1.totalFiles,
            gateReport: sb || null
        });
    }
    if (next.results.fileReduction) {
        next.results.fileReduction = sanitizeDataCleanupReportExport(next.results.fileReduction, {
            projectPath: next.projectPath,
            repositoryFilesTotal: (_2 = sb === null || sb === void 0 ? void 0 : sb.repositoryFilesTotal) !== null && _2 !== void 0 ? _2 : (_3 = sb === null || sb === void 0 ? void 0 : sb.repositoryInventory) === null || _3 === void 0 ? void 0 : _3.totalFiles,
            gateReport: sb || null
        });
    }
    ...
    next.summary = {
        ...
        ...(sbFinal ? {
            simplebeaconGatePass: (_5 = (_4 = sbFinal.gate) === null || _4 === void 0 ? void 0 : _4.pass) !== null && _5 !== void 0 ? _5 : next.summary.simplebeaconGatePass,
            simplebeaconIssues: (_8 = (_6 = sbFinal.issueCount) !== null && _6 !== void 0 ? _6 : (_7 = sbFinal.gate) === null || _7 === void 0 ? void 0 : _7.blockingCount) !== null && _8 !== void 0 ? _8 : ((_10 = (_9 = sbFinal.rawIssues) === null || _9 === void 0 ? void 0 : _9.length) !== null && _10 !== void 0 ? _10 : next.summary.simplebeaconIssues)
        } : {}),
        ...((complianceResult === null || complianceResult === void 0 ? void 0 : complianceResult.summary) || ((_11 = complianceResult === null || complianceResult === void 0 ? void 0 : complianceResult.checklist) === null || _11 === void 0 ? void 0 : _11.summary) ? {
            compliancePassed: (_14 = ((_13 = (_12 = complianceResult.checklist) === null || _12 === void 0 ? void 0 : _12.summary) !== null && _13 !== void 0 ? _13 : complianceResult.summary).passed) !== null && _14 !== void 0 ? _14 : next.summary.compliancePassed,
            complianceFailed: (_17 = ((_16 = (_15 = complianceResult.checklist) === null || _15 === void 0 ? void 0 : _15.summary) !== null && _16 !== void 0 ? _16 : complianceResult.summary).failed) !== null && _17 !== void 0 ? _17 : next.summary.complianceFailed
        } : {}),
        ...((consolidationResult === null || consolidationResult === void 0 ? void 0 : consolidationResult.summary) ? {
            consolidationDuplicateGroups: (_19 = (_18 = consolidationResult.summary.exactDuplicateGroups) !== null && _18 !== void 0 ? _18 : consolidationResult.summary.mergeCandidates) !== null && _19 !== void 0 ? _19 : next.summary.consolidationDuplicateGroups
        } : {}),
        ...(mockScanResult ? {
            fictionKpiHits: (mockScanResult.fictionIssues || []).reduce((sum, issue) => sum + (issue.count || 1), 0),
            fictionDigestTrust: (_20 = mockScanResult.digestTrust) !== null && _20 !== void 0 ? _20 : next.summary.fictionDigestTrust
        } : {})
    };
    if (next.summary.platformScope) {
        next.summary.platformScope = {
            ...
            handoffEligible: false,
            securityHandoffEligible: false,
            scanPaths: (sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.scanPaths) || next.summary.platformScope.scanPaths,
            simplebeaconGatePass: (_23 = (_21 = next.summary.simplebeaconGatePass) !== null && _21 !== void 0 ? _21 : (_22 = sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.gate) === null || _22 === void 0 ? void 0 : _22.pass) !== null && _23 !== void 0 ? _23 : null,
            simplebeaconGateAttestation: benchmarkScan && hollowGate
                ? 'limited-benchmark'
                : benchmarkScan
                    ? resolveBenchmarkGateAttestation(sbFinal, hollowGate)
                    : ((sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.gateAttestation) || (((_24 = sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.gate) === null || _24 === void 0 ? void 0 : _24.pass) ? 'platform-gate-pass' : ((_25 = sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.gate) === null || _25 === void 0 ? void 0 : _25.pass) === false ? 'fail' : next.summary.simplebeaconGateAttestation))
        };
    }
    const auditFiles = (_26 = sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.repositoryFilesTotal) !== null && _26 !== void 0 ? _26 : (_27 = sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.repositoryInventory) === null || _27 === void 0 ? void 0 : _27.totalFiles;
    const cleanupExplorer = (_32 = (_31 = (_29 = (_28 = cleanupResult === null || cleanupResult === void 0 ? void 0 : cleanupResult.inventory) === null || _28 === void 0 ? void 0 : _28.explorerInventoryRaw) !== null && _29 !== void 0 ? _29 : (_30 = cleanupResult === null || cleanupResult === void 0 ? void 0 : cleanupResult.inventory) === null || _30 === void 0 ? void 0 : _30.totalFiles) !== null && _31 !== void 0 ? _31 : next.summary.cleanupProjectedFilesRaw) !== null && _32 !== void 0 ? _32 : next.summary.cleanupProjectedFiles;
    if (auditFiles != null && cleanupExplorer != null && cleanupExplorer > auditFiles) {
        ...
        next.summary.cleanupProjectedFilesNote = ((_33 = cleanupResult === null || cleanupResult === void 0 ? void 0 : cleanupResult.inventory) === null || _33 === void 0 ? void 0 : _33.inventoryNote)
    ...
    else if (((_34 = cleanupResult === null || cleanupResult === void 0 ? void 0 : cleanupResult.inventory) === null || _34 === void 0 ? void 0 : _34.auditRepositoryFiles) != null) {
        next.summary.cleanupProjectedFiles = cleanupResult.inventory.auditRepositoryFiles;
    }
    else if (((_35 = cleanupResult === null || cleanupResult === void 0 ? void 0 : cleanupResult.inventory) === null || _35 === void 0 ? void 0 : _35.totalFiles) != null) {
    ...
    if (!benchmarkScan) {
        const exportNotes = [];
        exportNotes.push('securityHandoffEligible is false — complete scan bundle is hygiene aggregation only, not vendor security handoff.');
        ...
        if (auditFiles != null && cleanupExplorer != null && cleanupExplorer > auditFiles * 2) {
            exportNotes.push(`Cleanup brief inventory (${Number(cleanupExplorer).toLocaleString()} files) includes un-walked regenerable shells; gate audit profile counted ${Number(auditFiles).toLocaleString()} files.`);
        }
        if (((_37 = next.completeScanAnalysis) === null || _37 === void 0 ? void 0 : _37.artifactProfile) === 'mixed-no-safe-delete') {
            exportNotes.push('No phase-1 safe-delete bytes — use priorityActions for env keys, sync I/O review, and optional duplicate consolidation.');
        }
        const credentialScanned = (_39 = (_38 = sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.credentialScanned) !== null && _38 !== void 0 ? _38 : sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.productionLeakScanned) !== null && _39 !== void 0 ? _39 : null;
        const gateProfile = (_41 = (_40 = sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.scanScope) === null || _40 === void 0 ? void 0 : _40.profile) !== null && _41 !== void 0 ? _41 : null;
        if (auditFiles != null && credentialScanned != null && credentialScanned < auditFiles) {
            exportNotes.push(`Gate content-scanned ${Number(credentialScanned).toLocaleString()} production-path file(s) — ${Number(auditFiles - credentialScanned).toLocaleString()} metadata-only path(s) in full-tree inventory of ${Number(auditFiles).toLocaleString()}.`);
        }
        const fictionJson = (_42 = sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.fictionJsonFilesScanned) !== null && _42 !== void 0 ? _42 : (_43 = sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.scanScope) === null || _43 === void 0 ? void 0 : _43.fictionJsonFilesScanned;
        const fictionSamples = (_44 = sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.fictionSampleFilesScanned) !== null && _44 !== void 0 ? _44 : sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.mockSampleFiles;
        ...
        if (gateProfile) {
            exportNotes.push(`Gate rule bundle profile: ${gateProfile} — pair complete scan bundle with json/simplebeacon-gate.json for handoff evidence.`);
        }
        const blockingCount = (_47 = (_46 = (_45 = sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.gate) === null || _45 === void 0 ? void 0 : _45.blockingCount) !== null && _46 !== void 0 ? _46 : sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.issueCount) !== null && _47 !== void 0 ? _47 : null;
        if (((_48 = sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.gate) === null || _48 === void 0 ? void 0 : _48.pass) === false && (blockingCount !== null && blockingCount !== void 0 ? blockingCount : 0) > 0) {
            exportNotes.push(`Gate FAIL — ${Number(blockingCount).toLocaleString()} blocking finding(s) — complete scan bundle aggregates hygiene only; see json/simplebeacon-gate.json for production-path evidence.`);
        }
        else if ((_49 = sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.gate) === null || _49 === void 0 ? void 0 : _49.pass) {
            exportNotes.push('Complete scan gate pass is a hygiene bundle — not Simplebeacon vendor security handoff clearance by itself.');
        }
        if (((_50 = sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.scanScope) === null || _50 === void 0 ? void 0 : _50.jestExecutedDuringScan) === false || (sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.jestBaselineChecked) === false) {
            exportNotes.push('Jest was not run during the gate step — run `npm test` or `simplebeacon:full` before vendor handoff sign-off.');
        }
        exportNotes.push('Compliance checklist attests rule rows only — handoffEligible remains false until operator sign-off.');
        const hygieneSummary = {
            completeScanHealthStatus: next.summary.simplebeaconGatePass && ((_51 = next.summary.complianceFailed) !== null && _51 !== void 0 ? _51 : 1) === 0
                ? 'hygiene-pass-not-handoff'
                : 'review-required',
            enginesRun: (_55 = (_53 = (_52 = next.enginesRun) === null || _52 === void 0 ? void 0 : _52.length) !== null && _53 !== void 0 ? _53 : (_54 = next.summary) === null || _54 === void 0 ? void 0 : _54.stepCount) !== null && _55 !== void 0 ? _55 : null,
            stepsCompleted: (_57 = (_56 = next.summary) === null || _56 === void 0 ? void 0 : _56.stepsCompleted) !== null && _57 !== void 0 ? _57 : null,
            gatePass: (_60 = (_58 = next.summary.simplebeaconGatePass) !== null && _58 !== void 0 ? _58 : (_59 = sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.gate) === null || _59 === void 0 ? void 0 : _59.pass) !== null && _60 !== void 0 ? _60 : null,
            blockingCount,
            ...
            jestBaselineChecked: (sbFinal === null || sbFinal === void 0 ? void 0 : sbFinal.jestBaselineChecked) === false ? false : undefined,
        ...
        next = {
            ...
            securityHandoffEligible: false,
            handoffEligible: false,
            completeScanHealthStatus: next.summary.simplebeaconGatePass && ((_64 = next.summary.complianceFailed) !== null && _64 !== void 0 ? _64 : 1) === 0
                ? 'hygiene-pass-not-handoff'
                : 'review-required',
            scanScope: {
                ...
                ...(gateProfile ? { gateRuleBundleProfile: gateProfile } : {}),
                completeScanNote: 'Complete scan bundle — pair with json/simplebeacon-gate.json and per-engine JSON exports for handoff evidence.'
            },
            hygieneSummary,
...
export function sanitizeRoadmapExport(roadmap, options = {}) {
    ...
    if (!roadmap || roadmap.type !== 'dynamic-project-roadmap-analysis')
        return roadmap;
    const benchmarkScan = options.benchmarkScan
        ...
        || isBenchmarkCachePath(roadmap.sourceProjectPath || ((_a = roadmap.projectStructure) === null || _a === void 0 ? void 0 : _a.projectRoot) || '');
    ...
    const sampleInternal = ((deps === null || deps === void 0 ? void 0 : deps.sampleInternal) || []).filter((edge) => !roadmapPathTouchesBenchmark(String(edge).split(' -> ')[0]));
    const phase2 = (_e = roadmap.codeAnalysis) === null || _e === void 0 ? void 0 : _e.phase2;
    let nextPhase2 = phase2;
    if ((_f = phase2 === null || phase2 === void 0 ? void 0 : phase2.dependencyGraph) === null || _f === void 0 ? void 0 : _f.edges) {
        const edges = phase2.dependencyGraph.edges.filter((edge) => !roadmapPathTouchesBenchmark(edge.from) && !roadmapPathTouchesBenchmark(edge.to));
        nextPhase2 = {
            ...phase2,
            dependencyGraph: {
    ...
    for (const [name, category] of Object.entries(((_g = roadmap.projectStructure) === null || _g === void 0 ? void 0 : _g.mainCategories) || {})) {
        if (roadmapPathTouchesBenchmark(name))
            continue;
    ...
    if (((_j = next.strategicInsights) === null || _j === void 0 ? void 0 : _j.sourceMetrics) && staleWalk && ((_k = next.projectStructure) === null || _k === void 0 ? void 0 : _k.totalFiles) != null) {
    ...
    if (staleWalk || sampleInternal.length !== ((deps === null || deps === void 0 ? void 0 : deps.sampleInternal) || []).length || benchmarkScan) {
