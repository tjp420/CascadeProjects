...
function resolveNpmAuditGateContext(audit, options = {}) {
    ...
    const credentialScanned =
        (_j =
            (_h =
                (_g = gateReport.credentialScanned) !== null && _g !== void 0
                    ? _g
                    : gateReport.productionLeakScanned) !== null && _h !== void 0
                ? _h
                        ...
                        (_m =
                            (_l =
                                (_k = gateReport.scanScope) === null || _k === void 0
                                    ? void 0
                                    : _k.fullDirectoryStats) === null || _l === void 0
                                ? void 0
                            ...
                            : (_p =
                                    (_o = gateReport.scanScope) === null || _o === void 0
                                        ? void 0
                                        : _o.fullDirectoryStats) === null || _p === void 0
                              ? void 0
    ...
    const gateProfile =
        (_x =
            (_w =
                (_v = (_u = gateReport.scanScope) === null || _u === void 0 ? void 0 : _u.profile) !== null &&
                _v !== void 0
                    ? _v
    ...
    const fictionSampleFilesScanned =
        (_6 =
            (_5 =
                (_3 =
                    (_2 = gateReport.fictionSampleFilesScanned) !== null && _2 !== void 0
                        ? _2
                        : gateReport.mockSampleFiles) !== null && _3 !== void 0
                    ? _3
...
function buildNpmAuditHygieneSummary(audit, context = {}) {
    ...
    return {
        ...
        optionalDependencies:
            (_m =
                (_l = (_k = audit.dependencies) === null || _k === void 0 ? void 0 : _k.optional) !== null &&
                _l !== void 0
                    ? _l
...
function buildProductNpmAuditScanScope(audit, options = {}) {
    ...
    return {
        ...
        reportHealth:
            ((_a = audit.scanScope) === null || _a === void 0 ? void 0 : _a.reportHealth) || 'platform-scoped',
...
function buildNpmAuditExportNotes(audit, context = {}) {
    ...
    if (supplyChainStatus === 'pass' && deps != null) {
        ...
        if (!benchmarkScan && !skipped) {
            ...
            const optional =
                (_h = (_g = audit.dependencies) === null || _g === void 0 ? void 0 : _g.optional) !== null &&
                _h !== void 0
                    ? _h
...
export function sanitizeNpmAuditExport(audit, projectPath = '', options = {}) {
    ...
    next.summary = {
        ...summary,
        total:
            (_j = (_h = summary.total) !== null && _h !== void 0 ? _h : summary.vulnerabilityTotal) !== null &&
            _j !== void 0
                ? _j
                : 0,
        vulnerabilityTotal:
            (_l = (_k = summary.vulnerabilityTotal) !== null && _k !== void 0 ? _k : summary.total) !== null &&
            _l !== void 0
                ? _l
                : 0,
        dependencies: deps
