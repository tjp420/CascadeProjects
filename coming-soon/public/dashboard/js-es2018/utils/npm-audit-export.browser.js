...
function resolveNpmAuditGateContext(audit, options = {}) {
  ...
  const hygiene =
    (audit === null || audit === void 0 ? void 0 : audit.hygieneSummary) || {};
  const scanScope =
    (audit === null || audit === void 0 ? void 0 : audit.scanScope) || {};
  ...
  const gatePass =
    (_9 =
      (_8 =
        (_7 = gateReport.gate) === null || _7 === void 0 ? void 0 : _7.pass) !==
        null && _8 !== void 0
        ? _8
  ...
  const blockingCount =
    (_13 =
      (_12 =
        (_11 =
          (_10 = gateReport.gate) === null || _10 === void 0
            ? void 0
            : _10.blockingCount) !== null && _11 !== void 0
          ? _11
...
function buildNpmAuditHygieneSummary(audit, context = {}) {
  ...
  return {
    ...
    optionalDependencies:
      (_m =
        (_l =
          (_k = audit.dependencies) === null || _k === void 0
            ? void 0
            : _k.optional) !== null && _l !== void 0
          ? _l
    ...
    supplyChainStatus:
      (_o = context.supplyChainStatus) !== null && _o !== void 0
        ? _o
        : resolveSupplyChainStatus(audit),
    auditPackageJson:
      (_q =
        (_p = context.packageJsonPath) !== null && _p !== void 0
          ? _p
          : audit.packageJsonPath) !== null && _q !== void 0
        ? _q
        : null,
    ...
    ((_r = audit.hygieneSummary) === null || _r === void 0
      ? void 0
      : _r.jestBaselineChecked) === false
...
function buildProductNpmAuditScanScope(audit, options = {}) {
  ...
  return {
    ...
    reportHealth:
      ((_a = audit.scanScope) === null || _a === void 0
        ? void 0
        : _a.reportHealth) || "platform-scoped",
    securityHandoffEligible: false,
    ...(gateTotal != null ? { gateRepositoryFilesTotal: gateTotal } : {}),
    ...(gateProfile ? { gateRuleBundleProfile: gateProfile } : {}),
    supplyChainNote:
      ((_b = audit.scanScope) === null || _b === void 0
        ? void 0
        : _b.supplyChainNote) ||
...
function buildNpmAuditExportNotes(audit, context = {}) {
  ...
  if (supplyChainStatus === "pass" && deps != null) {
    ...
    if (!benchmarkScan && !skipped) {
      ...
      if (
        gatePass === false &&
        (blockingCount !== null && blockingCount !== void 0
          ? blockingCount
          : 0) > 0
      ) {
        notes.push(
      ...
      const optional =
        (_h =
          (_g = audit.dependencies) === null || _g === void 0
            ? void 0
            : _g.optional) !== null && _h !== void 0
          ? _h
...
export function sanitizeNpmAuditExport(audit, projectPath = "", options = {}) {
  ...
  next.summary = {
    ...
    total:
      (_j =
        (_h = summary.total) !== null && _h !== void 0
          ? _h
          : summary.vulnerabilityTotal) !== null && _j !== void 0
        ? _j
        : 0,
    vulnerabilityTotal:
      (_l =
        (_k = summary.vulnerabilityTotal) !== null && _k !== void 0
          ? _k
          : summary.total) !== null && _l !== void 0
        ? _l
        : 0,
    dependencies: deps,
  };
