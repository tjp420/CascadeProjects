...
function resolveIntentionalPairsExcludedCount(summaryBase, pairExclusions, rawMergeCount, mergeCandidatesLength) {
    ...
    const fromPairs =
        (_a =
            pairExclusions === null || pairExclusions === void 0 ? void 0 : pairExclusions.intentionalPairsExcluded) !==
            null && _a !== void 0
            ? _a
            : 0;
...
function resolveBenchmarkConsolidationHealth(summary) {
    var _a, _b;
    const mergeN =
        (_a = summary === null || summary === void 0 ? void 0 : summary.mergeCandidates) !== null && _a !== void 0
            ? _a
            : 0;
    const savings =
...
function buildBenchmarkConsolidationExportNotes(summary, pairExclusions) {
    ...
    const intentional = Math.max(
        (_a =
            ...
            ? _a
            : 0,
        (_b = summary === null || summary === void 0 ? void 0 : summary.intentionalPairsExcluded) !== null &&
            _b !== void 0
            ? _b
            : 0,
    ...
    if (
        ((_f = summary === null || summary === void 0 ? void 0 : summary.potentialSavingsBytes) !== null &&
        _f !== void 0
            ? _f
            : 0) === 0
    ) {
...
function filterAdvancedAnalysis(analysis, benchmarkScan) {
    ...
    ).filter(group => benchmarkScan || !(group.files || []).every(file => consolidationPathTouchesExcluded(file.path)));
    return {
        ...analysis,
        fuzzyNearDuplicates: {
...
function resolveConsolidationGateContext(scan, options = {}) {
        ...
        (_y =
            (_w =
                (_v =
                    (_s =
                        (_r =
                            (_q = gateReport.scanScope) === null || _q === void 0 ? void 0 : _q.fullDirectoryStats) ===
                            null || _r === void 0
                            ? void 0
    ...
    const gateProfile =
        (_4 =
            (_2 =
                (_0 = (_z = gateReport.scanScope) === null || _z === void 0 ? void 0 : _z.profile) !== null &&
                _0 !== void 0
                    ? _0
...
function buildProductConsolidationExportNotes(scan, ephemeralExcluded, context = {}) {
    ...
    const repoTotal =
        (_b = (_a = scan.summary) === null || _a === void 0 ? void 0 : _a.repositoryFilesTotal) !== null &&
        _b !== void 0
            ? _b
            : (_c = scan.repositoryInventory) === null || _c === void 0
              ...
              : _c.totalFiles;
    const repoAudited =
        (_e = (_d = scan.summary) === null || _d === void 0 ? void 0 : _d.repositoryFilesAudited) !== null &&
        _e !== void 0
            ? _e
    ...
    if (
        ((_v = (_u = scan.summary) === null || _u === void 0 ? void 0 : _u.exactDuplicateGroups) !== null &&
        _v !== void 0
            ? _v
            : 0) === 0 &&
    ...
    if (
        ((_z = (_y = scan.summary) === null || _y === void 0 ? void 0 : _y.potentialSavingsBytes) !== null &&
        _z !== void 0
            ? _z
            : 0) === 0
    ) {
...
export function sanitizeConsolidationExport(scan, options = {}) {
    ...
    const rawFuzzyPairExclusions = !benchmarkScan
        ? countExcludedFuzzyPairs(
              ((_d = rawAdvanced === null || rawAdvanced === void 0 ? void 0 : rawAdvanced.fuzzyNearDuplicates) ===
                  null || _d === void 0
                  ? void 0
                  : _d.pairs) || []
          )
        ...
        ...(benchmarkScan
            ? {
                  ...
                  hygieneSummary: {
                      ...
                      intentionalPairsExcluded,
                      repositoryFilesTotal:
                          (_s = repoRaw !== null && repoRaw !== void 0 ? repoRaw : summaryBase.repositoryFilesTotal) !==
                              null && _s !== void 0
                              ? _s
                              : null,
