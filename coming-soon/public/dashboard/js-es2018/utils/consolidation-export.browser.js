 ...
 * @returns {any}
 */
function applyRedactedConsolidationPaths(
  scan,
  projectPath,
  productPlatformRoot,
) {
  ...
  return {
    ...
    scanTargetRoot: redact(
      scan.scanTargetRoot || projectPath || scan.projectRoot,
    ),
    ...(scan.platformRoot ? { platformRoot: redact(scan.platformRoot) } : {}),
    ...(scan.productPlatformRoot
      ? { productPlatformRoot: redact(scan.productPlatformRoot) }
      : {}),
 ...
 * @returns {any}
 */
function isMonorepoPlatformAliasPair(
  pathA,
  pathB,
  platformDirName = "ai-platform",
) {
  ...
  return (
    (a.startsWith(prefix) && b === stripPrefix(a)) ||
    (b.startsWith(prefix) && a === stripPrefix(b))
  );
}
/**
...
function isIntentionalMcpExamplePair(pathA, pathB) {
   ...
   */
  const isMcpConfig = (p) =>
    p.endsWith("mcp.json") || /\/examples\/mcp\//.test(p);
...
function isConsolidationExcludedPair(pathA, pathB) {
  if (
    isEphemeralConsolidationPath(pathA) ||
    isEphemeralConsolidationPath(pathB)
  )
    return true;
...
function filterFuzzyPairs(pairs = []) {
  return pairs.filter(
    (pair) => !isConsolidationExcludedPair(pair.fileA, pair.fileB),
  );
}
/**
...
function resolveConsolidationProjectPath(scan, options = {}) {
  ...
  const explicit = String(
    options.projectPath ||
      ...
      scan.projectPath ||
      scan.projectRoot ||
      ((_a = scan.repositoryInventory) === null || _a === void 0
        ? void 0
        : _a.projectRoot) ||
      "",
  ).replace(/\\/g, "/");
...
function dedupeExportNotes(notes = []) {
  ...
  for (const note of notes) {
    ...
    const scopeKey = /consolidation export scoped to github-cache/i.test(
      normalized,
    )
              ...
              : /intentional cjs\/browser mirrors/i.test(normalized)
                ...
                : /securityhandoffeligible is false/i.test(normalized)
                  ...
                  : /gate content-scanned/i.test(normalized)
                    ...
                    : /json file\(s\) hashed for exact duplicates/i.test(
                          normalized,
                        )
...
function resolveIntentionalPairsExcludedCount(
  ...
  const fromPairs =
    (_a =
      ...
      : 0;
  const fromDiff =
    rawMergeCount > mergeCandidatesLength
      ? rawMergeCount - mergeCandidatesLength
      : 0;
  const fromSummary =
    (_b = summaryBase.intentionalPairsExcluded) !== null && _b !== void 0
      ? _b
      : 0;
  const fromFuzzy =
    (_c = summaryBase.fuzzyPairsExcluded) !== null && _c !== void 0 ? _c : 0;
...
function reconcileLegacyConsolidationCounts(summary = {}) {
  ...
  let benchmarkCacheCandidatesExcluded =
    (_a = summary.benchmarkCacheCandidatesExcluded) !== null && _a !== void 0
      ? _a
      : 0;
  let fuzzyPairsExcluded =
    (_b = summary.fuzzyPairsExcluded) !== null && _b !== void 0 ? _b : 0;
  if (
    benchmarkCacheCandidatesExcluded > 0 &&
    ((_c = summary.exactDuplicateGroups) !== null && _c !== void 0 ? _c : 0) ===
      0 &&
...
function rewriteProductScopedText(text, benchmarkScan) {
  ...
  return String(text)
    ...
    .replace(
      /\(includes github-cache\/\)/gi,
      "(OSS clone under github-cache/)",
    );
}
/**
...
function consolidationCandidateTouchesExcludedExport(candidate) {
   ...
   */
  const paths = (
    (candidate === null || candidate === void 0 ? void 0 : candidate.files) ||
    []
  )
  ...
  const mergeN =
    (_a =
      summary === null || summary === void 0
        ? void 0
        : summary.mergeCandidates) !== null && _a !== void 0
      ? _a
      : 0;
  const savings =
    (_b =
      summary === null || summary === void 0
        ? void 0
        : summary.potentialSavingsBytes) !== null && _b !== void 0
      ? _b
      : 0;
...
function buildBenchmarkConsolidationExportNotes(summary, pairExclusions) {
  ...
  const intentional = Math.max(
    ...
    (_b =
      summary === null || summary === void 0
        ? void 0
        : summary.intentionalPairsExcluded) !== null && _b !== void 0
      ? _b
      : 0,
    ((_c =
      summary === null || summary === void 0
        ? void 0
        : summary.browserMirrorPairsExcluded) !== null && _c !== void 0
      ? _c
      : 0) +
      ((_d =
        summary === null || summary === void 0
          ? void 0
          : summary.mcpExamplePairsExcluded) !== null && _d !== void 0
        ? _d
        : 0),
  );
  if (intentional > 0) {
  ...
  if (
    ((_e =
      summary === null || summary === void 0
        ? void 0
        : summary.mergeCandidates) !== null && _e !== void 0
      ? _e
      : 0) === 0
  ) {
    notes.push(
  ...
  if (
    ((_f =
      summary === null || summary === void 0
        ? void 0
        : summary.potentialSavingsBytes) !== null && _f !== void 0
      ? _f
      : 0) === 0
  ) {
    notes.push(
      "Measured potential savings are 0B — not a delete/merge approval.",
    );
  }
  notes.push(
 ...
 * @returns {any}
 */
function assembleBenchmarkConsolidationExportNotes(
  existingNotes = [],
  summary,
  pairExclusions,
) {
  const dynamic = buildBenchmarkConsolidationExportNotes(
    summary,
    pairExclusions,
  );
  const scopeNotes = [
  ...
  const filtered = dedupeExportNotes(existingNotes).filter((note) => {
    ...
    if (
      /Restart the dashboard|~2,200 files|includes github-cache\/\)/i.test(text)
    )
      return false;
...
function filterAdvancedAnalysis(analysis, benchmarkScan) {
  ...
  const fuzzyPairs = filterFuzzyPairs(
    ((_a = analysis.fuzzyNearDuplicates) === null || _a === void 0
      ? void 0
      : _a.pairs) || [],
  ).filter(
    (pair) =>
  ...
  const patternGroups = (
    ...
    (group) =>
      ...
      !(group.files || []).every((file) =>
        consolidationPathTouchesExcluded(file.path),
      ),
  );
  return {
    ...analysis,
  ...
  return {
    ...
    fictionSampleFilesScanned:
      (_15 =
        (_13 =
          (_11 =
            (_10 = gateReport.fictionSampleFilesScanned) !== null &&
            _10 !== void 0
              ? _10
 ...
 * @returns {any}
 */
function buildProductConsolidationHygieneSummary(
  summaryBase,
  scan,
  options = {},
) {
  ...
  return {
    ...
    mergeCandidates:
      (_g = summaryBase.mergeCandidates) !== null && _g !== void 0 ? _g : 0,
    potentialSavingsBytes:
      (_h = summaryBase.potentialSavingsBytes) !== null && _h !== void 0
        ? _h
        : 0,
    exactDuplicateGroups:
      (_j = summaryBase.exactDuplicateGroups) !== null && _j !== void 0
        ? _j
        : 0,
    jsonFilesAnalyzed:
      (_m =
    ...
    ((_t = scan.hygieneSummary) === null || _t === void 0
      ? void 0
      : _t.jestBaselineChecked) === false
 ...
 * @returns {any}
 */
function buildProductConsolidationExportNotes(
  scan,
  ephemeralExcluded,
  context = {},
) {
  ...
  const repoTotal =
    (_b =
      (_a = scan.summary) === null || _a === void 0
        ? void 0
  ...
  const repoAudited =
    (_e =
      (_d = scan.summary) === null || _d === void 0
        ? void 0
        : _d.repositoryFilesAudited) !== null && _e !== void 0
      ? _e
  ...
  const profile =
    ((_f = scan.repositoryInventory) === null || _f === void 0
      ? void 0
      : _f.profile) ||
  ...
  const jsonN =
    (_h =
      (_g = scan.summary) === null || _g === void 0
        ? void 0
        : _g.jsonFilesAnalyzed) !== null && _h !== void 0
      ? _h
  ...
  const sampleN =
    (_l =
      (_k = scan.summary) === null || _k === void 0
        ? void 0
        : _k.sampleDataFilesAnalyzed) !== null && _l !== void 0
      ? _l
  ...
  const aliasExcluded =
    ((_p =
      (_o = scan.summary) === null || _o === void 0
        ? void 0
        : _o.monorepoAliasPairsExcluded) !== null && _p !== void 0
      ? _p
      : 0) +
    ((_r =
      (_q = scan.summary) === null || _q === void 0
        ? void 0
        : _q.browserMirrorPairsExcluded) !== null && _r !== void 0
      ? _r
      : 0) +
    ((_t =
      (_s = scan.summary) === null || _s === void 0
        ? void 0
        : _s.mcpExamplePairsExcluded) !== null && _t !== void 0
      ? _t
      : 0);
  if (aliasExcluded > 0) {
    notes.push(
  ...
  if (
    ((_v =
      (_u = scan.summary) === null || _u === void 0
        ? void 0
        : _u.exactDuplicateGroups) !== null && _v !== void 0
      ? _v
      : 0) === 0 &&
    ((_x =
      (_w = scan.summary) === null || _w === void 0
        ? void 0
    ...
    notes.push(
      "No exact duplicate groups or actionable merge candidates in this export.",
    );
  }
  if (
    ((_z =
      (_y = scan.summary) === null || _y === void 0
        ? void 0
        : _y.potentialSavingsBytes) !== null && _z !== void 0
      ? _z
      : 0) === 0
  ) {
    notes.push(
  ...
  if (
    gateReport.jestBaselineChecked === false ||
    ((_0 = scan.hygieneSummary) === null || _0 === void 0
      ? void 0
      : _0.jestBaselineChecked) === false
  ) {
    notes.push(
  ...
  if (
    (_1 = scan.rejectedFiction) === null || _1 === void 0 ? void 0 : _1.warning
  ) {
    notes.push(
...
function buildProductConsolidationAiSummary(scan) {
  ...
  const parts = [
    ...
    s.jsonFilesAnalyzed != null
      ...
      : null,
    repoTotal != null
      ? `inventory ${Number(repoTotal).toLocaleString()} files`
      : null,
...
function buildBenchmarkConsolidationConclusion(scan) {
  ...
  const repoFiles =
    (_b =
      (_a = s.repositoryFilesTotal) !== null && _a !== void 0
        ? _a
        : s.repositoryFilesAudited) !== null && _b !== void 0
      ? _b
      : (_c = scan.repositoryInventory) === null || _c === void 0
        ? void 0
        : _c.totalFiles;
...
export function sanitizeConsolidationExport(scan, options = {}) {
  ...
  const benchmarkScan = isBenchmarkConsolidation(scan, {
    ...options,
    projectPath,
  });
  const repoRaw =
    (_c =
      ...
      ? _c
      : null;
  const staleProductInventory =
    !benchmarkScan && repoRaw != null && repoRaw > 10000;
  ...
  const benchmarkCacheCandidatesExcluded =
    legacyCounts.benchmarkCacheCandidatesExcluded +
    (benchmarkScan ? benchmarkMergeExcluded : 0);
  const fuzzyPairsExcluded =
    legacyCounts.fuzzyPairsExcluded ||
    rawFuzzyPairExclusions.fuzzyPairsExcluded;
  let recommendations = filterConsolidationRecommendations(
  ...
  const summaryBase = {
    ...
    ...(intentionalPairsExcluded > 0
      ? {
          intentionalPairsExcluded,
          browserMirrorPairsExcluded:
            ((_g = scan.summary.browserMirrorPairsExcluded) !== null &&
            _g !== void 0
              ? _g
              : 0) +
          ...
          mcpExamplePairsExcluded:
            ((_h = scan.summary.mcpExamplePairsExcluded) !== null &&
            _h !== void 0
              ? _h
              : 0) +
      ...
      : {}),
    ...(ephemeralFuzzyExcluded > 0 ||
    rawFuzzyPairExclusions.ephemeralPathsExcluded > 0
      ? {
          ephemeralPathsExcluded:
            ephemeralFuzzyExcluded ||
            rawFuzzyPairExclusions.ephemeralPathsExcluded,
        }
      : {}),
  };
  const exportNotes = benchmarkScan
    ...
    : dedupeExportNotes(
        (scan.exportSanitized || scan.exportNormalized
          ? []
          : scan.exportNotes || []
        )
          .filter((note) => {
          ...
          .concat(
            buildProductConsolidationExportNotes(
              ...
              {
                repositoryFilesTotal:
                  (_j = options.repositoryFilesTotal) !== null && _j !== void 0
                    ? _j
                    : null,
  ...
  const productScanPathsOnBenchmark =
    benchmarkScan &&
    (scan.scanPaths || []).some((p) =>
      PRODUCT_PATH_MARKERS.some((re) => re.test(String(p))),
    ) &&
    ((_l =
      (_k = scan.summary) === null || _k === void 0
        ? void 0
  ...
  const result = {
        ...
        : staleProductInventory
          ? {
              ...
              staleInventoryNote: rewriteProductScopedText(
                scan.summary.staleInventoryNote,
                false,
              ),
            }
          : {}),
    ...
    aiSummary: benchmarkScan
      ...
      : mergeCandidates.length === 0 &&
          ((_q = summaryBase.potentialSavingsBytes) !== null && _q !== void 0
            ? _q
            : 0) === 0
    ...
    aiSummaryProvider: scan.aiSummaryProvider
      ? String(scan.aiSummaryProvider).replace(
          /\bSimplebeacon\b/g,
          "SimpleBeacon",
        )
    ...
    ...(benchmarkScan
      ? {
          ...
          productPlatformRoot: productPlatformRoot || undefined,
          consolidationHealthStatus:
            resolveBenchmarkConsolidationHealth(summaryBase),
          title: "OSS Clone Consolidation Scan (github-cache benchmark)",
          hygieneSummary: {
            mergeCandidates: mergeCandidates.length,
            potentialSavingsBytes:
              (_r = summaryBase.potentialSavingsBytes) !== null && _r !== void 0
                ? _r
                : 0,
            intentionalPairsExcluded,
            repositoryFilesTotal:
              (_s =
                ...
                : null,
            jsonFilesAnalyzed:
              (_t = summaryBase.jsonFilesAnalyzed) !== null && _t !== void 0
                ? _t
                : null,
            attestationNote:
      ...
      : {
          ...
          consolidationHealthStatus:
            resolveProductConsolidationHealth(summaryBase),
          hygieneSummary: buildProductConsolidationHygieneSummary(
            summaryBase,
            scan,
            {
              repositoryFilesTotal:
                (_u = options.repositoryFilesTotal) !== null && _u !== void 0
                  ? _u
                  : null,
              gateReport: options.gateReport || null,
            },
    ...
    if (result.scanScope) {
      result.scanScope = {
        ...
        sampleDataPathsOmitted:
          scan.scanPaths ||
          ((_v = result.scanScope) === null || _v === void 0
            ? void 0
            : _v.sampleDataPaths) ||
          [],
      };
  ...
  if (
    benchmarkScan &&
    ((_w = result.implementationPhases) === null || _w === void 0
      ? void 0
      : _w.length)
  ) {
  ...
  return applyRedactedConsolidationPaths(
    result,
    projectPath,
    productPlatformRoot,
  );
