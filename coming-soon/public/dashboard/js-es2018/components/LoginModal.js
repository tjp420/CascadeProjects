...
export function showLoginModal({ onSuccess } = {}) {
  ...
  desc.textContent =
    "Paste your Simplebeacon license token to unlock the dashboard.";
  ...
  form.addEventListener("submit", async (e) => {
    ...
    try {
      const password =
        ((_a = overlay.querySelector("#login-token-password")) === null ||
        _a === void 0
          ? void 0
          : _a.value) || "";
  ...
  recoveryBtn.addEventListener("click", () => {
    ...
    recoveryEmail === null || recoveryEmail === void 0
      ? void 0
      : recoveryEmail.focus();
    recoverySubmit.addEventListener("click", async () => {
      ...
      const email =
        (_a =
          recoveryEmail === null || recoveryEmail === void 0
            ? void 0
            : recoveryEmail.value) === null || _a === void 0
          ? void 0
          : _a.trim();
      if (!email) {
      ...
      try {
        ...
        if (data.success) {
          ...
          recoveryStatus.textContent =
            data.error || "Failed to send recovery link.";
          recoveryStatus.style.color = "var(--error)";
        }
      } catch (_b) {
