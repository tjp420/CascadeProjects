...
export function renderCodebasePanel({ scan, loading, error } = {}) {
    ...
    <div class="metrics-row mb-4">
      ...
      ${
          (
              (_u = (_t = scan.structureInsights) === null || _t === void 0 ? void 0 : _t.summary) === null ||
              _u === void 0
                  ? void 0
                  : _u.sampledFiles
          )
    ...
    ${
        (
            (_z = (_y = scan.structureInsights) === null || _y === void 0 ? void 0 : _y.samples) === null ||
            _z === void 0
                ? void 0
                : _z.length
        )
...
export function buildCodebaseConclusion(scan) {
    ...
    const s = scan.summary;
    const critical =
        (_b = (_a = s.severityCounts) === null || _a === void 0 ? void 0 : _a.critical) !== null && _b !== void 0
            ? _b
            : 0;
    const high =
        (_d = (_c = s.severityCounts) === null || _c === void 0 ? void 0 : _c.high) !== null && _d !== void 0 ? _d : 0;
    const medium =
        (_f = (_e = s.severityCounts) === null || _e === void 0 ? void 0 : _e.medium) !== null && _f !== void 0
            ? _f
            : 0;
    const low =
