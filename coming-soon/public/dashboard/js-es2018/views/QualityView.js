    ...
    const total =
        (_g =
            (_e =
                ...
                ? _e
                : (_f = dashboardHome === null || dashboardHome === void 0 ? void 0 : dashboardHome.overview) ===
                        null || _f === void 0
                  ? void 0
...
export class QualityView {
    ...
    render() {
        ...
        const dependencyVulnTotal =
            (_c =
                (_b =
                    (_a = auditStats === null || auditStats === void 0 ? void 0 : auditStats.vulnerabilityTotal) !==
                        null && _a !== void 0
                        ? _a
            ...
            : _s.addEventListener('click', async () => {
                  ...
                  const payload = {
                      ...
                      reportSummary: {
                          ...
                          qualityScore:
                              (_k =
                                  (_j = quality.overallScore) !== null && _j !== void 0 ? _j : quality.qualityScore) !==
                                  null && _k !== void 0
                                  ? _k
                                  : 'N/A',
                          npmVulnerabilities:
