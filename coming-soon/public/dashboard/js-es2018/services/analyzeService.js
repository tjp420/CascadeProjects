...
function normalizeScanReport(rawReport) {
    ...
    const codeFilesAnalyzed =
        summary.codeFilesAnalyzed ?? summary.codeFilesDiscovered ?? rawReport.filesAnalyzed ?? null;
        ...
        return {
            ...
            fileReductionPlan: report.fileReductionPlan
                ? {
                      ...
                      safeToDelete: {
                          topDirectories: (
                              ((_a = report.fileReductionPlan.safeToDelete) === null || _a === void 0
                                  ? void 0
                                  : _a.topDirectories) || []
                          ).slice(0, 8)
                      },
                      unusedFiles: {
                          candidates:
                              (_c =
                                  (_b = report.fileReductionPlan.unusedFiles) === null || _b === void 0
                                      ? void 0
            ...
            executiveSummary: report.executiveSummary
                ? {
                      ...
                      security: {
                          piiNeedingReview:
                              (_e =
                                  (_d = report.executiveSummary.security) === null || _d === void 0
                                      ? void 0
        ...
        ? {
              ...
              tiers: {
                  safeNow: ((_b = results.cleanupAssistant.tiers) === null || _b === void 0 ? void 0 : _b.safeNow)
                      ...
                      : null,
                  investigate:
                      ((_c = results.cleanupAssistant.tiers) === null || _c === void 0 ? void 0 : _c.investigate) ||
                      null
              },
    ...
    if (exportPayload.type === 'data-cleanup-report') {
        ...
        return {
            ...
            summary: {
                scanKind: profile,
                dataQualityFindings:
                    (_c = (_b = exportPayload.summary) === null || _b === void 0 ? void 0 : _b.totalFindings) !==
                        null && _c !== void 0
                        ? _c
                        : null,
                fileReductionFindings:
                    (_e = (_d = exportPayload.summary) === null || _d === void 0 ? void 0 : _d.totalFindings) !==
                        null && _e !== void 0
                        ? _e
                        : null
            },
...
function codeFilesFromExportScan(normalized) {
    ...
    const value =
        (_c =
            (_b =
                (_a = normalized === null || normalized === void 0 ? void 0 : normalized.results) === null ||
                _a === void 0
                    ? void 0
...
export async function fetchEuAiActAuditReport(options = {}) {
    ...
    if (res.status === 422) {
        throw new Error(
            data.error || 'Run EU AI Act sprint first — no .simplebeacon/eu-ai-act-*.json artifacts found.'
        );
    }
    if (!res.ok || !data.success) {
...
export async function fetchDataCleanupScan(projectPath, options = {}) {
    ...
    try {
        ...
        if (profile === 'file-reduction') {
            const hasSignal =
                ((_c = (_b = scan.fileReductionPlan) === null || _b === void 0 ? void 0 : _b.totals) === null ||
                _c === void 0
                    ? void 0
                    : _c.safeToDeleteBytes) != null ||
                ((_f =
                    (_e = (_d = scan.fileReductionPlan) === null || _d === void 0 ? void 0 : _d.safeToDelete) ===
                        null || _e === void 0
                        ? void 0
...
export function scanHintsGameMod(scan) {
    ...
    return insights.some(item => {
        ...
        const domains =
            ((_d =
                (_c =
                    (_b = (_a = item.understanding) === null || _a === void 0 ? void 0 : _a.layers) === null ||
                    _b === void 0
                        ? void 0
                ...
                : _d.domains) ||
            ((_g =
                (_f = (_e = item.understanding) === null || _e === void 0 ? void 0 : _e.layers) === null ||
                _f === void 0
                    ? void 0
...
export function preparePlatformResultsReport(report) {
    ...
    const weightedPenalty = platformIssues
        ...
        .reduce(
            (sum, issue) => sum + (severityWeight[issue.severityBand || issue.severity] || 1) * (issue.count || 1),
            0
        );
...
export function buildInventoryProvenance(report, requestedPath, options = {}) {
    ...
    const inventoryRoot =
        (_h =
            (_g =
                (_f = inventory === null || inventory === void 0 ? void 0 : inventory.projectRoot) !== null &&
                _f !== void 0
                    ? _f
                    : reportAligned
                      ? reportRoot
    ...
    const files =
        (_j = inventory === null || inventory === void 0 ? void 0 : inventory.totalFiles) !== null && _j !== void 0
            ? _j
            : reportAligned
              ? (_k = report === null || report === void 0 ? void 0 : report.repositoryFilesTotal) !== null &&
                _k !== void 0
                  ? _k
                  : reportInventory === null || reportInventory === void 0
                    ? void 0
    ...
    const folders =
        (_l = inventory === null || inventory === void 0 ? void 0 : inventory.totalFolders) !== null && _l !== void 0
            ? _l
            : reportAligned
              ? (_m = report === null || report === void 0 ? void 0 : report.repositoryFoldersTotal) !== null &&
                _m !== void 0
                  ? _m
                  : reportInventory === null || reportInventory === void 0
                    ? void 0
    ...
    const ruleScoped = reportAligned
        ? (_q =
              (_o = report === null || report === void 0 ? void 0 : report.ruleScopedFilesAnalyzed) !== null &&
              _o !== void 0
                  ? _o
...
export function getScanFileMetrics(report, options = {}) {
    ...
    if (!report || typeof report !== 'object') {
        return {
            ...
            repositoryFiles:
                (_a = inventory === null || inventory === void 0 ? void 0 : inventory.totalFiles) !== null &&
                _a !== void 0
                    ? _a
                    : null,
            repositoryFolders:
                (_b = inventory === null || inventory === void 0 ? void 0 : inventory.totalFolders) !== null &&
                _b !== void 0
                    ? _b
                    : null,
            repositoryRoot:
                (_c = inventory === null || inventory === void 0 ? void 0 : inventory.projectRoot) !== null &&
                _c !== void 0
                    ? _c
                    : null
        };
    ...
    if (normalizedReport.type === 'file-merger-reduction-report') {
        const sampleDataFiles =
            (_g =
                (_e =
                    (_d = normalizedReport.summary) === null || _d === void 0 ? void 0 : _d.sampleDataFilesAnalyzed) !==
                    null && _e !== void 0
                    ? _e
        ...
        return {
            ...
            jsonFilesAnalyzed:
                (_q = (_p = normalizedReport.summary) === null || _p === void 0 ? void 0 : _p.jsonFilesAnalyzed) !==
                    null && _q !== void 0
                    ? _q
                    : null,
            credentialScanned: null,
            ...
            repositoryRoot:
                (_w =
                    (_v = normalizedReport.repositoryInventory) === null || _v === void 0 ? void 0 : _v.projectRoot) !==
                    null && _w !== void 0
                    ? _w
                    : null
        };
    ...
    return {
        ...
        repositoryRoot:
            (_11 =
                (_9 = inventory === null || inventory === void 0 ? void 0 : inventory.projectRoot) !== null &&
                _9 !== void 0
                    ? _9
...
export function resolvePageSpecsLabel(report, baseline) {
    ...
    return (_b = baseline === null || baseline === void 0 ? void 0 : baseline.pageSamplesLabel) !== null &&
        _b !== void 0
        ? _b
        : null;
}
    ...
    if (focus === 'fiction') {
        ...
        const inventoryBrief =
            repoFiles != null && ruleScoped != null
                ...
                : '';
        const fictionScope =
            ((_t = (_s = report.scanScope) === null || _s === void 0 ? void 0 : _s.limitations) === null ||
            _t === void 0
                ? void 0
...
export function assertCompleteScanFileReductionFresh(scan) {
    ...
    const hasSignal =
        ...
        ((_e =
            ...
            ? void 0
            : _e.length) ||
        ((_g = (_f = scan.scanners) === null || _f === void 0 ? void 0 : _f['build-artifacts']) === null ||
        _g === void 0
            ? void 0
