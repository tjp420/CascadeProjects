...
import { canUseDirectoryPicker, isLikelyWebkitDirectoryFileCap, browserFolderCapMessage, isEmbeddedDashboardFrame } from '../utils-lib/dom.js?v=20260729dropfix1';
import { normalizeSimplebeaconReport } from './analyzeService.js?v=20260729dropfix1';
import {
  createIgnoreContext,
...
const WORKER_URL = new URL('../workers/scan-worker.js?v=20260729dropfix1', import.meta.url);
