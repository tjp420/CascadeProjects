...
async function test() {
    // Node.js project
    const node = identifyProgram('my-app', makePaths([
        'package.json',
    ...
    // Unity project
    const unity = identifyProgram('unity-game', makePaths([
    ...
    // Python project
    const python = identifyProgram('py-app', makePaths([
        'requirements.txt',
        '.venv/bin/python',
        'main.py'
    ]));
    ...
    const unreal = identifyProgram('ue-game', makePaths([
    ...
    // VS Code: workspace
    const vscode = identifyProgram('repo', makePaths([
    ...
    const unknown = identifyProgram('custom', makePaths([
        'readme.md',
        'build.sh',
        'assets/logo.png'
    ]));
