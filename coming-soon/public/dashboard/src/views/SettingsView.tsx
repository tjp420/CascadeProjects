...
function AiProvidersTab() {
    ...
    const oracleInstalledSettings =
        selectedProvider === 'ollama' && availableModelOptions.includes('unbreakable-oracle');
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Configure AI analysis providers for the chatbot and narrative summaries. Outputs are AI-generated —
                        ...
                        <div className="flex items-start justify-between gap-3">
                            <div>
                                ...
                                <p className="text-xs text-foreground-muted mt-1">
                                    Custom LLM based on llama3.2 (3.2B) with a unique system prompt. Free to download,
                                    runs locally.
                                </p>
