            ...
            {activeOrg && (
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <p className="text-xs text-muted-foreground">
                            Exports use the latest scan report stored in your browser. Run a scan from the Analyze page
                            to populate data. The Audit PDF opens a printable view — use your browser's Print dialog to
                            save as PDF.
                        </p>
                    </CardContent>
                </Card>
