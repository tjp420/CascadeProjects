                                                    ...
                                                    {expandedOrg === org.orgId && (
                                                        <div className="mt-4 pt-4 border-t border-border space-y-3">
                                                            ...
                                                            <div className="flex gap-2 pt-2">
                                                                ...
                                                                >
                                                                    <TrendingUp className="h-3.5 w-3.5" /> Convert to
                                                                    Contract
                                                                </Button>
                                                            </div>
                                                        </div>
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            <div className="space-y-1">
                                                ...
                                                <input
                                                    ...
                                                    onChange={e =>
                                                        setSsoForm({ ...ssoForm, displayName: e.target.value })
                                                    }
                                            ...
                                            <div className="space-y-1">
                                                ...
                                                <select
                                                    ...
                                                    onChange={e =>
                                                        setSsoForm({ ...ssoForm, providerType: e.target.value })
                                                    }
                                                    className="w-full rounded-md border border-border bg-background px-3 py-2 text-sm"
                                                >
                                            ...
                                            <div className="space-y-3 border-t pt-4">
                                                ...
                                                <div className="space-y-1">
                                                    ...
                                                    <textarea
                                                        ...
                                                        onChange={e =>
                                                            setSsoForm({ ...ssoForm, samlCert: e.target.value })
                                                        }
                                                ...
                                                <div className="space-y-1">
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={e =>
                                                            setSsoForm({ ...ssoForm, samlIssuer: e.target.value })
                                                        }
                                            ...
                                            <div className="space-y-3 border-t pt-4">
                                                ...
                                                <div className="space-y-1">
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={e =>
                                                            setSsoForm({ ...ssoForm, oidcIssuer: e.target.value })
                                                        }
