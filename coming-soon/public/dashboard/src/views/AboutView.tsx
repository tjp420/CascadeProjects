        ...
        <div className="mx-auto max-w-4xl p-6 space-y-6">
            ...
            <Card>
                <CardContent className="space-y-4 p-6">
                    ...
                    <p className="text-sm text-foreground-secondary">
                        SimpleBeacon is a deterministic AI safety scanner that checks repositories for credentials, mock
                        paths, production leak directories, and compliance gate rules. It provides pattern-matching
                        scans (not semantic code review) scoped to configured scanPaths and production directories.
                    </p>
                </CardContent>
            </Card>
            ...
            <Card>
                ...
                <CardContent className="space-y-3">
                    <p className="text-sm text-foreground-secondary">
                        The HSM adapter stack implements a multi-tenant, regulation-compliant cryptographic engine
                        spanning 16 engineering tracks (10-25). All tracks are integrated, tested, and production-ready.
                    </p>
