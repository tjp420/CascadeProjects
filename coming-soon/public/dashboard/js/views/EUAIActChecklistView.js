...
export class EUAIActChecklistView {
    ...
    render() {
        ...
        // simplebeacon-ignore innerhtml-usage — static controlled checklist markup
    ...
    bindEvents() {
        this._container.querySelector('#export-pdf-btn')?.addEventListener('click', () => {
            import('../utils/pdf-export.js').then(m => {
                try {
        ...
        this._container.querySelector('#toggle-mock-btn')?.addEventListener('click', () => {
            // simple mock: flip the second item's status
