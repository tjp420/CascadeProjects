  ...
  return (
    Boolean(
      ((_b = audit.report) === null || _b === void 0
        ? void 0
        : _b.benchmarkScan) ||
      ((_c = audit.report) === null || _c === void 0
        ? void 0
        : _c.scanTargetProfile) === "benchmark-cache",
...
function resolveProductPlatformRoot(audit = {}) {
  ...
  return (
    ((_a = audit.npmAudit) === null || _a === void 0
      ? void 0
      : _a.projectPath) ||
...
function resolveCanonicalJestLabel(audit = {}) {
  ...
  const pageSampleAt = parseTimestamp(
    (_b =
      (_a = audit.pageSamples) === null || _a === void 0
        ? void 0
        : _a.baselineComparison) === null || _b === void 0
      ? void 0
      : _b.generatedAt,
  );
  const reportAt = parseTimestamp(
    (_c = audit.report) === null || _c === void 0 ? void 0 : _c.generatedAt,
  );
  const pageLabel =
    ((_f =
      (_e =
        (_d = audit.pageSamples) === null || _d === void 0
          ? void 0
          : _d.baselineComparison) === null || _e === void 0
        ? void 0
        : _e.overview) === null || _f === void 0
      ? void 0
      : _f.jestTestsLabel) ||
    ((_g = audit.baseline) === null || _g === void 0
      ? void 0
      : _g.jestTestsLabel);
  const layerLabel =
    (_j =
      (_h = audit.auditLayers) === null || _h === void 0
        ? void 0
        : _h.jestBaseline) === null || _j === void 0
      ? void 0
      : _j.label;
...
function resolveCanonicalPageSpecsLabel(audit = {}) {
  ...
  return (
    reportLabel ||
    pageLabel ||
    ((_j = audit.baseline) === null || _j === void 0
      ? void 0
      : _j.pageSamplesLabel) ||
    null
  );
...
function buildPageSpecsMismatchNote(audit = {}, pageSpecsLabel) {
  ...
  const baselineStatus =
    ((_a = audit.dashboard) === null || _a === void 0
      ? void 0
      : _a.baselineStatus) || {};
...
function resolveProjectLabel(audit = {}) {
  ...
  return projectLabelFromPath(
    ((_a = audit.report) === null || _a === void 0 ? void 0 : _a.projectRoot) ||
      ((_b = audit.npmAudit) === null || _b === void 0
        ? void 0
        : _b.projectPath) ||
      ((_c = audit.assessment) === null || _c === void 0
        ? void 0
        : _c.projectRoot),
  );
}
...
export function buildAuditMetrics(audit = {}) {
  ...
  const consistencyScore =
    (_e =
      (_d =
        (_c =
          (_b = report.consistencyScore) !== null && _b !== void 0
            ? _b
            : dash.consistencyScore) !== null && _c !== void 0
          ? _c
  ...
  const pageSpecsLabel =
    pageSpecsChecked != null
      ...
      : (_h =
            (_g = audit.baseline) === null || _g === void 0
              ? void 0
              : _g.pageSamplesLabel) !== null && _h !== void 0
        ? _h
        : null;
  const mockSampleFiles =
    (_k =
      (_j = report.mockSampleFiles) !== null && _j !== void 0
        ? _j
        : dash.mockSampleFiles) !== null && _k !== void 0
      ? _k
      : report.totalFiles;
  const filesAnalyzed =
    (_l = report.filesAnalyzed) !== null && _l !== void 0
      ? _l
      : dash.totalFilesScanned;
  return {
    consistencyScore,
    pageSpecsLabel,
    mockSampleFiles,
    ...
    lastScan:
      (_m = report.generatedAt) !== null && _m !== void 0 ? _m : dash.lastScan,
    inventoryFiles:
      (_o =
        inventory === null || inventory === void 0
          ? void 0
          : inventory.totalFiles) !== null && _o !== void 0
        ? _o
        : null,
    inventoryFolders:
      (_p =
        inventory === null || inventory === void 0
          ? void 0
          : inventory.totalFolders) !== null && _p !== void 0
        ? _p
        : null,
    inventoryRoot:
      (_r =
        (_q =
          inventory === null || inventory === void 0
            ? void 0
            : inventory.projectRoot) !== null && _q !== void 0
          ? _q
    ...
    qualityScore:
      (_t =
        (_s = report.qualityScore) !== null && _s !== void 0
          ? _s
          : dash.qualityScore) !== null && _t !== void 0
        ? _t
        : null,
...
export function buildComplianceAuditSummary(audit = {}) {
  ...
  const npmStats =
    audit.npmAudit && !audit.npmAudit.error
      ...
      : null;
  const exec =
    ((_a = audit.assessment) === null || _a === void 0
      ? void 0
      : _a.executiveSummary) || {};
  const checklist =
    ((_c =
      (_b = audit.assessment) === null || _b === void 0
        ? void 0
        : _b.complianceChecklist) === null || _c === void 0
      ? void 0
      : _c.summary) || {};
  ...
  const layerJest =
    (_d = layers.jestBaseline) === null || _d === void 0 ? void 0 : _d.label;
  ...
  const npmProjectLabel = projectLabelFromPath(
    ((_e = audit.npmAudit) === null || _e === void 0
      ? void 0
      : _e.projectPath) ||
  ...
  return {
    ...
    gateBlockingCount:
      (_j = gate.blockingCount) !== null && _j !== void 0 ? _j : null,
    gateWarningCount:
      (_k = gate.warningCount) !== null && _k !== void 0 ? _k : null,
    gateFailureNote:
      gate.pass === false
        ? `Gate FAIL — ${(_l = gate.blockingCount) !== null && _l !== void 0 ? _l : 0} blocking finding(s). Review detectedIssues in report export.`
        : null,
    consistencyScore:
      (_m = metrics.consistencyScore) !== null && _m !== void 0 ? _m : null,
    qualityScore:
      (_o = metrics.qualityScore) !== null && _o !== void 0 ? _o : null,
    pageSpecsLabel,
    jestTestsLabel,
    mockSampleFiles:
      (_p = metrics.mockSampleFiles) !== null && _p !== void 0 ? _p : null,
    filesAnalyzed:
      (_q = metrics.filesAnalyzed) !== null && _q !== void 0 ? _q : null,
    ruleScopedFilesAnalyzed:
      (_r = metrics.ruleScopedFilesAnalyzed) !== null && _r !== void 0
        ? _r
        : null,
    lastScan: (_s = metrics.lastScan) !== null && _s !== void 0 ? _s : null,
    inventoryFiles:
      (_t = metrics.inventoryFiles) !== null && _t !== void 0 ? _t : null,
    inventoryFolders:
      (_u = metrics.inventoryFolders) !== null && _u !== void 0 ? _u : null,
    ...
    fictionActiveFindings:
      (_w =
        (_v = layers.fictionKpis) === null || _v === void 0
          ? void 0
          : _v.findings) !== null && _w !== void 0
        ? _w
        : null,
    npmDependencies:
      (_x =
        npmStats === null || npmStats === void 0
          ? void 0
          : npmStats.dependencies) !== null && _x !== void 0
        ? _x
        : null,
    npmVulnerabilities:
      (_y =
        npmStats === null || npmStats === void 0
          ? void 0
          : npmStats.vulnerabilityTotal) !== null && _y !== void 0
        ? _y
        : null,
    npmAuditAt:
      (_z =
        npmStats === null || npmStats === void 0
          ? void 0
          : npmStats.generatedAt) !== null && _z !== void 0
        ? _z
        : null,
    npmAuditScope:
    ...
    assessmentGateResult:
      (_0 = exec.gateResult) !== null && _0 !== void 0 ? _0 : null,
    assessmentQualityScore:
      (_1 = exec.qualityScore) !== null && _1 !== void 0 ? _1 : null,
    checklistPassed:
      (_2 = checklist.passed) !== null && _2 !== void 0 ? _2 : null,
    checklistFailed:
      (_3 = checklist.failed) !== null && _3 !== void 0 ? _3 : null,
    checklistTotal:
      (_4 = checklist.total) !== null && _4 !== void 0 ? _4 : null,
    ...
    .map((issue) => {
      ...
      return {
        file:
          ...
          ((_b = issue.affectedFiles) === null || _b === void 0
            ? void 0
            : _b[0]) ||
          "—",
...
function reconcileAssessmentFromReport(assessment, report) {
  ...
  return {
    ...
    executiveSummary: {
      ...
      gateResult: (
        (_c = report.gate) === null || _c === void 0 ? void 0 : _c.pass
      )
        ? "PASS"
        : "FAIL",
      ...
      warningCount:
        (_p =
          (_m =
            (_l = report.gate) === null || _l === void 0
              ? void 0
              : _l.warningCount) !== null && _m !== void 0
            ? _m
...
function sanitizeReportExport(report, projectLabel, options = {}) {
  ...
  return {
    ...
    blockingCount:
      (_e =
        (_d =
          (_c = sanitized.gate) === null || _c === void 0
            ? void 0
    ...
    warningCount:
      (_h =
        (_g =
          (_f = sanitized.gate) === null || _f === void 0
            ? void 0
            : _f.warningCount) !== null && _g !== void 0
          ? _g
  ...
  return {
    ...
    ...(sourceReport
      ? {
          sourceReport: {
            generatedAt:
              (_a = sourceReport.generatedAt) !== null && _a !== void 0
                ? _a
                : null,
            duplicateGroups:
              (_b = sourceReport.duplicateGroups) !== null && _b !== void 0
                ? _b
                : null,
          },
        }
...
function sanitizeDashboardExport(dashboard, audit = {}) {
  ...
  const gate =
    report.gate ||
    ((_a = audit.auditLayers) === null || _a === void 0 ? void 0 : _a.gate) ||
    {};
  const next = {
    ...rest,
  ...
  if (next.scanStatus && gate.pass != null) {
    ...
    next.scanStatus = {
      ...
      issueCount:
        (_c =
          (_b = gate.blockingCount) !== null && _b !== void 0
            ? _b
            : report.issueCount) !== null && _c !== void 0
          ? _c
          : next.scanStatus.issueCount,
      blockingCount:
        (_d = gate.blockingCount) !== null && _d !== void 0
          ? _d
          : next.scanStatus.blockingCount,
      warningCount:
        (_e = gate.warningCount) !== null && _e !== void 0
          ? _e
          : next.scanStatus.warningCount,
      qualityScore:
        (_f = report.qualityScore) !== null && _f !== void 0
          ? _f
          : next.scanStatus.qualityScore,
  ...
  if (
    (_g = next.trends) === null || _g === void 0 ? void 0 : _g.aiAdoptionTrend
  ) {
    next.trends = {
      ...next.trends,
...
export function buildAuditLayersCsv(auditLayers = {}) {
  ...
  const rows = keys.map((key) => {
    ...
    const checked =
      (_c =
        (_b =
          (_a = layer.scanned) !== null && _a !== void 0
            ? _a
            : layer.checked) !== null && _b !== void 0
          ? _b
    ...
    const findings =
      (_e =
        (_d = layer.findings) !== null && _d !== void 0
          ? _d
          : layer.blockingCount) !== null && _e !== void 0
        ? _e
        : "";
    return [
      key,
  ...
  const rules =
    (_a =
      assessment === null || assessment === void 0
        ? void 0
        : assessment.complianceChecklist) === null || _a === void 0
      ? void 0
      : _a.rules;
