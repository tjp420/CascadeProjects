...
export const ANALYZER_CATALOG = [
  ...
  createAnalyzer('Economic & Regulatory AI Issues', 'Environmental Impact Analyzer', 'Measure energy and carbon footprint efficiency.', ['Energy usage logs', 'Compute utilization', 'Carbon intensity factors'], ['Compute energy per workload', 'Estimate emissions', 'Benchmark efficiency'], ['Energy per request', 'Carbon footprint score', 'Efficiency percentile'], 'higher_better', 'Derive deterministic sustainability metrics from runtime telemetry.', 'stub'),
  createAnalyzer('Economic & Regulatory AI Issues', 'Regulatory Compliance Analyzer', 'Assess alignment with applicable AI regulations.', ['Regulatory control catalog', 'System policy docs', 'Audit evidence'], ['Map controls to requirements', 'Check evidence completeness', 'Flag missing controls'], ['Compliance coverage rate', 'Control gap count', 'Audit readiness score'], 'higher_better', 'Implement control checklist and evidence validation engine.', 'stub'),
