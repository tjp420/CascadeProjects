...
function resolveVsixDownloadUrl(): string {
  if (typeof window !== "undefined") {
    const cfg = (
      window as { SIMPLEBEACON_SITE_CONFIG?: { vsixDownloadUrl?: string } }
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-foreground-muted text-sm mt-1 leading-relaxed">
              The browser scan covers the basics. The CLI and VS Code extension
              run the full deterministic rule engine across your entire
              repository — no source code upload required.
            </p>
            ...
            <div className="mt-3 rounded-md border border-amber-500/30 bg-amber-500/5 px-3 py-2.5">
              ...
              <p className="text-xs text-foreground-muted mt-1 leading-relaxed">
                ...
                to preview safe remediation recipes directly inside your Output
                channel on every document save.
              </p>
            </div>
            ...
            <div className="grid gap-1.5 mt-3">
              <div className="flex items-center gap-2 text-xs text-foreground-muted">
                ...
                <span>
                  Real-time IDE compliance — catch algorithmic redundancy and
                  token exposure as you type
                </span>
              </div>
              <div className="flex items-center gap-2 text-xs text-foreground-muted">
            ...
            <div className="flex flex-wrap gap-3 mt-4">
              ...
              >
                <Button type="button" size="sm" className="text-xs">
                  <Download className="h-3.5 w-3.5 mr-1.5" /> Download VS Code
                  Extension
                </Button>
              </a>
