      ...
      {isFreeTier && (
        <Card className="relative overflow-hidden border-primary/20">
          ...
          <CardContent className="relative flex flex-col items-center text-center py-12 px-6 space-y-5">
            <Badge
              variant="outline"
              className="border-success/30 bg-success/10 text-success px-4 py-1.5 text-xs font-semibold uppercase tracking-wider"
            >
            ...
            <p className="text-foreground-muted max-w-xl text-sm sm:text-base">
              SimpleBeacon runs entirely on your local machine to audit, clean,
              and certify your AI code pipelines for enterprise governance
              reviews.
            </p>
            ...
            <p className="text-xs text-foreground-muted pt-1">
              100% private. No sign-up required for basic scans.{" "}
              <strong>Not affiliated with Beacons.ai.</strong>
            </p>
          </CardContent>
        </Card>
      )}
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>
              Start a new scan or view recent results
            </CardDescription>
          </CardHeader>
            ...
            >
              ...
              <div className="flex flex-col items-start">
                ...
                <span className="text-xs opacity-80">
                  Analyze a project or repository
                </span>
              </div>
            </Button>
            <Button
        ...
        <div className="space-y-4">
          <div className="text-center">
            ...
            <p className="text-sm text-foreground-muted mt-1">
              Deterministic scanning that boards and clients can trust
            </p>
          </div>
      ...
      {isFreeTier && (
        <div className="space-y-4">
          <div className="text-center">
            ...
            <p className="text-sm text-foreground-muted mt-1">
              See exactly what your executives will present. A–F grade.
              Financial liability estimate. Actionable remediation.
            </p>
          </div>
              ...
              <div className="flex items-center justify-between border-b-2 border-slate-200 pb-4">
                <div>
                  <div className="text-lg font-bold text-slate-900">
                    Executive Risk Certificate
                  </div>
                  <div className="text-xs text-slate-500">
                    SimpleBeacon · Q2 2026 Assessment
                  </div>
                </div>
        ...
        <Card className="border-primary/20">
          <CardContent className="flex flex-col items-center text-center py-8 px-6 space-y-4">
            ...
            <p className="text-sm text-foreground-muted max-w-md">
              Drag and drop a project folder to get started. No sign-up, no
              upload — runs entirely in your browser.
            </p>
            <Button
              size="lg"
              onClick={() => navigate("analyze")}
