...
function renderPreview(data) {
    ...
    const analysisModulesHtml = (() => {
        ...
        if (br.checklist && br.checklist.length > 0 && !brLooksStale) {
            ...
            readinessScore = br.readinessScore ?? Math.round(((checks.filter(c => c.found).length / checks.length) * 100));
        ...
        if (hygiene.totalFiles) {
            ...
            if (hBreak.nodeModules) junkDetail += '<tr><td style="padding:2px 0;">node_modules</td><td style="text-align:right;padding:2px 0;">' + hBreak.nodeModules.toLocaleString() + '</td></tr>';
            if (hBreak.git) junkDetail += '<tr><td style="padding:2px 0;">.git objects</td><td style="text-align:right;padding:2px 0;">' + hBreak.git.toLocaleString() + '</td></tr>';
            if (hBreak.buildArtifacts) junkDetail += '<tr><td style="padding:2px 0;">Build artifacts</td><td style="text-align:right;padding:2px 0;">' + hBreak.buildArtifacts.toLocaleString() + '</td></tr>';
            if (hBreak.cacheDirs) junkDetail += '<tr><td style="padding:2px 0;">Cache dirs</td><td style="text-align:right;padding:2px 0;">' + hBreak.cacheDirs.toLocaleString() + '</td></tr>';
            if (hBreak.lockfiles) junkDetail += '<tr><td style="padding:2px 0;">Lockfiles</td><td style="text-align:right;padding:2px 0;">' + hBreak.lockfiles.toLocaleString() + '</td></tr>';
            if (hBreak.archives) junkDetail += '<tr><td style="padding:2px 0;">Archives</td><td style="text-align:right;padding:2px 0;">' + hBreak.archives.toLocaleString() + '</td></tr>';
            if (hBreak.binaries) junkDetail += '<tr><td style="padding:2px 0;">Binary/media</td><td style="text-align:right;padding:2px 0;">' + hBreak.binaries.toLocaleString() + '</td></tr>';
            if (hBreak.traditionalJunk) junkDetail += '<tr><td style="padding:2px 0;">Junk/temp files</td><td style="text-align:right;padding:2px 0;">' + hBreak.traditionalJunk.toLocaleString() + '</td></tr>';
