...
window.SIMPLEBEACON_SITE = window.SIMPLEBEACON_SITE || {
    ...
    // Direct VSIX download (3.0.588 is ~3.6 MiB, under the Cloudflare Pages 25 MiB static-asset limit).
    vsixDownloadUrl: '/downloads/simplebeacon.vsix?v=3.0.588',
    ...
    features: [
        ...
        },
        {
            ...
            developer: '<span class="check">&#10003;</span> 35 patterns',
            startup: '<span class="check">&#10003;</span> 35 patterns',
            compliance: '<span class="check">&#10003;</span> 35 patterns',
            enterprise: '<span class="check">&#10003;</span> 35 patterns'
        },
        {
            name: 'AI Slop Cop IDE rules',
            developer: '35 real-time patterns',
            startup: '<strong>35 IDE patterns</strong>',
            compliance: '<strong>35 IDE patterns</strong>',
            enterprise: '<strong>35 IDE patterns</strong>'
        },
        {
            name: 'CLI / Dashboard analyzers',
            developer: '<span class="check">&#10003;</span> Core',
            startup: '<span class="check">&#10003;</span> 38 modules',
            compliance: '<span class="check">&#10003;</span> 38 modules',
            enterprise: '<span class="check">&#10003;</span> 38 modules'
        },
        {
