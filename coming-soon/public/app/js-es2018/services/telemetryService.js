...
export function buildTelemetrySummary(telemetry) {
    ...
    return {
        ...
        scrubber: {
            ...
            utilization:
                scrubber.maxScrubbers > 0 ? Math.round((scrubber.activeScrubbers / scrubber.maxScrubbers) * 100) : 0
        },
        replay: {
            ...
            replayRate:
                replay.totalChecked > 0 ? Math.round((replay.totalReplays / replay.totalChecked) * 10000) / 100 : 0
        },
        audit: {
