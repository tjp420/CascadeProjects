        ...
        let issues = source.map((issue, index) => {
            ...
            return {
                ...
                filePath:
                    ...
                    ((_d = (_c = issue.metadata) === null || _c === void 0 ? void 0 : _c.duplicatePaths) === null ||
                    _d === void 0
                        ? void 0
                        : _d[0]) ||
    ...
    renderScanSummary(report) {
        ...
        const blockingCount =
            (_b = (_a = report.gate) === null || _a === void 0 ? void 0 : _a.blockingCount) !== null && _b !== void 0
                ...
                : 0;
        const gatePass =
            ((_c = report.gate) === null || _c === void 0 ? void 0 : _c.pass) === true && blockingCount === 0;
    ...
    bindExport(el, issues) {
        ...
        const doSendToAi = async (notes = '') => {
            ...
            const reportSummary = {
                ...
                filesScanned:
                    (_e = (_d = report.repositoryFilesTotal) !== null && _d !== void 0 ? _d : report.totalFiles) !==
                        null && _e !== void 0
                        ? _e
                        : 'N/A',
