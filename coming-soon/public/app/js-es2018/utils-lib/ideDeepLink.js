...
export function buildIdeFileUrl(filePath, line = 1, options = {}) {
  ...
  const scheme =
    ...
    /Cursor/i.test(navigator.userAgent || "")
      ? "cursor"
      : "vscode");
...
export function renderIdeFileLink(filePath, line = 1, options = {}) {
  ...
  const canOpen =
    Boolean(resolveAbsoluteFilePath(filePath, options.projectRoot)) ||
  ...
  return String(
    (report === null || report === void 0 ? void 0 : report.projectRoot) ||
      ...
      _b === void 0
        ? void 0
        : _b.lastProjectPath) ||
      ((_c = app === null || app === void 0 ? void 0 : app.state) === null ||
      _c === void 0
        ? void 0
        : _c.defaultProjectPath) ||
      ((_d = app === null || app === void 0 ? void 0 : app.state) === null ||
      _d === void 0
        ? void 0
        : _d.pathInputDraft) ||
      "",
