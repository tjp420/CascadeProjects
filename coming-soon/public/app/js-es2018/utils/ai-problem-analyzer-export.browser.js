    ...
    return issues.map(issue => {
        ...
        const riskScore =
            (_b =
                ...
                : null;
        const metricScore =
            (_c = result === null || result === void 0 ? void 0 : result.metricScore) !== null && _c !== void 0
                ? _c
                : null;
...
function slimArchitectureForExport(architecture, summary = null) {
    ...
    if (
        ...
        ((_a = summary === null || summary === void 0 ? void 0 : summary.stubCount) !== null && _a !== void 0
            ? _a
            : 0) === 0
    ) {
...
function buildHygieneSummary(summary, riskSummary, healthScore) {
    ...
    return {
        selectedAnalyzerCount:
            (_a = summary === null || summary === void 0 ? void 0 : summary.selectedIssueCount) !== null &&
            _a !== void 0
                ? _a
                : null,
        measuredCount:
            (_c =
                (_b = riskSummary === null || riskSummary === void 0 ? void 0 : riskSummary.measuredAnalyzerCount) !==
                    null && _b !== void 0
                    ? _b
        ...
        registrySummary: {
            catalogSize:
                (_d = (_c = source.registry) === null || _c === void 0 ? void 0 : _c.length) !== null && _d !== void 0
                    ...
                    : 48,
            implementedInRun:
                (_e = summary === null || summary === void 0 ? void 0 : summary.implementedCount) !== null &&
                _e !== void 0
                    ? _e
                    : null,
            stubsInRun:
                (_f = summary === null || summary === void 0 ? void 0 : summary.stubCount) !== null && _f !== void 0
                    ? _f
                    : 0,
...
export function sanitizeAiProblemAnalyzerExport(analysisResult, options = {}) {
    ...
    const healthScore =
        (_k =
            (_j =
                (_f = (_e = options.context) === null || _e === void 0 ? void 0 : _e.healthScore) !== null &&
                _f !== void 0
                    ? _f
