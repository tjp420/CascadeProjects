...
export function resolveFileReductionPlan(fileReduction) {
    ...
    if (
        ((_b =
            (_a = existing === null || existing === void 0 ? void 0 : existing.safeToDelete) === null || _a === void 0
                ? void 0
                : _a.topDirectories) === null || _b === void 0
            ? void 0
            : _b.length) ||
        ((_c = existing === null || existing === void 0 ? void 0 : existing.totals) === null || _c === void 0
            ? void 0
    ...
    const assetSummary =
        ((_h = fileReduction.scanners) === null || _h === void 0 ? void 0 : _h['asset-consolidation']) || {};
    ...
    return {
        ...
        totals: {
            reclaimableBytes:
                (_t =
                    (_s = (_r = fileReduction.summary) === null || _r === void 0 ? void 0 : _r.reclaimableBytes) !==
                        null && _s !== void 0
                        ? _s
...
export function isCleanupBriefRunnable({ brief, fileReduction, dataQuality } = {}) {
    ...
    if (
        ...
        return true;
    if (
        ((_b = fileReduction === null || fileReduction === void 0 ? void 0 : fileReduction.inventory) === null ||
        _b === void 0
            ? void 0
            : _b.totalFiles) != null
    )
        return true;
    if (
        ((_c = dataQuality === null || dataQuality === void 0 ? void 0 : dataQuality.inventory) === null ||
        _c === void 0
            ? void 0
            : _c.totalFiles) != null
    )
        return true;
    if ((dataQuality === null || dataQuality === void 0 ? void 0 : dataQuality.summary) != null) return true;
    if (
        (_d = brief === null || brief === void 0 ? void 0 : brief.scanAnalysis) === null || _d === void 0
            ? void 0
            : _d.dataQuality
    )
        return true;
    if (
        (_e = brief === null || brief === void 0 ? void 0 : brief.scanAnalysis) === null || _e === void 0
            ? void 0
            : _e.fileReduction
    )
        return true;
    if (
        (((_f = brief === null || brief === void 0 ? void 0 : brief.estimatedReduction) === null || _f === void 0
            ? void 0
            : _f.files) || 0) > 0
    )
        return true;
    if (
        ...
        return true;
    if (
        (((_j = brief === null || brief === void 0 ? void 0 : brief.dataQualityActions) === null || _j === void 0
            ? void 0
            : _j.length) || 0) > 0
    )
        return true;
...
export function buildCleanupAssistantBrief({
        ...
        totalFiles:
            (_c =
                (_a =
                    ...
                    ? _a
                    : (_b = fileReduction === null || fileReduction === void 0 ? void 0 : fileReduction.inventory) ===
                            null || _b === void 0
                      ? void 0
        ...
        totalFolders:
            (_f =
                (_d =
                    ...
                    ? _d
                    : (_e = fileReduction === null || fileReduction === void 0 ? void 0 : fileReduction.inventory) ===
                            null || _e === void 0
                      ? void 0
    ...
    const tiers = {
        ...
        investigate: {
            files:
                (_h = (_g = plan.unusedFiles) === null || _g === void 0 ? void 0 : _g.candidates) !== null &&
                _h !== void 0
                    ? _h
                    : 0,
    ...
    return {
        ...
        duplicateAssets:
            ((_o = (_m = plan.duplicateAssets) === null || _m === void 0 ? void 0 : _m.topGroups) === null ||
            _o === void 0
                ? void 0
                : _o.slice(0, 8)) || [],
        ...
        sourceScans: {
            ...
            fileReductionPlanPresent: Boolean(
                ...
                ((_q =
                    (_p = plan === null || plan === void 0 ? void 0 : plan.safeToDelete) === null || _p === void 0
                        ? void 0
            ...
            synthesizedPlan: Boolean(
                ...
                ((_s =
                    (_r = plan === null || plan === void 0 ? void 0 : plan.safeToDelete) === null || _r === void 0
                        ? void 0
    ...
    if (lastResult.kind === 'complete' && Array.isArray(lastResult.steps)) {
        ...
        return {
            ...
            fileReduction:
                ...
                (fileReductionStep === null || fileReductionStep === void 0 ? void 0 : fileReductionStep.scan) ||
                null,
            dataQuality:
                ...
                null,
            repositoryInventory:
                (cleanupStep === null || cleanupStep === void 0 ? void 0 : cleanupStep.repositoryInventory) ||
...
export function readCleanupPolicyFromDom(root) {
    ...
    return {
        ...
        allowNodeModules: Boolean(
            (_a = root === null || root === void 0 ? void 0 : root.querySelector('#cleanup-allow-node-modules')) ===
                null || _a === void 0
                ? void 0
                : _a.checked
        ),
        allowSimplebeaconCache: Boolean(
            (_b = root === null || root === void 0 ? void 0 : root.querySelector('#cleanup-allow-simplebeacon')) ===
                null || _b === void 0
                ? void 0
                : _b.checked
        ),
