...
function inferScanTargetRootFromHints(roadmap, options = {}) {
    ...
    const sourceRoot = normalizeExportPath((roadmap === null || roadmap === void 0 ? void 0 : roadmap.sourceProjectPath) || (roadmap === null || roadmap === void 0 ? void 0 : roadmap.projectRoot) || '');
    if (isBenchmarkScanTargetRoot(sourceRoot))
        return '';
...
function isStaleEmptyCodebaseMetrics(metrics) {
    ...
    if (!metrics || typeof metrics !== 'object')
        return true;
    const loc = (_a = metrics.totalLinesOfCode) !== null && _a !== void 0 ? _a : 0;
    const cov = (_b = metrics.testCoverage) !== null && _b !== void 0 ? _b : 0;
    const docs = (_d = (_c = metrics.documentation) === null || _c === void 0 ? void 0 : _c.totalDocs) !== null && _d !== void 0 ? _d : 0;
...
function redactRoadmapSubpath(value, label) {
    const normalized = normalizeExportPath(value);
    if (!normalized || !isAbsoluteExportPath(normalized))
        return normalized;
...
function redactProductRoadmapPaths(roadmap, label) {
    ...
    for (const field of ['sourceProjectPath', 'platformRoot', 'scanTargetRoot', 'requestedScanRoot', 'projectRoot', 'codeAnalysisRoot']) {
        if (next[field])
            next[field] = redactRoot(next[field]);
    }
...
function stripFictionCoverageFromText(text) {
    ...
    let out = text
        ...
        .replace(/(?:^|\*\s)[^*\n]*test coverage[^*\n]*\d+(?:\.\d+)?%[^*\n]*/gim, '* Test coverage percentages require live Jest/Istanbul — not inferred by roadmap LLM.')
        .replace(/\b\d{1,3}(?:\.\d+)?%\b(?: is above the recommended threshold of \d+%)?[^.]*\./gi, (match) => (/coverage/i.test(match)
        ? 'Coverage percentages require live Jest/Istanbul — not inferred by roadmap LLM.'
        : match));
    if (/SOC 2/i.test(text) && /\d+(?:\.\d+)?%/.test(text)) {
        out = out.replace(/Test coverage \(\d+(?:\.\d+)?%\) supports SOC 2[^.]*\./i, 'SOC 2 change-management evidence requires Simplebeacon gate scans — not roadmap-inferred coverage %.');
    }
    out = out
        .replace(/Moderate risk associated with low(?: test coverage)?/gi, 'Moderate risk — live test coverage not measured in this scan (pair with gate Jest output).')
        .replace(/high risk associated with low test coverage/gi, 'maintainability risk until live Jest/Istanbul baseline is established')
        .replace(/address the maintainability risk until live Jest\/Istanbul baseline is established and lack of documentation coverage/gi, 'establish live Jest/Istanbul and documentation baselines before compliance sign-off')
        .replace(/prioritizing test coverage improvements,\s*/gi, 'establishing a live Jest baseline, ');
    return out.replace(/\n{3,}/g, '\n\n').trim();
}
/**
...
function resolveGateInventoryTotals(gateReport, hygiene = null) {
    ...
    const repositoryFilesTotal = (_d = (_c = (_a = gateReport === null || gateReport === void 0 ? void 0 : gateReport.repositoryFilesTotal) !== null && _a !== void 0 ? _a : (_b = gateReport === null || gateReport === void 0 ? void 0 : gateReport.repositoryInventory) === null || _b === void 0 ? void 0 : _b.totalFiles) !== null && _c !== void 0 ? _c : hygiene === null || hygiene === void 0 ? void 0 : hygiene.gateRepositoryFilesTotal) !== null && _d !== void 0 ? _d : null;
    const credentialScanned = (_k = (_j = (_h = (_f = (_e = gateReport === null || gateReport === void 0 ? void 0 : gateReport.credentialScanned) !== null && _e !== void 0 ? _e : gateReport === null || gateReport === void 0 ? void 0 : gateReport.productionLeakScanned) !== null && _f !== void 0 ? _f : (_g = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) === null || _g === void 0 ? void 0 : _g.productionDirsScanned) !== null && _h !== void 0 ? _h : hygiene === null || hygiene === void 0 ? void 0 : hygiene.credentialScanned) !== null && _j !== void 0 ? _j : hygiene === null || hygiene === void 0 ? void 0 : hygiene.contentFilesScanned) !== null && _k !== void 0 ? _k : null;
...
function resolveRoadmapGateContext(roadmap, options = {}) {
    ...
    const hygiene = (roadmap === null || roadmap === void 0 ? void 0 : roadmap.hygieneSummary) || {};
    const scanScope = (roadmap === null || roadmap === void 0 ? void 0 : roadmap.scanScope) || {};
    const { repositoryFilesTotal: gateTotalFromReport, credentialScanned: credFromReport } = resolveGateInventoryTotals(gateReport, hygiene);
    const repositoryFilesTotal = (_c = (_b = (_a = options.repositoryFilesTotal) !== null && _a !== void 0 ? _a : gateTotalFromReport) !== null && _b !== void 0 ? _b : scanScope.gateRepositoryFilesTotal) !== null && _c !== void 0 ? _c : null;
    const credentialScanned = credFromReport;
    const contentScanned = (_o = (_m = (_l = (_k = (_j = (_f = (_e = (_d = gateReport.scanScope) === null || _d === void 0 ? void 0 : _d.fullDirectoryStats) === null || _e === void 0 ? void 0 : _e.contentScanned) !== null && _f !== void 0 ? _f : (_h = (_g = gateReport.scanScope) === null || _g === void 0 ? void 0 : _g.fullDirectoryStats) === null || _h === void 0 ? void 0 : _h.filesContentScanned) !== null && _j !== void 0 ? _j : gateReport.credentialScanned) !== null && _k !== void 0 ? _k : gateReport.productionLeakScanned) !== null && _l !== void 0 ? _l : hygiene.contentFilesScanned) !== null && _m !== void 0 ? _m : hygiene.credentialScanned) !== null && _o !== void 0 ? _o : null;
    const gateProfile = (_s = (_r = (_q = (_p = gateReport.scanScope) === null || _p === void 0 ? void 0 : _p.profile) !== null && _q !== void 0 ? _q : scanScope.gateRuleBundleProfile) !== null && _r !== void 0 ? _r : hygiene.gateRuleBundleProfile) !== null && _s !== void 0 ? _s : null;
    const fictionJsonFilesScanned = (_w = (_v = (_t = gateReport.fictionJsonFilesScanned) !== null && _t !== void 0 ? _t : (_u = gateReport.scanScope) === null || _u === void 0 ? void 0 : _u.fictionJsonFilesScanned) !== null && _v !== void 0 ? _v : hygiene.fictionJsonFilesScanned) !== null && _w !== void 0 ? _w : null;
    const fictionSampleFilesScanned = (_1 = (_0 = (_y = (_x = gateReport.fictionSampleFilesScanned) !== null && _x !== void 0 ? _x : gateReport.mockSampleFiles) !== null && _y !== void 0 ? _y : (_z = gateReport.scanScope) === null || _z === void 0 ? void 0 : _z.fictionSampleFilesScanned) !== null && _0 !== void 0 ? _0 : hygiene.fictionSampleFilesScanned) !== null && _1 !== void 0 ? _1 : null;
    const gatePass = (_4 = (_3 = (_2 = gateReport.gate) === null || _2 === void 0 ? void 0 : _2.pass) !== null && _3 !== void 0 ? _3 : hygiene.gatePass) !== null && _4 !== void 0 ? _4 : null;
    const blockingCount = (_8 = (_7 = (_6 = (_5 = gateReport.gate) === null || _5 === void 0 ? void 0 : _5.blockingCount) !== null && _6 !== void 0 ? _6 : gateReport.issueCount) !== null && _7 !== void 0 ? _7 : hygiene.blockingCount) !== null && _8 !== void 0 ? _8 : null;
...
function hasFictionCoverageInStrategicInsights(insights) {
    ...
    if (sm && (sm.testCoverage != null || sm.lineCoverage != null))
        return true;
    const parts = [
        insights.executiveSummary,
        insights.llmSummary,
        insights.complianceNarrative,
        ...(((_a = insights.riskAssessment) === null || _a === void 0 ? void 0 : _a.riskFactors) || []).flatMap((f) => [f.description, f.recommendation])
    ].filter(Boolean);
...
function sanitizeProductStrategicInsightsForExport(insights) {
    ...
    if ((_a = next.riskAssessment) === null || _a === void 0 ? void 0 : _a.riskFactors) {
        next.riskAssessment = {
            ...next.riskAssessment,
    ...
    if (Array.isArray(next.recommendations)) {
        next.recommendations = next.recommendations.map((rec) => {
            if (!rec || typeof rec !== 'object' || typeof rec.action !== 'string')
                return rec;
            if (!/test coverage/i.test(rec.action) || !/\d+(?:\.\d+)?%/.test(rec.action))
                return rec;
...
function sanitizeProductCoverageForExport(roadmap) {
    var _a, _b, _c;
    const metrics = (_a = roadmap.progressMetrics) === null || _a === void 0 ? void 0 : _a.metrics;
    ...
    if (!needsCoverageSanitize) {
        const next = {
            ...roadmap,
            coverageEvidenceSource: (_b = roadmap.coverageEvidenceSource) !== null && _b !== void 0 ? _b : ((metrics === null || metrics === void 0 ? void 0 : metrics.testCoverage) != null ? 'jest-coverage-summary' : null)
        };
    ...
    const next = { ...roadmap };
    if (staleProgressMetrics && ((_c = next.progressMetrics) === null || _c === void 0 ? void 0 : _c.metrics)) {
...
function buildProductRoadmapHygieneSummary(roadmap, gateContext = {}) {
     ...
     * @returns {any}
     */
    const jestFeature = (((_a = roadmap.codeAnalysis) === null || _a === void 0 ? void 0 : _a.features) || []).find((f) => /jest test files/i.test(String((f === null || f === void 0 ? void 0 : f.name) || '')));
    const { repositoryFilesTotal: gateTotal, credentialScanned, contentScanned, gateProfile, fictionJsonFilesScanned, fictionSampleFilesScanned, gatePass, blockingCount, jestBaselineChecked } = gateContext;
    return {
        roadmapAuditFiles: (_d = (_c = (_b = roadmap.codeAnalysis) === null || _b === void 0 ? void 0 : _b.structure) === null || _c === void 0 ? void 0 : _c.totalFiles) !== null && _d !== void 0 ? _d : null,
        gateRepositoryFilesTotal: gateTotal,
        sprintCompletionRate: (_f = (_e = roadmap.executiveSummary) === null || _e === void 0 ? void 0 : _e.completionRate) !== null && _f !== void 0 ? _f : null,
        coverageEvidenceSource: (_g = roadmap.coverageEvidenceSource) !== null && _g !== void 0 ? _g : (((_j = (_h = roadmap.progressMetrics) === null || _h === void 0 ? void 0 : _h.metrics) === null || _j === void 0 ? void 0 : _j.testCoverage) != null ? 'jest-coverage-summary' : 'none'),
        apiRouteCount: (_p = (_m = (_l = (_k = roadmap.codeAnalysis) === null || _k === void 0 ? void 0 : _k.aiIntegration) === null || _l === void 0 ? void 0 : _l.apiRouteCount) !== null && _m !== void 0 ? _m : (_o = roadmap.aiIntegration) === null || _o === void 0 ? void 0 : _o.apiRouteCount) !== null && _p !== void 0 ? _p : null,
        jestFilesOnDisk: (_q = jestFeature === null || jestFeature === void 0 ? void 0 : jestFeature.count) !== null && _q !== void 0 ? _q : null,
...
function buildProductRoadmapScanScope(scanScope, roadmap, gateContext = {}) {
    ...
    return {
        ...
        ...(gateProfile ? { gateRuleBundleProfile: gateProfile } : {}),
        roadmapNote: (scanScope === null || scanScope === void 0 ? void 0 : scanScope.roadmapNote)
            || ((_a = roadmap === null || roadmap === void 0 ? void 0 : roadmap.scanScope) === null || _a === void 0 ? void 0 : _a.roadmapNote)
...
function sanitizeProductDevelopmentPhases(phases, codeAnalysis) {
     ...
     * @returns {any}
     */
    const jestFeature = ((codeAnalysis === null || codeAnalysis === void 0 ? void 0 : codeAnalysis.features) || []).find((f) => /jest test files/i.test(String((f === null || f === void 0 ? void 0 : f.name) || '')));
    const testCount = jestFeature === null || jestFeature === void 0 ? void 0 : jestFeature.count;
    if (testCount == null)
        return phases;
    return phases.map((phase) => {
        if (!/Sprint 2/i.test(String(phase.phase || '')))
            return phase;
        /**
         * Features.
        ...
        return features.some((feature, index) => { var _a; return feature !== ((_a = phase.features) === null || _a === void 0 ? void 0 : _a[index]); })
            ? { ...phase, features }
            : phase;
    });
}
...
function buildProductRoadmapExportNotes(roadmap, context = {}) {
    ...
    if ((_a = roadmap.strategicInsights) === null || _a === void 0 ? void 0 : _a.llmAdvisoryOnly) {
        notes.push('strategicInsights LLM narrative is advisory — deterministic codeAnalysis and gate exports are source of truth.');
    }
    if ((_b = roadmap.rejectedFiction) === null || _b === void 0 ? void 0 : _b.warning) {
    ...
    const repoTotal = (_c = context.repositoryFilesTotal) !== null && _c !== void 0 ? _c : null;
    const auditFiles = (_e = (_d = roadmap.codeAnalysis) === null || _d === void 0 ? void 0 : _d.structure) === null || _e === void 0 ? void 0 : _e.totalFiles;
    const credentialScanned = (_f = context.credentialScanned) !== null && _f !== void 0 ? _f : null;
    const gateProfile = (_g = context.gateProfile) !== null && _g !== void 0 ? _g : null;
    const fictionJsonFilesScanned = (_h = context.fictionJsonFilesScanned) !== null && _h !== void 0 ? _h : null;
    const fictionSampleFilesScanned = (_j = context.fictionSampleFilesScanned) !== null && _j !== void 0 ? _j : null;
    const gatePass = (_k = context.gatePass) !== null && _k !== void 0 ? _k : null;
    const blockingCount = (_l = context.blockingCount) !== null && _l !== void 0 ? _l : null;
    const jestBaselineChecked = context.jestBaselineChecked;
    if (repoTotal != null && auditFiles != null && repoTotal !== auditFiles) {
        notes.push(`codeAnalysis.structure.totalFiles (${Number(auditFiles).toLocaleString()}) is roadmap audit scope — gate repository inventory is ${Number(repoTotal).toLocaleString()} paths.`);
    }
    if (repoTotal != null && credentialScanned != null && credentialScanned < repoTotal) {
        notes.push(`CRED/LEAK rules scanned ${Number(credentialScanned).toLocaleString()} production-path file(s) — ${Number(repoTotal - credentialScanned).toLocaleString()} metadata-only path(s) in gate inventory of ${Number(repoTotal).toLocaleString()}.`);
    }
    ...
    if (gatePass === false && (blockingCount !== null && blockingCount !== void 0 ? blockingCount : 0) > 0) {
        notes.push(`Gate FAIL — ${Number(blockingCount).toLocaleString()} blocking finding(s) — roadmap advisory does not clear production-path gate; see json/simplebeacon-gate.json.`);
    }
    if (roadmap.coverageEvidenceSource === 'omitted-stale-prior'
...
function sanitizeProductRoadmapExport(next, options = {}) {
    ...
    if (roadmap.developmentPhases) {
        roadmap.developmentPhases = sanitizeProductDevelopmentPhases(roadmap.developmentPhases, roadmap.codeAnalysis);
    }
    if (isStaleEmptyCodebaseMetrics(roadmap.codebaseMetrics)) {
        delete roadmap.codebaseMetrics;
    }
    if (roadmap.projectStructure && ((_a = roadmap.codeAnalysis) === null || _a === void 0 ? void 0 : _a.structure)) {
...
function collapseDuplicateBenchmarkPhases(roadmap) {
    ...
    if (!bench || bench.phasesRef || !Array.isArray(bench.phases))
        return roadmap;
    if (!phasesAreEquivalent(dev, bench.phases))
        return roadmap;
...
function alignProjectStructureInventory(projectStructure, structure) {
    if (!projectStructure || !(structure === null || structure === void 0 ? void 0 : structure.totalFiles))
...
function sanitizeCodebaseMetricsForBenchmark(metrics, structure) {
    ...
    const languages = structure.languages && Object.keys(structure.languages).length
        ? structure.languages
        : metrics === null || metrics === void 0 ? void 0 : metrics.languages;
    return {
        ...metrics,
        totalLinesOfCode: (metrics === null || metrics === void 0 ? void 0 : metrics.totalLinesOfCode) || null,
        languages: languages || {},
        testCoverage: null,
        complexity: (metrics === null || metrics === void 0 ? void 0 : metrics.complexity) || {},
        documentation: {
            readmeFiles: (_d = (_b = (_a = structure.languages) === null || _a === void 0 ? void 0 : _a['.md']) !== null && _b !== void 0 ? _b : (_c = metrics === null || metrics === void 0 ? void 0 : metrics.documentation) === null || _c === void 0 ? void 0 : _c.readmeFiles) !== null && _d !== void 0 ? _d : 0,
            totalDocs: (_f = (_e = structure.languages) === null || _e === void 0 ? void 0 : _e['.md']) !== null && _f !== void 0 ? _f : 0,
            coverage: null
        },
...
function sanitizeAiIntegrationForBenchmark(aiIntegration, misscopedPlatformWalk = false) {
    ...
    return {
        ...
        apiRouteCount: (_a = aiIntegration.apiRouteCount) !== null && _a !== void 0 ? _a : 0,
        confidence: null,
...
function sanitizeBenchmarkRecommendationItems(recommendations = []) {
    return recommendations.map((rec) => {
        ...
        if (!BENCHMARK_DELIVERY_FICTION.test(blob))
            return rec;
        return {
            ...rec,
...
function resolveRoadmapExportContext(roadmap, options = {}) {
    var _a;
    const sourceRoot = normalizeExportPath((roadmap === null || roadmap === void 0 ? void 0 : roadmap.sourceProjectPath)
        || (roadmap === null || roadmap === void 0 ? void 0 : roadmap.projectRoot)
        || ((_a = roadmap === null || roadmap === void 0 ? void 0 : roadmap.projectStructure) === null || _a === void 0 ? void 0 : _a.projectRoot)
        || '');
    const scanTargetRoot = normalizeExportPath(options.scanTargetRoot
        || options.requestedProjectPath
        || (roadmap === null || roadmap === void 0 ? void 0 : roadmap.scanTargetRoot)
        || (roadmap === null || roadmap === void 0 ? void 0 : roadmap.requestedScanRoot)
...
function filterTemplateRecommendations(recs = []) {
    return (recs || []).filter((item) => {
        const text = typeof item === 'string' ? item : (item === null || item === void 0 ? void 0 : item.action) || '';
...
function sanitizeStrategicInsights(insights, benchmarkScan) {
    ...
    if (benchmarkScan) {
        ...
        next.recommendations = sanitizeBenchmarkRecommendationItems(filteredRecs.length
            ? filteredRecs
            : [{
                    priority: 'LOW',
                    category: 'benchmark',
...
function sanitizeProgressMetrics(metrics, benchmarkScan, codeMetrics, misscopedPlatformWalk = false) {
    ...
    return {
        ...
        categories: {
            'OSS source': (codeMetrics === null || codeMetrics === void 0 ? void 0 : codeMetrics.codeFiles) ? Math.min(100, Math.round(codeMetrics.codeFiles / 20)) : null,
            Documentation: (_b = (_a = metrics.categories) === null || _a === void 0 ? void 0 : _a.Documentation) !== null && _b !== void 0 ? _b : null
        },
        metrics: {
            ...(metrics.metrics || {}),
            jestTests: (codeMetrics === null || codeMetrics === void 0 ? void 0 : codeMetrics.codeFiles) != null
...
function overlayMisscopedStructureInventory(structure, repositoryFilesTotal) {
    if (!structure || repositoryFilesTotal == null)
        return structure;
    return {
        ...structure,
...
function sanitizeCodeAnalysisForBenchmark(codeAnalysis, misscopedPlatformWalk = false) {
    ...
    if (Array.isArray(next.features)) {
        if (misscopedPlatformWalk) {
            ...
            next.features = next.features.filter((feature) => {
                const label = String((feature === null || feature === void 0 ? void 0 : feature.label) || (feature === null || feature === void 0 ? void 0 : feature.name) || '');
                if (/1000\/1000/.test(label) || Number(feature === null || feature === void 0 ? void 0 : feature.count) === 1000)
                    return false;
    ...
    const pairs = (_b = (_a = next.phase2) === null || _a === void 0 ? void 0 : _a.fuzzySimilarity) === null || _b === void 0 ? void 0 : _b.pairs;
        ...
        next.phase2 = {
            ...
            fuzzySimilarity: {
                ...
                pairs: pairs.map((pair) => {
                    ...
                    const isMirror = INTENTIONAL_MIRROR_PAIRS.some(([left, right]) => (a === left && b === right) || (a === right && b === left));
                    return isMirror
...
function sanitizeExecutiveSummaryForBenchmark(summary, codeMetrics) {
    ...
    return {
        ...
        codeFilesAnalyzed: (_a = codeMetrics === null || codeMetrics === void 0 ? void 0 : codeMetrics.codeFiles) !== null && _a !== void 0 ? _a : summary.codeFilesAnalyzed
    };
}
/**
...
export function sanitizeRoadmapExport(roadmap, options = {}) {
    ...
    if (misscopedPlatformWalk && options.repositoryFilesTotal != null && ((_a = next.codeAnalysis) === null || _a === void 0 ? void 0 : _a.structure)) {
        next.codeAnalysis = {
            ...next.codeAnalysis,
            structure: overlayMisscopedStructureInventory(next.codeAnalysis.structure, options.repositoryFilesTotal)
        };
    }
    ...
    if (next.recommendations) {
        ...
        const filtered = {
            ...
            priorities: {
                high: filterTemplateLines(((_b = rec.priorities) === null || _b === void 0 ? void 0 : _b.high) || rec.immediate),
                medium: filterTemplateLines(((_c = rec.priorities) === null || _c === void 0 ? void 0 : _c.medium) || rec.shortTerm),
                low: filterTemplateLines(((_d = rec.priorities) === null || _d === void 0 ? void 0 : _d.low) || rec.longTerm)
            }
        };
    ...
    if (((_e = next.developmentPhases) === null || _e === void 0 ? void 0 : _e.length) && matchesRoadmapTemplate(JSON.stringify(next.developmentPhases))) {
        if (!next.developmentPhasesTemplate) {
            next.developmentPhasesTemplate = next.developmentPhases;
        }
        next.developmentPhases = (((_f = next.benchmarkSprintModel) === null || _f === void 0 ? void 0 : _f.phases) || [{
    ...
    if ((_o = next.implementationPhases) === null || _o === void 0 ? void 0 : _o.length) {
        const alreadyBenchmark = next.implementationPhases.length === 1
            && String(((_p = next.implementationPhases[0]) === null || _p === void 0 ? void 0 : _p.phase) || '').toLowerCase().includes('benchmark filesystem');
        if (!alreadyBenchmark) {
    ...
    if (next.executiveSummary && typeof next.executiveSummary === 'object') {
        next.executiveSummary = sanitizeExecutiveSummaryForBenchmark(next.executiveSummary, (_q = next.codeAnalysis) === null || _q === void 0 ? void 0 : _q.structure);
    }
    ...
    next.progressMetrics = sanitizeProgressMetrics(next.progressMetrics, true, (_r = next.codeAnalysis) === null || _r === void 0 ? void 0 : _r.structure, misscopedPlatformWalk);
    ...
    if ((_t = (_s = next.codeAnalysis) === null || _s === void 0 ? void 0 : _s.phase2) === null || _t === void 0 ? void 0 : _t.resourceEstimate) {
        next.codeAnalysis.phase2.resourceEstimate = sanitizeResourceEstimateForBenchmark(next.codeAnalysis.phase2.resourceEstimate);
    }
    if (next.projectStructure) {
        ...
        }, (_u = next.codeAnalysis) === null || _u === void 0 ? void 0 : _u.structure);
    }
    if (next.codebaseMetrics) {
        next.codebaseMetrics = sanitizeCodebaseMetricsForBenchmark(next.codebaseMetrics, (_v = next.codeAnalysis) === null || _v === void 0 ? void 0 : _v.structure);
    }
