...
function resolveGateInventoryTotals(gateReport, hygiene = null) {
    ...
    const repositoryFilesTotal =
        (_d =
            (_c =
                (_a = gateReport === null || gateReport === void 0 ? void 0 : gateReport.repositoryFilesTotal) !==
                    null && _a !== void 0
                    ? _a
    ...
    const credentialScanned =
        (_k =
            (_j =
                (_h =
                    (_f =
                        (_e = gateReport === null || gateReport === void 0 ? void 0 : gateReport.credentialScanned) !==
                            null && _e !== void 0
                            ? _e
                        ...
                        ? _f
                        : (_g = gateReport === null || gateReport === void 0 ? void 0 : gateReport.scanScope) ===
                                null || _g === void 0
                          ? void 0
...
function resolveRoadmapGateContext(roadmap, options = {}) {
    ...
    const gateProfile =
        (_s =
            (_r =
                (_q = (_p = gateReport.scanScope) === null || _p === void 0 ? void 0 : _p.profile) !== null &&
                _q !== void 0
                    ? _q
    ...
    const blockingCount =
        (_8 =
            (_7 =
                (_6 = (_5 = gateReport.gate) === null || _5 === void 0 ? void 0 : _5.blockingCount) !== null &&
                _6 !== void 0
                    ? _6
...
function buildProductRoadmapHygieneSummary(roadmap, gateContext = {}) {
    ...
    return {
        roadmapAuditFiles:
            (_d =
                (_c = (_b = roadmap.codeAnalysis) === null || _b === void 0 ? void 0 : _b.structure) === null ||
                _c === void 0
                    ? void 0
...
function sanitizeProductDevelopmentPhases(phases, codeAnalysis) {
     ...
     */
    const jestFeature = (
        (codeAnalysis === null || codeAnalysis === void 0 ? void 0 : codeAnalysis.features) || []
    ).find(f => /jest test files/i.test(String((f === null || f === void 0 ? void 0 : f.name) || '')));
...
function sanitizeCodebaseMetricsForBenchmark(metrics, structure) {
    ...
    return {
        ...
        documentation: {
            readmeFiles:
                (_d =
                    (_b = (_a = structure.languages) === null || _a === void 0 ? void 0 : _a['.md']) !== null &&
                    _b !== void 0
                        ? _b
                        : (_c = metrics === null || metrics === void 0 ? void 0 : metrics.documentation) === null ||
                            _c === void 0
                          ? void 0
                    ...
                    : 0,
            totalDocs:
                (_f = (_e = structure.languages) === null || _e === void 0 ? void 0 : _e['.md']) !== null &&
                _f !== void 0
                    ? _f
                    : 0,
            coverage: null
    ...
    return {
        ...
        categories: {
            'OSS source': (codeMetrics === null || codeMetrics === void 0 ? void 0 : codeMetrics.codeFiles)
                ...
                : null,
            Documentation:
                (_b = (_a = metrics.categories) === null || _a === void 0 ? void 0 : _a.Documentation) !== null &&
                _b !== void 0
                    ? _b
                    : null
        },
...
function sanitizeExecutiveSummaryForBenchmark(summary, codeMetrics) {
    ...
    return {
        ...
        codeFilesAnalyzed:
            (_a = codeMetrics === null || codeMetrics === void 0 ? void 0 : codeMetrics.codeFiles) !== null &&
            _a !== void 0
                ? _a
        ...
        const filtered = {
            ...
            priorities: {
                ...
                low: filterTemplateLines(
                    ((_d = rec.priorities) === null || _d === void 0 ? void 0 : _d.low) || rec.longTerm
                )
            }
        };
