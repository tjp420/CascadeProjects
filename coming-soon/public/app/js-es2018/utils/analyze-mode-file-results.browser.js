...
function stepPayload(lastResult, stepId) {
    ...
    if ((lastResult === null || lastResult === void 0 ? void 0 : lastResult.kind) === 'complete') {
        return (_b =
            (_a = lastResult.steps) === null || _a === void 0 ? void 0 : _a.find(step => step.id === stepId)) !==
            null && _b !== void 0
            ? _b
            : null;
    }
        ...
        case 'simplebeacon':
            ...
            if ((lastResult === null || lastResult === void 0 ? void 0 : lastResult.kind) === 'complete')
                return {
                    kind: 'gate',
                    report:
                        (_a = stepPayload(lastResult, 'simplebeacon')) === null || _a === void 0 ? void 0 : _a.report
                };
        ...
        case 'eu-ai-act':
            ...
            if ((lastResult === null || lastResult === void 0 ? void 0 : lastResult.kind) === 'complete')
                return {
                    kind: 'gate',
                    report:
                        (_c = stepPayload(lastResult, 'simplebeacon')) === null || _c === void 0 ? void 0 : _c.report
                };
            return null;
        case 'mock-scan':
            if ((lastResult === null || lastResult === void 0 ? void 0 : lastResult.kind) === 'complete') {
        ...
        case 'compliance':
            ...
            if ((lastResult === null || lastResult === void 0 ? void 0 : lastResult.kind) === 'complete')
                return {
                    kind: 'compliance',
                    checklist:
                        (_h = stepPayload(lastResult, 'compliance')) === null || _h === void 0 ? void 0 : _h.checklist
                };
            return null;
        case 'npm-audit':
            ...
            if ((lastResult === null || lastResult === void 0 ? void 0 : lastResult.kind) === 'complete')
                return {
                    kind: 'npm',
                    npmAudit:
                        (_j = stepPayload(lastResult, 'npm-audit')) === null || _j === void 0 ? void 0 : _j.npmAudit
                };
            return null;
        case 'roadmap':
...
function buildRows(mode, payload) {
    ...
    if (payload.kind === 'fiction') {
        ...
        return {
            ...
            summary: {
                scoped:
                    (_b = (_a = payload.report) === null || _a === void 0 ? void 0 : _a.fictionJsonFilesScanned) !==
                        null && _b !== void 0
                        ? _b
                        : (_d = (_c = payload.report) === null || _c === void 0 ? void 0 : _c.scanScope) === null ||
                            _d === void 0
                          ? void 0
