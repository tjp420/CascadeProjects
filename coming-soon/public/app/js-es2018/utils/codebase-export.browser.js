...
function normalizeCodebaseExportPaths(report, scanTargetRoot = '', options = {}) {
    ...
    return {
        ...
        ...(report.scanTargetRoot || redactedRoot
            ? {
                  scanTargetRoot:
                      redactCodebasePathForExport(report.scanTargetRoot || rawRoot, pathOptions) || redactedRoot
              }
            : {}),
...
function resolveCodebaseHealthStatus(summary) {
    var _a, _b, _c, _d, _e;
    const total =
        (_a = summary === null || summary === void 0 ? void 0 : summary.findingsTotal) !== null && _a !== void 0
            ? _a
            : 0;
    const high =
        (_c =
...
function resolveGateInventoryContext(report, options = {}) {
        ...
        (_x =
            (_v =
                (_u =
                    (_r =
                        (_q =
                            (_p = gateReport.scanScope) === null || _p === void 0 ? void 0 : _p.fullDirectoryStats) ===
                            null || _q === void 0
                            ? void 0
    ...
    const gateProfile =
        (_3 =
            (_1 =
                (_z = (_y = gateReport.scanScope) === null || _y === void 0 ? void 0 : _y.profile) !== null &&
                _z !== void 0
                    ? _z
...
function buildProductCodebaseExportNotes(report, context = {}) {
    ...
    const medium =
        (_t =
            (_s = (_r = report.summary) === null || _r === void 0 ? void 0 : _r.severityCounts) === null ||
            _s === void 0
                ? void 0
    ...
    const high =
        (_w =
            (_v = (_u = report.summary) === null || _u === void 0 ? void 0 : _u.severityCounts) === null ||
            _v === void 0
                ? void 0
    ...
    const eslintFindings =
        (_z =
            (_y = (_x = report.summary) === null || _x === void 0 ? void 0 : _x.categoryCounts) === null ||
            _y === void 0
                ? void 0
...
function buildProductCodebaseHygieneSummary(report, options = {}) {
    ...
    return {
        ...
        mediumSeverityFindings:
            (_m = (_l = summary.severityCounts) === null || _l === void 0 ? void 0 : _l.medium) !== null &&
            _m !== void 0
                ? _m
                : 0,
...
function annotateStructureInsights(structureInsights) {
    var _a, _b, _c, _d, _e;
    if (
        !((_a = structureInsights === null || structureInsights === void 0 ? void 0 : structureInsights.samples) ===
            null || _a === void 0
            ? void 0
            : _a.length)
    )
            ...
            hygieneSummary: {
                healthScore:
                    ...
                    _e !== void 0
                        ...
                        : null,
                findingsTotal:
                    (_g = (_f = next.summary) === null || _f === void 0 ? void 0 : _f.findingsTotal) !== null &&
                    _g !== void 0
                        ? _g
                        : 0,
                codeFilesAnalyzed:
                    (_j = (_h = next.summary) === null || _h === void 0 ? void 0 : _h.codeFilesAnalyzed) !== null &&
                    _j !== void 0
                        ? _j
                        : null,
                repositoryFilesTotal:
                    (_o =
                        (_l = (_k = next.summary) === null || _k === void 0 ? void 0 : _k.repositoryFilesTotal) !==
                            null && _l !== void 0
                            ? _l
