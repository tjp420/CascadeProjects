        ...
        if (!(I(a) && !g()))
            try {
                ...
                if (o.ok) {
                    ...
                    if (l && (l.service === 'simplebeacon-bridge' || l.platform === 'Simplebeacon')) return `${a}/api`;
                }
        ...
        ? A && fe(F, A)
            ...
            : R ||
              ((R = (async () => {
                  ...
                  try {
                      const t = await C(`${e}/health`, { method: 'GET', headers: { Accept: 'application/json' } }, ae),
...
async function st(e = te()) {
    if (!De())
        return { available: !1, likelyBlocked: !1, extensionBridge: !1, origin: te() || Y, integratedSkipped: $() };
    if (!e) return { available: !1, likelyBlocked: !1, extensionBridge: !1, origin: Y, integratedSkipped: !0 };
    const t = be(e);
    return k() && !t && !g()
        ...
        : E && E.origin === e && fe(j, E)
          ...
          : O ||
            ((O = (async () => {
                ...
                try {
                    const n = await C(`${e}/api/ping`, { method: 'GET', headers: { Accept: 'application/json' } }, ae),
        ...
        const se = () => {
            ...
            if (
                (S.slice(0, w).forEach(u => {
                    ...
                    ((K.className = 'sb-compliance-file-badge'), (K.textContent = ie ? 'Clean' : String(u.status)));
