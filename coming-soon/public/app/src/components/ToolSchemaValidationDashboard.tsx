                ...
                <CardHeader>
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <CardDescription>
                                JSON schema enforcement for agent tool execution responses — validates tool outputs
                                before passing to inference pipeline
                            </CardDescription>
                        </div>
                                ...
                                <div className="flex items-center gap-2">
                                    <select
                                        ...
                                        onChange={e => {
                                            ...
                                            if (schema)
                                                setSchemaEditorText(
                                                    schema[dir] ? JSON.stringify(schema[dir], null, 2) : ''
                                                );
                                        }}
                                ...
                                {violations.map(v => (
                                    ...
                                    >
                                        <div className="flex items-center gap-2 flex-wrap">
                                            <Badge
                                                variant={v.direction === 'request' ? 'warning' : 'destructive'}
                                                className="text-[10px]"
                                            >
                                                {v.direction}
                                            </Badge>
