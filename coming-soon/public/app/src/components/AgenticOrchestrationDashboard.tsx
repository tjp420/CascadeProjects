...
interface ToolsData {
    builtin: Record<
        string,
        { name: string; description: string; parameters: Record<string, string>; category: string }
    >;
                ...
                <CardHeader>
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <CardDescription>
                                Multi-agent executor loop with tool wiring, state machine tracking, and guardrail
                                inspection passes
                            </CardDescription>
                        </div>
                            ...
                            <div className="space-y-2 max-h-[300px] overflow-y-auto">
                                {agents.map(agent => (
                                    ...
                                    >
                                        ...
                                        {agent.description && (
                                            <p className="text-[10px] text-foreground-muted">{agent.description}</p>
                                        )}
