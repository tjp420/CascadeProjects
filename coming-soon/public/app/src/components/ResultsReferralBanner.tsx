                ...
                <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-foreground-muted text-sm mt-1 leading-relaxed">
                            ...
                            <span className="text-emerald-400 font-bold font-mono">[{currentScanGrade}]</span>. Share
                            SimpleBeacon with another engineering manager. When they execute a private local code debt
                            scan, you both instantly unlock{' '}
