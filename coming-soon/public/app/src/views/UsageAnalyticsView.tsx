                                                ...
                                                <div className="flex items-center gap-2 pt-2 border-t flex-wrap">
                                                    ...
                                                    <div className="flex items-center gap-2 ml-auto">
                                                        <Button
                                                            ...
                                                            onClick={() =>
                                                                dispatchTicket(v.scanId, v.category, ticketTarget)
                                                            }
                                                        >
                                                    ...
                                                    {isTicketed ? (
                                                        ...
                                                        <>
                                                            ...
                                                            <Button
                                                                ...
                                                                size="sm"
                                                                disabled={
                                                                    !ticketRefInput.trim() || markingRow === rowKey
                                                                }
                                                                onClick={() =>
                                                                    markTicketed(
                                                                        v.scanId,
            ...
            {showScheduleModal && (
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-xs text-muted-foreground">
                            Configure a recurring compliance report that generates the 22-column ledger and emails it to
                            the specified recipients. Without SMTP configuration, reports are saved as stub files on
                            disk.
                        </p>
                        <div className="space-y-3">
                            <div className="grid grid-cols-2 gap-2">
            ...
            <Card className="mt-4">
                <CardHeader>
                    ...
                    <CardDescription className="text-xs">
                        Evaluate scan posture against organizational policy thresholds. Returns pass/fail for CI/CD
    ...
    echo "Deployment gate PASSED"`}
            ...
            {showGatePolicyModal && (
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-xs text-muted-foreground">
                            Configure organizational thresholds for CI/CD deployment gate evaluations. These thresholds
                            are applied to all gate evaluations unless overridden by query parameters.
                        </p>
                        <div className="space-y-3">
            ...
            <Card className="mt-4">
                <CardHeader>
                    ...
                    <CardDescription className="text-xs">
                        Immutable record of all administrative changes across ticket statuses, webhook configs, report
                        schedules, and deployment gate policies.
                    </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    {/* Stats Summary */}
            ...
            <Card className="mt-4">
                <CardHeader>
                    ...
                    <CardDescription className="text-xs">
                        Run adversarial test suites against LLM providers to benchmark bias, hallucination, injection
                        resistance, and policy compliance.
                    </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    {/* Stats Summary */}
