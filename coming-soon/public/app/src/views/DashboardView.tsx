                ...
                <Card className="relative overflow-hidden border-primary/20">
                    ...
                    <CardContent className="relative flex flex-col items-center text-center py-12 px-6 space-y-5">
                        ...
                        <p className="text-foreground-muted max-w-xl text-sm sm:text-base">
                            SimpleBeacon runs entirely on your local machine to audit, clean, and certify your AI code
                            pipelines for enterprise governance reviews.
                        </p>
            ...
            {isFreeTier && (
                <div className="space-y-4">
                    <div className="text-center">
                        ...
                        <p className="text-sm text-foreground-muted mt-1">
                            See exactly what your executives will present. A–F grade. Financial liability estimate.
                ...
                <Card className="border-primary/20">
                    <CardContent className="flex flex-col items-center text-center py-8 px-6 space-y-4">
                        ...
                        <p className="text-sm text-foreground-muted max-w-md">
                            Drag and drop a project folder to get started. No sign-up, no upload — runs entirely in your
                            browser.
                        </p>
                        <Button size="lg" onClick={() => navigate('analyze')} className="gap-2">
                            <FolderSearch className="h-4 w-4" />
