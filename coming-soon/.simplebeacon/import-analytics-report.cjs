...
const reportPath = process.argv[2] || 'c:\\Users\\Trevor\\CascadeProjects\\coming-soon\\.simplebeacon\\simplebeacon-analytics-report.json';
...
console.log(`  Critical: ${normalized.criticalCount}, High: ${normalized.highCount}, Med: ${normalized.mediumCount}, Low: ${normalized.lowCount}`);
