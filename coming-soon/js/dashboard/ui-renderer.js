...
function buildEuAiActControls(aiHits, licenseFiles, securityFiles, hasRiskAssessment = false) {
    ...
    controls.push({
        ...
        evidence:
            aiCount > 0
                ? `${aiCount} file(s) with AI SDK imports (e.g., openai, @anthropic-ai, @google/generative-ai)`
                : 'None detected',
        action:
            aiCount > 0
    ...
    controls.push({
        ...
        evidence:
            aiCount > 0
                ? `${aiCount} AI indicator(s); ${hasDocs ? docCount + ' governance doc(s) present — verify Annex III classification is explicitly documented' : '0 governance docs — add risk-assessment.md'}`
                : 'None detected',
        action:
            aiCount > 0
                ? hasDocs
...
function renderPreview(data) {
    ...
    if (typeof window.__simplebeaconSetReportForAI === 'function') window.__simplebeaconSetReportForAI(data);
    ...
    if (!Array.isArray(data.detectedIssues) && Array.isArray(data.allIssues)) data.detectedIssues = data.allIssues;
    if (!Array.isArray(data.detectedIssues)) data.detectedIssues = [];
    ...
    if (data.type === 'simplebeacon-npm-audit' && !data.gate) {
        ...
        data.gate = {
            pass: (_a = h.gatePass) !== null && _a !== void 0 ? _a : true,
            blockingCount: (h.critical || 0) + (h.high || 0),
            warningCount: (h.moderate || 0) + (h.low || 0)
        };
        data.qualityScore =
            h.gatePass === true
                ? 100
                : Math.max(
                      0,
                      100 - ((h.critical || 0) * 20 + (h.high || 0) * 10 + (h.moderate || 0) * 5 + (h.low || 0) * 2)
                  );
        ...
        data.npmAudit = {
            packageJsonCount: pjc1,
            dependencyCount: dc1,
            summary: `${pjc1} package.json file${pjc1 === 1 ? '' : 's'} found with ${dc1.toLocaleString()} total dependenc${dc1 === 1 ? 'y' : 'ies'}.`
        };
    }
    ...
    if (data.type === 'simplebeacon-public-summary' && !data.gate) {
        ...
        data.gate = {
            ...
            blockingCount:
                (((_f = data.severityCounts) === null || _f === void 0 ? void 0 : _f.critical) || 0) +
                (((_g = data.severityCounts) === null || _g === void 0 ? void 0 : _g.high) || 0),
            warningCount:
                (((_h = data.severityCounts) === null || _h === void 0 ? void 0 : _h.medium) || 0) +
                (((_j = data.severityCounts) === null || _j === void 0 ? void 0 : _j.low) || 0)
        };
    ...
    if (!data.gate) {
        ...
        if (
            (data.packageJsonCount !== undefined || data.dependencyCount !== undefined) &&
            !data.totalFiles &&
            !data.codebase &&
            !data.repositoryInventory
        ) {
            ...
            const low = h.low || 0;
            data.gate = {
                pass: (_u = h.gatePass) !== null && _u !== void 0 ? _u : true,
            ...
            data.npmAudit = {
                ...
                summary: `${pkgCount} package.json file${pkgCount === 1 ? '' : 's'} found with ${depCount.toLocaleString()} total dependenc${depCount === 1 ? 'y' : 'ies'}.`
            };
        } else {
            ...
            data.qualityScore =
                (_v = data.qualityScore) !== null && _v !== void 0
                    ? _v
                    : totalIssues === 0
                      ? 100
                      : Math.max(0, 100 - totalIssues * 2);
            data.totalFiles =
                (_x = (_w = data.totalFiles) !== null && _w !== void 0 ? _w : data.filesAnalyzed) !== null &&
                _x !== void 0
                    ? _x
                    : 0;
        }
    ...
    const gate =
        data.gate ||
        ((_z = (_y = data.results) === null || _y === void 0 ? void 0 : _y.simplebeacon) === null || _z === void 0
            ? void 0
            : _z.gate) ||
        {};
    const detectedIssues = Array.isArray(data.detectedIssues)
        ? data.detectedIssues
        : Array.isArray(data.rawIssues)
          ? data.rawIssues
          : [];
    const hasBlockingFindings =
        (gate.blockingCount || 0) > 0 ||
        (gate.blockingIssues || []).length > 0 ||
        detectedIssues.some(i => ['high', 'critical'].includes(i.severity));
    ...
    const quality =
        (_4 =
            (_1 = data.qualityScore) !== null && _1 !== void 0
                ? _1
                : (_3 = (_2 = data.results) === null || _2 === void 0 ? void 0 : _2.simplebeacon) === null ||
                    _3 === void 0
                  ? void 0
                  : _3.qualityScore) !== null && _4 !== void 0
            ? _4
            : rawIssues.length
    ...
    const files =
        (_11 =
            (_9 =
                (_7 =
                    (_6 = (_5 = data.totalFiles) !== null && _5 !== void 0 ? _5 : data.repositoryFilesTotal) !== null &&
                    _6 !== void 0
                        ? _6
                        : data.filesAnalyzed) !== null && _7 !== void 0
                    ? _7
                    : (_8 = data.summary) === null || _8 === void 0
                      ? void 0
                      : _8.files) !== null && _9 !== void 0
                ? _9
                : (_10 = data.summary) === null || _10 === void 0
                  ? void 0
                  : _10.repositoryFiles) !== null && _11 !== void 0
            ? _11
            : 0;
    const issues =
        (_14 =
            (_13 = (_12 = data.issueCount) !== null && _12 !== void 0 ? _12 : gate.blockingCount) !== null &&
            _13 !== void 0
                ? _13
                : detectedIssues.length) !== null && _14 !== void 0
            ? _14
            : 0;
    const project =
        data.projectRoot ||
    ...
    const issueItems = detectedIssues
        .slice(0, 5)
        .map(issue => {
            ...
            const confidence = issue.confidence
                ? `<span style="margin-left:6px;font-size:0.65rem;color:#64748B;">${Math.round(issue.confidence * 100)}% confidence</span>`
                : '';
    ...
    const moreIssues =
        detectedIssues.length > 5
            ? `<div class="issue-item" style="justify-content:center;"><span class="issue-text">+ ${detectedIssues.length - 5} more issues in full report</span></div>`
            : '';
    // SVG score ring
    ...
    const aiHits = detectedIssues
        .filter(isAiIssue)
        .map(i => i.filePath || '')
        .filter(Boolean);
    const licenseFiles =
        ((_15 = data.governance) === null || _15 === void 0 ? void 0 : _15.licenseFiles) ||
        ((_16 = data.compliance) === null || _16 === void 0 ? void 0 : _16.licenseFiles) ||
        [];
    const securityFiles =
        ((_17 = data.governance) === null || _17 === void 0 ? void 0 : _17.securityFiles) ||
        ((_18 = data.compliance) === null || _18 === void 0 ? void 0 : _18.securityFiles) ||
        [];
    const riskAssessmentFiles =
        ((_19 = data.compliance) === null || _19 === void 0 ? void 0 : _19.riskAssessmentFiles) || [];
    const hasRiskAssessment =
        riskAssessmentFiles.length > 0 ||
        (data.repositoryFilesTotal &&
            (data.detectedIssues || []).some(
                i => i.filePath && [].concat(i.filePath).some(fp => /risk-assessment/i.test(fp))
            ));
    ...
    const euAiaMatrixRows = euAiaControls
        .map(
            c => `
    ...
    const analysisModulesHtml = (() => {
        ...
        const pushModule = (num, icon, title, values, summary, statusColor, detailHtml) => {
            const hasIssues =
                values.some(v => typeof v.value === 'number' && v.value > 0) ||
                (statusColor && statusColor !== '#10B981' && statusColor !== '#34D399');
        ...
        const gateIssues = (data.detectedIssues || data.issues || []).filter(
            i => i.severity === 'high' || i.severity === 'critical'
        );
        const hasBlockingFindings =
            (g.blockingCount || 0) > 0 || (g.blockingIssues || []).length > 0 || gateIssues.length > 0;
        ...
        const gateDetail = gateIssues.length
            ? `<div class="detail-label">Blocking Findings</div><ul>${gateIssues
                  .map(i => {
                      const fp = Array.isArray(i.filePath) ? i.filePath : (i.filePath || '').split(',');
                      const findingsHtml =
                          i.findings && i.findings.length
                              ? `<div style="margin:4px 0;padding:4px 6px;background:rgba(30,41,59,0.5);border-radius:4px;font-size:0.65rem;font-family:monospace;color:#94A3B8;">${i.findings
                                    .slice(0, 2)
                                    .flatMap(f =>
                                        f.matches ? f.matches.map(m => `Line ${m.line}: ${m.snippet.slice(0, 80)}`) : []
                                    )
                                    .join('<br>')}</div>`
                              : '';
                  ...
                  .join('')}</ul>${
                  gateIssues.some(i => i.fix)
                      ? `<div class="detail-fix"><strong>Remediation:</strong> ${gateIssues
                            .map(i => i.fix)
                            .filter(Boolean)
                            .slice(0, 2)
                            .join(' ')}</div>`
            ...
            : `<div class="detail-label">No blocking findings</div><div style="font-size:0.72rem;color:var(--text-muted);">Gate is clear. Continue to next phase.</div>`;
        pushModule(
            '1',
            '🛡️',
            'Gate',
            ...
            g.summary ||
                (derivedPass === true ? 'Gate passed — no blocking credentials found.' : 'Review blocking issues.'),
            gateBorder,
            gateDetail
        );
        // 2. Consolidation
        ...
        const consDetail = dupFiles.length
            ? `<div class="detail-label">Duplicate Groups</div><ul>${dupFiles
                  .slice(0, 3)
                  .map(g => `<li>${g.slice(0, 2).join(' ↔ ')}${g.length > 2 ? ' ...' : ''}</li>`)
                  .join(
                      ''
                  )}</ul>${dupFiles.length > 3 ? `<div style="font-size:0.7rem;color:var(--text-muted);margin-top:4px;">... && ${dupFiles.length - 3} more groups</div>` : ''}<div class="detail-fix">Consolidate duplicate files into shared modules || remove redundant copies.</div>`
            : `<div class="detail-label">No duplicates found</div><div style="font-size:0.72rem;color:var(--text-muted);">Repository is well-deduplicated.</div>`;
        pushModule(
            '2',
            '🔀',
            'Consolidation',
            ...
            cons.summary ||
                (cons.duplicateGroups
                    ? `${cons.duplicateGroups} duplicate file groups detected (${dupPct}% of repo).`
                    : 'No duplicate files detected.'),
            cons.duplicateGroups ? '#F59E0B' : null,
            consDetail
        );
        // 3. Mock Data
        const mock = data.mockDataCategories || [];
        const mockTotal =
            (_e = data.mockSampleFiles) !== null && _e !== void 0
                ? _e
                : mock.reduce((a, c) => a + (c.fileCount || 0), 0);
        ...
        for (const f of mockFiles) {
            const key = f.includes('src/lib/')
                ? 'src/lib/ (utility code)'
                : f.includes('.github-sync/')
                  ? '.github-sync/ (sync artifacts)'
                  : f.includes('docs/')
                    ? 'docs/ (documentation)'
                    : f.includes('test')
                      ? 'test/ (test fixtures)'
        ...
        const pathBreakdown = Object.entries(pathGroups)
            .sort((a, b) => b[1] - a[1])
            .map(
                ([k, v]) =>
                    `<div style="display:flex;justify-content:space-between;padding:3px 0;border-bottom:1px solid rgba(255,255,255,0.05);"><span style="color:#94A3B8;font-size:0.75rem;">${k}</span><span style="color:#60A5FA;font-weight:600;font-size:0.75rem;">${v}</span></div>`
            )
            .join('');
        const riskAlert = mockFiles.some(f => f.includes('src/lib/'))
            ? `<div style="background:rgba(239,68,68,0.08);border:1px solid rgba(239,68,68,0.25);border-radius:6px;padding:8px 10px;margin:8px 0;font-size:0.72rem;color:#EF4444;"><strong>Risk:</strong> 4 files under <code>src/lib/</code> contain utility logic (validators, resolvers). Verify they are test-only imports.</div>`
            : '';
        const mockDetail = mockFilesPreview.length
            ? `<div class="detail-label">Mock / Fixture Files</div><div style="background:rgba(15,23,42,0.5);border-radius:8px;padding:10px;margin-bottom:8px;">${pathBreakdown}</div>${riskAlert}<ul>${mockFilesPreview.map(f => `<li>${f}</li>`).join('')}</ul>${mockTotal > mockFilesPreview.length ? `<div style="font-size:0.7rem;color:var(--text-muted);margin-top:4px;">... && ${mockTotal - mockFilesPreview.length} more</div>` : ''}<div class="detail-fix">Review if mock data should be excluded from production bundles.</div>`
            : `<div class="detail-label">No mock data</div><div style="font-size:0.72rem;color:var(--text-muted);">No fixture || sample files detected.</div>`;
        pushModule(
            '3',
            '🔍',
            'Mock Data',
            ...
            mockTotal
                ? `${mockTotal} mock/fixture file${mockTotal === 1 ? '' : 's'} detected (${mockPct}% of total).`
                : 'No mock data found.',
            mockTotal > 50 ? '#EF4444' : mockTotal > 0 ? '#F59E0B' : null,
            mockDetail
        );
        // 4. Roadmap
        ...
        const rmDetail = todoFiles.length
            ? `<div class="detail-label">Task / Fix Files</div><ul>${todoFiles.map(f => `<li>${f}</li>`).join('')}</ul>${(rm.todoCount || 0) > todoFiles.length ? `<div style="font-size:0.7rem;color:var(--text-muted);margin-top:4px;">... && ${(rm.todoCount || 0) - todoFiles.length} more files</div>` : ''}<div class="detail-fix">Address critical tasks before release. Consider converting fixes into tracked issues.</div>`
            : `<div class="detail-label">Clean codebase</div><div style="font-size:0.72rem;color:var(--text-muted);">No task || fix markers found.</div>`;
        pushModule(
            '4',
            '🗺️',
            'Roadmap',
            ...
            rm.summary ||
                (rm.todoCount || 0
                    ? `${rm.todoCount} file${rm.todoCount !== 1 ? 's' : ''} contain${rm.todoCount === 1 ? 's' : ''} task/fix markers (${todoDensity}% of repo).`
        ...
        const ftEntries = Object.entries(ft)
            .sort((a, b) => b[1] - a[1])
            .slice(0, 5);
        const cbDetail = ftEntries.length
            ? `<div class="detail-label">File Type Breakdown</div><ul>${ftEntries.map(([ext, count]) => `<li><strong>${ext}</strong> — ${count} file${count !== 1 ? 's' : ''}</li>`).join('')}</ul><div class="detail-fix">Average ${avgLines} lines/file. ${avgLines > 500 ? 'Large files may benefit from refactoring.' : ''}</div>`
            : `<div class="detail-label">Codebase overview</div><div style="font-size:0.72rem;color:var(--text-muted);">${(cb.totalFiles || files).toLocaleString()} files, ${(cb.totalLines || 0).toLocaleString()} lines analyzed.</div>`;
        pushModule(
            '5',
            '🧹',
            'Codebase',
            ...
            cb.summary ||
                `${(cb.totalFiles || files).toLocaleString()} files analyzed, ${(cb.totalLines || 0).toLocaleString()} lines of code.`,
            avgLines > 800 ? '#EF4444' : null,
            cbDetail
        );
        // 6. File Reduction
        ...
        const frDetail = assets.length
            ? `<div class="detail-label">Unused Asset Candidates</div><ul>${assets.map(a => `<li>${a}</li>`).join('')}</ul>${assetCount > assets.length ? `<div style="font-size:0.7rem;color:var(--text-muted);margin-top:4px;">... && ${assetCount - assets.length} more</div>` : ''}<div class="detail-fix">Review && remove unused assets to reduce bundle size.</div>`
            : `<div class="detail-label">No reduction opportunities</div><div style="font-size:0.72rem;color:var(--text-muted);">No unused asset candidates detected.</div>`;
        pushModule(
            '6',
            '📦',
            'File Reduction',
            ...
            fr.summary ||
                (assetCount ? `${assetCount} image assets detected for review.` : 'No file reduction opportunities.'),
            assetCount > 0 ? '#F59E0B' : null,
            frDetail
        );
        // 7. Data Quality
        const dq = data.dataQuality || {};
        const emptyJson = (dq.emptyJsonFiles || []).slice(0, 6);
        const dqDetail = emptyJson.length
            ? `<div class="detail-label">Empty / Trivial JSON Files</div><ul>${emptyJson.map(f => `<li>${f}</li>`).join('')}</ul>${(dq.emptyJsonCount || 0) > emptyJson.length ? `<div style="font-size:0.7rem;color:var(--text-muted);margin-top:4px;">... && ${(dq.emptyJsonCount || 0) - emptyJson.length} more</div>` : ''}<div class="detail-fix">Remove empty JSON files || add meaningful content. They bloat the repository && confuse tooling.</div>`
            : `<div class="detail-label">Data quality verified</div><div style="font-size:0.72rem;color:var(--text-muted);">No empty || trivial JSON files detected.</div>`;
        pushModule(
            '7',
            '🧪',
            'Data Quality',
            [
                {
                    value: dq.emptyJsonCount || 0,
                    label: 'Empty JSON',
                    color: (dq.emptyJsonCount || 0) > 0 ? '#EF4444' : '#34D399'
                }
            ],
            dq.summary ||
                (dq.emptyJsonCount || 0
                    ? `${dq.emptyJsonCount} empty JSON files detected.`
                    : 'No data quality issues.'),
            (dq.emptyJsonCount || 0) > 0 ? '#EF4444' : null,
            dqDetail
        );
        // 8. Cleanup
        const cl = data.cleanup || {};
        const debugSeverity =
            (cl.debugArtifactCount || 0) > 20 ? '#EF4444' : (cl.debugArtifactCount || 0) > 0 ? '#F59E0B' : null;
        const debugArts = (cl.debugArtifacts || []).slice(0, 6);
        const clDetail = debugArts.length
            ? `<div class="detail-label">Build Artifacts</div><ul>${debugArts.map(f => `<li>${f}</li>`).join('')}</ul>${(cl.debugArtifactCount || 0) > debugArts.length ? `<div style="font-size:0.7rem;color:var(--text-muted);margin-top:4px;">... && ${(cl.debugArtifactCount || 0) - debugArts.length} more</div>` : ''}<div class="detail-fix">Remove log statements, breakpoint statements, && open item markers before production builds.</div>`
            : `<div class="detail-label">Clean build ready</div><div style="font-size:0.72rem;color:var(--text-muted);">No build artifacts detected.</div>`;
        pushModule(
            '8',
            '🗂️',
            'Cleanup',
            ...
            cl.summary ||
                (cl.debugArtifactCount || 0
                    ? `${cl.debugArtifactCount} build artifacts detected — remove log statements, breakpoint statements, open item markers before production.`
                    : 'No cleanup items.'),
            debugSeverity,
            clDetail
        );
        ...
        const npmDetail = pkgFiles.length
            ? `<div class="detail-label">package.json Files</div><ul>${pkgFiles.map(f => `<li>${f}</li>`).join('')}</ul><div class="detail-fix">${(npm.dependencyCount || 0).toLocaleString()} total dependencies. ${depsPerPkg > 50 ? 'High dependency count — consider auditing for unused packages.' : ''}</div>`
            : `<div class="detail-label">No npm projects</div><div style="font-size:0.72rem;color:var(--text-muted);">No package.json files detected in scan.</div>`;
        pushModule(
            '9',
            '📦',
            'npm Audit',
        ...
        const compDetail = compScore
            ? `<div class="detail-label">Governance Files</div>${licFiles.length ? '<ul>' + licFiles.map(f => `<li>&#128220; ${f}</li>`).join('') + '</ul>' : ''}${secFiles.length ? '<ul>' + secFiles.map(f => `<li>&#128272; ${f}</li>`).join('') + '</ul>' : ''}<div class="detail-fix">Verify license compatibility with your distribution model.</div>`
            : `<div class="detail-label">No governance files</div><div style="font-size:0.72rem;color:var(--text-muted);">Consider adding LICENSE && SECURITY.md.</div>`;
        pushModule(
            '10',
            '✅',
            'Compliance',
            ...
            comp.summary ||
                (compScore
                    ? `${comp.licenseCount || 0} license files, ${comp.securityCount || 0} security/governance files detected.`
                    : 'No governance files detected.'),
            compScore === 0 ? '#EF4444' : null,
            compDetail
        );
        ...
        if (data.checkEuAi !== false) {
            ...
            const euDetail =
                eu.aiSystemIndicators || 0
                    ? `<div class="detail-label">AI System Indicators</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">${eu.aiSystemIndicators} indicator(s) detected. High-risk systems must comply by August 2026.</div>${euDocs.length ? '<div class="detail-label">Documentation Found</div><ul>' + euDocs.map(f => `<li>${f}</li>`).join('') + '</ul>' : ''}<div class="detail-fix">Review AI system classification (Art. 6) && schedule legal review if high-risk.</div>`
                    : `<div class="detail-label">No AI indicators</div><div style="font-size:0.72rem;color:var(--text-muted);">No EU AI Act indicators detected in this codebase.</div>`;
            pushModule(
                '11',
                '🇪🇺',
                'EU AI Act',
        ...
        const vulnDetail = vulnCount
            ? `<div class="detail-label">Vulnerability Summary</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">${vulnCount} total issue${vulnCount === 1 ? '' : 's'} found across dependencies.</div>${criticalVulns ? `<div style="font-size:0.7rem;color:#EF4444;margin-bottom:4px;">&#128308; ${criticalVulns} critical</div>` : ''}${highVulns ? `<div style="font-size:0.7rem;color:#F59E0B;margin-bottom:4px;">&#128993; ${highVulns} high</div>` : ''}${vulnFiles.length ? `<div class="detail-label">Affected Packages</div><ul>${vulnFiles.map(f => `<li>${f}</li>`).join('')}</ul>` : ''}<div class="detail-fix">Run ‘npm audit fix’ || update packages. Review breaking changes before major version bumps.</div>`
            : `<div class="detail-label">No known vulnerabilities</div><div style="font-size:0.72rem;color:var(--text-muted);">Dependency scan shows no flagged CVEs || audit warnings.</div>`;
        pushModule(
            '12',
            '🔒',
            'Dependency Vulns',
            [
                { value: vulnCount, label: 'Vulnerabilities', color: vulnColor || '#60A5FA' },
                {
                    ...
                    label: 'Severe',
                    color: criticalVulns > 0 ? '#EF4444' : highVulns > 0 ? '#F59E0B' : '#60A5FA'
                }
            ],
            vulnCount
                ? `${vulnCount} dependency issue${vulnCount === 1 ? '' : 's'} detected${criticalVulns ? ` (${criticalVulns} critical)` : ''}.`
        ...
        if (br.checklist && br.checklist.length > 0 && !brLooksStale) {
            ...
            readinessScore =
                (_f = br.readinessScore) !== null && _f !== void 0
                    ? _f
                    : Math.round((checks.filter(c => c.found).length / checks.length) * 100);
            readinessStatus =
                br.readinessStatus ||
                (readinessScore >= 80 ? 'READY' : readinessScore >= 50 ? 'NEEDS WORK' : 'BLOCKED');
        } else {
            ...
            const hasCiCd = lowerPaths.some(p =>
            ...
            const hasBuildScript = lowerPaths.some(p =>
            ...
            const hasBuildArtifactsCommitted = lowerPaths.some(
                p => /\/(dist|build|\.next|out)\//.test(p) && !/node_modules\//.test(p)
            );
        ...
        pushModule(
            ...
            [
                { value: readinessScore + '%', label: 'Score', color: readinessColor },
                {
                    ...
                    label: 'Blockers',
                    color: missingCritical.length > 0 ? '#EF4444' : '#10B981'
                }
            ],
            `${readinessStatus} — ${checks.filter(c => c.found).length} of ${checks.length} checklist items present.${missingCritical.length ? ` ${missingCritical.length} critical blocker${missingCritical.length === 1 ? '' : 's'}.` : ''}`,
            readinessColor,
            buildDetail
        );
        ...
        const aiDetail = aiSdkCount
            ? '<div class="detail-label">AI SDK Imports</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
              aiSdkCount +
              ' AI/LLM SDK import(s) detected.</div>' +
              (aiFiles.length
                  ? '<div class="detail-label">Files</div><ul>' +
                    aiFiles.map(f => '<li>' + escapeHtml(f) + '</li>').join('') +
                    '</ul>'
                  : '') +
              '<div class="detail-fix">Verify all AI integrations are approved && document model usage for compliance.</div>'
            : '<div class="detail-label">No AI indicators</div><div style="font-size:0.72rem;color:var(--text-muted);">No AI/LLM SDK imports or model inference patterns detected.</div>';
        pushModule(
            '14',
            '🤖',
            ...
            aiSdkCount
                ? aiSdkCount + ' AI SDK import' + (aiSdkCount === 1 ? '' : 's') + ' detected.'
        ...
        const govDetail = govLicense
            ? '<div class="detail-label">License Headers</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
              govLicense +
              ' file(s) with license headers.</div>' +
              (govCopyright
                  ? '<div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
                    govCopyright +
                    ' copyright notice(s).</div>'
                  : '') +
              (govFiles.length
                  ? '<div class="detail-label">Files</div><ul>' +
                    govFiles.map(f => '<li>' + escapeHtml(f) + '</li>').join('') +
                    '</ul>'
                  : '') +
              '<div class="detail-fix">Ensure license compatibility with your distribution model.</div>'
            : '<div class="detail-label">No license headers</div><div style="font-size:0.72rem;color:var(--text-muted);">No license or copyright markers detected.</div>';
        pushModule(
            '15',
            '📜',
            'License & Governance',
            ...
            govLicense
                ? govLicense + ' license header' + (govLicense === 1 ? '' : 's') + ' detected.'
        ...
        if (hygiene.totalFiles) {
            junkDetail +=
                '<div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
                hygiene.totalFiles.toLocaleString() +
                ' total files · ' +
                hygiene.usefulFiles.toLocaleString() +
                ' useful · ' +
                uselessPct +
                '% bloat</div>';
            junkDetail +=
                '<table style="width:100%;font-size:0.7rem;color:#94A3B8;margin-bottom:8px;border-collapse:collapse;"><tbody>';
            if (hBreak.nodeModules)
                junkDetail +=
                    '<tr><td style="padding:2px 0;">node_modules</td><td style="text-align:right;padding:2px 0;">' +
                    hBreak.nodeModules.toLocaleString() +
                    '</td></tr>';
            if (hBreak.git)
                junkDetail +=
                    '<tr><td style="padding:2px 0;">.git objects</td><td style="text-align:right;padding:2px 0;">' +
                    hBreak.git.toLocaleString() +
                    '</td></tr>';
            if (hBreak.buildArtifacts)
                junkDetail +=
                    '<tr><td style="padding:2px 0;">Build artifacts</td><td style="text-align:right;padding:2px 0;">' +
                    hBreak.buildArtifacts.toLocaleString() +
                    '</td></tr>';
            if (hBreak.cacheDirs)
                junkDetail +=
                    '<tr><td style="padding:2px 0;">Cache dirs</td><td style="text-align:right;padding:2px 0;">' +
                    hBreak.cacheDirs.toLocaleString() +
                    '</td></tr>';
            if (hBreak.lockfiles)
                junkDetail +=
                    '<tr><td style="padding:2px 0;">Lockfiles</td><td style="text-align:right;padding:2px 0;">' +
                    hBreak.lockfiles.toLocaleString() +
                    '</td></tr>';
            if (hBreak.archives)
                junkDetail +=
                    '<tr><td style="padding:2px 0;">Archives</td><td style="text-align:right;padding:2px 0;">' +
                    hBreak.archives.toLocaleString() +
                    '</td></tr>';
            if (hBreak.binaries)
                junkDetail +=
                    '<tr><td style="padding:2px 0;">Binary/media</td><td style="text-align:right;padding:2px 0;">' +
                    hBreak.binaries.toLocaleString() +
                    '</td></tr>';
            if (hBreak.traditionalJunk)
                junkDetail +=
                    '<tr><td style="padding:2px 0;">Junk/temp files</td><td style="text-align:right;padding:2px 0;">' +
                    hBreak.traditionalJunk.toLocaleString() +
                    '</td></tr>';
            junkDetail += '</tbody></table>';
        }
        if (junkFiles.length) {
            junkDetail +=
                '<div class="detail-label">Junk Files</div><ul>' +
                junkFiles.map(f => '<li>' + escapeHtml(f) + '</li>').join('') +
                '</ul>';
        }
        junkDetail +=
            '<div class="detail-fix">Run <code>npm ci</code> to deduplicate lockfiles. Delete build artifacts before commits. Add large binaries to .gitignore.</div>';
        pushModule(
            '16',
            '🗑️',
            'Junk & Temp Files',
        ...
        const arDetail =
            arHits > 0
                ? '<div class="detail-label">AI Residue Patterns</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
                  arHits +
                  ' pattern(s) detected.</div>' +
                  (arFindings.length
                      ? '<div class="detail-label">Findings</div><ul>' +
                        arFindings
                            .map(f => '<li>' + escapeHtml(f.file) + ' — ' + escapeHtml(f.type) + '</li>')
                            .join('') +
                        '</ul>'
                      : '') +
                  '<div class="detail-fix">Replace stubs with real implementations, modernize deprecated APIs, and add proper error handling.</div>'
                : '<div class="detail-label">Clean codebase</div><div style="font-size:0.72rem;color:var(--text-muted);">No AI residue patterns detected.</div>';
        pushModule(
            '17',
            '🤖',
            'AI Residue',
            ...
            arHits > 0
                ? arHits +
                      ' AI residue pattern' +
                      (arHits === 1 ? '' : 's') +
                      ' detected (stubs, deprecated APIs, error swallowing, dead code).'
        ...
        const perfDetail =
            perfCount > 0
                ? '<div class="detail-label">Performance Issues</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
                  perfCount +
                  ' issue(s).</div>' +
                  (perfFindingsUI.length
                      ? '<div class="detail-label">Files</div><ul>' +
                        perfFindingsUI
                            .map(f => '<li>' + escapeHtml(f.file) + ' — ' + escapeHtml(f.type) + '</li>')
                            .join('') +
                        '</ul>'
                      : '') +
                  '<div class="detail-fix">Optimize nested loops, debounce listeners, and review regex complexity.</div>'
                : '<div class="detail-label">Clean performance</div><div style="font-size:0.72rem;color:var(--text-muted);">No performance anti-patterns detected.</div>';
        pushModule(
            '18',
            '🚀',
            'Performance',
            [{ value: perfCount, label: 'Issues', color: perfColor || '#60A5FA' }],
            perfCount > 0
        ...
        const tsDetail =
            tsCount > 0
                ? '<div class="detail-label">Type Safety Gaps</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
                  tsCount +
                  ' gap(s).</div>' +
                  (tsFindingsUI.length
                      ? '<ul>' + tsFindingsUI.map(f => '<li>' + escapeHtml(f.file) + '</li>').join('') + '</ul>'
                      : '') +
                  '<div class="detail-fix">Replace any with specific types, add PropTypes, and limit function parameters.</div>'
                : '<div class="detail-label">Strongly typed</div><div style="font-size:0.72rem;color:var(--text-muted);">No type safety gaps detected.</div>';
        pushModule(
            '19',
            '🔧',
            'Type Safety',
            [{ value: tsCount, label: 'Gaps', color: tsColor || '#60A5FA' }],
            tsCount > 0
        ...
        const docDetail =
            docCount > 0
                ? '<div class="detail-label">Documentation Gaps</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
                  docCount +
                  ' gap(s).</div>' +
                  (docFindingsUI.length
                      ? '<ul>' + docFindingsUI.map(f => '<li>' + escapeHtml(f.file) + '</li>').join('') + '</ul>'
                      : '') +
                  '<div class="detail-fix">Add JSDoc to public functions and keep README in sync with recent changes.</div>'
        ...
        pushModule(
            ...
            '📖',
            'Documentation',
            [{ value: docCount, label: 'Gaps', color: docColor || '#60A5FA' }],
            docCount > 0
        ...
        const tcDetail =
            tcCount > 0
                ? '<div class="detail-label">Test Coverage Gaps</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
                  tcCount +
                  ' gap(s).</div>' +
                  (tcFindingsUI.length
                      ? '<ul>' + tcFindingsUI.map(f => '<li>' + escapeHtml(f.file) + '</li>').join('') + '</ul>'
                      : '') +
                  '<div class="detail-fix">Implement skipped tests and add tests for complex untested functions.</div>'
                : '<div class="detail-label">Good coverage</div><div style="font-size:0.72rem;color:var(--text-muted);">No test coverage gaps detected.</div>';
        pushModule(
            '21',
            '🧪',
            'Test Coverage',
            [{ value: tcCount, label: 'Gaps', color: tcColor || '#60A5FA' }],
            tcCount > 0
        ...
        const a11yDetail =
            a11yCount > 0
                ? '<div class="detail-label">Accessibility Gaps</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
                  a11yCount +
                  ' issue(s).</div>' +
                  (a11yFindingsUI.length
                      ? '<ul>' + a11yFindingsUI.map(f => '<li>' + escapeHtml(f.file) + '</li>').join('') + '</ul>'
                      : '') +
                  '<div class="detail-fix">Add alt text to images, aria-label to buttons, and labels to form inputs.</div>'
                : '<div class="detail-label">Accessible</div><div style="font-size:0.72rem;color:var(--text-muted);">No accessibility gaps detected.</div>';
        pushModule(
            '22',
            '♿',
            'Accessibility',
            [{ value: a11yCount, label: 'Issues', color: a11yColor || '#60A5FA' }],
            a11yCount > 0
        ...
        const i18nDetail =
            i18nCount > 0
                ? '<div class="detail-label">i18n Issues</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
                  i18nCount +
                  ' issue(s).</div>' +
                  (i18nFindingsUI.length
                      ? '<ul>' + i18nFindingsUI.map(f => '<li>' + escapeHtml(f.file) + '</li>').join('') + '</ul>'
                      : '') +
                  '<div class="detail-fix">Wrap UI strings in t()/i18n() and use locale-aware date/currency formatting.</div>'
                : '<div class="detail-label">i18n Ready</div><div style="font-size:0.72rem;color:var(--text-muted);">No i18n issues detected.</div>';
        pushModule(
            '23',
            '🌍',
            'i18n Readiness',
            [{ value: i18nCount, label: 'Issues', color: i18nColor || '#60A5FA' }],
            i18nCount > 0
        ...
        const sdDetail =
            sdCount > 0
                ? '<div class="detail-label">Sensitive Data Exposure</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
                  sdCount +
                  ' exposure(s).</div>' +
                  (sdFindingsUI.length
                      ? '<ul>' + sdFindingsUI.map(f => '<li>' + escapeHtml(f.file) + '</li>').join('') + '</ul>'
                      : '') +
                  '<div class="detail-fix">Remove PII from logs/source, sanitize user data, and avoid storing tokens in localStorage.</div>'
                : '<div class="detail-label">Clean data</div><div style="font-size:0.72rem;color:var(--text-muted);">No sensitive data exposures detected.</div>';
        pushModule(
            '24',
            '🕵️',
            'Sensitive Data',
            [{ value: sdCount, label: 'Exposures', color: sdColor || '#60A5FA' }],
            sdCount > 0
        ...
        const cdDetail =
            cdCount > 0
                ? '<div class="detail-label">Configuration Drift</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
                  cdCount +
                  ' drift(s).</div>' +
                  (cdFindingsUI.length
                      ? '<ul>' + cdFindingsUI.map(f => '<li>' + escapeHtml(f.file) + '</li>').join('') + '</ul>'
                      : '') +
                  '<div class="detail-fix">Move secrets to environment variables, externalize URLs, and never commit .env files.</div>'
                : '<div class="detail-label">Clean config</div><div style="font-size:0.72rem;color:var(--text-muted);">No configuration drift detected.</div>';
        pushModule(
            '25',
            '⚙️',
            'Config Drift',
            [{ value: cdCount, label: 'Drifts', color: cdColor || '#60A5FA' }],
            cdCount > 0
        ...
        const shDetail =
            shCount > 0
                ? '<div class="detail-label">Security Headers</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
                  shCount +
                  ' reference(s).</div>' +
                  (shFindingsUI.length
                      ? '<ul>' + shFindingsUI.map(f => '<li>' + escapeHtml(f.file) + '</li>').join('') + '</ul>'
                      : '') +
                  '<div class="detail-fix">Ensure CSP, X-Frame-Options, HSTS, and Referrer-Policy are configured.</div>'
                : '<div class="detail-label">No header configs</div><div style="font-size:0.72rem;color:var(--text-muted);">No security header configuration files detected.</div>';
        pushModule(
            '26',
            '🔒',
            'Security Headers',
            [{ value: shCount, label: 'Refs', color: shColor || '#60A5FA' }],
            shCount > 0
        ...
        const dbpDetail =
            dbpCount > 0
                ? '<div class="detail-label">Database Anti-Patterns</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
                  dbpCount +
                  ' issue(s).</div>' +
                  (dbpFindingsUI.length
                      ? '<ul>' + dbpFindingsUI.map(f => '<li>' + escapeHtml(f.file) + '</li>').join('') + '</ul>'
                      : '') +
                  '<div class="detail-fix">Use parameterized queries, add pagination limits, and wrap in transactions.</div>'
                : '<div class="detail-label">Clean DB patterns</div><div style="font-size:0.72rem;color:var(--text-muted);">No database anti-patterns detected.</div>';
        pushModule(
            '27',
            '💾',
            'Database Patterns',
            [{ value: dbpCount, label: 'Issues', color: dbpColor || '#60A5FA' }],
            dbpCount > 0
        ...
        const fpDetail =
            fpCount > 0
                ? '<div class="detail-label">Framework Practice Issues</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
                  fpCount +
                  ' issue(s).</div>' +
                  (fpFindingsUI.length
                      ? '<ul>' + fpFindingsUI.map(f => '<li>' + escapeHtml(f.file) + '</li>').join('') + '</ul>'
                      : '') +
                  '<div class="detail-fix">Fix hook dependencies, avoid direct DOM access, and add cleanup in Angular.</div>'
                : '<div class="detail-label">Clean framework code</div><div style="font-size:0.72rem;color:var(--text-muted);">No framework practice issues detected.</div>';
        pushModule(
            '28',
            '💻',
            'Framework Practices',
            [{ value: fpCount, label: 'Issues', color: fpColor || '#60A5FA' }],
            fpCount > 0
        ...
        const whDetail =
            whCount > 0
                ? '<div class="detail-label">Workspace Health Issues</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
                  whCount +
                  ' issue(s).</div>' +
                  (whFindingsUI.length
                      ? '<ul>' + whFindingsUI.map(f => '<li>' + escapeHtml(f.file) + '</li>').join('') + '</ul>'
                      : '') +
                  '<div class="detail-fix">Refactor shared code into common packages and align dependency versions.</div>'
                : '<div class="detail-label">Healthy workspace</div><div style="font-size:0.72rem;color:var(--text-muted);">No workspace health issues detected.</div>';
        pushModule(
            '29',
            '📊',
            'Workspace Health',
            [{ value: whCount, label: 'Issues', color: whColor || '#60A5FA' }],
            whCount > 0
        ...
        const udDetail =
            udCount > 0
                ? '<div class="detail-label">Unused Dependencies</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
                  udCount +
                  ' flag(s).</div>' +
                  (udFindingsUI.length
                      ? '<ul>' + udFindingsUI.map(f => '<li>' + escapeHtml(f.file) + '</li>').join('') + '</ul>'
                      : '') +
                  '<div class="detail-fix">Remove unused packages from package.json to reduce bundle size and attack surface.</div>'
                : '<div class="detail-label">Lean deps</div><div style="font-size:0.72rem;color:var(--text-muted);">No unused dependency flags detected.</div>';
        pushModule(
            '30',
            '📦',
            'Unused Dependencies',
            [{ value: udCount, label: 'Flags', color: udColor || '#60A5FA' }],
            udCount > 0
        ...
        const acDetail =
            acCount > 0
                ? '<div class="detail-label">API Contract Drift</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
                  acCount +
                  ' drift(s).</div>' +
                  (acFindingsUI.length
                      ? '<ul>' + acFindingsUI.map(f => '<li>' + escapeHtml(f.file) + '</li>').join('') + '</ul>'
                      : '') +
                  '<div class="detail-fix">Sync OpenAPI specs with implementation and verify frontend consumes all endpoints.</div>'
                : '<div class="detail-label">Synced contracts</div><div style="font-size:0.72rem;color:var(--text-muted);">No API contract drift detected.</div>';
        pushModule(
            '31',
            '🔄',
            'API Contract',
            [{ value: acCount, label: 'Drifts', color: acColor || '#60A5FA' }],
            acCount > 0
        ...
        const cxDetail =
            cxCount > 0
                ? '<div class="detail-label">Complexity Issues</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
                  cxCount +
                  ' issue(s).</div>' +
                  (cxFindingsUI.length
                      ? '<ul>' + cxFindingsUI.map(f => '<li>' + escapeHtml(f.file) + '</li>').join('') + '</ul>'
                      : '') +
                  '<div class="detail-fix">Extract helpers, reduce nesting with early returns, and apply complexity limits.</div>'
                : '<div class="detail-label">Clean complexity</div><div style="font-size:0.72rem;color:var(--text-muted);">No high complexity patterns detected.</div>';
        pushModule(
            '32',
            '📈',
            'Complexity Metrics',
            [{ value: cxCount, label: 'Issues', color: cxColor || '#60A5FA' }],
            cxCount > 0
        ...
        const fixDetail =
            fixCount > 0
                ? '<div class="detail-label">Suggested Fixes</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
                  fixCount +
                  ' fix' +
                  (fixCount === 1 ? '' : 'es') +
                  ' with patches.</div><ul>' +
                  topFixes
                      .map(
                          f =>
                              '<li>' +
                              escapeHtml(f.file || 'unknown') +
                              ':' +
                              (f.line || '?') +
                              ' — ' +
                              escapeHtml((f.action || 'Apply patch').slice(0, 60)) +
                              '</li>'
                      )
                      .join('') +
                  '</ul>' +
                  (fixCount > 5
                      ? '<div style="font-size:0.72rem;color:var(--text-muted);">...and ' +
                        (fixCount - 5) +
                        ' more</div>'
                      : '') +
                  '<div class="detail-fix">Click a fix in the Remediation Roadmap to view before/after diffs and copy patches.</div>'
        ...
        pushModule(
            ...
            '🔧',
            'Fix Preview',
            [{ value: fixCount, label: 'Patches', color: fixColor || '#60A5FA' }],
            fixCount > 0
                ? fixCount + ' auto-fixable issue' + (fixCount === 1 ? '' : 's') + ' with code patches.'
                : 'No suggested code patches.',
            fixColor,
            fixDetail
        );
        // 34. Token Bleed
        ...
        const tbDetail =
            tbCount > 0
                ? '<div class="detail-label">Token Bleed Risks</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
                  tbCount +
                  ' risk(s).</div>' +
                  (tbFindingsUI.length
                      ? '<ul>' +
                        ...
                        '</ul>'
                      : '') +
                  '<div class="detail-fix">Add max_tokens / max_completion_tokens to every LLM API call and chunk long literals.</div>'
                : '<div class="detail-label">No token bleed</div><div style="font-size:0.72rem;color:var(--text-muted);">No unbounded LLM API calls detected.</div>';
        pushModule(
            '34',
            '💸',
            'Token Bleed',
            [{ value: tbCount, label: 'Risks', color: tbColor || '#60A5FA' }],
            tbCount > 0
                ? tbCount + ' token bleed risk' + (tbCount === 1 ? '' : 's') + ' detected.'
                : 'No token bleed risks found.',
            tbColor,
            tbDetail
        );
        // 35. Production Leak
        ...
        const plDetail =
            plCount > 0
                ? '<div class="detail-label">Production Leaks</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
                  plCount +
                  ' leak(s).</div>' +
                  (plFindingsUI.length
                      ? '<ul>' +
                        ...
                        '</ul>'
                      : '') +
                  '<div class="detail-fix">Replace hardcoded mock/fixture paths with environment-based configuration or runtime discovery.</div>'
                : '<div class="detail-label">No production leaks</div><div style="font-size:0.72rem;color:var(--text-muted);">No mock/fixture path references in production code.</div>';
        pushModule(
            '35',
            '🔓',
            'Production Leak',
            [{ value: plCount, label: 'Leaks', color: plColor || '#60A5FA' }],
            plCount > 0
                ? plCount + ' production leak' + (plCount === 1 ? '' : 's') + ' detected.'
                : 'No production leaks found.',
            plColor,
            plDetail
        );
        // 36. Fiction KPI
        ...
        const fkDetail =
            fkCount > 0
                ? '<div class="detail-label">Fiction KPI Patterns</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
                  fkCount +
                  ' pattern(s).</div>' +
                  (fkFindingsUI.length
                      ? '<ul>' +
                        ...
                        '</ul>'
                      : '') +
                  '<div class="detail-fix">Replace hardcoded KPIs with real data sources and dynamic calculations.</div>'
                : '<div class="detail-label">No fiction KPIs</div><div style="font-size:0.72rem;color:var(--text-muted);">No hardcoded fiction KPI patterns detected.</div>';
        pushModule(
            '36',
            '🎭',
            'Fiction KPI',
            [{ value: fkCount, label: 'Patterns', color: fkColor || '#60A5FA' }],
            fkCount > 0
                ? fkCount + ' fiction KPI pattern' + (fkCount === 1 ? '' : 's') + ' detected.'
                : 'No fiction KPI patterns found.',
            fkColor,
            fkDetail
        );
        ...
        const adDetail =
            adCount > 0
                ? '<div class="detail-label">Architecture Drift</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
                  adCount +
                  ' finding(s).</div>' +
                  (adFindingsUI.length
                      ? '<ul>' +
                        ...
                        '</ul>'
                      : '') +
                  '<div class="detail-fix">Add schema validators (Zod, AJV, pydantic) and enforce max_tokens on all LLM calls.</div>'
                : '<div class="detail-label">No architecture drift</div><div style="font-size:0.72rem;color:var(--text-muted);">No unguarded LLM integration patterns detected.</div>';
        pushModule(
            '37',
            '🏗️',
            'Architecture Drift',
            [{ value: adCount, label: 'Findings', color: adColor || '#60A5FA' }],
            adCount > 0
                ? adCount + ' architecture drift finding' + (adCount === 1 ? '' : 's') + ' detected.'
        ...
        const rfDetail =
            rfCount > 0
                ? '<div class="detail-label">Removable Files</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
                  rfCount +
                  ' file(s) removable.</div>' +
                  (rfCategories.length
                      ? '<ul>' +
                        rfCategories
                            .map(
                        ...
                        '</ul>'
                      : '') +
                  '<div class="detail-fix">Review && remove identified files to reduce repository bloat.</div>'
                : '<div class="detail-label">No removable files</div><div style="font-size:0.72rem;color:var(--text-muted);">No obvious bloat detected.</div>';
        pushModule(
            '39',
            '🗑️',
            'Removable Files',
            [{ value: rfCount, label: 'Files', color: rfColor || '#60A5FA' }],
            rfCount > 0
                ? rfCount + ' removable file' + (rfCount === 1 ? '' : 's') + ' detected.'
        ...
        const csDetail = hasCs
            ? '<div class="detail-label">Consistency Score</div><div style="font-size:1.2rem;font-weight:700;color:' +
              csColor +
              ';margin-bottom:8px;">' +
              csScore +
              '/100</div><div style="font-size:0.72rem;color:var(--text-muted);margin-bottom:6px;">' +
              csDupGroups +
              ' duplicate file group(s).</div><div class="detail-fix">Consistency is based on duplicate file analysis. Consolidate duplicates to improve the score.</div>'
            : '<div class="detail-label">No consistency data</div><div style="font-size:0.72rem;color:var(--text-muted);">Consistency score not available for this scan.</div>';
        pushModule(
            '40',
            '✅',
            'Consistency Score',
            ...
            hasCs
                ? 'Consistency score: ' + csScore + '/100 based on ' + csDupGroups + ' duplicate group(s).'
                : 'No consistency score available.',
            hasCs ? csColor : null,
            csDetail
        );
        ...
        const panels = modules
            .map(mod => {
                const vals = mod.values
                    .map(
                        v =>
                            `<button class="detail-data-btn" onclick="copyReportData('${String(v.value).replace(/'/g, "\\'")}', this)"><strong style="color:${v.color || '#60A5FA'}">${v.value}</strong> <span style="color:var(--text-muted);font-weight:400;">${v.label}</span><span class="copy-icon">&#128203;</span></button>`
                    )
                    .join('');
        ...
        <div class="cert-preview ${hasToken ? '' : 'watermarked'}">
            ...
            ${(() => {
                ...
                const severityColor = s =>
                    s === 'critical' ? '#EF4444' : s === 'high' ? '#F59E0B' : s === 'medium' ? '#60A5FA' : '#34D399';
                const statusIcon = st =>
                        ...
                        const tasksHtml =
                            p.tasks && p.tasks.length
                                ? p.tasks
                                      .map((t, i) => {
                                          const patch =
                                              t.patch || (t.description && t.description.includes(' — ') ? null : null);
