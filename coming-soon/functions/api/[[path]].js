...
export async function onRequest(context) {
    ...
    const STUB_ENDPOINTS = {
        ...
        'admin/stats': { success: true, stats: { totalUsers: 0, activeUsers: 0, totalScans: 0, totalOrgs: 0, totalRevenue: 0, byTier: {}, byPlan: {} } },
        'admin/users': { success: true, users: [], total: 0, page: 1, limit: 20 },
        'enterprise/organizations': { success: true, organizations: [] },
