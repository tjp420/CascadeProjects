...
describe("index.js public API", () => {
  ...
  it("aliases point to same function as canonical names", () => {
    assert.strictEqual(
      index.loadSamplebeaconConfig,
      index.loadSimplebeaconConfig,
    );
    assert.strictEqual(
      Simplebeacon.config.initSamplebeacon,
      Simplebeacon.config.initSimplebeacon,
    );
  });
  ...
  it("Simplebeacon.config contains expected keys", () => {
    assert.strictEqual(
      typeof Simplebeacon.config.loadSimplebeaconConfig,
      "function",
    );
    assert.strictEqual(
      typeof Simplebeacon.config.resolveMockDataScanPaths,
      "function",
    );
    assert.strictEqual(
      Simplebeacon.config.loadSamplebeaconConfig,
      Simplebeacon.config.loadSimplebeaconConfig,
    );
    assert.strictEqual(
      Simplebeacon.config.initSamplebeacon,
      Simplebeacon.config.initSimplebeacon,
  ...
  it("Simplebeacon.report contains expected keys", () => {
    ...
    assert.strictEqual(
      typeof Simplebeacon.report.compileAuditReportMarkdown,
      "function",
    );
  });
  ...
  it("Simplebeacon.errors contains expected keys", () => {
    assert.strictEqual(
      typeof Simplebeacon.errors.SimplebeaconError,
      "function",
    );
  ...
  it("Simplebeacon.mcp contains expected keys", () => {
    assert.strictEqual(
      typeof Simplebeacon.mcp.createMcpStdioServer,
      "function",
    );
