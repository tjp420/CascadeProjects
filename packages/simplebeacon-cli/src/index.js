...
const _allModuleSpecs = [
    ...
    { name: 'agent-tier-capabilities', path: './lib/agent-tier-capabilities' },
    { name: 'agent-session', path: './lib/agent-session' },
    { name: 'agent-brief', path: './lib/agent-brief' },
    { name: 'agent-context-pack', path: './lib/agent-context-pack' },
    { name: 'cleanup-assistant-brief', path: './lib/cleanup-assistant-brief' },
    { name: 'file-reduction-ai-notes', path: './lib/file-reduction-ai-notes' },
    { name: 'enrich-cleanup-report', path: './lib/enrich-cleanup-report' },
    { name: 'agent-host-adapters', path: './lib/agent-host-adapters' },
    { name: 'agent-task-profiles', path: './lib/agent-task-profiles' },
    { name: 'gate-parity', path: './lib/gate-parity' },
    { name: 'ai-agent-controller', path: './lib/ai-agent-controller' },
