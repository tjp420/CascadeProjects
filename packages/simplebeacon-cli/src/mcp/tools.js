...
const TOOL_DEFINITIONS = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        projectRoot: {
          type: 'string',
          description: 'Project root for baseline.json (default: cwd or SIMPLEBEACON_PROJECT_ROOT)',
        },
      },
      required: ['content'],
    },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        configPath: {
          type: 'string',
          description: 'Path to custom .simplebeacon/config.json relative to project root',
        },
        profile: {
          type: 'string',
          description:
        ...
        fullDirectoryScan: {
          type: 'boolean',
          description: 'Walk entire repo tree instead of selective paths (slower, more thorough)',
        },
        complete: {
          type: 'boolean',
          description:
        ...
        gate: {
          type: 'boolean',
          description: 'Run gate-only scan (credentials + AI heuristics) instead of full scan',
        },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        projectRoot: {
          type: 'string',
          description: 'Project root for reading .simplebeacon/report.json (default: cwd)',
        },
        reportPath: {
          type: 'string',
          description: 'Override report path relative to project root',
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        profile: {
          type: 'string',
          description: 'Force profile: minimal, standard, cascade, executive, euai, universal',
        },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        tone: {
          type: 'string',
          description: 'Tone: professional, casual, technical (default: professional)',
        },
      },
    },
  },
