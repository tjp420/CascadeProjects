...
function parseLockfile(rootDir, options = {}) {
  const located = options.lockfilePath
    ? {
        ...
        format: detectFormat(options.lockfilePath),
      }
  ...
  switch (located.format) {
    case "npm":
      return {
        ...parseNpmLockfile(located.lockfilePath),
        lockfilePath: located.lockfilePath,
      };
    case "yarn":
      return {
        ...parseYarnLockfile(located.lockfilePath),
        lockfilePath: located.lockfilePath,
      };
    case "pnpm":
      return {
        ...parsePnpmLockfile(located.lockfilePath),
        lockfilePath: located.lockfilePath,
      };
    default:
      return null;
