...
function enrichCompleteScan(completeScan) {
  ...
  enriched.summary = {
    ...
    fileReductionReclaimableBytes:
      fr?.summary?.reclaimableBytes ?? enriched.summary?.fileReductionReclaimableBytes ?? null,
    fileReductionUnusedCandidates:
      frPlan?.unusedFiles?.candidates ?? fr?.summary?.unusedFileCandidates ?? null,
    dataQualityFindings:
      dq?.summary?.totalFindings ?? enriched.summary?.dataQualityFindings ?? null,
