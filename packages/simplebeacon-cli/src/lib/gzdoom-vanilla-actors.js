...
const GZDoom_VANILLA_ACTORS = new Set([
    ...
    'ExplosiveBarrel', 'BurningBarrel', 'TechLamp', 'TechPillar',
    'Column', 'Candle', 'Candlestick', 'BlueTorch', 'GreenTorch',
    'RedTorch', 'ShortBlueTorch', 'ShortGreenTorch', 'ShortRedTorch',
    'Stalagtite', 'TallTechColumn', 'TallShortBlueTorch',
    'HangNoGuts', 'HangBNoBrain', 'HangTLookingDown', 'HangTSkull',
    'HangTLookingUp', 'HangTNoBrain', 'HangColGuts', 'HangColNoGuts',
    'HangColNoBrain', 'HangBNoGuts', 'HangTNoGuts', 'HangBrainStem',
    'DeadMarine', 'DeadPlayer', 'DeadDemon', 'DeadLostSoul',
    'DeadCacodemon', 'DeadZombieMan', 'DeadShotgunGuy',
    'GibbedMarine', 'GibbedMarineExtra',
    'BloodPool', 'GibbedPlayer', 'GibbedPlayerChunk',
    'PoolOfBlood', 'PoolOfBrains', 'PoolOfGuts',
    'SmallBloodPool', 'LargeBloodPool',
    // Doom 2 decorations
    'Barrel', 'TorchTree', 'BlueTorchLong', 'GreenTorchLong', 'RedTorchLong',
    'BlueTorchShort', 'GreenTorchShort', 'RedTorchShort',
    'BrownTorch', 'BlueCandle', 'RedCandle', 'GreenCandle',
    'EvilCauldron', 'KneelingGuy', 'ImpaledHuman', 'ImpaledTwitching',
    'SkullPile', 'SkullColumn', 'SkullShrine', 'DeadRevenant',
    'WoodTorch', 'WallTorch', 'HangingTorch',
    // Additional vanilla columns and props
    'TallGreenColumn', 'TallRedColumn', 'ShortGreenColumn', 'ShortRedColumn',
    'HeartColumn', 'EvilEye', 'FloatingSkull',
    // Vanilla armor/health pickups (MODELDEF may reference these)
    'GreenArmor', 'BlueArmor', 'MediKit', 'Stimpack',
    'HealthBonus', 'ArmorBonus', 'Soulsphere', 'Megasphere',
    'InvulnerabilitySphere', 'InvisibilitySphere', 'RadSuit',
    'BlurSphere', 'Berserk', 'Allmap', 'Infrared',
    // Vanilla keys
