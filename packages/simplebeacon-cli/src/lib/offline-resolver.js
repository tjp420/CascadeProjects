...
const KNOWN_GOOD_PACKAGES = new Set([
    ...
    'next', 'nuxt', 'svelte', '@sveltejs/kit', 'astro', 'eleventy',
    'lodash', 'axios', 'chalk', 'commander', 'inquirer', 'ora',
    'typescript', 'jest', 'vitest', 'mocha', 'chai', 'playwright',
    'eslint', 'prettier', 'webpack', 'vite', 'rollup', 'esbuild',
    'tailwindcss', 'postcss', 'sass', 'less',
    'fastify', 'koa', 'hapi', 'polka', 'connect',
    'mongoose', 'sequelize', 'prisma', 'drizzle-orm', 'kysely',
    'pg', 'mysql2', 'sqlite3', 'better-sqlite3', 'redis', 'ioredis',
    'dotenv', 'cors', 'helmet', 'morgan', 'compression',
    'zod', 'joi', 'yup', 'ajv', 'io-ts', 'superstruct',
    'openai', 'anthropic', '@anthropic-ai/sdk', 'langchain', '@langchain/core',
    'ws', 'socket.io', 'nanoid', 'uuid', 'date-fns', 'dayjs', 'moment',
    'fs-extra', 'glob', 'chokidar', 'minimatch', 'micromatch',
    'bcrypt', 'argon2', 'jsonwebtoken', 'passport', 'oauth',
    'winston', 'pino', 'bunyan', 'loglevel',
    'node-fetch', 'got', 'undici', 'ky',
    'jszip', 'archiver', 'tar', 'unzipper',
    'sharp', 'jimp', 'canvas', 'pdfkit', 'puppeteer',
    '@babel/core', '@babel/parser', '@babel/traverse', '@babel/types',
    'bluebird', 'rxjs', 'immer', 'nanostores', 'zustand',
    'class-validator', 'class-transformer', 'reflect-metadata',
    'swagger-ui-express', 'swagger-jsdoc', '@nestjs/core', '@nestjs/common',
    'graphql', '@apollo/server', 'mercurius', 'type-graphql',
    'prisma', '@prisma/client', 'drizzle-orm',
    'simplebeacon', 'simplebeacon-cli',
]);

// Packages that are commonly hallucinated by LLMs
const KNOWN_HALLUCINATED_PACKAGES = new Set([
    'react-server-renderer-v2', 'next-ssr-optimizer', 'ai-code-fixer',
    'smart-react-hooks', 'vue-ai-validator', 'auto-remediation-engine',
    'llm-code-optimizer', 'gpt-router', 'claude-bridge', 'ai-middleware',
    'token-optimizer', 'prompt-injector', 'ai-safety-guard',
    'smart-async-handler', 'react-ai-component', 'vue-ai-composer',
]);
