...
export function resolveScanPaths(platformRoot: string, options?: any, extras?: string[]): string[];
export function resolveMockDataScanPaths(baseDir: string, extraPaths?: string[]): string[];
...
export function loadComplianceChecklist(projectRoot: string, options?: any): any;
...
export function verifyAnonymizedExport(exportData: any, signature: string, secret: string): boolean;
export function validateAnonymizedSchema(data: any): { valid: boolean; errors?: string[] };
...
export function padStart(str: string | number, len: number, char?: string): string;
export function padEnd(str: string | number, len: number, char?: string): string;
