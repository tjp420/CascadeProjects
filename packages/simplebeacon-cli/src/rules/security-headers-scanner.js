...
const REQUIRED_HEADERS = [
  {
    ...
    severity: "high",
    description:
      "Missing Content-Security-Policy header — exposes page to XSS and data injection attacks",
    remediation:
  ...
  },
  {
    ...
    severity: "high",
    description:
      "Missing Strict-Transport-Security header — allows protocol downgrade and MITM attacks",
    remediation:
  ...
  },
  {
    ...
    severity: "medium",
    description:
      "Missing X-Frame-Options header — page can be embedded in iframes (clickjacking risk)",
  ...
  },
  {
    ...
    severity: "low",
    description:
      "Missing Referrer-Policy header — referrer may leak sensitive path data",
