...
const RULE_CATALOG = [
  ...
  },
  {
    ...
    severity: "medium",
    description:
      'Generic placeholder file name (e.g., "Untitled", "script", "new_file", "temp")',
  },
  {
    id: "SB-FNAME-003",
  ...
  },
  {
    ...
    severity: "low",
    description:
      'Excessive version suffix chain (e.g., "v1_v2_final", "final_final_v2")',
  },
];
...
function analyzeFileName(relativePath, severityDefault = "medium") {
  ...
  if (
    LLM_NAMING_SLOP_RE.test(nameNoExt) &&
    !PLACEHOLDER_NAME_RE.test(nameNoExt)
  ) {
    issues.push({
      id: "SB-FNAME-003",
      type: "File Naming",
