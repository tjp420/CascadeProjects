...
const { SupplyChainSecurityScanner } = require('../analyzers/file-reduction/supply-chain-security-scanner');
...
module.exports = {
    ...
    scanners: [
        ...
        { id: 'dead-code', class: DeadCodeScanner, enabled: true, priority: 5 },
        ...
        { id: 'environment-variables', class: EnvironmentVariableAnalyzer, enabled: true, priority: 9 },
