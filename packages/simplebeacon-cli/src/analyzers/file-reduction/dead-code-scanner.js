...
const EXPORT_PATTERNS = [
  {
    kind: 'named',
    regex: /(?:export\s+(?:const|let|var|function|class)\s+)([A-Za-z_$][A-Za-z0-9_$]*)/g,
  },
  {
    kind: 'named-list',
    regex: /export\s*\{\s*([A-Za-z_$][A-Za-z0-9_$]*(?:\s*,\s*[A-Za-z_$][A-Za-z0-9_$]*)*)\s*\}/g,
  },
  {
    kind: 'default',
    regex: /export\s+default\s+(?:function\s+|class\s+)?([A-Za-z_$][A-Za-z0-9_$]*)/g,
  },
