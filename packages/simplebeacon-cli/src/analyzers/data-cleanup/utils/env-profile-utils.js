...
const PLANNED_ENV_KEY_PREFIXES = [/^AZURE_AD_/, /^GOOGLE_/, /^OKTA_/, /^LDAP_/, /^SAML_/];
...
const OPTIONAL_ENV_KEYS_WITH_CODE_DEFAULTS = new Set(['SIMPLEBEACON_SALES_COMMISSIONS_STORE']);
