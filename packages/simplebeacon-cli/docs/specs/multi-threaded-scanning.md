...
*Note: The orchestrator will bypass worker thread initialization for projects containing fewer than 2,000 files to dodge the underlying system execution spawning penalty.*
