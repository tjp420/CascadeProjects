  ...
  try {
    ...
    for (const f of folders) {
      ...
      try {
        ...
        aggregate.reconciledMetrics.totalFiles +=
          r.reconciledMetrics.totalFiles || 0;
        aggregate.reconciledMetrics.totalLines +=
          r.reconciledMetrics.totalLines || 0;
        for (const [k, v] of Object.entries(
          r.reconciledMetrics.extensionBreakdown || {},
        )) {
          aggregate.reconciledMetrics.extensionBreakdown[k] =
            (aggregate.reconciledMetrics.extensionBreakdown[k] || 0) + v;
        }
        if (
          r.architecturalCyclesCount &&
          r.detectedCycles &&
          r.detectedCycles.length
        ) {
