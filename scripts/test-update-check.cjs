...
// Load the module
const updateCheck = require(path.join(REPO_ROOT, 'packages/simplebeacon-cli/src/lib/update-check'));
...
describe('CLI entry point integration', () => {
    ...
    test('update check runs after version/help checks', () => {
        ...
        assert.ok(updatePos > versionPos, 'update check should come after version check');
    });
    ...
    test('update check runs before command execution', () => {
        ...
        assert.ok(updatePos < commandPos, 'update check should come before command execution');
    });
});
...
describe('syntax validation', () => {
    ...
    test('update-check.js passes node syntax check', () => {
        ...
        const filePath = path.join(REPO_ROOT, 'packages/simplebeacon-cli/src/lib/update-check.js');
