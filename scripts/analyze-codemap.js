...
const INPUT = process.argv[2] || 'j:\\Downloads\\cascadeprojects-codemap-analysis-2026-07-01.json';
...
fs.writeFileSync(path.join(OUTDIR, 'codemap-analysis-report.md'), report, 'utf8');
...
console.log('Top connected:', topConnected[0].id, '(degree:', topConnected[0].degree + ')');
