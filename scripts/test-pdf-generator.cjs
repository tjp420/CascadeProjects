...
} = require(path.join(REPO_ROOT, 'packages/simplebeacon-cli/src/lib/pdf-generator'));
...
describe('risk profile and grade logic', () => {
    ...
    test('buildRiskProfile classifies issues into pillars', () => {
        ...
        assert.ok(profile.slop.count > 0 || profile.leak.count > 0,
...
describe('syntax validation', () => {
    ...
    test('pdf-generator.js passes node syntax check', () => {
        ...
        const filePath = path.join(REPO_ROOT, 'packages/simplebeacon-cli/src/lib/pdf-generator.js');
