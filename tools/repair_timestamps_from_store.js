...
const input = argv.input || '.simplebeacon/filtered-org-compliance-attestation-strict-redacted.json';
...
if(!fs.existsSync(storePath)) { console.error('store not found', storePath); process.exit(1); }
...
console.log(JSON.stringify({status:'ok', input, storePath, output, countFixed}));
