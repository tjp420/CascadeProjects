...
const REPORT_PATH =
  process.env.SIMPLEBEACON_VERIFY_REPORT || 'J:/Downloads/simplebeacon-report-2026-07-14.json';
  ...
  try {
    ...
    allOk =
      assert(
        ...
        sandbox.status === 200 && sandbox.body?.sandbox === true && sandbox.body?.active === false,
    ...
    allOk =
      assert(
        ...
        active.status === 200 && active.body?.active === true && active.body?.tier === 'pro',
